...
func void YEZEGAN_Q602_KILLMARVIN() {
    ...
    INFO_CLEARCHOICES(90128);
    AI_STOPPROCESSINFOS(SELF);
    AI_FUNCTION(SELF, 90131);
}
...
func void DIA_YEZEGAN_Q602_CHOICES() {
    INFO_CLEARCHOICES(90128);
    INFO_ADDCHOICE(90128, "It's not my fight. All I care about is getting the Usurer.", 90140);
    INFO_ADDCHOICE(90128, "Where's Ulryk?", 90138);
    INFO_ADDCHOICE(90128, "Why did you attack the city?", 90137);
}
...
var int YEZEGAN_Q602_TIRED_COUNT;
...
func void DIA_YEZEGAN_Q602_HELLO_WHY() {
    ...
    INFO_ADDCHOICE(90128, "The island and the kingdom are threatened by orcs, and you fight among yourselves?", 90139);
    YEZEGAN_Q602_TIRED();
}
...
func void DIA_YEZEGAN_Q602_WHATDO_INFO() {
    INFO_CLEARCHOICES(90141);
    INFO_ADDCHOICE(90141, "Get out of here, you mangy bug! (Spare his life)", 90145);
    INFO_ADDCHOICE(90141, "You're dead, scum! (Kill)", 90144);
}
...
func void MARVIN_Q602_KILLYEZEGAN() {
    ...
    B_MAGICHURTNPC(HERO, DJG_10002_YEZEGAN_Q602, 99999);
