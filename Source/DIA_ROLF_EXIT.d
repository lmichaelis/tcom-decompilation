...
var int SQ109_MONEYFROMGOLD;
func void DIA_ROLF_EXIT_INFO() {
    if ((NPC_KNOWSINFO(OTHER, 86000)) && ((SQ109_ROLFPARTY) == (TRUE))) {
...
func int DIA_ROLF_SQ109_HELLO_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ109)) == (LOG_RUNNING)) && ((SQ109_ROLFISSAFE) == (TRUE))) {
        if (((NPC_GETDISTTONPC(SELF, OTHER)) <= (150)) || (NPC_ISINSTATE(SELF, 61599))) {
            return TRUE;
        };
    };
...
func void DIA_ROLF_SQ109_HELLO_INFO() {
    ...
    INFO_CLEARCHOICES(85990);
    INFO_ADDCHOICE(85990, "I would have preferred a purse instead of children.", 85996);
    INFO_ADDCHOICE(85990, "How long have you been here?", 85995);
}

var int ROLF_SQ109_INFORMATIONS_COUNT;
func void DIA_ROLF_SQ109_HELLO_COUNT() {
    ...
    if ((ROLF_SQ109_INFORMATIONS_COUNT) == (1)) {
        INFO_ADDCHOICE(85990, "What happened?", 85997);
    };
}
...
func int DIA_ROLF_SQ109_LETSGO_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ109)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 85990))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_ROLF_SQ109_HOME_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 86000)) {
        if (((NPC_GETDISTTOWP(SELF, "VILLAGE_PATH_41")) <= (5000)) || ((NPC_GETDISTTOWP(SELF, "VILLAGE_PATH_34")) <= (5000))) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
