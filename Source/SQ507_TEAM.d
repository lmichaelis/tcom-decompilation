...
func void SQ507_ENEMIESSPAWN() {
    WLD_INSERTNPC(51038, "PART17_PATH_155A");
    WLD_INSERTNPC(51038, "PART17_PATH_119A");
    WLD_INSERTNPC(50335, "PART17_PATH_70A");
    WLD_INSERTNPC(50335, "PART17_PATH_64A");
...
func void DIA_BARRY_SQ507_START_INFO() {
    ...
    INFO_CLEARCHOICES(82790);
    INFO_ADDCHOICE(82790, "None of your business.", 82793);
    INFO_ADDCHOICE(82790, "This girl was being held here against her will.", 82794);
}
...
func void DIA_BARRY_SQ507_START_THETRUTH() {
    ...
    INFO_CLEARCHOICES(82790);
    INFO_ADDCHOICE(82790, "I can do this without your help!", 82795);
    INFO_ADDCHOICE(82790, "We could use some help.", 82796);
}
...
func void DIA_BARRY_SQ507_AFTERATTACK_INFO() {
    ...
    INFO_CLEARCHOICES(82797);
    INFO_ADDCHOICE(82797, "These are people I've still got a bone to pick with.", 82800);
}
