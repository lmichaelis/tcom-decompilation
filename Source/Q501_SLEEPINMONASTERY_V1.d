...
func void Q501_SLEEPINMONASTERY_V2() {
    ...
    WLD_INSERTNPC(50695, "PART8_UNDERGROUND_PANTRY_03");
...
func void Q501_SLEEP() {
    ...
    FADESCREENTOBLACKF(4, 63372, 1000);
}
...
func void Q501_ANA_RIEROLROOM_CAMERA_APPLY() {
    var int Q501_ANA_RIEROLROOM_CAMERA_COUNT;
...
func void Q501_RIEROLSPYCUTSCENE_END_APPLY() {
    var int Q501_RIEROLSPYCUTSCENE_END_COUNT;
...
func void Q501_CAULDRON_APPLY() {
    ...
    if (((MOVER1.MOVERSTATE) != (MOVER_STATE_OPENING)) && ((MOVER1.MOVERSTATE) != (MOVER_STATE_CLOSING))) {
        PRINTD("Skoñczy³em - Q501_CAULDRON_APPLY");
...
func void Q501_AFTERCONTEST() {
    ...
    NPC_REFRESH(NOV_251_CURTIS);
    TELEPORTNPCTOWP(56756, NOV_251_CURTIS.WP);
    B_STARTOTHERROUTINE(NOV_201_NOVIZE, "Q501_AFTERCONTEST");
    NPC_REFRESH(NOV_201_NOVIZE);
    TELEPORTNPCTOWP(56737, NOV_201_NOVIZE.WP);
...
func void Q501_CHANGEALMEBICDOOR_APPLY() {
    var ZCMOVER MOVER1;
    var int MOVPTR1;
    var int Q501_CHANGEALMEBICDOOR_COUNT;
    ...
    if (((MOVER1.MOVERSTATE) != (MOVER_STATE_OPENING)) && ((MOVER1.MOVERSTATE) != (MOVER_STATE_CLOSING))) {
        PRINTD("Skoñczy³em - Q501_ChangeAlmebicDoor_Apply");
...
func void Q501_CHANGEDOORLABROOM() {
    FF_APPLYONCEEXTGT(63398, 0, -(1));
}

func void Q501_CHANGEDOORLABROOM_APPLY() {
    var ZCMOVER MOVER1;
    var int MOVPTR1;
    var int Q501_CHANGEDOORLABROOM_COUNT;
    ...
    if (((MOVER1.MOVERSTATE) != (MOVER_STATE_OPENING)) && ((MOVER1.MOVERSTATE) != (MOVER_STATE_CLOSING))) {
        PRINTD("Skoñczy³em - Q501_ChangeDoorLabRoom_Apply");
...
func void Q501_FINISHMAKINGPOTION() {
    FF_APPLYONCEEXT(63404, 75, 4);
}

func void Q501_FINISHMAKINGPOTION_APPLY() {
    var int Q501_FINISHMAKINGPOTION_COUNT;
...
func void Q501_FALLDOWNSCRIPT_FADESCREEN() {
    ...
    CREATEINVITEMS(NONE_202_KESSEL, 39480, 1);
    CREATEINVITEMS(NONE_202_KESSEL, 39709, 1);
    NPC_CHANGEARMOR(NONE_202_KESSEL, 35388);
    NPC_REMOVEINVITEMS(NONE_202_KESSEL, 35592, NPC_HASITEMS(NONE_202_KESSEL, 35592));
...
func void Q501_CHANGEDOORMARVINROOM_APPLY() {
    ...
    var ZCMOVER MOVER1;
    var int MOVPTR1;
    var int Q501_CHANGEDOORMARVINROOM_COUNT;
    ...
    if (((((MOVER1.MOVERSTATE) != (MOVER_STATE_OPENING)) && ((MOVER1.MOVERSTATE) != (MOVER_STATE_CLOSING))) && ((MOVER2.MOVERSTATE) != (MOVER_STATE_OPENING))) && ((MOVER2.MOVERSTATE) != (MOVER_STATE_CLOSING))) {
        PRINTD("Skoñczy³em - Q501_ChangeDoorMarvinRoom_Apply");
