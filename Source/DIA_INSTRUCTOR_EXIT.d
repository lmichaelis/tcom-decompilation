...
func void FMQ001_SHOTTHEAPPLE() {
    ...
    INFO_CLEARCHOICES(77339);
    AI_FUNCTION(SELF, 62791);
}

func void DIA_INSTRUCTOR_FMQ001_TARGET_INFO() {
    AI_OUTPUT(SELF, OTHER, "DIA_Instructor_FMQ001_Target_03_01");
    INFO_CLEARCHOICES(77339);
    INFO_ADDCHOICE(77339, "Why are we stopping?", 77343);
    INFO_ADDCHOICE(77339, "(Be silent)", 77344);
}
...
func void DIA_INSTRUCTOR_FMQ001_NEXTQUEST() {
    ...
    INFO_CLEARCHOICES(77345);
    INFO_ADDCHOICE(77345, "I wanted to ask you...", 77349);
    INFO_ADDCHOICE(77345, "(Be silent)", 77348);
    INFO_CLEARCHOICES(77351);
    INFO_ADDCHOICE(77351, "I wanted to ask you...", 77349);
    INFO_ADDCHOICE(77351, "(Be silent)", 77348);
}
