...
func void Q405_FOUNDJORN_SACHS_START() {
    ...
    TELEPORTNPCTOWP(53373, "SLUMS_HOUSE17_38");
    ...
    AI_WAIT(NONE_6413_SACHS, 1036831949);
    Q405_FOUNDJORN_SACHS_WAIT();
    AI_FUNCTION(NONE_6413_SACHS, 92624);
    ...
    Q405_FOUNDJORN_SACHS_WAIT();
    AI_FUNCTION(NONE_6413_SACHS, 92625);
    AI_TURNTONPC(NONE_6413_SACHS, HERO);
    ...
    Q405_FOUNDJORN_SACHS_WAIT();
    AI_FUNCTION(NONE_6413_SACHS, 92626);
    ...
    Q405_FOUNDJORN_SACHS_WAIT();
    AI_FUNCTION(NONE_6413_SACHS, 92630);
    AI_TURNTONPC(HERO, NONE_6413_SACHS);
...
func void Q405_FOUNDJORN_REMOVEFAKESCROLL() {
    ...
    NPC_REMOVEINVITEMS(NONE_6413_SACHS, 36085, 1);
    CREATEINVITEMS(NONE_6413_SACHS, 39710, 1);
    CREATEINVITEMS(NONE_6413_SACHS, 34384, 10);
}

func void Q405_FOUNDJORN_CAMERA_10() {
    TELEPORTNPCTOWP(1819, "SLUMS_HOUSE17_MARVINCROSSBOW");
    CREATEINVITEMS(HERO, 36086, 1);
...
func void Q405_FOUNDJORN_CAMERA_13() {
    FF_APPLYONCEEXTGT(63844, 0, -(1));
    TELEPORTNPCTOWP(56688, "SLUMS_HOUSE17_32");
...
func void Q405_FOUNDJORN_CAMERA_16() {
    TELEPORTNPCTOWP(56688, "SLUMS_HOUSE17_35");
