func void EVENTSMANAGER_SQ508() {
    ...
    if ((LOG_GETSTATUS(MIS_SQ508)) == (LOG_RUNNING)) {
        ...
        if ((SQ508_HELPNOVIZE) == (TRUE)) {
            if ((NPC_KNOWSINFO(HERO, 69988)) == (FALSE)) {
                ...
                if ((SQ508_CHECKWARANS_LOGENTRY) == (FALSE)) {
                    if ((NPC_GETDISTTOWP(HERO, "PART8_SQ508_CHECKWARANS")) <= (1100)) {
        ...
        if ((SQ508_CANDACFIGHT) == (1)) {
            ...
            if (((SQ508_SKELETONSAREDEAD()) == (TRUE)) && ((NPC_ISINSTATE(PAL_100_CANDAC, 61599)) == (FALSE))) {
                SQ508_CANDACFIGHT = 4;
