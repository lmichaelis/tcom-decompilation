var int SMUGGLER_MARVINISBRAINLET;
...
func void DIA_SMUGGLER_HELLO_INFO() {
    ...
    INFO_CLEARCHOICES(83332);
    INFO_ADDCHOICE(83332, "Apparently they've always sent Antonio so far.", 83335);
    INFO_ADDCHOICE(83332, "Coyote?", 83336);
    INFO_ADDCHOICE(83332, "Are you a guard?", 83337);
}
...
func void DIA_SMUGGLER_HELLO_ANTONIO() {
    ...
    INFO_CLEARCHOICES(83332);
    INFO_ADDCHOICE(83332, "Here's the money from Cortez.", 83339);
    INFO_ADDCHOICE(83332, "I'm supposed to give the money directly to Antonio.", 83340);
}
...
func void DIA_SMUGGLER_HELLO_ANTONIO_GIVEANTONIO() {
    ...
    INFO_CLEARCHOICES(83332);
    INFO_ADDCHOICE(83332, "Okay, it's none of my business. The important thing is that everything checks out.", 83341);
    INFO_ADDCHOICE(83332, "Hey, Antonio! Can you confirm that?", 83342);
}
...
func void DIA_SMUGGLER_HELLO_ANTONIO_GIVEANTONIO_NOTMYPROBLEM() {
    ...
    if ((NPC_HASITEMS(OTHER, 37247)) >= (1)) {
        Q304_POCKETGIVEN = TRUE;
        B_GIVEINVITEMS(OTHER, SELF, 37247, 1);
        CREATEINVITEMS(SELF, 37249, 1);
        B_GIVEINVITEMS(SELF, OTHER, 37249, 1);
...
func void DIA_SMUGGLER_HELLO_ANTONIO_GIVEANTONIO_ANTONIOHELP() {
    ...
    INFO_ADDCHOICE(83332, "Or? (Provoke)", 83343);
}
...
func int DIA_SMUGGLER_WAITASEC_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 83332)) && ((LOG_GETSTATUS(MIS_Q304)) == (LOG_RUNNING))) && ((SMUGGLER_MARVINISBRAINLET) == (TRUE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_SMUGGLER_WAITASEC_INFO() {
    ...
    INFO_CLEARCHOICES(83345);
    INFO_ADDCHOICE(83345, "If there's no other option, though, I'll pay.", 83349);
    if ((Q304_WATCHOUTMONEY) == (TRUE)) {
        INFO_ADDCHOICE(83345, "I'm sorry, but I got clear instructions.", 83350);
    };
}
...
func void DIA_SMUGGLER_WAITASEC_PAYDUMB() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (Q304_SMUGGLERPRANK)) {
        Q304_MARVINGIVEMONEY = TRUE;
        AI_OUTPUT(SELF, OTHER, "DIA_Smuggler_WaitASec_PayDumb_03_02");
        B_GIVEINVITEMS(OTHER, SELF, 34203, Q304_SMUGGLERPRANK);
...
func int DIA_SMUGGLER_CUTSCENEAMBIENT_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_Q304)) == (LOG_RUNNING)) && ((Q304_CUTSCENEENDING) == (2))) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
