...
func void DIA_WANDERER_NS63_START_INFO() {
    ...
    INFO_ADDCHOICE(80723, "Why should I know anything about it?", 80729);
    INFO_ADDCHOICE(80723, "The vineyard is right next to us.", 80726);
    INFO_ADDCHOICE(80723, "Maybe join the Merchant's Guild?", 80727);
    INFO_ADDCHOICE(80723, "Have you thought about the city guard?", 80728);
}
...
func int DIA_WANDERER_AFTER_NS63_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 80723)) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
