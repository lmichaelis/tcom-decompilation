...
func void DIA_NIRKO_SQ101_HELLO_INFO() {
    ...
    INFO_CLEARCHOICES(86045);
    INFO_ADDCHOICE(86045, "I'll tell Knut you're hiding here.", 86050);
    INFO_ADDCHOICE(86045, "You'll come back in kind or I'll make you.", 86049);
}
...
func void DIA_NIRKO_SQ101_HELLO_IWILLTELLKNUT() {
    ...
    INFO_ADDCHOICE(86045, "You'll have to give me a really good reason.", 86051);
}
...
func void DIA_NIRKO_SQ101_HELLO_IWILLTELLKNUT_GIVEMESOMETHING() {
    ...
    INFO_CLEARCHOICES(86045);
    INFO_ADDCHOICE(86045, "Your story doesn't convince me.", 86053);
    INFO_ADDCHOICE(86045, "What do you propose then?", 86054);
}

func void DIA_NIRKO_SQ101_HELLO_FINISH() {
    INFO_CLEARCHOICES(86045);
    AI_STOPPROCESSINFOS(SELF);
    AI_FUNCTION(SELF, 62335);
}
...
func void DIA_NIRKO_SQ101_HELLO_IWILLTELLKNUT_GIVEMESOMETHING_WHATSYOUROFFER() {
    ...
    INFO_ADDCHOICE(86045, "I think you could do with a little more effort.", 86055);
    INFO_ADDCHOICE(86045, "Fine. Give me that amulet.", 86056);
}
...
func void DIA_NIRKO_SQ101_HELLO_IWILLTELLKNUT_GIVEMESOMETHING_WHATSYOUROFFER_REALLY() {
    ...
    CREATEINVITEMS(SELF, 34203, SQ101_NIRKOGOLD);
    B_GIVEINVITEMS(SELF, OTHER, 34203, SQ101_NIRKOGOLD);
}
...
func void DIA_NIRKO_SQ101_HELLO_IWILLTELLKNUT_GIVEMESOMETHING_WHATSYOUROFFER_GIVEMETHAT() {
    ...
    CREATEINVITEMS(SELF, 37062, 1);
    B_GIVEINVITEMS(SELF, OTHER, 37062, 1);
    INFO_CLEARCHOICES(86045);
    AI_STOPPROCESSINFOS(SELF);
...
func void DIA_NIRKO_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(86060);
    INFO_ADDCHOICE(86060, DIALOG_BACK, 86064);
    INFO_ADDCHOICE(86060, DIALOG_PICKPOCKET, 86063);
}
