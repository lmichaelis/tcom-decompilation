...
func int DIA_FARMER_BUSY_CONDITION() {
    if (((NPC_HASITEMS(OTHER, 37068)) && ((LOG_GETSTATUS(MIS_Q106)) == (LOG_RUNNING))) && ((NPC_KNOWSINFO(OTHER, 87475)) == (FALSE))) {
        return FALSE;
    };
    if (((NPC_KNOWSINFO(OTHER, 87898)) && ((LOG_GETSTATUS(MIS_GQ001)) == (LOG_RUNNING))) && ((NPC_KNOWSINFO(OTHER, 87478)) == (FALSE))) {
        return FALSE;
    };
...
func void DIA_FARMER_YOURFAULT_INFO() {
    ...
    INFO_CLEARCHOICES(87478);
    INFO_ADDCHOICE(87478, "We're not too fond of Fabio either.", 87482);
    INFO_ADDCHOICE(87478, "Why would one of us kidnap another of ours?", 87483);
}
