...
func void DIA_TOMAS_EXIT_INFO() {
    ...
    if ((CQ003_TALKWITHTOMAS) == (0)) {
        ...
        INFO_CLEARCHOICES(69784);
        INFO_ADDCHOICE(69784, "Why not, good beer needs to be shown to the world.", 69789);
        if ((LOG_GETSTATUS(MIS_Q202)) == (LOG_RUNNING)) {
            INFO_ADDCHOICE(69784, "Can you help me become a citizen of the city?", 69788);
        };
        INFO_ADDCHOICE(69784, "Hm, I'll think about it some more.", 69787);
    };
}
...
func void DIA_TOMAS_WAITIHAVEQUEST_OKAY() {
    ...
    CQ003_TALKWITHTOMAS = 1;
    CREATEINVITEMS(SELF, 36364, 6);
    B_GIVEINVITEMS(SELF, OTHER, 36364, 6);
    ...
    INFO_CLEARCHOICES(69784);
    INFO_ADDCHOICE(69784, "The quartermaster of the city guard would buy beer from you?", 69792);
    INFO_ADDCHOICE(69784, "Do you want to work with the Merchant's Guild?", 69794);
    INFO_ADDCHOICE(69784, "What about that brothel owner?", 69793);
    INFO_ADDCHOICE(69784, "Tell me something about Gerstand.", 69791);
    INFO_ADDCHOICE(69784, "Tell me something about Helga.", 69790);
    INFO_ADDCHOICE(69784, "No, I can handle it.", 69795);
}
...
func void DIA_TOMAS_WHATBEER_INFO() {
    ...
    INFO_CLEARCHOICES(69799);
    INFO_ADDCHOICE(69799, "Dark Paladine.", 69802);
    INFO_ADDCHOICE(69799, "Islander Beer", 69803);
    INFO_ADDCHOICE(69799, "Maybe some other time, I don't have time right now.", 69804);
}
...
var int TOMAS_READYTOTOLDHISTORY;
...
func void DIA_TOMAS_WAITIHAVEQUEST_INFO() {
    ...
    AI_LOGENTRY(TOPIC_CQ003, LOG_CQ003_START);
    INFO_CLEARCHOICES(69812);
    INFO_ADDCHOICE(69812, "The quartermaster of the city guard would buy beer from you?", 69792);
    INFO_ADDCHOICE(69812, "Do you want to work with the Merchant's Guild?", 69794);
    INFO_ADDCHOICE(69812, "What about that brothel owner?", 69793);
    INFO_ADDCHOICE(69812, "Tell me something about Gerstand.", 69791);
    INFO_ADDCHOICE(69812, "Tell me something about Helga.", 69790);
    INFO_ADDCHOICE(69812, "No, I can handle it.", 69795);
}
...
func void DIA_TOMAS_REMINDME_INFO() {
    ...
    INFO_CLEARCHOICES(69815);
    INFO_ADDCHOICE(69815, DIALOG_BACK, 69818);
    INFO_ADDCHOICE(69815, "The quartermaster of the city guard would buy beer from you?", 69792);
    INFO_ADDCHOICE(69815, "Do you want to work with the Merchant's Guild?", 69794);
    INFO_ADDCHOICE(69815, "What about that brothel owner?", 69793);
    INFO_ADDCHOICE(69815, "Tell me something about Gerstand.", 69791);
    INFO_ADDCHOICE(69815, "Tell me something about Helga.", 69790);
}
...
var int CQ003_TOMAS_REFERENCEEXCHANGE;
func void DIA_TOMAS_CQ003DONE_INFO() {
    ...
    if ((CQ003_HAPPYCUSTOMER) <= (2)) {
        ...
        CREATEINVITEMS(SELF, 34203, CQ003_REWARD_TIER1);
    };
    if (((CQ003_HAPPYCUSTOMER) <= (8)) && ((CQ003_HAPPYCUSTOMER) >= (3))) {
        ...
        if ((LOG_GETSTATUS(MIS_Q202)) == (LOG_RUNNING)) {
            ...
            CREATEINVITEMS(SELF, 37163, 1);
            B_GIVEINVITEMS(SELF, OTHER, 37163, 1);
            CREATEINVITEMS(SELF, 34203, CQ003_REWARD_ALWAYS_TIER1);
        } else {
            CQ003_TOMAS_REFERENCEEXCHANGE = 1;
            CREATEINVITEMS(SELF, 34203, (CQ003_REWARD_ALWAYS_TIER1) + (CQ003_REWARD_TIER1));
            B_GIVEINVITEMS(SELF, OTHER, 34203, (CQ003_REWARD_ALWAYS_TIER1) + (CQ003_REWARD_TIER1));
        };
    ...
    if (((CQ003_HAPPYCUSTOMER) <= (10)) && ((CQ003_HAPPYCUSTOMER) >= (9))) {
        ...
        if ((LOG_GETSTATUS(MIS_Q202)) == (LOG_RUNNING)) {
            ...
            CREATEINVITEMS(SELF, 37163, 1);
            B_GIVEINVITEMS(SELF, OTHER, 37163, 1);
            CREATEINVITEMS(SELF, 34203, CQ003_REWARD_ALWAYS_TIER2);
        } else {
            CQ003_TOMAS_REFERENCEEXCHANGE = 2;
            CREATEINVITEMS(SELF, 34203, (CQ003_REWARD_ALWAYS_TIER2) + (CQ003_REWARD_TIER2));
            B_GIVEINVITEMS(SELF, OTHER, 34203, (CQ003_REWARD_ALWAYS_TIER2) + (CQ003_REWARD_TIER2));
        };
    ...
    if (((CQ003_HAPPYCUSTOMER) <= (13)) && ((CQ003_HAPPYCUSTOMER) >= (11))) {
        ...
        if ((LOG_GETSTATUS(MIS_Q202)) == (LOG_RUNNING)) {
            ...
            CREATEINVITEMS(SELF, 37163, 1);
            B_GIVEINVITEMS(SELF, OTHER, 37163, 1);
            CREATEINVITEMS(SELF, 34203, CQ003_REWARD_ALWAYS_TIER3);
        } else {
            CQ003_TOMAS_REFERENCEEXCHANGE = 3;
            CREATEINVITEMS(SELF, 34203, (CQ003_REWARD_ALWAYS_TIER3) + (CQ003_REWARD_TIER3));
            B_GIVEINVITEMS(SELF, OTHER, 34203, (CQ003_REWARD_ALWAYS_TIER3) + (CQ003_REWARD_TIER3));
        };
    ...
    if (((CQ003_HAPPYCUSTOMER) <= (16)) && ((CQ003_HAPPYCUSTOMER) >= (14))) {
        ...
        if ((LOG_GETSTATUS(MIS_Q202)) == (LOG_RUNNING)) {
            ...
            CREATEINVITEMS(SELF, 37163, 1);
            B_GIVEINVITEMS(SELF, OTHER, 37163, 1);
            CREATEINVITEMS(SELF, 34203, CQ003_REWARD_ALWAYS_TIER4);
        } else {
            CQ003_TOMAS_REFERENCEEXCHANGE = 4;
            CREATEINVITEMS(SELF, 34203, (CQ003_REWARD_ALWAYS_TIER4) + (CQ003_REWARD_TIER4));
            B_GIVEINVITEMS(SELF, OTHER, 34203, (CQ003_REWARD_ALWAYS_TIER4) + (CQ003_REWARD_TIER4));
        };
    ...
    if ((CQ003_HAPPYCUSTOMER) >= (17)) {
        ...
        if ((LOG_GETSTATUS(MIS_Q202)) == (LOG_RUNNING)) {
            ...
            CREATEINVITEMS(SELF, 37163, 1);
            B_GIVEINVITEMS(SELF, OTHER, 37163, 1);
            CREATEINVITEMS(SELF, 34203, CQ003_REWARD_ALWAYS_TIER5);
        } else {
            CQ003_TOMAS_REFERENCEEXCHANGE = 5;
            CREATEINVITEMS(SELF, 34203, (CQ003_REWARD_ALWAYS_TIER5) + (CQ003_REWARD_TIER5));
            B_GIVEINVITEMS(SELF, OTHER, 34203, (CQ003_REWARD_ALWAYS_TIER5) + (CQ003_REWARD_TIER5));
        };
...
func int DIA_TOMAS_REFERENCEEXCHANGE_CONDITION() {
    if (((((CQ003_TOMAS_REFERENCEEXCHANGE) >= (1)) && ((CQ003_TOMAS_REFERENCEEXCHANGE) < (6))) && ((LOG_GETSTATUS(MIS_Q202)) == (LOG_RUNNING))) && (NPC_KNOWSINFO(OTHER, 73577))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_TOMAS_REFERENCEEXCHANGE_CHOICES() {
    INFO_CLEARCHOICES(69823);
    if ((CQ003_TOMAS_REFERENCEEXCHANGE) == (1)) {
        INFO_ADDCHOICE(69823, DIALOG_GIVE30G, 69827);
    };
    if ((CQ003_TOMAS_REFERENCEEXCHANGE) == (2)) {
        INFO_ADDCHOICE(69823, DIALOG_GIVE50G, 69827);
    };
    if ((CQ003_TOMAS_REFERENCEEXCHANGE) == (3)) {
        INFO_ADDCHOICE(69823, DIALOG_GIVE65G, 69827);
    };
    if ((CQ003_TOMAS_REFERENCEEXCHANGE) == (4)) {
        INFO_ADDCHOICE(69823, DIALOG_GIVE80G, 69827);
    };
    if ((CQ003_TOMAS_REFERENCEEXCHANGE) == (5)) {
        INFO_ADDCHOICE(69823, DIALOG_GIVE100G, 69827);
    };
    INFO_ADDCHOICE(69823, DIALOG_BACK, 69828);
}
...
func void DIA_TOMAS_REFERENCEEXCHANGE_GIVEGOLD() {
    if (((((((CQ003_TOMAS_REFERENCEEXCHANGE) == (1)) && ((NPC_HASITEMS(OTHER, 34203)) >= (CQ003_REWARD_TIER1))) || (((CQ003_TOMAS_REFERENCEEXCHANGE) == (2)) && ((NPC_HASITEMS(OTHER, 34203)) >= (CQ003_REWARD_TIER2)))) || (((CQ003_TOMAS_REFERENCEEXCHANGE) == (3)) && ((NPC_HASITEMS(OTHER, 34203)) >= (CQ003_REWARD_TIER3)))) || (((CQ003_TOMAS_REFERENCEEXCHANGE) == (4)) && ((NPC_HASITEMS(OTHER, 34203)) >= (CQ003_REWARD_TIER4)))) || (((CQ003_TOMAS_REFERENCEEXCHANGE) == (5)) && ((NPC_HASITEMS(OTHER, 34203)) >= (CQ003_REWARD_TIER5)))) {
        if ((CQ003_TOMAS_REFERENCEEXCHANGE) == (1)) {
            ...
            B_GIVEINVITEMS(OTHER, SELF, 34203, CQ003_REWARD_TIER5);
            NPC_REMOVEINVITEMS(SELF, 34203, CQ003_REWARD_TIER5);
        };
...
func void DIA_TOMAS_SQ405_DEAL_INFO() {
    ...
    if ((SQ405_WEHAVEADEAL) == (1)) {
        ...
        CREATEINVITEMS(SELF, 34203, (SQ405_TOMASPRICE) * (2));
        B_GIVEINVITEMS(SELF, OTHER, 34203, (SQ405_TOMASPRICE) * (2));
    };
    if ((SQ405_WEHAVEADEAL) == (2)) {
        ...
        CREATEINVITEMS(SELF, 34203, (SQ405_TOMASPRICE) * (3));
        B_GIVEINVITEMS(SELF, OTHER, 34203, (SQ405_TOMASPRICE) * (3));
    };
    AI_OUTPUT(SELF, OTHER, "DIA_Tomas_SQ405_Deal_03_17");
    SQ405_DAYSUPPLY = WLD_GETDAY();
    CREATEINVITEMS(SELF, 36364, 5);
    B_GIVEINVITEMS(SELF, OTHER, 36364, 5);
}
...
func int DIA_TOMAS_SQ405_AFTERMATCH_CONDITION() {
    if (((SQ405_WEHAVEADEAL) == (2)) && (NPC_KNOWSINFO(OTHER, 69832))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_TOMAS_SQ405_AFTERMATCH_INFO() {
    ...
    if ((SQ405_WEEKMONEY) <= ((WLD_GETDAY()) - (7))) {
        ...
        SQ405_WEEKMONEY = WLD_GETDAY();
        CREATEINVITEMS(SELF, 34203, SQ405_TOMASPRICE);
    };
...
func void DIA_TOMAS_Q505_HELP_INFO() {
    ...
    AI_RESETFACEANI(SELF);
    CREATEINVITEMS(SELF, 37548, 1);
    B_GIVEINVITEMS(SELF, OTHER, 37548, 1);
}
...
func int DIA_TOMAS_AMBIENT_CONDITION() {
    if ((NPC_ISINSTATE(SELF, 61599)) && (NPC_KNOWSINFO(OTHER, 69796))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_TOMAS_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(69847);
    INFO_ADDCHOICE(69847, DIALOG_BACK, 69851);
    INFO_ADDCHOICE(69847, DIALOG_PICKPOCKET, 69850);
}

func void DIA_TOMAS_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (1)) {
        CREATEINVITEMS(SELF, 36364, 2);
        B_GIVEINVITEMS(SELF, OTHER, 36364, 2);
