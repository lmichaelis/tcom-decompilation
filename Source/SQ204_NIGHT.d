...
func void SQ204_NIGHT_START() {
    ...
    FADESCREENTOBLACKF(3, 92891, 1000);
}

func void SQ204_NIGHT_FADESCREEN() {
    FF_APPLYONCEEXT(92892, 1000, 9);
    TELEPORTNPCTOWP(53778, "PART11_INNOS");
    NPC_SETTRUEGUILD(VLK_3015_DETLOW, GIL_NONE);
    VLK_3015_DETLOW.GUILD = GIL_NONE;
    TELEPORTNPCTOWP(1819, "PART11_CUTSCENE_HERO");
    AI_PLAYANIBS(HERO, T_STAND_2_SIT, BS_SIT);
    WLD_INSERTNPC(50917, "PART11_DETLOW_WOLFATTACK_01");
    WLD_INSERTNPC(50920, "PART11_DETLOW_WOLFATTACK_02");
}

func void SQ204_NIGHT_FADESCREEN_CAMERA() {
    var int SQ204_CAMERACOUNT;
    ...
    if ((SQ204_CAMERACOUNT) == (9)) {
        ...
        TELEPORTNPCTOWP(50917, "PART11_MOB_11");
        TELEPORTNPCTOWP(50920, "PART11_MOB_11");
        HERO.AIVAR[4] = FALSE;
