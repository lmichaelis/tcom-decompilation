...
func int DIA_SMITH_NS56_NOITMISWORDRAW_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 68407)) && ((NPC_HASITEMS(OTHER, 34182)) < (2))) {
        if (!(NPC_KNOWSINFO(OTHER, 68413))) {
            if ((SMITHSTATUS) == (0)) {
                return TRUE;
            };
        };
...
func void DIA_SMITH_NS56_ITMISWORDRAW_INFO() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 34182, 2);
    SMITHSTATUS = 1;
...
func int DIA_SMITH_NS56_REWARD_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 68407)) && (NPC_KNOWSINFO(OTHER, 68413))) && (NPC_ISINSTATE(SELF, 61599))) {
        if ((SMITHSTATUS) == (1)) {
            return TRUE;
        };
    };
...
func void DIA_SMITH_NS56_REWARD_INFO() {
    ...
    if ((SELF.ATTRIBUTE[5]) >= (SELF.ATTRIBUTE[4])) {
        CREATEINVITEMS(SELF, 39482, 1);
    };
    CREATEINVITEMS(SELF, 39481, 1);
    B_GIVEINVITEMS(SELF, OTHER, 39481, 1);
...
func int DIA_SMITH_NS56_AFTERAFTER_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 68407)) && (NPC_ISINSTATE(SELF, 61599))) {
        if ((SMITHSTATUS) == (2)) {
            return TRUE;
        };
    };
