var int BODYGUARD_GOAWAY;
var int BODYGUARD_FIST;
...
func void DIA_BODYGUARD01_HELLO_INFO() {
    ...
    INFO_CLEARCHOICES(83292);
    if ((NPC_HASITEMS(OTHER, 34203)) >= (1)) {
        INFO_ADDCHOICE(83292, "(Show a gold coin)", 83296);
    };
    if ((NPC_HASITEMS(OTHER, 34204)) >= (1)) {
        INFO_ADDCHOICE(83292, "(Show an old coin)", 83297);
    };
    if ((NPC_HASITEMS(OTHER, 37248)) >= (1)) {
        INFO_ADDCHOICE(83292, "(Show the strange coin)", 83298);
    };
    INFO_ADDCHOICE(83292, "(Show fist - Provoke)", 83299);
}
...
func int DIA_BODYGUARD01_GOAWAY_CONDITION() {
    if (((BODYGUARD_GOAWAY) == (TRUE)) && (NPC_ISINSTATE(SELF, 61599))) {
...
func void DIA_BODYGUARD_FIGHT_INFO() {
    ...
    INFO_CLEARCHOICES(83304);
    INFO_ADDCHOICE(83304, "Yes, it's me, your worst nightmare.", 83308);
    INFO_ADDCHOICE(83304, "Have you been looking for me?", 83309);
}
