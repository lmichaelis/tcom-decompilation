...
func void DIA_VOLKERGUARD_YOUNG_SQ505_STOP_INFO() {
    ...
    INFO_CLEARCHOICES(0x10b13);
    INFO_ADDCHOICE(0x10b13, "How old are you? Aren't you too young to be a mercenary?", 0x10b16);
}
...
func void DIA_VOLKERGUARD_YOUNG_SQ505_STOP_OLD() {
    ...
    INFO_CLEARCHOICES(0x10b13);
    INFO_ADDCHOICE(0x10b13, "You made a mistake coming here!", 0x10b1b);
    INFO_ADDCHOICE(0x10b13, "Relax, I don't want to hurt you!", 0x10b1a);
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (SQ505_YOUNGVOLKERGUARD)) {
        INFO_ADDCHOICE(0x10b13, "You must be doing this for the gold, huh? (Bribe 2000 GP)", 0x10b17);
    };
}
