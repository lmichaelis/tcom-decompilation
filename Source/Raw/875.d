var int SQ221_LURKERNEST_01 = 0;
var int SQ221_LURKERNEST_02 = 0;
var int SQ221_LURKERNEST_03 = 0;
var int SQ221_LURKERNEST_04 = 0;
var int SQ221_LURKERNEST_05 = 0;
var int SQ221_ENTRYGIVEN = 0;
...
func void LURKERNEST_S1() {
    ...
    if ((HLP_GETINSTANCEID(SELF)) == (HLP_GETINSTANCEID(HER))) {
        ...
        if (HLP_STRCMP(NPC_GETNEARESTWP(HERO), "PART13_SQ112_LURKERNEST_02")) {
        ...
        if (HLP_STRCMP(NPC_GETNEARESTWP(HERO), "PART13_SQ112_LURKERNEST_03")) {
        ...
        if (HLP_STRCMP(NPC_GETNEARESTWP(HERO), "PART13_SQ112_LURKERNEST_04")) {
        ...
        if (HLP_STRCMP(NPC_GETNEARESTWP(HERO), "PART13_SQ112_LURKERNEST_05")) {
...
instance LURKERNEST_S1.HER(C_NPC)
...
func void SQ112_REMOVE_LURKERNEST() {
    if ((SQ221_LURKERNEST_01) == (1)) {
        if ((SQ221_LURKERNEST_01_COUNT) == (0)) {
            ...
            PRINTD("Skoñczy³em - SQ112_REMOVE_LURKERNEST");
...
var int SQ112_REMOVE_LURKERNEST.SQ221_LURKERNEST_01_COUNT = 0;
instance SQ112_REMOVE_LURKERNEST.MOVER1(ZCMOVER)
instance SQ112_REMOVE_LURKERNEST.MOVER2(ZCMOVER)
var int SQ112_REMOVE_LURKERNEST.MOVPTR1 = 0;
var int SQ112_REMOVE_LURKERNEST.MOVPTR2 = 0;
var int SQ112_REMOVE_LURKERNEST.SQ221_LURKERNEST_02_COUNT = 0;
instance SQ112_REMOVE_LURKERNEST.MOVER3(ZCMOVER)
instance SQ112_REMOVE_LURKERNEST.MOVER4(ZCMOVER)
var int SQ112_REMOVE_LURKERNEST.MOVPTR3 = 0;
var int SQ112_REMOVE_LURKERNEST.MOVPTR4 = 0;
var int SQ112_REMOVE_LURKERNEST.SQ221_LURKERNEST_03_COUNT = 0;
instance SQ112_REMOVE_LURKERNEST.MOVER5(ZCMOVER)
instance SQ112_REMOVE_LURKERNEST.MOVER6(ZCMOVER)
var int SQ112_REMOVE_LURKERNEST.MOVPTR5 = 0;
var int SQ112_REMOVE_LURKERNEST.MOVPTR6 = 0;
var int SQ112_REMOVE_LURKERNEST.SQ221_LURKERNEST_04_COUNT = 0;
instance SQ112_REMOVE_LURKERNEST.MOVER7(ZCMOVER)
instance SQ112_REMOVE_LURKERNEST.MOVER8(ZCMOVER)
var int SQ112_REMOVE_LURKERNEST.MOVPTR7 = 0;
var int SQ112_REMOVE_LURKERNEST.MOVPTR8 = 0;
var int SQ112_REMOVE_LURKERNEST.SQ221_LURKERNEST_05_COUNT = 0;
instance SQ112_REMOVE_LURKERNEST.MOVER9(ZCMOVER)
instance SQ112_REMOVE_LURKERNEST.MOVER10(ZCMOVER)
var int SQ112_REMOVE_LURKERNEST.MOVPTR9 = 0;
var int SQ112_REMOVE_LURKERNEST.MOVPTR10 = 0;
