...
func int DIA_NELSON_BOW_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x13ca4)) {
        return TRUE;
    };
...
func void DIA_NELSON_BOW_INFO() {
    ...
    INFO_CLEARCHOICES(0x13ca7);
    INFO_ADDCHOICE(0x13ca7, "I have to think about it.", 0x13cb5);
    INFO_ADDCHOICE(0x13ca7, "Well... why not?", 0x13cb4);
}

var int NELSON_QUEST_BUY = 0;
var int NELSON_QUEST_TALK = 0;
var int NELSON_QUEST_WHAT = 0;
var int NELSON_TAKEQUEST = 0;
func void DIA_NELSON_QUEST_CHOICES() {
    INFO_CLEARCHOICES(0x13cb6);
    if ((NELSON_QUEST_WHAT) == (FALSE)) {
        INFO_ADDCHOICE(0x13cb6, "So what do you want from me?", 0x13cb2);
    };
    INFO_ADDCHOICE(0x13cb6, DIALOG_BACK, 0x13cb3);
    if ((NELSON_QUEST_TALK) == (FALSE)) {
        INFO_ADDCHOICE(0x13cb6, "Are you sure that your father cannot be reasoned with?", 0x13cb1);
    };
    if ((NELSON_QUEST_BUY) == (FALSE)) {
        INFO_ADDCHOICE(0x13cb6, "Can't you just buy that horn?", 0x13cb0);
    };
    INFO_CLEARCHOICES(0x13ca7);
    if ((NELSON_QUEST_WHAT) == (FALSE)) {
        INFO_ADDCHOICE(0x13ca7, "So what do you want from me?", 0x13cb2);
    };
    INFO_ADDCHOICE(0x13ca7, DIALOG_ENDE, 0x13cb3);
    if ((NELSON_QUEST_TALK) == (FALSE)) {
        INFO_ADDCHOICE(0x13ca7, "Are you sure that your father cannot be reasoned with?", 0x13cb1);
    };
    if ((NELSON_QUEST_BUY) == (FALSE)) {
        INFO_ADDCHOICE(0x13ca7, "Can't you just buy that horn?", 0x13cb0);
    };
}
...
func int DIA_NELSON_TAKEQUEST_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x13ca7)) && ((NELSON_TAKEQUEST) == (TRUE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_NELSON_LETSHUNT_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ402)) == (LOG_RUNNING)) && (NPC_ISINSTATE(SELF, 0xf09f))) {
...
func void DIA_NELSON_LETSHUNT_INFO() {
    if ((SQ402_NELSON_READYFORHUNT) == (1)) {
        if ((NPC_GETDISTTOWP(SELF, "PART15_PATH_39")) <= (0x7d0)) {
            AI_OUTPUT(OTHER, SELF, "DIA_Nelson_LetsHunt_15_01");
            AI_OUTPUT(SELF, OTHER, "DIA_Nelson_LetsHunt_03_02");
            INFO_CLEARCHOICES(0x13cb9);
            INFO_ADDCHOICE(0x13cb9, "Yes. Lead the way.", 0x13cbc);
            INFO_ADDCHOICE(0x13cb9, "I need to gather my strength.", 0x13cbd);
        } else {
...
func void DIA_NELSON_LETSHUNT_YES() {
    ...
    WLD_INSERTNPC(0xc662, "PART10_FOREST_SHADOWBEAST");
...
func void DIA_NELSON_NEARSHADOW_INFO() {
    ...
    INFO_CLEARCHOICES(0x13cbe);
    INFO_ADDCHOICE(0x13cbe, "Neither do I. We better back off.", 0x13cc2);
    INFO_ADDCHOICE(0x13cbe, "We can't retreat now. Stay here and cover me.", 0x13cc1);
}

func void DIA_NELSON_NEARSHADOW_NO() {
    B_HEALNPC_SELF();
    SELF.FLAGS = 0;
    SELF.ATTRIBUTE[0] = 0x9c4;
    SELF.ATTRIBUTE[1] = 0x9c4;
...
func int DIA_NELSON_STOPFOLLOW_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x13cbe)) && ((LOG_GETSTATUS(MIS_SQ402)) == (LOG_RUNNING))) && ((SQ402_NELSON_READYFORHUNT) == (6))) {
        if ((NPC_GETDISTTONPC(HERO, SHADOWBEAST_NELSON)) >= (0x1130)) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
...
var int NELSON_AFTERHUNT = 0;
var int NELSON_AFTERHUNT_DAY = 0;
func void DIA_NELSON_AFTERFIGHT_INFO() {
    ...
    CREATEINVITEMS(SELF, 0x859b, SQ402_REWARD_V2);
    B_GIVEINVITEMS(SELF, OTHER, 0x859b, SQ402_REWARD_V2);
...
var int NELSON_GOODSTUDENT = 0;
var int NELSON_GOODSTUDENT_GIFT = 0;
var int NELSON_NOMORE = 0;
var string NELSON_PRINTS = "";
var int NELSON_CURRENTBLEVEL = 0;
...
func int DIA_NELSON_TEACH_CONDITION() {
    if ((((NELSON_CANTEACH) == (TRUE)) && (NPC_KNOWSINFO(OTHER, 0x13cce))) && ((NELSON_NOMORE) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_NELSON_TEACH_CHOICES() {
    ...
    INFO_CLEARCHOICES(0x13cd6);
    INFO_ADDCHOICE(0x13cd6, DIALOG_BACK, 0x13cdb);
    INFO_ADDCHOICE(0x13cd6, B_BUILDLEARNSTRING2(PRINT_LEARNBOW1, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_BOW, 1), NELSON_GOLDCOST), 0x13cdc);
    INFO_ADDCHOICE(0x13cd6, B_BUILDLEARNSTRING2(PRINT_LEARNBOW5, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_BOW, 5), (NELSON_GOLDCOST) * (5)), 0x13cdd);
...
var int DIA_NELSON_TEACH_CHOICES.NELSON_GOLDCOST = 0;
...
func void DIA_NELSON_TEACH_BOW1() {
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (NELSON_PAYMENT1)) {
        if ((NELSON_CURRENTBLEVEL) < (OTHER.AIVAR[86])) {
            SND_PLAY(GELDBEUTEL);
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, NELSON_PAYMENT1);
            NELSON_GOODSTUDENT += 1;
            NPC_REMOVEINVITEMS(SELF, 0x859b, NELSON_PAYMENT1);
        };
...
func void DIA_NELSON_TEACH_BOW5() {
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (NELSON_PAYMENT5)) {
        if ((NELSON_CURRENTBLEVEL) < (OTHER.AIVAR[86])) {
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, NELSON_PAYMENT5);
            SND_PLAY(GELDBEUTEL);
            NELSON_GOODSTUDENT += 5;
            NPC_REMOVEINVITEMS(SELF, 0x859b, NELSON_PAYMENT5);
        };
...
func void DIA_NELSON_AMBIENT_WL_INFO() {
    ...
    if (!(NPC_KNOWSINFO(OTHER, 0x13ccb))) {
...
func int DIA_NELSON_HUNTING_BASE_CONDITION() {
    if ((((NELSON_CANTEACH) == (TRUE)) && (NPC_KNOWSINFO(OTHER, 0x13cce))) && ((PLAYER_TALENT_TAKEANIMALTROPHY[2]) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_NELSON_HUNTING_BASE_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (NELSON_BASETROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[2]) == (TRUE)) {
            ...
            NPC_REMOVEINVITEMS(SELF, 0x859b, NELSON_BASETROPHY);
...
func void DIA_NELSON_HUNTING_SPECIAL_CHOICES() {
    ...
    INFO_ADDCHOICE(0x13ce4, DIALOG_BACK, 0x13ce8);
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[7]) == (FALSE)) {
        INFO_ADDCHOICE(0x13ce4, B_BUILDLEARNSTRING2(PRINT_TEACHBFSTING, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_BFSTING), NELSON_STINGSTROPHY), 0x13ce9);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[8]) == (FALSE)) {
        INFO_ADDCHOICE(0x13ce4, B_BUILDLEARNSTRING2(PRINT_TEACHMANDIBLES, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_MANDIBLES), NELSON_MANDIBLESTROPHY), 0x13cea);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[6]) == (FALSE)) {
        INFO_ADDCHOICE(0x13ce4, B_BUILDLEARNSTRING2(PRINT_TEACHBFWING, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_BFWING), NELSON_WINGSTROPHY), 0x13ceb);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[15]) == (FALSE)) {
        INFO_ADDCHOICE(0x13ce4, B_BUILDLEARNSTRING2(PRINT_TEACHFATS, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_FATS), NELSON_FATSTROPHY), 0x13ced);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[17]) == (FALSE)) {
        INFO_ADDCHOICE(0x13ce4, B_BUILDLEARNSTRING2(PRINT_TEACHSHELLS, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_SHELLS), NELSON_SHELLSTROPHY), 0x13cec);
    };
}
...
func void DIA_NELSON_HUNTING_SPECIAL_BFSTING() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (NELSON_STINGSTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[7]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, NELSON_STINGSTROPHY);
...
func void DIA_NELSON_HUNTING_SPECIAL_MANDIBLES() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (NELSON_MANDIBLESTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[8]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, NELSON_MANDIBLESTROPHY);
...
func void DIA_NELSON_HUNTING_SPECIAL_BFWING() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (NELSON_WINGSTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[6]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, NELSON_WINGSTROPHY);
...
func void DIA_NELSON_HUNTING_SPECIAL_SHELLS() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (NELSON_SHELLSTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[17]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, NELSON_SHELLSTROPHY);
...
func void DIA_NELSON_HUNTING_SPECIAL_FATS() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (NELSON_FATSTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[15]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, NELSON_FATSTROPHY);
...
func void DIA_NELSON_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x13cee);
    INFO_ADDCHOICE(0x13cee, DIALOG_BACK, 0x13cf2);
    INFO_ADDCHOICE(0x13cee, DIALOG_PICKPOCKET, 0x13cf1);
}
