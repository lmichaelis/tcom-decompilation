...
func void DIA_13356_FARMER_NICETOMEATYOU_INFO() {
    ...
    INFO_CLEARCHOICES(0x15601);
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (EVENT_ALMOSTFREEMEAT)) {
        INFO_ADDCHOICE(0x15601, "I'll take that meat.", 0x15604);
    };
    INFO_ADDCHOICE(0x15601, "Better share with your neighbors.", 0x15605);
}

func void DIA_13356_FARMER_MEATYES() {
    AI_OUTPUT(OTHER, SELF, "DIA_13356_Farmer_MeatYes_15_01");
    B_GIVEINVITEMS(OTHER, SELF, 0x859b, EVENT_ALMOSTFREEMEAT);
    AI_OUTPUT(SELF, OTHER, "DIA_13356_Farmer_MeatYes_03_02");
    B_GIVEPLAYERXP(XP_SECRET_ENIGMATICWANDERER_WRONGWAY);
    CREATEINVITEMS(SELF, 0x8e3b, 6);
    B_GIVEINVITEMS(SELF, OTHER, 0x8e3b, 6);
    AI_STOPPROCESSINFOS(SELF);
}
...
func int DIA_13356_FARMER_MYPOORSHEEP_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x15601)) && (NPC_ISINSTATE(SELF, 0xf09f))) {
        return TRUE;
    };
