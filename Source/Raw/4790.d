func void EVENTSMANAGER_SQ313() {
    ...
    if ((SQ313_HUUGCUTSCENEENABLE) == (1)) {
        ...
        FF_APPLYONCEEXT(0xf3d3, 75, 4);
        HERO.AIVAR[4] = TRUE;
    };
    if ((SQ313_HUUGESCAPE) == (1)) {
        if ((((SQ313_HUUGEVENT) == (1)) && ((NPC_GETDISTTOWP(NONE_1004_HUUG, "HARBOUR_SQ313_HUUG")) <= (500))) && ((NPC_ISINSTATE(NONE_1004_HUUG, 0xf09f)) == (FALSE))) {
            B_STARTOTHERROUTINE(NONE_1004_HUUG, "SQ313_FLEE_TIRED_01");
            NPC_REFRESH(NONE_1004_HUUG);
            PRINTD("Huug dobieg³");
            SQ313_HUUGESCAPE = 2;
        } else if ((((SQ313_HUUGEVENT) == (2)) && ((NPC_GETDISTTOWP(NONE_1004_HUUG, "HARBOUR_SQ313_HUUG_02")) <= (500))) && ((NPC_ISINSTATE(NONE_1004_HUUG, 0xf09f)) == (FALSE))) {
        ...
        if ((SQ313_APPLYSPRINTFORMARVIN) == (0)) {
            if ((NPC_GETDISTTOWP(HERO, "SLUMS_PATH_244")) <= (400)) {
                ...
                MDL_APPLYOVERLAYMDSTIMED(HERO, HUMANSSPRINTMDS, 0x9c40);
            };
        };
    };
    if ((SQ313_HUUGEVENT) == (1)) {
        if ((SQ313_FIGHTHUUG) == (1)) {
            if ((((((NPC_ISDEAD(NONE_1004_HUUG)) && (NPC_ISDEAD(NONE_6255_THUG))) && (NPC_ISDEAD(NONE_6256_THUG))) && (NPC_ISDEAD(NONE_6257_THUG))) && (NPC_ISDEAD(NONE_6258_THUG))) && ((NPC_ISINSTATE(KDF_6404_TRIMEGISTO, 0xf09f)) == (FALSE))) {
                SQ313_FIGHTHUUG = 2;
