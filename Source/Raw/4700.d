func void EVENTSMANAGER_Q305() {
    ...
    if ((Q305_SMUGGLERCHANGERTN) == (FALSE)) {
        if ((NPC_GETDISTTONPC(HERO, PIR_1320_SMUGGLER_ARCHOLOS)) <= (0x7d0)) {
    ...
    if ((Q305_JAVADFIGHT) == (1)) {
        if (NPC_ISINSTATE(NONE_6331_JAVAD, 0xf0a3)) {
            ...
            MDL_STARTFACEANI(NONE_6331_JAVAD, S_NEUTRAL, 0x3f800000, -1082130432);
            Q305_JAVADFIGHT = 2;
...
var int EVENTSMANAGER_Q305.Q305_ENOUGHSTUFF = 0;
var int EVENTSMANAGER_Q305.Q305_SMUGGLERCHANGERTN = 0;
var int EVENTSMANAGER_Q305.Q305_COUNTORE = 0;
var int EVENTSMANAGER_Q305.Q305_COUNTSTEEL = 0;
var int EVENTSMANAGER_Q305.Q305_COUNTBLOODPOCKET = 0;
var int EVENTSMANAGER_Q305.Q305_COUNTJAVADCHEST = 0;
var int EVENTSMANAGER_Q305.Q305_COUNTGOBLINCHEST = 0;
var int EVENTSMANAGER_Q305.Q305_COUNTHARRISWORD = 0;
