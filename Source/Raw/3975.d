...
func int DIA_NIKOLAS_HELLO_CONDITION() {
    if ((NPC_ISINSTATE(SELF, 0xf09f)) && (NPC_KNOWSINFO(OTHER, 0x12d49))) {
        return TRUE;
    };
...
func void DIA_NIKOLAS_WHAT_INFO() {
    ...
    INFO_CLEARCHOICES(0x12d49);
    INFO_ADDCHOICE(0x12d49, "I apologize.", 0x12d4c);
    INFO_ADDCHOICE(0x12d49, "Kiss my ass!", 0x12d4d);
}
...
func int DIA_NIKOLAS_SCHOLAR_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x12d49)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_NIKOLAS_WORK_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x12d4e)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_NIKOLAS_TRADE_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x12d51)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_NIKOLAS_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x12d5a);
    INFO_ADDCHOICE(0x12d5a, DIALOG_BACK, 0x12d5e);
    INFO_ADDCHOICE(0x12d5a, DIALOG_PICKPOCKET, 0x12d5d);
}
