...
func void KQ406_FINISHCUTSCENE_START() {
    ...
    TELEPORTNPCTOWP(0xd543, MIL_13680_ANSKAR.WP);
    TELEPORTNPCTOWP(0xd1d7, MIL_13382_HUXLAY.WP);
    TELEPORTNPCTOWP(0x71b, "PARTM5_CITYHALL_38");
    ...
    KQ406_FINISHCUTSCENE_WAIT();
    AI_FUNCTION(NONE_11068_GRAYSON, 0x168d7);
    KQ406_FINISHCUTSCENE_WAIT();
    ...
    AI_FUNCTION(NONE_11068_GRAYSON, 0x168d8);
    ...
    KQ406_FINISHCUTSCENE_WAIT();
    AI_FUNCTION(NONE_11068_GRAYSON, 0x168d9);
    ...
    AI_FUNCTION(NONE_11068_GRAYSON, 0x168da);
    ...
    AI_FUNCTION(NONE_11068_GRAYSON, 0x168d6);
}

func void KQ406_FINISHCUTSCENE_END() {
    FF_APPLYONCEEXT(0x87e1, 75, 4);
    HERO.AIVAR[4] = FALSE;
