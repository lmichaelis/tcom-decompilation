...
instance BAR_SETPROMILLE.B(_BAR)
...
instance _BAR_MOVETO_INTERNAL.B(_BAR)
instance _BAR_MOVETO_INTERNAL.V(ZCVIEW)
...
instance _BAR_RESIZE_INTERNAL.B(_BAR)
instance _BAR_RESIZE_INTERNAL.V0(ZCVIEW)
var int _BAR_RESIZE_INTERNAL.VCENTERX = 0;
var int _BAR_RESIZE_INTERNAL.VCENTERY = 0;
instance _BAR_RESIZE_INTERNAL.V1(ZCVIEW)
var int _BAR_RESIZE_INTERNAL.BARDIFFX = 0;
var int _BAR_RESIZE_INTERNAL.BARDIFFY = 0;
var int _BAR_RESIZE_INTERNAL.SCALEX = 0;
var int _BAR_RESIZE_INTERNAL.SCALEY = 0;
var int _BAR_RESIZE_INTERNAL.BARWIDTH = 0;
var int _BAR_RESIZE_INTERNAL.BARX = 0;
var int _BAR_RESIZE_INTERNAL.CURVAL = 0;
var int _BAR_RESIZE_INTERNAL.BARHEIGHT = 0;
var int _BAR_RESIZE_INTERNAL.BARY = 0;
...
var int BAR_GETANCHORXY.ANCHOR = 0;
...
instance BAR_GETANCHOR.B(_BAR)
instance BAR_GETANCHOR.V(ZCVIEW)
var int BAR_GETANCHOR.X = 0;
var int BAR_GETANCHOR.Y = 0;
...
instance BAR_GETINTERFACESCALING.HPBAR(OCVIEWSTATUSBAR)
...
instance BAR_SCALEEXT.B(_BAR)
instance BAR_SCALEEXT.V(ZCVIEW)
var int BAR_SCALEEXT.X = 0;
var int BAR_SCALEEXT.Y = 0;
var int BAR_SCALEEXT.W = 0;
var int BAR_SCALEEXT.H = 0;
var int BAR_SCALEEXT.ANCHOR = 0;
var int BAR_SCALEEXT.PIXELSFROMLEFT = 0;
var int BAR_SCALEEXT.PIXELSFROMRIGHT = 0;
var int BAR_SCALEEXT.W2 = 0;
var int BAR_SCALEEXT.PIXELSFROMCENTER = 0;
var int BAR_SCALEEXT.PIXELSFROMTOP = 0;
var int BAR_SCALEEXT.PIXELSFROMBOTTOM = 0;
var int BAR_SCALEEXT.H2 = 0;
var int BAR_SCALEEXT.PIXELSFROMMIDDLE = 0;
...
instance BAR_RESIZE.B(_BAR)
var int BAR_RESIZE.SCALE = 0;
...
instance BAR_SETBACKTEXTURE.B(_BAR)
...
instance BAR_SETBARTEXTURE.B(_BAR)
...
instance _BAR_UPDATESHOW.B(_BAR)
instance _BAR_UPDATESHOW.V(ZCVIEW)
...
instance _BAR_UPDATEHIDE.B(_BAR)
func void _BAR_UPDATE() {
    STATUS = _BAR_PLAYERSTATUS();
    if ((_BAR_UPDATE_STATUS) != (STATUS)) {
        _BAR_UPDATE_STATUS = STATUS;
        if (STATUS) {
            FOREACHHNDL(0x2ddf, 0x2e62);
        } else {
            FOREACHHNDL(0x2ddf, 0x2e66);
        };
    };
}

var int _BAR_UPDATE.STATUS = 0;
...
var int BAR_CREATE.PTR = 0;
instance BAR_CREATE.BU(BAR)
var int BAR_CREATE.BH = 0;
instance BAR_CREATE.B(_BAR)
var int BAR_CREATE.BUHH = 0;
var int BAR_CREATE.BUWH = 0;
var int BAR_CREATE.AH = 0;
var int BAR_CREATE.AW = 0;
instance BAR_CREATE.V(ZCVIEW)
var int _BAR_SCREEN_X = 0;
var int _BAR_SCREEN_Y = 0;
var int _BAR_SCALING = 0;
