...
var int LIAM_TELLMEABOUT_HOLDWIG = 0;
var int LIAM_TELLMEABOUT_ANDREAS = 0;
func int DIA_LIAM_TELLMEABOUT_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x13ae1)) {
        if (((((LOG_GETSTATUS(MIS_SQ225)) != (LOG_SUCCESS)) && ((LOG_GETSTATUS(MIS_Q308)) < (1))) && ((SQ225_FIGHTINVINEYARD_HOLDWIG) == (0))) && ((SQ225_FIGHTINVINEYARD) == (0))) {
...
func void DIA_LIAM_TELLMEABOUT_CHOICES() {
    INFO_CLEARCHOICES(0x13ae4);
    INFO_ADDCHOICE(0x13ae4, DIALOG_BACK, 0x13aea);
    if ((LIAM_TELLMEABOUT_HOLDWIG) == (FALSE)) {
        INFO_ADDCHOICE(0x13ae4, "Holdwig.", 0x13aec);
    };
    if ((LIAM_TELLMEABOUT_ANDREAS) == (FALSE)) {
        INFO_ADDCHOICE(0x13ae4, "Andreas.", 0x13aeb);
    };
}
...
var int LIAM_AMBIENT_OPTION1 = 0;
var int LIAM_AMBIENT_OPTION2 = 0;
var int LIAM_AMBIENT_OPTION3 = 0;
...
var int LIAM_TELLMEMORE_HOWMUCH = 0;
var int LIAM_TELLMEMORE_WHAT = 0;
var int LIAM_TELLMEMORE_CHANCE = 0;
var int LIAM_TELLMEMORE_DEATH = 0;
func int DIA_LIAM_TELLMEMORE_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_SQ225)) != (LOG_SUCCESS)) && ((LOG_GETSTATUS(MIS_Q308)) < (1))) && ((SQ225_FIGHTINVINEYARD_HOLDWIG) == (0))) && ((SQ225_FIGHTINVINEYARD) == (0))) {
        if ((NPC_KNOWSINFO(OTHER, 0x13af3)) && ((SQ225_MARVINKNOWABOUTLIAM) == (1))) {
            if (((((LIAM_TELLMEMORE_DEATH) == (FALSE)) || ((LIAM_TELLMEMORE_CHANCE) == (FALSE))) || ((LIAM_TELLMEMORE_WHAT) == (FALSE))) || ((LIAM_TELLMEMORE_HOWMUCH) == (FALSE))) {
                if (((SQ225_GERHARD_WAITFORACTION) == (0)) && ((NPC_KNOWSINFO(OTHER, 0xfe93)) == (FALSE))) {
                    return TRUE;
                };
            };
        };
...
func void DIA_LIAM_TELLMEMORE_CHOICES() {
    ...
    INFO_CLEARCHOICES(0x13af6);
    INFO_ADDCHOICE(0x13af6, DIALOG_BACK, 0x13afe);
    if ((LIAM_TELLMEMORE_DEATH) == (FALSE)) {
        INFO_ADDCHOICE(0x13af6, "Can you tell me about Valerio's death?", 0x13b02);
    };
    if ((LIAM_TELLMEMORE_CHANCE) == (FALSE)) {
        INFO_ADDCHOICE(0x13af6, "Any chance of the brothers reconciling?", 0x13b01);
    };
    if ((LIAM_TELLMEMORE_WHAT) == (FALSE)) {
        INFO_ADDCHOICE(0x13af6, "What was it that drove the brothers apart?", 0x13b00);
    };
    if ((LIAM_TELLMEMORE_HOWMUCH) == (FALSE)) {
        INFO_ADDCHOICE(0x13af6, "Do you know a lot about Valerio's sons?", 0x13aff);
    };
}
...
func int DIA_LIAM_SQ225_OPINION_CONDITION() {
    if (((((((LOG_GETSTATUS(MIS_SQ225)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0xfe77))) && ((SQ225_MARVINKNOWABOUTLIAM) == (0))) && ((NPC_KNOWSINFO(OTHER, 0x12097)) == (FALSE))) && ((NPC_KNOWSINFO(OTHER, 0xfe93)) == (FALSE))) && ((SQ225_FIGHTINVINEYARD_BLOCKFASTTRAVEL) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LIAM_SQ225_HELP_CONDITION() {
    if ((((((LOG_GETSTATUS(MIS_SQ225)) == (LOG_RUNNING)) && ((SQ225_MARVINKNOWABOUTLIAM) == (2))) && ((NPC_KNOWSINFO(OTHER, 0x12097)) == (FALSE))) && ((NPC_KNOWSINFO(OTHER, 0xfe93)) == (FALSE))) && ((SQ225_FIGHTINVINEYARD_BLOCKFASTTRAVEL) == (0))) {
...
var int LIAM_SQ225_TESTAMENTWAIT_DAY = 0;
var int LIAM_SQ225_TESTAMENTWAIT = 0;
...
func int DIA_LIAM_SQ225_TESTAMENTREADY_CONDITION() {
    if (((((((LOG_GETSTATUS(MIS_SQ225)) == (LOG_RUNNING)) && ((LIAM_SQ225_TESTAMENTWAIT) == (1))) && ((LIAM_SQ225_TESTAMENTWAIT_DAY) <= ((WLD_GETDAY()) - (1)))) && ((NPC_KNOWSINFO(OTHER, 0x12097)) == (FALSE))) && ((NPC_KNOWSINFO(OTHER, 0xfe93)) == (FALSE))) && ((SQ225_FIGHTINVINEYARD_BLOCKFASTTRAVEL) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LIAM_SQ225_AFTERFIRECART_CONDITION() {
    if (((((((LOG_GETSTATUS(MIS_SQ225)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x11a13))) && ((SQ225_ANDERASWAY_FAILED) == (TRUE))) && ((NPC_KNOWSINFO(OTHER, 0x12097)) == (FALSE))) && ((NPC_KNOWSINFO(OTHER, 0xfe93)) == (FALSE))) && ((SQ225_FIGHTINVINEYARD_BLOCKFASTTRAVEL) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LIAM_SQ225_GOTTESTAMENT_CONDITION() {
    if ((((((LOG_GETSTATUS(MIS_SQ225)) == (LOG_RUNNING)) && ((SQ225_VALERIOTESTAMENT) == (1))) && ((NPC_KNOWSINFO(OTHER, 0x12097)) == (FALSE))) && ((NPC_KNOWSINFO(OTHER, 0xfe93)) == (FALSE))) && ((SQ225_FIGHTINVINEYARD_BLOCKFASTTRAVEL) == (0))) {
        if (((NPC_HASITEMS(OTHER, 0x90e8)) >= (1)) && ((NPC_HASITEMS(OTHER, 0x90df)) >= (1))) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
...
func void DIA_LIAM_SQ225_GOTTESTAMENT_INFO() {
    ...
    B_STANDUP();
    NPC_REMOVEINVITEMS(SELF, 0x90e8, 1);
    B_USEFAKESCROLL();
    B_GIVEINVITEMS(OTHER, SELF, 0x90e8, 1);
    AI_STARTFACEANI(SELF, S_SMILE, 1, -(1));
...
func int DIA_LIAM_SQ116_ASKHOLDWIG_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ116)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0xfd7b))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_LIAM_SQ213_INFO() {
    ...
    INFO_CLEARCHOICES(0x13b1a);
    INFO_ADDCHOICE(0x13b1a, "Should I know anything more about these snappers?", 0x13b1d);
}

func void DIA_LIAM_SQ213_SNAPPERS() {
    FF_APPLYONCEEXTGT(0xf45b, 0, -(1));
...
func int DIA_LIAM_SNAPPERS_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x13b1a)) && ((LOG_GETSTATUS(MIS_SQ213)) == (LOG_RUNNING))) && ((SQ213_LIAMSNAPPERPROBLEMDONE) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LIAM_SQ213VINE_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x13b21)) && ((LOG_GETSTATUS(MIS_SQ213)) == (LOG_RUNNING))) {
...
func int DIA_LIAM_SQ213AFTERWORK_CONDITION() {
    if ((((NPC_KNOWSINFO(OTHER, 0x13b24)) && ((LOG_GETSTATUS(MIS_SQ213)) == (LOG_RUNNING))) && ((SQ213_VINECOLLECT_DONE) == (1))) && ((SQ213_EVERYTHINGREADY) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LIAM_QM401_CALM_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_QM401)) == (LOG_RUNNING)) && (NPC_ISINSTATE(SELF, 0xf09f))) && ((QM401_BEATUPBERTO) == (2))) && ((QM401_FIGHTWITHRENEGADESCHECK) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LIAM_SQ126_START_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x13ae1)) && ((LOG_GETSTATUS(MIS_SQ225)) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LIAM_SQ126_TAKEJOB_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x13b2d)) && ((LOG_GETSTATUS(MIS_SQ225)) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LIAM_SQ126_WAKEUP_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ126)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x13aac))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_LIAM_SQ126_FINISH_V1_INFO() {
    ...
    AI_RESETFACEANI(SELF);
    CREATEINVITEMS(SELF, 0x86d2, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x86d2, 1);
...
func void DIA_LIAM_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x13b3f);
    INFO_ADDCHOICE(0x13b3f, DIALOG_BACK, 0x13b43);
    INFO_ADDCHOICE(0x13b3f, DIALOG_PICKPOCKET, 0x13b42);
}

func void DIA_LIAM_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (2)) {
        CREATEINVITEMS(SELF, 0x8e09, 2);
        B_GIVEINVITEMS(SELF, OTHER, 0x8e09, 2);
