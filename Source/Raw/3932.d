...
func void DIA_PIETER_FAQ002_INFO() {
    if ((FAQ002_FIGHTWITHPIETER) == (1)) {
        ...
        INFO_CLEARCHOICES(0x12716);
        INFO_ADDCHOICE(0x12716, "I didn't know they let in boors like you.", 0x12719);
    };
...
func void DIA_PIETER_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x12721);
    INFO_ADDCHOICE(0x12721, DIALOG_BACK, 0x12725);
    INFO_ADDCHOICE(0x12721, DIALOG_PICKPOCKET, 0x12724);
}
