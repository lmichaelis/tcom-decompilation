func void EVENTSMANAGER_QA306() {
    ...
    if (((QA306_GOTOARAXOSMINE) == (1)) && ((SQ119_INSIDEMINE) == (0))) {
        if ((QA306_GOTOARAXOSMINE_DAY) <= ((WLD_GETDAY()) - (2))) {
            if ((NPC_GETDISTTOWP(HERO, "PART7_MINE_31")) >= (0x1388)) {
    ...
    if ((QA306_GOTOARAXOSMINE) == (2)) {
        ...
        if ((QA306_BLOODWYNCUTSCENESTATUS) == (1)) {
            if ((NPC_GETDISTTOWP(HERO, "PART7_MINE_39")) <= (0x4b0)) {
            ...
            if ((QA306_FIGHTWITHMURKSTATUS) == (1)) {
                if (NPC_ISINSTATE(NONE_13703_MURK, 0xf0a3)) {
            ...
            if ((QA306_FIGHTWITHARAXOSGUARDSTATUS) == (1)) {
                if (NPC_ISINSTATE(SLD_13700_ARAXOS_GUARDMINE, 0xf0a3)) {
                    ...
                    AI_FUNCTION(SLD_13700_ARAXOS_GUARDMINE, 0xf71b);
                };
            };
        };
    };
...
var int EVENTSMANAGER_QA306.QA306_GOTIGORKEY_LOGENTRY = 0;
var int EVENTSMANAGER_QA306.QA306_GOTSLEEPSPELL_LOGENTRY = 0;
