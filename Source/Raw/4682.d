func void EVENTSMANAGER_Q101() {
    ...
    if (NPC_KNOWSINFO(HERO, 0x165ba)) {
        if ((Q101_SMUGGLER_IDEA) == (0)) {
            if ((NPC_HASITEMS(HERO, 0x8376)) >= (1)) {
    ...
    if ((Q101_CAPTAIN_CUTSCENEENABLE) == (11)) {
        if (((((NPC_GETDISTTOWP(HERO, "START_KM")) >= (0x251c)) || ((NPC_GETDISTTOWP(HERO, "Q101_BLOCKPATH_01")) <= (0x4e2))) || ((NPC_GETDISTTOWP(HERO, "Q101_BLOCKPATH_02")) <= (0x4e2))) || ((NPC_GETDISTTOWP(HERO, "Q101_BLOCKPATH_03")) <= (0x4e2))) {
...
var int EVENTSMANAGER_Q101.Q101_STOPSCALETIME = 0;
