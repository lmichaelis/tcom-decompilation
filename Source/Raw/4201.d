var int CAPTAIN_TRIALOGCOUNT = 0;
...
func void DIA_CAPTAIN_ARCHOLOS_Q305_INFO() {
    ...
    INFO_CLEARCHOICES(0x14cb5);
    INFO_ADDCHOICE(0x14cb5, "Let's get down to business.", 0x14cba);
    INFO_ADDCHOICE(0x14cb5, "You have something that belongs to me!", 0x14cbc);
}
...
func void DIA_CAPTAIN_ARCHOLOS_Q305_BUISNESS() {
    ...
    INFO_ADDCHOICE(0x14cb5, "How is that?", 0x14cbb);
}
...
func int DIA_CAPTAIN_ARCHOLOS_Q305_KILLPIRATES_CONDITION() {
    if (((LOG_GETSTATUS(MIS_Q305)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x14739))) {
...
func void DIA_CAPTAIN_ARCHOLOS_Q305_KILLPIRATES_ADDCHOICE() {
    ...
    INFO_CLEARCHOICES(0x14cbd);
    INFO_ADDCHOICE(0x14cbd, "I'm not stupid. An order is an order.", 0x14cc2);
    INFO_ADDCHOICE(0x14cbd, "What do you suggest?", 0x14cc3);
}
...
func void DIA_CAPTAIN_ARCHOLOS_Q305_KILLPIRATES_INFO() {
    ...
    if ((Q305_KILLPIRATES) == (2)) {
        ...
        CREATEINVITEMS(SELF, 0x851e, 1);
        B_GIVEINVITEMS(SELF, OTHER, 0x851e, 1);
...
func int DIA_CAPTAINARCHOLOS_AMBIENT_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x14cb5)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_CAPTAIN_ARCHOLOS_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x14cc7);
    INFO_ADDCHOICE(0x14cc7, DIALOG_BACK, 0x14ccb);
    INFO_ADDCHOICE(0x14cc7, DIALOG_PICKPOCKET, 0x14cca);
}
