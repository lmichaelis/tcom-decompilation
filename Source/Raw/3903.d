...
func int DIA_ERNESTO_BUY_CONDITION() {
    if ((LOG_GETSTATUS(MIS_SQ412)) != (LOG_SUCCESS)) {
        if (NPC_KNOWSINFO(OTHER, 0x123ea)) {
            return TRUE;
        };
    };
...
func int DIA_ERNESTO_MONOPOL_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x123ea)) && ((NPC_GETDISTTOWP(SELF, "PARTM5_ERNESTO_STAND")) <= (0xfa0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_ERNESTO_FAQ002_START_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x11563)) && (NPC_KNOWSINFO(OTHER, 0x123ea))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_ERNESTO_FAQ002_TOTHEPOINT_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x123f4)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void ERNESTO_DRINKWINE() {
    AI_STOPLOOKAT(SELF);
    CREATEINVITEMS(SELF, 0x8cb7, 1);
    B_USEITEM(SELF, 0x8cb7);
}

func void ERNESTO_MARVIN_DRINKWINE() {
    AI_WAIT(OTHER, 0x3e99999a);
    AI_STOPLOOKAT(OTHER);
    CREATEINVITEMS(OTHER, 0x8cb7, 1);
    B_USEITEM(OTHER, 0x8cb7);
}
...
func void DIA_ERNESTO_FAQ002_TOTHEPOINT_INFO() {
    ...
    INFO_CLEARCHOICES(0x123f7);
    INFO_ADDCHOICE(0x123f7, "Why are you so concerned about Bodowin's opinion?", 0x123fe);
}
...
func void DIA_ERNESTO_FAQ002_TOTHEPOINT_COUNT_V2() {
    ...
    if ((ERNESTO_FAQ002_TOTHEPOINT_COUNT) == (2)) {
        INFO_ADDCHOICE(0x123f7, "I will try to get this matter resolved quickly.", 0x12402);
    };
}

var int DIA_ERNESTO_FAQ002_TOTHEPOINT_COUNT_V2.ERNESTO_FAQ002_TOTHEPOINT_COUNT = 0;
func void DIA_ERNESTO_FAQ002_TOTHEPOINT_RICHGUY() {
    ...
    INFO_CLEARCHOICES(0x123f7);
    INFO_ADDCHOICE(0x123f7, "How can I help you?", 0x123ff);
}
...
func void DIA_ERNESTO_FAQ002_TOTHEPOINT_START() {
    ...
    INFO_CLEARCHOICES(0x123f7);
    INFO_ADDCHOICE(0x123f7, "Who was this expert on herbs?", 0x12400);
    INFO_ADDCHOICE(0x123f7, "How do you know this man?", 0x12401);
}
...
func int DIA_ERNESTO_FAQ002_FINISH_CONDITION() {
    if (((LOG_GETSTATUS(MIS_FAQ002)) == (LOG_RUNNING)) && (NPC_ISINSTATE(SELF, 0xf09f))) {
...
func void DIA_ERNESTO_FAQ002_FINISH_INFO() {
    ...
    INFO_CLEARCHOICES(0x12406);
    INFO_ADDCHOICE(0x12406, "(Complete task)", 0x1240b);
    INFO_ADDCHOICE(0x12406, "(Don't complete the task)", 0x1240c);
}
...
func int DIA_ERNESTO_QA302_DEAL_CONDITION() {
    if (((LOG_GETSTATUS(MIS_QA302)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x112c6))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ERNESTO_QA302_DEAL_INFO() {
    ...
    INFO_CLEARCHOICES(0x1240d);
    INFO_ADDCHOICE(0x1240d, "Sorry, I didn't hear that.", 0x12411);
    INFO_ADDCHOICE(0x1240d, "(Let him talk)", 0x12412);
}

func void DIA_ERNESTO_QA302_DEAL_NEXT() {
    INFO_CLEARCHOICES(0x1240d);
    INFO_ADDCHOICE(0x1240d, "Is the tunnel the final decision?", 0x12414);
    INFO_ADDCHOICE(0x1240d, "I'm glad you're not going through the ravine...", 0x12415);
}
...
func int DIA_ERNESTO_SQ412_START_CONDITION() {
    if (((KAPITEL) == (4)) && ((NPC_GETDISTTOWP(SELF, "PARTM5_ERNESTO_STAND")) <= (0xfa0))) {
...
func int DIA_ERNESTO_SQ412_WHAT_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x12416)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ERNESTO_SQ412_WHAT_INFO() {
    ...
    INFO_CLEARCHOICES(0x12419);
    INFO_ADDCHOICE(0x12419, "I didn't expect you to make soup for the poor yourself.", 0x1241c);
}
...
func void DIA_ERNESTO_SQ412_WHAT_YOURSELF() {
    ...
    INFO_CLEARCHOICES(0x12419);
    INFO_ADDCHOICE(0x12419, "I think the mages meant for you personally to do something for the poor.", 0x1241d);
    INFO_ADDCHOICE(0x12419, "In that case, I'll get to cooking the soup.", 0x1241e);
}
...
func int DIA_ERNESTO_SQ412_FINISH_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ412)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0xfff2))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ERNESTO_SQ412_FINISH_INFO() {
    ...
    if (((HERO.ATTRIBUTE[3]) > (HERO.ATTRIBUTE[5])) && ((HERO.ATTRIBUTE[3]) > (HERO.ATTRIBUTE[4]))) {
        CREATEINVITEMS(SELF, 0x8f88, 1);
    };
    if (((HERO.ATTRIBUTE[5]) > (HERO.ATTRIBUTE[4])) && ((HERO.ATTRIBUTE[5]) > (HERO.ATTRIBUTE[3]))) {
        CREATEINVITEMS(SELF, 0x8f86, 1);
    };
    if (((HERO.ATTRIBUTE[4]) > (HERO.ATTRIBUTE[5])) && ((HERO.ATTRIBUTE[4]) > (HERO.ATTRIBUTE[3]))) {
        CREATEINVITEMS(SELF, 0x8f84, 1);
    };
    CREATEINVITEMS(SELF, 0x8e5d, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x8e5d, 1);
}
...
var int DIA_ERNESTO_SQ416_GOODJOB_INFO.SQ416_AMBIENT_ERNESTO = 0;
...
func void DIA_ERNESTO_Q505_HELP_INFO() {
    ...
    AI_RESETFACEANI(SELF);
    CREATEINVITEMS(SELF, 0x92be, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x92be, 1);
}
...
func void DIA_ERNESTO_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x1242c);
    INFO_ADDCHOICE(0x1242c, DIALOG_BACK, 0x12430);
    INFO_ADDCHOICE(0x1242c, DIALOG_PICKPOCKET, 0x1242f);
}
