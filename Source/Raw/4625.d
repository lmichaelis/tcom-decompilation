instance SQ202_STOCKS(CUTSCENE) {
    ONSTART = FUNCTION(0x16ad4);
}

func void SQ202_STOCKS_START() {
    TELEPORTNPCTOWP(0x71b, "VILLAGE_PATH_147");
    ...
    B_PASSTIME(1);
    FF_APPLYONCEEXT(0x16ad5, 1000, 17);
}
...
func void SQ202_CUTSCENE_TIMER() {
    ...
    if ((SQ202CUTSCENECOUNT) == (15)) {
        AI_FUNCTION(HERO, 0x16ad7);
    };
}

var int SQ202_CUTSCENE_TIMER.SQ202CUTSCENECOUNT = 0;
func void SQ202_CUTSCENE_END() {
    SQ202_CANUSESTOCKS = FALSE;
    FADESCREENTOBLACKF(2, 0x16ad8, 1000);
}

func void SQ202_CUTSCENE_END_FADESCREEN() {
    FF_APPLYONCEEXT(0xf4f8, 75, 4);
}
