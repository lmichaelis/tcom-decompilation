var int DETLOW_TALKEDABOUTBEAST = 0;
...
func void DIA_DETLOW_EXIT_INFO() {
    ...
    if ((LOG_GETSTATUS(MIS_SQ416)) == (LOG_SUCCESS)) {
        if ((NPC_KNOWSINFO(OTHER, 0x12117)) || (NPC_KNOWSINFO(OTHER, 0x1211a))) {
...
func int DIA_DETLOW_TEACH_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ204)) == (LOG_SUCCESS)) || (((LOG_GETSTATUS(MIS_QM302)) == (LOG_SUCCESS)) && (NPC_KNOWSINFO(OTHER, 0x120fb)))) || ((LOG_GETSTATUS(MIS_SQ416)) == (LOG_SUCCESS))) {
        return TRUE;
    };
...
var int DETLOW_NOMORE = 0;
var string DETLOW_PRINTS = "";
var int DETLOW_CURRENTBLEVEL = 0;
var int DETLOW_CURRENTDEXLEVEL = 0;
...
func int DIA_DETLOW_TRAINME_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x1209e)) && ((DETLOW_NOMORE) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DETLOW_TRAINME_CHOICES() {
    ...
    INFO_CLEARCHOICES(0x120a5);
    INFO_ADDCHOICE(0x120a5, B_BUILDLEARNSTRING2(PRINT_LEARNBOW1, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_BOW, 1), DETLOW_GOLDCOST), 0x120ab);
    INFO_ADDCHOICE(0x120a5, B_BUILDLEARNSTRING2(PRINT_LEARNBOW5, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_BOW, 5), (DETLOW_GOLDCOST) * (5)), 0x120ac);
    INFO_ADDCHOICE(0x120a5, B_BUILDLEARNSTRING2(PRINT_LEARNDEX1, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_DEXTERITY, 1), DETLOW_GOLDCOST), 0x120ad);
    INFO_ADDCHOICE(0x120a5, B_BUILDLEARNSTRING2(PRINT_LEARNDEX5, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_DEXTERITY, 5), (DETLOW_GOLDCOST) * (5)), 0x120ae);
    INFO_ADDCHOICE(0x120a5, DIALOG_BACK, 0x120aa);
}

var int DIA_DETLOW_TRAINME_CHOICES.DETLOW_GOLDCOST = 0;
...
func void DIA_DETLOW_TRAINMEBOW1() {
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (DETLOW_PAYMENT1)) {
        if ((DETLOW_CURRENTBLEVEL) < (OTHER.AIVAR[86])) {
            SND_PLAY(GELDBEUTEL);
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, DETLOW_PAYMENT1);
            NPC_REMOVEINVITEMS(SELF, 0x859b, DETLOW_PAYMENT1);
        };
...
func void DIA_DETLOW_TRAINMEBOW5() {
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (DETLOW_PAYMENT5)) {
        if ((DETLOW_CURRENTBLEVEL) < (OTHER.AIVAR[86])) {
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, DETLOW_PAYMENT5);
            SND_PLAY(GELDBEUTEL);
            NPC_REMOVEINVITEMS(SELF, 0x859b, DETLOW_PAYMENT5);
        };
...
func int DIA_DETLOW_FLETCHERY_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x1209e)) && ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_FLETCHERY)) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DETLOW_FLETCHERY_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (DETLOW_FLETCHERY)) {
        if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_FLETCHERY)) == (1)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, DETLOW_FLETCHERY);
            AI_OUTPUT(SELF, OTHER, "DIA_Detlow_Fletchery_13_01");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, DETLOW_FLETCHERY);
...
func int DIA_DETLOW_FLETCHERY2_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x1209e)) && ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_FLETCHERY)) == (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DETLOW_FLETCHERY2_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (DETLOW_FLETCHERY2)) {
        if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_FLETCHERY)) == (2)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, DETLOW_FLETCHERY2);
            AI_OUTPUT(SELF, OTHER, "DIA_Detlow_Fletchery2_13_01");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, DETLOW_FLETCHERY2);
...
func int DIA_DETLOW_HELLO_CONDITION() {
    if ((NPC_ISINSTATE(SELF, 0xf09f)) && ((NPC_GETDISTTOWP(SELF, "PARTM5_HOUSE_DETLOW_05")) <= (0x5dc))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_DETLOW_AMBIENT_CONDITION() {
    if ((NPC_GETDISTTOWP(SELF, "PARTM5_HOUSE_DETLOW_05")) <= (0x1b58)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_DETLOW_SQ204_HELP_CONDITION() {
    if ((((NPC_KNOWSINFO(OTHER, 0x120bb)) && ((NPC_GETDISTTOWP(SELF, "PART11_INNOS")) <= (600))) && ((LOG_GETSTATUS(MIS_SQ204)) == (LOG_RUNNING))) && (WLD_ISTIME(20, 0, 2, 0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DETLOW_SQ204_FIRSTROUND_INFO() {
    ...
    INFO_CLEARCHOICES(0x120c1);
    INFO_ADDCHOICE(0x120c1, "Do what you want. You're the boss here.", 0x120c5);
    INFO_ADDCHOICE(0x120c1, "I'll do it.", 0x120c6);
    SQ204_FIRSTROUND_SPAWNWOLFES();
}

var int DETLOW_SQ204_SHOWWHOSTHEBOSS = 0;
...
func int DIA_DETLOW_SQ204_COWARD_CONDITION() {
    if ((((DETLOW_SQ204_SHOWWHOSTHEBOSS) == (TRUE)) && ((NPC_GETDISTTOWP(SELF, "PART11_INNOS")) <= (0x9c4))) && ((LOG_GETSTATUS(MIS_SQ204)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_DETLOW_SQ204_HURTWOLF_CONDITION() {
    if ((LOG_GETSTATUS(MIS_SQ204)) == (LOG_RUNNING)) {
        if (((NPC_GETDISTTOWP(SELF, "PART11_WOLFDETLOWA_HURT")) <= (400)) || (((NPC_GETDISTTOWP(SELF, "PART11_WOLFDETLOWA_HURT")) <= (650)) && (NPC_ISINSTATE(SELF, 0xf09f)))) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
...
func void DIA_DETLOW_SQ204_HURTWOLF_INFO() {
    ...
    INFO_CLEARCHOICES(0x120cd);
    INFO_ADDCHOICE(0x120cd, "You're right. (Kill the wolf)", 0x120d5);
    INFO_ADDCHOICE(0x120cd, "Perhaps he could be helped in some way? (Spare the wolf)", 0x120d7);
}
...
func void DIA_DETLOW_KILLHURTEDWOLF_END() {
    ...
    HERO.AIVAR[4] = TRUE;
    FF_APPLYONCEEXT(0xf7f9, 75, 4);
}

func void SQ204_GOWITHDETLOW() {
    HERO.AIVAR[4] = TRUE;
    FF_APPLYONCEEXT(0xf7fb, 75, 4);
}
...
func void DIA_DETLOW_KILLHURTEDWOLF_NEXTPHASE() {
    ...
    INFO_CLEARCHOICES(0x120cd);
    INFO_ADDCHOICE(0x120cd, "That wasn't the deal. I'm coming with you.", 0x120d4);
    INFO_ADDCHOICE(0x120cd, "Okay, but hurry up.", 0x120d3);
}

func void DIA_DETLOW_SQ204_HURTWOLF_ALLRIGHT() {
    AI_OUTPUT(OTHER, SELF, "DIA_Detlow_SQ204_HurtWolf_Right_15_05");
    AI_WAITTILLEND(SELF, OTHER);
    AI_FUNCTION(SELF, 0x120d0);
}
...
func void DIA_DETLOW_SQ204_HURTWOLF_RIGHT() {
    ...
    TELEPORTNPCTOWP(0xd212, "PART11_PATH_115");
    TELEPORTNPCTOWP(0xc3ab, "PART11_MOB_12");
...
func void SQ204_THIRDPHASE_CAMERA01() {
    ...
    HERO.AIVAR[4] = FALSE;
    TELEPORTNPCTOWP(0xd212, "PART10_PATH2_94");
    TELEPORTNPCTOWP(0x71b, "PART10_CUTSCENE_HERO_2");
}
...
func void SQ204_THIRDPHASE_ENDDIALOGE() {
    ...
    FF_APPLYONCEEXT(0xf7fd, 75, 4);
    AI_FUNCTION(VLK_3015_DETLOW, 0xf7f1);
}
...
func int DIA_DETLOW_SQ204_ROUNDTHREE_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x120db)) && ((LOG_GETSTATUS(MIS_SQ204)) == (LOG_RUNNING))) && ((NPC_GETDISTTOWP(SELF, "PART10_SQ204_DETLOW_FIREPLACE")) <= (750))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DETLOW_SQ204_FINISH_INFO() {
    ...
    if ((NPC_KNOWSINFO(OTHER, 0x14da3)) && ((LOG_GETSTATUS(MIS_SQ416)) != (LOG_SUCCESS))) {
        ...
        INFO_CLEARCHOICES(0x120e3);
        INFO_ADDCHOICE(0x120e3, "I thought slaughtering a pack of wolves was quite a challenge.", 0x120e7);
    };
...
func int DIA_DETLOW_QM302_QUIET_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_QM302)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x115cb))) && ((NPC_GETDISTTOWP(SELF, "PART2_PATH_65")) <= (500))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_DETLOW_QM302_BEAST_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_QM302)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x120e8))) && ((LOG_GETSTATUS(MIS_SQ416)) != (LOG_SUCCESS))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_DETLOW_QM302_GUILD_CONDITION() {
    if (((LOG_GETSTATUS(MIS_QM302)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x120e8))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}

var int QM302_GUILD_TARGETS = 0;
var int QM302_GUILD_TEACHER = 0;
var int QM302_GUILD_REPAIR = 0;
func void DIA_DETLOW_QM302_GUILD_NEXT() {
    ...
    INFO_CLEARCHOICES(0x120ee);
    INFO_ADDCHOICE(0x120ee, "That Bodowin again...", 0x120f9);
    INFO_ADDCHOICE(0x120ee, "I'll go get the herbs.", 0x120fa);
}
...
func void DIA_DETLOW_QM302_GUILD_CHOICES() {
    if (((QM302_GUILD_TEACHER) == (FALSE)) || ((QM302_GUILD_REPAIR) == (FALSE))) {
        ...
        if ((QM302_GUILD_REPAIR) == (FALSE)) {
            INFO_ADDCHOICE(0x120ee, "Take care of crossbow maintenance.", 0x120f8);
        };
        if ((QM302_GUILD_TEACHER) == (FALSE)) {
            INFO_ADDCHOICE(0x120ee, "A teacher.", 0x120f6);
        };
        if ((QM302_GUILD_TARGETS) == (FALSE)) {
            INFO_ADDCHOICE(0x120ee, "Targets.", 0x120f7);
        };
    };
...
func int DIA_DETLOW_QM302_GOTPLANTS_CONDITION() {
    if (((LOG_GETSTATUS(MIS_QM302)) == (LOG_RUNNING)) && ((NPC_HASITEMS(OTHER, 0x916c)) >= (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DETLOW_QM302_GOTPLANTS_INFO() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 0x916c, 1);
    B_STANDUP();
    B_USEFAKEPACKET();
...
func void DIA_DETLOW_SQ416_ALLAN_INFO() {
    ...
    INFO_CLEARCHOICES(0x12101);
    INFO_ADDCHOICE(0x12101, "Looks like we're the only ones left.", 0x12106);
    INFO_ADDCHOICE(0x12101, "Unfortunately, Allan is dead.", 0x12105);
}
...
func void DIA_DETLOW_SQ416_ALLAN_NEXT() {
    ...
    INFO_CLEARCHOICES(0x12101);
    INFO_ADDCHOICE(0x12101, "How are we supposed to get there?", 0x12108);
    INFO_ADDCHOICE(0x12101, "Maybe we can go back for some reinforcements?", 0x12107);
}
...
func void DIA_DETLOW_SQ416_ALLAN_ALONE_NEXT_HOW() {
    ...
    INFO_CLEARCHOICES(0x12101);
    INFO_ADDCHOICE(0x12101, "Let's go.", 0x1210a);
    INFO_ADDCHOICE(0x12101, "What about the reward?", 0x12109);
}
...
func void DIA_DETLOW_SQ416_ALLAN_ALONE_NEXT_HOW_GO() {
    ...
    INFO_CLEARCHOICES(0x12101);
    AI_STOPPROCESSINFOS(SELF);
    AI_FUNCTION(SELF, 0x1210b);
}

func void DETLOW_SQ416_GOTOCAVE() {
    FADESCREENTOBLACKF(1, 0x1210c, 1000);
}

func void DETLOW_SQ416_GOTOCAVE_FADESCREEN() {
    FF_APPLYONCEEXT(0x1210d, 1000, 4);
}
...
func void DETLOW_SQ416_GOTOCAVE_FADESCREEN_APPLY() {
    ...
    if ((DETLOW_SQ416_GOTOCAVE_FADESCREEN_COUNT) == (3)) {
        ...
        NPC_REMOVEINVITEMS(VLK_3015_DETLOW, 0x9a58, NPC_HASITEMS(VLK_3015_DETLOW, 0x9a58));
...
var int DETLOW_SQ416_GOTOCAVE_FADESCREEN_APPLY.DETLOW_SQ416_GOTOCAVE_FADESCREEN_COUNT = 0;
...
func int DIA_DETLOW_SQ416_AFTERFIGHT_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ416)) == (LOG_RUNNING)) && ((SQ416_STARTBOSSFIGHT) == (3))) && (NPC_ISINSTATE(SELF, 0xf09f))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DETLOW_SQ416_AFTERFIGHT_INFO() {
    ...
    INFO_CLEARCHOICES(0x1210f);
    INFO_ADDCHOICE(0x1210f, "Why was this beast wearing some bits of armor?", 0x12112);
    INFO_ADDCHOICE(0x1210f, "I'll run to the village for help.", 0x12113);
}
...
func int DIA_DETLOW_SQ416_WHO_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ416)) == (LOG_SUCCESS)) && (NPC_KNOWSINFO(OTHER, 0x12117))) {
        if ((SQ416_RAMSEYPARTY) != (2)) {
            return TRUE;
        };
    };
...
func int DIA_DETLOW_SQ416_REALBEAST_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_SQ416)) == (LOG_SUCCESS)) && ((SQ416_RAMSEYPARTY) == (2))) && (NPC_KNOWSINFO(OTHER, 0x1211d))) && ((SQ416_REALMONSTER_COUNT) >= (6))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DETLOW_SQ416_FINALFIGHT() {
    FF_APPLYONCEEXTGT(0x12122, 0, -(1));
    AI_WAITTILLEND(SELF, OTHER);
    NPC_REMOVEINVITEMS(VLK_3015_DETLOW, 0x9a7d, NPC_HASITEMS(VLK_3015_DETLOW, 0x9a7d));
...
func void DIA_DETLOW_SQ416_REALBEAST_INFO() {
    ...
    INFO_CLEARCHOICES(0x12120);
    INFO_ADDCHOICE(0x12120, "What's all this for?", 0x12125);
}
...
func void DIA_DETLOW_SQ416_REALBEAST_WHY() {
    ...
    INFO_CLEARCHOICES(0x12120);
    INFO_ADDCHOICE(0x12120, "Then who did the killing?", 0x12126);
}
...
func void DIA_DETLOW_SQ416_REALBEAST_WHY_WHO() {
    ...
    INFO_CLEARCHOICES(0x12120);
    INFO_ADDCHOICE(0x12120, "There is a lot of truth in what you say...", 0x1212d);
    INFO_ADDCHOICE(0x12120, "You're crazy!", 0x1212c);
    INFO_ADDCHOICE(0x12120, DIALOG_BESILENT, 0x1212b);
}
...
func void DIA_DETLOW_SQ416_REALBEAST_NEXT2() {
    ...
    INFO_CLEARCHOICES(0x12120);
    INFO_ADDCHOICE(0x12120, "I promised to kill the Beast and I intend to fulfill the contract.", 0x12128);
    INFO_ADDCHOICE(0x12120, "(Say nothing and draw your weapon)", 0x12129);
}
...
func int DIA_DETLOW_HUNTING_SPECIAL_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x1209e)) && ((PLAYER_TALENT_TAKEANIMALTROPHY[2]) == (TRUE))) && ((DETLOW_ALLHUNT) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DETLOW_HUNTING_SPECIAL_CHOICES() {
    INFO_CLEARCHOICES(0x1212f);
    INFO_ADDCHOICE(0x1212f, DIALOG_BACK, 0x12133);
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[17]) == (FALSE)) {
        INFO_ADDCHOICE(0x1212f, B_BUILDLEARNSTRING2(PRINT_TEACHSHELLS, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_SHELLS), DETLOW_SHELLSTROPHY), 0x12134);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[4]) == (FALSE)) {
        INFO_ADDCHOICE(0x1212f, B_BUILDLEARNSTRING2(PRINT_TEACHSHADOWHORN, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_SHADOWHORN), DETLOW_SHADOWHORNTROPHY), 0x12135);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[13]) == (FALSE)) {
        INFO_ADDCHOICE(0x1212f, B_BUILDLEARNSTRING2(PRINT_TEACHREPTILESKIN, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_REPTILESKIN), DETLOW_REPTILESKINTROPHY), 0x12136);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[1]) == (FALSE)) {
        INFO_ADDCHOICE(0x1212f, B_BUILDLEARNSTRING2(PRINT_TEACHCLAWS, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_CLAWS), DETLOW_CLAWSTROPHY), 0x12137);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[0]) == (FALSE)) {
        INFO_ADDCHOICE(0x1212f, B_BUILDLEARNSTRING2(PRINT_TEACHTEETH, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_TEETH), DETLOW_TEETHTROPHY), 0x12138);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[5]) == (FALSE)) {
        INFO_ADDCHOICE(0x1212f, B_BUILDLEARNSTRING2(PRINT_TEACHFIRETONGUE, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_FIRETONGUE), DETLOW_FIRETONGUETROPHY), 0x12139);
    };
}
...
func void DIA_DETLOW_HUNTING_SPECIAL_SHELLS() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (DETLOW_SHELLSTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[17]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, DETLOW_SHELLSTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Detlow_Hunting_Special_Shells_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, DETLOW_SHELLSTROPHY);
...
func void DIA_DETLOW_HUNTING_SPECIAL_SHADOWHORN() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (DETLOW_SHADOWHORNTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[4]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, DETLOW_SHADOWHORNTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Detlow_Hunting_Special_ShadowHorn_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, DETLOW_SHADOWHORNTROPHY);
...
func void DIA_DETLOW_HUNTING_SPECIAL_REPTILESKIN() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (DETLOW_REPTILESKINTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[13]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, DETLOW_REPTILESKINTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Detlow_Hunting_Special_ReptileSkin_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, DETLOW_REPTILESKINTROPHY);
...
func void DIA_DETLOW_HUNTING_SPECIAL_CLAWS() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (DETLOW_CLAWSTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[1]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, DETLOW_CLAWSTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Detlow_Hunting_Special_Claws_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, DETLOW_CLAWSTROPHY);
...
func void DIA_DETLOW_HUNTING_SPECIAL_TEETH() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (DETLOW_TEETHTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[0]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, DETLOW_TEETHTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Detlow_Hunting_Special_Teeth_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, DETLOW_TEETHTROPHY);
...
func void DIA_DETLOW_HUNTING_SPECIAL_FIRETONGUE() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (DETLOW_FIRETONGUETROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[5]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, DETLOW_FIRETONGUETROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Detlow_Hunting_Special_FireTongue_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, DETLOW_FIRETONGUETROPHY);
...
func void DIA_DETLOW_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x1213a);
    INFO_ADDCHOICE(0x1213a, DIALOG_BACK, 0x1213e);
    INFO_ADDCHOICE(0x1213a, DIALOG_PICKPOCKET, 0x1213d);
}

func void DIA_DETLOW_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (3)) {
        CREATEINVITEMS(SELF, 0x844e, 1);
        B_GIVEINVITEMS(SELF, OTHER, 0x844e, 1);
