...
var int GAROS_QA202_START_WHAT = 0;
var int GAROS_QA202_START_HELP = 0;
var int GAROS_QA202_START_HURT = 0;
...
func void DIA_GAROS_QA202_START_CHOICES() {
    ...
    if ((GAROS_QA202_START_HURT) == (FALSE)) {
        INFO_ADDCHOICE(0x11380, "What if something happens to her?", 0x1138a);
    };
    if ((GAROS_QA202_START_HELP) == (FALSE)) {
        INFO_ADDCHOICE(0x11380, "That help is the only condition?", 0x11389);
    };
    if ((GAROS_QA202_START_WHAT) == (FALSE)) {
        INFO_ADDCHOICE(0x11380, "What kind of escapade?", 0x11388);
    };
}
...
func int DIA_GAROS_QA202_WHERE_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_QA202)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x11380))) && (!(NPC_KNOWSINFO(OTHER, 0x12a3f)))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_GAROS_QA202_FINISH_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_QA202)) == (LOG_RUNNING)) && ((QA202_RAMHAAFTERPLANT) >= (1))) && (NPC_ISINSTATE(SELF, 0xf09f))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_GAROS_QA202_FINISH_INFO() {
    if ((QA202_RAMHAAFTERPLANT) == (1)) {
        ...
        CREATEINVITEMS(SELF, 0x859b, QA202_REWARD);
        B_GIVEINVITEMS(SELF, OTHER, 0x859b, QA202_REWARD);
    ...
    AI_FUNCTION(SELF, 0x11391);
}

func void GAROS_QA202_SPAWNSNAPPERS() {
    WLD_INSERTNPC(0xc6cc, "PART7_MOB_21");
    WLD_INSERTNPC(0xc6cc, "PART7_MOB_22");
    WLD_INSERTNPC(0xc74a, "PART7_CUTSCENE_QA202_HERO");
}
...
var int GAROS_QA302_START_WHY = 0;
var int GAROS_QA302_START_MANY = 0;
var int GAROS_QA302_START_WHO = 0;
...
func void DIA_GAROS_QA302_CHOICES() {
    ...
    if ((((GAROS_QA302_START_WHY) == (FALSE)) || ((GAROS_QA302_START_MANY) == (FALSE))) || ((GAROS_QA302_START_WHO) == (FALSE))) {
        if ((GAROS_QA302_START_WHO) == (FALSE)) {
            INFO_ADDCHOICE(0x11392, "Do I get anyone to help me?", 0x1139c);
        };
        if ((GAROS_QA302_START_MANY) == (FALSE)) {
            INFO_ADDCHOICE(0x11392, "There are several roads leading to the Great Vineyard...", 0x1139b);
        };
        if ((GAROS_QA302_START_WHY) == (FALSE)) {
            INFO_ADDCHOICE(0x11392, "Why does he go to the Great Vineyard?", 0x1139a);
        };
    };
...
func void DIA_GAROS_QA302_ROUTESDONE_INFO() {
    ...
    INFO_CLEARCHOICES(0x1139d);
    INFO_ADDCHOICE(0x1139d, "Do you think this is some kind of trap?", 0x113a1);
    INFO_ADDCHOICE(0x1139d, "Ernesto will have protection?", 0x113a2);
}
...
func void DIA_GAROS_QA302_FINISH_INFO() {
    ...
    if ((QA302_READERNESTOLIST) == (TRUE)) {
        ...
        B_GIVEINVITEMS(OTHER, SELF, 0x9156, 1);
        B_STANDUP();
        B_USEFAKESCROLL();
    ...
    CREATEINVITEMS(SELF, 0x859b, (QA302_REWARD) * (GAROS_QA302_GOODPOINTS));
    B_GIVEINVITEMS(SELF, OTHER, 0x859b, (QA302_REWARD) * (GAROS_QA302_GOODPOINTS));
...
var int DIA_GAROS_QA302_FINISH_INFO.GAROS_QA302_GOODPOINTS = 0;
...
func void DIA_GAROS_QA303_START_INFO() {
    CREATEINVITEMS(SELF, 0x9159, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x9159, 1);
    AI_STARTFACEANI(SELF, S_SMILE, 1, -(1));
...
func void DIA_GAROS_QA303_FINISH_INFO() {
    ...
    CREATEINVITEMS(SELF, 0x859b, (QA303_REWARD) * (GAROS_QA303_GOODPOINTS));
    B_GIVEINVITEMS(SELF, OTHER, 0x859b, (QA303_REWARD) * (GAROS_QA303_GOODPOINTS));
...
var int DIA_GAROS_QA303_FINISH_INFO.GAROS_QA303_GOODPOINTS = 0;
...
func int DIA_GAROS_PROMOTION_TIER1_READY_CONDITION() {
    if ((HERO.GUILD) == (GIL_SLD)) {
        if (NPC_KNOWSINFO(OTHER, 0x113ae)) {
            if (((MARVIN_ARAXOSSPECIALIZATION) == (ARAXOS_SPECIALIZATION_NONE)) && ((MARVIN_ARAXOSSPECIALIZATION_CANJOIN_ARCHER) == (TRUE))) {
                return TRUE;
            };
        };
...
func void GAROS_CARAMONSPECIALIZATION_TIER1() {
    if ((CARAMON_TIERARMOR) == (3)) {
        ...
        EQUIPITEM(SLD_1009_CARAMON, 0x9b47);
    ...
    EQUIPITEM(SLD_1009_CARAMON, 0x9b45);
    CREATEINVITEMS(SLD_1009_CARAMON, 0x864f, 20);
...
var string DIA_GAROS_PROMOTION_TIER1_READY_INFO.GAROS_CHECKSMARVINBOWLEVEL = "";
var string DIA_GAROS_PROMOTION_TIER1_READY_INFO.MARVIN_CURRENTBOWLEVEL_GAROS = "";
...
func int DIA_GAROS_SQ503_AFTERCORTEZ_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ503)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x10804))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_GAROS_KQ407_ORCSNEWS_INFO() {
    ...
    AI_FUNCTION(SELF, 0xf161);
    AI_FUNCTION(SELF, 0xf15a);
}
...
func void DIA_GAROS_KQ407_ORCSROUNDTWO_INFO() {
    ...
    AI_FUNCTION(SELF, 0xf167);
    AI_FUNCTION(SELF, 0xf16a);
}
...
func int DIA_GAROS_KQ407_READY_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_KQ407)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x113c0))) && ((NPC_GETDISTTOWP(SELF, "PART1_KQ407_GAROS_STAND_01")) <= (700))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_GAROS_KQ407_LETSATTACK_CONDITION() {
    if (((LOG_GETSTATUS(MIS_KQ407)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x113c3))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_GAROS_KQ407_AFTERFIGHT_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_KQ407)) == (LOG_RUNNING)) && ((NPC_GETDISTTOWP(SELF, "PART1_KQ407_GAROS_STAND_04")) <= (1000))) && (NPC_KNOWSINFO(OTHER, 0x113c6))) {
...
func void DIA_GAROS_KQ407_AFTERFIGHT_INFO() {
    ...
    INFO_CLEARCHOICES(0x113c9);
    INFO_ADDCHOICE(0x113c9, "(Stay in the lighthouse)", 0x113cd);
    INFO_ADDCHOICE(0x113c9, "(Return by boat to the other side)", 0x113cc);
}

func void DIA_GAROS_KQ407_AFTERFIGHT_BOAT() {
    AI_STOPPROCESSINFOS(SELF);
    AI_FUNCTION(SELF, 0xf179);
}
...
var int GAROS_NOMORE = 0;
var int GAROS_CURRENTBLEVEL = 0;
var int GAROS_CURRENTDEXLEVEL = 0;
...
func int DIA_GAROS_TEACH_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x113ce)) && ((GAROS_NOMORE) == (FALSE))) && ((OTHER.GUILD) == (GIL_SLD))) {
        if ((MARVIN_ARAXOSSPECIALIZATION) == (4)) {
            return TRUE;
        };
    };
...
func void DIA_GAROS_TEACH_CHOICES() {
    ...
    GAROS_GOLDCOST = 0;
    INFO_CLEARCHOICES(0x113d7);
    INFO_ADDCHOICE(0x113d7, DIALOG_BACK, 0x113dc);
    INFO_ADDCHOICE(0x113d7, B_BUILDLEARNSTRING2(PRINT_LEARNBOW1, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_BOW, 1), GAROS_GOLDCOST), 0x113dd);
    INFO_ADDCHOICE(0x113d7, B_BUILDLEARNSTRING2(PRINT_LEARNBOW5, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_BOW, 5), (GAROS_GOLDCOST) * (5)), 0x113de);
    INFO_ADDCHOICE(0x113d7, B_BUILDLEARNSTRING2(PRINT_LEARNDEX1, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_DEXTERITY, 1), GAROS_GOLDCOST), 0x113df);
    INFO_ADDCHOICE(0x113d7, B_BUILDLEARNSTRING2(PRINT_LEARNDEX5, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_DEXTERITY, 5), (GAROS_GOLDCOST) * (5)), 0x113e0);
}

var int DIA_GAROS_TEACH_CHOICES.GAROS_GOLDCOST = 0;
...
func int DIA_GAROS_PROMOTION_TIER2_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x11677)) && ((MARVIN_ARAXOSSPECIALIZATION) == (ARAXOS_SPECIALIZATION_MASTERARCHER))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_GAROS_AMBIENT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x113e4)) || ((HERO.GUILD) == (GIL_SLD))) {
        if ((NPC_GETDISTTOWP(SELF, "PARTM1_LOOKOUT_01")) <= (0x1b58)) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
...
func int DIA_GAROS_HUNTING_SPECIAL_CONDITION() {
    if ((((NPC_KNOWSINFO(OTHER, 0x113ce)) && ((OTHER.GUILD) == (GIL_SLD))) && ((GAROS_ALLHUNT) == (FALSE))) && ((PLAYER_TALENT_TAKEANIMALTROPHY[2]) == (TRUE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_GAROS_HUNTING_SPECIAL_CHOICES() {
    INFO_CLEARCHOICES(0x113eb);
    INFO_ADDCHOICE(0x113eb, DIALOG_BACK, 0x113ef);
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[0]) == (FALSE)) {
        INFO_ADDCHOICE(0x113eb, B_BUILDLEARNSTRING2(PRINT_TEACHTEETH, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_TEETH), GAROS_TEETHTROPHY), 0x113f0);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[1]) == (FALSE)) {
        INFO_ADDCHOICE(0x113eb, B_BUILDLEARNSTRING2(PRINT_TEACHCLAWS, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_CLAWS), GAROS_CLAWSTROPHY), 0x113f1);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[5]) == (FALSE)) {
        INFO_ADDCHOICE(0x113eb, B_BUILDLEARNSTRING2(PRINT_TEACHFIRETONGUE, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_FIRETONGUE), GAROS_FIRETONGUETROPHY), 0x113f2);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[13]) == (FALSE)) {
        INFO_ADDCHOICE(0x113eb, B_BUILDLEARNSTRING2(PRINT_TEACHREPTILESKIN, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_REPTILESKIN), GAROS_REPTILESKINTROPHY), 0x113f3);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[4]) == (FALSE)) {
        INFO_ADDCHOICE(0x113eb, B_BUILDLEARNSTRING2(PRINT_TEACHSHADOWHORN, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_SHADOWHORN), GAROS_SHADOWHORNTROPHY), 0x113f4);
    };
}
...
func void DIA_GAROS_HUNTING_SPECIAL_TEETH() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (GAROS_TEETHTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[0]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, GAROS_TEETHTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Garos_Hunting_Special_Teeth_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, GAROS_TEETHTROPHY);
...
func void DIA_GAROS_HUNTING_SPECIAL_CLAWS() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (GAROS_CLAWSTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[1]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, GAROS_CLAWSTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Garos_Hunting_Special_Claws_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, GAROS_CLAWSTROPHY);
...
func void DIA_GAROS_HUNTING_SPECIAL_FIRETONGUE() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (GAROS_FIRETONGUETROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[5]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, GAROS_FIRETONGUETROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Garos_Hunting_Special_FireTongue_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, GAROS_FIRETONGUETROPHY);
...
func void DIA_GAROS_HUNTING_SPECIAL_REPTILESKIN() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (GAROS_REPTILESKINTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[13]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, GAROS_REPTILESKINTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Garos_Hunting_Special_ReptileSkin_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, GAROS_REPTILESKINTROPHY);
...
func void DIA_GAROS_HUNTING_SPECIAL_SHADOWHORN() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (GAROS_SHADOWHORNTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[4]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, GAROS_SHADOWHORNTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Garos_Hunting_Special_ShadowHorn_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, GAROS_SHADOWHORNTROPHY);
...
func void DIA_GAROS_BOUNTY_CHOICES() {
    ...
    if (((BOUNTY_RAT_SPAWN) == (TRUE)) && ((BOUNTY_RAT_SPAWNINARCHOLOS) == (3))) {
        if (((NPC_ISDEAD(BDT_8028_RAT)) && (NPC_ISDEAD(BDT_8029_RAT))) && (NPC_ISDEAD(BDT_8030_RAT))) {
            INFO_ADDCHOICE(0x113f5, NAME_WANTEDPOSTER_RAT_MANY, 0x11405);
        };
    };
    if (((BOUNTY_GOLEM_SPAWN) == (TRUE)) && ((BOUNTY_GOLEM_SPAWNINARCHOLOS) == (3))) {
        if (NPC_ISDEAD(BDT_8031_GOLEM)) {
            INFO_ADDCHOICE(0x113f5, NAME_WANTEDPOSTER_GOLEM, 0x11406);
        };
    };
    if (((BOUNTY_TROLL_SPAWN) == (TRUE)) && ((BOUNTY_TROLL_SPAWNINARCHOLOS) == (3))) {
        if (((NPC_ISDEAD(BDT_8032_TROLL)) && (NPC_ISDEAD(BDT_8033_TROLL))) && (NPC_ISDEAD(BDT_8034_TROLL))) {
            INFO_ADDCHOICE(0x113f5, NAME_WANTEDPOSTER_TROLL_MANY, 0x11407);
        };
    };
    if (((BOUNTY_FIREWARAN_SPAWN) == (TRUE)) && ((BOUNTY_FIREWARAN_SPAWNINARCHOLOS) == (3))) {
        if (((NPC_ISDEAD(BDT_8035_FIREWARAN)) && (NPC_ISDEAD(BDT_8036_FIREWARAN))) && (NPC_ISDEAD(BDT_8037_FIREWARAN))) {
            INFO_ADDCHOICE(0x113f5, NAME_WANTEDPOSTER_FIREWARAN_MANY, 0x11408);
        };
    };
}
...
func void DIA_GAROS_BOUNTY_GIVEGOLD() {
    ...
    CREATEINVITEMS(SELF, 0x859b, GAROS_WANTEDPOSTER_REWARD);
    B_GIVEINVITEMS(SELF, OTHER, 0x859b, GAROS_WANTEDPOSTER_REWARD);
...
func void DIA_GAROS_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x11409);
    INFO_ADDCHOICE(0x11409, DIALOG_BACK, 0x1140d);
    INFO_ADDCHOICE(0x11409, DIALOG_PICKPOCKET, 0x1140c);
}

func void DIA_GAROS_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (3)) {
        CREATEINVITEMS(SELF, 0x8445, 1);
        B_GIVEINVITEMS(SELF, OTHER, 0x8445, 1);
