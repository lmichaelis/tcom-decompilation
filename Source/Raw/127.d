var int STATUSSCREEN_EXPBAR = 0;
var int STATUSSCREEN_EXPBAR_EXP = 0;
var int STATUSSCREEN_EXPBAR_NEXT = 0;
...
func void STATUSSCREENSHOW_HOOK() {
    ...
    FF_APPLYONCEEXT(0x555e, 15, 1);
}

var int STATUSSCREENSHOW_HOOK.LASTLEVELEXPNEXT = 0;
var string STATUSSCREENSHOW_HOOK.REAL_EXP = "";
var string STATUSSCREENSHOW_HOOK.REAL_NEXT = "";
var string STATUSSCREENSHOW_HOOK.NEXT_PERCENT = "";
var int STATUSSCREENSHOW_HOOK.REAL_HP = 0;
var string STATUSSCREENSHOW_HOOK.PLAYERGUILD = "";
func void STATUSSCREEN_CREATEEXPBAR() {
    STATUSSCREEN_EXPBAR = BAR_CREATE(0x5555);
...
var int STATUSSCREEN_CREATEEXPBAR.SCALEF = 0;
