...
func int DIA_FIGARO_BADDAY_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x127d8)) {
        return TRUE;
    };
...
func void DIA_FIGARO_CQ006_INFO() {
    ...
    INFO_CLEARCHOICES(0x127e1);
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (CQ006_FIGAROCOST)) {
        INFO_ADDCHOICE(0x127e1, DIALOG_GIVE70G, 0x127e5);
    };
    INFO_ADDCHOICE(0x127e1, "Couldn't you come down on the price a bit?", 0x127e6);
    INFO_ADDCHOICE(0x127e1, "I don't have that much.", 0x127e7);
}

func void DIA_FIGARO_CQ006_GOLD() {
    CQ006_ALCHEMISTWAY = 1;
    AI_OUTPUT(OTHER, SELF, "DIA_Figaro_CQ006_Gold_15_01");
    B_GIVEINVITEMS(OTHER, SELF, 0x859b, CQ006_FIGAROCOST);
...
func int DIA_FIGARO_ALCHEMISTGOLD_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_CQ006)) == (LOG_RUNNING)) && ((CQ006_ALCHEMISTWANTGOLD) == (TRUE))) && ((NPC_HASITEMS(OTHER, 0x859b)) >= (CQ006_FIGAROCOST))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_FIGARO_RIVERMIRT_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_CQ006)) == (LOG_RUNNING)) && ((CQ006_RIVERMIRT) == (TRUE))) && ((NPC_HASITEMS(OTHER, 0x930f)) >= (5))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_FIGARO_RIVERMIRT_INFO() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 0x930f, 5);
...
func int DIA_FIGARO_QA202_FINALLY_CONDITION() {
    if (((LOG_GETSTATUS(MIS_QA202)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x12a47))) {
...
func int DIA_FIGARO_QA202_NEEDHELP_CONDITION() {
    if (((LOG_GETSTATUS(MIS_QA202)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x12a51))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_FIGARO_QA202_NOTTIME_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_QA202)) == (LOG_RUNNING)) && ((NPC_GETDISTTONPC(SELF, VLK_6407_RAMHA)) >= (0x1d4c))) && (NPC_KNOWSINFO(OTHER, 0x127f2))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_FIGARO_QA202_DONE_CONDITION() {
    if (((LOG_GETSTATUS(MIS_QA202)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x12a57))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_FIGARO_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x12801);
    INFO_ADDCHOICE(0x12801, DIALOG_BACK, 0x12805);
    INFO_ADDCHOICE(0x12801, DIALOG_PICKPOCKET, 0x12804);
}

func void DIA_FIGARO_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (1)) {
        CREATEINVITEMS(SELF, 0x85e2, 1);
        B_GIVEINVITEMS(SELF, OTHER, 0x85e2, 1);
        CREATEINVITEMS(SELF, 0x85e8, 1);
        B_GIVEINVITEMS(SELF, OTHER, 0x85e8, 1);
        CREATEINVITEMS(SELF, 0x9e13, 1);
        B_GIVEINVITEMS(SELF, OTHER, 0x9e13, 1);
