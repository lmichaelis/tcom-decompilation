...
func void Q514_VOLFZACKETREASURYENTERCUTSCENE_START() {
    ...
    TELEPORTNPCTOWP(0x71b, "VOLFZACK_CATACOMBS_67");
    AI_WAIT(HERO, 0x3f99999a);
    AI_PLAYANI(HERO, R_SCRATCHLSHOULDER);
    FF_APPLYONCEEXT(0x16a1f, 1000, 17);
}
...
func void Q514_VOLFZACKETREASURYENTERCUTSCENE_TIMER() {
    ...
    if ((Q514_VOLFZACKETREASURYENTERCUTSCENE_TIMER_COUNT) == (5)) {
        ...
        TELEPORTNPCTOWP(0x71b, "VOLFZACK_TREASURY_01");
    ...
    if ((Q514_VOLFZACKETREASURYENTERCUTSCENE_TIMER_COUNT) == (17)) {
        ...
        TELEPORTNPCTOWP(0x71b, "VOLFZACK_TREASURY_HERO_01");
...
var int Q514_VOLFZACKETREASURYENTERCUTSCENE_TIMER.Q514_VOLFZACKETREASURYENTERCUTSCENE_TIMER_COUNT = 0;
