...
var int WORKERGUARD_CANENTER = 0;
...
func int DIA_WORKERGUARD_KQ406_OFFERMONEY_CONDITION() {
    if (((LOG_GETSTATUS(MIS_KQ406)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x11dfb))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_WORKERGUARD_KQ406_GIVE_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_KQ406)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x11dfe))) && ((WORKERGUARD_CANENTER) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_WORKERGUARD_KQ406_GIVE_INFO() {
    ...
    if (((NPC_HASITEMS(OTHER, 0x859b)) >= (KQ406_WORKERGUARDOFFER)) && ((C_GOTANYKINDOFBEER(HERO)) == (TRUE))) {
        WORKERGUARD_CANENTER = TRUE;
        B_GIVEANYBEER_USEIT();
        B_GIVEINVITEMS(OTHER, SELF, 0x859b, KQ406_WORKERGUARDOFFER);
    ...
    if (((NPC_HASITEMS(OTHER, 0x859b)) >= (KQ406_WORKERGUARDOFFER)) == (FALSE)) {
        AI_STARTFACEANI(SELF, S_ANGRY, 1, -(1));
