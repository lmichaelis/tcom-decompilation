...
func void DIA_JAVAD_Q602_FINALLY_INFO() {
    ...
    INFO_CLEARCHOICES(0x161ce);
    INFO_ADDCHOICE(0x161ce, "It looked like you had the situation under control.", 0x161d1);
}
...
func void DIA_JAVAD_Q602_FINALLY_CALM() {
    ...
    INFO_CLEARCHOICES(0x161ce);
    INFO_ADDCHOICE(0x161ce, "It seems that Ulryk and the Usurer have joined forces.", 0x161d2);
}
