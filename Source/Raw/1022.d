...
instance STONEGOLEM(MST_DEFAULT_STONEGOLEM) {
    ...
    CREATEINVITEMS(STONEGOLEM, 0x8c95, 3);
}
...
instance CURSEDSTONEGOLEM(MST_DEFAULT_STONEGOLEM) {
    ...
    CREATEINVITEMS(CURSEDSTONEGOLEM, 0x8c95, 11);
}
...
instance NATURE_GOLEM(MST_DEFAULT_STONEGOLEM) {
    ...
    CREATEINVITEMS(NATURE_GOLEM, 0x8c95, 7);
...
func void ZS_GOLEMDOWN() {
    ...
    NPC_PERCENABLE(SELF, PERC_ASSESSPLAYER, 0xc729);
...
func void ZS_NATUREGOLEMDOWN() {
    ...
    SELF.SENSES_RANGE = 0xdac;
    NPC_SETPERCTIME(SELF, 0x3f800000);
    NPC_PERCENABLE(SELF, PERC_ASSESSPLAYER, 0xc72e);
    SELF.AIVAR[19] = NOTINPOS;
}
...
func void B_NATUREGOLEMRISE() {
    if ((((NPC_GETDISTTONPC(SELF, HERO)) <= (700)) && (NPC_HASITEMS(OTHER, 0x9067))) || ((SELF.ATTRIBUTE[0]) != (SELF.ATTRIBUTE[1]))) {
        AI_PLAYANI(SELF, "T_RISE");
        SELF.NOFOCUS = FALSE;
        SELF.NAME[0] = NAME_NATUREGOLEM;
        SELF.FLAGS = 0;
...
instance GOLEM_VOLFZACKE_01(MST_DEFAULT_STONEGOLEM) {
    ...
    CREATEINVITEMS(GOLEM_VOLFZACKE_01, 0x8c95, 7);
}
...
instance GOLEM_VOLFZACKE_02(MST_DEFAULT_STONEGOLEM) {
    ...
    AIVAR[43] = ID_GOLEMVOLFZACKE;
    DAMAGETYPE = DAM_BLUNT;
    CREATEINVITEMS(GOLEM_VOLFZACKE_02, 0x8c95, 7);
}
...
instance GOLEM_VOLFZACKE_03(MST_DEFAULT_STONEGOLEM) {
    ...
    AIVAR[43] = ID_GOLEMVOLFZACKE;
    DAMAGETYPE = DAM_BLUNT;
    CREATEINVITEMS(GOLEM_VOLFZACKE_03, 0x8c95, 7);
}
...
instance SQ312_STONEGOLEM_01(MST_DEFAULT_STONEGOLEM) {
    ...
    CREATEINVITEMS(SQ312_STONEGOLEM_01, 0x8c95, 3);
}
...
instance SQ312_STONEGOLEM_02(MST_DEFAULT_STONEGOLEM) {
    ...
    CREATEINVITEMS(SQ312_STONEGOLEM_02, 0x8c95, 2);
}
...
instance SQ312_STONEGOLEM_03(MST_DEFAULT_STONEGOLEM) {
    ...
    CREATEINVITEMS(SQ312_STONEGOLEM_03, 0x8c95, 3);
}
...
instance SQ312_STONEGOLEM_04(MST_DEFAULT_STONEGOLEM) {
    ...
    CREATEINVITEMS(SQ312_STONEGOLEM_04, 0x8c95, 2);
}
...
instance STONEGOLEM_Q403(MST_DEFAULT_STONEGOLEM) {
    ...
    CREATEINVITEMS(STONEGOLEM_Q403, 0x8c95, 4);
}
