...
func int DIA_MATEY_Q202_START_CONDITION() {
    if ((NPC_ISINSTATE(SELF, 0xf09f)) && ((LOG_GETSTATUS(MIS_Q202)) == (LOG_RUNNING))) {
        return TRUE;
    };
...
func void DIA_MATEY_Q202_START_INFO() {
    ...
    INFO_CLEARCHOICES(0x11f69);
    INFO_ADDCHOICE(0x11f69, "The rest of those waiting let me pass.", 0x11f6e);
    INFO_ADDCHOICE(0x11f69, "I don't have that much time, it's urgent.", 0x11f6d);
}

func void DIA_MATEY_Q202_START_NEXT() {
    AI_OUTPUT(SELF, OTHER, "DIA_Matey_Q202_Start_NoTime_03_03");
    INFO_CLEARCHOICES(0x11f69);
    INFO_ADDCHOICE(0x11f69, "I can read.", 0x11f6f);
}
...
func void DIA_MATEY_Q202_START_NOTIME_CANREAD() {
    ...
    CREATEINVITEMS(SELF, 0x90cd, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x90cd, 1);
...
var int Q202_QUESTIONS_OLDSTYLE = 0;
var int Q202_QUESTIONS_GOLD = 0;
var int Q202_QUESTIONS_WHO = 0;
...
func void DIA_MATEY_Q202_QUESTIONS_CHOICES() {
    INFO_CLEARCHOICES(0x11f70);
    INFO_ADDCHOICE(0x11f70, DIALOG_BACK, 0x11f76);
    if ((Q202_QUESTIONS_WHO) == (FALSE)) {
        INFO_ADDCHOICE(0x11f70, "Who can give me a letter of recommendation?", 0x11f7d);
    };
    if ((Q202_QUESTIONS_GOLD) == (FALSE)) {
        INFO_ADDCHOICE(0x11f70, "The citizenship is a big expense...", 0x11f79);
    };
    if ((Q202_QUESTIONS_OLDSTYLE) == (FALSE)) {
        INFO_ADDCHOICE(0x11f70, "From time immemorial, to become a citizen...", 0x11f78);
    };
}
...
func void DIA_MATEY_Q202_QUESTIONS_OLDSTYLE() {
    ...
    CREATEINVITEMS(SELF, 0x90d0, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x90d0, 1);
    DIA_MATEY_Q202_QUESTIONS_CHOICES();
}
...
func void DIA_MATEY_Q202_QUESTIONS_GOLD() {
    ...
    INFO_CLEARCHOICES(0x11f70);
    INFO_ADDCHOICE(0x11f70, "A broom?", 0x11f7b);
    INFO_ADDCHOICE(0x11f70, "You want me to sweep your floor?", 0x11f7c);
}
...
func void DIA_MATEY_SQ226_CLEAN_INFO() {
    ...
    if ((SQ226_JOBDONE) == (TRUE)) {
        ...
        if ((LOG_GETSTATUS(MIS_Q202)) != (LOG_SUCCESS)) {
            ...
            CREATEINVITEMS(SELF, 0x859b, SQ226_REWARD);
        } else {
...
var int CQ001_IWANTTOBUYBOOK = 0;
...
func void DIA_MATEY_CHESS_INFO() {
    ...
    INFO_CLEARCHOICES(0x11f85);
    INFO_ADDCHOICE(0x11f85, "Kuno sent me.", 0x11f88);
}
...
func void DIA_MATEY_CHESS_KUNO() {
    ...
    INFO_CLEARCHOICES(0x11f85);
    INFO_ADDCHOICE(0x11f85, "Bloody expensive. I'm not paying.", 0x11f8b);
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (MATEY_CHESS_KUNOGOLD)) {
        INFO_ADDCHOICE(0x11f85, "Here you go, here's 50 gold pieces.", 0x11f8a);
    };
}
...
func void DIA_MATEY_CHESS_KUNO_GOLD() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 0x859b, MATEY_CHESS_KUNOGOLD);
...
func int DIA_MATEY_CHESSBOOK_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_CQ001)) == (LOG_RUNNING)) && ((CQ001_CHESSBOOK) == (1))) && ((CQ001_IWANTTOBUYBOOK) == (TRUE))) && ((NPC_HASITEMS(OTHER, 0x859b)) >= (MATEY_CHESS_KUNOGOLD))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_MATEY_Q202_FINISH_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x922b)) >= (1)) {
...
func void DIA_MATEY_Q202_PAY_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (Q202_PRICE)) {
        B_GIVEINVITEMS(OTHER, SELF, 0x859b, Q202_PRICE);
        DIA_MATEY_Q202_FINISH_PASS();
    };
...
func int DIA_MATEY_SQ225_TESTAMENT_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ225)) == (LOG_RUNNING)) && ((SQ225_VALERIOTESTAMENT) == (1))) && ((NPC_HASITEMS(OTHER, 0x90e5)) >= (2))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_MATEY_SQ225_TESTAMENT_INFO() {
    ...
    NPC_REMOVEINVITEMS(SELF, 0x90e5, 2);
    B_USEFAKESCROLL();
    B_GIVEINVITEMS(OTHER, SELF, 0x90e5, 2);
    AI_STARTFACEANI(SELF, S_SERIOUS, 1, -(1));
    AI_OUTPUT(SELF, OTHER, "DIA_Matey_SQ225_Testament_03_08");
    INFO_CLEARCHOICES(0x11f99);
    INFO_ADDCHOICE(0x11f99, "Liam had it.", 0x11f9d);
    INFO_ADDCHOICE(0x11f99, "What does it matter?", 0x11f9e);
    INFO_ADDCHOICE(0x11f99, "I found in the vineyard area.", 0x11f9c);
}
...
func void DIA_MATEY_SQ225_TESTAMENT_LIAM() {
    ...
    INFO_CLEARCHOICES(0x11f99);
    INFO_ADDCHOICE(0x11f99, "It's Venzel's work.", 0x11fa3);
    INFO_ADDCHOICE(0x11f99, "I can't disclose my associate.", 0x11f9f);
}
...
func void DIA_MATEY_SQ225_TESTAMENT_LIAM_NO() {
    ...
    INFO_CLEARCHOICES(0x11f99);
    INFO_ADDCHOICE(0x11f99, "I'll bring it later.", 0x11fa4);
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (SQ225_MATEY_PAYFORWORK)) {
        INFO_ADDCHOICE(0x11f99, "All right, here. (100 GP)", 0x11fa2);
    };
}
...
func void DIA_MATEY_SQ225_TESTAMENT_END() {
    B_STANDUP();
    B_USEFAKESCROLL();
    CREATEINVITEMS(SELF, 0x90e8, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x90e8, 1);
...
var int MATEY_SQ225_YOURGOLD = 0;
func void DIA_MATEY_SQ225_TESTAMENT_LIAM_NO_HERE() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 0x859b, SQ225_MATEY_PAYFORWORK);
...
func int DIA_MATEY_SQ225_YOURGOLD_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ225)) == (LOG_RUNNING)) && ((MATEY_SQ225_YOURGOLD) == (1))) && ((NPC_HASITEMS(OTHER, 0x859b)) >= (SQ225_MATEY_PAYFORWORK))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_MATEY_SQ309_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ309)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x1274d))) && ((SQ309_MARVINSAWDOCUMENTABOUTMAILOR) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_MATEY_SQ309_INFO() {
    ...
    INFO_CLEARCHOICES(0x11fa8);
    INFO_ADDCHOICE(0x11fa8, "I don't have that much on me.", 0x11fac);
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (SQ309_MATEYINFORMATION)) {
        INFO_ADDCHOICE(0x11fa8, "Here's the payment. (25 GP)", 0x11fab);
    };
}

func void DIA_MATEY_SQ309_GOLD() {
    AI_OUTPUT(OTHER, SELF, "DIA_Matey_SQ309_Gold_15_01");
    B_GIVEINVITEMS(OTHER, SELF, 0x859b, SQ309_MATEYINFORMATION);
...
func int DIA_MATEY_YOURGOLD_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ309)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x11fa8))) && ((SQ309_NEEDMONEYMATEY) == (TRUE))) {
        if ((NPC_HASITEMS(OTHER, 0x859b)) >= (SQ309_MATEYINFORMATION)) {
            return TRUE;
        };
    };
...
func void DIA_MATEY_Q311_INFO() {
    ...
    INFO_CLEARCHOICES(0x11fb0);
    INFO_ADDCHOICE(0x11fb0, "I'm looking for the author of certain pamphlets.", 0x11fb4);
    INFO_ADDCHOICE(0x11fb0, "Who accepts writing assignments?", 0x11fb5);
}
...
func void DIA_MATEY_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x11fb9);
    INFO_ADDCHOICE(0x11fb9, DIALOG_BACK, 0x11fbd);
    INFO_ADDCHOICE(0x11fb9, DIALOG_PICKPOCKET, 0x11fbc);
}
