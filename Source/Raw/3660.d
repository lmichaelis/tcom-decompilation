...
var int CITYGUARD_FIRSTDIALOGUE = 0;
...
func void DIA_4021_CITYGUARD_FIRSTGATEVISIT_INFO() {
    if ((CITYGUARD_FIRSTDIALOGUE) == (FALSE)) {
        ...
        INFO_CLEARCHOICES(0x10503);
        INFO_ADDCHOICE(0x10503, "Actually, I'm just looking around.", 0x10511);
        INFO_ADDCHOICE(0x10503, "I think it's obvious, to the city.", 0x1050c);
    };
    ...
    if (((GQ001_CANTRYENTERCITY) == (TRUE)) && ((LOG_GETSTATUS(MIS_Q201)) == (LOG_RUNNING))) {
        if ((NPC_HASITEMS(OTHER, 0x9110)) > (0)) {
            INFO_ADDCHOICE(0x10503, "Here's my pass.", 0x10510);
        };
        ITM = NPC_GETEQUIPPEDARMOR(OTHER);
        if (((NPC_HASEQUIPPEDARMOR(OTHER)) == (TRUE)) && ((HLP_ISITEM(ITM, 0x8afd)) == (TRUE))) {
            if ((NPC_HASITEMS(OTHER, 0x9111)) > (0)) {
                INFO_ADDCHOICE(0x10503, "I have a letter here from the woodcutters' camp.", 0x10514);
            };
        };
    };
    INFO_ADDCHOICE(0x10503, "Not yet.", 0x10512);
    OTHER.AIVAR[13] = NPC_GETDISTTOWP(OTHER, CITYGUARD_CHECKPOINT);
    SELF.AIVAR[12] = GP_FIRSTWARNGIVEN;
}

instance DIA_4021_CITYGUARD_FIRSTGATEVISIT_INFO.ITM(C_ITEM)
...
func void DIA_4021_CITYGUARD_FIRSTGATEVISIT_TOCITY() {
    ...
    INFO_CLEARCHOICES(0x10503);
    INFO_ADDCHOICE(0x10503, "I don't have a pass.", 0x1050e);
    INFO_ADDCHOICE(0x10503, "I think I must have left it somewhere.", 0x1050f);
    if (((GQ001_CANTRYENTERCITY) == (TRUE)) && ((LOG_GETSTATUS(MIS_Q201)) == (LOG_RUNNING))) {
        if ((NPC_HASITEMS(OTHER, 0x9110)) > (0)) {
            INFO_ADDCHOICE(0x10503, "Here's my pass.", 0x10510);
        };
        ...
        if (((NPC_HASEQUIPPEDARMOR(OTHER)) == (TRUE)) && ((HLP_ISITEM(ITM, 0x8afd)) == (TRUE))) {
            if ((NPC_HASITEMS(OTHER, 0x9111)) > (0)) {
                INFO_ADDCHOICE(0x10503, "I have a letter here from the woodcuters' camp that I need to deliver to the shipyard.", 0x10514);
            };
        };
    };
...
instance DIA_4021_CITYGUARD_FIRSTGATEVISIT_TOCITY.ITM(C_ITEM)
...
func void DIA_4021_CITYGUARD_CUTTER_CHOICES() {
    INFO_CLEARCHOICES(0x10503);
    INFO_ADDCHOICE(0x10503, "You've got to be kidding me.", 0x10515);
    if (C_GOTANYKINDOFBEER(HERO)) {
        INFO_ADDCHOICE(0x10503, "I got something cold here for you and your buddy.", 0x10517);
    };
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (Q201_GATEGUARD_CUTTER_GOLD)) {
        INFO_ADDCHOICE(0x10503, "Maybe a few gold pieces will get the job done? (20 GP)", 0x10518);
    };
    INFO_CLEARCHOICES(0x10519);
    INFO_ADDCHOICE(0x10519, "You've got to be kidding me.", 0x10515);
    if (C_GOTANYKINDOFBEER(HERO)) {
        INFO_ADDCHOICE(0x10519, "I got something cold here for you and your buddy.", 0x10517);
    };
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (Q201_GATEGUARD_CUTTER_GOLD)) {
        INFO_ADDCHOICE(0x10519, "Maybe a few gold pieces will get the job done? (20 GP)", 0x10518);
    };
    INFO_CLEARCHOICES(0x10520);
    INFO_ADDCHOICE(0x10520, "You've got to be kidding me.", 0x10515);
    if (C_GOTANYKINDOFBEER(HERO)) {
        INFO_ADDCHOICE(0x10520, "I got something cold here for you and your buddy.", 0x10517);
    };
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (Q201_GATEGUARD_CUTTER_GOLD)) {
        INFO_ADDCHOICE(0x10520, "Maybe a few gold pieces will get the job done? (20 GP)", 0x10518);
    };
    INFO_CLEARCHOICES(0x10520);
    INFO_ADDCHOICE(0x10520, "You've got to be kidding me.", 0x10515);
    if (C_GOTANYKINDOFBEER(HERO)) {
...
func void DIA_4021_CITYGUARD_FIRSTGATEVISIT_GOLD() {
    B_GIVEINVITEMS(OTHER, SELF, 0x859b, Q201_GATEGUARD_CUTTER_GOLD);
...
func void DIA_CITYGUARD_SECONDWARN_INFO() {
    ...
    if (((GQ001_CANTRYENTERCITY) == (TRUE)) && ((LOG_GETSTATUS(MIS_Q201)) == (LOG_RUNNING))) {
        if ((NPC_HASITEMS(OTHER, 0x9110)) > (0)) {
            INFO_ADDCHOICE(0x10519, "Here's my pass.", 0x10510);
        };
        ITM = NPC_GETEQUIPPEDARMOR(OTHER);
        if (((NPC_HASEQUIPPEDARMOR(OTHER)) == (TRUE)) && ((HLP_ISITEM(ITM, 0x8afd)) == (TRUE))) {
            if ((NPC_HASITEMS(OTHER, 0x9111)) > (0)) {
                INFO_ADDCHOICE(0x10519, "I have a letter here from the woodcuters' camp that I need to deliver to the shipyard.", 0x10514);
            };
        };
    };
    OTHER.AIVAR[13] = NPC_GETDISTTOWP(OTHER, CITYGUARD_CHECKPOINT);
...
instance DIA_CITYGUARD_SECONDWARN_INFO.ITM(C_ITEM)
...
func int DIA_CITYGUARD_CITYENTER_CONDITION() {
    if (((KAPITEL) >= (0)) && ((KAPITEL) <= (2))) {
        if ((NPC_ISINSTATE(SELF, 0xf09f)) && ((CITYENTERED) == (FALSE))) {
            if (((GQ001_CANTRYENTERCITY) == (TRUE)) && ((LOG_GETSTATUS(MIS_Q201)) == (LOG_RUNNING))) {
                return TRUE;
            };
        };
...
func void DIA_CITYGUARD_CITYENTER_INFO() {
    INFO_CLEARCHOICES(0x10520);
    if ((NPC_HASITEMS(OTHER, 0x9110)) > (0)) {
        INFO_ADDCHOICE(0x10520, "Here's my pass.", 0x10510);
    };
    ITM = NPC_GETEQUIPPEDARMOR(OTHER);
    if (((NPC_HASEQUIPPEDARMOR(OTHER)) == (TRUE)) && ((HLP_ISITEM(ITM, 0x8afd)) == (TRUE))) {
        if ((NPC_HASITEMS(OTHER, 0x9111)) > (0)) {
            INFO_ADDCHOICE(0x10520, "I have a letter here from the woodcutters' camp.", 0x10514);
        };
    };
}

instance DIA_CITYGUARD_CITYENTER_INFO.ITM(C_ITEM)
...
func void DIA_CITYGUARD_Q312_WAITASEC_INFO() {
    ...
    INFO_CLEARCHOICES(0x10527);
    INFO_ADDCHOICE(0x10527, "What's going on here?", 0x1052a);
}
