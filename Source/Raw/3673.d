...
func int DIA_ALCAS_WHOAREYOU_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x106fa)) {
        return TRUE;
    };
...
func int DIA_ALCAS_ROYALGUARD_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x106fd)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ALCAS_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x1070c);
    INFO_ADDCHOICE(0x1070c, DIALOG_BACK, 0x10710);
    INFO_ADDCHOICE(0x1070c, DIALOG_PICKPOCKET, 0x1070f);
}
