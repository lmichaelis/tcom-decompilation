func void EVENTSMANAGER_Q311() {
    ...
    if (NPC_KNOWSINFO(HERO, 0x129dd)) {
        if ((Q311_TAVERNCUTSCENE) == (0)) {
            if ((NPC_GETDISTTOWP(HERO, "PARTM4_TAVERN_05")) <= (450)) {
                Q311_TAVERNCUTSCENE = 1;
                HERO.AIVAR[4] = TRUE;
                FF_APPLYONCEEXT(0xf915, 75, 4);
            };
        };
    };
    if (((((Q311_PROPAGANDIST02FLEE) == (FALSE)) && (NPC_HASGUILDARMOREQUIPPED(HERO, GIL_MIL))) && ((NPC_GETDISTTONPC(HERO, VLK_6416_PROPAGANDIST)) <= (750))) && (!(NPC_KNOWSINFO(HERO, 0x12afb)))) {
    ...
    if ((((Q311_PROPAGANDIST02FLEE) == (TRUE)) && ((NPC_GETDISTTOWP(VLK_6416_PROPAGANDIST, "PARTM1_PATH_95")) <= (500))) && ((NPC_ISINSTATE(VLK_6416_PROPAGANDIST, 0xf09f)) == (FALSE))) {
