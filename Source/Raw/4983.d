        ...
        if ((LOG_GETSTATUS(MIS_Q309)) != (LOG_RUNNING)) {
            if ((NPC_GETDISTTOWP(HERO, RNG_TRAP06_WAYPOINT)) <= (RNG_RADIUS_MEDIUM)) {
                if ((TRAP06_SPAWNED) == (FALSE)) {
                    ...
                    WLD_INSERTNPC(0xd8ac, "PARTM8_GRAVEROBBER_07");
                    WLD_INSERTNPC(0xd8aa, "PARTM8_GRAVEROBBER_09");
                    WLD_INSERTNPC(0xd8a8, "PARTM8_GRAVEROBBER_04A");
                    WLD_INSERTNPC(0xd8a6, "PARTM8_GRAVEROBBER_02");
