...
func int DIA_SCARMAN_SQ207_TROUBLE_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ207)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x122b0))) && ((SQ207_FAILED) == (FALSE))) {
        return TRUE;
    };
...
func void DIA_SCARMAN_SQ207_TROUBLE_INFO() {
    ...
    INFO_CLEARCHOICES(0x10b1f);
    INFO_ADDCHOICE(0x10b1f, "You wanted this...", 0x10b23);
    INFO_ADDCHOICE(0x10b1f, "I wonder what Volker has to say about this.", 0x10b24);
}

var int SCARMAN_SQ207_ARENAFIGHT = 0;
