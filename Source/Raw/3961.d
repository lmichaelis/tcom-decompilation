...
func void DIA_PROPAGANDIST02_HELLO_INFO() {
    ...
    INFO_CLEARCHOICES(0x12afb);
    INFO_ADDCHOICE(0x12afb, "Why not.", 0x12afe);
    INFO_ADDCHOICE(0x12afb, "What's in it?", 0x12aff);
    INFO_ADDCHOICE(0x12afb, "Where did you get those flyers?", 0x12b00);
}
...
func void DIA_PROPAGANDIST02_HELLO_YES() {
    ...
    INFO_ADDCHOICE(0x12afb, "(Chat)", 0x12b01);
}
...
func void DIA_PROPAGANDIST02_HELLO_FROM() {
    ...
    INFO_CLEARCHOICES(0x12afb);
    AI_STOPPROCESSINFOS(SELF);
    if (NPC_KNOWSINFO(OTHER, 0x12b17)) {
...
func void DIA_PROPAGANDIST02_HELLO_YES_TALK() {
    ...
    INFO_CLEARCHOICES(0x12afb);
    INFO_ADDCHOICE(0x12afb, "The governor has a problem.", 0x12b02);
    INFO_ADDCHOICE(0x12afb, "Who told you that?", 0x12b03);
}
...
func void DIA_PROPAGANDIST02_HELLO_YES_TALK_PROBLEM() {
    ...
    INFO_CLEARCHOICES(0x12afb);
    INFO_ADDCHOICE(0x12afb, "What can we, the common people, do about it?", 0x12b04);
}
...
var int PROPAGANDIST02_GOTYOU = 0;
func int DIA_PROPAGANDIST02_GOTYOU_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_Q311)) == (LOG_RUNNING)) && ((Q311_PROPAGANDIST02FLEE) > (0))) && ((PROPAGANDIST02_GOTYOU) == (0))) && (NPC_ISINSTATE(SELF, 0xf09f))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_PROPAGANDIST02_GOTYOU_INFO() {
    ...
    INFO_CLEARCHOICES(0x12b05);
    INFO_ADDCHOICE(0x12b05, "Get out of here.", 0x12b09);
    INFO_ADDCHOICE(0x12b05, "I despise worms like you.", 0x12b0a);
    Q311_SPAWNLUDLOF();
}
