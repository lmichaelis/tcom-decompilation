...
func int DIA_11302_BODYGUARD_WHATISGOINGON_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x11b2d)) {
        return TRUE;
    };
...
func int DIA_11302_BODYGUARD_TELLMEALREADY_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x11b30)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_11302_BODYGUARD_HAIAMINDANGER_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x11b33)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_11302_BODYGUARD_BEATME_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ314)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x11b36))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_11302_BODYGUARD_FIRSTAMBIENT_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_SQ314)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x11b39))) && (NPC_ISINSTATE(SELF, 0xf09f))) && ((TRAP17_SPAWNEDPHASE2) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_11302_BODYGUARD_HARDERDADDY_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ314)) == (LOG_RUNNING)) && ((TRAP17_SPAWNEDPHASE2) == (TRUE))) && (NPC_KNOWSINFO(OTHER, 0x11b51))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_11302_BODYGUARD_AMBIENT_CONDITION() {
    if (((NPC_ISINSTATE(SELF, 0xf09f)) && ((TRAP17_OUTCOME) != (0))) && ((TRAP17_SPAWNEDPHASE3) == (FALSE))) {
        if (NPC_KNOWSINFO(OTHER, 0x11b3f)) {
            return TRUE;
        };
    };
...
func void DIA_11302_BODYGUARD_AFTEREVENT_INFO() {
    if ((TRAP17_OUTCOME) == (1)) {
        ...
        CREATEINVITEMS(SELF, 0x859b, EVENT_TRAP17_ENDINGV1);
        B_GIVEINVITEMS(SELF, OTHER, 0x859b, EVENT_TRAP17_ENDINGV1);
    ...
    CREATEINVITEMS(SELF, 0x859b, EVENT_TRAP17_ENDINGV2);
    B_GIVEINVITEMS(SELF, OTHER, 0x859b, EVENT_TRAP17_ENDINGV2);
...
func int DIA_11302_BODYGUARD_ENDINGAMBIENT_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x11b48)) {
