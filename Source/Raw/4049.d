...
var int ARAXOS_GUARDMINE_03_PAYEDONCE = 0;
...
func int DIA_ARAXOS_GUARDMINE_03_LOOKAWAY_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x135ab)) && ((QA306_GOTOARAXOSMINE) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_ARAXOS_GUARDMINE_03_OFFER_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x135ae)) && ((ARAXOS_GUARDMINE_03_ALLOWUSTOGO) == (FALSE))) && ((QA306_GOTOARAXOSMINE) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}

var int GUARD_OFFER_GOLD = 0;
func void DIA_ARAXOS_GUARDMINE_03_OFFER_INFO() {
    INFO_CLEARCHOICES(0x135b1);
    INFO_ADDCHOICE(0x135b1, DIALOG_BACK, 0x135b7);
    INFO_ADDCHOICE(0x135b1, "Five nuggets is enough?", 0x135b5);
    if ((GUARD_OFFER_GOLD) == (FALSE)) {
        if ((NPC_HASITEMS(OTHER, 0x859b)) >= (1)) {
            INFO_ADDCHOICE(0x135b1, "I have some gold coins on me...", 0x135b6);
        };
    };
}
...
func void DIA_ARAXOS_GUARDMINE_03_OFFER_5ORE() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x837c)) >= (5)) {
        ...
        B_GIVEINVITEMS(OTHER, SELF, 0x837c, 5);
...
var int GUARD_QA306_BETTERPRICE = 0;
...
func void DIA_GUARD_QA306_ENTER() {
    ...
    INFO_CLEARCHOICES(0x135bf);
    AI_STOPPROCESSINFOS(SELF);
}

func void DIA_GUARD_QA306_PAY_INFO() {
    INFO_CLEARCHOICES(0x135bf);
    INFO_ADDCHOICE(0x135bf, DIALOG_BACK, 0x135c3);
    if ((GUARD_QA306_BETTERPRICE) == (TRUE)) {
        INFO_ADDCHOICE(0x135bf, "(Pay 5 gold nuggets)", 0x135c4);
    };
    INFO_ADDCHOICE(0x135bf, "(Pay 10 gold nuggets)", 0x135c5);
}
...
func void DIA_GUARD_QA306_PAY_10() {
    if ((NPC_HASITEMS(OTHER, 0x837c)) >= (10)) {
        ARAXOS_GUARDMINE_03_ALLOWUSTOGO = TRUE;
        NPC_REMOVEINVITEMS(SELF, 0x837c, 10);
        DIA_GUARD_QA306_ENTER();
    };
    B_SAY(SELF, OTHER, "$NOGOLD");
    DIA_GUARD_QA306_PAY_INFO();
