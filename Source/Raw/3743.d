...
func int DIA_BRADLOCK_HELLO_CONDITION() {
    if ((NPC_GETDISTTOWP(SELF, "PARTM4_VOLKER_IVY")) <= (0x7d0)) {
        return TRUE;
    };
...
func int DIA_BRADLOCK_VOLKER_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x10c7a)) && ((NPC_KNOWSINFO(OTHER, 0x11f16)) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_BRADLOCK_LOAN_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x10c7d)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_BRADLOCK_SQ225_START_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x10c7d)) && (NPC_KNOWSINFO(OTHER, 0x13ad8))) {
...
func void DIA_BRADLOCK_SQ225_START_INFO() {
    ...
    CREATEINVITEMS(SELF, 0x90d9, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x90d9, 1);
...
var int BRADLOCK_SQ225_QUESTIONS_ANDERAS = 0;
var int BRADLOCK_SQ225_QUESTIONS_HOLDWIG = 0;
func void DIA_BRADLOCK_SQ225_QUESTIONS_CHOICES() {
    INFO_CLEARCHOICES(0x10c86);
    INFO_ADDCHOICE(0x10c86, DIALOG_BACK, 0x10c8c);
    if ((BRADLOCK_SQ225_QUESTIONS_HOLDWIG) == (FALSE)) {
        INFO_ADDCHOICE(0x10c86, "Do you know anything about Holdwig?", 0x10c8e);
    };
    if ((BRADLOCK_SQ225_QUESTIONS_ANDERAS) == (FALSE)) {
        INFO_ADDCHOICE(0x10c86, "What can you tell me about Andreas?", 0x10c8d);
    };
}
...
func void DIA_BRADLOCK_SQ225_QUESTIONS_ANDERAS() {
    ...
    INFO_CLEARCHOICES(0x10c86);
    INFO_ADDCHOICE(0x10c86, "Where can I find him?", 0x10c8f);
}
...
func int DIA_BRADLOCK_SQ225_FINISH_CONDITION() {
    if ((NPC_ISINSTATE(SELF, 0xf09f)) && ((LOG_GETSTATUS(MIS_SQ225)) == (LOG_RUNNING))) {
        if ((((SQ225_VALERIOTESTAMENT) == (2)) || (NPC_KNOWSINFO(OTHER, 0x11a22))) || (NPC_KNOWSINFO(OTHER, 0xfea7))) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
...
func void DIA_BRADLOCK_SQ225_FINISH_INFO() {
    ...
    INFO_CLEARCHOICES(0x10c91);
    if (NPC_KNOWSINFO(OTHER, 0xfea7)) {
        INFO_ADDCHOICE(0x10c91, "Holdwig has full control of the vineyard.", 0x10c96);
    };
    if (NPC_KNOWSINFO(OTHER, 0x11a22)) {
        INFO_ADDCHOICE(0x10c91, "Andreas regained control of the vineyard.", 0x10c97);
    };
    if ((SQ225_VALERIOTESTAMENT) == (2)) {
        INFO_ADDCHOICE(0x10c91, "The brothers manage the vineyard together.", 0x10c98);
    };
    INFO_ADDCHOICE(0x10c91, "Shouldn't I report to the boss?", 0x10c94);
...
func void DIA_BRADLOCK_SQ225_REWARD_INFO() {
    ...
    if ((SQ225_FINISHWAY) == (3)) {
        CREATEINVITEMS(SELF, 0x859b, SQ225_FINALREWARD_V2);
        B_GIVEINVITEMS(SELF, OTHER, 0x859b, SQ225_FINALREWARD_V2);
        AI_STARTFACEANI(OTHER, S_WHAT, 1, -(1));
    ...
    AI_RESETFACEANI(OTHER);
    CREATEINVITEMS(SELF, 0x859b, SQ225_FINALREWARD_V1);
    B_GIVEINVITEMS(SELF, OTHER, 0x859b, SQ225_FINALREWARD_V1);
...
func void DIA_BRADLOCK_Q308HELLO_INVESTIGATIONADDCHOICE() {
    INFO_ADDCHOICE(0x10c9c, "I'm here about the investigation.", 0x10ca5);
}
...
func void DIA_BRADLOCK_Q308HELLO_INFO() {
    ...
    INFO_CLEARCHOICES(0x10c9c);
    DIA_BRADLOCK_Q308HELLO_INVESTIGATIONADDCHOICE();
    INFO_ADDCHOICE(0x10c9c, "I want to work for him.", 0x10ca4);
}
...
func void DIA_BRADLOCK_Q308HELLO_COMEIN() {
    ...
    TELEPORTNPCTOWP(0xd09a, "PARTM4_VOLKER_HOUSE_FIREPLACE");
}
...
func void DIA_BRADLOCK_Q308HELLO_FINALCHOICE() {
    INFO_CLEARCHOICES(0x10c9c);
    INFO_ADDCHOICE(0x10c9c, "Does that mean you'll take me to Volker?", 0x10ca1);
    INFO_ADDCHOICE(0x10c9c, "Does that mean you'll take me to the Usurer?", 0x10ca2);
}
...
func void DIA_BRADLOCK_Q308HELLO_WORK() {
    ...
    INFO_CLEARCHOICES(0x10c9c);
    INFO_ADDCHOICE(0x10c9c, "I have valuable skills.", 0x10ca6);
}
...
func void DIA_BRADLOCK_Q308HELLO_WORK_SKILL() {
    ...
    if ((Q306_TOURNAMENTSTATUS) == (1)) {
        INFO_ADDCHOICE(0x10c9c, "I deal with thugs pretty well.", 0x10ca7);
    };
}
...
func int DIA_BRADLOCK_VOLKERTRIALOG_CONDITION() {
    if (((LOG_GETSTATUS(MIS_Q308)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x10c9c))) {
...
func void DIA_BRADLOCK_INFORMATIONS_INFO() {
    ...
    INFO_CLEARCHOICES(0x10cab);
    INFO_ADDCHOICE(0x10cab, "And yet, by some miracle, the attempt happened.", 0x10cae);
}
...
func void DIA_BRADLOCK_INFORMATIONS_INFOS() {
    ...
    INFO_CLEARCHOICES(0x10cab);
    INFO_ADDCHOICE(0x10cab, "Tell me about this boy.", 0x10caf);
}
...
func void DIA_BRADLOCK_INFORMATIONS_INFO_BOY() {
    ...
    INFO_CLEARCHOICES(0x10cab);
    INFO_ADDCHOICE(0x10cab, "Do you have the bolthead with you?", 0x10cb0);
}
...
func void DIA_BRADLOCK_AFTERMINE_INFO() {
    ...
    INFO_CLEARCHOICES(0x10cb2);
    if ((Q402_STRANGENOTELOGENTRY) == (TRUE)) {
        INFO_ADDCHOICE(0x10cb2, "I'm close to finding out where this organization's hideout is.", 0x10cb9);
    };
    if (NPC_KNOWSINFO(OTHER, 0x13d6a)) {
        INFO_ADDCHOICE(0x10cb2, "I was attacked by several people in the Den.", 0x10cb8);
    };
    if (NPC_KNOWSINFO(OTHER, 0x13fa9)) {
        INFO_ADDCHOICE(0x10cb2, "Has Ivy been here lately?", 0x10cb7);
    };
    INFO_ADDCHOICE(0x10cb2, "Why doesn't Volker let anyone in?", 0x10cb6);
}
...
func int DIA_BRADLOCK_CANTPASS_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x10cb2)) && (NPC_ISINSTATE(SELF, 0xf09f))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_BRADLOCK_CANYOUTEACHME_CONDITION() {
    if ((((NPC_KNOWSINFO(OTHER, 0x10cab)) && (NPC_ISINSTATE(SELF, 0xf09f))) && ((LOG_GETSTATUS(MIS_Q308)) == (LOG_RUNNING))) || ((((LOG_GETSTATUS(MIS_Q308)) == (LOG_SUCCESS)) && ((BRADLOCKNOTEACH) == (FALSE))) && ((KAPITEL) < (5)))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
var int BRADLOCK_CURRENTSTRLEVEL = 0;
var int BRADLOCK_NOMORE = 0;
...
func int DIA_BRADLOCK_TRAIN_CONDITION() {
    if ((((NPC_KNOWSINFO(OTHER, 0x10cbd)) && ((BRADLOCK_NOMORE) == (FALSE))) && ((BRADLOCKNOTEACH) == (FALSE))) && ((KAPITEL) < (5))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_BRADLOCK_TRAIN_CHOICES() {
    ...
    INFO_CLEARCHOICES(0x10cc4);
    INFO_ADDCHOICE(0x10cc4, DIALOG_BACK, 0x10cc9);
    INFO_ADDCHOICE(0x10cc4, B_BUILDLEARNSTRING2(PRINT_LEARNSTR1, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_STRENGTH, 1), BRADLOCK_GOLDCOST), 0x10cca);
    INFO_ADDCHOICE(0x10cc4, B_BUILDLEARNSTRING2(PRINT_LEARNSTR5, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_STRENGTH, 5), (BRADLOCK_GOLDCOST) * (5)), 0x10ccb);
}

var int DIA_BRADLOCK_TRAIN_CHOICES.BRADLOCK_GOLDCOST = 0;
...
func void DIA_BRADLOCK_TRAINSTR_1() {
    if (((NPC_HASITEMS(OTHER, 0x859b)) >= (BRADLOCK_PAYMENT1)) && ((OTHER.AIVAR[81]) >= (30))) {
        if ((BRADLOCK_CURRENTSTRLEVEL) < (OTHER.AIVAR[81])) {
            SND_PLAY(GELDBEUTEL);
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, BRADLOCK_PAYMENT1);
            NPC_REMOVEINVITEMS(SELF, 0x859b, BRADLOCK_PAYMENT1);
        };
        B_TEACHATTRIBUTEPOINTS(SELF, OTHER, ATR_STRENGTH, 1, 120);
        DIA_BRADLOCK_TRAIN_CHOICES();
    };
    if ((NPC_HASITEMS(OTHER, 0x859b)) < (BRADLOCK_PAYMENT1)) {
...
func void DIA_BRADLOCK_TRAINSTR_5() {
    if (((NPC_HASITEMS(OTHER, 0x859b)) >= (BRADLOCK_PAYMENT5)) && ((OTHER.AIVAR[81]) >= (30))) {
        if ((BRADLOCK_CURRENTSTRLEVEL) < (OTHER.AIVAR[81])) {
            SND_PLAY(GELDBEUTEL);
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, BRADLOCK_PAYMENT5);
            NPC_REMOVEINVITEMS(SELF, 0x859b, BRADLOCK_PAYMENT5);
        };
        B_TEACHATTRIBUTEPOINTS(SELF, OTHER, ATR_STRENGTH, 5, 120);
        DIA_BRADLOCK_TRAIN_CHOICES();
    };
    if ((NPC_HASITEMS(OTHER, 0x859b)) < (BRADLOCK_PAYMENT5)) {
...
func int DIA_BRADLOCK_SQ207_VOLKER_CONDITION() {
    if ((((((LOG_GETSTATUS(MIS_SQ207)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x122b0))) && (NPC_KNOWSINFO(OTHER, 0x10c7a))) && ((SQ207_BORISRESULT) == (0))) && ((SQ207_FAILED) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_BRADLOCK_SQ207_VOLKER_INFO() {
    ...
    INFO_CLEARCHOICES(0x10ccc);
    INFO_ADDCHOICE(0x10ccc, "Why do you allow your men to make life miserable for honest citizens?", 0x10cd2);
}
...
func void DIA_BRADLOCK_SQ207_VOLKER_WHY() {
    ...
    CREATEINVITEMS(SELF, 0x910d, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x910d, 1);
    ...
    INFO_CLEARCHOICES(0x10ccc);
    INFO_ADDCHOICE(0x10ccc, "You get business done quickly.", 0x10cd3);
}
...
func int DIA_BRADLOCK_AMBIENT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x10c7d)) && (!(NPC_KNOWSINFO(OTHER, 0x10cb2)))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_BRADLOCK_FREEARMOR_INFO() {
    ...
    CREATEINVITEMS(SELF, 0x8a97, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x8a97, 1);
    AI_EQUIPARMOR(OTHER, 0x8a97);
}
...
func void DIA_BRADLOCK_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x10cda);
    INFO_ADDCHOICE(0x10cda, DIALOG_BACK, 0x10cde);
    INFO_ADDCHOICE(0x10cda, DIALOG_PICKPOCKET, 0x10cdd);
}
