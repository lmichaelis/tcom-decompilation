func void KQ401_SPAWNNPC() {
    ...
    FF_APPLYONCEEXTGT(0xf145, 0, -(1));
    if (HLP_ISVALIDNPC(VLK_6104_GUY)) {
        B_STARTOTHERROUTINE(VLK_6104_GUY, "KQ401");
    };
    WLD_INSERTNPC(0xd1f0, "PARTM4_MERCHANTGUIDE_04");
    WLD_INSERTNPC(0xd1ca, "PARTM5_CITYHALL_GUARD_01");
    WLD_INSERTNPC(0xd1d7, "PARTM5_CITYHALL_GUARD_02");
    WLD_INSERTNPC(0xd27f, "HARBOUR_KQ402_GUARDSMAN_01");
    WLD_INSERTNPC(0xd1e6, "PARTM5_CITYHALL_GUARD_03");
}
...
var int KQ401_MOVERS_APPLY.KQ401_MOVERS_APPLY_COLLISION = 0;
instance KQ401_MOVERS_APPLY.MOVER1(ZCMOVER)
instance KQ401_MOVERS_APPLY.MOVER2(ZCMOVER)
instance KQ401_MOVERS_APPLY.MOVER3(ZCMOVER)
instance KQ401_MOVERS_APPLY.MOVER4(ZCMOVER)
instance KQ401_MOVERS_APPLY.MOVER5(ZCMOVER)
var int KQ401_MOVERS_APPLY.MOVPTR1 = 0;
var int KQ401_MOVERS_APPLY.MOVPTR2 = 0;
var int KQ401_MOVERS_APPLY.MOVPTR3 = 0;
var int KQ401_MOVERS_APPLY.MOVPTR4 = 0;
var int KQ401_MOVERS_APPLY.MOVPTR5 = 0;
...
var int KQ401_OPENDOOR_APPLY.KQ401_OPENDOOR_APPLY_COLLISION = 0;
instance KQ401_OPENDOOR_APPLY.MOVER1(ZCMOVER)
var int KQ401_OPENDOOR_APPLY.MOVPTR1 = 0;
func void KQ401_TELEPORTTOGRAYSON() {
    FADESCREENTOBLACKF(1, 0xf14a, 1000);
}
