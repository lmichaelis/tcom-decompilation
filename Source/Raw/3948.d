...
func void DIA_NIVEL_SQ301_WEWON_INFO() {
    ...
    INFO_CLEARCHOICES(0x12904);
    INFO_ADDCHOICE(0x12904, "We'll live to see.", 0x12907);
    INFO_ADDCHOICE(0x12904, "As soon as I hear about something, I'll let you know.", 0x12909);
}
...
func int DIA_NIVEL_Q504_FEEL_CONDITION() {
    if ((((NPC_GETDISTTOWP(SELF, "PART5_WORKERSCAMP_SMALLTALK_01")) <= (0x7d0)) && ((Q504_TAKEWORKERS) == (2))) && ((Q504_NIVELMIROHVOLFZACKE) == (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_NIVEL_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x1290d);
    INFO_ADDCHOICE(0x1290d, DIALOG_BACK, 0x12911);
    INFO_ADDCHOICE(0x1290d, DIALOG_PICKPOCKET, 0x12910);
}
