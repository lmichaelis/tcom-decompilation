func void EVENTSMANAGER_SQ220() {
    if ((LOG_GETSTATUS(MIS_SQ220)) == (LOG_RUNNING)) {
        if ((SQ220_ARENAFIGHT) == (1)) {
            if (((NPC_ISINSTATE(NONE_10037_EWALD, 0xf0a3)) && (NPC_ISINSTATE(NONE_3400_EWALDFRIEND, 0xf0a3))) && (NPC_ISINSTATE(NONE_3401_EWALDFRIEND, 0xf0a3))) {
                PRINTD("Wygrana");
                SQ220_ARENAFIGHT = 2;
                ...
                NONE_3400_EWALDFRIEND.AIVAR[96] = 4;
                NONE_3401_EWALDFRIEND.AIVAR[96] = 6;
                if (!(NPC_ISINSTATE(NONE_10037_EWALD, 0xf0a3))) {
    ...
    if ((LOG_GETSTATUS(MIS_SQ220)) == (LOG_SUCCESS)) {
        if ((SQ220_REMOVENPC) == (0)) {
            if ((NPC_GETDISTTONPC(HERO, NONE_10037_EWALD)) >= (0x9c4)) {
                PRINTD("NPC nie ma");
                SQ220_REMOVENPC = 1;
                B_REMOVENPC(0xcce9);
                B_REMOVENPC(0xcfaa);
