var int TIMOWILLREMEMBERTHAT = 0;
...
func void DIA_TIMO_Q102_HELLO_INFO() {
    ...
    INFO_CLEARCHOICES(0x164b6);
    INFO_ADDCHOICE(0x164b6, "I didn't help you because I felt sorry for you.", 0x164b9);
    INFO_ADDCHOICE(0x164b6, "Oh, come on. I did what anyone would do in my position.", 0x164ba);
}
...
func int DIA_TIMO_HOWAREYOU_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x164b6)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_TIMO_GREATMEETING_INFO() {
    ...
    INFO_ADDCHOICE(0x164c1, "Well, a lesson with me will cost you...", 0x164c6);
    INFO_ADDCHOICE(0x164c1, "Sure, no problem!", 0x164c7);
    INFO_ADDCHOICE(0x164c1, "Sorry, I'm not fit to be a teacher.", 0x164c5);
}
...
func void DIA_TIMO_GREATMEETING_GIVEMONEY() {
    ...
    CREATEINVITEMS(SELF, 0x859b, EVENT_TIMOSGOLD);
    B_GIVEINVITEMS(SELF, OTHER, 0x859b, EVENT_TIMOSGOLD);
