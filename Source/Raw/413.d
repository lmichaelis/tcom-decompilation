instance DIA_VLK_CITY_Q209_WHEREJORN(C_INFO) {
    NR = 10;
    CONDITION = DIA_VLK_CITY_Q209_WHEREJORN_CONDITION;
    INFORMATION = DIA_VLK_CITY_Q209_WHEREJORN_INFO;
    PERMANENT = TRUE;
    DESCRIPTION = "My brother Jorn is missing. Maybe you've heard something?";
}
...
var int DIA_VLK_CITY_Q209_WHEREJORN_INFO.RNGANWSER = 0;
var int DIA_VLK_CITY_Q209_WHEREJORN_INFO.Q209_WHEREJORN_COUNT = 0;
...
func int DIA_VLK_CITY_Q206_SMUGGLERS_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_Q206)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x11296))) && ((NPC_GETDISTTONPC(VLK_3018_OLAF, OTHER)) <= (0xdac))) && ((NPC_KNOWSINFO(OTHER, 0x11299)) == (FALSE))) {
        if ((SELF.AIVAR[93]) <= (WLD_GETDAY())) {
            return TRUE;
        };
    };
...
var int DIA_VLK_CITY_Q206_SMUGGLERS_INFO.RNGANWSER = 0;
...
var int DIA_VLK_CITY_Q206_FINBARBODY_INFO.RNGANWSER = 0;
