func void KQ405_HUNTERS_CHANGEARMORSSTATS() {
    ...
    NPC_CHANGEARMOR(BDT_6289_VILLAN, 0x8a63);
    NPC_REMOVEINVITEMS(BDT_6289_VILLAN, 0x9b38, 1);
    B_SETFIGHTSKILLS(BDT_6289_VILLAN, 40);
    NPC_REMOVEINVITEMS(BDT_6289_VILLAN, 0x8a46, 1);
    CREATEINVITEMS(BDT_6289_VILLAN, 0x9a94, 1);
    MDL_APPLYOVERLAYMDS(BDT_6289_VILLAN, HUMANSARROGANCEMDS);
    B_SETATTRIBUTESTOLEVEL(BDT_6289_VILLAN, 38);
    NPC_CHANGEARMOR(BDT_6290_BANDIT, 0x8a64);
    NPC_REMOVEINVITEMS(BDT_6290_BANDIT, 0x9b38, 1);
    B_SETFIGHTSKILLS(BDT_6290_BANDIT, 40);
    NPC_REMOVEINVITEMS(BDT_6290_BANDIT, 0x8a4b, 1);
    CREATEINVITEMS(BDT_6290_BANDIT, 0x9aa5, 1);
    MDL_APPLYOVERLAYMDS(BDT_6290_BANDIT, HUMANSMILITIAMDS);
    B_SETATTRIBUTESTOLEVEL(BDT_6290_BANDIT, 40);
    NPC_CHANGEARMOR(BDT_6288_MYRMIDON, 0x8a65);
    NPC_REMOVEINVITEMS(BDT_6288_MYRMIDON, 0x8a6e, 1);
    B_SETFIGHTSKILLS(BDT_6288_MYRMIDON, 40);
    CREATEINVITEMS(BDT_6288_MYRMIDON, 0x9243, 1);
...
func void KQ405_HUNTERSSPAWN() {
    ...
    WLD_INSERTNPC(0xe25b, "PART13_KQ405_SPAWNHUNTER_03");
    WLD_INSERTNPC(0xe264, "PART13_KQ405_SPAWNHUNTER_02");
    WLD_INSERTNPC(0xe2b4, "PART13_KQ405_SPAWNHUNTER_01");
    KQ405_HUNTERSRTN_01();
...
var int KQ405_SEWERS_CORPSES_APPLY.KQ405_SEWERS_CORPSES_COUNT = 0;
instance KQ405_SEWERS_CORPSES_APPLY.MOVER1(ZCMOVER)
instance KQ405_SEWERS_CORPSES_APPLY.MOVER2(ZCMOVER)
instance KQ405_SEWERS_CORPSES_APPLY.MOVER3(ZCMOVER)
instance KQ405_SEWERS_CORPSES_APPLY.MOVER4(ZCMOVER)
var int KQ405_SEWERS_CORPSES_APPLY.MOVPTR1 = 0;
var int KQ405_SEWERS_CORPSES_APPLY.MOVPTR2 = 0;
var int KQ405_SEWERS_CORPSES_APPLY.MOVPTR3 = 0;
var int KQ405_SEWERS_CORPSES_APPLY.MOVPTR4 = 0;
