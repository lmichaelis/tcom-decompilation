...
func int DIA_CUSTO_ABOUTFRED_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x13a20)) {
        return TRUE;
    };
...
func int DIA_CUSTO_HELPFREDPLEASE_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x138ad)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void CUSTO_TELEPORTNOVIZE() {
    ...
    TELEPORTNPCTOWP(0xdd07, "PART8_MONASTERY_SCAREDFRED");
...
func int DIA_CUSTO_AMBIENT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x138b4)) || (NPC_KNOWSINFO(OTHER, 0x138ad))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_CUSTO_HOWDIDYOUGETHERE_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x138bd)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_CUSTO_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x138c0);
    INFO_ADDCHOICE(0x138c0, DIALOG_BACK, 0x138c4);
    INFO_ADDCHOICE(0x138c0, DIALOG_PICKPOCKET, 0x138c3);
}
