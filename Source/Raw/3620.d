...
func void DIA_TERRY_SQ116_CUTSCENE_INFO() {
    ...
    INFO_CLEARCHOICES(0xfe24);
    INFO_ADDCHOICE(0xfe24, "You should be taught a lesson! (Attack)", 0xfe28);
    INFO_ADDCHOICE(0xfe24, "Wait a minute, let's talk to him first.", 0xfe29);
}
...
func int DIA_TERRY_GQ001_JORNV1_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x1575a)) && ((GQ001_INFOFROMDICKON) == (TRUE))) && ((LOG_GETSTATUS(MIS_GQ001)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_TERRY_GQ001_JORNV2_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x1575a)) && ((GQ001_INFOFROMDICKON) == (FALSE))) && ((LOG_GETSTATUS(MIS_GQ001)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
var int DIA_TERRY_GQ001_COUNT.GQ001_TERRYINFORMATIONJORN = 0;
func void DIA_TERRY_GQ001_SAWSOMEONE_CHOICES() {
    INFO_ADDCHOICE(0xfe51, "Do you remember which way they went?", 0xfe58);
    INFO_ADDCHOICE(0xfe51, "How do you know the guy they were carrying was drunk?", 0xfe59);
    if ((TERRY_GQ001_2POINTS) == (FALSE)) {
        INFO_ADDCHOICE(0xfe51, "Remember what they looked like?", 0xfe5a);
    };
    INFO_ADDCHOICE(0xfe5b, "Do you remember which way they went?", 0xfe58);
    INFO_ADDCHOICE(0xfe5b, "How do you know the guy they were carrying was drunk?", 0xfe59);
    if ((TERRY_GQ001_2POINTS) == (FALSE)) {
        INFO_ADDCHOICE(0xfe5b, "Remember what they looked like?", 0xfe5a);
    };
}
...
func void DIA_TERRY_AMBIENT_INFO() {
    ...
    if (((GQ001_TALKEDWITHTERRYABOUTJORN) == (FALSE)) && (!(NPC_KNOWSINFO(OTHER, 0xfe38)))) {
        AI_OUTPUT(SELF, OTHER, "DIA_Terry_Ambient_03_01");
    };
    if (((GQ001_TALKEDWITHTERRYABOUTJORN) == (TRUE)) && (!(NPC_KNOWSINFO(OTHER, 0xfe38)))) {
        AI_OUTPUT(SELF, OTHER, "DIA_Terry_Ambient_03_02");
    };
    if (NPC_KNOWSINFO(OTHER, 0xfe38)) {
...
func int DIA_TERRY_SQ116_ABOUTHOLDWIG_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_SQ116)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0xfd7b))) && ((SQ116_GUMBERTINFORMATIONS_THERRY) == (TRUE))) && ((NPC_KNOWSINFO(OTHER, 0xfd85)) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_TERRY_SQ116_ABOUTHOLDWIG_INFO() {
    ...
    DIA_TERRY_ASKHOLDWIG();
    INFO_CLEARCHOICES(0xfe61);
    INFO_ADDCHOICE(0xfe61, "Don't play dumb, tell me what you know.", 0xfe64);
}
...
func void DIA_TERRY_SQ116_ABOUTHOLDWIG_TALK() {
    ...
    DIA_TERRY_WHATSGOINGON();
    INFO_CLEARCHOICES(0xfe61);
    INFO_ADDCHOICE(0xfe61, "Okay, relax, I believe you.", 0xfe67);
    INFO_ADDCHOICE(0xfe61, "(Intimidate)", 0xfe66);
}

var int TERRY_SCAREDINDIALOGUE = 0;
...
func int DIA_TERRY_TAKEGOLD_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0xfe44)) && ((NPC_HASITEMS(OTHER, 0x859b)) >= (HOMELESS_ASKFORMONEY))) {
...
var int DIA_TERRY_TAKEGOLD_INFO.TERRY_GOLDCOUNT = 0;
...
func void DIA_TERRY_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0xfe6c);
    INFO_ADDCHOICE(0xfe6c, DIALOG_BACK, 0xfe70);
    INFO_ADDCHOICE(0xfe6c, DIALOG_PICKPOCKET, 0xfe6f);
}
