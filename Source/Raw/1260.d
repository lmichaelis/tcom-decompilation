instance MIL_4017_ARWID(NPC_DEFAULT) {
    ...
    EQUIPITEM(MIL_4017_ARWID, 0x9a4c);
    B_SETNPCVISUAL(MIL_4017_ARWID, MALE, HUMHEADPONY, FACE_N_ARWID, BODYTEX_N, 0x8a9a);
...
instance MIL_4017_ARWID_KQ402(NPC_DEFAULT) {
    ...
    if ((MARVIN_MILITIA_WHEREJOINED) == (1)) {
        if ((ARWID_TIERARMOR) == (1)) {
            EQUIPITEM(MIL_4017_ARWID_KQ402, 0x8512);
        } else {
            EQUIPITEM(MIL_4017_ARWID_KQ402, 0x9a4c);
        } else {
            /* set_instance(0) */;
        };
    };
    if ((MARVIN_MILITIA_WHEREJOINED) == (2)) {
        if ((ARWID_TIERARMOR) == (3)) {
            CREATEINVITEMS(MIL_4017_ARWID_KQ402, 0x8650, 20);
            EQUIPITEM(MIL_4017_ARWID_KQ402, 0x8652);
        } else {
            EQUIPITEM(MIL_4017_ARWID_KQ402, 0x9a4c);
        } else {
            /* set_instance(0) */;
    ...
    EQUIPITEM(MIL_4017_ARWID_KQ402, 0x9a4c);
    B_SETNPCVISUAL(MIL_4017_ARWID_KQ402, MALE, HUMHEADPONY, FACE_N_ARWID, BODYTEX_N, 0x846f);
