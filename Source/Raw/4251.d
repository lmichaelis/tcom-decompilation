...
func void STONE_Q514_CAMERA_ENABLE() {
    ...
    TELEPORTNPCTOWP(0x71b, "VOLFZACK_FORGE_01");
    TELEPORTNPCTOWP(0xe6e7, "VOLFZACK_FORGE_02");
}
...
func void DIA_STONE_VZ_Q514_WATER_INFO() {
    B_GIVEINVITEMS(OTHER, SELF, 0x84be, 10);
    ...
    CREATEINVITEMS(SELF, 0x8cfa, 1);
    AI_USEITEMTOSTATE(SELF, 0x8cfa, 1);
    AI_FUNCTION(SELF, 0xefae);
    AI_USEITEMTOSTATE(SELF, 0x8cfa, -(1));
    B_STANDUP();
...
func int DIA_STONE_VZ_Q514_MAKE_CONDITION() {
    if (((LOG_GETSTATUS(MIS_Q514)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x15289))) {
        return TRUE;
    };
...
func void STONE_Q514_MAKECHOICES() {
    INFO_CLEARCHOICES(0x1528c);
    INFO_ADDCHOICE(0x1528c, DIALOG_BACK, 0x15290);
    if ((NPC_HASITEMS(OTHER, 0x8a70)) >= (1)) {
        return;
    };
}
...
func void DIA_STONE_VZ_Q514_MAKE_OLDARMOR() {
    INFO_CLEARCHOICES(0x1528c);
    INFO_ADDCHOICE(0x1528c, "I have nothing to lose anyway. Try to fix it.", 0x15292);
    INFO_ADDCHOICE(0x1528c, "I think I'll keep it for myself.", 0x15293);
}
...
func void DIA_STONE_VZ_TEACH_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (STONE_VZ_SMITH_01)) {
        if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_SMITH)) == (1)) {
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, STONE_VZ_SMITH_01);
...
func void DIA_STONE_VZ_TEACH2_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (STONE_VZ_SMITH_02)) {
        if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_SMITH)) == (2)) {
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, STONE_VZ_SMITH_02);
...
func void DIA_STONE_VZ_AMBIENT_RANDOM() {
    ...
    if ((NPC_GETLASTAMBIENT(SELF)) == (1)) {
        if ((NPC_KNOWSINFO(OTHER, 0x15284)) == (FALSE)) {
...
func void DIA_STONE_VZ_AMBIENT_INFO() {
    ...
    if ((Q514_CAMPISREADY) == (TRUE)) {
        if (NPC_HASEQUIPPEDARMOR(HERO)) {
            ...
            if (HLP_ISITEM(HEROARMOR, 0x8a72)) {
                AI_STARTFACEANI(SELF, S_SMUG, 1, -(1));
...
instance DIA_STONE_VZ_AMBIENT_INFO.HEROARMOR(C_ITEM)
...
func int DIA_STONE_VZ_Q514_OLDARMOR_CONDITION() {
    if (((Q514_CRAWLER_FINISH) == (0)) && ((NPC_HASITEMS(OTHER, 0x8a70)) >= (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}

var int STONE_Q514_OLDARMOR_BETTER = 0;
func void DIA_STONE_VZ_Q514_OLDARMOR_INFO() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 0x8a70, 1);
    AI_OUTPUT(OTHER, SELF, "DIA_Stone_VZ_Q514_Make_Yes_15_01");
    AI_RESETFACEANI(SELF);
    AI_RESETFACEANI(OTHER);
    if (((VOLFZACKEARMOR_READ) == (TRUE)) && ((NPC_HASITEMS(OTHER, 0x9bfa)) >= (1))) {
        INFO_CLEARCHOICES(0x1529f);
        INFO_ADDCHOICE(0x1529f, "I found a book describing the craft of the Vardhal armorers.", 0x152a3);
    };
...
func void DIA_STONE_VZ_Q514_OLDARMOR_BOOK() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 0x9bfa, 1);
    ...
    AI_OUTPUT(SELF, OTHER, "DIA_Stone_VZ_Q514_Make_03_02");
    CREATEINVITEMS(SELF, 0x9bfd, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x9bfd, 1);
    INFO_CLEARCHOICES(0x1529f);
...
func int DIA_STONE_VZ_Q514_GOTLIST_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x1529f)) && ((STONE_Q514_OLDARMOR_BETTER) == (TRUE))) && ((Q514_CRAWLER_FINISH) == (0))) {
        if ((((((NPC_HASITEMS(OTHER, 0x8449)) >= (1)) && ((NPC_HASITEMS(OTHER, 0x89ff)) >= (1))) && ((NPC_HASITEMS(OTHER, 0x844b)) >= (1))) && ((NPC_HASITEMS(OTHER, 0x859a)) >= (1))) && ((NPC_HASITEMS(OTHER, 0x904b)) >= (1))) {
            if (((NPC_HASITEMS(OTHER, 0x844c)) >= (1)) || ((NPC_HASITEMS(OTHER, 0x8a1e)) >= (1))) {
                if ((((NPC_HASITEMS(OTHER, 0x844f)) >= (1)) || ((NPC_HASITEMS(OTHER, 0x8a2b)) >= (1))) || ((NPC_HASITEMS(OTHER, 0x8a2a)) >= (1))) {
                    return TRUE;
                };
            };
        };
...
func void DIA_STONE_VZ_Q514_GOTLIST_INFO() {
    if ((NPC_HASITEMS(OTHER, 0x844c)) >= (1)) {
    };
    if ((NPC_HASITEMS(OTHER, 0x8a1e)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 0x8a1e, 1);
    };
    if ((NPC_HASITEMS(OTHER, 0x844f)) >= (1)) {
    };
    if ((NPC_HASITEMS(OTHER, 0x8a2b)) >= (1)) {
    };
    if ((NPC_HASITEMS(OTHER, 0x8a2a)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 0x8a2a, 1);
    };
    B_GIVEINVITEMS(OTHER, SELF, 0x904b, 1);
    AI_STARTFACEANI(SELF, S_SMUG, 1, -(1));
    B_GIVEINVITEMS(OTHER, SELF, 0x859a, 1);
    AI_OUTPUT(OTHER, SELF, "DIA_Stone_VZ_Q514_GotList_15_01");
    B_GIVEINVITEMS(OTHER, SELF, 0x844b, 1);
    B_SAY(SELF, OTHER, "$NotBad");
    B_GIVEINVITEMS(OTHER, SELF, 0x89ff, 1);
    AI_OUTPUT(SELF, OTHER, "DIA_Stone_VZ_Q514_Water_03_02");
    B_GIVEINVITEMS(OTHER, SELF, 0x8449, 1);
    AI_RESETFACEANI(SELF);
...
func int DIA_STONE_VZ_Q514_ARMORREADY_CONDITION() {
    if ((Q514_FINISHVOLFZACKE) == (0)) {
        if ((NPC_KNOWSINFO(OTHER, 0x152a4)) || ((NPC_KNOWSINFO(OTHER, 0x1529f)) && ((STONE_Q514_OLDARMOR_BETTER) == (FALSE)))) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
...
func int DIA_STONE_VZ_Q514_GIVEARMOR_CONDITION() {
    if (((Q514_FINISHVOLFZACKE) >= (1)) && (NPC_KNOWSINFO(OTHER, 0x1529f))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_STONE_VZ_Q514_GIVEARMOR_INFO() {
    if (((STONE_Q514_OLDARMOR_BETTER) == (TRUE)) && (NPC_KNOWSINFO(OTHER, 0x152a4))) {
        AI_STARTFACEANI(SELF, S_SMUG, 1, -(1));
        AI_OUTPUT(SELF, OTHER, "DIA_Stone_SQ202_Enough_712_02");
        CREATEINVITEMS(SELF, 0x8a72, 1);
        B_GIVEINVITEMS(SELF, OTHER, 0x8a72, 1);
        AI_EQUIPARMOR(OTHER, 0x8a72);
    ...
    CREATEINVITEMS(SELF, 0x8a71, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x8a71, 1);
    AI_EQUIPARMOR(OTHER, 0x8a71);
    DIA_STONE_VZ_Q514_GIVEARMOR_BETTER();
    AI_RESETFACEANI(OTHER);
...
var int STONEVZ_CANTTEACH = 0;
var int STONEVZ_CURRENTSTRLEVEL = 0;
var int STONEVZ_GOLDCOST = 0;
...
func int DIA_STONEVZ_TEACH_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x15441)) && (!(NPC_KNOWSINFO(OTHER, 0x1544e)))) && ((STONEVZ_CANTTEACH) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_STONEVZ_TEACH_CHOICES() {
    ...
    INFO_CLEARCHOICES(0x152b2);
    INFO_ADDCHOICE(0x152b2, DIALOG_BACK, 0x152b6);
    INFO_ADDCHOICE(0x152b2, B_BUILDLEARNSTRING2(PRINT_LEARNSTR1, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_STRENGTH, 1), STONEVZ_GOLDCOST), 0x152b7);
    INFO_ADDCHOICE(0x152b2, B_BUILDLEARNSTRING2(PRINT_LEARNSTR5, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_STRENGTH, 5), (STONEVZ_GOLDCOST) * (5)), 0x152b8);
}
...
func void DIA_STONEVZ_TEACH_STR1() {
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (STONEVZ_GOLDCOST)) {
...
func void DIA_STONEVZ_TEACH_STR5() {
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= ((STONEVZ_GOLDCOST) * (5))) {
        if ((STONEVZ_CURRENTSTRLEVEL) < (OTHER.AIVAR[81])) {
            B_SAY(SELF, OTHER, "$YouLearnedSomething");
        };
    };
