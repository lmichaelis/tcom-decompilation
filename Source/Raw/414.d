instance DIA_FINBARBODYGUARD_EXIT(C_INFO) {
    NR = 999;
    CONDITION = DIA_FINBARBODYGUARD_EXIT_CONDITION;
    INFORMATION = DIA_FINBARBODYGUARD_EXIT_INFO;
    PERMANENT = TRUE;
...
var int FINBARBODYGUARD_ALLOWSUSGO = 0;
var int FINBARBODYGUARD_THEYKNOWYOURGUILD = 0;
func int DIA_FINBARBODYGUARD_FIRSTWARN_CONDITION() {
    if (((Q206_KNOWSFINBAR) == (TRUE)) && ((LOG_GETSTATUS(MIS_Q206)) == (LOG_RUNNING))) {
        if ((FINBARBODYGUARD_ALLOWSUSGO) == (TRUE)) {
            ...
            SELF.AIVAR[14] = FALSE;
        } else if ((NPC_GETDISTTONPC(SELF, HERO)) <= (700)) {
...
func void DIA_FINBARBODYGUARD_PAY_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (Q206_GOLDFORINFO)) {
        B_GIVEINVITEMS(OTHER, SELF, 0x859b, Q206_GOLDFORINFO);
...
var int DIA_FINBARBODYGUARD_BUSY_INFO.RND_FINBARBODYGUARD = 0;
