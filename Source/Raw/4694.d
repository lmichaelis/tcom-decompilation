func void EVENTSMANAGER_Q206() {
    if ((LOG_GETSTATUS(MIS_Q206)) == (LOG_RUNNING)) {
        if ((Q206_MARVINISSPY) == (FALSE)) {
            if (((NPC_GETDISTTOWP(HERO, "HARBOUR_TAVERN_06")) <= (1000)) && (NPC_KNOWSINFO(HERO, 0x11296))) {
        ...
        if ((Q206_FISHERMANLOGENTRY) == (FALSE)) {
            if ((NPC_KNOWSINFO(HERO, 0x11296)) && ((NPC_KNOWSINFO(HERO, 0x11299)) == (FALSE))) {
        ...
        if ((Q206_FIGHTWITHPABLO) == (1)) {
            if (((NPC_ISINSTATE(NONE_7004_PABLO, 0xf0a3)) && (NPC_ISDEAD(NONE_6279_BANDIT))) && (NPC_ISDEAD(NONE_6280_BANDIT))) {
        ...
        if ((Q206_GOWITHPABLO) == (1)) {
            if (((NPC_GETDISTTONPC(HERO, NONE_13518_THUG)) <= (1000)) && ((NPC_GETDISTTOWP(NONE_7004_PABLO, NONE_7004_PABLO.WP)) <= (1000))) {
                Q206_GOWITHPABLO = 2;
                FF_APPLYONCEEXT(0xee80, 75, 4);
                HERO.AIVAR[4] = TRUE;
            };
        };
        if ((Q206_FISHERMANASKCOUNT) >= (2)) {
            if ((Q206_FISHERMAN_RUNAWAY) == (0)) {
                if (((NPC_ISINSTATE(NONE_13522_FISHERMAN, 0xf09f)) == (FALSE)) && ((NPC_ISINSTATE(HERO, 0xf09f)) == (FALSE))) {
                ...
                if (((NPC_GETDISTTOWP(NONE_13522_FISHERMAN, NONE_13522_FISHERMAN.WP)) <= (500)) && ((NPC_ISINSTATE(NONE_13522_FISHERMAN, 0xf09f)) == (FALSE))) {
...
var int EVENTSMANAGER_Q206.Q206_FINBARWORKPLACE_LOGENTRY = 0;
