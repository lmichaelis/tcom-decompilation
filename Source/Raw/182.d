...
var int BUILDRECIPEDIALOGDESCRIPTION.PTR = 0;
instance BUILDRECIPEDIALOGDESCRIPTION.REC(C_RECIPE)
var string BUILDRECIPEDIALOGDESCRIPTION.RESULTSTRING = "";
var int BUILDRECIPEDIALOGDESCRIPTION.S = 0;
instance BUILDRECIPEDIALOGDESCRIPTION.CURRENTITEM(C_ITEM)
...
var int BUILDRECIPELOG.PTR = 0;
instance BUILDRECIPELOG.REC(C_RECIPE)
var string BUILDRECIPELOG.RESULTSTRING = "";
var int BUILDRECIPELOG.S = 0;
instance BUILDRECIPELOG.CURRENTITEM(C_ITEM)
var int BUILDRECIPELOG.I = 0;
...
var int SHOWWEAPONRECIPEDOC.NDOCID = 0;
instance SHOWWEAPONRECIPEDOC.RECITEM(C_ITEM)
instance SHOWWEAPONRECIPEDOC.CURRENTITEM(C_ITEM)
var int SHOWWEAPONRECIPEDOC.I = 0;
var int SHOWWEAPONRECIPEDOC.S = 0;
...
var int SHOWEDIBLERECIPEDOC.NDOCID = 0;
instance SHOWEDIBLERECIPEDOC.RECITEM(C_ITEM)
instance SHOWEDIBLERECIPEDOC.CURRENTITEM(C_ITEM)
var int SHOWEDIBLERECIPEDOC.I = 0;
var int SHOWEDIBLERECIPEDOC.S = 0;
var int SHOWEDIBLERECIPEDOC.TEXTARRAYPTR = 0;
var int SHOWEDIBLERECIPEDOC.COUNTARRAYPTR = 0;
var int SHOWEDIBLERECIPEDOC.J = 0;
var int SHOWEDIBLERECIPEDOC.COUNT = 0;
...
var int LEARNWEAPONRECIPE.PTR = 0;
instance LEARNWEAPONRECIPE.REC(C_RECIPE)
var string LEARNWEAPONRECIPE.LOG = "";
...
var int USEMELEEWEAPONRECIPE.PTR = 0;
instance USEMELEEWEAPONRECIPE.REC(C_RECIPE)
...
var int USERANGEDWEAPONRECIPE.PTR = 0;
instance USERANGEDWEAPONRECIPE.REC(C_RECIPE)
var string USERANGEDWEAPONRECIPE.LOG = "";
...
var int USECOOKINGRECIPE.PTR = 0;
instance USECOOKINGRECIPE.REC(C_RECIPE)
var string USECOOKINGRECIPE.LOG = "";
...
var int USEALCHEMYRECIPE.PTR = 0;
instance USEALCHEMYRECIPE.REC(C_RECIPE)
var string USEALCHEMYRECIPE.LOG = "";
...
var int GIVERECIPEITEMS.PTR = 0;
instance GIVERECIPEITEMS.REC(C_RECIPE)
var int GIVERECIPEITEMS.I = 0;
...
var int PC_CRAFTRECIPEITEM_MAX.PTR = 0;
instance PC_CRAFTRECIPEITEM_MAX.REC(C_RECIPE)
var int PC_CRAFTRECIPEITEM_MAX.CHECK = 0;
var int PC_CRAFTRECIPEITEM_MAX.MAX = 0;
var int PC_CRAFTRECIPEITEM_MAX.I = 0;
var int PC_CRAFTRECIPEITEM_MAX.INVITEMS = 0;
...
var int PC_CRAFTRECIPEITEMS.PTR = 0;
instance PC_CRAFTRECIPEITEMS.REC(C_RECIPE)
var int PC_CRAFTRECIPEITEMS.CHECK = 0;
instance PC_CRAFTRECIPEITEMS.CURRENTITEM(C_ITEM)
var int PC_CRAFTRECIPEITEMS.I = 0;
var int PC_CRAFTRECIPEITEMS.INVITEMS = 0;
instance PC_CRAFTRECIPEITEMS.RECITEM(C_ITEM)
var int PC_CRAFTRECIPEITEMS.J = 0;
var int PC_CRAFTRECIPEITEMS.S2 = 0;
