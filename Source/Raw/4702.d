func void EVENTSMANAGER_Q307() {
    ...
    if ((Q307_HIERRONEARALCHEMY) == (FALSE)) {
        if (((NPC_KNOWSINFO(HERO, 0x1464c)) && ((NPC_GETDISTTOWP(NOV_200_HIERRO, "PART17_HAVEN_HUT5_ALCHEMY_01")) <= (500))) && ((NPC_ISINSTATE(NOV_200_HIERRO, 0xf09f)) == (FALSE))) {
    ...
    if (((Q307_WECRATEDPOTION) == (FALSE)) && ((Q307_POISONFROMHIERRO) == (FALSE))) {
        if ((PLAYER_MOBSI_PRODUCTION) == (MOBSI_NONE)) {
            if ((NPC_HASITEMS(HERO, 0x9056)) >= (1)) {
                CREATEINVITEMS(HERO, 0x9057, 1);
    ...
    if ((Q307_BARRELLOGENTRY) == (FALSE)) {
        if ((((NPC_HASITEMS(HERO, 0x9056)) >= (1)) && ((NPC_GETDISTTOWP(HERO, "PART17_BAR_25")) <= (300))) && (NPC_KNOWSINFO(HERO, 0x1493f))) {
