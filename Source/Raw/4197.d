...
func int DIA_AMJAK_WHAT_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x14c70)) {
        return TRUE;
    };
...
func int DIA_AMJAK_WHATAMBIENTTRUE_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x14c73)) && ((NS72_BARRELOFFORTUNECANYOU) == (0))) && (NPC_ISINSTATE(SELF, 0xf09f))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
var int DIA_AMJAK_AFTERBARREL_INFO.RND_KAJMA = 0;
...
func int DIA_AMJAK_AFTERAFTERBARREL_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x14c7a)) && (NPC_ISINSTATE(SELF, 0xf09f))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
