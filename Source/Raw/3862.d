...
func int DIA_TOHAR_QM202_HELP_CONDITION() {
    if (((LOG_GETSTATUS(MIS_QM202)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x11cdb))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_TOHAR_YOUSURE_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x11cde)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_TOHAR_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x11ce4);
    INFO_ADDCHOICE(0x11ce4, DIALOG_BACK, 0x11ce8);
    INFO_ADDCHOICE(0x11ce4, DIALOG_PICKPOCKET, 0x11ce7);
}
