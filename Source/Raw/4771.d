func void EVENTSMANAGER_SQ219() {
    ...
    if ((LOG_GETSTATUS(MIS_SQ219)) == (LOG_RUNNING)) {
        if ((NPC_ISINSTATE(VLK_10035_GARD, 0xf09f)) == (FALSE)) {
    ...
    if ((LOG_GETSTATUS(MIS_SQ219)) == (LOG_SUCCESS)) {
        if ((NPC_GETDISTTONPC(HERO, VLK_10035_GARD)) >= (0x1388)) {
...
var int EVENTSMANAGER_SQ219.SQ219_WOLFSDEN_IDEA_LOGENTRY = 0;
var int EVENTSMANAGER_SQ219.SQ219_SWAMP_IDEA_LOGENTRY = 0;
var int EVENTSMANAGER_SQ219.SQ219_VINEYARD_IDEA_LOGENTRY = 0;
