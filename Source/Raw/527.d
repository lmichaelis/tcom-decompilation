...
const int SPELL_PICKLOCK_CLEARKEYBUFFER.CALL = 0;
...
instance SPELL_LOGIC_PICKLOCK.SLF(OCNPC)
instance SPELL_LOGIC_PICKLOCK.MOB(OCMOBLOCKABLE)
var int SPELL_LOGIC_PICKLOCK.MOBPTR = 0;
var int SPELL_LOGIC_PICKLOCK.CURRCHARCOUNT = 0;
var int SPELL_LOGIC_PICKLOCK.PARTPICKLOCK = 0;
var int SPELL_LOGIC_PICKLOCK.TOTALCHARCOUNT = 0;
var int SPELL_LOGIC_PICKLOCK.TIMESTEP = 0;
...
var int SPELL_PICKLOCK_PRIO.CASTER = 0;
instance SPELL_PICKLOCK_PRIO.SLF(C_NPC)
const int SPELL_PICKLOCK_PRIO.MOB_PRIO_BACKUP = 42;
var int SPELL_PICKLOCK_PRIO.SPELLID = 0;
...
var int SPELL_PICKLOCK_FOCUS.VOBPTR = 0;
instance SPELL_PICKLOCK_FOCUS.MOB(OCMOBLOCKABLE)
func void SPELL_PICKLOCK_INIT_GAMESTART() {
    HOOKENGINEF(OCSPELL__ISTARGETTYPEVALID, 5, 0xab1c);
    HOOKENGINEF(OCSPELL__SETUP, 7, 0xab17);
}
...
var int SPELL_PICKLOCK_INIT_ALWAYS.FMAGICPTR = 0;
