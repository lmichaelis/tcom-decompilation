instance DIA_OLDCITYGUARD_EXIT(C_INFO) {
    NR = 999;
    CONDITION = DIA_OLDCITYGUARD_EXIT_CONDITION;
    INFORMATION = DIA_OLDCITYGUARD_EXIT_INFO;
    PERMANENT = TRUE;
...
func void DIA_OLDCITYGUARD_CHOICES() {
    INFO_ADDCHOICE(0xa559, DIALOG_ENDE, 0xa561);
    INFO_ADDCHOICE(0xa559, "Why not?", 0xa560);
}

func void DIA_OLDCITYGUARD_FIRSTWARN_INFO() {
    INFO_CLEARCHOICES(0xa559);
...
func void DIA_OLDCITYGUARD_FIRSTWARN_WHY() {
    ...
    INFO_ADDCHOICE(0xa559, "I didn't know I needed a pass for that.", 0xa55f);
}
