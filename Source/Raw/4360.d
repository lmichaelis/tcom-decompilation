...
func void DIA_RAMSEY_Q602_WAIT_INFO() {
    ...
    INFO_CLEARCHOICES(0x161c5);
    INFO_ADDCHOICE(0x161c5, "Go back to Silbach. This is not your battle.", 0x161c9);
    INFO_ADDCHOICE(0x161c5, "You betrayed the city, you deserve to die. I will be your executioner. (Kill)", 0x161c8);
}
...
func void MARVIN_Q602_KILLRAMSEY() {
    ...
    B_MAGICHURTNPC(HERO, NONE_500_RAMSEY_Q602, 0x1869f);
