...
func void USE_RINGTESTPACKET() {
    CREATEINVITEMS(HERO, 0x86a8, 1);
    CREATEINVITEMS(HERO, 0x86ab, 1);
    CREATEINVITEMS(HERO, 0x86ae, 1);
    CREATEINVITEMS(HERO, 0x86b1, 1);
    CREATEINVITEMS(HERO, 0x86ba, 1);
    CREATEINVITEMS(HERO, 0x86bd, 1);
    CREATEINVITEMS(HERO, 0x86b4, 1);
    CREATEINVITEMS(HERO, 0x86b7, 1);
    CREATEINVITEMS(HERO, 0x86c0, 1);
    CREATEINVITEMS(HERO, 0x86c3, 1);
    CREATEINVITEMS(HERO, 0x86c6, 1);
    CREATEINVITEMS(HERO, 0x86c9, 1);
    CREATEINVITEMS(HERO, 0x86cc, 1);
    CREATEINVITEMS(HERO, 0x86cf, 1);
    CREATEINVITEMS(HERO, 0x86d2, 1);
    CREATEINVITEMS(HERO, 0x86d5, 1);
    CREATEINVITEMS(HERO, 0x86d8, 1);
    CREATEINVITEMS(HERO, 0x86db, 1);
    CREATEINVITEMS(HERO, 0x86de, 1);
    CREATEINVITEMS(HERO, 0x86e1, 1);
    CREATEINVITEMS(HERO, 0x86e4, 1);
    CREATEINVITEMS(HERO, 0x86e7, 1);
    CREATEINVITEMS(HERO, 0x911a, 1);
    CREATEINVITEMS(HERO, 0x9473, 1);
    CREATEINVITEMS(HERO, 0x947c, 2);
    CREATEINVITEMS(HERO, 0x947f, 2);
    CREATEINVITEMS(HERO, 0x9485, 2);
    CREATEINVITEMS(HERO, 0x9488, 2);
    CREATEINVITEMS(HERO, 0x948b, 2);
    CREATEINVITEMS(HERO, 0x948e, 2);
    CREATEINVITEMS(HERO, 0x9491, 2);
    CREATEINVITEMS(HERO, 0x9494, 2);
    CREATEINVITEMS(HERO, 0x9498, 2);
    CREATEINVITEMS(HERO, 0x949b, 2);
    CREATEINVITEMS(HERO, 0x949e, 2);
    CREATEINVITEMS(HERO, 0x94a1, 2);
    CREATEINVITEMS(HERO, 0x9476, 1);
    CREATEINVITEMS(HERO, 0x9479, 1);
    SND_PLAY(GELDBEUTEL);
}
...
var int ITRI_FIST_01_COUNT = 0;
var int ITRI_FIST_01_STR = 0;
var int ITRI_FIST_01_STR_READY = 0;
...
var int WATERCIRCLESET_WEARINGANYRING = 0;
