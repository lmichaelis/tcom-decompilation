instance DIA_SLD_SQ127_NEWS(C_INFO) {
    NR = 10;
    CONDITION = DIA_SLD_SQ127_NEWS_CONDITION;
    INFORMATION = DIA_SLD_SQ127_NEWS_INFO;
    PERMANENT = FALSE;
    IMPORTANT = TRUE;
}

func int DIA_SLD_SQ127_NEWS_CONDITION() {
    if ((((((LOG_GETSTATUS(MIS_SQ127)) == (LOG_SUCCESS)) && (((KAPITEL) >= ((SQ127_WAITINGTIME) + (2))) == (TRUE))) && ((SQ127_WORKWITHGUMBERT) == (3))) && ((NPC_KNOWSINFO(OTHER, 0xfe10)) == (FALSE))) && ((SELF.VOICE) != (28))) {
        return TRUE;
    };
...
func void DIA_SLD_SQ116_NEWS_INFO() {
    ...
    CREATEINVITEMS(SELF, 0x909d, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x909d, 1);
    AI_STOPPROCESSINFOS(SELF);
...
func void DIA_SLD_SQ411_NEWS_INFO() {
    ...
    B_SAY(SELF, OTHER, "$REWARD_CALM");
    CREATEINVITEMS(SELF, 0x91ff, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x91ff, 1);
    AI_STOPPROCESSINFOS(SELF);
}
...
func int DIA_SLD_PROMOTIONAVAILABLE_CONDITION() {
    if ((HERO.GUILD) == (GIL_SLD)) {
        if ((OTHER.AIVAR[93]) <= (WLD_GETDAY())) {
            if (((((((((((((LOG_GETSTATUS(MIS_Q206)) == (LOG_SUCCESS)) && ((Q206_AFTERQUEST) == (1))) && ((Q206_AFTERQUEST_DAY) <= ((WLD_GETDAY()) - (1)))) && ((NPC_KNOWSINFO(OTHER, 0x11648)) == (FALSE))) || ((((((LOG_GETSTATUS(MIS_QA203)) == (LOG_SUCCESS)) && ((LOG_GETSTATUS(MIS_QA305)) == (LOG_SUCCESS))) && ((QA305_FINISH) == (TRUE))) && ((QA305_FINISH_DAY) <= ((WLD_GETDAY()) - (1)))) && ((NPC_KNOWSINFO(OTHER, 0x1164b)) == (FALSE)))) || ((((((LOG_GETSTATUS(MIS_QA202)) == (LOG_SUCCESS)) && ((LOG_GETSTATUS(MIS_QA303)) == (LOG_SUCCESS))) && ((QA303_FINISH) == (TRUE))) && ((QA303_FINISH_DAY) <= ((WLD_GETDAY()) - (1)))) && ((NPC_KNOWSINFO(OTHER, 0x1164b)) == (FALSE)))) || ((((((((MARVIN_ARAXOSSPECIALIZATION) == (ARAXOS_SPECIALIZATION_NONE)) && ((MARVIN_ARAXOSSPECIALIZATION_CANJOIN_FIGHTER) == (TRUE))) && ((MARVIN_ARAXOSSPECIALIZATION_CANJOIN_ARCHER) == (FALSE))) && ((LOG_GETSTATUS(MIS_QA202)) == (LOG_SUCCESS))) && ((LOG_GETSTATUS(MIS_QA303)) == (LOG_SUCCESS))) && ((QA303_FINISH) == (TRUE))) && ((QA303_FINISH_DAY) <= ((WLD_GETDAY()) - (1))))) || ((((((((MARVIN_ARAXOSSPECIALIZATION) == (ARAXOS_SPECIALIZATION_NONE)) && ((MARVIN_ARAXOSSPECIALIZATION_CANJOIN_FIGHTER) == (FALSE))) && ((MARVIN_ARAXOSSPECIALIZATION_CANJOIN_ARCHER) == (TRUE))) && ((LOG_GETSTATUS(MIS_QA203)) == (LOG_SUCCESS))) && ((LOG_GETSTATUS(MIS_QA305)) == (LOG_SUCCESS))) && ((QA305_FINISH) == (TRUE))) && ((QA305_FINISH_DAY) <= ((WLD_GETDAY()) - (1))))) || ((((((((((((MARVIN_ARAXOSSPECIALIZATION) == (ARAXOS_SPECIALIZATION_FIGHTER)) && ((LOG_GETSTATUS(MIS_QA301)) == (LOG_SUCCESS))) && ((LOG_GETSTATUS(MIS_QA401)) == (LOG_SUCCESS))) && ((LOG_GETSTATUS(MIS_KQ403)) == (LOG_SUCCESS))) && ((QA401_FINISH) == (TRUE))) && ((QA401_FINISH_DAY) <= ((WLD_GETDAY()) - (1)))) && ((QA301_FINISH) == (TRUE))) && ((QA301_FINISH_DAY) <= ((WLD_GETDAY()) - (1)))) && ((KQ403_FINISH) == (TRUE))) && ((KQ403_FINISH_DAY) <= ((WLD_GETDAY()) - (1)))) && ((NPC_KNOWSINFO(OTHER, 0x11677)) == (FALSE)))) || ((((((((((((MARVIN_ARAXOSSPECIALIZATION) == (ARAXOS_SPECIALIZATION_ARCHER)) && ((LOG_GETSTATUS(MIS_QA302)) == (LOG_SUCCESS))) && ((LOG_GETSTATUS(MIS_QA401)) == (LOG_SUCCESS))) && ((LOG_GETSTATUS(MIS_KQ403)) == (LOG_SUCCESS))) && ((QA401_FINISH) == (TRUE))) && ((QA401_FINISH_DAY) <= ((WLD_GETDAY()) - (1)))) && ((QA302_FINISH) == (TRUE))) && ((QA302_FINISH_DAY) <= ((WLD_GETDAY()) - (1)))) && ((KQ403_FINISH) == (TRUE))) && ((KQ403_FINISH_DAY) <= ((WLD_GETDAY()) - (1)))) && ((NPC_KNOWSINFO(OTHER, 0x11677)) == (FALSE)))) || (((KAPITEL) == (5)) && ((NPC_KNOWSINFO(OTHER, 0x11620)) == (FALSE)))) || (((((((KAPITEL) == (5)) && ((MARVIN_ARAXOSSPECIALIZATION) >= (3))) && ((SQ503_GUILDFINALTIER) == (TRUE))) && ((SQ503_GUILDFINALTIER_DAY) <= ((WLD_GETDAY()) - (1)))) && ((LOG_GETSTATUS(MIS_QA306)) == (LOG_SUCCESS))) && ((NPC_KNOWSINFO(OTHER, 0x1163c)) == (FALSE)))) {
                return TRUE;
            };
        };
    };
...
func void DIA_SLD_LORENZO_INFO() {
    ...
    INFO_CLEARCHOICES(0xa57a);
    INFO_ADDCHOICE(0xa57a, "The Royal Envoy?", 0xa57e);
    INFO_ADDCHOICE(0xa57a, "Thanks for your message.", 0xa57f);
}
...
func int DIA_SLD_LATE_CONDITION() {
    if (((((Q402_MARVINISLATE) == (TRUE)) && ((HERO.GUILD) == (GIL_SLD))) && ((LOG_GETSTATUS(MIS_Q402)) == (LOG_RUNNING))) && ((NPC_KNOWSINFO(OTHER, 0x115fa)) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
