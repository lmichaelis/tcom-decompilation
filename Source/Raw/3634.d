...
func int DIA_TENGRAL_HELLO_CONDITION() {
    if (((NPC_ISINSTATE(SELF, 0xf09f)) && ((NPC_GETDISTTOWP(SELF, "PARTM8_PATH_PREACH")) <= (500))) && (WLD_ISTIME(13, 0, 14, 0))) {
        return FALSE;
    };
...
func void DIA_TENGRAL_INNOS_INFO() {
    ...
    INFO_CLEARCHOICES(0xff7c);
    INFO_ADDCHOICE(0xff7c, "I am a follower of Adanos.", 0xff80);
    INFO_ADDCHOICE(0xff7c, "I am a humble servant of Beliar.", 0xff81);
    INFO_ADDCHOICE(0xff7c, "I don't get along with gods.", 0xff7f);
}
...
func int DIA_TENGRAL_FIREMAGE_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0xff7c)) && ((LOG_GETSTATUS(MIS_Q405)) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_TENGRAL_CQ005_START_INFO() {
    ...
    INFO_CLEARCHOICES(0xff88);
    INFO_ADDCHOICE(0xff88, "How am I supposed to do that?", 0xff8b);
}
...
func int DIA_TENGRAL_CQ005_SILVESTRDEAD_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x12d76)) && ((LOG_GETSTATUS(MIS_CQ005)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_TENGRAL_CQ005_GOODENDING_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x111af)) && ((LOG_GETSTATUS(MIS_CQ005)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_TENGRAL_REFERENCEEXCHANGE_CONDITION() {
    if ((((CQ005_TENGRAL_REFERENCEEXCHANGE) == (1)) && ((LOG_GETSTATUS(MIS_Q202)) == (LOG_RUNNING))) && (NPC_KNOWSINFO(OTHER, 0x11f69))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_TENGRAL_REFERENCEEXCHANGE_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (CQ005_REWARD)) {
        NPC_REMOVEINVITEMS(SELF, 0x859b, CQ005_REWARD);
        AI_STARTFACEANI(SELF, S_SMILE, 1, -(1));
        B_GIVEINVITEMS(OTHER, SELF, 0x859b, CQ005_REWARD);
        B_SAY(SELF, OTHER, "$SURE_V3");
        AI_RESETFACEANI(SELF);
        CREATEINVITEMS(SELF, 0x912d, 1);
        B_GIVEINVITEMS(SELF, OTHER, 0x912d, 1);
...
func void DIA_TENGRAL_SQ309_SELLING_SQ309() {
    ...
    INFO_CLEARCHOICES(0xff98);
    INFO_ADDCHOICE(0xff98, DIALOG_BESILENT, 0xff9b);
    INFO_ADDCHOICE(0xff98, "There is some information that may make you change your mind...", 0xff9d);
}
...
func void DIA_TENGRAL_SQ309_INFO() {
    ...
    INFO_CLEARCHOICES(0xff98);
    INFO_ADDCHOICE(0xff98, "Selling golden Innoses is against the will of the Fire Archmages!", 0xffa0);
    INFO_ADDCHOICE(0xff98, "I had no ill intentions.", 0xff9f);
}
...
func int DIA_TENGRAL_KQ404_FIREMAGEARMOR_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_KQ404)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0xffa4))) && ((INEXTREMO_CANPLAYCONCERT) == (TRUE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_TENGRAL_KQ404_NIGHTMEETING_CONDITION() {
    if ((((((LOG_GETSTATUS(MIS_KQ404)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0xffa7))) && (WLD_ISTIME(22, 0, 8, 0))) && ((INEXTREMO_CANPLAYCONCERT) == (TRUE))) && ((NPC_GETDISTTOWP(SELF, "PARTM1_PATH_66")) <= (0x5dc))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_TENGRAL_KQ404_NIGHTMEETING_INFO() {
    ...
    CREATEINVITEMS(SELF, 0x91d4, 2);
    B_GIVEINVITEMS(SELF, OTHER, 0x91d4, 2);
    AI_STOPPROCESSINFOS(SELF);
...
var int TENGRALCURRENTMANALEVEL = 0;
var int TENGRAL_NOMORE = 0;
...
func int DIA_TENGRAL_TEACH_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0xffb0)) && ((TENGRAL_NOMORE) == (FALSE))) && ((HERO.GUILD) == (GIL_MIL))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_TENGRAL_TEACH_CHOICES() {
    ...
    INFO_CLEARCHOICES(0xffb6);
    INFO_ADDCHOICE(0xffb6, DIALOG_BACK, 0xffbb);
    INFO_ADDCHOICE(0xffb6, B_BUILDLEARNSTRING2(PRINT_LEARNMANA1, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_MANA_MAX, 1), TENGRAL_GOLDCOST), 0xffbc);
    INFO_ADDCHOICE(0xffb6, B_BUILDLEARNSTRING2(PRINT_LEARNMANA5, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_MANA_MAX, 5), (TENGRAL_GOLDCOST) * (5)), 0xffbd);
}

var int DIA_TENGRAL_TEACH_CHOICES.TENGRAL_GOLDCOST = 0;
...
func void DIA_TENGRAL_TEACH1() {
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (TENGRAL_PAYMENT1)) {
        if ((TENGRALCURRENTMANALEVEL) < (OTHER.AIVAR[83])) {
            SND_PLAY(GELDBEUTEL);
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, TENGRAL_PAYMENT1);
            NPC_REMOVEINVITEMS(SELF, 0x859b, TENGRAL_PAYMENT1);
        };
...
func void DIA_TENGRAL_TEACH5() {
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (TENGRAL_PAYMENT5)) {
        if ((TENGRALCURRENTMANALEVEL) < (OTHER.AIVAR[83])) {
            SND_PLAY(GELDBEUTEL);
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, TENGRAL_PAYMENT5);
            NPC_REMOVEINVITEMS(SELF, 0x859b, TENGRAL_PAYMENT5);
        };
...
func void DIA_TENGRAL_Q505_HELP_INFO() {
    ...
    CREATEINVITEMS(SELF, 0x92d9, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x92d9, 1);
    AI_RESETFACEANI(SELF);
    AI_RESETFACEANI(OTHER);
}
...
var int DIA_TENGRAL_TRADE_INFO.TENGRAL_TRADE_CHECKINFO = 0;
...
func void DIA_TENGRAL_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0xffce);
    INFO_ADDCHOICE(0xffce, DIALOG_BACK, 0xffd2);
    INFO_ADDCHOICE(0xffce, DIALOG_PICKPOCKET, 0xffd1);
}
