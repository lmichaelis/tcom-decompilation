var int SLEPTINARAXOSMINEBED = 0;
var int ASTOL_AFTERSLEEP_FIGHT = 0;
...
instance SLEEPABIT_ARAXOSMINE_RICH_S1.HER(C_NPC)
func void PC_ARAXOSMINE_RICH_SLEEP(var int T) {
    ...
    if ((ASTOL_AFTERSLEEP_FIGHT) != (2)) {
        if ((SLEPTINARAXOSMINEBED) == (FALSE)) {
            ...
            TELEPORTNPCTOWP(0xdc64, SLD_13714_ASTOL.WP);
        };
    };
...
instance PC_ARAXOSMINE_RICH_NOSLEEP(C_INFO) {
    NPC = 0xc3ab;
    NR = 999;
    CONDITION = PC_ARAXOSMINE_RICH_NOSLEEP_CONDITION;
    INFORMATION = PC_ARAXOSMINE_RICH_NOSLEEP_INFO;
    IMPORTANT = FALSE;
    PERMANENT = TRUE;
