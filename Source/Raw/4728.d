func void EVENTSMANAGER_QA302() {
    ...
    if ((QA302_ROUTE_CAVE_MONSTERS) == (FALSE)) {
        if (((NPC_GETDISTTOWP(HERO, "PART2_PATH_68")) <= (0x898)) || ((NPC_GETDISTTOWP(HERO, "PART9_CONNECTION_PART2_V2")) <= (0x898))) {
    ...
    if ((QA302_FOLLOWCITIZEN) == (1)) {
        if (((NPC_GETDISTTONPC(HERO, NONE_13499_QA302_BANDIT)) <= (0x5dc)) || (((NPC_GETDISTTONPC(SLD_1009_CARAMON, NONE_13499_QA302_BANDIT)) <= (0x5dc)) && ((NPC_ISINSTATE(NONE_13499_QA302_BANDIT, 0xf09f)) == (FALSE)))) {
            PRINTD("Idzie");
    ...
    if ((QA302_FOLLOWCITIZEN) == (2)) {
        if (((NPC_GETDISTTOWP(NONE_13499_QA302_BANDIT, "PARTM4_PATH_12")) <= (600)) && ((NPC_ISINSTATE(NONE_13499_QA302_BANDIT, 0xf09f)) == (FALSE))) {
            PRINTD("Szuka nas");
    ...
    if (((QA302_FOLLOWCITIZEN) == (2)) || ((QA302_FOLLOWCITIZEN) == (4))) {
        if (((NPC_ISINSTATE(NONE_13499_QA302_BANDIT, 0xf09f)) == (FALSE)) && ((NPC_ISINSTATE(SLD_1009_CARAMON, 0xf09f)) == (FALSE))) {
            if (((NPC_GETDISTTONPC(HERO, NONE_13499_QA302_BANDIT)) <= (500)) || ((NPC_GETDISTTONPC(SLD_1009_CARAMON, NONE_13499_QA302_BANDIT)) <= (500))) {
                ...
                QA302_ERNESTORTN();
                MDL_APPLYOVERLAYMDSTIMED(HERO, HUMANSSPRINTMDS, 0xc350);
                MDL_APPLYOVERLAYMDSTIMED(SLD_1009_CARAMON, HUMANSSPRINTMDS, 0xcb20);
                MDL_APPLYOVERLAYMDSTIMED(NONE_13499_QA302_BANDIT, HUMANSSPRINTMDS, 0xea60);
            };
        };
    };
    if ((QA302_FOLLOWCITIZEN) == (3)) {
        if (((NPC_GETDISTTOWP(NONE_13499_QA302_BANDIT, "HARBOUR_PATH_195")) <= (600)) && ((NPC_ISINSTATE(NONE_13499_QA302_BANDIT, 0xf09f)) == (FALSE))) {
            PRINTD("Ucieka dalej");
    ...
    if ((QA302_BANDITS_CUTSCENEENABLE) == (1)) {
        if (((((NPC_ISINSTATE(NONE_13499_QA302_BANDIT, 0xf09f)) == (FALSE)) && ((NPC_ISINSTATE(NONE_13496_QA302_BANDIT, 0xf09f)) == (FALSE))) && ((NPC_ISINSTATE(SLD_1009_CARAMON, 0xf09f)) == (FALSE))) && ((NPC_ISINSTATE(HERO, 0xf09f)) == (FALSE))) {
            if ((NPC_GETDISTTONPC(NONE_13496_QA302_BANDIT, NONE_13499_QA302_BANDIT)) <= (800)) {
                if ((NPC_GETDISTTOWP(NONE_13499_QA302_BANDIT, "HARBOUR_PATH_256")) <= (0x5dc)) {
                    QA302_BANDITS_CUTSCENEENABLE = 2;
                    HERO.AIVAR[4] = TRUE;
                    FF_APPLYONCEEXT(0xf005, 75, 4);
                };
            };
        };
    };
    if ((QA302_BANDITS_CUTSCENEENABLE) == (3)) {
        if (NPC_KNOWSINFO(HERO, 0x112cc)) {
