...
func void DIA_HAVARD_Q404_NEEDHELP_INFO() {
    ...
    INFO_CLEARCHOICES(0x1422d);
    INFO_ADDCHOICE(0x1422d, "Are you up to something?", 0x14231);
    INFO_ADDCHOICE(0x1422d, "I've heard enough about being a city boy...", 0x14230);
}
...
func void DIA_HAVARD_Q404_NEEDHELP_POINT() {
    ...
    INFO_CLEARCHOICES(0x1422d);
    INFO_ADDCHOICE(0x1422d, "Okay, I'll look for your friend.", 0x14233);
    INFO_ADDCHOICE(0x1422d, "Why didn't you move inside yourself?", 0x14232);
}
...
var int HAVARD_Q404_COUNTEXP = 0;
var int HAVARD_Q404_HELPED = 0;
func void DIA_HAVARD_Q404_AFTERMINE_INFO() {
    HAVARD_Q404_COUNTEXP = 0;
    AI_STARTFACEANI(SELF, S_WHAT, 1, -(1));
    AI_OUTPUT(SELF, OTHER, "DIA_Havard_Q404_AfterMine_03_01");
    INFO_CLEARCHOICES(0x14234);
    if ((Q404_GAURRING_TAKEITEM) == (TRUE)) {
        INFO_ADDCHOICE(0x14234, "I'm sorry, your friend is dead.", 0x1423a);
    };
    INFO_ADDCHOICE(0x14234, "I'm sorry, I didn't find your friend.", 0x14239);
}
...
func void DIA_HAVARD_Q404_AFTERMINE_YES() {
    ...
    AI_RESETFACEANI(OTHER);
    INFO_CLEARCHOICES(0x14234);
    INFO_ADDCHOICE(0x14234, "I think he fell from a height.", 0x1423c);
    INFO_ADDCHOICE(0x14234, "He fell fighting an entire horde of crawlers.", 0x1423d);
}
...
func void DIA_HAVARD_Q404_AFTERMINE_NEXT() {
    ...
    if ((Q404_GAURCORPSE_BURNED) == (TRUE)) {
        INFO_ADDCHOICE(0x14234, "Yes, he will be able to have peace now.", 0x1423f);
    };
    INFO_ADDCHOICE(0x14234, "Unfortunately, there were too many of those beasts out there, I couldn't take any chances.", 0x14240);
}
...
func int DIA_HAVARD_Q509_QUESTION_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x14241)) && ((Q509_COUNTWARRIORS) < (4))) && ((LOG_GETSTATUS(MIS_Q509)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_HAVARD_Q509_QUESTION_INFO() {
    ...
    INFO_CLEARCHOICES(0x14244);
    INFO_ADDCHOICE(0x14244, "I'm looking for a certain artifact...", 0x14247);
}
...
func int DIA_HAVARD_Q509_FEEL_CONDITION() {
    if (((NPC_GETDISTTOWP(SELF, "PART5_Q509_HAVARD")) <= (0x7d0)) && ((Q509_HAVARDVOLFZACKE) == (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_HAVARD_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x1424c);
    INFO_ADDCHOICE(0x1424c, DIALOG_BACK, 0x14250);
    INFO_ADDCHOICE(0x1424c, DIALOG_PICKPOCKET, 0x1424f);
}
