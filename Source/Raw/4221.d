...
func int DIA_CARDEN_TRADE_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x14ec4)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_CARDEN_MILITIA_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x14ec4)) && ((KAPITEL) < (5))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_CARDEN_HELP_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x14ec4)) && ((TAKINGCOASTQUEST) == (FALSE))) {
        if ((KAPITEL) >= (2)) {
            return TRUE;
        };
    };
...
func void DIA_CARDEN_HELP_INFO() {
    ...
    INFO_CLEARCHOICES(0x14ed0);
    if ((OTHER.HITCHANCE[3]) >= (30)) {
        INFO_ADDCHOICE(0x14ed0, "I shoot pretty well.", 0x14ed4);
    };
    INFO_ADDCHOICE(0x14ed0, "I can do something.", 0x14ed5);
}
...
func void DIA_CARDEN_HELP_BOW_SEARCH() {
    ...
    INFO_CLEARCHOICES(0x14ed0);
    INFO_ADDCHOICE(0x14ed0, "I think I'll pass.", 0x14ed9);
    INFO_ADDCHOICE(0x14ed0, "Been doing worse.", 0x14ed8);
}
...
func void DIA_CARDEN_SQ112_FINISH_INFO() {
    ...
    B_GIVEINVITEMS(SELF, OTHER, 0x85ee, 1);
    CREATEINVITEMS(SELF, 0x85f0, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x85f0, 1);
...
func void CARDEN_TROPHYTRADE() {
    MARVIN_CURRENTSEALURKERCLAW = NPC_HASITEMS(OTHER, 0x8a19);
    MARVIN_CURRENTSEALURKERSKIN = NPC_HASITEMS(OTHER, 0x89f2);
    MARVIN_CURRENTLURKERCLAW = NPC_HASITEMS(OTHER, 0x843b);
    MARVIN_CURRENTLURKERSKIN = NPC_HASITEMS(OTHER, 0x8442);
    ...
    if ((NPC_HASITEMS(OTHER, 0x8a19)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 0x8a19, MARVIN_CURRENTSEALURKERCLAW);
        NPC_REMOVEINVITEMS(SELF, 0x8a19, MARVIN_CURRENTSEALURKERCLAW);
    };
    if ((NPC_HASITEMS(OTHER, 0x89f2)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 0x89f2, MARVIN_CURRENTSEALURKERSKIN);
        NPC_REMOVEINVITEMS(SELF, 0x89f2, MARVIN_CURRENTSEALURKERSKIN);
    };
    if ((NPC_HASITEMS(OTHER, 0x843b)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 0x843b, MARVIN_CURRENTLURKERCLAW);
        NPC_REMOVEINVITEMS(SELF, 0x843b, MARVIN_CURRENTLURKERCLAW);
    };
    if ((NPC_HASITEMS(OTHER, 0x8442)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 0x8442, MARVIN_CURRENTLURKERSKIN);
        NPC_REMOVEINVITEMS(SELF, 0x8442, MARVIN_CURRENTLURKERSKIN);
    };
    CREATEINVITEMS(SELF, 0x859b, CARDEN_MONEYFORTROPHY);
    B_GIVEINVITEMS(SELF, OTHER, 0x859b, CARDEN_MONEYFORTROPHY);
}

var int CARDEN_TROPHYTRADE.MARVIN_CURRENTSEALURKERCLAW = 0;
var int CARDEN_TROPHYTRADE.MARVIN_CURRENTSEALURKERSKIN = 0;
var int CARDEN_TROPHYTRADE.MARVIN_CURRENTLURKERCLAW = 0;
var int CARDEN_TROPHYTRADE.MARVIN_CURRENTLURKERSKIN = 0;
var int CARDEN_TROPHYTRADE.CARDEN_MONEYFORTROPHY = 0;
func void DIA_CARDEN_LURKERTROPHY_INFO() {
    AI_OUTPUT(OTHER, SELF, "DIA_Carden_LurkerTrophy_15_01");
    if (((((NPC_HASITEMS(OTHER, 0x8a19)) >= (1)) || ((NPC_HASITEMS(OTHER, 0x89f2)) >= (1))) || ((NPC_HASITEMS(OTHER, 0x843b)) >= (1))) || ((NPC_HASITEMS(OTHER, 0x8442)) >= (1))) {
...
func void DIA_CARDEN_SQ115_BOAR_INFO() {
    ...
    INFO_CLEARCHOICES(0x14ee9);
    INFO_ADDCHOICE(0x14ee9, "Where would I get their meat?", 0x14eec);
    if (!(NPC_KNOWSINFO(OTHER, 0x15e51))) {
        INFO_ADDCHOICE(0x14ee9, "Where can I find Markus?", 0x14eed);
    };
}
...
var int CARDENCANTEACHUS = 0;
var int CARDENCANTEACHUSHUNT = 0;
var int CARDENHUNTTEACHINFO = 0;
...
var int CARDEN_BOWLEVEL = 0;
var int CARDEN_DEXLEVEL = 0;
...
func void DIA_CARDEN_TEACH_CHOICES() {
    ...
    INFO_CLEARCHOICES(0x14ef8);
    INFO_ADDCHOICE(0x14ef8, DIALOG_BACK, 0x14f01);
    INFO_ADDCHOICE(0x14ef8, B_BUILDLEARNSTRING2(PRINT_LEARNDEX5, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_DEXTERITY, 5), (CARDEN_GOLDCOST) * (5)), 0x14efe);
    INFO_ADDCHOICE(0x14ef8, B_BUILDLEARNSTRING2(PRINT_LEARNDEX1, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_DEXTERITY, 1), CARDEN_GOLDCOST), 0x14efd);
    INFO_ADDCHOICE(0x14ef8, B_BUILDLEARNSTRING2(PRINT_LEARNBOW5, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_BOW, 5), (CARDEN_GOLDCOST) * (5)), 0x14f00);
    INFO_ADDCHOICE(0x14ef8, B_BUILDLEARNSTRING2(PRINT_LEARNBOW1, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_BOW, 1), CARDEN_GOLDCOST), 0x14eff);
}

var int DIA_CARDEN_TEACH_CHOICES.CARDEN_GOLDCOST = 0;
...
func void DIA_CARDEN_TEACHDEX1() {
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (CARDEN_PAYMENT1)) {
        if ((CARDEN_DEXLEVEL) < (OTHER.AIVAR[82])) {
            SND_PLAY(GELDBEUTEL);
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, CARDEN_PAYMENT1);
            NPC_REMOVEINVITEMS(SELF, 0x859b, CARDEN_PAYMENT1);
        };
...
func void DIA_CARDEN_TEACHDEX5() {
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (CARDEN_PAYMENT5)) {
        if ((CARDEN_DEXLEVEL) < (OTHER.AIVAR[82])) {
            SND_PLAY(GELDBEUTEL);
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, CARDEN_PAYMENT5);
            NPC_REMOVEINVITEMS(SELF, 0x859b, CARDEN_PAYMENT5);
        };
...
func int DIA_CARDEN_AMBIENT_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x14ecd)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_CARDEN_Q205_GUARDS_CONDITION() {
    if (((LOG_GETSTATUS(MIS_Q205)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x14ec4))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_CARDEN_SQ509_WHAT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x13913)) && (NPC_KNOWSINFO(OTHER, 0x14ec4))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_CARDEN_SQ509_MORE_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ509)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x14f0b))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_CARDEN_SQ509_MORE_INFO() {
    ...
    INFO_CLEARCHOICES(0x14f0e);
    INFO_ADDCHOICE(0x14f0e, "Do you know where they come from?", 0x14f11);
}
...
func void DIA_CARDEN_HUNTING_BASE_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (CARDEN_BASETROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[2]) == (TRUE)) {
            ...
            NPC_REMOVEINVITEMS(SELF, 0x859b, CARDEN_BASETROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Carden_Hunting_Base_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, CARDEN_BASETROPHY);
...
func void DIA_CARDEN_HUNTING_SPECIAL_CHOICES() {
    INFO_CLEARCHOICES(0x14f15);
    INFO_ADDCHOICE(0x14f15, DIALOG_BACK, 0x14f19);
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[7]) == (FALSE)) {
        INFO_ADDCHOICE(0x14f15, B_BUILDLEARNSTRING2(PRINT_TEACHBFSTING, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_BFSTING), CARDEN_STINGSTROPHY), 0x14f1a);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[15]) == (FALSE)) {
        INFO_ADDCHOICE(0x14f15, B_BUILDLEARNSTRING2(PRINT_TEACHFATS, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_FATS), CARDEN_FATSTROPHY), 0x14f1b);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[6]) == (FALSE)) {
        INFO_ADDCHOICE(0x14f15, B_BUILDLEARNSTRING2(PRINT_TEACHBFWING, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_BFWING), CARDEN_WINGSTROPHY), 0x14f1c);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[13]) == (FALSE)) {
        INFO_ADDCHOICE(0x14f15, B_BUILDLEARNSTRING2(PRINT_TEACHREPTILESKIN, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_REPTILESKIN), CARDEN_REPTILESKINTROPHY), 0x14f1d);
    };
}
...
func void DIA_CARDEN_HUNTING_SPECIAL_BFSTING() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (CARDEN_STINGSTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[7]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, CARDEN_STINGSTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Carden_Hunting_Special_BFSting_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, CARDEN_STINGSTROPHY);
...
func void DIA_CARDEN_HUNTING_SPECIAL_FATS() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (CARDEN_FATSTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[15]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, CARDEN_FATSTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Carden_Hunting_Special_Fats_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, CARDEN_FATSTROPHY);
...
func void DIA_CARDEN_HUNTING_SPECIAL_BFWING() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (CARDEN_WINGSTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[6]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, CARDEN_WINGSTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Carden_Hunting_Special_BFWing_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, CARDEN_WINGSTROPHY);
...
func void DIA_CARDEN_HUNTING_SPECIAL_REPTILESKIN() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (CARDEN_REPTILESKINTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[13]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, CARDEN_REPTILESKINTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Carden_Hunting_Special_ReptileSkin_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, CARDEN_REPTILESKINTROPHY);
...
func void DIA_CARDEN_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x14f1e);
    INFO_ADDCHOICE(0x14f1e, DIALOG_BACK, 0x14f22);
    INFO_ADDCHOICE(0x14f1e, DIALOG_PICKPOCKET, 0x14f21);
}

func void DIA_CARDEN_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (2)) {
        CREATEINVITEMS(SELF, 0x843b, 1);
        B_GIVEINVITEMS(SELF, OTHER, 0x843b, 1);
...
var int CARDENNEEDFUR_RAT_ENOUGH = 0;
var int CARDENNEEDFUR_WOLF_ENOUGH = 0;
var int CARDENNEEDFUR_KEILER_ENOUGH = 0;
var int CARDENNEEDFUR_RAT_COUNT = 0;
var int CARDENNEEDFUR_WOLF_COUNT = 0;
var int CARDENNEEDFUR_KEILER_COUNT = 0;
...
var int CARDEN_FURINSTANCE = 0;
var int CARDEN_FURVALUE = 0;
func void DIA_CARDEN_SELLFUR_CHOICES() {
    ...
    if ((((CARDENNEEDFUR_RAT_ENOUGH) == (TRUE)) && ((CARDENNEEDFUR_WOLF_ENOUGH) == (TRUE))) && ((CARDENNEEDFUR_KEILER_ENOUGH) == (TRUE))) {
        INFO_CLEARCHOICES(0x14f23);
    };
    INFO_CLEARCHOICES(0x14f23);
    INFO_ADDCHOICE(0x14f23, DIALOG_BACK, 0x14f32);
    if (((NPC_HASITEMS(OTHER, 0x8a0d)) >= (1)) && ((CARDENNEEDFUR_RAT_ENOUGH) == (FALSE))) {
        INFO_ADDCHOICE(0x14f23, THROPHYNAME_RATFUR, 0x14f33);
    };
    if (((NPC_HASITEMS(OTHER, 0x8a0e)) >= (1)) && ((CARDENNEEDFUR_RAT_ENOUGH) == (FALSE))) {
        INFO_ADDCHOICE(0x14f23, THROPHYNAME_BLACKRATFUR, 0x14f34);
    };
    if (((NPC_HASITEMS(OTHER, 0x8438)) >= (1)) && ((CARDENNEEDFUR_WOLF_ENOUGH) == (FALSE))) {
        INFO_ADDCHOICE(0x14f23, THROPHYNAME_WOLFFUR, 0x14f35);
    };
    if (((NPC_HASITEMS(OTHER, 0x8a16)) >= (1)) && ((CARDENNEEDFUR_WOLF_ENOUGH) == (FALSE))) {
        INFO_ADDCHOICE(0x14f23, THROPHYNAME_BLACKWOLFFUR, 0x14f36);
    };
    if (((NPC_HASITEMS(OTHER, 0x8444)) >= (1)) && ((CARDENNEEDFUR_KEILER_ENOUGH) == (FALSE))) {
        INFO_ADDCHOICE(0x14f23, THROPHYNAME_KEILERSKIN, 0x14f37);
    };
    if (((NPC_HASITEMS(OTHER, 0x8a04)) >= (1)) && ((CARDENNEEDFUR_KEILER_ENOUGH) == (FALSE))) {
        INFO_ADDCHOICE(0x14f23, THROPHYNAME_YKEILERFUR, 0x14f38);
    };
}
...
func void DIA_CARDEN_SELLFUR_ALL() {
    if ((NPC_HASITEMS(OTHER, CARDEN_FURINSTANCE)) >= (1)) {
        ...
        CREATEINVITEMS(SELF, 0x859b, (MAX) * (CARDEN_FURVALUE));
        B_GIVEINVITEMS(SELF, OTHER, 0x859b, (MAX) * (CARDEN_FURVALUE));
        AI_STARTFACEANI(SELF, S_SMILE, 1, -(1));
        B_SAY(SELF, OTHER, "$REWARD_CALM");
        AI_RESETFACEANI(SELF);
        if (((CARDEN_FURINSTANCE) == (0x8444)) || ((CARDEN_FURINSTANCE) == (0x8a04))) {
            CARDENNEEDFUR_KEILER_COUNT = (CARDENNEEDFUR_KEILER_COUNT) + (MAX);
            if ((CARDENNEEDFUR_KEILER_COUNT) >= (6)) {
                CARDENNEEDFUR_KEILER_ENOUGH = TRUE;
                if ((CARDENNEEDFUR_KEILER_COUNT) > (6)) {
                    if ((CARDEN_FURINSTANCE) == (0x8444)) {
                        AI_FUNCTION(SELF, 0x14f3e);
                    } else if ((CARDEN_FURINSTANCE) == (0x8a04)) {
                        AI_FUNCTION(SELF, 0x14f3f);
                    };
                };
            };
        } else if (((CARDEN_FURINSTANCE) == (0x8438)) || ((CARDEN_FURINSTANCE) == (0x8a16))) {
            CARDENNEEDFUR_WOLF_COUNT = (CARDENNEEDFUR_WOLF_COUNT) + (MAX);
            if ((CARDENNEEDFUR_WOLF_COUNT) >= (14)) {
                CARDENNEEDFUR_WOLF_ENOUGH = TRUE;
                if ((CARDENNEEDFUR_WOLF_COUNT) > (14)) {
                    if ((CARDEN_FURINSTANCE) == (0x8438)) {
                        AI_FUNCTION(SELF, 0x14f40);
                    } else if ((CARDEN_FURINSTANCE) == (0x8a16)) {
                        AI_FUNCTION(SELF, 0x14f41);
                    };
                };
            };
        } else if (((CARDEN_FURINSTANCE) == (0x8a0d)) || ((CARDEN_FURINSTANCE) == (0x8a0e))) {
            CARDENNEEDFUR_RAT_COUNT = (CARDENNEEDFUR_RAT_COUNT) + (MAX);
            if ((CARDENNEEDFUR_RAT_COUNT) >= (16)) {
                CARDENNEEDFUR_RAT_ENOUGH = TRUE;
                if ((CARDENNEEDFUR_RAT_COUNT) > (16)) {
                    if ((CARDEN_FURINSTANCE) == (0x8a0d)) {
                        AI_FUNCTION(SELF, 0x14f42);
                    } else if ((CARDEN_FURINSTANCE) == (0x8a0e)) {
                        AI_FUNCTION(SELF, 0x14f43);
                    };
                };
            };
        };
...
var int DIA_CARDEN_SELLFUR_ALL.MAX = 0;
func void DIA_CARDEN_SELLFUR_5() {
    if ((NPC_HASITEMS(OTHER, CARDEN_FURINSTANCE)) >= (5)) {
        ...
        B_SAY(SELF, OTHER, "$REWARD_CALM");
        AI_RESETFACEANI(SELF);
        CREATEINVITEMS(SELF, 0x859b, (5) * (CARDEN_FURVALUE));
        if (((CARDEN_FURINSTANCE) == (0x8444)) || ((CARDEN_FURINSTANCE) == (0x8a04))) {
        ...
        if ((((((((CARDEN_FURINSTANCE) == (0x8a0d)) && ((CARDENNEEDFUR_RAT_ENOUGH) == (FALSE))) || (((CARDEN_FURINSTANCE) == (0x8a0e)) && ((CARDENNEEDFUR_RAT_ENOUGH) == (FALSE)))) || (((CARDEN_FURINSTANCE) == (0x8438)) && ((CARDENNEEDFUR_WOLF_ENOUGH) == (FALSE)))) || (((CARDEN_FURINSTANCE) == (0x8a16)) && ((CARDENNEEDFUR_WOLF_ENOUGH) == (FALSE)))) || (((CARDEN_FURINSTANCE) == (0x8444)) && ((CARDENNEEDFUR_KEILER_ENOUGH) == (FALSE)))) || (((CARDEN_FURINSTANCE) == (0x8a04)) && ((CARDENNEEDFUR_KEILER_ENOUGH) == (FALSE)))) {
            DIA_CARDEN_SELLFUR_AMMOUNT();
        } else {
            DIA_CARDEN_SELLFUR_CHOICES();
        } else {
...
var int DIA_CARDEN_SELLFUR_5.MAX = 0;
func void DIA_CARDEN_SELLFUR_1() {
    if ((NPC_HASITEMS(OTHER, CARDEN_FURINSTANCE)) >= (1)) {
        ...
        B_SAY(SELF, OTHER, "$REWARD_CALM");
        AI_RESETFACEANI(SELF);
        CREATEINVITEMS(SELF, 0x859b, CARDEN_FURVALUE);
        if (((CARDEN_FURINSTANCE) == (0x8444)) || ((CARDEN_FURINSTANCE) == (0x8a04))) {
...
func void CARDEN_GIVEBACKSTUFF_KEILER() {
    NPC_REMOVEINVITEMS(NONE_6262_CARDEN, 0x859b, (VALUE_KEILERFUR) * ((CARDENNEEDFUR_KEILER_COUNT) - (6)));
    PRINTSCREENS(PRINT_CARDENFUR, -(1), -(1), FONT_SCREENSMALL, 4);
    B_GIVEINVITEMS(HERO, NONE_6262_CARDEN, 0x859b, (VALUE_KEILERFUR) * ((CARDENNEEDFUR_KEILER_COUNT) - (6)));
}

func void CARDEN_GIVEBACKSTUFF_YKEILER() {
    NPC_REMOVEINVITEMS(NONE_6262_CARDEN, 0x859b, (VALUE_YKEILERFUR) * ((CARDENNEEDFUR_KEILER_COUNT) - (6)));
    PRINTSCREENS(PRINT_CARDENFUR, -(1), -(1), FONT_SCREENSMALL, 4);
    B_GIVEINVITEMS(HERO, NONE_6262_CARDEN, 0x859b, (VALUE_YKEILERFUR) * ((CARDENNEEDFUR_KEILER_COUNT) - (6)));
}

func void CARDEN_GIVEBACKSTUFF_WOLF() {
    NPC_REMOVEINVITEMS(NONE_6262_CARDEN, 0x859b, (VALUE_WOLFFUR) * ((CARDENNEEDFUR_WOLF_COUNT) - (14)));
    PRINTSCREENS(PRINT_CARDENFUR, -(1), -(1), FONT_SCREENSMALL, 4);
    B_GIVEINVITEMS(HERO, NONE_6262_CARDEN, 0x859b, (VALUE_WOLFFUR) * ((CARDENNEEDFUR_WOLF_COUNT) - (14)));
}

func void CARDEN_GIVEBACKSTUFF_BLACKWOLF() {
    NPC_REMOVEINVITEMS(NONE_6262_CARDEN, 0x859b, (VALUE_BLACKWOLFFUR) * ((CARDENNEEDFUR_WOLF_COUNT) - (14)));
    PRINTSCREENS(PRINT_CARDENFUR, -(1), -(1), FONT_SCREENSMALL, 4);
    B_GIVEINVITEMS(HERO, NONE_6262_CARDEN, 0x859b, (VALUE_BLACKWOLFFUR) * ((CARDENNEEDFUR_WOLF_COUNT) - (14)));
}

func void CARDEN_GIVEBACKSTUFF_RAT() {
    NPC_REMOVEINVITEMS(NONE_6262_CARDEN, 0x859b, (VALUE_RATFUR) * ((CARDENNEEDFUR_RAT_COUNT) - (16)));
    PRINTSCREENS(PRINT_CARDENFUR, -(1), -(1), FONT_SCREENSMALL, 4);
    B_GIVEINVITEMS(HERO, NONE_6262_CARDEN, 0x859b, (VALUE_RATFUR) * ((CARDENNEEDFUR_RAT_COUNT) - (16)));
}

func void CARDEN_GIVEBACKSTUFF_BLACKRAT() {
    NPC_REMOVEINVITEMS(NONE_6262_CARDEN, 0x859b, (VALUE_BLACKRATFUR) * ((CARDENNEEDFUR_RAT_COUNT) - (16)));
    PRINTSCREENS(PRINT_CARDENFUR, -(1), -(1), FONT_SCREENSMALL, 4);
    B_GIVEINVITEMS(HERO, NONE_6262_CARDEN, 0x859b, (VALUE_BLACKRATFUR) * ((CARDENNEEDFUR_RAT_COUNT) - (16)));
}
