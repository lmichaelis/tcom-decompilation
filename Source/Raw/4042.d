...
func int DIA_ERGO_SQ224_START_CONDITION() {
    if (((KAPITEL) >= (2)) && (NPC_KNOWSINFO(OTHER, 0x134b8))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}

var int ERGO_SQ224_TAKEQUEST = 0;
func void DIA_ERGO_SQ224_START_INFO() {
    ...
    INFO_CLEARCHOICES(0x13499);
    INFO_ADDCHOICE(0x13499, "I don't have time right now.", 0x134a0);
    INFO_ADDCHOICE(0x13499, "What's the idea?", 0x1349f);
    INFO_ADDCHOICE(0x13499, "I'm in, there's never enough honey!", 0x1349e);
}
...
func void DIA_ERGO_SQ224_START_HELLYES() {
    ...
    INFO_CLEARCHOICES(0x13499);
    INFO_ADDCHOICE(0x13499, "What plants do you want to grow?", 0x134a1);
    INFO_CLEARCHOICES(0x134a3);
    INFO_ADDCHOICE(0x134a3, "What plants do you want to grow?", 0x134a1);
}
...
func void DIA_ERGO_SQ224_START_YES_WHAT() {
    ...
    INFO_CLEARCHOICES(0x13499);
    INFO_ADDCHOICE(0x13499, "How many seeds do you need?", 0x134a2);
    INFO_CLEARCHOICES(0x134a3);
    INFO_ADDCHOICE(0x134a3, "How many seeds do you need?", 0x134a2);
}
...
func int DIA_ERGO_SQ224_TAKEQUEST_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x13499)) && ((ERGO_SQ224_TAKEQUEST) == (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_ERGO_SQ224_GOTSEEDS_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ224)) == (LOG_RUNNING)) && ((NPC_HASITEMS(OTHER, 0x89ee)) >= (10))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ERGO_SQ224_GOTSEEDS_INFO() {
    ...
    B_USEFAKEBAG();
    B_GIVEINVITEMS(OTHER, SELF, 0x89ee, 10);
    AI_STARTFACEANI(SELF, S_SMILE, 0, 1);
    AI_OUTPUT(SELF, OTHER, "DIA_ERGO_SQ224_GotSeeds_03_03");
    CREATEINVITEMS(SELF, 0x90d8, 5);
    B_GIVEINVITEMS(SELF, OTHER, 0x90d8, 5);
...
func int DIA_ERGO_SQ224_RIGHTPLACE_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ224)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x134a6))) && ((NPC_GETDISTTOWP(SELF, "PART4_SQ224_ERGO")) <= (700))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ERGO_SQ224_WORKDONE_INFO() {
    ...
    INFO_CLEARCHOICES(0x134ac);
    INFO_ADDCHOICE(0x134ac, "I think I'll pass.", 0x134b1);
    INFO_ADDCHOICE(0x134ac, "I'd love to.", 0x134b0);
}
...
func int DIA_ERGO_SQ224_HONEYREADY_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ224)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x134ac))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ERGO_SQ224_HONEYREADY_INFO() {
    ...
    if (((KAPITEL) >= ((SQ224_WAITFORHONEY) + (1))) == (TRUE)) {
        ...
        AI_WAITTILLEND(SELF, OTHER);
        B_STANDUP();
        CREATEINVITEMS(SELF, 0x8e5b, 4);
        B_GIVEINVITEMS(SELF, OTHER, 0x8e5b, 3);
        B_USEITEM(SELF, 0x8e5b);
        AI_WAIT(OTHER, 0x3e99999a);
        B_USEITEM(OTHER, 0x8e5b);
...
func int DIA_ERGO_AMBIENT_CONDITION() {
    if ((NPC_ISINSTATE(SELF, 0xf09f)) && (NPC_KNOWSINFO(OTHER, 0x134b8))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ERGO_AMBIENT_INFO() {
    ...
    if (((LOG_GETSTATUS(MIS_SQ224)) != (LOG_SUCCESS)) && (!(NPC_KNOWSINFO(OTHER, 0x134b5)))) {
        AI_OUTPUT(SELF, OTHER, "DIA_Ergo_Ambient_03_01");
    };
    if (((LOG_GETSTATUS(MIS_SQ224)) == (LOG_SUCCESS)) && (!(NPC_KNOWSINFO(OTHER, 0x134b5)))) {
        AI_OUTPUT(SELF, OTHER, "DIA_Ergo_Ambient_03_02");
    };
    if (NPC_KNOWSINFO(OTHER, 0x134b5)) {
...
func void DIA_ERGO_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x134be);
    INFO_ADDCHOICE(0x134be, DIALOG_BACK, 0x134c2);
    INFO_ADDCHOICE(0x134be, DIALOG_PICKPOCKET, 0x134c1);
}

func void DIA_ERGO_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (2)) {
        CREATEINVITEMS(SELF, 0x84bc, 1);
        B_GIVEINVITEMS(SELF, OTHER, 0x84bc, 1);
