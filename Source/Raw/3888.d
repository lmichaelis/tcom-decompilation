...
func void DIA_WORRIEDCITIZENMAIN_BELIAREVENT_INFO() {
    ...
    INFO_CLEARCHOICES(0x11eed);
    INFO_ADDCHOICE(0x11eed, "Every god deserves to be worshiped.", 0x11ef0);
    INFO_ADDCHOICE(0x11eed, "If you don't leave me alone, I'll put a curse on you...", 0x11ef1);
    INFO_ADDCHOICE(0x11eed, "It's none of your business what I have in my garden.", 0x11ef2);
}
...
func int DIA_WORRIEDCITIZENMAIN_AFTERBELIAREVENT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x11eed)) && (NPC_ISINSTATE(SELF, 0xf09f))) {
        return TRUE;
    };
