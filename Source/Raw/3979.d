...
func void DIA_NIZAR_QA401_WAIT_INFO() {
    ...
    AI_STARTSTATE(BDT_13569_SMUGGLER, 0xf08e, 1, "");
    AI_TURNTONPC(NONE_7005_HEKTOR, HERO);
    AI_STARTSTATE(NONE_7005_HEKTOR, 0xf08e, 1, "");
    ...
    INFO_CLEARCHOICES(0x12d7f);
    INFO_ADDCHOICE(0x12d7f, "(Draw your weapon)", 0x12d84);
    INFO_ADDCHOICE(0x12d7f, "Orders are orders... We're not to spare anyone.", 0x12d83);
    INFO_ADDCHOICE(0x12d7f, "Get out of here now, or you'll end up like the rest of them.", 0x12d82);
}
