...
func int DIA_ARWID_KQ402_WHATDO_CONDITION() {
    if (((LOG_GETSTATUS(MIS_KQ402)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x104db))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ARWID_KQ402_WHATDO_INFO() {
    ...
    INFO_CLEARCHOICES(0x104df);
    INFO_ADDCHOICE(0x104df, "Tell me everything in detail.", 0x104e4);
    INFO_ADDCHOICE(0x104df, "Get to the point.", 0x104e5);
}

var int ARWID_KQ402_STORY = 0;
...
func int DIA_ARWID_KQ402_GOTPOTIONS_CONDITION() {
    if (((LOG_GETSTATUS(MIS_KQ402)) == (LOG_RUNNING)) && ((NPC_HASITEMS(OTHER, 0x91cb)) >= (5))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ARWID_KQ402_GOTPOTIONS_INFO() {
    ...
    INFO_CLEARCHOICES(0x104e6);
    INFO_ADDCHOICE(0x104e6, "1000 gold pieces.", 0x104eb);
    INFO_ADDCHOICE(0x104e6, "500 gold pieces.", 0x104ea);
}

func void DIA_ARWID_KQ402_GOTPOTIONS_NEXT() {
    CREATEINVITEMS(SELF, 0x859b, KQ402_RAMHAPAYMENT_V2);
    B_GIVEINVITEMS(SELF, OTHER, 0x859b, KQ402_RAMHAPAYMENT_V2);
    AI_RESETFACEANI(SELF);
...
func int DIA_ARWID_KQ402_RIGHTPLACE_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_KQ402)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x104e6))) && ((NPC_GETDISTTOWP(SELF, "HARBOUR_PATH_390")) <= (500))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ARWID_KQ402_RIGHTPLACE_INFO() {
    ...
    INFO_CLEARCHOICES(0x104ec);
    INFO_ADDCHOICE(0x104ec, "Talk to him. I'll sneak up behind his back.", 0x104f1);
    INFO_ADDCHOICE(0x104ec, "Maybe he'll go for the gold?", 0x104ef);
    INFO_ADDCHOICE(0x104ec, "Provoke him! I'll go into the warehouse while you're at it.", 0x104f0);
}
...
func int DIA_ARWID_KQ402_JOBDONE_CONDITION() {
    if (((LOG_GETSTATUS(MIS_KQ402)) == (LOG_RUNNING)) && (NPC_ISINSTATE(SELF, 0xf09f))) {
        if (((((((MOB_HASITEMS("KQ402_CHEST_01", 0x91cb)) >= (1)) && ((MOB_HASITEMS("KQ402_CHEST_02", 0x91cb)) >= (1))) && ((MOB_HASITEMS("KQ402_CHEST_03", 0x91cb)) >= (1))) && ((MOB_HASITEMS("KQ402_CHEST_04", 0x91cb)) >= (1))) && ((MOB_HASITEMS("KQ402_CHEST_05", 0x91cb)) >= (1))) || ((KQ402_ENOUGHPOTIONS_COUNT) == (5))) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
...
func int DIA_ARWID_KQ402_YOUGOOD_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_KQ402)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x104f3))) && ((NPC_GETDISTTOWP(SELF, "HARBOUR_PATH_128")) <= (500))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}

var int ARWID_KQ402_GOTARMOR = 0;
func void DIA_ARWID_KQ402_YOUGOOD_INFO() {
    ...
    AI_RESETFACEANI(SELF);
    if ((NPC_HASITEMS(OTHER, 0x846f)) >= (1)) {
