func void EVENTSMANAGER_SQ213() {
    if ((LOG_GETSTATUS(MIS_SQ213)) == (LOG_RUNNING)) {
        ...
        if ((SQ213_SPAWNRAZORS) == (1)) {
            ...
            if ((NPC_ISDEAD(SNAPPER_SQ213_BIG)) == (FALSE)) {
                MEAT = MOB_HASITEMGROUP("KM_SQ213_FARMERBODY", 0x7e2a);
                if ((MEAT) > (11)) {
        ...
        if (((NPC_HASITEMS(HERO, 0x922c)) >= (1)) && ((SQ213_GOTVINE) == (0))) {
        ...
        if ((SQ213_SONGRESULT) == (3)) {
            if (NPC_ISINSTATE(HERO, 0xf0a3)) {
                ...
                MDL_STARTFACEANI(MIL_6318_LUTZ, S_NEUTRAL, 0x3f800000, -1082130432);
                SQ213_SONGRESULT = 4;
                AI_FUNCTION(HERO, 0xf458);
            } else if (NPC_ISINSTATE(MIL_6318_LUTZ, 0xf0a3)) {
                SQ213_SONGRESULT = 5;
                MIL_6318_LUTZ.AIVAR[95] = FALSE;
                MIL_6318_LUTZ.AIVAR[94] = FALSE;
                NPC_CLEARAIQUEUE(BAU_703_MARTHA);
                BAU_703_MARTHA.ATTRIBUTE[4] = 0xf423f;
                BAU_703_MARTHA.FLAGS = 2;
                B_IMMEDIATEATTACKPLAYER(BAU_703_MARTHA, AR_NONE);
            };
        };
        if (((SQ213_SONGRESULT) == (5)) && (NPC_ISINSTATE(HERO, 0xf0a3))) {
            NPC_CLEARAIQUEUE(BAU_703_MARTHA);
            ...
            MDL_STARTFACEANI(BAU_703_MARTHA, S_NEUTRAL, 0x3f800000, -1082130432);
    ...
    if ((LOG_GETSTATUS(MIS_SQ213)) == (LOG_SUCCESS)) {
        if ((SQ213_LUTZ_CHANGERTNSILBACH) == (FALSE)) {
            if ((SQ213_WAITTONEXTQUEST_DAY) <= ((WLD_GETDAY()) - (1))) {
                if (((((NPC_ISINSTATE(MIL_6318_LUTZ, 0xf09f)) == (FALSE)) && ((NPC_ISINSTATE(BAU_722_RASCO, 0xf09f)) == (FALSE))) && ((NPC_ISINSTATE(BAU_702_VIKTOR, 0xf09f)) == (FALSE))) && ((NPC_ISINSTATE(BAU_703_MARTHA, 0xf09f)) == (FALSE))) {
...
var int EVENTSMANAGER_SQ213.SQ213_LUTZDEBT_REMINDER = 0;
var int EVENTSMANAGER_SQ213.MEAT = 0;
var int EVENTSMANAGER_SQ213.SQ213_TELLKARIN = 0;
