var int SQ225_TELEPORTSTARW_01 = 0;
var int SQ225_TELEPORTSTARW_02 = 0;
var int SQ225_TELEPORTSTARW_03 = 0;
var int SQ225_TELEPORTSTARW_04 = 0;
var int SQ225_TELEPORTSTARW_05 = 0;
var int SQ225_TELEPORTSTARW_06 = 0;
var int SQ225_TELEPORTSTARW_07 = 0;
var int SQ225_TELEPORTSTARW_08 = 0;
var int SQ225_TELEPORTSTARW_09 = 0;
var int SQ225_TELEPORTSTARW_10 = 0;
...
var int SQ225_ANDERAS_PREPARESCENE_APPLY.SQ225_ANDERAS_PREPARESCENE_COLLISION = 0;
instance SQ225_ANDERAS_PREPARESCENE_APPLY.MOVER1(ZCMOVER)
instance SQ225_ANDERAS_PREPARESCENE_APPLY.MOVER2(ZCMOVER)
var int SQ225_ANDERAS_PREPARESCENE_APPLY.MOVPTR1 = 0;
var int SQ225_ANDERAS_PREPARESCENE_APPLY.MOVPTR2 = 0;
func void SQ225_HIDEEVENTS_ANDERASWAY() {
    if ((SQ225_ANDERASWAY_AGREEDCHECK) == (TRUE)) {
        if ((SQ225_TELEPORTSTARW_01) == (TRUE)) {
            ...
            B_REMOVENPC(0xc708);
        } else if ((SQ225_TELEPORTSTARW_02) == (TRUE)) {
            WLD_SENDTRIGGER("KM_STRAWDESTROYED_02");
        } else {
            B_REMOVENPC(0xc709);
        } else if ((SQ225_TELEPORTSTARW_03) == (TRUE)) {
            WLD_SENDTRIGGER("KM_STRAWDESTROYED_03");
        } else {
            B_REMOVENPC(0xc70a);
        } else if ((SQ225_TELEPORTSTARW_04) == (TRUE)) {
            WLD_SENDTRIGGER("KM_STRAWDESTROYED_04");
        } else {
            B_REMOVENPC(0xc70b);
        } else if ((SQ225_TELEPORTSTARW_05) == (TRUE)) {
            WLD_SENDTRIGGER("KM_STRAWDESTROYED_05");
        } else {
            B_REMOVENPC(0xc70c);
        } else if ((SQ225_TELEPORTSTARW_06) == (TRUE)) {
            WLD_SENDTRIGGER("KM_STRAWDESTROYED_06");
        } else {
            B_REMOVENPC(0xc70d);
        } else if ((SQ225_TELEPORTSTARW_07) == (TRUE)) {
            WLD_SENDTRIGGER("KM_STRAWDESTROYED_07");
        } else {
            B_REMOVENPC(0xc70e);
        } else if ((SQ225_TELEPORTSTARW_08) == (TRUE)) {
            WLD_SENDTRIGGER("KM_STRAWDESTROYED_08");
        } else {
            B_REMOVENPC(0xc70f);
        } else if ((SQ225_TELEPORTSTARW_09) == (TRUE)) {
            WLD_SENDTRIGGER("KM_STRAWDESTROYED_09");
        } else {
            B_REMOVENPC(0xc710);
        } else if ((SQ225_TELEPORTSTARW_10) == (TRUE)) {
            WLD_SENDTRIGGER("KM_STRAWDESTROYED_10");
        } else {
            B_REMOVENPC(0xc711);
        } else if (((SQ225_FIRECARTWAIT) != (2)) || ((SQ225_FIRECARTWAIT) == (0))) {
...
func void SQ225_PREPAREGIANTBUGSCAVE() {
    ...
    WLD_INSERTNPC(0xc504, "PART2_TUNNEL_12");
    WLD_INSERTNPC(0xc505, "PART2_TUNNEL_11");
    WLD_INSERTNPC(0xc506, "PART2_TUNNEL_09");
    WLD_INSERTNPC(0xc507, "PART2_TUNNEL_08");
    WLD_INSERTNPC(0xc508, "PART2_TUNNEL_06");
    WLD_INSERTNPC(0xc509, "PART2_TUNNEL_07");
    WLD_INSERTNPC(0xc50a, "PART2_TUNNEL_03");
}
...
func void SQ225_ANDERASWAY_STARTCUTSCENE_APPLY() {
    ...
    if ((SQ225_ANDERASWAY_STARTCUTSCENE_COUNT) == (4)) {
        ...
        CUTSCENE_START(0x16ae5);
    };
}

var int SQ225_ANDERASWAY_STARTCUTSCENE_APPLY.SQ225_ANDERASWAY_STARTCUTSCENE_COUNT = 0;
func void SQ225_HOLDWIGWAY_STARTCUTSCENE_APPLY() {
    ...
    if ((SQ225_HOLDWIGWAY_STARTCUTSCENE_COUNT) == (4)) {
        ...
        CUTSCENE_START(0x16aed);
    };
}

var int SQ225_HOLDWIGWAY_STARTCUTSCENE_APPLY.SQ225_HOLDWIGWAY_STARTCUTSCENE_COUNT = 0;
func void SQ225_REMOVEVENZELFRIEND() {
    ...
    if ((SQ225_REMOVEVENZELFRIEND_COUNT) == (1)) {
        ...
        TELEPORTNPCTOWP(0xcd53, VLK_64260_ERVALT.WP);
    ...
    if ((SQ225_REMOVEVENZELFRIEND_COUNT) == (2)) {
        ...
        TELEPORTNPCTOWP(0xcd56, VLK_64261_ARTHUR.WP);
        WLD_INSERTITEM(0x9df8, "FP_VENZEL_PRISONNOTE");
    };
}

var int SQ225_REMOVEVENZELFRIEND.SQ225_REMOVEVENZELFRIEND_COUNT = 0;
