...
func void SPAWNARAXOSFASTTRAVEL(var string WP, var string ROUTINE) {
    ...
    TELEPORTNPCTOWP(0xe032, WP);
}

func int SPAWNARAXOSFASTTRAVELISAVAILABLE(var string WP) {
    if (((NPC_GETDISTTOWP(HERO, WP)) <= (0xfa0)) && ((HLP_STRCMP(SPAWNARAXOSFASTTRAVEL_GQ001_LASTWP, WP)) == (FALSE))) {
...
func void SPAWNTHUGS(var string WP, var string ROUTINE) {
    ...
    TELEPORTNPCTOWP(0xd72d, CONCATSTRINGS(WP, "_03"));
    if ((LOG_GETSTATUS(MIS_FMQ003)) == (LOG_RUNNING)) {
        TELEPORTNPCTOWP(0xd73b, CONCATSTRINGS(WP, "_02"));
        TELEPORTNPCTOWP(0xd734, CONCATSTRINGS(WP, "_01"));
    };
}
...
func void SPAWNBORR(var string WP, var string ROUTINE) {
    FADESCREENTOBLACKF(1, 0xfb11, 1000);
}
...
func void SPAWNGERHARD(var string WP, var string ROUTINE) {
    ...
    TELEPORTNPCTOWP(0xd0a7, VLK_3014_GERHARD_VINEYARDFIGHT.WP);
...
func int SPAWNGERHARDISAVAILABLE(var string WP) {
    if (((NPC_GETDISTTOWP(HERO, WP)) <= (0xbb8)) && ((HLP_STRCMP(SPAWNGERHARD_SQ225_LASTWP, WP)) == (FALSE))) {
...
func void SPAWNFARMER(var string WP, var string ROUTINE) {
    ...
    TELEPORTNPCTOWP(0xde9d, BAU_11216_FARMER.WP);
}

func int SPAWNFARMERISAVAILABLE(var string WP) {
    if (((NPC_GETDISTTOWP(HERO, WP)) <= (0xbb8)) && ((HLP_STRCMP(SPAWNFARMER_SQ225_LASTWP, WP)) == (FALSE))) {
...
func int SPAWNKESSELISAVAILABLE(var string WP) {
    if ((NPC_GETDISTTOWP(HERO, WP)) <= (0x1388)) {
