...
func void QM401_FINALBATTLE_FADESCREEN() {
    ...
    FF_APPLYONCEEXT(0x16aab, 1000, 32);
}
...
func void QM401_FINALBATTLE_TIMER() {
    ...
    if ((QM401_FINALBATTLE_TIMER_COUNT) == (12)) {
        ...
        B_REMOVENPC(0xc3b0);
        TELEPORTNPCTOWP(0xc3b0, MARVIN_CUTSCENEHELPER_QM401.WP);
    };
    ...
    if ((QM401_FINALBATTLE_TIMER_COUNT) == (29)) {
        FF_APPLYONCEEXT(0xf585, 75, 4);
    };
}

var int QM401_FINALBATTLE_TIMER.QM401_FINALBATTLE_TIMER_COUNT = 0;
