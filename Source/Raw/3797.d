...
func int DIA_SUNDER_FAQ001_GIVEBEER_CONDITION() {
    if ((((NPC_ISINSTATE(SELF, 0xf09f)) && (NPC_KNOWSINFO(OTHER, 0x116fc))) && ((SUNDERBEER) == (FALSE))) && ((LOG_GETSTATUS(MIS_FAQ001)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_SUNDER_FAQ001_GIVEBEER_INFO() {
    ...
    INFO_CLEARCHOICES(0x11700);
    INFO_ADDCHOICE(0x11700, "I'm still working on it.", 0x11703);
    if (NPC_HASITEMS(OTHER, 0x913b)) {
        INFO_ADDCHOICE(0x11700, "That should get you back on your feet.", 0x11704);
    };
}
...
func void DIA_SUNDER_FAQ001_GIVEBEER_YES() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 0x913b, 1);
    AI_WAITTILLEND(OTHER, SELF);
    AI_WAITTILLEND(SELF, OTHER);
    AI_STOPLOOKAT(SELF);
    CREATEINVITEM(SELF, 0x8cc8);
    AI_USEITEMTOSTATE(SELF, 0x8cc8, 1);
    AI_STARTFACEANI(SELF, S_DISGUST, 1, -(1));
    AI_OUTPUT(SELF, OTHER, "DIA_Sunder_FAQ001_GiveBeer_Yes_03_03");
    INFO_CLEARCHOICES(0x11700);
    INFO_ADDCHOICE(0x11700, "Dishwater in a pint glass.", 0x11706);
    INFO_ADDCHOICE(0x11700, "Vengard Light.", 0x11707);
}
...
func void DIA_SUNDER_FAQ001_GIVEBEER_FINALCHOICES() {
    ...
    AI_RESETFACEANI(SELF);
    INFO_CLEARCHOICES(0x11700);
    INFO_ADDCHOICE(0x11700, "Dima is waiting to hear from you.", 0x1170a);
    INFO_ADDCHOICE(0x11700, "What do you do?", 0x11709);
    INFO_ADDCHOICE(0x11700, "Why were you so drunk last night?", 0x11708);
}
...
func void DIA_SUNDER_FAQ001_SEARCH_INFO() {
    ...
    AI_RESETFACEANI(OTHER);
    INFO_CLEARCHOICES(0x1170f);
    INFO_ADDCHOICE(0x1170f, "I'm not gonna lie to Dima.", 0x11713);
    INFO_ADDCHOICE(0x1170f, "Fine. Lead the way.", 0x11712);
}
...
func void DIA_SUNDER_FAQ001_FOUNDBODY_INFO() {
    ...
    AI_RESETFACEANI(OTHER);
    INFO_CLEARCHOICES(0x11717);
    INFO_ADDCHOICE(0x11717, "The same thing could have happened to you as the man you were waiting for.", 0x1171b);
    INFO_ADDCHOICE(0x11717, "It doesn't matter. I think I found the man you're looking for.", 0x1171c);
}
...
func int DIA_SUNDER_FAQ001_SURPRISED_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x11717)) && ((LOG_GETSTATUS(MIS_FAQ001)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_SUNDER_HUNTERS_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x1171d)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_SUNDER_QA401_LETSGO_CONDITION() {
    if (((LOG_GETSTATUS(MIS_QA401)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x1122c))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_SUNDER_QA401_RIGHTPLACE_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_QA401)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x11723))) && ((NPC_GETDISTTOWP(SELF, SELF.WP)) <= (500))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_SUNDER_QA401_RIGHTPLACE_INFO() {
    ...
    INFO_CLEARCHOICES(0x11726);
    INFO_ADDCHOICE(0x11726, "Here?", 0x11729);
}
...
func void DIA_SUNDER_QA401_RIGHTPLACE_HERE() {
    ...
    INFO_CLEARCHOICES(0x11726);
    INFO_ADDCHOICE(0x11726, DIALOG_GIVEMESCROLL, 0x1172c);
    INFO_ADDCHOICE(0x11726, "What do I have to remember?", 0x1172b);
    INFO_ADDCHOICE(0x11726, "So you're not even sure if the tunnels connect?", 0x1172a);
}
...
func void DIA_SUNDER_QA401_RIGHTPLACE_HERE_GIVE() {
    ...
    AI_WAITTILLEND(SELF, OTHER);
    CREATEINVITEMS(SELF, 0x952c, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x952c, 1);
    AI_RESETFACEANI(SELF);
    AI_RESETFACEANI(OTHER);
    INFO_CLEARCHOICES(0x11726);
    AI_STOPPROCESSINFOS(SELF);
...
var int SUNDER_NOMORE = 0;
var int SUNDER_CURRENT1HLEVEL = 0;
var int SUNDER_CURRENT2HLEVEL = 0;
var int SUNDER_CURRENTSTRLEVEL = 0;
...
func int DIA_SUNDER_TEACH_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x1172d)) && ((SUNDER_NOMORE) == (FALSE))) && ((OTHER.GUILD) == (GIL_SLD))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_SUNDER_TEACH_CHOICES() {
    ...
    SUNDER_GOLDCOST = 0;
    INFO_CLEARCHOICES(0x11736);
    INFO_ADDCHOICE(0x11736, DIALOG_BACK, 0x1173d);
    INFO_ADDCHOICE(0x11736, B_BUILDLEARNSTRING2(PRINT_LEARN1H1, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_1H, 1), SUNDER_GOLDCOST), 0x1173f);
    INFO_ADDCHOICE(0x11736, B_BUILDLEARNSTRING2(PRINT_LEARN1H5, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_1H, 5), (SUNDER_GOLDCOST) * (5)), 0x11741);
    INFO_ADDCHOICE(0x11736, B_BUILDLEARNSTRING2(PRINT_LEARNSTR1, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_STRENGTH, 1), SUNDER_GOLDCOST), 0x11745);
    INFO_ADDCHOICE(0x11736, B_BUILDLEARNSTRING2(PRINT_LEARNSTR5, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_STRENGTH, 5), (SUNDER_GOLDCOST) * (5)), 0x11747);
    if ((MARVIN_ARAXOSSPECIALIZATION) >= (1)) {
        INFO_ADDCHOICE(0x11736, B_BUILDLEARNSTRING2(PRINT_LEARN2H1, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_2H, 1), SUNDER_GOLDCOST), 0x11742);
        INFO_ADDCHOICE(0x11736, B_BUILDLEARNSTRING2(PRINT_LEARN2H5, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_2H, 5), (SUNDER_GOLDCOST) * (5)), 0x11743);
    };
}

var int DIA_SUNDER_TEACH_CHOICES.SUNDER_GOLDCOST = 0;
...
func void DIA_SUNDER_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x1174b);
    INFO_ADDCHOICE(0x1174b, DIALOG_BACK, 0x1174f);
    INFO_ADDCHOICE(0x1174b, DIALOG_PICKPOCKET, 0x1174e);
}

func void DIA_SUNDER_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (1)) {
        CREATEINVITEMS(SELF, 0x8e12, 1);
        B_GIVEINVITEMS(SELF, OTHER, 0x8e12, 1);
