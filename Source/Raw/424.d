instance DIA_Q308_MAGES_BUSY(C_INFO) {
    NR = 1;
    CONDITION = DIA_Q308_MAGES_BUSY_CONDITION;
    INFORMATION = DIA_Q308_MAGES_BUSY_INFO;
    PERMANENT = TRUE;
    IMPORTANT = TRUE;
}

func int DIA_Q308_MAGES_BUSY_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_Q312)) == (LOG_RUNNING)) && (NPC_ISINSTATE(SELF, 0xf09f))) || (((LOG_GETSTATUS(MIS_Q308)) == (LOG_RUNNING)) && (NPC_ISINSTATE(SELF, 0xf09f)))) {
        return FALSE;
    };
