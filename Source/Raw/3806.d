var int HOMELESS_AGAIN = 0;
var int HOMELESS_ASK = 0;
var int HOMELESS_COUNT = 0;
var int HOMELESS_HELP = 0;
...
func int DIA_HOMELESS_HOMELESSGOLD_CONDITION() {
    if (((NPC_HASITEMS(OTHER, 0x859b)) >= (HOMELESS_ASKFORMONEY)) && (NPC_KNOWSINFO(OTHER, 0x118d7))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_HOMELESS_AMBIENTTALK_CONDITION() {
    if (((((HOMELESS_AGAIN) == (WLD_GETDAY())) && (NPC_ISINSTATE(SELF, 0xf09f))) && ((HOMELESS_HELP) == (TRUE))) && ((SELF.AIVAR[66]) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
