func void EVENTSMANAGER_Q403() {
    if ((LOG_GETSTATUS(MIS_Q403)) == (LOG_RUNNING)) {
        ...
        if ((NPC_ISINSTATE(DJG_10015_BAES, 0xf09f)) == (FALSE)) {
    ...
    if ((LOG_GETSTATUS(MIS_Q403)) == (LOG_SUCCESS)) {
        ...
        if ((Q402_GRONVOMIT) == (2)) {
            ...
            TELEPORTNPCTOWP(0xe399, DJG_10011_GRON.WP);
            Q402_GRONVOMIT = 3;
        };
        ...
        if ((Q404_CHANGENPCRTN) == (FALSE)) {
            ...
            TELEPORTNPCTOWP(0xe3ab, DJG_10014_VAHRAL.WP);
            B_STARTOTHERROUTINE(DJG_10017_LEGRIF, "NORMALDAY");
            NPC_REFRESH(DJG_10017_LEGRIF);
            TELEPORTNPCTOWP(0xe3c0, DJG_10017_LEGRIF.WP);
        };
    };
}
