func void SQ419_PREPARENPC() {
    WLD_INSERTNPC(0xe366, "PART16_SQ419_WOODCUTTER_01");
    WLD_INSERTNPC(0xe36a, "PART16_SQ419_WOODCUTTER_02");
    FF_APPLYONCEEXTGT(0xf9b5, 0, -(1));
}
...
var int SQ419_PREPARENPC_APPLY.SQ419_PREPARENPC_COUNT = 0;
instance SQ419_PREPARENPC_APPLY.MOVER1(ZCMOVER)
var int SQ419_PREPARENPC_APPLY.MOVPTR1 = 0;
...
var int SQ419_WOODCUTTINGCUTSCENE_END_APPLY.SQ419_WOODCUTTINGCUTSCENE_END_COUNT = 0;
...
var int SQ419_WOODTANNINGCUTSCENE_END_APPLY.SQ419_WOODTANNINGCUTSCENE_END_COUNT = 0;
func void SQ419_FINALCUTSCENE_PREPARE() {
    HERO.AIVAR[4] = TRUE;
    FADESCREENTOBLACKF(1, 0xf9c3, 1000);
}

func void SQ419_FINALCUTSCENE_PREPARE_FADESCREEN() {
    WLD_SENDTRIGGER("SQ419_MOVER_WOLFSHEAD");
    FF_APPLYONCEEXT(0xf9c4, 75, 4);
}
...
func void SQ419_FINALCUTSCENE_PREPARE_APPLY() {
    ...
    if ((SQ419_FINALCUTSCENE_PREPARE_COUNT) == (4)) {
        CUTSCENE_START(0x16b41);
        SQ419_FINALCUTSCENE_PREPARE_COUNT = 0;
    };
}

var int SQ419_FINALCUTSCENE_PREPARE_APPLY.SQ419_FINALCUTSCENE_PREPARE_COUNT = 0;
func void SQ419_FINALCUTSCENE_END() {
    FF_APPLYONCEEXT(0xf9c7, 75, 4);
}
...
var int SQ419_FINALCUTSCENE_END_APPLY.SQ419_FINALCUTSCENE_END_COUNT = 0;
...
var int SQ419_REMOVELASTCART_APPLY.SQ419_REMOVELASTCART_COUNT = 0;
instance SQ419_REMOVELASTCART_APPLY.MOVER1(ZCMOVER)
var int SQ419_REMOVELASTCART_APPLY.MOVPTR1 = 0;
