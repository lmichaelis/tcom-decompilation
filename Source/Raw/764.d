...
var int ZS_SPEECH_HERALD_RANDOMSPEECH.RNDHERALDSPEECH = 0;
func void ZS_SPEECH_HERALD_STORYSPEECH() {
    if ((((((LOG_GETSTATUS(MIS_Q307)) == (LOG_SUCCESS)) && ((KAPITEL) != (5))) || (((LOG_GETSTATUS(MIS_Q312)) == (LOG_RUNNING)) || ((LOG_GETSTATUS(MIS_Q308)) == (LOG_RUNNING)))) || ((LOG_GETSTATUS(MIS_Q404)) == (LOG_SUCCESS))) || (((LOG_GETSTATUS(MIS_Q404)) == (LOG_SUCCESS)) && ((KAPITEL) < (5)))) {
        if ((NPC_GETSTATETIME(SELF)) >= (85)) {
            ...
            if (((RNDHERALDSPEECHSTORY) >= (25)) && ((RNDHERALDSPEECHSTORY) < (50))) {
            ...
            if (((RNDHERALDSPEECHSTORY) >= (50)) && ((RNDHERALDSPEECHSTORY) < (75))) {
            ...
            if (((RNDHERALDSPEECHSTORY) >= (75)) && ((RNDHERALDSPEECHSTORY) <= (100))) {
...
var int ZS_SPEECH_HERALD_STORYSPEECH.RNDHERALDSPEECHSTORY = 0;
