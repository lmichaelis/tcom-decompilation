...
func void DIA_DOGGO_HELLO_INFO() {
    ...
    INFO_CLEARCHOICES(0x10a2c);
    INFO_ADDCHOICE(0x10a2c, "(End the suffering)", 0x10a30);
    INFO_ADDCHOICE(0x10a2c, "(Take home)", 0x10a2f);
}
...
func void DOGGO_TAKEHOME() {
    FADESCREENTOBLACKF(2, 0x10a35, 1000);
}

func void DOGGO_DAMAGE() {
    FF_APPLYONCEEXT(0x10a33, 500, 2);
}
...
func void DOGGO_DAMAGE_APPLY() {
    ...
    if ((DOGGO_DAMAGE_COUNT) == (2)) {
        ...
        B_MAGICHURTNPC(HERO, NONE_13336_DOGGO, 0x270f);
        HERO.AIVAR[4] = FALSE;
    };
}

var int DOGGO_DAMAGE_APPLY.DOGGO_DAMAGE_COUNT = 0;
func void DOGGO_TAKEHOME_FADESCREEN() {
    TELEPORTNPCTOWP(0x71b, "PARTM5_HEROHOUSE_HERO_DOGGO");
    TELEPORTNPCTOWP(0xd11f, "PARTM5_HEROHOUSE_DOGGO");
...
func void DIA_DOGGO_PET_INFO() {
    ...
    AI_FUNCTION(SELF, 0x10a39);
    INFO_CLEARCHOICES(0x10a36);
    INFO_ADDCHOICE(0x10a36, DIALOG_FINISH, 0x10a3a);
}
...
func void DIA_DOGGO_NAME_INFO() {
    INFO_CLEARCHOICES(0x10a3c);
    INFO_ADDCHOICE(0x10a3c, CHOICE_ANSWER_NAME_DOG, 0x10a48);
}
...
func void RESTOREDOGGONAME() {
    HANDLE = GETPERSISTENTSTRINGSHANDLE();
    DATA = GET(HANDLE);
    FILLDOGGONAMEANDDIALOGS(DATA.DOGGONAME);
}

var int RESTOREDOGGONAME.HANDLE = 0;
instance RESTOREDOGGONAME.DATA(PERSISTENTSTRINGS)
...
var int SETDOGGONAME.HANDLE = 0;
instance SETDOGGONAME.DATA(PERSISTENTSTRINGS)
func void DIA_DOGGO_NAME_ONCHOICE() {
    SETDOGGONAME(INFOMANAGERANSWER);
}
...
func void DIA_DOGGO_GOODBYE_INFO() {
    ...
    AI_WAITTILLEND(OTHER, SELF);
    DIA_DOGGO_PET_STOP();
    AI_FUNCTION(SELF, 0x10a4c);
}

func void DOGGO_GOODBYEFADE() {
    FADESCREENTOBLACKF(1, 0x10a4d, 1000);
}
...
func void DOGGO_GOODBYEFADESCREEN() {
    ...
    TELEPORTNPCTOWP(0xd11f, NONE_13336_DOGGO.WP);
    HERO.AIVAR[4] = FALSE;
