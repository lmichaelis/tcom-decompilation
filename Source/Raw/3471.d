...
var int SQ118_FLORAGRAVE_APPLY.SQ118_FLORAGRAVE_COUNT = 0;
instance SQ118_FLORAGRAVE_APPLY.MOVER1(ZCMOVER)
instance SQ118_FLORAGRAVE_APPLY.MOVER2(ZCMOVER)
var int SQ118_FLORAGRAVE_APPLY.MOVPTR1 = 0;
var int SQ118_FLORAGRAVE_APPLY.MOVPTR2 = 0;
func void SQ118_SPAWNWEED() {
    WLD_INSERTITEM(0x85dd, "FP_PART12_WEED_01");
    WLD_INSERTITEM(0x85dd, "FP_PART12_WEED_02");
    WLD_INSERTITEM(0x85dd, "FP_PART12_WEED_03");
    WLD_INSERTITEM(0x85dd, "FP_PART12_WEED_04");
    WLD_INSERTITEM(0x85dd, "FP_PART12_WEED_05");
    WLD_INSERTITEM(0x85dd, "FP_PART12_WEED_06");
    WLD_INSERTITEM(0x85dd, "FP_PART12_WEED_07");
    WLD_INSERTITEM(0x85dd, "FP_PART12_WEED_08");
    WLD_INSERTITEM(0x85dd, "FP_PART12_WEED_09");
    WLD_INSERTITEM(0x85dd, "FP_PART12_WEED_10");
    WLD_INSERTITEM(0x85dd, "FP_PART12_WEED_11");
    WLD_INSERTITEM(0x85dd, "FP_PART12_WEED_12");
    WLD_INSERTITEM(0x85dd, "FP_PART12_WEED_13");
    WLD_INSERTITEM(0x85dd, "FP_PART12_WEED_14");
    WLD_INSERTITEM(0x85dd, "FP_PART12_WEED_15");
}

func void SQ118_ONITEMTAKEN_HOOK(var C_ITEM ITEM) {
    if ((HLP_GETINSTANCEID(ITEM)) == (0x85dd)) {
        NPC_REMOVEINVITEMS(HERO, 0x85dd, 1);
        CREATEINVITEMS(HERO, 0x85dc, 1);
