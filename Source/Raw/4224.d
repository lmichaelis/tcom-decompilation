...
func int DIA_GRIZ_QA301_ADELARD_CONDITION() {
    if (((LOG_GETSTATUS(MIS_QA301)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x11205))) {
        return TRUE;
    };
...
func int DIA_GRIZ_QA301_READY_CONDITION() {
    if (((LOG_GETSTATUS(MIS_QA301)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x14f61))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_GRIZ_QA301_WRONGWAY_CONDITION() {
    if (((LOG_GETSTATUS(MIS_QA301)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x14f64))) {
        if ((QA301_FOREST) == (0)) {
            if (((((NPC_GETDISTTOWP(SELF, "PART12_PATH_41")) >= (0x251c)) || ((NPC_GETDISTTOWP(SELF, "PART12_MOB_61")) <= (0x5dc))) || ((NPC_GETDISTTOWP(SELF, "PART12_MOB_60")) <= (0x5dc))) || ((NPC_GETDISTTOWP(SELF, "PART12_MOB_83")) <= (1000))) {
                return TRUE;
            };
        };
        if ((QA301_FOREST) == (1)) {
            if ((NPC_GETDISTTOWP(SELF, "PART12_PATH_45")) >= (0xdac)) {
                return TRUE;
            };
        };
        if ((QA301_FOREST) == (2)) {
            if ((NPC_GETDISTTOWP(SELF, "PART12_PATH_85")) >= (0xdac)) {
                return TRUE;
            };
        };
        if ((QA301_FOREST) == (3)) {
            if ((NPC_GETDISTTOWP(SELF, "PART12_MOB_68")) >= (0x1b58)) {
                return TRUE;
            };
        };
    };
...
func void DIA_GRIZ_QA301_WRONGWAY_INFO() {
    ...
    AI_STOPPROCESSINFOS(SELF);
    AI_FUNCTION(SELF, 0x14f6b);
}

func void GRIZ_QA301_WRONGWAY() {
    FADESCREENTOBLACKF(1, 0x14f6c, 1000);
}

func void GRIZ_QA301_WRONGWAY_FADESCREEN() {
    if ((QA301_FOREST) == (0)) {
        TELEPORTNPCTOWP(0x71b, "PART12_PATH_02");
        TELEPORTNPCTOWP(0xe023, "PART12_QA301_SLD_01");
        AI_TELEPORTALWAYS(SLD_11054_ARAXOS_QA301, "PART12_QA301_SLD_01", TRUE);
        TELEPORTNPCTOWP(0xe02a, "PART12_QA301_SLD_02");
        AI_TELEPORTALWAYS(SLD_11055_ARAXOS_QA301, "PART12_QA301_SLD_02", TRUE);
        TELEPORTNPCTOWP(0xe16a, "PART12_QA301_SLD_03");
    ...
    if ((QA301_FOREST) == (1)) {
        ...
        TELEPORTNPCTOWP(0xe02a, "PART12_MOB_30");
        AI_TELEPORTALWAYS(SLD_11055_ARAXOS_QA301, "PART12_MOB_30", TRUE);
        TELEPORTNPCTOWP(0xe16a, "PART12_MOB_31");
        AI_TELEPORTALWAYS(SLD_11056_GRIZ, "PART12_MOB_31", TRUE);
        NPC_REFRESH(SLD_11055_ARAXOS_QA301);
        NPC_REFRESH(SLD_11056_GRIZ);
    };
    if ((QA301_FOREST) == (2)) {
        TELEPORTNPCTOWP(0x71b, "PART12_PATH_82");
        TELEPORTNPCTOWP(0xe16a, "PART12_PATH_75");
...
func void DIA_GRIZ_QA301_SEETHAT_INFO() {
    ...
    INFO_CLEARCHOICES(0x14f6d);
    INFO_ADDCHOICE(0x14f6d, "There's no need for that. Stay here.", 0x14f71);
    INFO_ADDCHOICE(0x14f6d, "You're right, let's go hunt it down.", 0x14f70);
}
...
func void DIA_GRIZ_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x14f7b);
    INFO_ADDCHOICE(0x14f7b, DIALOG_BACK, 0x14f7f);
    INFO_ADDCHOICE(0x14f7b, DIALOG_PICKPOCKET, 0x14f7e);
}
