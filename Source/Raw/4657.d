func void EVENTSMANAGER_CQ005() {
    ...
    if ((CQ005_CHANGESILVESTRRTN) == (TRUE)) {
        if (((NPC_GETDISTTOWP(PAL_101_SILVESTR, PARTM2_PATH_19)) <= (700)) && (!(NPC_ISINSTATE(PAL_101_SILVESTR, 0xf09f)))) {
    ...
    if ((CQ005_CHANGESILVESTRRTN) == (FALSE)) {
        if (((NPC_GETDISTTOWP(PAL_101_SILVESTR, "PARTM3_RODERICH_10")) <= (300)) && (!(NPC_ISINSTATE(PAL_101_SILVESTR, 0xf09f)))) {
            B_STARTOTHERROUTINE(PAL_101_SILVESTR, "CQ005_Smalltalk");
            CQ005_CHANGESILVESTRRTN = TRUE;
            PRINTD("Silvestr zmieni³ RTN");
        };
        if (((NPC_GETDISTTOWP(PAL_101_SILVESTR, "PART1_SILVESTR")) <= (300)) && (!(NPC_ISINSTATE(PAL_101_SILVESTR, 0xf09f)))) {
