var int JAVAD_Q305_WHO = 0;
var int JAVAD_Q305_WHY = 0;
...
func int DIA_JAVAD_KILLMARVIN_CONDITION() {
    if ((((NPC_HASITEMS(OTHER, 0x9188)) >= (1)) && ((LOG_GETSTATUS(MIS_Q305)) == (LOG_RUNNING))) && ((Q305_JAVAD_WENTTONEWHOME) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_JAVAD_CALMDOWN_CONDITION() {
    if (((Q305_JAVADFIGHT) == (2)) && (NPC_ISINSTATE(SELF, 0xf09f))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_JAVAD_CALMDOWN_INFO() {
    B_HEALNPC_SELF();
    B_STANDUP();
    if ((NPC_HASITEMS(OTHER, 0x9188)) >= (1)) {
    ...
    INFO_CLEARCHOICES(0x144e1);
    INFO_ADDCHOICE(0x144e1, "Maybe we can work something out?", 0x144e7);
    INFO_ADDCHOICE(0x144e1, "Why are you still sitting here?", 0x144e6);
    INFO_ADDCHOICE(0x144e1, "Who are you anyway?", 0x144e5);
}
...
func void DIA_JAVAD_CALMDOWN_TALK() {
    ...
    INFO_CLEARCHOICES(0x144e1);
    INFO_ADDCHOICE(0x144e1, "It will be easier if I kill you.", 0x144e8);
    INFO_ADDCHOICE(0x144e1, "All right. I'll get those beasts. What about you?", 0x144e9);
}

func void DIA_JAVAD_CALMDOWN_TALK_KILL() {
    Q305_JAVADFIGHT = 4;
    if ((NPC_HASEQUIPPEDMELEEWEAPON(SELF)) == (FALSE)) {
        CREATEINVITEMS(SELF, 0x83c2, 1);
...
func void DIA_JAVAD_CALMDOWN_TALK_SURE() {
    ...
    INFO_CLEARCHOICES(0x144e1);
    INFO_ADDCHOICE(0x144e1, "I know where you can find warriors. (Send to Haven)", 0x144ea);
    INFO_ADDCHOICE(0x144e1, "I know a place where you could be useful. (Send to town)", 0x144eb);
}
...
func int DIA_JAVAD_WHO_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x144ec)) && ((JAVAD_Q305_WHO) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_JAVAD_WHY_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x144ef)) && ((JAVAD_Q305_WHY) == (FALSE))) && ((Q305_JAVAD_WENTTONEWHOME) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_JAVAD_TOURNAMENTFIGHT_INFO() {
    ...
    AI_FUNCTION(SELF, 0x144fa);
    AI_OUTPUT(SELF, OTHER, "DIA_Javad_TournamentFight_03_03");
    AI_OUTPUT(SELF, OTHER, "DIA_Javad_TournamentFight_03_04");
    AI_FUNCTION(SELF, 0x144fb);
    INFO_CLEARCHOICES(0x144f2);
    INFO_ADDCHOICE(0x144f2, "Javad, I have to win this tournament.", 0x144f9);
    INFO_ADDCHOICE(0x144f2, "I'll be happy to check it out. Get your weapon!", 0x144f8);
}
...
func void DIA_JAVAD_BEFOREFINAL_INFO() {
    ...
    INFO_ADDCHOICE(0x14500, "No, I've already beaten plenty of opponents. Ben will be the next to fall.", 0x14505);
    INFO_ADDCHOICE(0x14500, "Yeah, everyone talks about Ben like he's some kind of monster.", 0x14504);
}
...
func void DIA_JAVAD_BEFOREFINAL_END() {
    ...
    if ((Q306_FIGHTWITHJAVED) == (1)) {
        ...
        B_GIVEINVITEMS(SELF, OTHER, 0x9238, 1);
...
func int DIA_JAVAD_Q509_PREPARE_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_Q509)) == (LOG_RUNNING)) && ((Q509_COUNTWARRIORS) < (4))) && (NPC_KNOWSINFO(OTHER, 0x14506))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_JAVAD_Q509_FEEL_CONDITION() {
    if (((NPC_GETDISTTOWP(SELF, "PART5_Q509_JAVAD")) <= (0x7d0)) && ((Q509_JAVADVOLFZACKE) == (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_JAVAD_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x14512);
    INFO_ADDCHOICE(0x14512, DIALOG_BACK, 0x14516);
    INFO_ADDCHOICE(0x14512, DIALOG_PICKPOCKET, 0x14515);
}

func void DIA_JAVAD_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (3)) {
        CREATEINVITEMS(SELF, 0x8e07, 2);
        B_GIVEINVITEMS(SELF, OTHER, 0x8e07, 2);
