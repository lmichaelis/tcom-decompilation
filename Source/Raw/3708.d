...
func int DIA_ABLO_BADIDEA_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x10a85)) && (!(NPC_KNOWSINFO(OTHER, 0x10a8e)))) {
        return TRUE;
    };
...
func int DIA_ABLO_MYTHCONFIRMED_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x10a88)) && (NPC_ISINSTATE(SELF, 0xf09f))) && ((NPC_HASITEMS(OTHER, 0x935a)) == (0))) {
        return TRUE;
    };
    if ((NPC_KNOWSINFO(OTHER, 0x10a8e)) && (NPC_ISINSTATE(SELF, 0xf09f))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_ABLO_WHOLSOMEMYTH_CONDITION() {
    if (((NPC_HASITEMS(OTHER, 0x935a)) >= (1)) && (NPC_KNOWSINFO(OTHER, 0x10a85))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ABLO_WHOLSOMEMYTH_INFO() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 0x935a, 1);
    NPC_EXCHANGEROUTINE(SELF, "AFTER");
...
func int DIA_ABLO_AMBIENT_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x10a85)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
