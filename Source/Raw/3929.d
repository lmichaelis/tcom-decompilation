...
func void DIA_FMQ003CITIZEN_HELLO_INFO() {
    ...
    INFO_CLEARCHOICES(0x126cb);
    INFO_ADDCHOICE(0x126cb, "In that case, no crime took place.", 0x126ce);
    INFO_ADDCHOICE(0x126cb, "I reprimand you.", 0x126cf);
}
...
func void DIA_FMQ003CITIZEN_HELLO_BADGUY() {
    ...
    INFO_CLEARCHOICES(0x126cb);
    INFO_ADDCHOICE(0x126cb, "Maybe it could be done...", 0x126d0);
    INFO_ADDCHOICE(0x126cb, "No.", 0x126d1);
}
