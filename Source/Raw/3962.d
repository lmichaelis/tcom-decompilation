...
func void DIA_PROPAGANDIST_POSTER_INFO() {
    ...
    INFO_CLEARCHOICES(0x12b13);
    INFO_ADDCHOICE(0x12b13, "Who is the author of these flyers?", 0x12b16);
}
...
func int DIA_PROPAGANDIST_MOREPOSTERS_CONDITION() {
    if (((LOG_GETSTATUS(MIS_Q311)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x12b13))) {
        if ((PROPAGANDIST01_MAD) == (FALSE)) {
            return TRUE;
        };
    };
...
func void DIA_PROPAGANDIST_MOREPOSTERS_INFO() {
    ...
    INFO_CLEARCHOICES(0x12b17);
    INFO_ADDCHOICE(0x12b17, "Where are the other agitators?", 0x12b1a);
}
...
func void DIA_PROPAGANDIST_MOREPOSTERS_WHERE() {
    ...
    INFO_CLEARCHOICES(0x12b17);
    INFO_ADDCHOICE(0x12b17, "So I can more easily break up this rabble of yours.", 0x12b1b);
    INFO_ADDCHOICE(0x12b17, "I would like to learn more about your movement.", 0x12b1c);
}
...
func void DIA_PROPAGANDIST_MOREPOSTERS_WHERE_MORE() {
    ...
    INFO_CLEARCHOICES(0x12b17);
    INFO_ADDCHOICE(0x12b17, "In my opinion, you need a leader.", 0x12b1e);
    if (NPC_HASGUILDARMOREQUIPPED(OTHER, GIL_MIL)) {
        INFO_ADDCHOICE(0x12b17, "Perhaps other city guards would support your cause.", 0x12b21);
    };
    INFO_ADDCHOICE(0x12b17, "I may know someone who would support your cause.", 0x12b22);
}

var int PROPAGANDIST01_LEADERTALK = 0;
...
func void DIA_PROPAGANDIST_WHAT_INFO() {
    ...
    INFO_CLEARCHOICES(0x12b23);
    INFO_ADDCHOICE(0x12b23, "What are your demands?", 0x12b26);
}
...
func void DIA_PROPAGANDIST_WHAT_DEMANDS() {
    ...
    INFO_CLEARCHOICES(0x12b23);
    INFO_ADDCHOICE(0x12b23, "What is the governor's view on this?", 0x12b27);
}
...
func void DIA_PROPAGANDIST_AFTERFIGHT_INFO() {
    ...
    INFO_CLEARCHOICES(0x12b2b);
    INFO_ADDCHOICE(0x12b2b, "See how easy it went?", 0x12b2e);
    Q311_SPAWNLUDLOF();
}
...
func int DIA_PROPAGANDIST_AMBIENTMAD_CONDITION() {
    if (((LOG_GETSTATUS(MIS_Q311)) == (LOG_RUNNING)) && (NPC_ISINSTATE(SELF, 0xf09f))) {
