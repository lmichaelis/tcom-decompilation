...
func void QA301_SPAWNNPC() {
    PRINTD("NPC gotowe!");
    WLD_INSERTNPC(0xdfd9, "PART12_QA301_BAU_01");
    WLD_INSERTNPC(0xdfe0, "PART12_QA301_BAU_02");
    WLD_INSERTNPC(0xdfe7, "PART12_QA301_BAU_03");
    WLD_INSERTNPC(0xe023, "PART12_QA301_SLD_01");
    WLD_INSERTNPC(0xe02a, "PART12_QA301_SLD_02");
    WLD_INSERTNPC(0xe16a, "PART12_QA301_SLD_03");
}

func void QA301_SPAWNMONSTERS() {
    PRINTD("Potwory gotowe!");
    WLD_INSERTNPC(0xc54c, "PART12_QA301_GOBBO_01");
    WLD_INSERTNPC(0xc54d, "PART12_QA301_GOBBO_02");
    WLD_INSERTNPC(0xc54e, "PART12_QA301_GOBBO_03");
    WLD_INSERTNPC(0xc53c, "PART12_QA301_GOBBO_04");
    WLD_INSERTNPC(0xc53d, "PART12_QA301_GOBBO_05");
    WLD_INSERTNPC(0xc3fe, "PART12_QA301_GOBBO_06");
}

func void QA301_FIREPLACE() {
    FF_APPLYONCEEXTGT(0xf625, 0, -(1));
}
...
var int QA301_FIREPLACE_MOVER.QA301_FIREPLACE_MOVER_COUNT = 0;
instance QA301_FIREPLACE_MOVER.MOVER1(ZCMOVER)
var int QA301_FIREPLACE_MOVER.MOVPTR1 = 0;
func void QA301_SPAWNSHADOWBEAST() {
    PRINTD("Cieniostwór gotowy!");
    WLD_INSERTNPC(0xc663, "PART12_FOREST_QA301_SHADOWBEAST");
    WLD_INSERTNPC(0xc622, "PART12_FOREST_QA301_SCAVENGER");
    B_KILLNPC(0xc622);
}
...
func void QA301_TRANSPORTEND() {
    FADESCREENTOBLACKF(2, 0xf62d, 1000);
}
...
func void QA301_LASTMOVER() {
    ...
    TELEPORTNPCTOWP(0x71b, "PART7_PATH_168");
    TELEPORTNPCTOWP(0xdfd9, "PART7_QA301_BAU_01");
    TELEPORTNPCTOWP(0xdfe0, "PART7_QA301_BAU_02");
    TELEPORTNPCTOWP(0xdfe7, "PART7_QA301_BAU_03");
    TELEPORTNPCTOWP(0xe023, "PART7_QA301_ARX_02");
    TELEPORTNPCTOWP(0xe02a, "PART7_QA301_ARX_01");
    if ((QA301_FINALCUTSCENE) == (5)) {
        TELEPORTNPCTOWP(0xe16a, "PART7_PATH_95");
    };
    B_PASSTIME(2);
    QA301_MOVERS();
...
func void QA301_REMOVEEVENTS() {
    ...
    if (!(NPC_ISDEAD(SLD_11056_GRIZ))) {
        ...
        NPC_CHANGEARMOR(SLD_11056_GRIZ, 0x8a8e);
        NPC_REMOVEINVITEMS(SLD_11056_GRIZ, 0x8a89, 1);
    };
}
