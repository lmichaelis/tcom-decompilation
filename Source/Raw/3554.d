...
func void VOLKERGUARDS_PREPARESCENE() {
    ...
    B_REMOVENPC(0xd6b4);
    WLD_INSERTNPC(0xcfcd, "SLUMS_HOUSE17_14");
    WLD_INSERTNPC(0xd71e, "SLUMS_HOUSE17_52");
    WLD_INSERTNPC(0xd720, "SLUMS_VOLKGERGUARD_01");
    WLD_INSERTNPC(0xd722, "SLUMS_VOLKGERGUARD_02");
}

func void Q405_VOLKERTIMELIMIT() {
    FF_APPLYONCEEXT(0xf956, 1000, 10);
}
...
var int Q405_DOORCLOSED_TIMELIMIT.VOLKERGUARDATTACK_DOORCLOSED_COUNT = 0;
func void Q405_FOUNDJORN_APPLY() {
    ...
    if ((Q405_FOUNDJORN_COUNT) == (4)) {
        ...
        HERO.AIVAR[4] = TRUE;
        CUTSCENE_START(0x169b7);
    };
}

var int Q405_FOUNDJORN_APPLY.Q405_FOUNDJORN_COUNT = 0;
func void Q405_FOUNDJORN_SACHS_APPLY() {
    ...
    if ((Q405_FOUNDJORN_SACHS_COUNT) == (4)) {
        HERO.AIVAR[4] = TRUE;
        CUTSCENE_START(0x169c9);
    };
}

var int Q405_FOUNDJORN_SACHS_APPLY.Q405_FOUNDJORN_SACHS_COUNT = 0;
...
var int Q405_FOUNDJORN_DISABLE.Q405_FOUNDJORN_DISABLE_COUNT = 0;
...
var int Q405_FOUNDJORN_CLOSEDOOR.Q405_FOUNDJORN_CLOSEDOOR_COUNT = 0;
instance Q405_FOUNDJORN_CLOSEDOOR.MOVER1(ZCMOVER)
instance Q405_FOUNDJORN_CLOSEDOOR.MOVER2(ZCMOVER)
var int Q405_FOUNDJORN_CLOSEDOOR.MOVPTR1 = 0;
var int Q405_FOUNDJORN_CLOSEDOOR.MOVPTR2 = 0;
...
var int Q405_FOUNDJORN_CLOSEDOOR_V2.Q405_FOUNDJORN_CLOSEDOOR_V2_COUNT = 0;
instance Q405_FOUNDJORN_CLOSEDOOR_V2.MOVER1(ZCMOVER)
instance Q405_FOUNDJORN_CLOSEDOOR_V2.MOVER2(ZCMOVER)
var int Q405_FOUNDJORN_CLOSEDOOR_V2.MOVPTR1 = 0;
var int Q405_FOUNDJORN_CLOSEDOOR_V2.MOVPTR2 = 0;
