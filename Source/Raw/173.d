func void SQ505_SPAWNVOLKERMAN_SLUMS() {
    WLD_INSERTNPC(0xd85a, RNG_NS26_WAYPOINT);
    WLD_INSERTNPC(0xd85d, "SLUMS_VOLKERSPEECH_02");
    WLD_INSERTNPC(0xd860, "SLUMS_VOLKERSPEECH_03");
    WLD_INSERTNPC(0xd863, "SLUMS_VOLKERLISTENER_01");
    WLD_INSERTNPC(0xd866, "SLUMS_VOLKERLISTENER_02");
    WLD_INSERTNPC(0xd869, "SLUMS_VOLKERLISTENER_03");
    WLD_INSERTNPC(0xd86c, "SLUMS_VOLKERLISTENER_04");
}
...
func void SQ505_SPAWNVOLKERMAN_M7() {
    WLD_INSERTNPC(0xd86f, RNG_NS27_WAYPOINT);
    if ((LOG_GETSTATUS(MIS_SQ505)) != (LOG_RUNNING)) {
        WLD_INSERTNPC(0xd872, "SLUMS_VOLKERSPEECH02_02");
        WLD_INSERTNPC(0xd875, "SLUMS_VOLKERSPEECH02_03");
    };
    WLD_INSERTNPC(0xd68a, "SLUMS_VOLKERLISTENER02_01");
    WLD_INSERTNPC(0xd68d, "SLUMS_VOLKERLISTENER02_02");
    WLD_INSERTNPC(0xd690, "SLUMS_VOLKERLISTENER02_03");
    WLD_INSERTNPC(0xd693, "SLUMS_VOLKERLISTENER02_04");
}
...
func void SQ505_SPAWNVOLKERMAN_M3() {
    WLD_INSERTNPC(0xcf64, RNG_NS28_WAYPOINT);
    WLD_INSERTNPC(0xcf67, "PARTM3_PATH_139");
    WLD_INSERTNPC(0xcf6a, "PARTM3_PATH_138");
    WLD_INSERTNPC(0xcf7e, "PARTM3_VOLKERLISTENER01");
    WLD_INSERTNPC(0xcf86, "PARTM3_VOLKERLISTENER02");
    WLD_INSERTNPC(0xcf82, "PARTM3_VOLKERLISTENER03");
    WLD_INSERTNPC(0xcf8a, "PARTM3_VOLKERLISTENER04");
}
...
func void SQ505_PREPARENPC() {
    ...
    WLD_INSERTNPC(0xd62a, "SLUMS_PATH_56A");
}
...
var int SQ505_PREPAREVOBS_APPLY.SQ505_PREPAREVOBS_COUNT = 0;
instance SQ505_PREPAREVOBS_APPLY.MOVER1(ZCMOVER)
instance SQ505_PREPAREVOBS_APPLY.MOVER2(ZCMOVER)
instance SQ505_PREPAREVOBS_APPLY.MOVER3(ZCMOVER)
instance SQ505_PREPAREVOBS_APPLY.MOVER4(ZCMOVER)
var int SQ505_PREPAREVOBS_APPLY.MOVPTR1 = 0;
var int SQ505_PREPAREVOBS_APPLY.MOVPTR2 = 0;
var int SQ505_PREPAREVOBS_APPLY.MOVPTR3 = 0;
var int SQ505_PREPAREVOBS_APPLY.MOVPTR4 = 0;
