...
func int DIA_KLAUS_ABOUTTHATTOWER_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x150fd)) {
        return TRUE;
    };
...
func int DIA_KLAUS_SQ101_BASTIAN_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ101)) == (LOG_RUNNING)) && ((SQ101_MARVINCANTAKEWOOD) == (FALSE))) && (NPC_KNOWSINFO(OTHER, 0x150fd))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_KLAUS_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x1510f);
    INFO_ADDCHOICE(0x1510f, DIALOG_BACK, 0x15113);
    INFO_ADDCHOICE(0x1510f, DIALOG_PICKPOCKET, 0x15112);
}
