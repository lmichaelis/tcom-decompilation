    ...
    if ((LOG_GETSTATUS(MIS_SQ417)) == (LOG_RUNNING)) {
        if ((SQ417_ARETHEPATROL) == (2)) {
            if ((((SQ417_PATROLTIME) != (6)) && ((SQ417_PATROLTIME) != (7))) && ((SQ417_PATROLTIME) != (10))) {
                if ((NPC_GETDISTTOWP(HERO, "WOLFSDEN_WALL_08")) >= (0x898)) {
        ...
        if ((SQ417_PATROLTIME) == (1)) {
            ...
            if (((NPC_GETDISTTOWP(HERO, "WOLFSDEN_WALL_12")) <= (SQ417_PATROLDISTANCE)) && ((NPC_ISINSTATE(DJG_10012_ARETHE, 0xf09f)) == (FALSE))) {
                SQ417_PATROLTIME = 6;
            ...
            if ((NPC_GETDISTTOWP(HERO, "WOLFSDEN_WALL_06")) <= (SQ417_PATROLDISTANCE)) {
                SQ417_PATROLTIME = 10;
                FADESCREENTOBLACKF(1, 0xf881, 1000);
            };
        };
        if ((SQ417_ARETHEPLAN) == (2)) {
            if ((SQ417_ARETHEPLAN_EVENTS) == (0)) {
                if ((NPC_GETDISTTOWP(HERO, "WOLFSDEN_HOUSE01_04")) <= (400)) {
                    ...
                    FADESCREENTOBLACKF(1, 0xf882, 1000);
                };
            ...
            if ((SQ417_FIGHTWITHWOLFSON) == (1)) {
                if (NPC_ISINSTATE(DJG_13635_WOLFSON, 0xf0a3)) {
                    ...
                    MDL_STARTFACEANI(DJG_13635_WOLFSON, S_NEUTRAL, 0x3f800000, -1082130432);
            ...
            if ((SQ417_FIGHTWITHBAES) == (1)) {
                if (NPC_ISINSTATE(DJG_10015_BAES, 0xf0a3)) {
                    ...
                    MDL_STARTFACEANI(DJG_10015_BAES, S_NEUTRAL, 0x3f800000, -1082130432);
    ...
    if ((LOG_GETSTATUS(MIS_SQ417)) == (LOG_FAILED)) {
        if ((SQ417_ARETHEMAD) == (1)) {
            if ((NPC_GETDISTTONPC(HERO, DJG_10012_ARETHE)) <= (1000)) {
                if ((NPC_ISINSTATE(HERO, 0xf0a3)) || (NPC_ISINSTATE(DJG_10012_ARETHE, 0xf0a3))) {
                    SQ417_ARETHEMAD = 2;
                    ...
                    MDL_STARTFACEANI(DJG_10012_ARETHE, S_NEUTRAL, 0x3f800000, -1082130432);
                    PRINTD("Clear Attitude");
                    return;
                };
            };
...
const int EVENTSMANAGER_SQ417.SQ417_PATROLDISTANCE = 250;
var int EVENTSMANAGER_SQ417.SQ417_LEGRIFBOTTLES_LOGENTRY = 0;
var int EVENTSMANAGER_SQ417.SQ417_EVENTS_LOGENTRY_01 = 0;
var int EVENTSMANAGER_SQ417.SQ417_EVENTS_LOGENTRY_03 = 0;
