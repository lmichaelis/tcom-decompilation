...
func int DIA_GUARDMINE_STOP_CONDITION() {
    if (((NPC_HASITEMS(OTHER, 0x91dd)) == (0)) || ((LOG_GETSTATUS(MIS_Q403)) != (LOG_SUCCESS))) {
        return TRUE;
    };
...
func int DIA_GUARDMINE_PASS_CONDITION() {
    if (((LOG_GETSTATUS(MIS_Q403)) == (LOG_SUCCESS)) && ((NPC_HASITEMS(OTHER, 0x91dd)) >= (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_GUARDMINE_PASS_INFO() {
    ...
    INFO_CLEARCHOICES(0x140f0);
    INFO_ADDCHOICE(0x140f0, "Fine.", 0x140f3);
    INFO_ADDCHOICE(0x140f0, "You've got to be kidding!", 0x140f4);
}
