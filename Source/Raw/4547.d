...
func void KQ402_ARWID_START() {
    ...
    WLD_INSERTITEM(0x91c9, "FP_PARTM3_MILARMOR_G2_L_01");
    WLD_INSERTITEM(0x91ca, "FP_PARTM3_MILARMOR_G2_L_02");
    TELEPORTNPCTOWP(0x71b, "PARTM3_BARRACK_HOUSE2_01");
    TELEPORTNPCTOWP(0xccbc, MIL_4017_ARWID_KQ402.WP);
    ...
    KQ402_ARWID_WAIT();
    AI_FUNCTION(NONE_2009_LENNART, 0x168ab);
    ...
    KQ402_ARWID_WAIT();
    AI_FUNCTION(NONE_2009_LENNART, 0x168ac);
    ...
    KQ402_ARWID_WAIT();
    AI_FUNCTION(NONE_2009_LENNART, 0x168aa);
}
