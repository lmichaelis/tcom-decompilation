...
func int DIA_MIROH_Q504_FEEL_CONDITION() {
    if ((((NPC_GETDISTTOWP(SELF, "PART5_WORKERSCAMP_SMALLTALK_02")) <= (0x7d0)) && ((Q504_TAKEWORKERS) == (2))) && ((Q504_NIVELMIROHVOLFZACKE) == (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_MIROH_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x1291b);
    INFO_ADDCHOICE(0x1291b, DIALOG_BACK, 0x1291f);
    INFO_ADDCHOICE(0x1291b, DIALOG_PICKPOCKET, 0x1291e);
}

func void DIA_MIROH_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (1)) {
        CREATEINVITEMS(SELF, 0x8c8c, 2);
        B_GIVEINVITEMS(SELF, OTHER, 0x8c8c, 2);
