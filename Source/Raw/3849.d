...
func void DIA_SOUTHERNER01_SQ413_START_INFO() {
    ...
    INFO_CLEARCHOICES(0x11b60);
    INFO_ADDCHOICE(0x11b60, "I don't have time to run around with packages right now.", 0x11b65);
    INFO_ADDCHOICE(0x11b60, "Sounds interesting, no gold stinks.", 0x11b66);
}

var int SOUTHERNER01_TAKEQUEST = 0;
...
func void DIA_SOUTHERNER01_SQ413_START_YES() {
    ...
    CREATEINVITEMS(SELF, 0x9202, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x9202, 1);
