...
func int DIA_MYSTERIOUSLEONZO_WHATSUP_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x11971)) {
        return TRUE;
    };
...
func int DIA_MYSTERIOUSLEONZO_ADVENTUREQUEST_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x11974)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_MYSTERIOUSLEONZO_ADVENTUREQUEST_INFO() {
    ...
    CREATEINVITEMS(SELF, 0x9ba7, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x9ba7, 1);
    AI_STOPPROCESSINFOS(SELF);
}
...
func int DIA_MYSTERIOUSLEONZO_AMBIENTTALK1_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x11977)) && (NPC_ISINSTATE(SELF, 0xf09f))) && ((NPC_GETDISTTOWP(VLK_11156_MYSTERIOUSLEONZO, RNG_NS03_WAYPOINT)) <= (0x1964))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_MYSTERIOUSLEONZO_HELLOAGAIN_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x11977)) && ((MYSTERIOUSLEONZO_DAY) <= ((WLD_GETDAY()) - (3)))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_MYSTERIOUSLEONZO_BOOK_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x1197d)) && ((NPC_HASITEMS(OTHER, 0x9ba7)) >= (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_MYSTERIOUSLEONZO_BOOK_INFO() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 0x9ba7, 1);
    AI_OUTPUT(SELF, OTHER, "DIA_MysteriousLeonzo_Book_03_03");
    CREATEINVITEMS(SELF, 0x859b, EVENT_MYSTERIOUSLEONZO_BOOK);
    B_GIVEINVITEMS(SELF, OTHER, 0x859b, EVENT_MYSTERIOUSLEONZO_BOOK);
...
func int DIA_MYSTERIOUSLEONZO_WTF_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x11980)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
