...
func void DIA_GRAVE_WORK_INFO() {
    ...
    INFO_CLEARCHOICES(0x1284d);
    INFO_ADDCHOICE(0x1284d, "Robbers?", 0x12850);
}
...
func int DIA_GRAVE_SHOVEL_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_Q309)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x10e01))) && ((NPC_HASITEMS(OTHER, 0x9058)) == (0))) {
        if ((Q309_BOLTLOGENTRY) == (FALSE)) {
            return TRUE;
        };
    };
...
func void DIA_GRAVE_SHOVEL_INFO() {
    ...
    INFO_CLEARCHOICES(0x12854);
    INFO_ADDCHOICE(0x12854, "I have to dig up the flower beds.", 0x12858);
    INFO_ADDCHOICE(0x12854, "I have to dig up the body.", 0x12859);
}
