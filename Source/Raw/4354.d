...
func void DIA_SALL_Q602_STOP_INFO() {
    ...
    INFO_CLEARCHOICES(0x1611d);
    INFO_ADDCHOICE(0x1611d, "What happened to Oktav and the others?", 0x16121);
    INFO_ADDCHOICE(0x1611d, "Why Old Town?", 0x16120);
}
...
func void DIA_SALL_Q602_STOP_OKTAV() {
    ...
    AI_RESETFACEANI(SELF);
    INFO_CLEARCHOICES(0x1611d);
    INFO_ADDCHOICE(0x1611d, "I don't have time to save the Fire Mages right now.", 0x16124);
    INFO_ADDCHOICE(0x1611d, "I'll help you get to the Fire Mages.", 0x16123);
    if (((MARVIN_MILITIASPECIALIZATION) == (MILITIA_SPECIALIZATION_FIGHTER)) || ((MARVIN_MILITIASPECIALIZATION) == (MILITIA_SPECIALIZATION_CROSSBOWMAN))) {
        INFO_ADDCHOICE(0x1611d, "I'm taking command of your unit.", 0x16122);
    };
}
...
func void DIA_SALL_Q602_DEADBODIES_INFO() {
    ...
    AI_FUNCTION(SELF, 0x1612e);
    AI_OUTPUT(SELF, OTHER, "DIA_Sall_Q602_DeadBodies_03_01");
    AI_OUTPUT(SELF, OTHER, "DIA_Sall_Q602_DeadBodies_03_02");
    INFO_CLEARCHOICES(0x16129);
    INFO_ADDCHOICE(0x16129, "If you're afraid to risk your life for the priests of Innos himself...", 0x1612d);
    INFO_ADDCHOICE(0x16129, "Calm down! We have a task to complete!", 0x1612c);
}
