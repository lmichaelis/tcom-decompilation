...
func void DIA_VIRAN_OBSERVE_INFO() {
    ...
    INFO_CLEARCHOICES(0x114e7);
    INFO_ADDCHOICE(0x114e7, "Why do you say that?", 0x114ea);
}
...
func int DIA_VIRAN_Q506_HARBOUR_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x114e7)) && ((LOG_GETSTATUS(MIS_Q505)) == (LOG_RUNNING))) && (NPC_KNOWSINFO(OTHER, 0x13974))) {
        return TRUE;
    };
...
func void DIA_VIRAN_Q506_HARBOUR_INFO() {
    ...
    INFO_CLEARCHOICES(0x114eb);
    INFO_ADDCHOICE(0x114eb, "As fast as you can, the ruins of Vardhal.", 0x114ee);
}
...
func int DIA_VARIN_Q506_FEEL_CONDITION() {
    if (((NPC_GETDISTTOWP(SELF, "PART5_WORKERSCAMP_VIRAN")) <= (0x7d0)) && ((Q506_VIRANVOLFZACKE) == (TRUE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_VARIN_Q506_NOTNOW_CONDITION() {
    if ((((NPC_GETDISTTOWP(SELF, "PART5_WORKERSCAMP_VIRAN")) >= (0xfa0)) && (NPC_ISINSTATE(SELF, 0xf09f))) && ((Q506_VIRANVOLFZACKE) == (TRUE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_VARIN_AMBIENT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x114f5)) && ((Q506_VIRANVOLFZACKE) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_VARIN_AMBIENT_INFO() {
    ...
    if ((HERO.GUILD) == (GIL_SLD)) {
        if (!(NPC_KNOWSINFO(OTHER, 0x114e7))) {
            AI_OUTPUT(SELF, OTHER, "DIA_Varin_Ambient_03_02");
        } else if (NPC_KNOWSINFO(OTHER, 0x114e7)) {
...
func void DIA_VARIN_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x114fb);
    INFO_ADDCHOICE(0x114fb, DIALOG_BACK, 0x114ff);
    INFO_ADDCHOICE(0x114fb, DIALOG_PICKPOCKET, 0x114fe);
}
