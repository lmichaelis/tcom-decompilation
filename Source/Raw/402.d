instance DIA_SLD_CITYGUIDE_EXIT(C_INFO) {
    NR = 999;
    CONDITION = DIA_SLD_CITYGUIDE_EXIT_CONDITION;
    INFORMATION = DIA_SLD_CITYGUIDE_EXIT_INFO;
    PERMANENT = TRUE;
...
func int DIA_SLD_CITYGUIDE_HELLO_CONDITION() {
    if ((NPC_ISINSTATE(SELF, 0xf09f)) && ((CITYGUIDE_ONRUN) == (FALSE))) {
        return TRUE;
    };
...
func void DIA_SLD_CITYGUIDE_TRAVEL_CHOICES() {
    INFO_CLEARCHOICES(0xa615);
    if ((NPC_GETDISTTOWP(SELF, PARTM4_PATH_85)) >= (CITYGUIDE_DIST)) {
        INFO_ADDCHOICE(0xa615, CHOICE_CITYGUIDE_GATEEAST, 0xa61c);
    };
    if ((NPC_GETDISTTOWP(SELF, PARTM2_PATH_05)) >= (CITYGUIDE_DIST)) {
        INFO_ADDCHOICE(0xa615, CHOICE_CITYGUIDE_GATEWEST, 0xa61d);
    };
    if ((NPC_GETDISTTOWP(SELF, PARTM8_PATH_12)) >= (CITYGUIDE_DIST)) {
        INFO_ADDCHOICE(0xa615, CHOICE_CITYGUIDE_INNOS, 0xa61e);
    };
    if ((NPC_GETDISTTOWP(SELF, HARBOUR_PATH_74)) >= (CITYGUIDE_DIST)) {
        INFO_ADDCHOICE(0xa615, CHOICE_CITYGUIDE_ADANOS, 0xa61f);
    };
    if ((NPC_GETDISTTOWP(SELF, PARTM4_PATH_40)) >= (CITYGUIDE_DIST)) {
        INFO_ADDCHOICE(0xa615, CHOICE_CITYGUIDE_VOLKER, 0xa620);
    };
    if ((NPC_GETDISTTOWP(SELF, HARBOUR_PATH_179)) >= (CITYGUIDE_DIST)) {
        INFO_ADDCHOICE(0xa615, CHOICE_CITYGUIDE_SHIPYARD, 0xa621);
    };
    if ((NPC_GETDISTTOWP(SELF, SLUMS_PATH_30)) >= (CITYGUIDE_DIST)) {
        INFO_ADDCHOICE(0xa615, CHOICE_CITYGUIDE_SLUMS, 0xa622);
    };
    if ((NPC_GETDISTTOWP(SELF, HARBOUR_PATH_19)) >= (CITYGUIDE_DIST)) {
        INFO_ADDCHOICE(0xa615, CHOICE_CITYGUIDE_HARBOURMARKET, 0xa623);
    };
    if ((NPC_GETDISTTOWP(SELF, PARTM2_PATH_19)) >= (CITYGUIDE_DIST)) {
        INFO_ADDCHOICE(0xa615, CHOICE_CITYGUIDE_MARKET, 0xa624);
    };
    if ((NPC_GETDISTTOWP(SELF, PARTM3_PATH_40)) >= (CITYGUIDE_DIST)) {
        INFO_ADDCHOICE(0xa615, CHOICE_CITYGUIDE_CRAFT, 0xa625);
    };
    if ((NPC_GETDISTTOWP(SELF, PARTM3_PATH_04)) >= (CITYGUIDE_DIST)) {
        INFO_ADDCHOICE(0xa615, CHOICE_CITYGUIDE_BARRACK, 0xa626);
    };
    if ((NPC_GETDISTTOWP(SELF, PARTM1_PATH_89)) >= (CITYGUIDE_DIST)) {
        INFO_ADDCHOICE(0xa615, CHOICE_CITYGUIDE_ARAXOS, 0xa627);
    };
    if ((NPC_GETDISTTOWP(SELF, PARTM4_TAVERN_03)) >= (CITYGUIDE_DIST)) {
        INFO_ADDCHOICE(0xa615, CHOICE_CITYGUIDE_GERSTAND, 0xa629);
    };
    if ((NPC_GETDISTTOWP(SELF, HARBOUR_PATH_129)) >= (CITYGUIDE_DIST)) {
        INFO_ADDCHOICE(0xa615, CHOICE_CITYGUIDE_OLAF, 0xa628);
    };
    INFO_ADDCHOICE(0xa615, DIALOG_BACK, 0xa62a);
}
...
func void DIA_SLD_CITYGUIDE_TRAVEL_LETSGO() {
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (CITYGUID_SLD)) {
        B_SAY(SELF, OTHER, "$CITYGUIDE_YES");
        B_GIVEINVITEMS(OTHER, SELF, 0x859b, CITYGUID_SLD);
        INFO_CLEARCHOICES(0xa615);
        AI_STOPPROCESSINFOS(SELF);
        ARAXOS_CITYGUIDE();
    };
