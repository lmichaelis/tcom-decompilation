func void ZS_PREACH_TRIMEGISTO() {
...
func int ZS_PREACH_TRIMEGISTO_LOOP() {
    ...
    if (((ISINCAMERA) == (FALSE)) && (INFOMANAGER_HASFINISHED())) {
        if ((NPC_GETSTATETIME(SELF)) >= (4)) {
            ...
            B_PREACH_TRIMEGISTO(SELF.AIVAR[97]);
...
func void ZS_PREACH_TRIMEGISTO_END() {
    AI_PLAYANI(SELF, T_LGUARD_2_STAND);
}

func void REMOVETRIMEGISTOPREACHMDS() {
