func void ZS_SIT_CHAIR_SMOKE_Q306() {
    if (((NPC_HASITEMS(SELF, 0x8592)) >= (5)) && ((SELF.FLAGS) != (2))) {
        NPC_REMOVEINVITEMS(SELF, 0x8592, NPC_HASITEMS(SELF, 0x8592));
    };
...
func int ZS_SIT_CHAIR_SMOKE_Q306_LOOP() {
...
var int ZS_SIT_CHAIR_SMOKE_Q306_LOOP.RANDOM = 0;
func void ZS_SIT_CHAIR_SMOKE_Q306_END() {
    AI_USEMOB(SELF, "CHAIR", -(1));
}
