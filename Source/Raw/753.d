...
func int ZS_SMALLTALK_LOOP() {
    if (NPC_ISONFP(SELF, "SMALLTALK")) {
        if ((NPC_GETSTATETIME(SELF)) >= ((SMALLTALKFREQ) * (2))) {
            ...
            if ((WLD_DETECTNPC(SELF, -(1), 0xb65f, -(1))) || (WLD_DETECTNPC(SELF, -(1), 0xb662, -(1)))) {
                ...
                AI_STARTSTATE(SELF, 0xb662, 1, "");
            };
            WLD_DETECTNPC(SELF, -(1), 0xb662, -(1));
...
var int ZS_SMALLTALK_WAIT_LOOP.RANDOM = 0;
