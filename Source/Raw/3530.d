...
func void Q306_PREPAREFIRSTFIGHT() {
    NPC_CHANGEARMOR(PIR_1312_LARRY, 0x8a46);
...
instance Q306_STARTFIGHTWITHSNAKE.SNAKE(C_NPC)
...
func void Q306_LOSTTOURNAMENT_DELAY() {
    ...
    if ((Q306_LOSTTOURNAMENT_COUNT) == (3)) {
        CUTSCENE_START(0x16964);
        Q306_LOSTTOURNAMENT_COUNT = 0;
    };
}

var int Q306_LOSTTOURNAMENT_DELAY.Q306_LOSTTOURNAMENT_COUNT = 0;
...
func void Q306_REFRESHBENHEADONLOAD() {
    if ((Q306_BEN_REMEMBERTHISVISUAL) == (TRUE)) {
        MDL_SETVISUALBODY(NONE_7500_BEN, "HUM_BODY_NAKED0", 1, 0, HUMHEADNOTHING, FACE_N_BIGBEN, 0, 0x8a3b);
        PRINTD("Refresh - G³owa");
    };
}

func void Q306_BEN_RUNTOHERO() {
    if (NPC_ISINSTATE(NONE_7500_BEN, 0xab50)) {
        NPC_SETSTATETIME(NONE_7500_BEN, (SPL_TIME_FREEZE) + (1));
    };
    if (NPC_ISINSTATE(NONE_7500_BEN, 0xab85)) {
        NPC_SETSTATETIME(NONE_7500_BEN, (SPL_TIME_SHORTZAPPED) + (1));
    };
    if (NPC_ISINSTATE(NONE_7500_BEN, 0xab81)) {
...
func void Q306_BEN_ATTACK() {
    ...
    if ((NONE_7500_BEN.AIVAR[17]) == (TRUE)) {
        FF_APPLYONCEEXT(0xf742, 800, 2);
    };
    FF_APPLYONCEEXT(0xf742, 400, 2);
}
...
var int Q306_BEN_ATTACK_APPLY.Q306_BENATTACK_COUNT = 0;
