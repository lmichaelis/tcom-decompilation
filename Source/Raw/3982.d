...
func void DIA_IGNIS_HUNTERSTRIALOG_INFO() {
    ...
    AI_STOPLOOKAT(SELF);
    AI_STOPLOOKAT(OTHER);
    INFO_CLEARCHOICES(0x12dc9);
    INFO_ADDCHOICE(0x12dc9, "Enough with those games!", 0x12dce);
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (IGNIS_DRINK)) {
        INFO_ADDCHOICE(0x12dc9, "Drink for my health! (Give 100 GP)", 0x12dcd);
    };
    INFO_ADDCHOICE(0x12dc9, "I don't have that much gold.", 0x12dcc);
}
...
func void DIA_IGNIS_HUNTERSTRIALOG_GOLD() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 0x859b, IGNIS_DRINK);
