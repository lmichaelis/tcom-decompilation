...
func void TRAP24_ZACKY_GOLEM_SPAWN() {
    ...
    WLD_INSERTNPC(0xc575, "PART8_MONASTERY_GOLEM");
}
...
func int DIA_ZACKY_AFTEREVENT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x139e0)) && (NPC_ISDEAD(ICEGOLEM_ZACKY))) {
        return TRUE;
    };
...
func int DIA_ZACKY_WHATAREYOUDOINGHERE_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x139e3)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_ZACKY_SCROLLSTRADE_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x139e6)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_ZACKY_ABOUTCASPAR_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x139e6)) && ((SQ508_RESULT) != (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ZACKY_AMBIENT_INFO() {
    ...
    if (!(NPC_KNOWSINFO(OTHER, 0x139ec))) {
