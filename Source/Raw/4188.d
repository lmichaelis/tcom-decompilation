...
func int DIA_DAN_CANYOUTRAIN_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x14b50)) {
        return TRUE;
    };
...
var int DAN_CURRENTCRLEVEL = 0;
var int DAN_CURRENT2HLEVEL = 0;
var int DAN_CURRENTSTRLEVEL = 0;
var int DAN_NOMORE = 0;
var string DAN_PRINTS = "";
var int DAN_GOODSTUDENT = 0;
...
func int DIA_DAN_TRAIN_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x14b53)) && ((DAN_NOMORE) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DAN_TRAIN_CHOICES() {
    ...
    INFO_CLEARCHOICES(0x14b5c);
    INFO_ADDCHOICE(0x14b5c, DIALOG_BACK, 0x14b61);
    INFO_ADDCHOICE(0x14b5c, B_BUILDLEARNSTRING2(PRINT_LEARNCROSSBOW1, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_CROSSBOW, 1), DAN_GOLDCOST), 0x14b62);
    INFO_ADDCHOICE(0x14b5c, B_BUILDLEARNSTRING2(PRINT_LEARNCROSSBOW5, (B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_CROSSBOW, 1)) * (5), (DAN_GOLDCOST) * (5)), 0x14b63);
    INFO_ADDCHOICE(0x14b5c, B_BUILDLEARNSTRING2(PRINT_LEARN2H1, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_2H, 1), DAN_GOLDCOST), 0x14b64);
    INFO_ADDCHOICE(0x14b5c, B_BUILDLEARNSTRING2(PRINT_LEARN2H5, (B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_2H, 1)) * (5), (DAN_GOLDCOST) * (5)), 0x14b65);
    INFO_ADDCHOICE(0x14b5c, B_BUILDLEARNSTRING2(PRINT_LEARNSTR1, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_STRENGTH, 1), DAN_GOLDCOST), 0x14b66);
    INFO_ADDCHOICE(0x14b5c, B_BUILDLEARNSTRING2(PRINT_LEARNSTR5, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_STRENGTH, 5), (DAN_GOLDCOST) * (5)), 0x14b67);
}

var int DIA_DAN_TRAIN_CHOICES.DAN_GOLDCOST = 0;
...
func void DIA_DAN_TRAIN_CR_1() {
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (DAN_PAYMENT1)) {
        if ((DAN_CURRENTCRLEVEL) < (OTHER.AIVAR[87])) {
            SND_PLAY(GELDBEUTEL);
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, DAN_PAYMENT1);
            NPC_REMOVEINVITEMS(SELF, 0x859b, DAN_PAYMENT1);
        };
...
func void DIA_DAN_TRAIN_CR_5() {
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (DAN_PAYMENT5)) {
        if ((DAN_CURRENTCRLEVEL) < (OTHER.AIVAR[87])) {
            SND_PLAY(GELDBEUTEL);
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, DAN_PAYMENT5);
            NPC_REMOVEINVITEMS(SELF, 0x859b, DAN_PAYMENT5);
        };
...
func void DIA_DAN_DUELPROPOSAL_INFO() {
    ...
    INFO_CLEARCHOICES(0x14b68);
    INFO_ADDCHOICE(0x14b68, "We'll see who get punch in the face.", 0x14b6d);
    INFO_ADDCHOICE(0x14b68, "I want to earn respect.", 0x14b6e);
    INFO_ADDCHOICE(0x14b68, "I'm Marvin.", 0x14b6f);
}

var int DIA_DAN_DUELPROPOSAL_CHOICESCOUNT = 0;
func void DIA_DAN_DUELPROPOSAL_BOTHAFTER() {
    if ((DIA_DAN_DUELPROPOSAL_CHOICESCOUNT) == (3)) {
        ...
        INFO_ADDCHOICE(0x14b68, "I have to get ready.", 0x14b70);
        INFO_ADDCHOICE(0x14b68, "We're good to go.", 0x14b73);
        INFO_ADDCHOICE(0x14b68, "I'd like to test myself with you in shooting.", 0x14b74);
    };
}
...
var int Q302_ACTIVEDUELWITHDAN = 0;
...
var int Q302_PLAYERDUELWITHDANSTATE = 0;
...
func int DIA_DAN_DUELGUIDE_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x14b68)) && ((Q302_ACTIVEDUELWITHDAN) == (FALSE))) && ((Q302_PLAYERDUELWITHDANSTATE) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DAN_SQ406_POTION_INFO() {
    ...
    INFO_CLEARCHOICES(0x14b85);
    INFO_ADDCHOICE(0x14b85, "I will tell you if you promise not to tell anyone.", 0x14b88);
}
...
func void DIA_DAN_SQ406_POTION_TELL() {
    ...
    INFO_CLEARCHOICES(0x14b85);
    INFO_ADDCHOICE(0x14b85, "I drink strength potions regularly.", 0x14b89);
}
...
func void DIA_DAN_SQ406_POTION_TELL_SECRET() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x91f7)) >= (1)) {
        INFO_ADDCHOICE(0x14b85, "(Give strong transformation potion)", 0x14b8c);
    };
    if ((NPC_HASITEMS(OTHER, 0x91f6)) >= (1)) {
        INFO_ADDCHOICE(0x14b85, "(Give transformation potion)", 0x14b8b);
    };
    if ((NPC_HASITEMS(OTHER, 0x91f5)) >= (1)) {
        INFO_ADDCHOICE(0x14b85, "(Give weak transformation potion)", 0x14b8a);
    };
}
...
func void DIA_DAN_SQ406_POTION_TELL_SECRET_TRANSFORM_H() {
    ...
    AI_FUNCTION(SELF, 0x14b8f);
    AI_PLAYANI(SELF, "T_STOMACHHURT_REMOVE");
    AI_FUNCTION(SELF, 0x14b8e);
    INFO_CLEARCHOICES(0x14b85);
    AI_STOPPROCESSINFOS(SELF);
...
func void DAN_SQ406_REMOVEHEAD() {
    ...
    if ((NPC_HASITEMS(PIR_1326_DAN, 0x8323)) >= (1)) {
        NPC_REMOVEINVITEMS(PIR_1326_DAN, 0x8323, 1);
    };
...
func int DIA_DAN_SQ406_MONSTER_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ406)) == (LOG_RUNNING)) && ((SQ406_DAN_POTION) == (3))) && ((NPC_GETDISTTOWP(SELF, "PART17_CAVE_CAMPFIRE_01")) <= (0x4b0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DANTOURNAMENTFIGHTCOMMENT_INFO() {
    ...
    INFO_ADDCHOICE(0x14b93, "For a city guard, it's daily bread.", 0x14b98);
    INFO_ADDCHOICE(0x14b93, "Merchant's Guild contracts involve more than the delivery of goods.", 0x14b99);
    INFO_ADDCHOICE(0x14b93, "I happen to punch a few scabby mouths from time to time.", 0x14b9a);
    INFO_ADDCHOICE(0x14b93, "None of your business.", 0x14b9b);
}
...
func void DIA_DAN_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x14b9c);
    INFO_ADDCHOICE(0x14b9c, DIALOG_BACK, 0x14ba0);
    INFO_ADDCHOICE(0x14b9c, DIALOG_PICKPOCKET, 0x14b9f);
}
