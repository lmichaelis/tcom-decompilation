...
func int DIA_KETH_CQ004_START_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x12604)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_KETH_CQ004_FREE_CONDITION() {
    if ((((NPC_KNOWSINFO(OTHER, 0x1265a)) && ((CQ004_KETHCHEAT) == (FALSE))) && ((CQ004_RECONANDVEIGOCHEAT) == (FALSE))) && ((LOG_GETSTATUS(MIS_CQ004)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_KETH_CQ004_FREE_INFO() {
    ...
    CQ004_KETHREWARD = 2;
    INFO_CLEARCHOICES(0x1260a);
    INFO_ADDCHOICE(0x1260a, "I'll see how it goes.", 0x1260f);
    INFO_ADDCHOICE(0x1260a, "Any idea what would be a good 'something'?", 0x1260e);
    INFO_ADDCHOICE(0x1260a, "What if they're innocent?", 0x1260d);
}
...
func void DIA_KETH_CQ004_JUDGMENT_INFO() {
    ...
    INFO_CLEARCHOICES(0x12611);
    if (((CQ004_RECONCHESTSTATUS) == (1)) && ((MOB_HASITEMS("RECON_CHEST", 0x9125)) == (TRUE))) {
        INFO_ADDCHOICE(0x12611, "As suspected, the sabotage was done by Recon and Veigo.", 0x12615);
    };
    INFO_ADDCHOICE(0x12611, "It wasn't Recon and Veigo who sabotaged the crane.", 0x12614);
}
...
func void DIA_KETH_CQ004_JUDGMENT_KETHWON() {
    ...
    AI_WAITTILLEND(SELF, OTHER);
    AI_WAITTILLEND(OTHER, SELF);
    AI_FUNCTION(VLK_6230_KETH, 0x12617);
    AI_FUNCTION(HERO, 0x12618);
    AI_WAIT(SELF, 0x41300000);
}

func void GIVESALLGEAR() {
    B_GIVEINVITEMS(HERO, MIL_4044_SALL, 0x9125, 1);
}

func void MILITIAWENTFORGEARNOW() {
    FADESCREENTOBLACKF(9, 0x1261a, 1000);
}
...
func void FADESCREENWORKERS() {
    ...
    AI_WAIT(MIL_4047_PRISONGUARD, 0x3e4ccccd);
    AI_TURNAWAY(MIL_4047_PRISONGUARD, HERO);
    AI_FUNCTION(MIL_4047_PRISONGUARD, 0x12619);
}
...
var int CQ004_KETH_REFERENCEEXCHANGE = 0;
func void DIA_KETH_CQ004_WORKERRESULT_INFO() {
    if ((CQ004_RESULT) == (1)) {
        ...
        INFO_CLEARCHOICES(0x1261c);
        INFO_ADDCHOICE(0x1261c, "I hope I never have to see you again.", 0x12621);
        INFO_ADDCHOICE(0x1261c, "Is that a threat?", 0x12622);
    };
    if ((CQ004_RESULT) == (2)) {
        ...
        if ((CQ004_KETHREWARD) == (2)) {
            ...
            CREATEINVITEMS(SELF, 0x859b, CQ004_KETHREWARD_V1_NOQ202);
        } else if ((CQ004_KETHREWARD) == (1)) {
            CREATEINVITEMS(SELF, 0x859b, CQ004_KETHREWARD_V1);
            B_GIVEINVITEMS(SELF, OTHER, 0x859b, CQ004_KETHREWARD_V1);
        };
        AI_OUTPUT(SELF, OTHER, "DIA_Keth_CQ004_WorkerResult_03_07");
        INFO_CLEARCHOICES(0x1261c);
        INFO_ADDCHOICE(0x1261c, "Let's just hope they have enough to satisfy you.", 0x12624);
        INFO_ADDCHOICE(0x1261c, "What if you don't?", 0x12625);
    };
}
...
func void DIA_KETH_CQ004_WORKERRESULT_FINISH() {
    ...
    if ((CQ004_KETHREWARD) == (1)) {
        ...
        CREATEINVITEMS(SELF, 0x9126, 1);
        B_GIVEINVITEMS(SELF, OTHER, 0x9126, 1);
    };
    INFO_CLEARCHOICES(0x1261c);
    AI_STOPPROCESSINFOS(SELF);
    if ((CQ004_KETHREWARD) == (1)) {
...
func void DIA_KETH_CQ004_WORKERRESULT_HAPPY() {
    ...
    if ((CQ004_KETHREWARD) == (2)) {
        CQ004_KETH_REFERENCEEXCHANGE = 1;
        CREATEINVITEMS(SELF, 0x859b, CQ004_KETHREWARD_V2_NOQ202);
    };
    if ((CQ004_KETHREWARD) == (1)) {
        CREATEINVITEMS(SELF, 0x859b, CQ004_KETHREWARD_V2);
        B_GIVEINVITEMS(SELF, OTHER, 0x859b, CQ004_KETHREWARD_V2);
    };
...
func int DIA_KETH_REFERENCEEXCHANGE_CONDITION() {
    if ((((CQ004_KETH_REFERENCEEXCHANGE) == (1)) && ((LOG_GETSTATUS(MIS_Q202)) == (LOG_RUNNING))) && (NPC_KNOWSINFO(OTHER, 0x11f69))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_KETH_REFERENCEEXCHANGE_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= ((CQ004_KETHREWARD_V1_NOQ202) - (CQ004_KETHREWARD_V1))) {
        NPC_REMOVEINVITEMS(SELF, 0x859b, (CQ004_KETHREWARD_V1_NOQ202) - (CQ004_KETHREWARD_V1));
        AI_STARTFACEANI(SELF, S_SMILE, 1, -(1));
        B_GIVEINVITEMS(OTHER, SELF, 0x859b, (CQ004_KETHREWARD_V1_NOQ202) - (CQ004_KETHREWARD_V1));
...
func int DIA_KETH_AMBIENT_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x1260a)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_KETH_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x1262c);
    INFO_ADDCHOICE(0x1262c, DIALOG_BACK, 0x12630);
    INFO_ADDCHOICE(0x1262c, DIALOG_PICKPOCKET, 0x1262f);
}
