...
func int DIA_GASPAR_Q207_ANTONIO_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x10229)) && ((Q207_MARVINKNOWABOUTANTONIO) == (FALSE))) && ((LOG_GETSTATUS(MIS_Q207)) == (LOG_RUNNING))) {
        return TRUE;
    };
...
func int DIA_GASPAR_Q207_SOREN_CONDITION() {
    if (((LOG_GETSTATUS(MIS_Q207)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x15bac))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_GASPAR_WINE_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x15035)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_GASPAR_WINE_INFO() {
    ...
    INFO_CLEARCHOICES(0x1503e);
    INFO_ADDCHOICE(0x1503e, "Are they selling well?", 0x15041);
}
...
func void DIA_GASPAR_WINE_SELL() {
    ...
    INFO_CLEARCHOICES(0x1503e);
    INFO_ADDCHOICE(0x1503e, "To what does Holdwig owe its success?", 0x15042);
    INFO_ADDCHOICE(0x1503e, "What do you know about this conflict?", 0x15043);
}
...
func int DIA_GASPAR_GIVEWINE_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x1503e)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_GASPAR_GIVEWINE_INFO() {
    ...
    CREATEINVITEMS(SELF, 0x8e29, 2);
    B_GIVEINVITEMS(SELF, OTHER, 0x8e29, 2);
    AI_WAITTILLEND(SELF, OTHER);
    AI_WAITTILLEND(OTHER, SELF);
    AI_STOPLOOKAT(OTHER);
    AI_WAITTILLEND(SELF, OTHER);
    AI_WAITTILLEND(OTHER, SELF);
    AI_USEITEM(OTHER, 0x8e29);
    AI_WAITTILLEND(SELF, OTHER);
    AI_WAITTILLEND(OTHER, SELF);
    ...
    INFO_CLEARCHOICES(0x1503e);
    INFO_ADDCHOICE(0x1503e, "What does its name actually mean?", 0x15047);
}
...
var int DIA_GASPAR_TRADE_INFO.GASPAR_TRADE_CHECKINFO = 0;
...
func int DIA_GASPAR_SQ120_FINISH_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x1500f)) && ((LOG_GETSTATUS(MIS_SQ120)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_GASPAR_SQ120_FINISH_INFO() {
    ...
    AI_RESETFACEANI(SELF);
    CREATEINVITEMS(SELF, 0x859b, SQ120_REWARD);
    B_GIVEINVITEMS(SELF, OTHER, 0x859b, SQ120_REWARD);
...
func int DIA_GASPAR_SQ206_WHAT_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x15052)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_GASPAR_SQ206_KILLANIMALS_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x15055)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_GASPAR_SQ206_BLATTCRAWLER_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x15058)) && ((SQ206_NEARCRAWLERS_LOGENTRY) == (TRUE))) && ((LOG_GETSTATUS(MIS_SQ206)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_GASPAR_SQ206_BLATTCRAWLER_INFO() {
    ...
    MOB_CREATEITEMS("SQ206_WOODCHEST", 0x910b, 5);
    MOB_CREATEITEMS("WITHOUTRACE_VINEYARD_CHEST_02", 0x910b, 5);
...
func void DIA_GASPAR_SQ206_FINISH_INFO() {
    ...
    if (NPC_KNOWSINFO(OTHER, 0x1505e)) {
    ...
    if (NPC_KNOWSINFO(OTHER, 0x1505e)) {
        ...
        CREATEINVITEMS(SELF, 0x859b, (SQ206_REWARD) + (SQ206_BONUSREWARD));
    };
    B_GIVEPLAYERXP(XP_SQ206_FINISH);
    CREATEINVITEMS(SELF, 0x859b, SQ206_REWARD);
    B_GIVEINVITEMS(SELF, OTHER, 0x859b, SQ206_REWARD);
}
...
var int GASPAR_Q505_WENEEDTOPAY = 0;
...
func int DIA_GASPAR_Q505_PAY_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x15064)) && ((LOG_GETSTATUS(MIS_Q505)) == (LOG_RUNNING))) && ((GASPAR_Q505_WENEEDTOPAY) == (TRUE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_GASPAR_Q505_PAY_INFO() {
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (Q505_RITAPRICE)) {
        GASPAR_Q505_WENEEDTOPAY = 0;
        NPC_REMOVEINVITEMS(SELF, 0x859b, Q505_RITAPRICE);
        AI_STARTFACEANI(SELF, S_SMILE, 1, -(1));
        B_GIVEINVITEMS(OTHER, SELF, 0x859b, Q505_RITAPRICE);
        AI_OUTPUT(SELF, OTHER, "DIA_Gaspar_Q505_Pay_03_01");
        CREATEINVITEMS(SELF, 0x92b2, 1);
        B_GIVEINVITEMS(SELF, OTHER, 0x92b2, 1);
        AI_RESETFACEANI(SELF);
    };
...
func void DIA_GASPAR_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x1506b);
    INFO_ADDCHOICE(0x1506b, DIALOG_BACK, 0x1506f);
    INFO_ADDCHOICE(0x1506b, DIALOG_PICKPOCKET, 0x1506e);
}

func void DIA_GASPAR_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (2)) {
        CREATEINVITEMS(SELF, 0x8e29, 1);
        B_GIVEINVITEMS(SELF, OTHER, 0x8e29, 1);
