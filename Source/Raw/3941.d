...
func int DIA_ANAIS_Q206_KNOWHIM_CONDITION() {
    if ((((NPC_KNOWSINFO(OTHER, 0x12830)) && ((LOG_GETSTATUS(MIS_Q206)) == (LOG_RUNNING))) && ((Q206_KNOWSFINBAR) == (TRUE))) && ((NPC_GETDISTTOWP(SELF, "HARBOUR_PATH_100")) <= (1000))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_ANAIS_Q206_WHERE_CONDITION() {
    if ((((NPC_KNOWSINFO(OTHER, 0x12833)) && ((LOG_GETSTATUS(MIS_Q206)) == (LOG_RUNNING))) && ((Q206_KNOWSFINBAR) == (TRUE))) && ((NPC_GETDISTTOWP(SELF, "HARBOUR_PATH_100")) <= (1000))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ANAIS_Q206_WHERE_INFO() {
    ...
    INFO_CLEARCHOICES(0x12836);
    INFO_ADDCHOICE(0x12836, "I don't have time right now.", 0x1283b);
    INFO_ADDCHOICE(0x12836, "Let's go!", 0x1283a);
}

var int ANAIS_Q206_GUIDE = 0;
...
func int DIA_ANAIS_Q206_THANKS_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_Q206)) == (LOG_RUNNING)) && ((NPC_GETDISTTOWP(SELF, "SLUMS_PATH_36")) <= (500))) && (NPC_KNOWSINFO(OTHER, 0x12836))) && ((ANAIS_Q206_GUIDE) == (TRUE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_ANAIS_AMBIENT_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x12836)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ANAIS_AMBIENT_INFO() {
    ...
    if (((ANAIS_Q206_GUIDE) == (TRUE)) && (!(NPC_KNOWSINFO(OTHER, 0x1283c)))) {
...
func void DIA_ANAIS_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x12842);
    INFO_ADDCHOICE(0x12842, DIALOG_BACK, 0x12846);
    INFO_ADDCHOICE(0x12842, DIALOG_PICKPOCKET, 0x12845);
}
