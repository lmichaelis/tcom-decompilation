...
instance SLEEPABIT_S1.HER(C_NPC)
instance SLEEPABIT_S1.ROCK(C_NPC)
func void Q103_UNLOCKVILLAGE() {
    ...
    WLD_INSERTNPC(0xe1de, "PART13_BANDIT_01");
    WLD_INSERTNPC(0xe1e0, "PART13_BANDIT_02");
    WLD_INSERTNPC(0xe1e2, "PART13_BANDIT_03");
    WLD_INSERTNPC(0xc611, "PART_13_SPAWN_SCAVENGER_01");
    WLD_INSERTNPC(0xc5b1, "PART_13_SPAWN_SCAVENGER_03");
    WLD_INSERTNPC(0xc5b1, "PART_13_SPAWN_SCAVENGER_03");
    WLD_INSERTNPC(0xc5b1, "PART_13_SPAWN_SCAVENGER_03");
    WLD_INSERTNPC(0xc611, "PART_13_SPAWN_SCAVENGER_05");
    WLD_INSERTNPC(0xc59b, "PART_13_SPAWN_LURKER_04");
    WLD_INSERTNPC(0xc49c, "PART_13_SPAWN_BLOODFLY_01");
    WLD_INSERTNPC(0xc611, "PART13_MOB_03");
    WLD_INSERTNPC(0xc407, "PART13_MOB_04");
    WLD_INSERTNPC(0xc611, "PART13_MOB_05");
    WLD_INSERTNPC(0xc49c, "PART13_MOB_06");
    WLD_INSERTNPC(0xc611, RNG_TRAP37_WAYPOINT);
    WLD_INSERTNPC(0xc611, "PART13_MOB_15");
    WLD_INSERTNPC(0xc611, "PART13_MOB_10");
    WLD_INSERTNPC(0xc5aa, "PART13_MOB_17");
    WLD_INSERTNPC(0xc49c, "PART13_MOB_23");
    WLD_INSERTNPC(0xc49c, "PART13_MOB_25");
    WLD_INSERTNPC(0xc611, "PART13_MOB_27");
    WLD_INSERTNPC(0xc611, "PART13_MOB_30");
    WLD_INSERTNPC(0xc78a, "PART13_MOB_38");
    WLD_INSERTNPC(0xc407, "PART13_MOB_39");
    WLD_INSERTNPC(0xc611, "PART13_MOB_45");
    WLD_INSERTNPC(0xc407, "PART13_MOB_46");
}
...
func void Q103_NPCINVILLAGE() {
    ...
    TELEPORTNPCTOWP(0xe0b8, BAU_702_VIKTOR.WP);
    ...
    TELEPORTNPCTOWP(0xc8d3, NONE_100012_KAZEEM.WP);
    ...
    if (Q101_TIMOSURVIVE) {
        ...
        TELEPORTNPCTOWP(0xc94c, NONE_6_TIMO.WP);
    };
    if (Q101_LEASURVIVE) {
        B_STARTOTHERROUTINE(NONE_100009_LEA, PUB01);
        TELEPORTNPCTOWP(0xc98f, NONE_100009_LEA.WP);
    };
...
func void SILBACHFIRSTSLEEP() {
    FADESCREENTOBLACKF(1, 0xbb7c, 1000);
}
...
var int SQ416_MOVERS_APPLY.SQ416_MOVERS_COUNT = 0;
instance SQ416_MOVERS_APPLY.MOVER1(ZCMOVER)
instance SQ416_MOVERS_APPLY.MOVER2(ZCMOVER)
instance SQ416_MOVERS_APPLY.MOVER3(ZCMOVER)
instance SQ416_MOVERS_APPLY.MOVER4(ZCMOVER)
instance SQ416_MOVERS_APPLY.MOVER5(ZCMOVER)
instance SQ416_MOVERS_APPLY.MOVER6(ZCMOVER)
var int SQ416_MOVERS_APPLY.MOVPTR1 = 0;
var int SQ416_MOVERS_APPLY.MOVPTR2 = 0;
var int SQ416_MOVERS_APPLY.MOVPTR3 = 0;
var int SQ416_MOVERS_APPLY.MOVPTR4 = 0;
var int SQ416_MOVERS_APPLY.MOVPTR5 = 0;
var int SQ416_MOVERS_APPLY.MOVPTR6 = 0;
func void SQ416_HUNTERSWAKEUP() {
    ...
    NPC_REMOVEINVITEMS(VLK_3015_DETLOW, 0x8653, 1);
...
func int PC_Q306_REST_CONDITION() {
    if ((((((PLAYER_MOBSI_PRODUCTION) == (MOBSI_SLEEPABIT)) && (Q306_READY)) && (Q306_PLAYERSIGNEDIN)) && ((LOG_GETSTATUS(MIS_Q306)) == (LOG_RUNNING))) && (NPC_KNOWSINFO(HERO, 0x1486f))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void PROXIMO_PREPAREARENA() {
    ...
    AI_FUNCTION(SELF, 0xfa8c);
    AI_FUNCTION(SELF, 0xf732);
...
func int PC_SLEEPTIME_CONDITION_SQ311() {
    if (((((PLAYER_MOBSI_PRODUCTION) == (MOBSI_SLEEPABIT)) && ((NPC_GETDISTTOWP(SELF, "PART10_MINE_31")) <= (0x2710))) && (NPC_KNOWSINFO(SELF, 0x13c07))) && ((NPC_KNOWSINFO(SELF, 0x13c14)) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
