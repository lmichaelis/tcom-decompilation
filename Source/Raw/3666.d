...
func int DIA_SALL_CANYOUTRAIN_CONDITION() {
    if (((((OTHER.GUILD) == (GIL_MIL)) && ((LOG_GETSTATUS(MIS_Q203)) == (LOG_SUCCESS))) && ((LOG_GETSTATUS(MIS_CQ004)) != (LOG_RUNNING))) && (NPC_KNOWSINFO(OTHER, 0x105a6))) {
        return TRUE;
    };
...
var int SALL_NOMORE = 0;
var int SALL_CURRENT1HLEVEL = 0;
var int SALL_CURRENTDEXLEVEL = 0;
...
func int DIA_SALL_TRAIN_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x10590)) && ((SALL_NOMORE) == (FALSE))) && ((LOG_GETSTATUS(MIS_CQ004)) != (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_SALL_TRAIN_CHOICES() {
    ...
    SALL_GOLDCOST = 0;
    INFO_CLEARCHOICES(0x10597);
    INFO_ADDCHOICE(0x10597, DIALOG_BACK, 0x1059d);
    INFO_ADDCHOICE(0x10597, B_BUILDLEARNSTRING2(PRINT_LEARN1H1, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_1H, 1), SALL_GOLDCOST), 0x1059f);
    INFO_ADDCHOICE(0x10597, B_BUILDLEARNSTRING2(PRINT_LEARN1H5, (B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_1H, 1)) * (5), (SALL_GOLDCOST) * (5)), 0x105a1);
    INFO_ADDCHOICE(0x10597, B_BUILDLEARNSTRING2(PRINT_LEARNDEX1, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_DEXTERITY, 1), SALL_GOLDCOST), 0x105a3);
    INFO_ADDCHOICE(0x10597, B_BUILDLEARNSTRING2(PRINT_LEARNDEX5, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_DEXTERITY, 5), (SALL_GOLDCOST) * (5)), 0x105a5);
}

var int DIA_SALL_TRAIN_CHOICES.SALL_GOLDCOST = 0;
...
func int DIA_SALL_WHYNOT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x105a6)) && ((KAPITEL) < (3))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_SALL_CQ004_WHAT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x12607)) && ((LOG_GETSTATUS(MIS_CQ004)) == (LOG_RUNNING))) {
...
func void DIA_SALL_CQ004_WHAT_INFO() {
    ...
    INFO_CLEARCHOICES(0x105ac);
    INFO_ADDCHOICE(0x105ac, "How can you be sure it was damaged?", 0x105b4);
    INFO_ADDCHOICE(0x105ac, "Did it prevent them from continuing to work?", 0x105b3);
}
...
var int DIA_SALL_CQ004_WHAT_TURN.CQ004_KETHANDSALLTURN = 0;
func void DIA_SALL_CQ004_WHAT_NEXT() {
    ...
    if ((CQ004_KETHINFORMATION) == (2)) {
        ...
        INFO_CLEARCHOICES(0x105ac);
        AI_STOPPROCESSINFOS(SELF);
        AI_FUNCTION(SELF, 0xf4cf);
    };
}

var int DIA_SALL_CQ004_WHAT_NEXT.CQ004_KETHINFORMATION = 0;
...
func int DIA_SALL_AMBIENT_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x105a6)) {
...
func void DIA_SALL_AMBIENT_INFO() {
    ...
    if (((LOG_GETSTATUS(MIS_CQ004)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x105ac))) {
...
func int DIA_SALL_HUNTING_BASE_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x10590)) && ((PLAYER_TALENT_TAKEANIMALTROPHY[2]) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_SALL_HUNTING_BASE_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (SALL_BASETROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[2]) == (TRUE)) {
            ...
            NPC_REMOVEINVITEMS(SELF, 0x859b, SALL_BASETROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Sall_Hunting_Base_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, SALL_BASETROPHY);
...
func int DIA_SALL_HUNTING_SPECIAL_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x10590)) && ((PLAYER_TALENT_TAKEANIMALTROPHY[2]) == (TRUE))) && ((SALL_ALLHUNT) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_SALL_HUNTING_SPECIAL_CHOICES() {
    INFO_CLEARCHOICES(0x105c8);
    INFO_ADDCHOICE(0x105c8, DIALOG_BACK, 0x105cc);
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[17]) == (FALSE)) {
        INFO_ADDCHOICE(0x105c8, B_BUILDLEARNSTRING2(PRINT_TEACHSHELLS, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_SHELLS), SALL_SHELLSTROPHY), 0x105cd);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[8]) == (FALSE)) {
        INFO_ADDCHOICE(0x105c8, B_BUILDLEARNSTRING2(PRINT_TEACHMANDIBLES, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_MANDIBLES), SALL_MANDIBLESTROPHY), 0x105ce);
    };
}
...
func void DIA_SALL_HUNTING_SPECIAL_SHELLS() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (SALL_SHELLSTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[17]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, SALL_SHELLSTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Sall_Hunting_Special_Shells_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, SALL_SHELLSTROPHY);
...
func void DIA_SALL_HUNTING_SPECIAL_MANDIBLES() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (SALL_MANDIBLESTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[8]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, SALL_MANDIBLESTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Sall_Hunting_Special_Mandibles_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, SALL_MANDIBLESTROPHY);
...
func void DIA_SALL_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x105cf);
    INFO_ADDCHOICE(0x105cf, DIALOG_BACK, 0x105d3);
    INFO_ADDCHOICE(0x105cf, DIALOG_PICKPOCKET, 0x105d2);
}
