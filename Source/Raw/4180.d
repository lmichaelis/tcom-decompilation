var int GQ001_THIAGOINFORMATION = 0;
var int GQ001_THIAGO_RULES = 0;
var int GQ001_THIAGO_WHO = 0;
var int GQ001_THIAGO_CORTEZ = 0;
var int GQ001_THIAGO_MAN = 0;
var int GQ001_THIAGO_BEN = 0;
var int GQ001_THIAGO_MILITIAARMOR = 0;
...
func void DIA_THIAGO_HEYYOU_INFO() {
    ...
    AI_FUNCTION(SELF, 0xfb02);
    AI_STARTFACEANI(SELF, S_SERIOUS, 1, -(1));
    AI_OUTPUT(SELF, OTHER, "DIA_Thiago_Heyyou_13_04");
    INFO_CLEARCHOICES(0x149ce);
    INFO_ADDCHOICE(0x149ce, "You don't want to do that.", 0x149d6);
    if ((((LOG_GETSTATUS(MIS_Q207)) == (LOG_RUNNING)) && ((LOG_GETSTATUS(MIS_Q205)) == (LOG_SUCCESS))) && ((Q207_GONZALOGUIDE) >= (4))) {
        if ((Q207_LETTER_READ) == (TRUE)) {
            INFO_ADDCHOICE(0x149ce, "I'm one of Slasher's men...", 0x149d7);
        };
        ITM = NPC_GETEQUIPPEDARMOR(OTHER);
        if ((((NPC_HASEQUIPPEDARMOR(OTHER)) == (TRUE)) && ((HLP_ISITEM(ITM, 0x8ab5)) == (TRUE))) || (NPC_HASGUILDARMOREQUIPPED(OTHER, GIL_MIL))) {
            INFO_ADDCHOICE(0x149ce, "I'm one of Salvi's men...", 0x149d8);
        };
    };
    if ((((LOG_GETSTATUS(MIS_Q208)) == (LOG_RUNNING)) && ((LOG_GETSTATUS(MIS_Q206)) == (LOG_SUCCESS))) && (NPC_KNOWSINFO(OTHER, 0x13099))) {
        INFO_ADDCHOICE(0x149ce, "I came with Yannick.", 0x149dc);
        INFO_ADDCHOICE(0x149ce, "I'm one of the smugglers.", 0x149de);
    };
    if ((NPC_HASITEMS(OTHER, 0x859b)) > (0)) {
        INFO_ADDCHOICE(0x149ce, "I'm sure we'll get along somehow... (Bribe)", 0x149d5);
    };
}

instance DIA_THIAGO_HEYYOU_INFO.ITM(C_ITEM)
func void DIA_THIAGO_HEYYOU_KILLPLAYER() {
    ...
    AI_STOPPROCESSINFOS(SELF);
    AI_FUNCTION(SELF, 0x149d3);
    AI_FUNCTION(SELF, 0xfb0e);
}
...
func void DIA_THIAGO_HEYYOU_FROMSALVI() {
    ...
    AI_WAITTILLEND(SELF, OTHER);
    AI_FUNCTION(SELF, 0xfb06);
    AI_OUTPUT(SELF, OTHER, "DIA_Thiago_Heyyou_FromSalvi_03_03");
    INFO_CLEARCHOICES(0x149ce);
    INFO_ADDCHOICE(0x149ce, "I have a message directly to Cortez.", 0x149da);
    INFO_ADDCHOICE(0x149ce, "I came to recruit some people...", 0x149db);
}

instance DIA_THIAGO_HEYYOU_FROMSALVI.ITM(C_ITEM)
func void DIA_THIAGO_HEYYOU_FROMSALVI_CORTEZ() {
    AI_FUNCTION(SELF, 0xfb07);
...
func void DIA_THIAGO_HEYYOU_YANNICK() {
    ...
    AI_FUNCTION(SELF, 0xfb09);
    AI_OUTPUT(SELF, OTHER, "DIA_Thiago_Heyyou_Yannick_03_04");
    if ((((NPC_HASITEMS(OTHER, 0x911f)) >= (1)) || ((NPC_HASITEMS(OTHER, 0x9102)) >= (1))) || ((NPC_HASITEMS(OTHER, 0x9155)) >= (1))) {
        INFO_ADDCHOICE(0x149ce, "I bring something straight from the fishermen. (Give swampweed)", 0x149dd);
    };
}

func void DIA_THIAGO_HEYYOU_YANNICK_JOINT() {
    AI_FUNCTION(SELF, 0xfb0a);
    if ((NPC_HASITEMS(OTHER, 0x911f)) >= (1)) {
    };
    if ((NPC_HASITEMS(OTHER, 0x9102)) >= (1)) {
    };
    if ((NPC_HASITEMS(OTHER, 0x9155)) >= (1)) {
        ...
        NPC_REMOVEINVITEMS(SELF, 0x9155, 1);
    };
...
func void DIA_THIAGO_HEYYOU_SMUGGLER() {
    AI_FUNCTION(SELF, 0xfb0b);
    AI_OUTPUT(OTHER, SELF, "DIA_Thiago_Heyyou_Smuggler_15_01");
    AI_WAITTILLEND(SELF, OTHER);
    AI_FUNCTION(SELF, 0xfb0c);
    AI_OUTPUT(SELF, OTHER, "DIA_Thiago_Heyyou_Smuggler_03_02");
    INFO_CLEARCHOICES(0x149ce);
    INFO_ADDCHOICE(0x149ce, "We operate on the Amber Coast.", 0x149df);
    INFO_ADDCHOICE(0x149ce, "I wanted to offer Cortez a regular delivery...", 0x149e0);
}

func void DIA_THIAGO_HEYYOU_SMUGGLER_BEACH() {
    AI_FUNCTION(SELF, 0xfb0d);
...
func int DIA_THIAGO_SQ317_WHAT_CONDITION() {
    if ((((KAPITEL) == (3)) && ((LOG_GETSTATUS(MIS_Q306)) == (LOG_SUCCESS))) || (NPC_KNOWSINFO(OTHER, 0x149e5))) {
        return FALSE;
    };
...
func void DIA_THIAGO_SQ317_WHAT_INFO() {
    ...
    INFO_CLEARCHOICES(0x149e1);
    INFO_ADDCHOICE(0x149e1, "Cortez wants us to repair palisade by his house.", 0x149e4);
}
...
func void DIA_THIAGO_SQ317_WHERE_INFO() {
    ...
    INFO_CLEARCHOICES(0x149e5);
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (SQ317_THIAGOGOLD)) {
        INFO_ADDCHOICE(0x149e5, "Let's forget the whole thing. (50 GP)", 0x149ea);
    };
    INFO_ADDCHOICE(0x149e5, "Homer was eaten by swampsharks.", 0x149e9);
}
...
func void DIA_THIAGO_SQ317_WHERE_FORGET() {
    ...
    B_MARVIN_USEFAKEBAG_THROW();
    B_GIVEINVITEMS(OTHER, SELF, 0x859b, SQ317_THIAGOGOLD);
    DIA_THIAGO_SQ317_WHERE_NEXT();
}
...
func int DIA_THIAGO_IWILLTEACHYOU_CONDITION() {
    if (((GQ001_THIAGO_WHO) == (TRUE)) && (NPC_KNOWSINFO(OTHER, 0x146f8))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
var int THIAGO_CURRENTCBLEVEL = 0;
var int THIAGO_CURRENTBOWLEVEL = 0;
var int THIAGO_NOMORE = 0;
...
func int DIA_THIAGO_TRAIN_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x149eb)) && ((THIAGO_NOMORE) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_THIAGO_TRAIN_CHOICES() {
    ...
    INFO_CLEARCHOICES(0x149f2);
    INFO_ADDCHOICE(0x149f2, DIALOG_BACK, 0x149f7);
    INFO_ADDCHOICE(0x149f2, B_BUILDLEARNSTRING2(PRINT_LEARNCROSSBOW1, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_CROSSBOW, 1), THIAGO_GOLDCOST), 0x149f8);
    INFO_ADDCHOICE(0x149f2, B_BUILDLEARNSTRING2(PRINT_LEARNCROSSBOW5, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_CROSSBOW, 5), (THIAGO_GOLDCOST) * (5)), 0x149f9);
    INFO_ADDCHOICE(0x149f2, B_BUILDLEARNSTRING2(PRINT_LEARNBOW1, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_BOW, 1), THIAGO_GOLDCOST), 0x149fa);
    INFO_ADDCHOICE(0x149f2, B_BUILDLEARNSTRING2(PRINT_LEARNBOW5, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_BOW, 5), (THIAGO_GOLDCOST) * (5)), 0x149fb);
}

var int DIA_THIAGO_TRAIN_CHOICES.THIAGO_GOLDCOST = 0;
...
func void DIA_THIAGO_TRAIN_CROSSBOW1() {
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (THIAGO_PAYMENT1)) {
        if ((THIAGO_CURRENTCBLEVEL) < (OTHER.AIVAR[87])) {
            SND_PLAY(GELDBEUTEL);
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, THIAGO_PAYMENT1);
            NPC_REMOVEINVITEMS(SELF, 0x859b, THIAGO_PAYMENT1);
        };
...
func void DIA_THIAGO_TRAIN_CROSSBOW5() {
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (THIAGO_PAYMENT5)) {
        if ((THIAGO_CURRENTCBLEVEL) < (OTHER.AIVAR[87])) {
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, THIAGO_PAYMENT5);
            SND_PLAY(GELDBEUTEL);
            NPC_REMOVEINVITEMS(SELF, 0x859b, THIAGO_PAYMENT5);
        };
...
func int DIA_THIAGO_TRAIN_PICKLOCK_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x149eb)) && ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKLOCK)) == (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_THIAGO_TRAIN_PICKLOCK_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (THIAGO_PICKLOCK)) {
        if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKLOCK)) == (2)) {
            ...
            NPC_REMOVEINVITEMS(SELF, 0x859b, THIAGO_PICKLOCK);
            AI_OUTPUT(SELF, OTHER, "DIA_Thiago_TRAIN_Picklock_03_01");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, THIAGO_PICKLOCK);
...
func int DIA_THIAGO_AMBIENT_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x14a02)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_THIAGO_WELCOME_INFO() {
    ...
    INFO_CLEARCHOICES(0x14a02);
    INFO_ADDCHOICE(0x14a02, "What exactly is this place?", 0x14a06);
}

func void DIA_THIAGO_WELCOME_CHOICES() {
    if ((LOG_GETSTATUS(MIS_Q301)) == (LOG_RUNNING)) {
        INFO_CLEARCHOICES(0x14a0d);
        INFO_CLEARCHOICES(0x14a10);
    };
    INFO_CLEARCHOICES(0x14a02);
    if ((GQ001_THIAGO_RULES) == (FALSE)) {
        INFO_ADDCHOICE(0x14a02, "Are there any rules here?", 0x14a07);
    };
    if ((HERO.GUILD) == (GIL_MIL)) {
        if ((GQ001_THIAGO_MAN) == (FALSE)) {
            INFO_ADDCHOICE(0x14a02, "Any three men come in here recently?", 0x14a0a);
        };
        if ((GQ001_THIAGO_MILITIAARMOR) == (FALSE)) {
            INFO_ADDCHOICE(0x14a02, "No one will attack me because of my guard uniform?", 0x14a29);
        };
    };
    if ((HERO.GUILD) == (GIL_SLD)) {
        if ((GQ001_THIAGO_BEN) == (FALSE)) {
            INFO_ADDCHOICE(0x14a02, "Has there been a big guy here lately?", 0x14a0b);
        };
    };
    if ((GQ001_THIAGOINFORMATION) == (2)) {
        INFO_ADDCHOICE(0x14a02, "Where do I go now?", 0x14a0c);
    };
}
...
func int DIA_THIAGO_WHO_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x14a02)) && ((GQ001_THIAGO_WHO) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_THIAGO_CORTEZ_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x14a02)) && ((GQ001_THIAGO_CORTEZ) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_THIAGO_HUNTING_SPECIAL_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x149eb)) && ((THIAGO_ALLHUNT) == (FALSE))) && ((PLAYER_TALENT_TAKEANIMALTROPHY[2]) == (TRUE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_THIAGO_HUNTING_SPECIAL_CHOICES() {
    INFO_CLEARCHOICES(0x14a17);
    INFO_ADDCHOICE(0x14a17, DIALOG_BACK, 0x14a1b);
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[7]) == (FALSE)) {
        INFO_ADDCHOICE(0x14a17, B_BUILDLEARNSTRING2(PRINT_TEACHBFSTING, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_BFSTING), THIAGO_BFSTINGTROPHY), 0x14a1c);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[8]) == (FALSE)) {
        INFO_ADDCHOICE(0x14a17, B_BUILDLEARNSTRING2(PRINT_TEACHMANDIBLES, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_MANDIBLES), THIAGO_MANDIBLESTROPHY), 0x14a1d);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[6]) == (FALSE)) {
        INFO_ADDCHOICE(0x14a17, B_BUILDLEARNSTRING2(PRINT_TEACHBFWING, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_BFWING), THIAGO_BFWINGTROPHY), 0x14a1e);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[15]) == (FALSE)) {
        INFO_ADDCHOICE(0x14a17, B_BUILDLEARNSTRING2(PRINT_TEACHFATS, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_FATS), THIAGO_FATSTROPHY), 0x14a1f);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[13]) == (FALSE)) {
        INFO_ADDCHOICE(0x14a17, B_BUILDLEARNSTRING2(PRINT_TEACHREPTILESKIN, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_REPTILESKIN), THIAGO_REPTILESKINTROPHY), 0x14a20);
    };
}
...
func void DIA_THIAGO_HUNTING_SPECIAL_BFSTING() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (THIAGO_BFSTINGTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[7]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, THIAGO_BFSTINGTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Thiago_Hunting_Special_BFSting_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, THIAGO_BFSTINGTROPHY);
...
func void DIA_THIAGO_HUNTING_SPECIAL_MANDIBLES() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (THIAGO_MANDIBLESTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[8]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, THIAGO_MANDIBLESTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Thiago_Hunting_Special_Mandibles_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, THIAGO_MANDIBLESTROPHY);
...
func void DIA_THIAGO_HUNTING_SPECIAL_BFWING() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (THIAGO_BFWINGTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[6]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, THIAGO_BFWINGTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Thiago_Hunting_Special_BFWing_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, THIAGO_BFWINGTROPHY);
...
func void DIA_THIAGO_HUNTING_SPECIAL_FATS() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (THIAGO_FATSTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[15]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, THIAGO_FATSTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Thiago_Hunting_Special_Fats_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, THIAGO_FATSTROPHY);
...
func void DIA_THIAGO_HUNTING_SPECIAL_REPTILESKIN() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (THIAGO_REPTILESKINTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[13]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, THIAGO_REPTILESKINTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Thiago_Hunting_Special_ReptileSkin_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, THIAGO_REPTILESKINTROPHY);
...
func int DIA_THIAGO_IWILLTEACHACROBAT_CONDITION() {
    if (((GQ001_THIAGO_WHO) == (TRUE)) && (NPC_KNOWSINFO(OTHER, 0x149eb))) {
...
func int DIA_THIAGO_TRAIN_ACROBAT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x14a21)) && ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_ACROBAT)) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_THIAGO_TRAIN_ACROBAT_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (THIAGO_ACROBAT)) {
        if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_ACROBAT)) == (1)) {
            NPC_REMOVEINVITEMS(SELF, 0x859b, THIAGO_ACROBAT);
            AI_OUTPUT(SELF, OTHER, "DIA_Thiago_TRAIN_Acrobat_03_01");
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, THIAGO_ACROBAT);
...
func int DIA_THIAGO_MILITIAARMOR_CONDITION() {
    if (((((HERO.GUILD) == (GIL_MIL)) && ((KAPITEL) == (3))) && ((GQ001_THIAGO_MILITIAARMOR) == (FALSE))) && (NPC_KNOWSINFO(OTHER, 0x14a02))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_THIAGO_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x14a2b);
    INFO_ADDCHOICE(0x14a2b, DIALOG_BACK, 0x14a2f);
    INFO_ADDCHOICE(0x14a2b, DIALOG_PICKPOCKET, 0x14a2e);
}

func void DIA_THIAGO_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (3)) {
        CREATEINVITEMS(SELF, 0x864f, 11);
        B_GIVEINVITEMS(SELF, OTHER, 0x864f, 11);
