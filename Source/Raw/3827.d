...
func void DIA_WNREFUGEE_HELLO_INFO() {
    ...
    INFO_CLEARCHOICES(0x119dd);
    INFO_ADDCHOICE(0x119dd, "I don't believe you and I'm not giving you anything.", 0x119e0);
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (EVENT_REFUGEEFAVOR)) {
        INFO_ADDCHOICE(0x119dd, "Here. (Give 50 GP)", 0x119e1);
    };
}
...
func void DIA_WNREFUGEE_ISNICE() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 0x859b, EVENT_REFUGEEFAVOR);
...
func int DIA_WNREFUGEE_GETLOST_CONDITION() {
    if (((WNREFUGEE_HELP) == (1)) && (NPC_ISINSTATE(SELF, 0xf09f))) {
        return TRUE;
    };
...
func int DIA_WNREFUGEE_COMELATER_CONDITION() {
    if ((((WNREFUGEE_HELP) == (2)) && (NPC_ISINSTATE(SELF, 0xf09f))) && (((KAPITEL) == (4)) || ((WNREFUGEE_DAY) == (WLD_GETDAY())))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_WNREFUGEE_YOURGOLD_INFO() {
    ...
    CREATEINVITEMS(SELF, 0x859b, EVENT_REFUGEEFAVOR_FORHERO);
    B_GIVEINVITEMS(SELF, OTHER, 0x859b, EVENT_REFUGEEFAVOR_FORHERO);
    B_GIVEPLAYERXP(XP_EVENT_REFUGEE_HELP);
...
func int DIA_WNREFUGEE_AFTERPARTY_CONDITION() {
    if (((WNREFUGEE_HELP) == (3)) && (NPC_ISINSTATE(SELF, 0xf09f))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
