func void SALZER_TOCITY() {
    PRINTD("DZIA£A!");
    FADESCREENTOBLACKF(1, 0xf7e3, 1000);
}
...
func void SALZER_TOCITY2() {
    if ((LOG_GETSTATUS(MIS_Q201)) == (LOG_RUNNING)) {
        ...
        AI_FUNCTION(SLD_5004_SALZER, 0xf7e4);
    ...
    TELEPORTNPCTOWP(0xd9e9, SLD_5004_SALZER.WP);
    FF_APPLYONCEEXTGT(0xf7e5, 0, -(1));
}
...
var int SQ201_CART_START.SQ201_CART_COLLISION = 0;
instance SQ201_CART_START.MOVER1(ZCMOVER)
instance SQ201_CART_START.MOVER2(ZCMOVER)
instance SQ201_CART_START.MOVER3(ZCMOVER)
var int SQ201_CART_START.MOVPTR1 = 0;
var int SQ201_CART_START.MOVPTR2 = 0;
var int SQ201_CART_START.MOVPTR3 = 0;
...
func void SQ201_SALZER_GIVEGOLD() {
    if ((FORWHEEL30) == (TRUE)) {
        CREATEINVITEMS(SELF, 0x859b, SQ201_REWARD_V1);
    };
    if ((FORWHEEL50) == (TRUE)) {
        CREATEINVITEMS(SELF, 0x859b, SQ201_REWARD_V2);
        B_GIVEINVITEMS(SELF, OTHER, 0x859b, SQ201_REWARD_V2);
    };
}
