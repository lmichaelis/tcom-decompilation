...
func void B_SETVISUALS_RAT() {
    ...
    MDL_SETMODELSCALE(SELF, 0x3e800000, 0x3e4ccccd, 0x3e4ccccd);
}
...
instance RATFLOUR(MST_DEFAULT_RAT) {
    ...
    CREATEINVITEMS(RATFLOUR, 0x8e33, 1);
}
...
instance NONE_13503_ALF(MST_DEFAULT_RAT) {
    ...
    CREATEINVITEMS(NONE_13503_ALF, 0x8e33, 1);
}
...
instance RAT_Q101_01(MST_DEFAULT_RAT) {
    ...
    CREATEINVITEMS(RAT_Q101_01, 0x8e33, 1);
}
...
instance RAT_Q101_02(MST_DEFAULT_RAT) {
    ...
    CREATEINVITEMS(RAT_Q101_02, 0x8e33, 1);
}
...
instance RAT_Q101_03(MST_DEFAULT_RAT) {
    ...
    CREATEINVITEMS(RAT_Q101_03, 0x8e33, 1);
}
...
instance RAT_Q101_04(MST_DEFAULT_RAT) {
    ...
    CREATEINVITEMS(RAT_Q101_04, 0x8e33, 1);
}
...
instance RAT_Q101_05(MST_DEFAULT_RAT) {
    ...
    CREATEINVITEMS(RAT_Q101_05, 0x8e33, 1);
}
...
instance RAT_Q101_06(MST_DEFAULT_RAT) {
    ...
    CREATEINVITEMS(RAT_Q101_06, 0x8e33, 1);
}
...
instance RAT_KQ406(MST_DEFAULT_RAT) {
    ...
    CREATEINVITEMS(RAT_KQ406, 0x8e33, 1);
}
...
instance RAT_Q501(MST_DEFAULT_RAT) {
    ...
    CREATEINVITEMS(RAT_Q501, 0x8e33, 1);
}
