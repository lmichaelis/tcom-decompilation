...
func void SQ416_RAMSEYHOUSEMEETINGCUTSCENE_START() {
    ...
    TELEPORTNPCTOWP(0xd0c8, VLK_6389_NIRKA.WP);
    TELEPORTNPCTOWP(0xcd11, VLK_3025_ALLAN.WP);
    TELEPORTNPCTOWP(0xcb5b, SLD_13491_RUDI.WP);
    TELEPORTNPCTOWP(0x71b, "PARTM5_RAMSEY_07");
    ...
    AI_FUNCTION(NONE_500_RAMSEY, 0x16b3f);
    ...
    AI_FUNCTION(NONE_500_RAMSEY, 0x16b40);
    ...
    AI_FUNCTION(NONE_500_RAMSEY, 0x16b3e);
}

func void SQ416_RAMSEYHOUSEMEETINGCUTSCENE_END() {
    FF_APPLYONCEEXT(0xf83e, 75, 4);
}
