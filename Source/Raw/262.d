var int MARVIN_MAGELEARNING_TIER1 = 0;
var int MARVIN_MAGELEARNING_TIER2 = 0;
var int MARVIN_MAGELEARNING_TIER3 = 0;
var int MARVIN_MAGELEARNING_TIER4 = 0;
...
func void USE_MAGICTESTPACKET() {
    CREATEINVITEMS(HERO, 0x9f82, 1);
    CREATEINVITEMS(HERO, 0x9f8d, 1);
    CREATEINVITEMS(HERO, 0x9f98, 1);
    CREATEINVITEMS(HERO, 0x9fa3, 1);
    CREATEINVITEMS(HERO, 0x9fae, 1);
    CREATEINVITEMS(HERO, 0x9fb9, 1);
    CREATEINVITEMS(HERO, 0x9fc4, 1);
    CREATEINVITEMS(HERO, 0x9fcf, 1);
    CREATEINVITEMS(HERO, 0x9fda, 1);
    CREATEINVITEMS(HERO, 0x9fe5, 1);
    CREATEINVITEMS(HERO, 0x9ff0, 1);
    CREATEINVITEMS(HERO, 0x9ffb, 1);
    CREATEINVITEMS(HERO, 0xa006, 1);
    CREATEINVITEMS(HERO, 0xa011, 1);
    CREATEINVITEMS(HERO, 0x9f83, 1);
    CREATEINVITEMS(HERO, 0x9f8e, 1);
    CREATEINVITEMS(HERO, 0x9f99, 1);
    CREATEINVITEMS(HERO, 0x9fa4, 1);
    CREATEINVITEMS(HERO, 0x9faf, 1);
    CREATEINVITEMS(HERO, 0x9fba, 1);
    CREATEINVITEMS(HERO, 0x9fc5, 1);
    CREATEINVITEMS(HERO, 0x9fd0, 1);
    CREATEINVITEMS(HERO, 0x9fdb, 1);
    CREATEINVITEMS(HERO, 0x9fe6, 1);
    CREATEINVITEMS(HERO, 0x9ff1, 1);
    CREATEINVITEMS(HERO, 0x9ffc, 1);
    CREATEINVITEMS(HERO, 0xa007, 1);
    CREATEINVITEMS(HERO, 0xa012, 1);
    SND_PLAY(GELDBEUTEL);
}
...
func void USE_TALENTBOOKTESTPACKET() {
    CREATEINVITEMS(HERO, 0xa070, 1);
    CREATEINVITEMS(HERO, 0xa073, 1);
    CREATEINVITEMS(HERO, 0xa076, 1);
    CREATEINVITEMS(HERO, 0xa067, 1);
    CREATEINVITEMS(HERO, 0xa06a, 1);
    CREATEINVITEMS(HERO, 0xa06d, 1);
    CREATEINVITEMS(HERO, 0xa05e, 1);
    CREATEINVITEMS(HERO, 0xa061, 1);
    CREATEINVITEMS(HERO, 0xa064, 1);
    CREATEINVITEMS(HERO, 0xa055, 1);
    CREATEINVITEMS(HERO, 0xa058, 1);
    CREATEINVITEMS(HERO, 0xa05b, 1);
    CREATEINVITEMS(HERO, 0xa043, 1);
    CREATEINVITEMS(HERO, 0xa046, 1);
    CREATEINVITEMS(HERO, 0xa049, 1);
    CREATEINVITEMS(HERO, 0xa079, 1);
    CREATEINVITEMS(HERO, 0xa07c, 1);
    CREATEINVITEMS(HERO, 0xa07f, 1);
    CREATEINVITEMS(HERO, 0xa04c, 1);
    CREATEINVITEMS(HERO, 0xa04f, 1);
    CREATEINVITEMS(HERO, 0xa052, 1);
    CREATEINVITEMS(HERO, 0xa026, 1);
    CREATEINVITEMS(HERO, 0xa083, 1);
    SND_PLAY(GELDBEUTEL);
}
...
var int SCROLLBOOK_STARTDIALOGUE = 0;
...
var int CIRCLEBOOK_TIER1_01_STARTDIALOGUE = 0;
var int CIRCLEBOOK_TIER1_01_LEARNED = 0;
...
var int CIRCLEBOOK_TIER1_02_STARTDIALOGUE = 0;
var int CIRCLEBOOK_TIER1_02_LEARNED = 0;
...
var int CIRCLEBOOK_TIER2_01_STARTDIALOGUE = 0;
var int CIRCLEBOOK_TIER2_01_LEARNED = 0;
...
var int CIRCLEBOOK_TIER2_02_STARTDIALOGUE = 0;
var int CIRCLEBOOK_TIER2_02_LEARNED = 0;
...
var int CIRCLEBOOK_TIER2_03_STARTDIALOGUE = 0;
var int CIRCLEBOOK_TIER2_03_LEARNED = 0;
...
var int CIRCLEBOOK_TIER3_01_STARTDIALOGUE = 0;
var int CIRCLEBOOK_TIER3_01_LEARNED = 0;
...
var int CIRCLEBOOK_TIER3_02_STARTDIALOGUE = 0;
var int CIRCLEBOOK_TIER3_02_LEARNED = 0;
...
var int CIRCLEBOOK_TIER3_03_STARTDIALOGUE = 0;
var int CIRCLEBOOK_TIER3_03_LEARNED = 0;
...
var int CIRCLEBOOK_TIER3_04_STARTDIALOGUE = 0;
var int CIRCLEBOOK_TIER3_04_LEARNED = 0;
...
var int CIRCLEBOOK_TIER4_01_STARTDIALOGUE = 0;
var int CIRCLEBOOK_TIER4_01_LEARNED = 0;
...
var int CIRCLEBOOK_TIER4_02_STARTDIALOGUE = 0;
var int CIRCLEBOOK_TIER4_02_LEARNED = 0;
...
var int CIRCLEBOOK_TIER4_03_STARTDIALOGUE = 0;
var int CIRCLEBOOK_TIER4_03_LEARNED = 0;
...
var int CIRCLEBOOK_TIER4_04_STARTDIALOGUE = 0;
var int CIRCLEBOOK_TIER4_04_LEARNED = 0;
...
var int CIRCLEBOOK_TIER4_05_STARTDIALOGUE = 0;
var int CIRCLEBOOK_TIER4_05_LEARNED = 0;
...
var int ALCHEMYBOOK_TIER1_STARTDIALOGUE = 0;
var int ALCHEMYBOOK_TIER1_LEARNED = 0;
...
func void ALCHEMYBOOK_TIER1_LEARN_INFO() {
    if ((HERO.LP) >= (10)) {
        ...
        MEM_PUSHINTPARAM(1);
        MEM_CALLBYID(MEM_GETFUNCID(0xf0ff));
        SND_PLAY("LEVELUP");
        AI_STOPPROCESSINFOS(SELF);
        ALCHEMYBOOK_TIER1_STARTDIALOGUE = FALSE;
    };
...
var int VOLFZACKE_LEARNING_STARTDIALOGUE = 0;
var int VOLFZACKE_LEARNING_TEACHED = 0;
...
func void VOLFZACKE_LEARNING_TEACH_CHOICES() {
    ...
    INFO_CLEARCHOICES(0xa028);
    INFO_ADDCHOICE(0xa028, DIALOG_ENDE, 0xa03e);
    INFO_ADDCHOICE(0xa028, B_BUILDLEARNSTRING2(PRINT_LEARNCROSSBOW1, B_GETLEARNCOSTTALENT(HERO, NPC_TALENT_CROSSBOW, 1), VOLFZACKE_GOLDCOST), 0xa034);
    INFO_ADDCHOICE(0xa028, B_BUILDLEARNSTRING2(PRINT_LEARNCROSSBOW5, B_GETLEARNCOSTTALENT(HERO, NPC_TALENT_CROSSBOW, 5), (VOLFZACKE_GOLDCOST) * (5)), 0xa035);
    INFO_ADDCHOICE(0xa028, B_BUILDLEARNSTRING2(PRINT_LEARNBOW1, B_GETLEARNCOSTTALENT(HERO, NPC_TALENT_BOW, 1), VOLFZACKE_GOLDCOST), 0xa036);
    INFO_ADDCHOICE(0xa028, B_BUILDLEARNSTRING2(PRINT_LEARNBOW5, B_GETLEARNCOSTTALENT(HERO, NPC_TALENT_BOW, 5), (VOLFZACKE_GOLDCOST) * (5)), 0xa037);
    INFO_ADDCHOICE(0xa028, B_BUILDLEARNSTRING2(PRINT_LEARN2H1, B_GETLEARNCOSTTALENT(HERO, NPC_TALENT_2H, 1), VOLFZACKE_GOLDCOST), 0xa03a);
    INFO_ADDCHOICE(0xa028, B_BUILDLEARNSTRING2(PRINT_LEARN2H5, B_GETLEARNCOSTTALENT(HERO, NPC_TALENT_2H, 5), (VOLFZACKE_GOLDCOST) * (5)), 0xa03b);
    INFO_ADDCHOICE(0xa028, B_BUILDLEARNSTRING2(PRINT_LEARN1H1, B_GETLEARNCOSTTALENT(HERO, NPC_TALENT_1H, 1), VOLFZACKE_GOLDCOST), 0xa038);
    INFO_ADDCHOICE(0xa028, B_BUILDLEARNSTRING2(PRINT_LEARN1H5, B_GETLEARNCOSTTALENT(HERO, NPC_TALENT_1H, 5), (VOLFZACKE_GOLDCOST) * (5)), 0xa039);
    INFO_ADDCHOICE(0xa028, B_BUILDLEARNSTRING2(PRINT_LEARNDEX1, B_GETLEARNCOSTATTRIBUTE(HERO, ATR_DEXTERITY, 1), VOLFZACKE_GOLDCOST), 0xa032);
    INFO_ADDCHOICE(0xa028, B_BUILDLEARNSTRING2(PRINT_LEARNDEX5, B_GETLEARNCOSTATTRIBUTE(HERO, ATR_DEXTERITY, 5), (VOLFZACKE_GOLDCOST) * (5)), 0xa033);
    INFO_ADDCHOICE(0xa028, B_BUILDLEARNSTRING2(PRINT_LEARNSTR1, B_GETLEARNCOSTATTRIBUTE(HERO, ATR_STRENGTH, 1), VOLFZACKE_GOLDCOST), 0xa030);
    INFO_ADDCHOICE(0xa028, B_BUILDLEARNSTRING2(PRINT_LEARNSTR5, B_GETLEARNCOSTATTRIBUTE(HERO, ATR_STRENGTH, 5), (VOLFZACKE_GOLDCOST) * (5)), 0xa031);
}

var int VOLFZACKE_LEARNING_TEACH_CHOICES.VOLFZACKE_GOLDCOST = 0;
...
var int VOLFZACKE_LEARNING_TEACH_INFO.VOLFZACKE_LEARNING_FIRSTTIME = 0;
...
var int TALENTBOOK_SOUTHERNER_TIER1_LEARNED = 0;
...
var int TALENTBOOK_SOUTHERNER_TIER2_LEARNED = 0;
...
var int TALENTBOOK_SOUTHERNER_TIER3_LEARNED = 0;
...
var int TALENTBOOK_SAILOR_TIER1_LEARNED = 0;
...
var int TALENTBOOK_SAILOR_TIER2_LEARNED = 0;
...
var int TALENTBOOK_SAILOR_TIER3_LEARNED = 0;
...
var int TALENTBOOK_NORDMAR_TIER1_LEARNED = 0;
...
var int TALENTBOOK_NORDMAR_TIER2_LEARNED = 0;
...
var int TALENTBOOK_NORDMAR_TIER3_LEARNED = 0;
...
var int TALENTBOOK_SWORDSMAN_TIER1_LEARNED = 0;
...
var int TALENTBOOK_SWORDSMAN_TIER2_LEARNED = 0;
...
var int TALENTBOOK_SWORDSMAN_TIER3_LEARNED = 0;
...
var int TALENTBOOK_CROSSBOW_TIER1_LEARNED = 0;
...
var int TALENTBOOK_CROSSBOW_TIER2_LEARNED = 0;
...
var int TALENTBOOK_CROSSBOW_TIER3_LEARNED = 0;
...
var int TALENTBOOK_BOW_TIER1_LEARNED = 0;
...
var int TALENTBOOK_BOW_TIER2_LEARNED = 0;
...
var int TALENTBOOK_BOW_TIER3_LEARNED = 0;
...
var int TALENTBOOK_MAGE_TIER1_LEARNED = 0;
...
var int TALENTBOOK_MAGE_TIER2_LEARNED = 0;
...
var int TALENTBOOK_MAGE_TIER3_LEARNED = 0;
...
var int PICKPOCKETBOOK_TIER1_STARTDIALOGUE = 0;
var int PICKPOCKETBOOK_TIER1_LEARNED = 0;
...
var int USE_STINGSDRINKING.NDOCID = 0;
...
var int USE_MANDIBLESDRINKING.NDOCID = 0;
