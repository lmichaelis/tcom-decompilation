...
func void Q108_MEETING_PREPARE_APPLY() {
    ...
    if ((Q108_MEETING_PREPARE_COUNT) == (4)) {
        ...
        CUTSCENE_START(0x16907);
    };
}

var int Q108_MEETING_PREPARE_APPLY.Q108_MEETING_PREPARE_COUNT = 0;
...
func int Q108_IGOTPLANTS(var C_NPC NPC) {
    if ((((NPC_HASITEMS(NPC, 0x9315)) >= (2)) && ((NPC_HASITEMS(NPC, 0x85e8)) >= (5))) && ((NPC_HASITEMS(NPC, 0x9090)) >= (1))) {
        return TRUE;
    };
...
var int Q108_FISHINGWITHKURT_END_APPLY.Q108_FISHINGWITHKURT_END_COUNT = 0;
