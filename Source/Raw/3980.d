var int DUNCAN_SQ122_TAKEQUEST = 0;
...
func int DIA_DUNCAN_SQ122_FINISH_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ122)) == (LOG_RUNNING)) && ((NPC_HASITEMS(OTHER, 0x9092)) >= (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DUNCAN_SQ122_FINISH_INFO() {
    ...
    AI_RESETFACEANI(SELF);
    B_GIVEINVITEMS(OTHER, SELF, 0x9092, 1);
    CREATEINVITEMS(SELF, 0x9573, 12);
    B_GIVEINVITEMS(SELF, OTHER, 0x9573, 12);
    CREATEINVITEMS(SELF, 0x8372, 4);
    B_GIVEINVITEMS(SELF, OTHER, 0x8372, 4);
