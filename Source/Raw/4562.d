...
func void Q304_TRAPCUTSCENE_START() {
    ...
    if ((SIMON_Q304_NEEDMOREPPL) >= (1)) {
        ...
        if ((SIMON_Q304_NEEDMOREPPL) == (2)) {
            if (!(NPC_ISDEAD(PIR_6322_GHOST))) {
                ...
                TELEPORTNPCTOWP(0xe481, "PART17_CUTSCENE_FINAL_PIRAT_03");
    ...
    TELEPORTNPCTOWP(0xe420, "PART17_CAVE_CUTSCENE_BODYGUARD_05");
    TELEPORTNPCTOWP(0xe430, "PART17_CAVE_CUTSCENE_BODYGUARD_04");
    TELEPORTNPCTOWP(0xe43a, "PART17_CAVE_CUTSCENE_BODYGUARD_03");
    TELEPORTNPCTOWP(0xe443, "PART17_CAVE_CUTSCENE_BODYGUARD_02");
    TELEPORTNPCTOWP(0xe460, "PART17_CAVE_CUTSCENE_BODYGUARD_01");
    TELEPORTNPCTOWP(0xe44c, "PART17_CAVE_SMUGGLER");
    ...
    AI_WAIT(HERO, 0x40a00000);
    AI_FUNCTION(HERO, 0x1691f);
    ...
    AI_FUNCTION(HERO, 0x16920);
    Q304_TRAPCUTSCENE_WAIT();
    AI_OUTPUT(NONE_6340_SMUGGLER, HERO, "DIA_Q304_FINALCUTSCENE_03_05");
    AI_FUNCTION(HERO, 0x16921);
    Q304_TRAPCUTSCENE_WAIT();
    if ((Q304_GONZALOSAFED) == (FALSE)) {
        AI_FUNCTION(HERO, 0x16922);
        ...
        Q304_TRAPCUTSCENE_WAIT();
        AI_FUNCTION(BAU_6287_GONZALO, 0x16926);
        AI_TURNTONPC(NONE_6340_SMUGGLER, HERO);
        AI_LOOKATNPC(NONE_6340_SMUGGLER, HERO);
    };
    Q304_TRAPCUTSCENE_WAIT();
    AI_FUNCTION(HERO, 0x16923);
    ...
    AI_WAIT(NONE_6340_SMUGGLER, 0x40a00000);
...
func void Q304_TRAPCUTSCENE_SETCHASMDETECTION_ONFRAME() {
    if (HLP_ISVALIDNPC(NONE_6337_BODYGUARD)) {
        CALL_INTPARAM(FALSE);
        CALL__THISCALL(MEM_INSTTOPTR(0xe430), 0x688a70);
    };
    if (HLP_ISVALIDNPC(NONE_6338_BODYGUARD)) {
        CALL_INTPARAM(FALSE);
        CALL__THISCALL(MEM_INSTTOPTR(0xe43a), 0x688a70);
    };
    if (HLP_ISVALIDNPC(NONE_6341_BODYGUARD)) {
        CALL_INTPARAM(FALSE);
        CALL__THISCALL(MEM_INSTTOPTR(0xe460), 0x688a70);
    };
}
...
func void Q304_TRAPCUTSCENE_CAMERA6() {
    ...
    TELEPORTNPCTOWP(0xe535, "PART17_PATH_158");
    TELEPORTNPCTOWP(0xe54f, "PART17_PATH_160");
    ...
    if ((SIMON_Q304_NEEDMOREPPL) >= (1)) {
        if (!(NPC_ISDEAD(PIR_1311_THIAGO))) {
            ...
            TELEPORTNPCTOWP(0xe577, "PART17_PATH_162");
        ...
        if ((SIMON_Q304_NEEDMOREPPL) == (2)) {
            if (!(NPC_ISDEAD(PIR_6322_GHOST))) {
                ...
                TELEPORTNPCTOWP(0xe481, "PART17_PATH_163");
...
func void Q304_TRAPCUTSCENE_END() {
    ...
    AI_STOPLOOKAT(HERO);
    Q304_MAKETHEMBANDIT();
    TELEPORTNPCTOWP(0x71b, "PART17_CAVE_CUTSCENE_HERO");
    ...
    TELEPORTNPCTOWP(0xe44c, "PART17_PATH_158");
...
func void Q304_KILLGONZALO() {
    ...
    NPC_CLEARAIQUEUE(NONE_6339_BODYGUARD);
    AI_WAIT(NONE_6339_BODYGUARD, 0x3f800000);
    AI_TURNTONPC(BAU_6287_GONZALO, NONE_6339_BODYGUARD);
    AI_WAIT(BAU_6287_GONZALO, 0x3f800000);
    AI_READYRANGEDWEAPON(NONE_6339_BODYGUARD);
    AI_AIMAT(NONE_6339_BODYGUARD, BAU_6287_GONZALO);
    AI_WAIT(NONE_6339_BODYGUARD, 0x3f8ccccd);
    AI_WAIT(BAU_6287_GONZALO, 0x3fa66666);
    AI_SHOOTAT(NONE_6339_BODYGUARD, BAU_6287_GONZALO);
    AI_FUNCTION(NONE_6339_BODYGUARD, 0xf730);
}
