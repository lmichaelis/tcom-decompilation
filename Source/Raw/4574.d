...
func void Q306_SECONDROUND_START() {
    ...
    if ((Q305_JAVAD_WENTTONEWHOME) == (1)) {
        ...
        TELEPORTNPCTOWP(0xe4c6, "P17_HAVEN_ARENA_OPPONENT_01");
        AI_SETWALKMODE(NONE_6331_JAVAD, NPC_WALK);
        AI_SETWALKMODE(HERO, NPC_WALK);
        AI_WAIT(HERO, 0x3ff33333);
        AI_WAIT(NONE_6331_JAVAD, 0x40000000);
        ...
        Q306_SECONDROUND_WAIT();
        AI_FUNCTION(NONE_6331_JAVAD, 0x1696b);
    };
    NPC_CLEARAIQUEUE(PIR_1330_ALVAREZ);
    TELEPORTNPCTOWP(0xe5cc, "P17_HAVEN_ARENA_OPPONENT_01");
    AI_SETWALKMODE(PIR_1330_ALVAREZ, NPC_WALK);
    AI_SETWALKMODE(HERO, NPC_WALK);
    AI_WAIT(HERO, 0x3ff33333);
    AI_WAIT(PIR_1330_ALVAREZ, 0x40000000);
    Q306_SECONDROUND_WAIT();
    AI_GOTOWP(HERO, "P17_HAVEN_ARENA_PLAYER_02");
    ...
    Q306_SECONDROUND_WAIT();
    AI_FUNCTION(PIR_1330_ALVAREZ, 0x1696b);
}
