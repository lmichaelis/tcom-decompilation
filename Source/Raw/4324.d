var int GARNEK_NERVE = 0;
var int GARNEK_NERVE_COUNT = 0;
const int NERVESEC = 35;
var int GARNEK_NERVEREALIZED = 0;
var int GARNEK_HEROEXP = 0;
var int GARNEK_HEROLEVEL = 0;
var int GARNEK_DAY = 0;
...
func void DIA_GARNEK_FIRSTEXIT_INFO() {
    ...
    INFO_CLEARCHOICES(0x15eee);
    INFO_ADDCHOICE(0x15eee, "Leave me alone!", 0x15ef1);
    INFO_ADDCHOICE(0x15eee, "I could use a companion.", 0x15ef2);
}
...
func int DIA_GARNEK_SHUTTHEFUCKUP_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x15ef3)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_GARNEK_SHUTTHEFUCKUP_INFO() {
    ...
    INFO_ADDCHOICE(0x15ef6, "Just leave me alone!", 0x15ef9);
    INFO_ADDCHOICE(0x15ef6, "More like full of shit...", 0x15efa);
}
...
func int DIA_GARNEK_ANOTHERPLACENERVE_CONDITION() {
    if (((((NPC_GETDISTTOWP(SELF, "PART8_MONASTERY_PLACE_08")) <= (0x46b4)) || ((NPC_GETDISTTOWP(SELF, "WOLFSDEN_CITADEL_THRONE")) <= (0x46b4))) || ((NPC_GETDISTTOWP(SELF, "PART5_VOLFZACKE_ULRYK")) <= (0x46b4))) || ((NPC_GETDISTTOWP(SELF, "P17_GHOST_ENCOUNTER_WAIT")) <= (0x46b4))) {
        if ((GARNEK_NERVEREALIZED) == (TRUE)) {
            return 1;
        };
    };
...
func int DIA_GARNEK_DIEYOUTRAITOR_CONDITION() {
    if ((((NPC_GETDISTTOWP(SELF, "PARTM1_PATH_29")) <= (0x46b4)) || ((NPC_GETDISTTOWP(SELF, "PARTM2_CONNECTION_PART3")) <= (0x7d0))) || ((NPC_GETDISTTOWP(SELF, "PARTM4_CONNECTION_PART2")) <= (0x7d0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_GARNEK_SILENCE_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x15ef3)) && (NPC_ISINSTATE(SELF, 0xf09f))) {
        return 1;
    };
    return 0 /* !broken stack! */;
}
