func void EVENTSMANAGER_QM302() {
    if ((LOG_GETSTATUS(MIS_QM302)) == (LOG_RUNNING)) {
        if ((QM302_RENEGADESEVENT) == (1)) {
            ...
            if (((NPC_GETDISTTONPC(HERO, MIL_11272_LEADER)) <= (700)) && ((NPC_ISINSTATE(SLD_1018_DOCAN, 0xf09f)) == (FALSE))) {
...
var int EVENTSMANAGER_QM302.QM302_FAILEDQUEST = 0;
