func void Q201_SPAWNARAXOSFASTTRAVELGUY() {
    ...
    FF_APPLYONCEEXTGT(0xf203, 0, -(1));
    WLD_INSERTNPC(0xe032, "PART2_Q201_FASTTRAVEL_01");
}
...
var int Q201_SPAWNARAXOSFASTTRAVELGUY_APPLY.Q201_SPAWNARAXOSFASTTRAVELGUY_COUNT = 0;
instance Q201_SPAWNARAXOSFASTTRAVELGUY_APPLY.MOVER1(ZCMOVER)
instance Q201_SPAWNARAXOSFASTTRAVELGUY_APPLY.MOVER2(ZCMOVER)
var int Q201_SPAWNARAXOSFASTTRAVELGUY_APPLY.MOVPTR1 = 0;
var int Q201_SPAWNARAXOSFASTTRAVELGUY_APPLY.MOVPTR2 = 0;
...
var int Q201_SPAWNARAXOSFASTTRAVELGUY_VILLAGE_APPLY.Q201_SPAWNARAXOSFASTTRAVELGUY_VILLAGE_COUNT = 0;
instance Q201_SPAWNARAXOSFASTTRAVELGUY_VILLAGE_APPLY.MOVER1(ZCMOVER)
instance Q201_SPAWNARAXOSFASTTRAVELGUY_VILLAGE_APPLY.MOVER2(ZCMOVER)
instance Q201_SPAWNARAXOSFASTTRAVELGUY_VILLAGE_APPLY.MOVER3(ZCMOVER)
var int Q201_SPAWNARAXOSFASTTRAVELGUY_VILLAGE_APPLY.MOVPTR1 = 0;
var int Q201_SPAWNARAXOSFASTTRAVELGUY_VILLAGE_APPLY.MOVPTR2 = 0;
var int Q201_SPAWNARAXOSFASTTRAVELGUY_VILLAGE_APPLY.MOVPTR3 = 0;
...
func void Q201_OPENSEWERS_APPLY() {
    if ((Q201_OPENSEWERS_COUNT) == (0)) {
        ...
        if ((LOG_GETSTATUS(MIS_Q201)) == (LOG_RUNNING)) {
            ...
            WLD_INSERTNPC(0xc3ea, "PART2_SEWERS_01");
        };
...
var int Q201_OPENSEWERS_APPLY.Q201_OPENSEWERS_COUNT = 0;
instance Q201_OPENSEWERS_APPLY.MOVER1(ZCMOVER)
var int Q201_OPENSEWERS_APPLY.MOVPTR1 = 0;
