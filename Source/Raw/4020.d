...
func void DIA_MILITIA_QM303_HELP_INFO() {
    ...
    INFO_CLEARCHOICES(0x131de);
    INFO_ADDCHOICE(0x131de, "Unfortunately, no.", 0x131e7);
    if (C_GOTINGRENDIENTS_ANYHEALTHPOTION(HERO)) {
        INFO_ADDCHOICE(0x131de, "Yes, here.", 0x131e4);
    };
}
...
func int DIA_MILITIA_QM303_GIVEPOTION_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_QM303)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x131de))) && ((QM303_GIVEMILITIAPOTION) == (FALSE))) && (C_GOTINGRENDIENTS_ANYHEALTHPOTION(HERO))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
var int MILITIA_QM303_FASTTRAVEL = 0;
func int DIA_MILITIA_QM303_BACK_CONDITION() {
    if (((((QM303_ALLTASKDONE) == (TRUE)) && ((MILITIA_QM303_FASTTRAVEL) == (FALSE))) && ((LOG_GETSTATUS(MIS_QM303)) == (LOG_RUNNING))) && (NPC_KNOWSINFO(OTHER, 0x131de))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_MILITIA_QM303_AMBIENT_CONDITION() {
    if (((NPC_ISINSTATE(SELF, 0xf09f)) && ((MILITIA_QM303_FASTTRAVEL) == (TRUE))) && ((QM303_GIVEMILITIAPOTION_CHECKTIME) != (2))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
