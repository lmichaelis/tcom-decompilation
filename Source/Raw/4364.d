...
func void DIA_BLAKE_Q602_HELLO_INFO() {
    ...
    INFO_CLEARCHOICES(0x161f2);
    INFO_ADDCHOICE(0x161f2, "The city is engulfed in battle, and you steal from innocent people?", 0x161f5);
}
...
func void DIA_BLAKE_Q602_HELLO_CITY() {
    ...
    INFO_CLEARCHOICES(0x161f2);
    INFO_ADDCHOICE(0x161f2, "Letting you go was a mistake.", 0x161f6);
    INFO_ADDCHOICE(0x161f2, "Do what you want. It's none of my business.", 0x161f7);
}
...
func void DIA_BLAKE_Q602_HELLO_CITY_LEAVE() {
    ...
    INFO_CLEARCHOICES(0x161f2);
    AI_STOPPROCESSINFOS(SELF);
    CREATEINVITEMS(SELF, 0x85a2, 2);
    B_GIVEINVITEMS(SELF, OTHER, 0x85a2, 2);
    CREATEINVITEMS(SELF, 0x8963, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x8963, 1);
    CREATEINVITEMS(SELF, 0x86c9, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x86c9, 1);
}
