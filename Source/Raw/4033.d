...
func int DIA_BEVIN_CANHELP_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x13398)) {
        return TRUE;
    };
...
func void DIA_BEVIN_CANHELP_INFO() {
    ...
    INFO_CLEARCHOICES(0x13388);
    INFO_ADDCHOICE(0x13388, "A bear? Are you crazy?", 0x1338b);
    INFO_ADDCHOICE(0x13388, "A jar of honey for getting rid of a bear?", 0x1338c);
    INFO_ADDCHOICE(0x13388, "A bear is no problem for me.", 0x1338d);
}
...
func void DIA_BEVIN_SQ114_REALENDING() {
    CREATEINVITEMS(SELF, 0x8e2d, 1);
    if ((SQ114_BETTERREWARD) == (TRUE)) {
        CREATEINVITEMS(SELF, 0x84bc, 5);
        B_GIVEINVITEMS(SELF, OTHER, 0x84bc, 5);
    };
    if ((SQ114_ENDING) == (2)) {
    };
    B_GIVEINVITEMS(SELF, OTHER, 0x8e2d, 1);
    CREATEINVITEMS(SELF, 0x84bc, 5);
    if ((SQ114_ENDING) == (1)) {
...
func int DIA_BEVIN_SQ114_DEADBEAR_CONDITION() {
    if ((LOG_GETSTATUS(MIS_SQ114)) == (LOG_RUNNING)) {
        if (((((NPC_HASITEMS(HERO, 0x89fe)) >= (1)) || ((NPC_HASITEMS(HERO, 0x89ff)) >= (1))) || ((NPC_HASITEMS(HERO, 0x8a00)) >= (1))) || ((SQ114_BEARISDEAD) == (TRUE))) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
...
func void DIA_BEVIN_SQ114_DEADBEAR_INFO() {
    ...
    INFO_CLEARCHOICES(0x1338f);
    INFO_ADDCHOICE(0x1338f, DIALOG_BACK, 0x13392);
    if ((SQ114_BEARISDEAD) == (TRUE)) {
        INFO_ADDCHOICE(0x1338f, "You can walk to the grove yourself and see his carcass.", 0x13393);
    };
    if ((((NPC_HASITEMS(HERO, 0x89fe)) >= (1)) || ((NPC_HASITEMS(HERO, 0x89ff)) >= (1))) || ((NPC_HASITEMS(HERO, 0x8a00)) >= (1))) {
        INFO_ADDCHOICE(0x1338f, "(Show the skin of another bear)", 0x13394);
    };
    if ((NPC_HASITEMS(HERO, 0x8a01)) >= (1)) {
        INFO_ADDCHOICE(0x1338f, "(Show the skin of another bear)", 0x13394);
    };
}
...
func void DIA_BEVIN_SQ114_BEARISDEAD_FUR() {
    if ((NPC_HASITEMS(HERO, 0x8a01)) >= (1)) {
        NPC_REMOVEINVITEM(SELF, 0x8a01);
        SQ114_ENDING = 4;
    };
    if ((NPC_HASITEMS(HERO, 0x89fe)) >= (1)) {
    };
    if ((NPC_HASITEMS(HERO, 0x89ff)) >= (1)) {
    };
    if ((NPC_HASITEMS(HERO, 0x8a00)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 0x8a00, 1);
        NPC_REMOVEINVITEM(SELF, 0x8a00);
    };
    if ((SQ114_BEARISDEAD) == (TRUE)) {
        SQ114_ENDING = 3;
    };
...
func void DIA_BEVIN_Q505_HELP_INFO() {
    ...
    CREATEINVITEMS(SELF, 0x92c7, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x92c7, 1);
...
func int DIA_BEVIN_AMBIENT_CONDITION() {
    if ((NPC_ISINSTATE(SELF, 0xf09f)) && (NPC_KNOWSINFO(OTHER, 0x13398))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_BEVIN_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x1339e);
    INFO_ADDCHOICE(0x1339e, DIALOG_BACK, 0x133a2);
    INFO_ADDCHOICE(0x1339e, DIALOG_PICKPOCKET, 0x133a1);
}
