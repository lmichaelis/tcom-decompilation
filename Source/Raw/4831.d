        ...
        if ((LOG_GETSTATUS(MIS_SQ313)) != (LOG_RUNNING)) {
            if ((NPC_GETDISTTOWP(HERO, RNG_NS01_WAYPOINT)) <= (RNG_RADIUS_BIG)) {
                if ((NS01_SPAWNED) == (FALSE)) {
                    ...
                    WLD_INSERTNPC(0xd60c, "HARBOUR_DRUNKEN_SAILOR_01");
                    WLD_INSERTNPC(0xd610, "HARBOUR_DRUNKEN_SAILOR_02");
                    WLD_INSERTNPC(0xd608, "HARBOUR_DRUNKEN_SAILOR_03");
                    WLD_INSERTNPC(0xd614, "HARBOUR_DRUNKEN_SAILOR_04");
