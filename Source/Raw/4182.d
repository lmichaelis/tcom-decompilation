...
var int GETTER_GOTLARRYPURSE = 0;
...
func void DIA_GETTER_HAVEPURSE_INFO() {
    ...
    if ((Q302_PLAYERDUELWITHGETTERSTATE) == (2)) {
        ...
        DIA_GETTER_SCARED();
        B_GIVEINVITEMS(SELF, OTHER, 0x91a1, 1);
        AI_LOGENTRY(TOPIC_SQ303, LOG_Q302_LARRYPURSE);
    };
    AI_OUTPUT(SELF, OTHER, "DIA_Getter_HavePurse_13_04");
    INFO_CLEARCHOICES(0x14a72);
    INFO_ADDCHOICE(0x14a72, "Nothing, we'll talk about it another time.", 0x14a79);
    INFO_ADDCHOICE(0x14a72, "Give me the pocket or I'll take it myself.", 0x14a7a);
}

var int STEALPURSE = 0;
...
var int Q302_PLAYERDUELWITHGETTERDAY = 0;
var int Q302_PLAYERDUELWITHGETTERSTATE = 0;
...
func void DIA_GETTER_HELLO_INFO() {
    ...
    INFO_CLEARCHOICES(0x14a7d);
    INFO_ADDCHOICE(0x14a7d, "What do you need gold for?", 0x14a82);
    INFO_ADDCHOICE(0x14a7d, "Sorry, you're not getting anything.", 0x14a81);
    INFO_ADDCHOICE(0x14a7d, "Sure, why not. Cheers. (Give 20 GP)", 0x14a80);
}

func void DIA_GETTER_HELLO_PAY() {
    INFO_CLEARCHOICES(0x14a7d);
    AI_OUTPUT(OTHER, SELF, "DIA_Getter_Hello_Pay_15_01");
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (GETTER_WANTSGOLD)) {
        B_GIVEINVITEMS(OTHER, SELF, 0x859b, GETTER_WANTSGOLD);
...
func void DIA_GETTER_WHYYOUWANTGOLD() {
    ...
    INFO_CLEARCHOICES(0x14a7d);
    INFO_ADDCHOICE(0x14a7d, "Sorry, you won't be drinking at my expense.", 0x14a83);
    INFO_ADDCHOICE(0x14a7d, "Eh, okay, take it.", 0x14a84);
}
...
func void DIA_GETTER_NEXTDAY_INFO() {
    ...
    INFO_CLEARCHOICES(0x14a88);
    INFO_ADDCHOICE(0x14a88, "No, it's over.", 0x14a8c);
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (GETTER_WANTSGOLD)) {
        INFO_ADDCHOICE(0x14a88, "Yes...", 0x14a8b);
    };
}
...
func void DIA_GETTER_GIVEMEGOLD_INFO() {
    ...
    DIA_GETTER_SCARED();
    CREATEINVITEMS(SELF, 0x859b, GETTER_WANTSGOLD);
    B_GIVEINVITEMS(SELF, OTHER, 0x859b, GETTER_WANTSGOLD);
    AI_STOPPROCESSINFOS(SELF);
}
...
func int DIA_GETTER_SQ406_LETSGO_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ406)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x14a97))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_GETTER_SQ406_POTION_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ406)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x14a9a))) && ((NPC_GETDISTTOWP(SELF, "PART17_PATH_19")) <= (700))) {
...
func void DIA_GETTER_SQ406_POTION_INFO() {
    ...
    CREATEINVITEMS(OTHER, 0x8cfc, 1);
    B_USEITEM(OTHER, 0x8cfc);
    AI_OUTPUT(OTHER, SELF, "DIA_Getter_SQ406_Potion_15_03");
    AI_OUTPUT(SELF, OTHER, "DIA_Getter_SQ406_Potion_03_04");
    INFO_CLEARCHOICES(0x14a9d);
    if ((NPC_HASITEMS(OTHER, 0x91f7)) >= (1)) {
        INFO_ADDCHOICE(0x14a9d, "(Give strong transformation potion)", 0x14aa5);
    };
    if ((NPC_HASITEMS(OTHER, 0x91f6)) >= (1)) {
        INFO_ADDCHOICE(0x14a9d, "(Give transformation potion)", 0x14aa4);
    };
    if ((NPC_HASITEMS(OTHER, 0x91f5)) >= (1)) {
        INFO_ADDCHOICE(0x14a9d, "(Give weak transformation potion)", 0x14aa3);
    };
}
...
func void GETTER_SQ406_REMOVEHEAD() {
    ...
    if ((NPC_HASITEMS(PIR_1313_GETTER, 0x8a46)) >= (1)) {
        NPC_REMOVEINVITEMS(PIR_1313_GETTER, 0x8a46, 1);
    };
...
func void DIA_GETTER_SQ406_POTION_TRANSFORML() {
    ...
    INFO_CLEARCHOICES(0x14a9d);
    INFO_ADDCHOICE(0x14a9d, "Enjoy your beer!", 0x14aaa);
    INFO_ADDCHOICE(0x14a9d, "If I were you, I would hold off on this for a while.", 0x14aa9);
}
...
func void DIA_GETTER_SQ406_POTION_TRANSFORMH() {
    ...
    AI_FUNCTION(SELF, 0x14aa2);
    AI_PLAYANI(SELF, "T_STOMACHHURT_REMOVE");
    AI_FUNCTION(SELF, 0x14aa7);
...
func int DIA_GETTER_SQ406_MONSTER_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ406)) == (LOG_RUNNING)) && ((SQ406_GETTER_POTION) == (3))) && ((NPC_GETDISTTOWP(SELF, "PART17_CAVE_CAMPFIRE_01")) <= (0x4b0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_GETTER_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x14ab0);
    INFO_ADDCHOICE(0x14ab0, DIALOG_BACK, 0x14ab4);
    INFO_ADDCHOICE(0x14ab0, DIALOG_PICKPOCKET, 0x14ab3);
}

func void DIA_GETTER_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (1)) {
        B_PICKPOCKET_AMBIENT_TIER_1();
        if ((((LOG_GETSTATUS(MIS_SQ303)) == (LOG_RUNNING)) && ((NPC_HASITEMS(OTHER, 0x91a1)) == (0))) && ((GETTER_GOTLARRYPURSE) == (FALSE))) {
            GETTER_GOTLARRYPURSE = TRUE;
            B_GIVEINVITEMS(SELF, OTHER, 0x91a1, 1);
