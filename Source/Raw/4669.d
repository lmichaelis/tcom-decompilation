func void EVENTSMANAGER_KQ403() {
    ...
    if ((KQ403_GOTBONES) == (1)) {
        if ((NPC_HASITEMS(HERO, 0x8453)) >= (3)) {
            KQ403_GOTBONES = 2;
            B_LOGENTRY(TOPIC_KQ403, LOG_KQ403_BONES);
        };
    };
    if ((KQ403_GOTEVERYTHING) == (FALSE)) {
        if (NPC_KNOWSINFO(HERO, 0x112e9)) {
            if ((((NPC_HASITEMS(HERO, 0x8453)) >= (3)) && ((NPC_HASITEMS(HERO, 0x91d0)) >= (1))) && ((NPC_HASITEMS(HERO, 0x9a70)) >= (1))) {
