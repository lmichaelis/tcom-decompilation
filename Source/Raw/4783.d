var int SQ301_BRUNONEARMINE = 0;
var int SQ301_ARAXOSNEARMINE = 0;
var int SQ301_WORKER01NEARMINE = 0;
var int SQ301_WORKER02NEARMINE = 0;
var int SQ301_BRUNOISDEAD = 0;
    ...
    if ((LOG_GETSTATUS(MIS_SQ301)) == (LOG_RUNNING)) {
        if ((SQ301_BRUNOISDEAD) == (FALSE)) {
            if (((SQ301_ROCKSREMOVED) == (FALSE)) && (NPC_ISDEAD(VLK_6355_BRUNO))) {
                ...
                B_IMMEDIATEATTACKPLAYER(SLD_6356_ARAXOS, 0x71b);
                B_IMMEDIATEATTACKPLAYER(VLK_6357_NIVEL, 0x71b);
                B_IMMEDIATEATTACKPLAYER(VLK_6358_MIROH, 0x71b);
            };
        };
        if ((SQ301_ROCKSREMOVED) == (FALSE)) {
            if ((SQ301_ARAXOSNEARMINE) == (FALSE)) {
                if (((NPC_GETDISTTOWP(SLD_6356_ARAXOS, "PART3_PATH_133")) <= (750)) && ((NPC_ISINSTATE(SLD_6356_ARAXOS, 0xf09f)) == (FALSE))) {
            ...
            if ((SQ301_WORKER01NEARMINE) == (FALSE)) {
                if (((NPC_GETDISTTOWP(VLK_6357_NIVEL, "PART3_PATH_133")) <= (750)) && ((NPC_ISINSTATE(VLK_6357_NIVEL, 0xf09f)) == (FALSE))) {
            ...
            if ((SQ301_WORKER02NEARMINE) == (FALSE)) {
                if (((NPC_GETDISTTOWP(VLK_6358_MIROH, "PART3_PATH_133")) <= (750)) && ((NPC_ISINSTATE(VLK_6358_MIROH, 0xf09f)) == (FALSE))) {
        ...
        if ((SQ301_ARENAFIGHTHERO) == (1)) {
            if ((NPC_ISINSTATE(VLK_6355_BRUNO, 0xf0a3)) && (NPC_ISINSTATE(SLD_6356_ARAXOS, 0xf0a3))) {
                HERO.AIVAR[95] = FALSE;
                HERO.AIVAR[94] = FALSE;
            ...
            } else if (NPC_ISINSTATE(HERO, 0xf0a3)) {
    ...
    if ((LOG_GETSTATUS(MIS_SQ301)) == (LOG_SUCCESS)) {
        if ((SQ301_SPAWNNEWMONSTERS) == (1)) {
            if ((SQ301_SPAWNNEWMONSTERS_DAY) <= ((WLD_GETDAY()) - (1))) {
                if ((((NPC_GETDISTTOWP(HERO, "PART3_MOB_73")) >= (0x1388)) && ((NPC_GETDISTTOWP(HERO, "PART3_MOB_15")) >= (0x1388))) && ((NPC_GETDISTTOWP(HERO, "PART3_MOB_85")) >= (0x1388))) {
                    SQ301_SPAWNNEWMONSTERS = 2;
                    WLD_INSERTNPC(0xc3fb, "PART3_MOB_73");
                    WLD_INSERTNPC(0xc3fb, "PART3_MOB_75");
                    WLD_INSERTNPC(0xc3fb, "PART3_MOB_74");
                    WLD_INSERTNPC(0xc3dc, "FP_ROAM_PART3_80");
                    WLD_INSERTNPC(0xc3dc, "FP_ROAM_PART3_117");
                    WLD_INSERTNPC(0xc3dc, "FP_ROAM_PART3_88");
                    WLD_INSERTNPC(0xc3dc, "FP_ROAM_PART3_86");
                    WLD_INSERTNPC(0xc49b, "FP_ROAM_PART3_110");
                    WLD_INSERTNPC(0xc49b, "FP_ROAM_PART3_113");
                    WLD_INSERTNPC(0xc406, "FP_ROAM_PART3_125");
                    WLD_INSERTNPC(0xc406, "FP_ROAM_PART3_124");
                    WLD_INSERTNPC(0xc406, "FP_ROAM_PART3_122");
                };
            };
        };
    };
