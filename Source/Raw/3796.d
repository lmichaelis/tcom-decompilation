...
func void DIA_DIMA_EXIT_INFO() {
    if (((SQ207_DIMATOLEXX) == (1)) && ((SQ207_FAILED) == (FALSE))) {
        ...
        WLD_INSERTITEM(0x9024, "FP_SQ207_DIMAKEY");
        AI_STOPPROCESSINFOS(SELF);
        if ((NPC_GETDISTTOWP(HERO, RESERVED_CONST_STRING_09)) >= (0xdac)) {
            AI_FUNCTION(SELF, 0xfb12);
        } else {
            SQ207_DIMATOLEXX = 2;
        } else {
            /* set_instance(0) */;
...
func void DIA_DIMA_WHATUTRADE_INFO() {
    ...
    INFO_CLEARCHOICES(0x1169e);
    INFO_ADDCHOICE(0x1169e, "Mages are happy to buy goods from you?", 0x116a1);
    INFO_ADDCHOICE(0x1169e, "I see business is booming.", 0x116a2);
}
...
func int DIA_DIMA_TRADE_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x1169e)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DIMA_FAQ001_START_INFO() {
    ...
    INFO_CLEARCHOICES(0x116ac);
    INFO_ADDCHOICE(0x116ac, "No, thank you.", 0x116b1);
    INFO_ADDCHOICE(0x116ac, "I'd love to.", 0x116b0);
}
...
func int DIA_DIMA_FAQ001_CHANGEDMIND_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x116ac)) && ((DIMAQUESTREFUSED) == (TRUE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DIMA_FAQ001_FINISH_RESULT() {
    ...
    CREATEINVITEMS(SELF, 0x859b, FAQ001_REWARD);
    ...
    B_GIVEINVITEMS(SELF, OTHER, 0x859b, FAQ001_REWARD);
...
func int DIA_DIMA_SQ207_COMEBACK_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_SQ207)) == (LOG_RUNNING)) && ((SQ207_DIMATOLEXX) == (8))) && ((SQ207_FAILED) == (FALSE))) && (NPC_ISINSTATE(SELF, 0xf09f))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}

var int DIMA_SQ207_COMEBACK_ARAXOS = 0;
var int DIMA_SQ207_COMEBACK_WOMAN = 0;
func void DIA_DIMA_SQ207_COMEBACK_ALL() {
    ...
    INFO_CLEARCHOICES(0x116bc);
    AI_STOPPROCESSINFOS(SELF);
    NPC_EXCHANGEROUTINE(SELF, START);
    CREATEINVITEMS(SELF, 0x859b, SQ207_DIMAREWARD);
    B_GIVEINVITEMS(SELF, OTHER, 0x859b, SQ207_DIMAREWARD);
...
func void DIA_DIMA_SQ207_COMEBACK_CHOICES() {
    ...
    if (((DIMA_SQ207_COMEBACK_ARAXOS) == (FALSE)) || ((DIMA_SQ207_COMEBACK_WOMAN) == (FALSE))) {
        if ((DIMA_SQ207_COMEBACK_ARAXOS) == (FALSE)) {
            INFO_ADDCHOICE(0x116bc, "There was a mercenary here...", 0x116c4);
        };
        if ((DIMA_SQ207_COMEBACK_WOMAN) == (FALSE)) {
            INFO_ADDCHOICE(0x116bc, "A woman, she came to pick up the hammers and the figurine.", 0x116c5);
        };
    };
...
func int DIA_DIMA_SQ309_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ309)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x1280d))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DIMA_SQ309_INFO() {
    ...
    INFO_CLEARCHOICES(0x116c6);
    INFO_ADDCHOICE(0x116c6, "Just tell me how much you want for this information.", 0x116ca);
    if (((LOG_GETSTATUS(MIS_FAQ001)) == (LOG_SUCCESS)) && ((OTHER.GUILD) == (GIL_SLD))) {
        INFO_ADDCHOICE(0x116c6, "I'm thinking about investing in this business myself.", 0x116cb);
    };
    if ((NPC_HASEQUIPPEDARMOR(OTHER)) == (TRUE)) {
        if (NPC_HASGUILDARMOREQUIPPED(OTHER, GIL_MIL)) {
            INFO_ADDCHOICE(0x116c6, "I'm investigating this case.", 0x116cc);
        };
    };
    if ((SQ309_INFORMATIONABOUTSUES) == (TRUE)) {
        INFO_ADDCHOICE(0x116c6, "I thought figure making was done by artisans.", 0x116cd);
    };
}
...
func void DIA_DIMA_SQ309_INFORMATION() {
    ...
    INFO_CLEARCHOICES(0x116c6);
    INFO_ADDCHOICE(0x116c6, "I don't carry that much gold.", 0x116cf);
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (SQ309_DIMAINFORMATION_V1)) {
        INFO_ADDCHOICE(0x116c6, DIALOG_GIVE100G, 0x116ce);
    };
}
...
func void DIA_DIMA_SQ309_INVESTIGATION() {
    ...
    INFO_ADDCHOICE(0x116c6, "I don't carry that much gold.", 0x116cf);
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (SQ309_DIMAINFORMATION_V2)) {
        INFO_ADDCHOICE(0x116c6, DIALOG_GIVE75G, 0x116ce);
    };
}
...
func void DIA_DIMA_SQ309_INFORMATION_GOLD() {
    ...
    if ((SQ309_DIMAPRICE100GOLD) == (TRUE)) {
        B_GIVEINVITEMS(OTHER, SELF, 0x859b, SQ309_DIMAINFORMATION_V1);
    };
...
func int DIA_DIMA_GI75GOLD_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ309)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x116c6))) && ((SQ309_DIMAWANTSGOLDFORINFORMATION) == (TRUE))) {
        if ((SQ309_DIMAPRICE75GOLD) == (TRUE)) {
            if ((NPC_HASITEMS(OTHER, 0x859b)) >= (SQ309_DIMAINFORMATION_V2)) {
                return TRUE;
            };
...
var int DIMA_Q505_BUYSCROLLS = 0;
...
func int DIA_DIMA_Q505_PAY_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_Q505)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x116d9))) && ((DIMA_Q505_BUYSCROLLS) == (TRUE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DIMA_Q505_PAY_INFO() {
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (Q505_HELGAPRICE)) {
        NPC_REMOVEINVITEMS(SELF, 0x859b, Q505_DIMAPRICE);
        DIMA_Q505_BUYSCROLLS = 0;
        B_GIVEINVITEMS(OTHER, SELF, 0x859b, Q505_DIMAPRICE);
        AI_OUTPUT(OTHER, SELF, "DIA_Dima_Q505_Pay_15_01");
        AI_STARTFACEANI(SELF, S_SMILE, 1, -(1));
        AI_OUTPUT(SELF, OTHER, "DIA_Dima_Q505_Pay_03_02");
        AI_RESETFACEANI(SELF);
        CREATEINVITEMS(SELF, 0x92dc, 1);
    };
...
func void DIA_DIMA_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x116e0);
    INFO_ADDCHOICE(0x116e0, DIALOG_BACK, 0x116e4);
    INFO_ADDCHOICE(0x116e0, DIALOG_PICKPOCKET, 0x116e3);
}

func void DIA_DIMA_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (3)) {
        CREATEINVITEMS(SELF, 0x9527, 1);
        B_GIVEINVITEMS(SELF, OTHER, 0x9527, 1);
...
var int DIMANEEDORE_ENOUGH = 0;
var int DIMANEEDORE_COUNT = 0;
...
var int DIMA_OREINSTANCE = 0;
var int DIMA_OREVALUE = 0;
func void DIA_DIMA_SELLORE_CHOICES() {
    DIMA_OREINSTANCE = 0x8c95;
    DIMA_OREVALUE = VALUE_ITCR_MAGICORE_POWDERED;
    INFO_CLEARCHOICES(0x116e5);
    MAX = NPC_HASITEMS(HERO, DIMA_OREINSTANCE);
    ALL_STRING = CS4(DIALOG_ALL, " (", I2S(MAX), ")");
    INFO_ADDCHOICE(0x116e5, ALL_STRING, 0x116f0);
    INFO_ADDCHOICE(0x116e5, CHOICE_NUMBER_5, 0x116f2);
    INFO_ADDCHOICE(0x116e5, CHOICE_NUMBER_1, 0x116f4);
    INFO_ADDCHOICE(0x116e5, DIALOG_BACK, 0x116ef);
}

var int DIA_DIMA_SELLORE_CHOICES.MAX = 0;
var string DIA_DIMA_SELLORE_CHOICES.ALL_STRING = "";
...
func void DIA_DIMA_SELLORE_ALL() {
    if ((NPC_HASITEMS(OTHER, DIMA_OREINSTANCE)) >= (1)) {
        ...
        CREATEINVITEMS(SELF, 0x859b, (MAX) * (DIMA_OREVALUE));
        B_GIVEINVITEMS(SELF, OTHER, 0x859b, (MAX) * (DIMA_OREVALUE));
        AI_STARTFACEANI(SELF, S_SMILE, 1, -(1));
        B_SAY(SELF, OTHER, "$REWARD_CALM");
        AI_RESETFACEANI(SELF);
        if ((DIMA_OREINSTANCE) == (0x8c95)) {
            DIMANEEDORE_COUNT = (DIMANEEDORE_COUNT) + (MAX);
            if ((DIMANEEDORE_COUNT) >= (100)) {
                DIMANEEDORE_ENOUGH = TRUE;
                if ((DIMANEEDORE_COUNT) > (100)) {
                    AI_FUNCTION(SELF, 0x116f5);
                };
            };
        };
        if (((DIMA_OREINSTANCE) == (0x8c95)) && ((DIMANEEDORE_ENOUGH) == (FALSE))) {
            DIA_DIMA_SELLORE_CHOICES();
        } else {
...
var int DIA_DIMA_SELLORE_ALL.MAX = 0;
func void DIA_DIMA_SELLORE_5() {
    if ((NPC_HASITEMS(OTHER, DIMA_OREINSTANCE)) >= (5)) {
        ...
        B_SAY(SELF, OTHER, "$REWARD_CALM");
        AI_RESETFACEANI(SELF);
        CREATEINVITEMS(SELF, 0x859b, (5) * (DIMA_OREVALUE));
        if ((DIMA_OREINSTANCE) == (0x8c95)) {
...
var int DIA_DIMA_SELLORE_5.MAX = 0;
func void DIA_DIMA_SELLORE_1() {
    if ((NPC_HASITEMS(OTHER, DIMA_OREINSTANCE)) >= (1)) {
        ...
        B_SAY(SELF, OTHER, "$REWARD_CALM");
        AI_RESETFACEANI(SELF);
        CREATEINVITEMS(SELF, 0x859b, DIMA_OREVALUE);
        if ((DIMA_OREINSTANCE) == (0x8c95)) {
...
func void DIMA_GIVEBACKSTUFF_ORE() {
    NPC_REMOVEINVITEMS(SLD_5001_DIMA, 0x859b, (VALUE_ITCR_MAGICORE_POWDERED) * ((DIMANEEDORE_COUNT) - (100)));
    PRINTSCREENS(PRINT_DIMAORE, -(1), -(1), FONT_SCREENSMALL, 4);
    B_GIVEINVITEMS(HERO, SLD_5001_DIMA, 0x859b, (VALUE_ITCR_MAGICORE_POWDERED) * ((DIMANEEDORE_COUNT) - (100)));
}
