...
var int TOLLEK_GOLDNUGGET_PRICE = 0;
func void DIA_TOLLEK_NICEPLACE_INFO() {
    ...
    INFO_CLEARCHOICES(0x133fc);
    INFO_ADDCHOICE(0x133fc, "No, thanks. I'll be fine on my own.", 0x13401);
    INFO_ADDCHOICE(0x133fc, "Here, I would love to learn a little more about this craft.", 0x13400);
}

func void DIA_TOLLEK_NICEPLACE_SURE() {
    SQ119_TOLLEKRESULT = 1;
    AI_OUTPUT(OTHER, SELF, "DIA_Tollek_NicePlace_Sure_15_01");
    if ((NPC_HASITEMS(OTHER, 0x837c)) >= (TOLLEK_GOLDNUGGET_PRICE)) {
...
func void DIA_TOLLEK_NICEPLACE_NO() {
    ...
    INFO_ADDCHOICE(0x133fc, "I already told you something, I'm not interested.", 0x13402);
}
...
func void DIA_TOLLEK_NICEPLACE_NO_GOAWAY() {
    ...
    INFO_ADDCHOICE(0x133fc, "Leave me alone or you'll get hurt.", 0x13403);
}
...
func int DIA_TOLLEK_GIVEBACK_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x133fc)) && ((SQ119_TOLLEKRESULT) == (1))) && ((QA306_GOTOARAXOSMINE) == (0))) {
        if ((Q504_TAKEWORKERS) != (2)) {
            return TRUE;
        };
    };
...
func void DIA_TOLLEK_GIVEBACK_INFO() {
    ...
    INFO_CLEARCHOICES(0x13404);
    INFO_ADDCHOICE(0x13404, "I paid you, and you're still stealing from me?", 0x13409);
    INFO_ADDCHOICE(0x13404, "You leave me no choice, I'll have to drag you away by force.", 0x13408);
}
...
var int TOLLEK_QA306_FIRSTWARN_FIRSTDIALOGUE = 0;
var int TOLLEK_QA306_WANTSTOWORK = 0;
func void DIA_TOLLEK_QA306_FIRSTWARN_INFO() {
    AI_STARTFACEANI(SELF, S_WHAT, 1, -(1));
    if (NPC_KNOWSINFO(OTHER, 0x133fc)) {
    ...
    if ((TOLLEK_QA306_FIRSTWARN_FIRSTDIALOGUE) == (FALSE)) {
        ...
        INFO_CLEARCHOICES(0x1340a);
        if ((HERO_HACKCHANCE) >= (50)) {
            INFO_ADDCHOICE(0x1340a, "I've been training a lot lately.", 0x13411);
        } else {
            INFO_ADDCHOICE(0x1340a, "I can swing a pickaxe if that's what you want to know.", 0x13412);
        };
    };
...
func void DIA_TOLLEK_QA306_FIRSTWARN_TRAIN() {
    ...
    INFO_CLEARCHOICES(0x1340a);
    INFO_ADDCHOICE(0x1340a, "I'm not going into any business with you.", 0x13414);
    INFO_ADDCHOICE(0x1340a, "Sure, let's get to work.", 0x13413);
    INFO_CLEARCHOICES(0x1341b);
    INFO_ADDCHOICE(0x1341b, "I'm not going into any business with you.", 0x13414);
    INFO_ADDCHOICE(0x1341b, "Sure, let's get to work.", 0x13413);
}
...
func int DIA_TOLLEK_QA306_TELLABOUT_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_QA306)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x1341e))) && ((QA306_GOTOARAXOSMINE) == (2))) {
        if ((NPC_KNOWSINFO(HERO, 0x13625)) == (FALSE)) {
            return TRUE;
        };
    };
...
func int DIA_TOLLEK_Q504_FEEL_CONDITION() {
    if ((((NPC_GETDISTTOWP(SELF, "PART5_WORKERSCAMP_SMALLTALK_02")) <= (0x7d0)) && ((Q504_TAKEWORKERS) == (2))) && ((Q504_LOAFSVOLFZACKE) == (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_TOLLEK_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x13427);
    INFO_ADDCHOICE(0x13427, DIALOG_BACK, 0x1342b);
    INFO_ADDCHOICE(0x13427, DIALOG_PICKPOCKET, 0x1342a);
}
