var int KNUT_CANBUYWOODCUTTERARMOR = 0;
var int KNUT_REGULARWORK_XPCHECK = 0;
...
func int DIA_KNUT_SQ101_WOOD_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x14d0f)) && ((LOG_GETSTATUS(MIS_SQ101)) == (LOG_RUNNING))) && ((KQ407_START) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_KNUT_SQ101_WOOD_INFO() {
    ...
    INFO_CLEARCHOICES(0x14d15);
    INFO_ADDCHOICE(0x14d15, "The residents of Silbach are in urgent need of supplies.", 0x14d18);
    INFO_ADDCHOICE(0x14d15, "Maybe I'll earn that wood then?", 0x14d1b);
    INFO_ADDCHOICE(0x14d15, "Who is the ruler of this fortress?", 0x14d19);
}
...
func void DIA_KNUT_SQ101_WOOD_WORK() {
    ...
    INFO_CLEARCHOICES(0x14d15);
    INFO_ADDCHOICE(0x14d15, "Any idea where I should look for it?", 0x14d1d);
    INFO_ADDCHOICE(0x14d15, "How do I recognize him?", 0x14d1c);
    INFO_ADDCHOICE(0x14d15, "I'll try to find him.", 0x14d1e);
}
...
func int DIA_KNUT_WOODFORYOU_CONDITION() {
    ...
    if ((LOG_GETSTATUS(MIS_SQ101)) == (LOG_RUNNING)) {
        if ((((SQ101_WOODFROMSAW) == (TRUE)) && ((SQ101_GOTWOODFROMKNUT) == (FALSE))) && ((NPC_HASITEMS(OTHER, 0x90c4)) >= (5))) {
            return TRUE;
        };
    };
    if (((NPC_HASITEMS(OTHER, 0x90c4)) >= (40)) && ((KNUT_REGULARWORK) == (2))) {
        return TRUE;
    };
    if ((((((LOG_GETSTATUS(MIS_KQ404)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x14d4b))) && ((NPC_KNOWSINFO(OTHER, 0x14d4e)) == (FALSE))) && ((KQ404_UNICORNLIST_READ) == (TRUE))) && ((INEXTREMO_CANPLAYCONCERT) == (TRUE))) {
        return FALSE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_KNUT_WOODREWARD() {
    ...
    CREATEINVITEMS(SELF, 0x90c5, 1);
    B_GIVEINVITEMS(SELF, OTHER, 0x90c5, 1);
}

func void KNUT_GIVEGOLDFORWORK() {
    AI_OUTPUT(SELF, OTHER, "DIA_Knut_WoodForYou_03_08");
    CREATEINVITEMS(SELF, 0x859b, KNUT_REWARDGOLD);
    B_GIVEINVITEMS(SELF, OTHER, 0x859b, KNUT_REWARDGOLD);
}
...
func void DIA_KNUT_WOODFORYOU_GIVEWOOD() {
    B_GIVEINVITEMS(OTHER, SELF, 0x90c4, 40);
}

var int KNUT_INVITETOWOODCUTTER = 0;
func void DIA_KNUT_WOODFORYOU_ARMOR() {
    if ((KNUT_INVITETOWOODCUTTER) == (FALSE)) {
        ...
        INFO_CLEARCHOICES(0x14d1f);
        INFO_ADDCHOICE(0x14d1f, "I think I prefer the paycheck though.", 0x14d28);
        INFO_ADDCHOICE(0x14d1f, "Sounds like a reasonable offer.", 0x14d2b);
    };
...
func void DIA_KNUT_WOODFORYOU_INFO() {
    ...
    if (((SQ101_WOODFROMSAW) == (TRUE)) && ((SQ101_ICANSAWBYMYSELF) == (TRUE))) {
        B_GIVEINVITEMS(OTHER, SELF, 0x90c4, 5);
...
func int DIA_KNUT_BUYARMOR_CONDITION() {
    if (((KNUT_CANBUYWOODCUTTERARMOR) == (TRUE)) && ((NPC_HASITEMS(OTHER, 0x859b)) >= (KNUT_REWARDGOLD))) {
        return TRUE;
    };
    if (((((LOG_GETSTATUS(MIS_KQ404)) == (LOG_RUNNING)) && ((NPC_KNOWSINFO(OTHER, 0x14d4e)) == (FALSE))) && ((KQ404_UNICORNLIST_READ) == (TRUE))) && ((INEXTREMO_CANPLAYCONCERT) == (TRUE))) {
        return FALSE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_KNUT_BUYARMOR_INFO() {
    CREATEINVITEMS(SELF, 0x8afd, 1);
    B_GIVEINVITEMS(OTHER, SELF, 0x859b, KNUT_REWARDGOLD);
    AI_EQUIPARMOR(SELF, 0x8afd);
    B_GIVEINVITEMS(SELF, OTHER, 0x8afd, 1);
...
func int DIA_KNUT_SQ101_FOUNDNIRKO_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 0x1501d)) && ((LOG_GETSTATUS(MIS_SQ101)) == (LOG_RUNNING))) && ((KQ407_START) == (FALSE))) {
        if ((((SQ101_NIRKOFIGHT) == (2)) || ((SQ101_NIRKOCOMEBACKTOWORK) == (TRUE))) || ((NPC_HASITEMS(OTHER, 0x90c6)) >= (1))) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
...
func void DIA_KNUT_SQ101_FOUNDNIRKO_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 0x90c6)) >= (1)) {
        INFO_CLEARCHOICES(0x14d2f);
        INFO_ADDCHOICE(0x14d2f, "In the charcoal burners' camp.", 0x14d34);
        INFO_ADDCHOICE(0x14d2f, "He's dead (Lie).", 0x14d33);
    };
...
func void DIA_KNUT_SQ101_FOUNDNIRKO_DEAD() {
    ...
    NPC_REMOVEINVITEMS(HERO, 0x90c6, 1);
    DIA_KNUT_FOUNDNIRKO();
    B_GIVEINVITEMS(OTHER, SELF, 0x90c6, 1);
}
...
func int DIA_KNUT_WORK_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x14d12)) && ((KQ407_START) == (FALSE))) {
...
func void DIA_KNUT_WORK_INFO() {
    ...
    if (((KNUT_ANOTHERWORK_DAY) <= ((WLD_GETDAY()) - (1))) && ((KNUT_ANOTHERWORK_DAY_CHECK) == (TRUE))) {
        if ((OTHER.EXP) > ((KNUT_REGULARWORK_XPCHECK) + (200))) {
            ...
            INFO_CLEARCHOICES(0x14d35);
            INFO_ADDCHOICE(0x14d35, "All right, I'll help you.", 0x14d3c);
            INFO_ADDCHOICE(0x14d35, "What do I get in return?", 0x14d3d);
            INFO_ADDCHOICE(0x14d35, "Why don't you take care of it yourself?", 0x14d3e);
        } else {
...
func int DIA_KNUT_SQ204_FINISH_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x120e3)) && ((LOG_GETSTATUS(MIS_SQ204)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_KNUT_SQ204_FINISH_INFO() {
    ...
    CREATEINVITEMS(SELF, 0x859b, SQ204_FINISH);
    B_GIVEINVITEMS(SELF, OTHER, 0x859b, SQ204_FINISH);
}
...
func int DIA_KNUT_Q401HELP_CONDITION() {
    if (((LOG_GETSTATUS(MIS_Q401)) == (LOG_RUNNING)) && ((Q401_ESTICUTTERS) == (1))) {
        if ((Q401_FABIOANDGANGGONE) == (0)) {
            if (!(NPC_KNOWSINFO(OTHER, 0x14dbb))) {
                return TRUE;
            };
        };
    };
...
func int DIA_KNUT_KQ404_WOODCUTTERARMOR_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_KQ404)) == (LOG_RUNNING)) && ((KQ404_UNICORNLIST_READ) == (TRUE))) && ((NPC_HASITEMS(OTHER, 0x8afd)) == (0))) && ((INEXTREMO_CANPLAYCONCERT) == (TRUE))) {
...
func int DIA_KNUT_KQ404_GOTYOURWOOD_CONDITION() {
    if (((((((NPC_KNOWSINFO(OTHER, 0x14d4b)) && ((LOG_GETSTATUS(MIS_KQ404)) == (LOG_RUNNING))) && (NPC_ISINSTATE(SELF, 0xf09f))) && ((KQ404_UNICORNLIST_READ) == (TRUE))) && ((INEXTREMO_CANPLAYCONCERT) == (TRUE))) && ((NPC_HASITEMS(OTHER, 0x90c4)) >= (40))) && ((KNUT_REGULARWORK) >= (2))) {
        if ((KQ404_UNICORNLIST_GOTEVERYTHING) != (2)) {
            return TRUE;
        };
    };
...
func int DIA_KNUT_KQ406_OFFER_CONDITION() {
    if (((LOG_GETSTATUS(MIS_KQ406)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x100ee))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_KNUT_CANYOUTRAIN_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 0x14d12)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
var int KNUT_CURRENTSTRLEVEL = 0;
var int KNUT_NOMORE = 0;
...
func int DIA_KNUT_TRAIN_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 0x14d54)) && ((KNUT_NOMORE) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_KNUT_TRAIN_CHOICES() {
    ...
    INFO_CLEARCHOICES(0x14d5b);
    INFO_ADDCHOICE(0x14d5b, DIALOG_BACK, 0x14d60);
    INFO_ADDCHOICE(0x14d5b, B_BUILDLEARNSTRING2(PRINT_LEARNSTR1, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_STRENGTH, 1), KNUT_GOLDCOST), 0x14d61);
    INFO_ADDCHOICE(0x14d5b, B_BUILDLEARNSTRING2(PRINT_LEARNSTR5, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_STRENGTH, 5), (KNUT_GOLDCOST) * (5)), 0x14d62);
}

var int DIA_KNUT_TRAIN_CHOICES.KNUT_GOLDCOST = 0;
...
func void DIA_KNUT_TRAINSTR_1() {
    if (((NPC_HASITEMS(OTHER, 0x859b)) >= (KNUT_PAYMENT1)) && ((OTHER.AIVAR[81]) >= (20))) {
        if ((KNUT_CURRENTSTRLEVEL) < (OTHER.AIVAR[81])) {
            SND_PLAY(GELDBEUTEL);
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, KNUT_PAYMENT1);
            NPC_REMOVEINVITEMS(SELF, 0x859b, KNUT_PAYMENT1);
        };
        B_TEACHATTRIBUTEPOINTS(SELF, OTHER, ATR_STRENGTH, 1, 60);
        DIA_KNUT_TRAIN_CHOICES();
    };
    if ((NPC_HASITEMS(OTHER, 0x859b)) < (KNUT_PAYMENT1)) {
...
func void DIA_KNUT_TRAINSTR_5() {
    if (((NPC_HASITEMS(OTHER, 0x859b)) >= (KNUT_PAYMENT5)) && ((OTHER.AIVAR[81]) >= (20))) {
        if ((KNUT_CURRENTSTRLEVEL) < (OTHER.AIVAR[81])) {
            SND_PLAY(GELDBEUTEL);
            B_GIVEINVITEMS(OTHER, SELF, 0x859b, KNUT_PAYMENT5);
            NPC_REMOVEINVITEMS(SELF, 0x859b, KNUT_PAYMENT5);
        };
        B_TEACHATTRIBUTEPOINTS(SELF, OTHER, ATR_STRENGTH, 5, 60);
        DIA_KNUT_TRAIN_CHOICES();
    };
    if ((NPC_HASITEMS(OTHER, 0x859b)) < (KNUT_PAYMENT5)) {
...
var int KNUT_Q505_PAYFORWOOD = 0;
...
func int DIA_KNUT_Q505_PAY_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_Q505)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 0x14d63))) && ((KNUT_Q505_PAYFORWOOD) == (TRUE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_KNUT_Q505_PAY_INFO() {
    if ((NPC_HASITEMS(OTHER, 0x859b)) >= (Q505_KNUTPRICE)) {
        NPC_REMOVEINVITEMS(SELF, 0x859b, Q505_KNUTPRICE);
        KNUT_Q505_PAYFORWOOD = 0;
        B_GIVEINVITEMS(OTHER, SELF, 0x859b, Q505_KNUTPRICE);
        AI_STARTFACEANI(SELF, S_SMUG, 1, -(1));
        AI_OUTPUT(SELF, OTHER, "DIA_Knut_Q505_Pay_03_01");
        AI_RESETFACEANI(SELF);
        CREATEINVITEMS(SELF, 0x92e6, 1);
    };
...
func void DIA_KNUT_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(0x14d6a);
    INFO_ADDCHOICE(0x14d6a, DIALOG_BACK, 0x14d6e);
    INFO_ADDCHOICE(0x14d6a, DIALOG_PICKPOCKET, 0x14d6d);
}

func void DIA_KNUT_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (2)) {
        CREATEINVITEMS(SELF, 0x8c8d, 3);
        B_GIVEINVITEMS(SELF, OTHER, 0x8c8d, 3);
