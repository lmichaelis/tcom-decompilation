func void EVENTSMANAGER_Q309() {
    ...
    if ((Q309_READYFORGRAVE) == (1)) {
        if ((NPC_GETDISTTOWP(HERO, "PARTM8_FUNERAL_TRIMEGISTO")) <= (2000)) {
            Q309_READYFORGRAVE = 2;
            WLD_SENDTRIGGER("KM_GRAVE_01");
            TELEPORTNPCTOWP(51943, "PARTM8_FUNERAL_TRIMEGISTO");
            TELEPORTNPCTOWP(55456, "PARTM8_FUNERAL_GRAVEDIGGER");
            TELEPORTNPCTOWP(1819, "PARTM8_GRAVE_HERO_01");
            ...
            AI_FUNCTION(KDF_6404_TRIMEGISTO, 94086);
            ...
            AI_FUNCTION(KDF_6404_TRIMEGISTO, 94087);
            ...
            AI_FUNCTION(KDF_6404_TRIMEGISTO, 94088);
        };
    };
    if (((Q309_BOLTLOGENTRY) == (FALSE)) && ((NPC_HASITEMS(HERO, 37293)) >= (1))) {
