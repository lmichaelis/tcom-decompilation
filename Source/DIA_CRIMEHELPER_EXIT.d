...
func void DIA_CRIMEHELPER_CRIMETEST_INFO() {
    INFO_CLEARCHOICES(51238);
    INFO_ADDCHOICE(51238, "Klasztor", 51243);
    INFO_ADDCHOICE(51238, "Wilcze le¿e", 51244);
    INFO_ADDCHOICE(51238, "Miasto", 51242);
    INFO_ADDCHOICE(51238, "Wioska i farmy", 51241);
}
...
func void DIA_CRIMEHELPER_ADDCRIME_INFO() {
    INFO_CLEARCHOICES(51245);
    INFO_ADDCHOICE(51245, "Klasztor", 51251);
    INFO_ADDCHOICE(51245, "Wilcze le¿e", 51252);
    INFO_ADDCHOICE(51245, "Miasto", 51250);
    INFO_ADDCHOICE(51245, "Wioska i farmy", 51249);
}

func void DIA_CRIMEHELPER_ADDCRIME_CHOOSETYPE() {
    INFO_CLEARCHOICES(51245);
    INFO_ADDCHOICE(51245, "Owca", 51253);
    INFO_ADDCHOICE(51245, "Kradzie¿", 51254);
    INFO_ADDCHOICE(51245, "Pobicie", 51255);
    INFO_ADDCHOICE(51245, "Morderstwo", 51256);
}
...
func void DIA_CRIMEHELPER_DELETECRIME_INFO() {
    INFO_CLEARCHOICES(51257);
    INFO_ADDCHOICE(51257, "Klasztor", 51266);
    INFO_ADDCHOICE(51257, "Wilcze le¿e", 51267);
    INFO_ADDCHOICE(51257, "Miasto", 51265);
    INFO_ADDCHOICE(51257, "Wioska i farmy", 51264);
}

func void DIA_CRIMEHELPER_DELETECRIME_FARMS_CHOOSETYPE() {
    INFO_CLEARCHOICES(51257);
    INFO_ADDCHOICE(51257, "Owca", 51268);
    INFO_ADDCHOICE(51257, "Kradzie¿", 51269);
    INFO_ADDCHOICE(51257, "Pobicie", 51270);
    INFO_ADDCHOICE(51257, "Morderstwo", 51271);
}

func void DIA_CRIMEHELPER_DELETECRIME_CITY_CHOOSETYPE() {
    INFO_CLEARCHOICES(51257);
    INFO_ADDCHOICE(51257, "Owca", 51272);
    INFO_ADDCHOICE(51257, "Kradzie¿", 51273);
    INFO_ADDCHOICE(51257, "Pobicie", 51274);
    INFO_ADDCHOICE(51257, "Morderstwo", 51275);
}

func void DIA_CRIMEHELPER_DELETECRIME_MONASTERY_CHOOSETYPE() {
    INFO_CLEARCHOICES(51257);
    INFO_ADDCHOICE(51257, "Owca", 51276);
    INFO_ADDCHOICE(51257, "Kradzie¿", 51277);
    INFO_ADDCHOICE(51257, "Pobicie", 51278);
    INFO_ADDCHOICE(51257, "Morderstwo", 51279);
}

func void DIA_CRIMEHELPER_DELETECRIME_WOLFSLAIR_CHOOSETYPE() {
    INFO_CLEARCHOICES(51257);
    INFO_ADDCHOICE(51257, "Owca", 51280);
    INFO_ADDCHOICE(51257, "Kradzie¿", 51281);
    INFO_ADDCHOICE(51257, "Pobicie", 51282);
    INFO_ADDCHOICE(51257, "Morderstwo", 51283);
}
...
func void DIA_CRIMEHELPER_ABSOLUTION_INFO() {
    INFO_CLEARCHOICES(51284);
    INFO_ADDCHOICE(51284, "Wszêdzie", 51291);
    INFO_ADDCHOICE(51284, "Klasztor", 51289);
    INFO_ADDCHOICE(51284, "Wilcze le¿e", 51290);
    INFO_ADDCHOICE(51284, "Miasto", 51288);
    INFO_ADDCHOICE(51284, "Wioska i farmy", 51287);
}
