...
func int DIA_HERSHLIK_PQ104_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 73665)) && ((WHONEEDPEON) == (TRUE))) {
        return TRUE;
    };
...
func void DIA_HERSHLIK_PQ104_MORE_INFO() {
    INFO_CLEARCHOICES(73674);
    INFO_ADDCHOICE(73674, "Where should I look?", 73677);
}
...
func void DIA_HERSHLIK_PQ104_MORE_WHERE() {
    ...
    INFO_CLEARCHOICES(73674);
    INFO_ADDCHOICE(73674, "You want me to take it out of their mouths?", 73678);
    INFO_ADDCHOICE(73674, "What kind of animals are they?", 73679);
}
...
func int DIA_HERSHLIK_PQ104_SEEDS_CONDITION() {
    if ((((((NPC_KNOWSINFO(OTHER, 73668)) && ((NPC_HASITEMS(OTHER, 35306)) >= (2))) && ((NPC_HASITEMS(OTHER, 35313)) >= (2))) && ((NPC_HASITEMS(OTHER, 35309)) >= (2))) && ((NPC_HASITEMS(OTHER, 35310)) >= (2))) && ((LOG_GETSTATUS(MIS_PQ104)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_HERSHLIK_PQ104_SEEDS_INFO() {
    ...
    INFO_CLEARCHOICES(73680);
    INFO_ADDCHOICE(73680, "What's in it for me?", 73684);
    INFO_ADDCHOICE(73680, "I think I'll pass for now.", 73683);
}
...
func void DIA_HERSHLIK_PQ104_SEEDS_PRIZE() {
    ...
    INFO_ADDCHOICE(73680, "Sounds fair. Let's get on with it.", 73686);
}

var int PLANTINGWITHHERSHLIK;
func void DIA_HERSHLIK_PQ104_SEEDS_OK() {
    ...
    AI_STOPPROCESSINFOS(SELF);
    AI_FUNCTION(SELF, 73687);
}

func void HERSHLIK_PREPARELANDTOSEED() {
    FF_APPLYONCEEXTGT(62729, 0, -(1));
}
...
func int DIA_HERSHLIK_PQ104_PLANTING_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 73680)) && ((PLANTINGWITHHERSHLIK) == (TRUE))) && ((NPC_GETDISTTOWP(SELF, "PARTM2_PATH_78")) <= (500))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_HERSHLIK_PQ104_PLANTING_INFO() {
    ...
    B_GIVEINVITEMS(SELF, OTHER, 37139, 3);
    NPC_EXCHANGEROUTINE(SELF, "PQ104_SEEDS");
    AI_STOPPROCESSINFOS(SELF);
}

var int PQ104_WECANBEPEON;
...
func int DIA_HERSHLIK_PQ104_PLANTINGSUCCESS_CONDITION() {
    if ((((NPC_KNOWSINFO(OTHER, 73688)) && (PQ104_FIELD1)) && (PQ104_FIELD2)) && (PQ104_FIELD3)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_HERSHLIK_PQ104_PLANTSREADY_INFO() {
    ...
    if ((PQ104_HERSHLIKPLANTSLASTCHAPTER) < (KAPITEL)) {
        ...
        B_GIVEINVITEMS(SELF, OTHER, 34274, 10);
        PQ104_HERSHLIKPLANTSLASTCHAPTER = KAPITEL;
    };
...
func void DIA_HERSHLIK_IWANTTOBEPEON_INFO() {
    ...
    INFO_CLEARCHOICES(73699);
    INFO_ADDCHOICE(73699, "I'll think about it some more.", 73702);
    INFO_ADDCHOICE(73699, "I'm sure.", 73703);
}
...
var int HERSHLIK_MIL_SURPRISED;
var int HERSHLIK_SLD_SURPRISED;
var int PQ105_CANBESTARTED;
var int ALCHEMY_INFO;
...
func void DIA_HERSHLIK_HOWTOBEPEON_SIDEQUEST() {
    ...
    WLD_INSERTNPC(50140, RESERVED_CONST_STRING_166);
    WLD_INSERTNPC(50140, RESERVED_CONST_STRING_167);
    WLD_INSERTNPC(50140, RESERVED_CONST_STRING_168);
    WLD_INSERTNPC(50140, RESERVED_CONST_STRING_169);
    WLD_INSERTNPC(50140, RESERVED_CONST_STRING_170);
    WLD_INSERTNPC(50140, RESERVED_CONST_STRING_171);
}
...
func int DIA_HERSHLIK_WHOAYOUMILITIA_CONDITION() {
    if ((((((PEON_HERSHLIK) == (TRUE)) && ((HERSHLIK_MIL_SURPRISED) == (FALSE))) && ((HERO.GUILD) == (GIL_MIL))) && (NPC_KNOWSINFO(OTHER, 73708))) && ((NPC_KNOWSINFO(OTHER, 73722)) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_HERSHLIK_WHOAYOUARAXOS_CONDITION() {
    if ((((((PEON_HERSHLIK) == (TRUE)) && ((HERSHLIK_SLD_SURPRISED) == (FALSE))) && ((HERO.GUILD) == (GIL_SLD))) && (NPC_KNOWSINFO(OTHER, 73708))) && ((NPC_KNOWSINFO(OTHER, 73722)) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
var int POTIONVALUE;
var int HERSHLIK_TRADE_POTION_AMOUNT;
var int HERSHLIK_COUNTGOLD;
var int HERSHLIK_COUNTALL;
var int MAXMANA04VOL2;
var int MAXMANA03VOL2;
var int MAXMANA02VOL2;
var int MAXMANA01VOL2;
var int MAXMANA04VOL1;
var int MAXMANA03VOL1;
var int MAXMANA02VOL1;
var int MAXMANA01VOL1;
var int MAXHP04VOL2;
var int MAXHP03VOL2;
var int MAXHP02VOL2;
var int MAXHP01VOL2;
...
var int MAXHP02VOL1;
var int MAXHP01VOL1;
var int GOLDMANA04VOL2;
var int GOLDMANA03VOL2;
var int GOLDMANA02VOL2;
var int GOLDMANA01VOL2;
var int GOLDMANA04VOL1;
var int GOLDMANA03VOL1;
var int GOLDMANA02VOL1;
var int GOLDMANA01VOL1;
var int GOLDHP04VOL2;
var int GOLDHP03VOL2;
var int GOLDHP02VOL2;
var int GOLDHP01VOL2;
var int GOLDHP04VOL1;
var int GOLDHP03VOL1;
var int GOLDHP02VOL1;
var int GOLDHP01VOL1;
func void DIA_HERSHLIK_IHAVEPOTION_CHOICES() {
    var string ALL_STRING_POTIONS;
    MAXMANA04VOL2 = NPC_HASITEMS(HERO, 34350);
    MAXMANA03VOL2 = NPC_HASITEMS(HERO, 34347);
    MAXMANA02VOL2 = NPC_HASITEMS(HERO, 34341);
    MAXMANA01VOL2 = NPC_HASITEMS(HERO, 34336);
    MAXMANA04VOL1 = NPC_HASITEMS(HERO, 33680);
    MAXMANA03VOL1 = NPC_HASITEMS(HERO, 34344);
    MAXMANA02VOL1 = NPC_HASITEMS(HERO, 34339);
    MAXMANA01VOL1 = NPC_HASITEMS(HERO, 34334);
    MAXHP04VOL2 = NPC_HASITEMS(HERO, 34369);
    MAXHP03VOL2 = NPC_HASITEMS(HERO, 34367);
    MAXHP02VOL2 = NPC_HASITEMS(HERO, 34364);
    MAXHP01VOL2 = NPC_HASITEMS(HERO, 34361);
    MAXHP04VOL1 = NPC_HASITEMS(HERO, 33678);
    MAXHP03VOL1 = NPC_HASITEMS(HERO, 34357);
    MAXHP02VOL1 = NPC_HASITEMS(HERO, 34354);
    MAXHP01VOL1 = NPC_HASITEMS(HERO, 34352);
    GOLDMANA04VOL2 = 0;
    GOLDMANA03VOL2 = 0;
    GOLDMANA02VOL2 = 0;
    GOLDMANA01VOL2 = 0;
    ...
    POTIONINSTANCE = -(1);
    POTIONVALUE = 0;
    INFO_CLEARCHOICES(73728);
    if ((NPC_HASITEMS(OTHER, 34350)) >= (1)) {
        INFO_ADDCHOICE(73728, POTIONNAME_MANA_04_VOL2, 73792);
    };
    if ((NPC_HASITEMS(OTHER, 34347)) >= (1)) {
        INFO_ADDCHOICE(73728, POTIONNAME_MANA_03_VOL2, 73791);
    };
    if ((NPC_HASITEMS(OTHER, 34341)) >= (1)) {
        INFO_ADDCHOICE(73728, POTIONNAME_MANA_02_VOL2, 73790);
    };
    if ((NPC_HASITEMS(OTHER, 34336)) >= (1)) {
        INFO_ADDCHOICE(73728, POTIONNAME_MANA_01_VOL2, 73789);
    };
    if ((NPC_HASITEMS(OTHER, 34369)) >= (1)) {
        INFO_ADDCHOICE(73728, POTIONNAME_HEALTH_04_VOL2, 73800);
    };
    if ((NPC_HASITEMS(OTHER, 34367)) >= (1)) {
        INFO_ADDCHOICE(73728, POTIONNAME_HEALTH_03_VOL2, 73799);
    };
    if ((NPC_HASITEMS(OTHER, 34364)) >= (1)) {
        INFO_ADDCHOICE(73728, POTIONNAME_HEALTH_02_VOL2, 73798);
    };
    if ((NPC_HASITEMS(OTHER, 34361)) >= (1)) {
        INFO_ADDCHOICE(73728, POTIONNAME_HEALTH_01_VOL2, 73797);
    };
    if ((NPC_HASITEMS(OTHER, 33680)) >= (1)) {
        INFO_ADDCHOICE(73728, POTIONNAME_MANA_04, 73788);
    };
    if ((NPC_HASITEMS(OTHER, 34344)) >= (1)) {
        INFO_ADDCHOICE(73728, POTIONNAME_MANA_03, 73787);
    };
    if ((NPC_HASITEMS(OTHER, 34339)) >= (1)) {
        INFO_ADDCHOICE(73728, POTIONNAME_MANA_02, 73786);
    };
    if ((NPC_HASITEMS(OTHER, 34334)) >= (1)) {
        INFO_ADDCHOICE(73728, POTIONNAME_MANA_01, 73785);
    };
    if ((NPC_HASITEMS(OTHER, 33678)) >= (1)) {
        INFO_ADDCHOICE(73728, POTIONNAME_HEALTH_04, 73796);
    };
    if ((NPC_HASITEMS(OTHER, 34357)) >= (1)) {
        INFO_ADDCHOICE(73728, POTIONNAME_HEALTH_03, 73795);
    };
    if ((NPC_HASITEMS(OTHER, 34354)) >= (1)) {
        INFO_ADDCHOICE(73728, POTIONNAME_HEALTH_02, 73794);
    };
    if ((NPC_HASITEMS(OTHER, 34352)) >= (1)) {
        INFO_ADDCHOICE(73728, POTIONNAME_HEALTH_01, 73793);
    };
    ALL_STRING_POTIONS = CS4(DIALOG_ALL, " (", I2S(HERSHLIK_COUNTALL), ")");
    INFO_ADDCHOICE(73728, ALL_STRING_POTIONS, 73769);
    INFO_ADDCHOICE(73728, DIALOG_BACK, 73784);
}
...
func void DIA_HERSHLIK_IHAVEPOTION_EVERYTHING() {
    ...
    if ((NPC_HASITEMS(OTHER, 34352)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 34352, MAXHP01VOL1);
    };
    if ((NPC_HASITEMS(OTHER, 34354)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 34354, MAXHP02VOL1);
    };
    if ((NPC_HASITEMS(OTHER, 34357)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 34357, MAXHP03VOL1);
    };
    if ((NPC_HASITEMS(OTHER, 33678)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 33678, MAXHP04VOL1);
    };
    if ((NPC_HASITEMS(OTHER, 34361)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 34361, MAXHP01VOL2);
    };
    if ((NPC_HASITEMS(OTHER, 34364)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 34364, MAXHP02VOL2);
    };
    if ((NPC_HASITEMS(OTHER, 34367)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 34367, MAXHP03VOL2);
    };
    if ((NPC_HASITEMS(OTHER, 34369)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 34369, MAXHP04VOL2);
    };
    if ((NPC_HASITEMS(OTHER, 34334)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 34334, MAXMANA01VOL1);
    };
    if ((NPC_HASITEMS(OTHER, 34339)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 34339, MAXMANA02VOL1);
    };
    if ((NPC_HASITEMS(OTHER, 34344)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 34344, MAXMANA03VOL1);
    };
    if ((NPC_HASITEMS(OTHER, 33680)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 33680, MAXMANA04VOL1);
    };
    if ((NPC_HASITEMS(OTHER, 34336)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 34336, MAXMANA01VOL2);
    };
    if ((NPC_HASITEMS(OTHER, 34341)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 34341, MAXMANA02VOL2);
    };
    if ((NPC_HASITEMS(OTHER, 34347)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 34347, MAXMANA03VOL2);
    };
    if ((NPC_HASITEMS(OTHER, 34350)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 34350, MAXMANA04VOL2);
    };
    AI_WAIT(SELF, 1056964608);
    AI_FUNCTION(SELF, 73770);
    DIA_HERSHLIK_IHAVEPOTION_CHOICES();
}

func void HERSHLIK_SELLPOTIONS() {
    CREATEINVITEMS(VLK_3002_HERSHLIK, 34203, (HERSHLIK_COUNTGOLD) / (2));
    B_GIVEINVITEMS(VLK_3002_HERSHLIK, HERO, 34203, (HERSHLIK_COUNTGOLD) / (2));
}
...
func void DIA_HERSHLIK_IHAVEPOTION_AMMOUNT() {
    ...
    INFO_ADDCHOICE(73728, ALL_STRING, 73774);
    INFO_ADDCHOICE(73728, CHOICE_NUMBER_25, 73776);
    INFO_ADDCHOICE(73728, CHOICE_NUMBER_10, 73778);
    INFO_ADDCHOICE(73728, CHOICE_NUMBER_5, 73780);
    INFO_ADDCHOICE(73728, CHOICE_NUMBER_1, 73782);
    INFO_ADDCHOICE(73728, DIALOG_BACK, 73767);
}
...
func void DIA_HERSHLIK_IHAVEPOTION_ALL() {
    ...
    if ((NPC_HASITEMS(OTHER, POTIONINSTANCE)) >= (1)) {
        ...
        CREATEINVITEMS(SELF, 34203, ((MAX) * (POTIONVALUE)) / (2));
        B_GIVEINVITEMS(SELF, OTHER, 34203, ((MAX) * (POTIONVALUE)) / (2));
...
func void DIA_HERSHLIK_IHAVEPOTION_25() {
    ...
    if ((NPC_HASITEMS(OTHER, POTIONINSTANCE)) >= (25)) {
        ...
        CREATEINVITEMS(SELF, 34203, ((25) * (POTIONVALUE)) / (2));
        B_GIVEINVITEMS(SELF, OTHER, 34203, ((25) * (POTIONVALUE)) / (2));
...
func void DIA_HERSHLIK_IHAVEPOTION_10() {
    ...
    if ((NPC_HASITEMS(OTHER, POTIONINSTANCE)) >= (10)) {
        ...
        CREATEINVITEMS(SELF, 34203, ((10) * (POTIONVALUE)) / (2));
        B_GIVEINVITEMS(SELF, OTHER, 34203, ((10) * (POTIONVALUE)) / (2));
...
func void DIA_HERSHLIK_IHAVEPOTION_5() {
    ...
    if ((NPC_HASITEMS(OTHER, POTIONINSTANCE)) >= (5)) {
        ...
        CREATEINVITEMS(SELF, 34203, ((5) * (POTIONVALUE)) / (2));
        B_GIVEINVITEMS(SELF, OTHER, 34203, ((5) * (POTIONVALUE)) / (2));
...
func void DIA_HERSHLIK_IHAVEPOTION_1() {
    if ((NPC_HASITEMS(OTHER, POTIONINSTANCE)) >= (1)) {
        ...
        CREATEINVITEMS(SELF, 34203, (POTIONVALUE) / (2));
        B_GIVEINVITEMS(SELF, OTHER, 34203, (POTIONVALUE) / (2));
...
func int DIA_HERSHLIK_PQ105_DONE_CONDITION() {
    if (((LOG_GETSTATUS(MIS_PQ105)) == (LOG_RUNNING)) && ((NPC_HASITEMS(OTHER, 37649)) >= (3))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_HERSHLIK_PQ105_DONE_INFO() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 37649, 3);
    ...
    CREATEINVITEMS(SELF, 34203, PQ105_REWARD);
    B_GIVEINVITEMS(SELF, OTHER, 34203, PQ105_REWARD);
...
func void DIA_HERSHLIK_Q505_HELP_INFO() {
    ...
    CREATEINVITEMS(SELF, 37587, 1);
    B_GIVEINVITEMS(SELF, OTHER, 37587, 1);
    AI_RESETFACEANI(SELF);
}
...
var int HERSHLIK_FINISHPEON;
var int HERSHLIK_FINISHPEON_DAY;
func void DIA_HERSHLIK_FINISHPEON_INFO() {
    ...
    AI_RESETFACEANI(SELF);
    CREATEINVITEMS(SELF, 39888, 1);
    B_GIVEINVITEMS(SELF, OTHER, 39888, 1);
    LOG_CREATETOPIC(TOPIC_WORK_HERSHLIK, LOG_NOTE);
...
func void DIA_HERSHLIK_FINALPRESENT_INFO() {
    ...
    AI_RESETFACEANI(SELF);
    CREATEINVITEMS(SELF, 37747, 1);
    B_GIVEINVITEMS(SELF, OTHER, 37747, 1);
}
...
func void DIA_HERSHLIK_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(73836);
    INFO_ADDCHOICE(73836, DIALOG_BACK, 73840);
    INFO_ADDCHOICE(73836, DIALOG_PICKPOCKET, 73839);
}

func void DIA_HERSHLIK_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (1)) {
        CREATEINVITEMS(SELF, 34284, 1);
        B_GIVEINVITEMS(SELF, OTHER, 34284, 1);
