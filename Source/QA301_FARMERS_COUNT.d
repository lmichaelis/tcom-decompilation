var int QA301_FARMERS_COUNT;
func void EVENTSMANAGER_QA301() {
    var int QA301_FOREST_LOGENTRY;
    if ((LOG_GETSTATUS(MIS_QA301)) == (LOG_RUNNING)) {
        if ((QA301_TALKWITHARAXOSGUARD) == (0)) {
            if (((NPC_KNOWSINFO(HERO, 85860)) && ((QA301_FOREST) == (0))) && ((NPC_GETDISTTOWP(HERO, "PART12_PATH_41")) <= (1250))) {
                PRINTD("Biegnie 1");
            ...
            if (((NPC_GETDISTTOWP(HERO, "PART12_PATH_75")) <= (1250)) && ((QA301_FOREST) == (1))) {
                PRINTD("Biegnie 2");
                B_SAY(HERO, HERO, "$MARVIN_WaitForMe");
            ...
            if (((QA301_FOREST) == (2)) && ((NPC_GETDISTTOWP(HERO, "PART12_PATH_94")) <= (1250))) {
                PRINTD("Biegnie 3");
                B_SAY(HERO, HERO, "$MARVIN_WaitForMe");
        ...
        if ((QA301_FINALCUTSCENE) == (1)) {
            ...
            FF_APPLYONCEEXT(94233, 500, 2);
        };
        if ((QA301_FINALCUTSCENE) == (3)) {
            QA301_FINALCUTSCENE = 4;
            FF_APPLYONCEEXT(94237, 250, 3);
