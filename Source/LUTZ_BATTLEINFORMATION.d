var int LUTZ_BATTLEINFORMATION;
var int LUTZ_ORCSINFORMATION;
var int LUTZ_GENERALLEEINFORMATION;
var int LUTZ_INFORMATION;
...
func void DIA_LUTZ_HELLO_CHOICE() {
    INFO_CLEARCHOICES(67081);
    if ((LUTZ_BATTLEINFORMATION) == (FALSE)) {
        INFO_ADDCHOICE(67081, "What's the situation on the front?", 67085);
    };
    if ((LUTZ_ORCSINFORMATION) == (FALSE)) {
        INFO_ADDCHOICE(67081, "Tell me about the orcs.", 67086);
    };
    if (((LUTZ_GENERALLEEINFORMATION) == (FALSE)) && ((LUTZ_WEKNOWLEE) == (TRUE))) {
        INFO_ADDCHOICE(67081, "Who is this General Lee?", 67087);
    };
    if ((LUTZ_INFORMATION) >= (1)) {
        INFO_ADDCHOICE(67081, "Thanks for the information. I have to go now.", 67088);
    };
}
...
func void DIA_LUTZ_HELLO_GOODBYE() {
    ...
    INFO_CLEARCHOICES(67081);
    INFO_ADDCHOICE(67081, "I'm sorry, I don't know anyone like that.", 67090);
    INFO_ADDCHOICE(67081, "Martha?! Are you talking about that rough and spiteful hag?", 67089);
}
...
func void DIA_LUTZ_HELLO_GOODBYE_GRANDMA() {
    ...
    INFO_CLEARCHOICES(67081);
    INFO_ADDCHOICE(67081, "I don't have time for this.", 67092);
    INFO_ADDCHOICE(67081, "The road to Silbach is long and dangerous...", 67091);
}
...
func int DIA_LUTZ_BATTLE_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 67081)) && ((LUTZ_BATTLEINFORMATION) == (FALSE))) && ((Q509_LUTZVOLFZACKE) == (0))) {
        return TRUE;
    };
...
func int DIA_LUTZ_ORCS_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 67081)) && ((LUTZ_ORCSINFORMATION) == (FALSE))) && ((Q509_LUTZVOLFZACKE) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LUTZ_GENERALLEE_CONDITION() {
    if ((((NPC_KNOWSINFO(OTHER, 67081)) && ((LUTZ_GENERALLEEINFORMATION) == (FALSE))) && ((Q509_LUTZVOLFZACKE) == (0))) && ((LUTZ_WEKNOWLEE) == (TRUE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LUTZ_TAKEQUEST_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 67081)) && ((SQ213_TAKEQUEST) == (TRUE))) && ((SQ213_KNOWMARTHA) == (2))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LUTZ_MARTHATAKEQUEST_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 67081)) && ((SQ213_TAKEQUEST) == (TRUE))) && ((SQ213_KNOWMARTHA) == (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LUTZ_MARTHA_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 88162)) && ((LOG_GETSTATUS(MIS_SQ213)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_LUTZ_MARTHA_COMEBACK_HER() {
    ...
    CREATEINVITEMS(SELF, 34203, MIST_LUTZDEBT);
    B_GIVEINVITEMS(SELF, OTHER, 34203, MIST_LUTZDEBT);
    SQ213_LUTZDEBTGIVEN = 1;
    SQ213_LUTZDEBTGIVEN_DAY = WLD_GETDAY();
    INFO_CLEARCHOICES(67108);
    INFO_ADDCHOICE(67108, "(Take care of other matters)", 67112);
    INFO_ADDCHOICE(67108, "(Go to Martha)", 67111);
}

func void DIA_LUTZ_MARTHA_TELEPORT() {
    AI_STOPPROCESSINFOS(SELF);
    AI_FUNCTION(SELF, 62559);
}

func void DIA_LUTZ_MARTHA_LATER() {
    INFO_CLEARCHOICES(67129);
    INFO_CLEARCHOICES(67108);
}
...
func void DIA_LUTZ_MARTHA_INFO() {
    ...
    INFO_CLEARCHOICES(67108);
    INFO_ADDCHOICE(67108, "Start by paying off your debt.", 67114);
    INFO_ADDCHOICE(67108, "Better get back to the mainland.", 67115);
}
...
func int DIA_LUTZ_ANGRY_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ213)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 67108))) && ((SQ213_LUTZANGRY) == (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LUTZ_GOAWAY_CONDITION() {
    if (((((SQ213_LUTZANGRY) == (3)) && (NPC_KNOWSINFO(OTHER, 67120))) && (NPC_ISINSTATE(SELF, 61599))) || ((((SQ213_SONGRESULT) == (7)) && (NPC_KNOWSINFO(OTHER, 67146))) && (NPC_ISINSTATE(SELF, 61599)))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LUTZ_MARTHARESULT_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 67108)) && ((LOG_GETSTATUS(MIS_SQ213)) == (LOG_RUNNING))) && ((SQ213_EVERYTHINGREADY) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_LUTZ_MARTHARESULT_INFO() {
    ...
    if ((SQ213_LUTZDEBTGIVEN) == (2)) {
        ...
        if (((SQ213_BASTIANINFORMATION) == (3)) || (NPC_KNOWSINFO(OTHER, 88270))) {
            if ((SQ213_VIKTORWAY) == (1)) {
            ...
            if (((SQ213_MUSICANNOHELP) == (FALSE)) && ((SQ213_MARVINKNOWHOWTOPLAY) == (FALSE))) {
...
func void DIA_LUTZ_SQ213READY_INFO() {
    ...
    AI_FUNCTION(SELF, 67132);
    AI_LOGENTRY(TOPIC_SQ213, LOG_SQ213_ALMOSTREADY);
    NPC_EXCHANGEROUTINE(SELF, ORCHARD);
    INFO_CLEARCHOICES(67129);
    INFO_ADDCHOICE(67129, "(Take care of other matters)", 67112);
    INFO_ADDCHOICE(67129, "(Go to Martha)", 67111);
}

func void LUTZ_SQ213_CHANGEARMOR_VLK() {
    var C_ITEM ITM;
    if ((NPC_HASITEMS(MIL_6318_LUTZ, 35549)) == (0)) {
        CREATEINVITEMS(MIL_6318_LUTZ, 35549, 1);
    };
    ITM = NPC_GETEQUIPPEDARMOR(MIL_6318_LUTZ);
    if ((NPC_HASEQUIPPEDARMOR(MIL_6318_LUTZ)) == (TRUE)) {
        if ((HLP_ISITEM(ITM, 35549)) == (FALSE)) {
            AI_EQUIPARMOR(MIL_6318_LUTZ, 35549);
        };
    };
    AI_EQUIPARMOR(MIL_6318_LUTZ, 35549);
    NPC_REMOVEINVITEMS(MIL_6318_LUTZ, 35615, 1);
}

func void LUTZ_SQ213_CHANGEARMOR_GRD() {
    var C_ITEM ITM;
    if ((NPC_HASITEMS(MIL_6318_LUTZ, 35615)) == (0)) {
        CREATEINVITEMS(MIL_6318_LUTZ, 35615, 1);
    };
    ITM = NPC_GETEQUIPPEDARMOR(MIL_6318_LUTZ);
    if ((NPC_HASEQUIPPEDARMOR(MIL_6318_LUTZ)) == (TRUE)) {
        if ((HLP_ISITEM(ITM, 35615)) == (FALSE)) {
            AI_EQUIPARMOR(MIL_6318_LUTZ, 35615);
        };
    };
    AI_EQUIPARMOR(MIL_6318_LUTZ, 35615);
    NPC_REMOVEINVITEMS(MIL_6318_LUTZ, 35549, 1);
}
...
func void DIA_LUTZ_FINISHMIST_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 37421)) >= (1)) {
        ...
        B_GIVEINVITEMS(OTHER, SELF, 37421, 1);
...
func void MIST_SONGWITHOUTKARIN() {
    FADESCREENTOBLACKF(1, 67141, 1000);
}
...
func void DIA_LUTZ_FINISHQUEST_INFO() {
    ...
    if ((HERO.HITCHANCE[1]) >= (HERO.HITCHANCE[2])) {
        CREATEINVITEMS(SELF, 39496, 1);
        if ((NPC_HASITEMS(OTHER, 36034)) == (0)) {
            CREATEINVITEM(OTHER, 36034);
            AI_USEITEMTOSTATE(OTHER, 36034, 1);
            AI_WAIT(OTHER, 1082130432);
            AI_USEITEMTOSTATE(OTHER, 36034, -(1));
        };
    };
    CREATEINVITEMS(SELF, 39497, 1);
    if ((NPC_HASITEMS(OTHER, 36035)) == (0)) {
        CREATEINVITEM(OTHER, 36035);
        AI_USEITEMTOSTATE(OTHER, 36035, 1);
        AI_WAIT(OTHER, 1082130432);
        AI_USEITEMTOSTATE(OTHER, 36035, -(1));
    };
    B_GIVEINVITEMS(SELF, OTHER, 39497, 1);
    AI_OUTPUT(SELF, OTHER, "DIA_LUTZ_FinishQuest_03_28");
    INFO_CLEARCHOICES(67146);
    INFO_ADDCHOICE(67146, "What are you going to do now?", 67149);
}
...
func void DIA_LUTZ_SQ410_START_INFO() {
    ...
    INFO_CLEARCHOICES(67150);
    INFO_ADDCHOICE(67150, "No, unless Martha starts torturing me.", 67155);
    INFO_ADDCHOICE(67150, "After all we've been through together?", 67154);
}
...
func void DIA_LUTZ_SQ410_HELP_INFO() {
    ...
    AI_RESETFACEANI(SELF);
    AI_RESETFACEANI(OTHER);
    if (((LOG_GETSTATUS(MIS_SQ410)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 88185))) {
...
func int DIA_LUTZ_SQ410_VIKTOR_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ410)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 88080))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LUTZ_SQ410_NOTHING_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ410)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 67159))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LUTZ_SQ410_IDEA_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ410)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 67162))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LUTZ_SQ410_SUCCESS_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ410)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 88188))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void LUTZ_KQ404_GIVEARMOR() {
    ...
    B_GIVEINVITEMS(MIL_6318_LUTZ, HERO, 35615, 1);
}
...
func int DIA_LUTZ_Q509_LETSGO_CONDITION() {
    ...
    if ((((LOG_GETSTATUS(MIS_Q509)) == (LOG_RUNNING)) && ((Q509_COUNTWARRIORS) < (4))) && (NPC_KNOWSINFO(OTHER, 67184))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LUTZ_Q509_FEEL_CONDITION() {
    if (((Q509_LUTZVOLFZACKE) == (1)) && ((NPC_GETDISTTOWP(SELF, "PART5_Q509_LUTZ")) <= (2000))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_LUTZ_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(67193);
    INFO_ADDCHOICE(67193, DIALOG_BACK, 67197);
    INFO_ADDCHOICE(67193, DIALOG_PICKPOCKET, 67196);
}
