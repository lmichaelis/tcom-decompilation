...
func void USE_ALCHEMYTESTPACKET() {
    CREATEINVITEMS(HERO, 35046, 1);
    CREATEINVITEMS(HERO, 35048, 1);
    CREATEINVITEMS(HERO, 34974, 1);
    CREATEINVITEMS(HERO, 35044, 1);
    CREATEINVITEMS(HERO, 35042, 1);
    CREATEINVITEMS(HERO, 35014, 1);
    CREATEINVITEMS(HERO, 35012, 1);
    CREATEINVITEMS(HERO, 35010, 1);
    CREATEINVITEMS(HERO, 35008, 1);
    CREATEINVITEMS(HERO, 35040, 1);
    CREATEINVITEMS(HERO, 35030, 1);
    CREATEINVITEMS(HERO, 35032, 1);
    CREATEINVITEMS(HERO, 35034, 1);
    CREATEINVITEMS(HERO, 35036, 1);
    CREATEINVITEMS(HERO, 35038, 1);
    CREATEINVITEMS(HERO, 35050, 1);
    CREATEINVITEMS(HERO, 35052, 1);
    CREATEINVITEMS(HERO, 35016, 1);
    CREATEINVITEMS(HERO, 35018, 1);
    CREATEINVITEMS(HERO, 37698, 5);
    CREATEINVITEMS(HERO, 37702, 5);
    CREATEINVITEMS(HERO, 37706, 5);
    CREATEINVITEMS(HERO, 37710, 5);
    CREATEINVITEMS(HERO, 37714, 5);
    CREATEINVITEMS(HERO, 37718, 5);
    CREATEINVITEMS(HERO, 37704, 5);
    CREATEINVITEMS(HERO, 37708, 5);
    CREATEINVITEMS(HERO, 37712, 5);
    CREATEINVITEMS(HERO, 37716, 5);
    CREATEINVITEMS(HERO, 37720, 5);
    CREATEINVITEMS(HERO, 37724, 5);
    CREATEINVITEMS(HERO, 37730, 5);
    CREATEINVITEMS(HERO, 37734, 5);
    CREATEINVITEMS(HERO, 37732, 5);
    CREATEINVITEMS(HERO, 37736, 5);
    CREATEINVITEMS(HERO, 37738, 5);
    CREATEINVITEMS(HERO, 37722, 5);
    CREATEINVITEMS(HERO, 34379, 5);
    CREATEINVITEMS(HERO, 34381, 5);
    CREATEINVITEMS(HERO, 34177, 100);
    CREATEINVITEMS(HERO, 34296, 100);
    CREATEINVITEMS(HERO, 34302, 500);
    CREATEINVITEMS(HERO, 34303, 500);
    CREATEINVITEMS(HERO, 34290, 500);
    CREATEINVITEMS(HERO, 34280, 100);
    CREATEINVITEMS(HERO, 34282, 100);
    CREATEINVITEMS(HERO, 34284, 100);
    CREATEINVITEMS(HERO, 34274, 100);
    CREATEINVITEMS(HERO, 34276, 100);
    CREATEINVITEMS(HERO, 34278, 100);
    CREATEINVITEMS(HERO, 37647, 100);
    CREATEINVITEMS(HERO, 37653, 100);
    CREATEINVITEMS(HERO, 34288, 100);
    CREATEINVITEMS(HERO, 34286, 100);
    SND_PLAY(GELDBEUTEL);
}
...
func void USEITPO_TIMED_HEALTH() {
    ...
    BUFF_APPLYEXT(SELF, 32463, ((DURATION_POTION_TIMED) * (60)) * (1000), FALSE, TRUE);
}
...
func void USEITPO_TIMED_HEALTH2() {
    ...
    BUFF_APPLYEXT(SELF, 32463, ((DURATION_POTION_TIMED_STRONG) * (60)) * (1000), FALSE, TRUE);
}
...
func void USEITPO_TIMED_MANA() {
    GIVEPOTIONXP(SELF, XP_ITPO_TIMED);
    BUFF_APPLYEXT(SELF, 32472, ((DURATION_POTION_TIMED) * (60)) * (1000), FALSE, TRUE);
}
...
func void USEITPO_TIMED_MANA2() {
    GIVEPOTIONXP(SELF, XP_ITPO_TIMEDSTRONG);
    BUFF_APPLYEXT(SELF, 32472, ((DURATION_POTION_TIMED_STRONG) * (60)) * (1000), FALSE, TRUE);
}
...
func void USEITPO_TIMED_STR() {
    GIVEPOTIONXP(SELF, XP_ITPO_TIMED);
    BUFF_APPLYEXT(SELF, 32482, ((DURATION_POTION_TIMED) * (60)) * (1000), FALSE, TRUE);
}
...
func void USEITPO_TIMED_STR2() {
    GIVEPOTIONXP(SELF, XP_ITPO_TIMEDSTRONG);
    BUFF_APPLYEXT(SELF, 32482, ((DURATION_POTION_TIMED_STRONG) * (60)) * (1000), FALSE, TRUE);
}
...
func void USEITPO_TIMED_DEX2() {
    GIVEPOTIONXP(SELF, XP_ITPO_TIMEDSTRONG);
    BUFF_APPLYEXT(SELF, 32492, ((DURATION_POTION_TIMED_STRONG) * (60)) * (1000), FALSE, TRUE);
}
...
func void USEITPO_TIMED_DEF() {
    GIVEPOTIONXP(SELF, XP_ITPO_TIMED);
    BUFF_APPLYEXT(SELF, 32511, ((DURATION_POTION_TIMED) * (60)) * (1000), FALSE, TRUE);
}
...
func void USEITPO_TIMED_DEF2() {
    GIVEPOTIONXP(SELF, XP_ITPO_TIMEDSTRONG);
    BUFF_APPLYEXT(SELF, 32511, ((DURATION_POTION_TIMED_STRONG) * (60)) * (1000), FALSE, TRUE);
}
...
func void USEITPO_DIVE() {
    BUFF_APPLYORADDTIME(SELF, 32520);
}
...
func void USEITPO_STONESKIN() {
    var string PRINT_MAGIC_STONESKIN_PERMVALUE;
    var string PRINT_MAGIC_STONESKINBONUS;
    var string PRINT_STONESKINBONUS;
    var string PRINT_STONESKIN_PERMVALUE;
...
func void USEITPO_HPREGEN() {
    GIVEPOTIONXP(SELF, XP_ITPO_TIMED);
    BUFF_APPLYEXT(SELF, 32444, ((DURATION_POTION_REGEN) * (60)) * (1000), FALSE, TRUE);
}
...
func void USEITPO_HPREGEN2() {
    GIVEPOTIONXP(SELF, XP_ITPO_TIMEDSTRONG);
    BUFF_APPLYEXT(SELF, 32444, ((DURATION_POTION_REGEN_STRONG) * (60)) * (1000), FALSE, TRUE);
}
...
func void USEITPO_MANAREGEN() {
    GIVEPOTIONXP(SELF, XP_ITPO_TIMED);
    BUFF_APPLYEXT(SELF, 32449, ((DURATION_POTION_TIMED) * (60)) * (1000), FALSE, TRUE);
}
...
func void USEITPO_MANAREGEN2() {
    GIVEPOTIONXP(SELF, XP_ITPO_TIMEDSTRONG);
    BUFF_APPLYEXT(SELF, 32449, ((DURATION_POTION_TIMED_STRONG) * (60)) * (1000), FALSE, TRUE);
}
...
func void USEITPO_FALL() {
    BUFF_APPLYORADDTIME(SELF, 32443);
}
...
func void USE_SQ313TIMESTR() {
    ...
    BUFF_APPLYORADDTIME(SELF, 32554);
}
    ...
    if ((STOPBEFOREISTOOLATE_CHECK) == (TRUE)) {
        if ((WLD_ISTIME(23, 20, 23, 22)) && ((NPC_GETDISTTOWP(HERO, "PART5_ARG_01")) <= (500))) {
            if ((ARG_03_CHECK) == (FALSE)) {
                ...
                WLD_INSERTITEM(40011, "FP_ARG_P5");
            };
        };
    };
}
