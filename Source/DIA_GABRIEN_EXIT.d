...
func int DIA_GABRIEN_LESSON_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 88336)) && ((HERO.GUILD) == (GIL_NONE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_GABRIEN_LESSON_INFO() {
    ...
    INFO_CLEARCHOICES(88339);
    INFO_ADDCHOICE(88339, "I don't know the man.", 88342);
    INFO_ADDCHOICE(88339, "We had nothing to do with his death.", 88343);
}
...
func int DIA_GABRIEN_BUILDING_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 88336)) && ((NPC_GETDISTTOWP(SELF, "VILLAGE_PLACE_10")) <= (500))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_GABRIEN_SQ104_ARIES_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ104)) == (LOG_RUNNING)) && ((NPC_KNOWSINFO(OTHER, 89994)) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_GABRIEN_WHEREISJORN_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 87898)) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_GABRIEN_WHEREISJORN_INFO() {
    ...
    INFO_CLEARCHOICES(88356);
    INFO_ADDCHOICE(88356, "Have you heard anything about Kurt's break-in?", 88359);
    INFO_ADDCHOICE(88356, "Have you seen a bald, muscular guy anywhere?", 88360);
}
...
func void DIA_GABRIEN_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(88361);
    INFO_ADDCHOICE(88361, DIALOG_BACK, 88365);
    INFO_ADDCHOICE(88361, DIALOG_PICKPOCKET, 88364);
}
