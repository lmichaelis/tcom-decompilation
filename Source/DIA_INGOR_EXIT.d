...
func void DIA_INGOR_ARMORS_CHOICE() {
    INFO_CLEARCHOICES(70444);
    INFO_ADDCHOICE(70444, TXT_ARMORTRADE_25, 70448);
    INFO_ADDCHOICE(70444, TXT_ARMORTRADE_26, 70449);
    if (NPC_KNOWSINFO(OTHER, 71240)) {
        INFO_ADDCHOICE(70444, TXT_ARMORTRADE_27, 70450);
    };
    INFO_ADDCHOICE(70444, DIALOG_BACK, 70447);
}
...
func void DIA_INGOR_NEEDARMOR_LEATHER() {
    if ((NPC_HASITEMS(OTHER, 34203)) >= ((VALUE_ITAR_KM_LEATHER_M) / (2))) {
        B_GIVEINVITEMS(OTHER, SELF, 34203, (VALUE_ITAR_KM_LEATHER_M) / (2));
...
func void DIA_INGOR_NEEDARMOR_CHAIN() {
    if ((NPC_HASITEMS(OTHER, 34203)) >= ((VALUE_ITAR_CHAIN_M) / (2))) {
        B_GIVEINVITEMS(OTHER, SELF, 34203, (VALUE_ITAR_CHAIN_M) / (2));
        CREATEINVITEMS(SELF, 35403, 1);
        B_GIVEINVITEMS(SELF, OTHER, 35403, 1);
        AI_EQUIPARMOR(OTHER, 35403);
        DIA_INGOR_ARMORS_CHOICE();
    };
    B_SAY(SELF, OTHER, "$NOGOLD");
    DIA_INGOR_ARMORS_CHOICE();
...
func void DIA_INGOR_NEEDARMOR_ARAXOS_TIER1() {
    if ((NPC_HASITEMS(OTHER, 34203)) >= (VALUE_ITAR_ARX_B)) {
        B_GIVEINVITEMS(OTHER, SELF, 34203, VALUE_ITAR_ARX_B);
        CREATEINVITEMS(SELF, 35465, 1);
        B_GIVEINVITEMS(SELF, OTHER, 35465, 1);
        AI_EQUIPARMOR(OTHER, 35465);
        DIA_INGOR_ARMORS_CHOICE();
    };
    B_SAY(SELF, OTHER, "$NOGOLD");
    DIA_INGOR_ARMORS_CHOICE();
...
func void DIA_INGOR_NEEDARMOR_INFO() {
    var int INGOR_FIRSTDIALOGUEABOUTARMORS;
    var int INGOR_FIRSTDIALOGUEABOUTARMORS_TIER1;
    var int INGOR_FIRSTDIALOGUEABOUTARMORS_TIER2;
    AI_OUTPUT(OTHER, SELF, "DIA_Ingor_NeedArmor_15_01");
    if ((((MARVIN_ARAXOSSPECIALIZATION) > (ARAXOS_SPECIALIZATION_NONE)) && ((INGOR_FIRSTDIALOGUEABOUTARMORS_TIER2) == (FALSE))) || ((NPC_KNOWSINFO(OTHER, 71240)) && ((INGOR_FIRSTDIALOGUEABOUTARMORS_TIER1) == (FALSE)))) {
        ...
        if (((MARVIN_ARAXOSSPECIALIZATION) > (ARAXOS_SPECIALIZATION_NONE)) && ((INGOR_FIRSTDIALOGUEABOUTARMORS_TIER2) == (FALSE))) {
            ...
            if ((MARVIN_ARAXOSSPECIALIZATION) == (ARAXOS_SPECIALIZATION_FIGHTER)) {
                CREATEINVITEMS(SELF, 35454, 1);
                B_GIVEINVITEMS(SELF, OTHER, 35454, 1);
                AI_EQUIPARMOR(OTHER, 35454);
            } else if ((MARVIN_ARAXOSSPECIALIZATION) == (ARAXOS_SPECIALIZATION_ARCHER)) {
                CREATEINVITEMS(SELF, 35470, 1);
                B_GIVEINVITEMS(SELF, OTHER, 35470, 1);
                AI_EQUIPARMOR(OTHER, 35470);
            };
        } else if ((NPC_KNOWSINFO(OTHER, 71240)) && ((INGOR_FIRSTDIALOGUEABOUTARMORS_TIER1) == (FALSE))) {
    ...
    if ((NPC_KNOWSINFO(OTHER, 71240)) && ((INGOR_FIRSTDIALOGUEABOUTARMORS_TIER1) == (FALSE))) {
...
func int DIA_INGOR_Q309_WHOBOLT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 70455)) && ((LOG_GETSTATUS(MIS_Q309)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
var int INGOR_QM305_BOOK_PRICEDECISION;
var int INGOR_QM305_BOOK_PRICE;
func void DIA_INGOR_QM305_BOOK_CHOICES() {
    INFO_CLEARCHOICES(70461);
    if ((INGOR_QM305_BOOK_PRICEDECISION) == (FALSE)) {
        INFO_ADDCHOICE(70461, "I'm an authority figure. You'll give it to me cheaper.", 70467);
        INFO_ADDCHOICE(70461, "And why would a blacksmith like you need a book like this?", 70468);
    };
    INFO_ADDCHOICE(70461, "Maybe so, but how long will I be unable to eat?", 70469);
}
...
func int DIA_INGOR_QM305_BUYBOOK_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_QM305)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 70461))) && ((QM305_GOTARAXOSBOOK) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_INGOR_QM305_BUYBOOK_BACK() {
    INFO_CLEARCHOICES(70470);
}

func void DIA_INGOR_QM305_BUYBOOK_INFO() {
    INFO_CLEARCHOICES(70470);
    INFO_ADDCHOICE(70470, DIALOG_BACK, 70472);
    if ((INGOR_QM305_BOOK_PRICE) == (3)) {
        INFO_ADDCHOICE(70470, DIALOG_PAY200G, 70475);
    };
    if ((INGOR_QM305_BOOK_PRICE) == (2)) {
        INFO_ADDCHOICE(70470, DIALOG_GIVE150G, 70476);
    };
    if ((INGOR_QM305_BOOK_PRICE) == (1)) {
        INFO_ADDCHOICE(70470, DIALOG_GIVE100G, 70477);
    };
}
...
func void DIA_INGOR_QM305_BUYBOOK_200() {
    if ((NPC_HASITEMS(OTHER, 34203)) >= (QM305_BUYARAXOSBOOK_V3)) {
        NPC_REMOVEINVITEMS(SELF, 34203, QM305_BUYARAXOSBOOK_V3);
...
func void DIA_INGOR_QM305_BUYBOOK_150() {
    if ((NPC_HASITEMS(OTHER, 34203)) >= (QM305_BUYARAXOSBOOK_V2)) {
        NPC_REMOVEINVITEMS(SELF, 34203, QM305_BUYARAXOSBOOK_V2);
        DIA_INGOR_QM305_BUYBOOK_PAY();
    };
    B_SAY(SELF, OTHER, "$NOGOLD");
    DIA_INGOR_QM305_BUYBOOK_INFO();
...
func void DIA_INGOR_QM305_BUYBOOK_100() {
    if ((NPC_HASITEMS(OTHER, 34203)) >= (QM305_BUYARAXOSBOOK_V1)) {
        NPC_REMOVEINVITEMS(SELF, 34203, QM305_BUYARAXOSBOOK_V1);
        DIA_INGOR_QM305_BUYBOOK_PAY();
    };
    B_SAY(SELF, OTHER, "$NOGOLD");
    DIA_INGOR_QM305_BUYBOOK_INFO();
...
func void DIA_INGOR_QM305_BOOKREADY_INFO() {
    ...
    if ((QM305_GOTARAXOSBOOK_DAY) <= ((WLD_GETDAY()) - (1))) {
        ...
        CREATEINVITEMS(SELF, 37234, 1);
        B_GIVEINVITEMS(SELF, OTHER, 37234, 1);
        AI_STARTFACEANI(SELF, S_SMILE, 1, -(1));
...
var int INGOR_NOMORE;
var int INGOR_CURRENT2HLEVEL;
var int INGOR_CURRENTSTRLEVEL;
...
func int DIA_INGOR_TRAIN_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 70481)) && ((INGOR_NOMORE) == (FALSE))) && ((OTHER.GUILD) == (GIL_SLD))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_INGOR_TRAIN_CHOICES() {
    var int INGOR_GOLDCOST;
    INGOR_CURRENT2HLEVEL = OTHER.AIVAR[85];
    INGOR_CURRENTSTRLEVEL = OTHER.AIVAR[81];
    INGOR_GOLDCOST = 0;
    INFO_CLEARCHOICES(70489);
    INFO_ADDCHOICE(70489, DIALOG_BACK, 70495);
    INFO_ADDCHOICE(70489, B_BUILDLEARNSTRING2(PRINT_LEARN2H1, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_2H, 1), INGOR_GOLDCOST), 70497);
    INFO_ADDCHOICE(70489, B_BUILDLEARNSTRING2(PRINT_LEARN2H5, (B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_2H, 1)) * (5), (INGOR_GOLDCOST) * (5)), 70499);
    if (((MARVIN_ARAXOSSPECIALIZATION) == (ARAXOS_SPECIALIZATION_MASTERFIGHTER)) || ((MARVIN_ARAXOSSPECIALIZATION) == (ARAXOS_SPECIALIZATION_MASTERARCHER))) {
        INFO_ADDCHOICE(70489, B_BUILDLEARNSTRING2(PRINT_LEARNSTR1, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_STRENGTH, 1), INGOR_GOLDCOST), 70500);
        INFO_ADDCHOICE(70489, B_BUILDLEARNSTRING2(PRINT_LEARNSTR5, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_STRENGTH, 5), (INGOR_GOLDCOST) * (5)), 70501);
    };
}
...
func int DIA_INGOR_TEACH_SMITH_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 70481)) && ((OTHER.GUILD) == (GIL_SLD))) && ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_SMITH)) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_INGOR_TEACH_SMITH_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (INGOR_SMITH)) {
        if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_SMITH)) == (1)) {
            ...
            B_GIVEINVITEMS(SELF, OTHER, 35980, 4);
...
func int DIA_INGOR_TEACH_SMITH2_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 70481)) && ((OTHER.GUILD) == (GIL_SLD))) && ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_SMITH)) == (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_INGOR_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(70511);
    INFO_ADDCHOICE(70511, DIALOG_BACK, 70515);
    INFO_ADDCHOICE(70511, DIALOG_PICKPOCKET, 70514);
}

func void DIA_INGOR_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (2)) {
        CREATEINVITEMS(SELF, 36912, 1);
        B_GIVEINVITEMS(SELF, OTHER, 36912, 1);
