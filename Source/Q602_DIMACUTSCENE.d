...
func void Q602_DIMACUTSCENE_START() {
    ...
    TELEPORTNPCTOWP(1819, "PARTE1_DIMA_CUTSCENE_HERO");
    TELEPORTNPCTOWP(59832, "PARTE1_VOLKERGUARD_05");
    TELEPORTNPCTOWP(59835, "PARTE1_VOLKERGUARD_04");
    TELEPORTNPCTOWP(59838, "PARTE1_VOLKERGUARD_03");
    TELEPORTNPCTOWP(60029, "PARTE1_DIMA");
    TELEPORTNPCTOWP(60020, "PARTE1_ARAXOS_01");
    ...
    AI_FUNCTION(NONE_10064_VOLKERGUARD_Q602, 92736);
    Q602_DIMACUTSCENE_WAIT();
    AI_WAIT(NONE_10064_VOLKERGUARD_Q602, 1045220557);
    AI_WAIT(NONE_10065_VOLKERGUARD_Q602, 1065353216);
    AI_WAIT(NONE_10066_VOLKERGUARD_Q602, 1067869798);
    ...
    Q602_DIMACUTSCENE_WAIT();
    AI_FUNCTION(NONE_10064_VOLKERGUARD_Q602, 92737);
    AI_STARTFACEANI(HERO, S_ANGRY, 1, -(1));
    AI_WAIT(HERO, 1061997773);
    Q602_DIMACUTSCENE_WAIT();
    AI_FUNCTION(NONE_10064_VOLKERGUARD_Q602, 92735);
}
