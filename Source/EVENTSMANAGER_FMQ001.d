func void EVENTSMANAGER_FMQ001() {
    ...
    if ((LOG_GETSTATUS(MIS_FMQ001)) == (LOG_RUNNING)) {
        if ((FMQ001_INSTRUCTORRUN) == (1)) {
            if ((FMQ001_INSTRUCTORRUN_TELEPORT) == (FALSE)) {
                if ((((NPC_GETDISTTONPC(HERO, MIL_4040_RECRUIT)) >= (FMQ001_MAXDISTANCE)) || ((NPC_GETDISTTONPC(HERO, MIL_4041_RECRUIT)) >= (FMQ001_MAXDISTANCE))) || ((NPC_GETDISTTONPC(HERO, MIL_4042_RECRUIT)) >= (FMQ001_MAXDISTANCE))) {
                    if ((((NPC_ISINSTATE(MIL_4040_RECRUIT, 61599)) == (FALSE)) && ((NPC_ISINSTATE(MIL_4041_RECRUIT, 61599)) == (FALSE))) && ((NPC_ISINSTATE(MIL_4042_RECRUIT, 61599)) == (FALSE))) {
                        FMQ001_INSTRUCTORRUN_TELEPORT = TRUE;
                        CLOSEINVENTORY();
                        FADESCREENTOBLACKF(1, 62796, 1000);
                    };
                };
            };
            ...
            if ((FMQ001_INSTRUCTORRUN_TELEPORT) == (FALSE)) {
                if ((NPC_GETDISTTONPC(HERO, MIL_4043_INSTRUCTOR)) >= (FMQ001_MAXDISTANCE)) {
                    if ((NPC_ISINSTATE(MIL_4043_INSTRUCTOR, 61599)) == (FALSE)) {
                        FMQ001_INSTRUCTORRUN_TELEPORT = TRUE;
                        CLOSEINVENTORY();
                        FADESCREENTOBLACKF(1, 62797, 1000);
                    };
                };
            };
        };
        if (((FMQ001_RODEIRCHSENTTOTRAINING_DAY) == ((WLD_GETDAY()) - (1))) && ((FMQ001_SPAWNRECRUITS) == (FALSE))) {
            WLD_INSERTNPC(52886, "PARTM3_RECRUIT_01");
            WLD_INSERTNPC(52911, "PARTM3_RECRUIT_02");
            WLD_INSERTNPC(52933, "PARTM3_RECRUIT_03");
            FMQ001_SPAWNRECRUITS = TRUE;
            PRINTD("Rekruci stworzeni!");
        };
        if ((FMQ001_FIRSTFIGHTCHECK) == (TRUE)) {
            if (HLP_ISVALIDNPC(MIL_4040_RECRUIT)) {
                if ((NPC_ISINSTATE(MIL_4040_RECRUIT, 61603)) && ((FMQ001_TRAININGFIRSTFIGHTRESULT) == (2))) {
                    ...
                    MDL_STARTFACEANI(MIL_4040_RECRUIT, S_NEUTRAL, 1065353216, -1082130432);
            ...
            if ((NPC_ISINSTATE(HERO, 61603)) && ((FMQ001_TRAININGFIRSTFIGHTRESULT) == (2))) {
                if (HLP_ISVALIDNPC(MIL_4040_RECRUIT)) {
                    NPC_SETATTITUDE(MIL_4040_RECRUIT, ATT_NEUTRAL);
                    NPC_SETTEMPATTITUDE(MIL_4040_RECRUIT, ATT_NEUTRAL);
                    MIL_4040_RECRUIT.AIVAR[1] = CRIME_NONE;
        ...
        if ((FMQ001_REMATCHFIGHTCHECK) == (TRUE)) {
            if (HLP_ISVALIDNPC(MIL_4040_RECRUIT)) {
                if ((NPC_ISINSTATE(MIL_4040_RECRUIT, 61603)) && ((FMQ001_TRAININGREMATCHFIGHTRESULT) == (2))) {
                    NPC_SETATTITUDE(MIL_4040_RECRUIT, ATT_NEUTRAL);
                    NPC_SETTEMPATTITUDE(MIL_4040_RECRUIT, ATT_NEUTRAL);
                    MIL_4040_RECRUIT.AIVAR[1] = CRIME_NONE;
                    MIL_4040_RECRUIT.AIVAR[0] = FIGHT_NONE;
            ...
            if ((NPC_ISINSTATE(HERO, 61603)) && ((FMQ001_TRAININGREMATCHFIGHTRESULT) == (2))) {
                if (HLP_ISVALIDNPC(MIL_4040_RECRUIT)) {
                    NPC_SETATTITUDE(MIL_4040_RECRUIT, ATT_NEUTRAL);
                    NPC_SETTEMPATTITUDE(MIL_4040_RECRUIT, ATT_NEUTRAL);
                    MIL_4040_RECRUIT.AIVAR[1] = CRIME_NONE;
        ...
        if ((FMQ001_SECONDFIGHTCHECK) == (TRUE)) {
            if (HLP_ISVALIDNPC(MIL_4041_RECRUIT)) {
                if ((NPC_ISINSTATE(MIL_4041_RECRUIT, 61603)) && ((FMQ001_RECRUIT02DOWN) == (FALSE))) {
            ...
            if (HLP_ISVALIDNPC(MIL_4042_RECRUIT)) {
                if ((NPC_ISINSTATE(MIL_4042_RECRUIT, 61603)) && ((FMQ001_RECRUIT03DOWN) == (FALSE))) {
                    FMQ001_RECRUIDDOWNCOUNT = (FMQ001_RECRUIDDOWNCOUNT) + (1);
                    PRINTD("Pad³ 42");
            ...
            if ((FMQ001_RECRUIDDOWNCOUNT) == (2)) {
                ...
                MDL_STARTFACEANI(MIL_4041_RECRUIT, S_NEUTRAL, 1065353216, -1082130432);
                ...
                MDL_STARTFACEANI(MIL_4042_RECRUIT, S_NEUTRAL, 1065353216, -1082130432);
            ...
            if ((NPC_ISINSTATE(HERO, 61603)) && ((FMQ001_TRAINING2VS1FIGHTRESULT) == (2))) {
                NPC_SETATTITUDE(MIL_4041_RECRUIT, ATT_NEUTRAL);
                NPC_SETTEMPATTITUDE(MIL_4041_RECRUIT, ATT_NEUTRAL);
                MIL_4041_RECRUIT.AIVAR[1] = CRIME_NONE;
                MIL_4041_RECRUIT.AIVAR[0] = FIGHT_NONE;
        ...
        if ((FMQ001_THIRDFIGHTCHECK) == (TRUE)) {
            if (HLP_ISVALIDNPC(MIL_4040_RECRUIT)) {
                if ((NPC_ISINSTATE(MIL_4040_RECRUIT, 61603)) && ((FMQ001_RECRUIT01DOWN) == (FALSE))) {
            ...
            if ((NPC_ISINSTATE(HERO, 61603)) && ((TRAINING3VS1FIGHTRESULT) == (2))) {
                if (HLP_ISVALIDNPC(MIL_4040_RECRUIT)) {
                    NPC_SETATTITUDE(MIL_4040_RECRUIT, ATT_NEUTRAL);
                    NPC_SETTEMPATTITUDE(MIL_4040_RECRUIT, ATT_NEUTRAL);
                    MIL_4040_RECRUIT.AIVAR[1] = CRIME_NONE;
        ...
        if (HLP_ISVALIDNPC(MIL_4043_INSTRUCTOR)) {
            if ((((FMQ001_INSTRUCTORREADYFORACTION) == (FALSE)) && ((NPC_GETDISTTOWP(MIL_4043_INSTRUCTOR, "PART3_PATH_10")) <= (300))) && ((NPC_ISINSTATE(MIL_4043_INSTRUCTOR, 61599)) == (FALSE))) {
        ...
        if (HLP_ISVALIDNPC(MIL_4040_RECRUIT)) {
            if (((((FMQ001_RECRUIT01FMQ001_RACEDONE) == (FALSE)) && ((FMQ001_RUNNINGTOTREE) == (TRUE))) && ((NPC_GETDISTTOWP(MIL_4040_RECRUIT, "PART3_PATH_09")) <= (300))) && ((NPC_ISINSTATE(MIL_4040_RECRUIT, 61599)) == (FALSE))) {
        ...
        if (HLP_ISVALIDNPC(MIL_4041_RECRUIT)) {
            if (((((FMQ001_RECRUIT02FMQ001_RACEDONE) == (FALSE)) && ((FMQ001_RUNNINGTOTREE) == (TRUE))) && ((NPC_GETDISTTOWP(MIL_4041_RECRUIT, "PART3_PATH_09")) <= (300))) && ((NPC_ISINSTATE(MIL_4041_RECRUIT, 61599)) == (FALSE))) {
        ...
        if (HLP_ISVALIDNPC(MIL_4042_RECRUIT)) {
            if (((((FMQ001_RECRUIT03FMQ001_RACEDONE) == (FALSE)) && ((FMQ001_RUNNINGTOTREE) == (TRUE))) && ((NPC_GETDISTTOWP(MIL_4042_RECRUIT, "PART3_PATH_09")) <= (300))) && ((NPC_ISINSTATE(MIL_4042_RECRUIT, 61599)) == (FALSE))) {
        ...
        if ((FMQ001_STARTKANSAIDRIFTO) == (TRUE)) {
            if (((NPC_GETDISTTOWP(MIL_4041_RECRUIT, "PART2_PATH_19")) <= (750)) && ((FMQ001_DEJAVUIJUSTBEENINTHISPLACEBEFOREHIGHERONTHESTREET) == (FALSE))) {
                MDL_APPLYOVERLAYMDSTIMED(MIL_4041_RECRUIT, HUMANSSPRINTMDS, 360000);
                FMQ001_DEJAVUIJUSTBEENINTHISPLACEBEFOREHIGHERONTHESTREET = TRUE;
            };
            if (((((NPC_GETDISTTOWP(MIL_4040_RECRUIT, "PART2_BRIDGE_PATH_02")) <= (300)) && ((FMQ001_STARTKANSAIDRIFTO) == (TRUE))) && ((FMQ001_RECRUIT01FMQ001_RACEDONE) == (FALSE))) && ((NPC_ISINSTATE(MIL_4040_RECRUIT, 61599)) == (FALSE))) {
                MDL_APPLYOVERLAYMDSTIMED(MIL_4040_RECRUIT, HUMANSTIREDMDS, 360000);
                B_STARTOTHERROUTINE(MIL_4040_RECRUIT, "AfterRace");
                NPC_REFRESH(MIL_4040_RECRUIT);
                FMQ001_RECRUIT01FMQ001_RACEDONE = TRUE;
                FMQ001_TELEPORTWINSTAN();
            };
            if ((((NPC_GETDISTTOWP(MIL_4041_RECRUIT, "PART2_BRIDGE_PATH_02")) <= (300)) && ((FMQ001_RECRUIT02FMQ001_RACEDONE) == (FALSE))) && ((NPC_ISINSTATE(MIL_4041_RECRUIT, 61599)) == (FALSE))) {
                MDL_APPLYOVERLAYMDSTIMED(MIL_4041_RECRUIT, HUMANSTIREDMDS, 360000);
                B_STARTOTHERROUTINE(MIL_4041_RECRUIT, "AfterRace");
                NPC_REFRESH(MIL_4041_RECRUIT);
                FMQ001_RECRUIT02FMQ001_RACEDONE = TRUE;
                FMQ001_TELEPORTWINSTAN();
            };
            if ((((NPC_GETDISTTOWP(MIL_4042_RECRUIT, "PART2_BRIDGE_PATH_02")) <= (300)) && ((FMQ001_RECRUIT03FMQ001_RACEDONE) == (FALSE))) && ((NPC_ISINSTATE(MIL_4042_RECRUIT, 61599)) == (FALSE))) {
                MDL_APPLYOVERLAYMDSTIMED(MIL_4042_RECRUIT, HUMANSTIREDMDS, 360000);
