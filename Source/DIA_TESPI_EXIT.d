...
func void DIA_TESPI_QM202_JOB_INFO() {
    ...
    INFO_CLEARCHOICES(72960);
    INFO_ADDCHOICE(72960, "(Speak only positively)", 72964);
    INFO_ADDCHOICE(72960, "(Speak frankly)", 72965);
}
...
func void DIA_TESPI_QM202_TRUTH_INFO() {
    ...
    INFO_CLEARCHOICES(72966);
    INFO_ADDCHOICE(72966, "We won't do it.", 72970);
    INFO_ADDCHOICE(72966, "Just get us there, we'll take care of the rest.", 72971);
}
...
func void DIA_TESPI_QM202_TRUTH_NEXT() {
    ...
    if ((QM202_HELPTESPI) == (1)) {
        ...
        AI_FUNCTION(SELF, 62986);
    };
    AI_FUNCTION(SELF, 62985);
}
...
func int DIA_TESPI_QM202_FIELDCLEAR_CONDITION() {
    if (((LOG_GETSTATUS(MIS_QM202)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 66714))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_TESPI_NOTSURE_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 72975)) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_TESPI_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(72981);
    INFO_ADDCHOICE(72981, DIALOG_BACK, 72985);
    INFO_ADDCHOICE(72981, DIALOG_PICKPOCKET, 72984);
}
