...
func void STORYHELPER_MAINSTORYLINE_CHAPTER1_INFO() {
    ...
    INFO_ADDCHOICE(93359, "8b. GQ001 - Bez Œladu - Rozmowa z Mieszkañcami", 93375);
    INFO_ADDCHOICE(93359, "8a. GQ001 - Bez Œladu - U Kurta", 93374);
...
func void STORYHELPER_MAINSTORYLINE_CHAPTER3_CHOICES() {
    ...
    INFO_ADDCHOICE(93438, "6b. W bia³y dzieñ (œledztwo)", 93456);
...
func void STORYHELPER_SIDESTORYLINE_CHAPTER3_1_ARAXOS() {
    INFO_CLEARCHOICES(93438);
    INFO_ADDCHOICE(93438, DIALOG_BACK, 93440);
    INFO_ADDCHOICE(93438, "Zbieranie liœci", 93450);
...
func void STORYHELPER_MAINSTORYLINE_CHAPTER4_CHOICES() {
    ...
    INFO_ADDCHOICE(93460, "4b. Q404 - Kopalnia (wejœcie)", 93473);
...
func void STORYHELPER_MAINSTORYLINE_CHAPTER5_4() {
    INFO_CLEARCHOICES(93482);
    INFO_ADDCHOICE(93482, "Daj mi wszystkie mo¿liwoœci pracowników", 93499);
    INFO_ADDCHOICE(93482, "Daj mi 0 mo¿liwoœci pracowników", 93500);
}
...
func void STORYHELPER_MAINSTORYLINE_CHAPTER6_CHOICEV7() {
    ...
    INFO_ADDCHOICE(93530, "Kurwa odpalaj miasto", 93542);
    INFO_ADDCHOICE(93530, "7d) Yezegan - Zrobiliœmy wszystkie jego zadania", 93565);
    INFO_ADDCHOICE(93530, "7c) Yezegan - Zrobiliœmy jego Fedexa", 93566);
    INFO_ADDCHOICE(93530, "7b) Yezegan - Zrobiliœmy jego sposobem 'Im siê nale¿y'", 93567);
    INFO_ADDCHOICE(93530, "7a) Yezegan - Nie zrobiliœmy dla niego zadañ", 93568);
}
...
func void STORYHELPER_MAINSTORYLINE_CHAPTER6_CHOICEV9() {
    ...
    INFO_ADDCHOICE(93530, "Kurwa odpalaj miasto", 93542);
    INFO_ADDCHOICE(93530, "9b) Ramsey - W jego zadaniu wybraliœmy ka¿d¹ inn¹ opcjê (NIE MA ZNACZENIA)", 93562);
    INFO_ADDCHOICE(93530, "9a) Ramsey - W jego zadaniu wybraliœmy opcjê 'Kradzie¿' (NIE MA ZNACZENIA)", 93561);
}
...
func void STORYHELPER_MAINSTORYLINE_CHAPTER6_3() {
    ...
    INFO_ADDCHOICE(93530, "1d) Ending - Walczy³em w mieœcie", 93668);
}
...
func void STORYHELPER_MAINSTORYLINE_CHAPTER6_3_CHOICES_04() {
    ...
    INFO_ADDCHOICE(93530, "5b) Stra¿nik - Arwid zosta³ w mieœcie", 93656);
...
func void STORYHELPER_MAINSTORYLINE_CHAPTER6_3_CHOICES_14() {
    ...
    INFO_ADDCHOICE(93530, "Kurwa odpalaj napisy koñcowe", 93582);
    INFO_ADDCHOICE(93530, "15a) Rupert - Pracuje w mieœcie", 93631);
    INFO_ADDCHOICE(93530, "15b) Rupert - Nie pracuje w mieœcie", 93630);
}
...
func void STORYHELPER_MAINSTORYLINE_CHAPTER6_3_CHOICES_15() {
    ...
    INFO_ADDCHOICE(93530, "Kurwa odpalaj napisy koñcowe", 93582);
    INFO_ADDCHOICE(93530, "16a) Timo - Spotkaliœmy go w mieœcie", 93629);
    INFO_ADDCHOICE(93530, "16b) Timo - Nie spotkaliœmy go w mieœcie", 93628);
}
...
func void STORYHELPER_MAINSTORYLINE_CHAPTER6_3_CHOICES_17() {
    ...
    INFO_ADDCHOICE(93530, "18c) Ivy - Zabiliœmy j¹", 93623);
}
...
func void STORYHELPER_SIDESTORYLINE_CHAPTER1_INFO() {
    ...
    INFO_ADDCHOICE(93669, "26. Morskie opowieœci", 93703);
    ...
    INFO_ADDCHOICE(93669, "18. Sprawa ¿ycia lub œmierci", 93691);
    INFO_ADDCHOICE(93669, "17. Krew myœliwego", 93690);
    ...
    INFO_ADDCHOICE(93669, "9. Niech stanie siê œwiat³oœæ", 93682);
    ...
    INFO_ADDCHOICE(93669, "2. OdnaleŸæ Rolfa", 93673);
...
func void STORYHELPER_SIDESTORYLINE_CHAPTER2_INFO() {
    ...
    INFO_ADDCHOICE(93706, "19. Opowieœæ plagi", 93736);
    INFO_ADDCHOICE(93706, "18. Dzielnica Piêœci", 93735);
    ...
    INFO_ADDCHOICE(93706, "9. Oczyœciæ brzeg", 93718);
    INFO_ADDCHOICE(93706, "8. Praca dla rzeŸnika", 93717);
...
func void STORYHELPER_SIDESTORYLINE_CHAPTER3_INFO() {
    ...
    INFO_ADDCHOICE(93738, "22. Opatrznoœæ z góry", 93766);
    ...
    INFO_ADDCHOICE(93738, "14. Braki w ¿ywnoœci", 93758);
    ...
    INFO_ADDCHOICE(93738, "9. Grochem o œciane", 93749);
...
func void STORYHELPER_SIDESTORYLINE_CHAPTER4_INFO() {
    ...
    INFO_ADDCHOICE(93770, "18. Nie do podŸwigniêcia", 93818);
...
func void STORYHELPER_SIDESTORYLINE_CHAPTER4_KING() {
    ...
    INFO_ADDCHOICE(93770, "1. W s³u¿bie jego krolewskiej moœci", 93776);
}
...
func void STORYHELPER_SIDESTORYLINE_CHAPTER4_15_A() {
    ...
    INFO_ADDCHOICE(93770, "2a). Araxos 	- odszed³eœ sam", 93782);
    INFO_ADDCHOICE(93770, "2a). Stra¿nik - odszed³eœ sam", 93781);
