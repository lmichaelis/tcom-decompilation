...
func void SQ503_PREPARENPC() {
    ...
    WLD_INSERTNPC(60158, "PART1_SQ503_MILITIA_03");
    WLD_INSERTNPC(60162, "PART1_SQ503_MILITIA_02");
    WLD_INSERTNPC(60166, "PART1_SQ503_MILITIA_01");
    WLD_INSERTNPC(60231, "PART1_SQ503_ARAXOS_01");
    WLD_INSERTNPC(60235, "PART1_SQ503_ARAXOS_02");
    WLD_INSERTNPC(60239, "PART1_SQ503_ARAXOS_03");
    if ((Q307_POISONWAY) != (1)) {
        if (NPC_KNOWSINFO(HERO, 83911)) {
        ...
        if ((LOG_GETSTATUS(MIS_SQ316)) == (LOG_SUCCESS)) {
...
func void SQ503_TELEPORTVIEWRES() {
    ...
    if (((Q305_JAVAD_WENTTONEWHOME) == (1)) && ((Q509_JAVADVOLFZACKE) != (1))) {
        ...
        TELEPORTNPCTOWP(58566, NONE_6331_JAVAD.WP);
...
func void SQ503_HAVENSCARED() {
    AI_WAIT(PIR_1306_RODRIGO, 1065353216);
    AI_PLAYANI(PIR_1306_RODRIGO, T_SEARCH);
    AI_WAIT(NOV_200_HIERRO, 1053609165);
    AI_PLAYANI(NOV_200_HIERRO, T_SEARCH);
    if ((NPC_ISDEAD(PIR_1300_LEONARDO)) == (FALSE)) {
        AI_WAIT(PIR_1300_LEONARDO, 1068708659);
        AI_PLAYANI(PIR_1300_LEONARDO, T_SEARCH);
    };
    if ((NPC_ISDEAD(PIR_1304_IVAN)) == (FALSE)) {
        AI_WAIT(PIR_1304_IVAN, 1061997773);
        AI_PLAYANI(PIR_1304_IVAN, T_SEARCH);
    };
    if ((Q307_POISONWAY) != (1)) {
        AI_WAIT(PIR_1309_OSCAR, 1056964608);
        AI_PLAYANI(PIR_1309_OSCAR, T_SEARCH);
        AI_WAIT(PIR_1310_VICENTE, 1050253722);
...
func void SQ503_FINALHAVENFIGHT_END_APPLY() {
    var int SQ503_FINALHAVENFIGHT_END_COUNT;
...
func void SQ503_FINALHAVENFIGHT_BEYONDARENA() {
    ...
    if ((Q307_POISONWAY) != (1)) {
        ...
        if ((SQ406_GHOST_POTION) != (3)) {
            ...
            TELEPORTNPCTOWP(58497, PIR_6322_GHOST.WP);
        ...
        if ((NPC_ISDEAD(PIR_1330_ALVAREZ)) == (FALSE)) {
            ...
            TELEPORTNPCTOWP(58828, PIR_1330_ALVAREZ.WP);
        ...
        if ((NPC_ISDEAD(PIR_1307_PROXIMO)) == (FALSE)) {
            ...
            TELEPORTNPCTOWP(58696, PIR_1307_PROXIMO.WP);
            B_KILLNPC(58696);
        };
        if ((NPC_ISDEAD(PIR_1305_OTIS)) == (FALSE)) {
            ...
            TELEPORTNPCTOWP(58664, PIR_1305_OTIS.WP);
            B_KILLNPC(58664);
        };
        if ((NPC_ISDEAD(PIR_1302_MORTY)) == (FALSE)) {
            ...
            TELEPORTNPCTOWP(58638, PIR_1302_MORTY.WP);
        ...
        if ((NPC_ISDEAD(PIR_1301_GREGOR)) == (FALSE)) {
            ...
            TELEPORTNPCTOWP(58633, PIR_1301_GREGOR.WP);
    ...
    if ((NPC_ISDEAD(PIR_13550_PIRATE)) == (FALSE)) {
        ...
        TELEPORTNPCTOWP(58875, PIR_13550_PIRATE.WP);
...
func void SQ503_FINISHQUEST() {
    ...
    if ((MARVIN_MILITIASPECIALIZATION) == (MILITIA_SPECIALIZATION_MASTERCROSSBOWMAN)) {
        CREATEINVITEMS(MIL_4000_RODERICH, 39740, 1);
    };
    if ((MARVIN_ARAXOSSPECIALIZATION) == (ARAXOS_SPECIALIZATION_MASTERARCHER)) {
        CREATEINVITEMS(SLD_5000_LORENZO, 39743, 1);
    };
    if ((MAXWEAPONSKILL) == (HERO.HITCHANCE[2])) {
        if ((HERO.ATTRIBUTE[4]) >= (HERO.ATTRIBUTE[5])) {
            if ((HERO.GUILD) == (GIL_MIL)) {
                CREATEINVITEMS(MIL_4000_RODERICH, 39580, 1);
            } else {
                CREATEINVITEMS(SLD_5000_LORENZO, 39580, 1);
                B_GIVEINVITEMS(SLD_5000_LORENZO, HERO, 39580, 1);
            };
        } else if ((HERO.GUILD) == (GIL_MIL)) {
            CREATEINVITEMS(MIL_4000_RODERICH, 39625, 1);
        } else {
            CREATEINVITEMS(SLD_5000_LORENZO, 39625, 1);
            B_GIVEINVITEMS(SLD_5000_LORENZO, HERO, 39625, 1);
        };
    };
    if ((HERO.GUILD) == (GIL_MIL)) {
        CREATEINVITEMS(MIL_4000_RODERICH, 39558, 1);
    };
    CREATEINVITEMS(SLD_5000_LORENZO, 39558, 1);
    B_GIVEINVITEMS(SLD_5000_LORENZO, HERO, 39558, 1);
...
func void SQ503_CORTEZ_RUNTOHERO() {
    if (NPC_ISINSTATE(PIR_1303_CORTEZ, 43856)) {
        NPC_SETSTATETIME(PIR_1303_CORTEZ, (SPL_TIME_FREEZE) + (1));
    };
    if (NPC_ISINSTATE(PIR_1303_CORTEZ, 43909)) {
        NPC_SETSTATETIME(PIR_1303_CORTEZ, (SPL_TIME_SHORTZAPPED) + (1));
    };
    if (NPC_ISINSTATE(PIR_1303_CORTEZ, 43905)) {
...
func void SQ503_CORTEZ_ATTACK() {
    ...
    if ((PIR_1303_CORTEZ.AIVAR[17]) == (TRUE)) {
        FF_APPLYONCEEXT(63920, 360, 14);
    };
    FF_APPLYONCEEXT(63920, 180, 14);
}

func void SQ503_CORTEZ_ATTACK_APPLY() {
    var int SQ503_CORTEZ_ATTACK_COUNT;
