func void EVENTSMANAGER_KQ406() {
    var int KQ406_CRATES_IDEA_LOGENTRY;
    var int KQ406_GOTWOOD_LOGENTRY;
    ...
    if ((KQ406_WAITFORSABOTEUR) == (1)) {
        if (((KQ406_WAITFORSABOTEUR_DAY) <= ((WLD_GETDAY()) - (1))) || ((NPC_GETDISTTOWP(HERO, "HARBOUR_PATH_199")) >= (7000))) {
            KQ406_WAITFORSABOTEUR = 2;
            KQ406_PREPAREANGRYMOB();
        };
    };
    if ((KQ406_FIGHTWITHWORKER) == (1)) {
        if (((NPC_GETDISTTONPC(HERO, VLK_13676_WORKER)) >= (1500)) && ((NPC_ISINSTATE(VLK_13676_WORKER, 61599)) == (FALSE))) {
