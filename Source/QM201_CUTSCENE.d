...
func void QM201_CUTSCENE_START() {
    ...
    TELEPORTNPCTOWP(1819, "HARBOUR_PATH_503");
    TELEPORTNPCTOWP(52847, MIL_4016_WEGAR.WP);
    AI_FUNCTION(MIL_4016_WEGAR, 92824);
...
func void QM201_CUTSCENE_FADE() {
    FADESCREENTOBLACKF(3, 92825, 1000);
}

func void QM201_CUTSCENE_FADESCREEN() {
    TELEPORTNPCTOWP(1819, "HARBOUR_QM201_HERO");
    TELEPORTNPCTOWP(52847, MIL_4016_WEGAR.WP);
    B_STARTOTHERROUTINE(MIL_13583_MILITIA, START);
    TELEPORTNPCTOWP(53890, MIL_13583_MILITIA.WP);
    B_STARTOTHERROUTINE(NONE_13584_PRISONER, START);
    TELEPORTNPCTOWP(53951, NONE_13584_PRISONER.WP);
    B_STARTOTHERROUTINE(NONE_13585_THUG, START);
    TELEPORTNPCTOWP(53954, NONE_13585_THUG.WP);
    B_STARTOTHERROUTINE(NONE_13586_THUG, START);
    TELEPORTNPCTOWP(53957, NONE_13586_THUG.WP);
    B_STARTOTHERROUTINE(NONE_13587_THUG, START);
    TELEPORTNPCTOWP(53960, NONE_13587_THUG.WP);
    WLD_SETTIME(1, 30);
    FF_APPLYONCEEXT(92826, 1500, 5);
    ...
    AI_WAIT(NONE_13585_THUG, 1088841318);
    AI_WAIT(MIL_4016_WEGAR, 1088841318);
    QM201_CUTSCENE_WAIT();
    ...
    QM201_CUTSCENE_WAIT();
    AI_FUNCTION(MIL_4016_WEGAR, 92828);
    ...
    AI_FUNCTION(NONE_13585_THUG, 92831);
}

func void QM201_CUTSCENE_FADESCREEN_APPLY() {
    var int QM201_CUTSCENE_FADESCREEN_COUNT;
