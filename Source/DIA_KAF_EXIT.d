...
func void KAF_EQUIPARMOR() {
    CREATEINVITEM(VLK_6249_KAF, 35427);
    NPC_REMOVEINVITEMS(VLK_6249_KAF, 35553, 1);
    AI_EQUIPARMOR(VLK_6249_KAF, 35427);
}
...
func int DIA_KAF_FAQ002_TRAP_CONDITION() {
    if ((FAQ002_FIGHTWITHKAF) == (2)) {
        if (((NPC_GETDISTTOWP(SELF, RNG_TRAP07_WAYPOINT)) < (500)) && (NPC_KNOWSINFO(OTHER, 75565))) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
...
func void DIA_KAF_FAQ002_TRAP_INFO() {
    ...
    AI_FUNCTION(SELF, 75579);
    AI_FUNCTION(SELF, 75578);
    ...
    INFO_CLEARCHOICES(75570);
    INFO_ADDCHOICE(75570, "Why is Ernesto so important to you?", 75576);
    INFO_ADDCHOICE(75570, "Who's your boss?", 75577);
}
...
func void INSERJEFANDROF() {
    WLD_INSERTNPC(53436, "PARTM3_PATH_34");
    WLD_INSERTNPC(53433, "PARTM3_PATH_43");
}

func void JEFANDROFCAM() {
    TELEPORTNPCTOWP(1819, "PARTM3_KAFTRAP_05");
