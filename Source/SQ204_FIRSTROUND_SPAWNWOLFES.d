func void SQ204_FIRSTROUND_SPAWNWOLFES() {
    ...
    WLD_INSERTNPC(50912, "PART11_PATH_101");
    WLD_INSERTNPC(50913, "PART11_MOB_06");
    WLD_INSERTNPC(50914, "PART11_MOB_07");
    WLD_INSERTNPC(50915, "PART11_MOB_05");
    WLD_INSERTNPC(50916, "PART11_PATH_109");
}

func void SQ204_SPAWNHURTEDWOLF() {
    WLD_INSERTNPC(57262, "PART11_WOLFDETLOWA_HURT");
}

func void SQ204_SPAWNARMYOFWOLVES() {
    PRINTD("Wilki zrespione!");
    WLD_INSERTNPC(50923, TOT);
    WLD_INSERTNPC(50927, TOT);
    WLD_INSERTNPC(50931, TOT);
    WLD_INSERTNPC(50935, TOT);
    WLD_INSERTNPC(50939, TOT);
    WLD_INSERTNPC(50944, TOT);
}
...
func void SQ204_MOVEARMYOFWOLVES() {
    ...
    TELEPORTNPCTOWP(50923, WOLF_DETLOW_07.WP);
    TELEPORTNPCTOWP(50927, WOLF_DETLOW_08.WP);
    TELEPORTNPCTOWP(50931, WOLF_DETLOW_11.WP);
    TELEPORTNPCTOWP(50935, WOLF_DETLOW_12.WP);
    TELEPORTNPCTOWP(50939, WOLF_DETLOW_13.WP);
    TELEPORTNPCTOWP(50944, WOLF_DETLOW_14.WP);
    HERO.AIVAR[4] = FALSE;
}
...
func void SQ204_KILLHURTEDWOLF_DAMAGE() {
    ...
    B_MAGICHURTNPC(HERO, WOLF_DETLOW_HURT, 9999);
    HERO.AIVAR[4] = FALSE;
}
...
func void SQ204_DETLOW_THIRDROUND_FINISHCAMERA() {
    var int SQ204_DETLOW_THIRDROUND_COUNT;
