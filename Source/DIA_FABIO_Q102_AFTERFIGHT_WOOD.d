...
func int DIA_FABIO_Q102_AFTERFIGHT_WOOD_CONDITION() {
    if (((FABIOWOODFIGHT) && (NPC_ISINSTATE(SELF, 61599))) && ((LOG_GETSTATUS(MIS_Q102)) == (LOG_RUNNING))) {
...
func void TRIA_FABIO_CHANGECAMERA_01() {
    ...
    TELEPORTNPCTOWP(51439, NONE_5_FABIO.WP);
    TELEPORTNPCTOWP(51512, NONE_1_JORN.WP);
...
func void TRIA_FABIO_CHANGECAMERA_UNLOCKALL() {
    FF_APPLYONCEEXT(91174, 75, 4);
}

func void TRIA_FABIO_CHANGECAMERA_UNLOCKALL_APPLY() {
    var int TRIA_FABIO_CHANGECAMERA_UNLOCKALL_COUNT;
...
func void TRIA_FABIO_Q102_JORNTRIALOG_INFO() {
    ...
    INFO_CLEARCHOICES(91161);
    INFO_ADDCHOICE(91161, "Are you sure you remember the way to the village?", 91184);
    INFO_ADDCHOICE(91161, "What condition are the survivors in?", 91185);
    INFO_ADDCHOICE(91161, "Maybe we can find this village?", 91186);
    INFO_ADDCHOICE(91161, "Will we be safe in the cave?", 91187);
}
...
func void TRIA_FABIO_Q102_JORNTRIALOG_FINISH() {
    ...
    AI_STOPLOOKAT(SELF);
    AI_STOPLOOKAT(OTHER);
    AI_FUNCTION(SELF, 62035);
    AI_STOPPROCESSINFOS(SELF);
    AI_FUNCTION(SELF, 91173);
}
...
func void TRIA_FABIO_Q102_JORNTRIALOG_QUESTION_END_NEXT() {
    ...
    INFO_CLEARCHOICES(91161);
    INFO_ADDCHOICE(91161, CHOICE_FABIO_Q102_JORNTRIALOG_QUESTION_GOWITHJORN, 91179);
    INFO_ADDCHOICE(91161, CHOICE_FABIO_Q102_JORNTRIALOG_QUESTION_GOWITHFABIO, 91178);
}

var int TRIA_FABIO_Q102_JORNTRIALOG_QUESTION_END_NEXT_ADDED;
func void TRIA_FABIO_Q102_JORNTRIALOG_QUESTION_END() {
    var int FABIO_Q102_QUESTIONCOUNT;
    ...
    if ((TRIA_FABIO_Q102_JORNTRIALOG_QUESTION_END_NEXT_ADDED) == (FALSE)) {
        if ((FABIO_Q102_QUESTIONCOUNT) >= (2)) {
            INFO_ADDCHOICE(91161, "That's all I needed to know.", 91180);
...
func void KAZEEMGOGATHERWOOD() {
    ...
    AI_STOPLOOKAT(SELF);
    AI_STOPLOOKAT(OTHER);
    AI_FUNCTION(NONE_5_FABIO, 91203);
    AI_STOPPROCESSINFOS(SELF);
    AI_FUNCTION(SELF, 62044);
}

var int KAZEEMGATHERWOOD;
func void TRIA_FABIO_Q102_MOLERATS_INFO() {
    ...
    INFO_ADDCHOICE(91188, "All right, I'll go.", 91193);
    INFO_ADDCHOICE(91188, "Go get that brushwood yourself.", 91194);
    if ((Q101_FABIOWANTBEER) == (2)) {
        INFO_ADDCHOICE(91188, "I brought you a beer, remember?", 91199);
    };
    INFO_ADDCHOICE(91188, "Send someone else.", 91195);
}
...
func void TRIA_FABIO_Q102_MOLERAT_NOWAY() {
    ...
    INFO_ADDCHOICE(91188, "Okay, okay, I'll go...", 91196);
    INFO_ADDCHOICE(91188, "Make me.", 91198);
}
...
var int FABIOKAZEEMSMALLTALK;
var int FABIOKAZEEMSMALLTALK2;
var int FABIOAFTERFIRE;
...
func void DIA_FABIO_KAZEEM_FIREPLACE() {
    ...
    AI_FUNCTION(NONE_5_FABIO, 91209);
    AI_PLAYANI(NONE_5_FABIO, T_PLUNDER);
    AI_FUNCTION(NONE_5_FABIO, 91206);
    ...
    AI_FUNCTION(NONE_5_FABIO, 62036);
...
func int DIA_FABIO_Q102_WOOD_CONDITION() {
    if (((((NPC_KNOWSINFO(OTHER, 91188)) && ((KAZEEMGATHERWOOD) == (FALSE))) && ((Q102_FABIOGATHERWOOD) == (FALSE))) && ((NPC_HASITEMS(OTHER, 37029)) > (0))) && ((LOG_GETSTATUS(MIS_Q102)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void FABIO_Q102_FIREPLACECUTSCENE() {
    ...
    AI_FUNCTION(SELF, 91205);
}

func void DIA_FABIO_Q102_WOOD_INFO() {
    var int MARVINCURRENTBRUSHWOOD;
    MARVINCURRENTBRUSHWOOD = NPC_HASITEMS(OTHER, 37029);
    Q102_FABIOGIVEMEAT = TRUE;
    ...
    NPC_REMOVEINVITEMS(SELF, 37029, MARVINCURRENTBRUSHWOOD);
    FABIO_Q102_FIREPLACECUTSCENE();
    B_GIVEINVITEMS(OTHER, SELF, 37029, MARVINCURRENTBRUSHWOOD);
}
...
func int DIA_FABIO_Q102_NIGHT_CONDITION() {
    if ((FABIOTOSILBACH) == (FALSE)) {
        if ((NPC_KNOWSINFO(OTHER, 91207)) || ((FABIOAFTERFIRE) && ((LOG_GETSTATUS(MIS_Q102)) == (LOG_RUNNING)))) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
...
func void DIA_FABIO_Q102_TOSILBACH_INFO() {
    ...
    INFO_CLEARCHOICES(91222);
    INFO_ADDCHOICE(91222, "Let's go.", 91225);
    INFO_ADDCHOICE(91222, "Why us?", 91226);
}
...
func int DIA_FABIO_Q103_VILLAGE_CONDITION() {
    if (((((SILBACHSLEEP) == (2)) && (NPC_ISINSTATE(SELF, 61599))) && ((LOG_GETSTATUS(MIS_Q102)) == (LOG_SUCCESS))) && ((Q102_JORNCHOSEN) == (TRUE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_FABIO_GQ001_JORNGONE_INFO() {
    ...
    INFO_CLEARCHOICES(91230);
    INFO_ADDCHOICE(91230, "Do you know anything about Jorn's disappearance?", 91233);
}
...
func void DIA_FABIO_GQ001_JORNGONE_UKNOW() {
    ...
    INFO_CLEARCHOICES(91230);
    INFO_ADDCHOICE(91230, "Okay, thanks.", 91234);
    INFO_ADDCHOICE(91230, "Are you sure?", 91235);
}
...
var int PLAYERWONTHELPFABIOWITHBEER;
var int Q104_FABIODEAL;
...
func void DIA_FABIO_Q104_FRATERNALASSISTANCE_INFO() {
    ...
    INFO_CLEARCHOICES(91238);
    INFO_ADDCHOICE(91238, "You could finally do something on your own.", 91244);
    INFO_ADDCHOICE(91238, "What's in it for me?", 91241);
    INFO_ADDCHOICE(91238, "What specifically do you want me to do?", 91242);
    INFO_CLEARCHOICES(91252);
    INFO_ADDCHOICE(91252, "What specifically do you want me to do?", 91242);
}
...
func void DIA_FABIO_Q104_FRATERNALASSISTANCE2() {
    ...
    INFO_CLEARCHOICES(91238);
    INFO_ADDCHOICE(91238, "I'll see what I can do.", 91243);
    INFO_ADDCHOICE(91238, "You could finally do something on your own.", 91244);
    INFO_CLEARCHOICES(91252);
    INFO_ADDCHOICE(91252, "I'll see what I can do.", 91243);
}
...
var int FABIOWONTWORKWITHOUTBEER;
...
func int DIA_FABIO_Q104_STAKEANDBEER_CONDITION() {
    if ((LOG_GETSTATUS(MIS_Q104)) == (LOG_RUNNING)) {
        if (((NPC_KNOWSINFO(OTHER, 91238)) && ((Q104_FABIODEAL) == (TRUE))) && ((NPC_HASITEMS(OTHER, 36413)) >= (1))) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
...
func void DIA_FABIO_Q104_STAKEANDBEER_INFO() {
    NPC_REMOVEINVITEMS(OTHER, 36413, 1);
    ...
    CREATEINVITEMS(SELF, 34203, Q104_FABIOREWARD);
    ...
    B_GIVEINVITEMS(SELF, OTHER, 34203, Q104_FABIOREWARD);
}
...
func int DIA_FABIO_Q104_WORKFORALBYN_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 87695)) && ((LOG_GETSTATUS(MIS_Q104)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_FABIO_SQ103_WENEEDHELP_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ103)) == (LOG_RUNNING)) && ((Q102_FABIOCHOSEN) == (TRUE))) && (!(NPC_KNOWSINFO(OTHER, 91539)))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_FABIO_GQ001_WHEREISJORN_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 87898)) && ((LOG_GETSTATUS(MIS_Q201)) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_FABIO_GQ001_WHEREISJORN_INFO() {
    ...
    INFO_CLEARCHOICES(91261);
    INFO_ADDCHOICE(91261, "Tell me what you know or I'll teach you a lesson.", 91266);
    INFO_ADDCHOICE(91261, "The Elder will know everything.", 91267);
}
...
func void DIA_FABIO_Q401_MEETING_INFO() {
    ...
    INFO_CLEARCHOICES(91274);
    INFO_ADDCHOICE(91274, "Why are you hanging out here?", 91277);
    INFO_ADDCHOICE(91274, "Couldn't you set up camp somewhere else?", 91278);
}
...
func int DIA_FABIO_Q401_GOAWAY_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 91274)) && ((LOG_GETSTATUS(MIS_Q401)) == (LOG_RUNNING))) {
        if (((Q401_DUSTERBIZZAREADVENTURE) < (4)) && ((NPC_KNOWSINFO(OTHER, 67226)) == (FALSE))) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
...
var int FABIO_GOAWAY_NOTGOOD;
var int FABIO_GOAWAY_COMPANIONS;
var int FABIO_GOAWAY_MINE;
var int FABIO_GOAWAY_VINEYARD;
var int FABIO_GOAWAY_PROTECT;
func void DIA_FABIO_Q401_GOAWAY_CHOICES() {
    INFO_CLEARCHOICES(91279);
    INFO_ADDCHOICE(91279, "I don't think we're going to reach a compromise.", 91297);
    if ((FABIO_GOAWAY_COMPANIONS) == (FALSE)) {
        INFO_ADDCHOICE(91279, "Do your comrades have any right to vote?", 91296);
    };
    if (((((FABIO_GOAWAY_MINE) == (FALSE)) || ((FABIO_GOAWAY_VINEYARD) == (FALSE))) || ((NPC_KNOWSINFO(OTHER, 81447)) && ((Q401_FABIOJOINTS) == (FALSE)))) || ((FABIO_GOAWAY_PROTECT) == (FALSE))) {
        INFO_ADDCHOICE(91279, "You could earn everything you need.", 91290);
    };
    if ((FABIO_GOAWAY_NOTGOOD) == (FALSE)) {
        INFO_ADDCHOICE(91279, "Think: this is not a good place to camp.", 91289);
    };
}

func void DIA_FABIO_Q401_GOAWAY_WORK_PROPOSITION() {
    INFO_CLEARCHOICES(91279);
    INFO_ADDCHOICE(91279, DIALOG_BACK, 91295);
    if ((FABIO_GOAWAY_MINE) == (FALSE)) {
        INFO_ADDCHOICE(91279, "You can work in any mine.", 91291);
    };
    if ((FABIO_GOAWAY_VINEYARD) == (FALSE)) {
        INFO_ADDCHOICE(91279, "Every pair of hands comes in handy in the vineyards.", 91292);
    };
    if (((Q401_FABIOJOINTS) == (FALSE)) && (NPC_KNOWSINFO(OTHER, 81447))) {
        INFO_ADDCHOICE(91279, "Start growing something.", 91293);
    };
    if ((FABIO_GOAWAY_PROTECT) == (FALSE)) {
        INFO_ADDCHOICE(91279, "Maybe protect the farmers from field raiders?", 91294);
    };
}
...
func int DIA_FABIO_Q401_JOINTS_CONDITION() {
    if (((((NPC_KNOWSINFO(OTHER, 91279)) && (NPC_KNOWSINFO(OTHER, 81447))) && ((Q401_FABIOJOINTS) == (FALSE))) && ((LOG_GETSTATUS(MIS_Q401)) == (LOG_RUNNING))) && ((NPC_KNOWSINFO(OTHER, 67226)) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_FABIO_Q401_GOSWAMP_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_Q401)) == (LOG_RUNNING)) && ((Q401_FABIOFRIENDSCOUNT) != (4))) && ((Q401_FABIOJOINTS) >= (1))) && ((NPC_KNOWSINFO(OTHER, 67226)) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_FABIO_Q401_GOTPROTECTION_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_Q401)) == (LOG_RUNNING)) && ((Q401_FABIONEEDSPROTECTION) == (1))) && ((NPC_KNOWSINFO(OTHER, 67226)) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_FABIO_Q401_GOTPROTECTION_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (Q401_FABIOPRICE)) {
        SELF.FLAGS = 2;
        NPC_REMOVEINVITEMS(SELF, 34203, Q401_FABIOPRICE);
        AI_OUTPUT(SELF, OTHER, "DIA_Fabio_Q401_GotProtection_05_02");
        B_GIVEINVITEMS(OTHER, SELF, 34203, Q401_FABIOPRICE);
...
func int DIA_FABIO_AMBIENT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 64810)) || ((LOG_GETSTATUS(MIS_Q102)) > (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_FABIO_AMBIENT_INFO() {
    ...
    if ((KAPITEL) >= (4)) {
        if ((LOG_GETSTATUS(MIS_Q401)) > (0)) {
            if (((LOG_GETSTATUS(MIS_Q401)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 91279))) {
