...
func void DIA_COURIER_NS62_START_INFO() {
    ...
    INFO_ADDCHOICE(78328, "Yeah, I'm Barvin.", 78331);
    INFO_ADDCHOICE(78328, "No, you have me confused with someone.", 78332);
}
...
func void DIA_COURIER_NS62_BARVIN() {
    ...
    CREATEINVITEMS(SELF, 38209, 1);
    B_GIVEINVITEMS(SELF, OTHER, 38209, 1);
...
func int DIA_COURIER_NS62_NOTIME_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 78328)) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
