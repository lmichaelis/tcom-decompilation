var int ALLANCANTEACHUSCROSSBOW;
var int ALLANCANTEACHUSHUNT;
var int ALLANHUNTTEACHINFO;
...
func void DIA_ALLAN_TRAIN_CHOICES() {
    var int ALLAN_GOLDCOST;
    ALLAN_GOLDCOST = 15;
    ALLAN_CURRENTCBLEVEL = OTHER.AIVAR[87];
    INFO_CLEARCHOICES(74815);
    INFO_ADDCHOICE(74815, DIALOG_BACK, 74820);
    INFO_ADDCHOICE(74815, B_BUILDLEARNSTRING2(PRINT_LEARNCROSSBOW1, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_CROSSBOW, 1), ALLAN_GOLDCOST), 74821);
    INFO_ADDCHOICE(74815, B_BUILDLEARNSTRING2(PRINT_LEARNCROSSBOW5, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_CROSSBOW, 5), (ALLAN_GOLDCOST) * (5)), 74822);
}
...
func void DIA_ALLAN_TRAIN_CROSSBOW1() {
    if ((NPC_HASITEMS(OTHER, 34203)) >= (ALLAN_PAYMENT1)) {
        if ((ALLAN_CURRENTCBLEVEL) < (OTHER.AIVAR[87])) {
            SND_PLAY(GELDBEUTEL);
            B_GIVEINVITEMS(OTHER, SELF, 34203, ALLAN_PAYMENT1);
            NPC_REMOVEINVITEMS(SELF, 34203, ALLAN_PAYMENT1);
        };
...
func void DIA_ALLAN_TRAIN_CROSSBOW5() {
    if ((NPC_HASITEMS(OTHER, 34203)) >= (ALLAN_PAYMENT5)) {
        if ((ALLAN_CURRENTCBLEVEL) < (OTHER.AIVAR[87])) {
            B_GIVEINVITEMS(OTHER, SELF, 34203, ALLAN_PAYMENT5);
            SND_PLAY(GELDBEUTEL);
            NPC_REMOVEINVITEMS(SELF, 34203, ALLAN_PAYMENT5);
        };
...
func void DIA_ALLAN_TEACHHUNT_CHOICES() {
    INFO_CLEARCHOICES(74823);
    INFO_ADDCHOICE(74823, DIALOG_BACK, 74829);
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[0]) == (FALSE)) {
        INFO_ADDCHOICE(74823, B_BUILDLEARNSTRING2(PRINT_TEACHTEETH, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_TEETH), ALLAN_CLAWSTROPHY), 74828);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[1]) == (FALSE)) {
        INFO_ADDCHOICE(74823, B_BUILDLEARNSTRING2(PRINT_TEACHCLAWS, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_CLAWS), ALLAN_TEETHTROPHY), 74827);
    };
}
...
func void DIA_ALLAN_TEACHHUNT_CLAWS() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (ALLAN_CLAWSTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[1]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 34203, ALLAN_CLAWSTROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Allan_TeachHunt_Claws_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 34203, ALLAN_CLAWSTROPHY);
...
func void DIA_ALLAN_TEACHHUNT_TEETH() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (ALLAN_TEETHTROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[0]) == (TRUE)) {
            NPC_REMOVEINVITEMS(SELF, 34203, ALLAN_TEETHTROPHY);
...
func int DIA_ALLAN_CQ002_HUNT_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 74807)) && ((LOG_GETSTATUS(MIS_CQ002)) == (LOG_RUNNING))) && ((LOG_GETSTATUS(MIS_SQ416)) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_ALLAN_CQ002_TRACE_CONDITION() {
    if ((((NPC_KNOWSINFO(OTHER, 74836)) && ((NPC_GETDISTTOWP(SELF, "PART3_MOB_31")) <= (550))) && ((LOG_GETSTATUS(MIS_CQ002)) == (LOG_RUNNING))) && ((LOG_GETSTATUS(MIS_SQ416)) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ALLAN_SQ416_DRINK_INFO() {
    ...
    CREATEINVITEMS(SELF, 34198, 1);
    B_GIVEINVITEMS(SELF, OTHER, 34198, 1);
    ...
    INFO_CLEARCHOICES(74845);
    INFO_ADDCHOICE(74845, "It must be something completely different.", 74857);
    INFO_ADDCHOICE(74845, "Dragon snapper.", 74856);
    INFO_ADDCHOICE(74845, "Shadowbeast.", 74855);
}
...
func void DIA_ALLAN_SQ416_DRINK_ALLAN_NEXT() {
    ...
    AI_TURNTONPC(SELF, OTHER);
    INFO_CLEARCHOICES(74845);
    INFO_ADDCHOICE(74845, "To the hunt! (drink)", 74849);
    INFO_ADDCHOICE(74845, "I'm not going to drink before hunting.", 74850);
}
...
func void DIA_ALLAN_SQ416_DRINK_ALLAN_NEXT_NO() {
    ...
    AI_FUNCTION(SELF, 63554);
    AI_FUNCTION(SELF, 63589);
    INFO_CLEARCHOICES(74845);
    INFO_ADDCHOICE(74845, "All right, give me that beer.", 74851);
    INFO_ADDCHOICE(74845, "I prefer to keep my mind fully sober.", 74852);
}
...
func void DIA_ALLAN_HUNTING_BASE_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (ALLAN_BASETROPHY)) {
        if ((PLAYER_TALENT_TAKEANIMALTROPHY[2]) == (TRUE)) {
            ...
            NPC_REMOVEINVITEMS(SELF, 34203, ALLAN_BASETROPHY);
            AI_OUTPUT(SELF, OTHER, "DIA_Allan_Hunting_Base_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 34203, ALLAN_BASETROPHY);
...
func void DIA_ALLAN_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(74861);
    INFO_ADDCHOICE(74861, DIALOG_BACK, 74865);
    INFO_ADDCHOICE(74861, DIALOG_PICKPOCKET, 74864);
}

func void DIA_ALLAN_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (2)) {
        CREATEINVITEMS(SELF, 35350, 1);
        B_GIVEINVITEMS(SELF, OTHER, 35350, 1);
