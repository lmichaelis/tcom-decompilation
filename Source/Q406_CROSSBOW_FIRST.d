instance Q406_CROSSBOW_FIRST(CUTSCENE) {
    ONSTART = FUNCTION(92640);
}

func void Q406_CROSSBOW_FIRST_START() {
    WLD_SENDTRIGGER("KM_CROSSBOW_01");
    TELEPORTNPCTOWP(56833, NONE_6443_VOLKERGUARD.WP);
    TELEPORTNPCTOWP(56836, NONE_6444_VOLKERGUARD.WP);
    TELEPORTNPCTOWP(56848, NONE_6448_VOLKERGUARD_CROSSBOW.WP);
    TELEPORTNPCTOWP(56853, NONE_6449_VOLKERGUARD_CROSSBOW.WP);
    TELEPORTNPCTOWP(1819, "PART9_PATH_109");
    TELEPORTNPCTOWP(56688, "PART9_PATH_110");
    ...
    AI_FUNCTION(HERO, 92641);
}

func void Q406_CROSSBOW_FIRST_END() {
    FF_APPLYONCEEXT(92642, 1000, 4);
}
