...
func int DIA_DACK_SQ203_FINISH_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ203)) == (LOG_RUNNING)) && ((NPC_HASITEMS(OTHER, 37137)) >= (1))) && (NPC_KNOWSINFO(OTHER, 71719))) {
        return TRUE;
    };
...
func void DIA_DACK_SQ203_FINISH_INFO() {
    ...
    NPC_REMOVEINVITEMS(SELF, 37137, 1);
    B_STANDUP();
    ...
    CREATEINVITEMS(SELF, 34203, SQ203_REWARD);
    B_GIVEINVITEMS(SELF, OTHER, 34203, SQ203_REWARD);
}
...
func int DIA_DACK_AMBIENT_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 71719)) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}

var int DACK_WANTTOSEESON;
func void DIA_DACK_AMBIENT_INFO() {
    if ((NPC_KNOWSINFO(OTHER, 71742)) == (FALSE)) {
...
var int DACK_CANTEACHYOU;
func int DIA_DACK_TEACH_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 71729)) && ((DACK_CANTEACHYOU) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DACK_TEACH_CHOICES() {
    INFO_CLEARCHOICES(71732);
    INFO_ADDCHOICE(71732, DIALOG_BACK, 71739);
    if ((HERO_HACKCHANCE) <= (85)) {
        INFO_ADDCHOICE(71732, B_BUILDLEARNSTRING2(PRINT_LEARN_MINE5, 0, DACK_PAYMENT2), 71741);
    };
    if ((HERO_HACKCHANCE) <= (89)) {
        INFO_ADDCHOICE(71732, B_BUILDLEARNSTRING2(PRINT_LEARN_MINE1, 0, DACK_PAYMENT1), 71740);
    };
}
...
func void DIA_DACK_TEACH_1POINTS() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (DACK_PAYMENT1)) {
        if ((HERO_HACKCHANCE) < (100)) {
...
func void DIA_DACK_TEACH_5POINTS() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (DACK_PAYMENT2)) {
...
func void DIA_DACK_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(71745);
    INFO_ADDCHOICE(71745, DIALOG_BACK, 71749);
    INFO_ADDCHOICE(71745, DIALOG_PICKPOCKET, 71748);
}
