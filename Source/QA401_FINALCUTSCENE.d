...
func void QA401_FINALCUTSCENE_START() {
    ...
    if ((NPC_HASITEMS(SLD_5002_SUNDER, 34387)) == (0)) {
        CREATEINVITEMS(SLD_5002_SUNDER, 34387, 1);
    };
    CREATEINVITEMS(SLD_5002_SUNDER, 34383, 10);
    ...
    TELEPORTNPCTOWP(1819, "PART1_CAVE_UP_HERO");
    ...
    QA401_FINALCUTSCENE_WAIT();
    AI_FUNCTION(SLD_1000_ADELARD, 92803);
    ...
    QA401_FINALCUTSCENE_WAIT();
    AI_FUNCTION(SLD_1000_ADELARD, 92804);
...
func void QA401_FINALCUTSCENE_PART2() {
    ...
    AI_FUNCTION(SLD_1000_ADELARD, 92815);
    ...
    AI_FUNCTION(SLD_1000_ADELARD, 92816);
    QA401_FINALCUTSCENE_WAIT();
    AI_FUNCTION(SLD_1000_ADELARD, 92817);
...
func void QA401_ISGETORYXREALLYDEAD() {
    if (!(NPC_ISDEAD(NONE_7002_GETORYX))) {
        B_MAGICHURTNPC(SLD_5002_SUNDER, NONE_7002_GETORYX, 9999);
        PRINTD("Dobij kurwe");
    };
}
...
func void QA401_FINALCUTSCENE_CAMERA_03() {
    ...
    TELEPORTNPCTOWP(55606, "PART1_FISHER_BEACH_CARAMON_03");
}
...
func void QA401_FINALCUTSCENE_CAMERA_14() {
    ...
    TELEPORTNPCTOWP(55579, "PART1_CAVE_UP_04");
}

func void QA401_FINALCUTSCENE_END() {
    FADESCREENTOBLACKF(5, 92818, 1000);
}

func void QA401_FINALCUTSCENE_END_FADESCREEN() {
    FF_APPLYONCEEXT(92819, 75, 4);
}

func void QA401_FINALCUTSCENE_END_APPLY() {
    var int QA401_FINALCUTSCENE_END_COUNT;
