func void QA401_PREPARENPC() {
    ...
    FF_APPLYONCEEXTGT(62877, 0, -(1));
    WLD_INSERTNPC(53930, "HARBOUR_SHIPYARD_QA401_WORKER_01");
    WLD_INSERTNPC(53934, "HARBOUR_SHIPYARD_QA401_WORKER_02");
    WLD_INSERTNPC(53938, "HARBOUR_SHIPYARD_QA401_WORKER_03");
    ...
    WLD_INSERTNPC(53942, "SLUMS_QA401_BODYGUARD_01");
    WLD_INSERTNPC(53945, "SLUMS_QA401_BODYGUARD_02");
    ...
    WLD_INSERTNPC(52099, "PART4_QA401_OTMAR");
    WLD_INSERTNPC(55878, "PART4_QA401_ARAXOS");
    WLD_INSERTNPC(55632, TOT);
}

func void QA401_EVENTS_APPLY() {
    var ZCMOVER MOVER8;
    var int QA401_EVENTS_COUNT;
    var int MOVPTR6;
    var int MOVPTR4;
    var int MOVPTR1;
    var int MOVPTR3;
...
func void QA401_PREPAREARAXOSBEACH() {
    ...
    NPC_CHANGEARMOR(SLD_1009_CARAMON, 33907);
    ...
    NPC_CHANGEARMOR(SLD_5002_SUNDER, 35572);
    NPC_REMOVEINVITEMS(SLD_5002_SUNDER, 35465, 1);
    B_STARTOTHERROUTINE(SLD_1000_ADELARD, "QA401_BEACH_WAIT");
    QA401_ADELARD_RTNCHECK = 2;
    NPC_REFRESH(SLD_1000_ADELARD);
    TELEPORTNPCTOWP(51978, SLD_1000_ADELARD.WP);
    NPC_CHANGEARMOR(SLD_1000_ADELARD, 33907);
    NPC_REMOVEINVITEMS(SLD_1000_ADELARD, 35459, 1);
    ...
    NPC_CHANGEARMOR(SLD_13548_ARAXOS, 35571);
    NPC_REMOVEINVITEMS(SLD_13548_ARAXOS, 35454, 1);
    ...
    NPC_CHANGEARMOR(SLD_13549_ARAXOS, 33906);
    NPC_REMOVEINVITEMS(SLD_13549_ARAXOS, 35470, 1);
}
...
func void QA401_DOORCUTSCENE_KICKDOOR_END() {
    var int QA401_DOORCUTSCENE_KICKDOOR_END_COUNT;
...
func void QA401_GOAWAY_BLOCKER_FADESCREEN() {
    ...
    TELEPORTNPCTOWP(1819, "PART1_CAVE_IN_01");
    TELEPORTNPCTOWP(51996, SLD_1009_CARAMON.WP);
...
func void QA401_GIVEITEMS() {
    CREATEINVITEMS(SELF, 34203, QA401_SMUGGLERPAY);
    B_GIVEINVITEMS(SELF, OTHER, 34203, QA401_SMUGGLERPAY);
    ...
    B_GIVEINVITEMS(SELF, OTHER, 34225, 1);
}
...
func void QA401_REMOVEFIRECRATES() {
    ...
    NPC = HLP_GETNPC(1819);
    NPCPTR = _@(62928);
    FF_APPLYEXTDATAGT(62935, 75, -(1), NPCPTR);
}

func void QA401_REMOVEBIGCRATES() {
    FF_APPLYONCEEXTGT(62931, 0, -(1));
    if (HLP_ISVALIDNPC(VLK_6064_OLDGUY)) {
...
func void QA401_REMOVEBIGCRATES_APPLY() {
    var ZCMOVER MOVER1;
    var int MOVPTR1;
    var int QA401_REMOVEBIGCRATES_COUNT;
...
func void QA401_REMOVEFIRECRATES_APPLY() {
    if ((CURRENTLEVEL) == (ARCHOLOS_ZEN)) {
        if ((NPC_GETDISTTOWP(HERO, "HARBOUR_PATH_296")) >= (5000)) {
...
func void QA401_OTMARWHATDO() {
    ...
    if ((QA401_OTMARRESULT) == (1)) {
        ...
        TELEPORTNPCTOWP(52092, VLK_10095_OTMAR.WP);
        NPC_CHANGEARMOR(VLK_10095_OTMAR, 35571);
    };
    B_KILLNPC(52099);
}
...
func void QA401_SEWERS_SPAWNPABLO() {
    ...
    WLD_INSERTNPC(58975, "S1_QM305_SPAWNGAMAL");
}
...
func void QA401_PABLOUPDATEARAXOS_APPLY() {
    var ZCMOVER MOVER1;
    var int MOVPTR1;
    var int QA401_PABLOUPDATEARAXOS_COUNT;
