...
func int DIA_EZEKIEL_FORWHOLELIFE_CONDITION() {
    if (((NPC_ISINSTATE(SELF, 61599)) && ((Q101_AFTERJUMP) == (TRUE))) && (!(NPC_KNOWSINFO(OTHER, 90881)))) {
        return TRUE;
    };
...
func void DIA_EZEKIEL_FORWHOLELIFE_INFO() {
    ...
    INFO_CLEARCHOICES(91050);
    INFO_ADDCHOICE(91050, "Don't beat yourself up. It's not your fault.", 91053);
    INFO_ADDCHOICE(91050, "The rest is in the hands of the gods.", 91054);
    INFO_ADDCHOICE(91050, "Each of us gets lessons from life.", 91055);
}
...
func int DIA_EZEKIEL_SQ118_WHAT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 90881)) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_EZEKIEL_SQ118_WHAT_INFO() {
    ...
    INFO_CLEARCHOICES(91056);
    INFO_ADDCHOICE(91056, "In that case, good luck. Goodbye.", 91064);
    INFO_ADDCHOICE(91056, "You're coming with us or I'll drag you in by force.", 91063);
    INFO_ADDCHOICE(91056, "Your daughter would certainly be delighted if her father was eaten by lurkers.", 91062);
    INFO_ADDCHOICE(91056, "We don't have time for this.", 91061);
}
...
func void DIA_EZEKIEL_SQ118_GRAVEREADY_INFO() {
    ...
    INFO_CLEARCHOICES(91086);
    INFO_ADDCHOICE(91086, "What do you mean?", 91091);
    INFO_ADDCHOICE(91086, "I'd be happy to go with you.", 91090);
}
...
func void DIA_EZEKIEL_SQ118_GRAVEREADY_NEXT() {
    ...
    INFO_CLEARCHOICES(91086);
    INFO_ADDCHOICE(91086, "Maybe some other time.", 91093);
    INFO_ADDCHOICE(91086, "I'll help you convince the sentries to help.", 91092);
}
...
func int DIA_EZEKIEL_SQ118_WILLHELP_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ118)) == (LOG_RUNNING)) && ((SQ118_EZEKIEL_GUARDHELP) == (0))) && (NPC_KNOWSINFO(OTHER, 91086))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_EZEKIEL_SQ227_VEITNEEDGOLD_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ227)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 91112))) && ((SQ227_BOUGHTVEITLIST) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_EZEKIEL_SQ227_GOTLISTVEIT_CONDITION() {
    if ((SQ227_BOUGHTVEITLIST) == (TRUE)) {
        if (((NPC_KNOWSINFO(OTHER, 91112)) && ((LOG_GETSTATUS(MIS_SQ227)) == (LOG_RUNNING))) || ((LOG_GETSTATUS(MIS_SQ227)) == (LOG_SUCCESS))) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
...
func int DIA_EZEKIEL_SQ227_HOWSWORK_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ227)) == (LOG_RUNNING)) && ((SQ227_EZEKIELWORK) == (2))) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_EZEKIEL_SQ227_GOTBEER_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ227)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 91124))) && ((EZEKIEL_SQ227_GOTBEER) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_EZEKIEL_SQ227_GOTPARSLEY_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ227)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 91124))) && ((NPC_HASITEMS(OTHER, 36380)) >= (10))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_EZEKIEL_SQ227_GOTPARSLEY_INFO() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 36380, 10);
...
func int DIA_EZEKIEL_SQ227_GOTDOC_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ227)) == (LOG_RUNNING)) && ((SQ227_ALBYNDECISION) == (1))) && ((NPC_HASITEMS(OTHER, 37105)) >= (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_EZEKIEL_SQ227_GOTDOC_INFO() {
    ...
    AI_STARTFACEANI(SELF, S_SMILE, 1, -(1));
    NPC_REMOVEINVITEMS(SELF, 37105, 1);
    AI_OUTPUT(OTHER, SELF, "DIA_Ezekiel_SQ227_GotDoc_15_01");
    B_GIVEINVITEMS(OTHER, SELF, 37105, 1);
    B_STANDUP();
    B_USEFAKESCROLL();
...
var int EZEKIEL_BOUGHTSWORD;
func int DIA_EZEKIEL_SQ227_BUYSWORD_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 91136)) && ((EZEKIEL_BOUGHTSWORD) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_EZEKIEL_SQ227_BUYSWORD_INFO() {
    if ((NPC_HASITEMS(OTHER, 34203)) >= ((VALUE_MEISTERDEGEN_2) / (2))) {
        EZEKIEL_BOUGHTSWORD = TRUE;
        NPC_REMOVEINVITEMS(SELF, 34203, (VALUE_MEISTERDEGEN_2) / (2));
        CREATEINVITEMS(SELF, 34095, 1);
    };
...
func void DIA_EZEKIEL_Q505_HELP_INFO() {
    ...
    CREATEINVITEMS(SELF, 37603, 1);
    B_GIVEINVITEMS(SELF, OTHER, 37603, 1);
