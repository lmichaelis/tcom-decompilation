...
func void SQ121_RIORDIANTEACHINGCUTSCENE_END_APPLY() {
    var int SQ121_RIORDIANTEACHING_COUNT_END;
    ...
    if ((SQ121_RIORDIANTEACHING_COUNT_END) == (4)) {
        ...
        CREATEINVITEMS(KDW_203_RIORDIAN, 34695, 1);
        B_GIVEINVITEMS(KDW_203_RIORDIAN, HERO, 34695, 1);
        CREATEINVITEMS(KDW_203_RIORDIAN, 37698, 1);
        B_GIVEINVITEMS(KDW_203_RIORDIAN, HERO, 37698, 1);
...
func void SQ121_LOKVARTIMER() {
    ...
    FF_APPLYONCEEXT(62088, 1000, 15);
}

func void SQ121_LOKVARTIMER_APPLY() {
    var int SQ121_LOKVARTIMER_COUNT;
