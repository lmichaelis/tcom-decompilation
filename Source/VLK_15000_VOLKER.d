instance VLK_15000_VOLKER(NPC_DEFAULT) {
    ...
    B_SETNPCVISUAL(VLK_15000_VOLKER, MALE, HUMHEADBALD, FACE_N_VOLKER, BODYTEX_N, 35538);
    MDL_APPLYOVERLAYMDS(VLK_15000_VOLKER, HUMANSLEADERMDS);
    B_CREATEAMBIENTINV(VLK_15000_VOLKER);
    EQUIPITEM(VLK_15000_VOLKER, 34097);
...
instance VLK_15000_VOLKER_Q105(NPC_DEFAULT) {
    ...
    FIGHT_TACTIC = FAI_HUMAN_STRONG;
    EQUIPITEM(VLK_15000_VOLKER_Q105, 34097);
    B_SETNPCVISUAL(VLK_15000_VOLKER_Q105, MALE, HUMHEADBALD, FACE_N_VOLKER, BODYTEX_N, 35538);
