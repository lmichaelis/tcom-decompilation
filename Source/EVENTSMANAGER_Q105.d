func void EVENTSMANAGER_Q105() {
    ...
    if ((Q105_CHANGEJORNRTN) == (FALSE)) {
        if (((NPC_KNOWSINFO(HERO, 90940)) && ((NPC_GETDISTTOWP(NONE_1_JORN, "VILLAGE_Q105_FIGHT")) <= (350))) && ((NPC_ISINSTATE(NONE_1_JORN, 61599)) == (FALSE))) {
            PRINTD("Zmiana RTN");
    ...
    if ((Q105_CHANGEJORNRTN) == (1)) {
        if ((((Q105_GOTOBAKER) == (TRUE)) && ((NPC_GETDISTTOWP(NONE_1_JORN, "VILLAGE_Q105_JORN")) <= (350))) && ((NPC_ISINSTATE(NONE_1_JORN, 61599)) == (FALSE))) {
            PRINTD("Zmiana RTN");
    ...
    if ((Q105_CHANGEJORNRTN) == (2)) {
        if (((NPC_KNOWSINFO(HERO, 90966)) && ((NPC_GETDISTTOWP(NONE_1_JORN, "VILLAGE_Q105_BEER")) <= (350))) && ((NPC_ISINSTATE(NONE_1_JORN, 61599)) == (FALSE))) {
            PRINTD("Zmiana RTN");
    ...
    if ((Q105_CHANGEJORNRTN) == (3)) {
        if (((NPC_KNOWSINFO(HERO, 90976)) && ((NPC_GETDISTTOWP(NONE_1_JORN, "VILLAGE_KURTHOUSE_03")) <= (350))) && ((NPC_ISINSTATE(NONE_1_JORN, 61599)) == (FALSE))) {
            PRINTD("Zmiana RTN");
    ...
    if ((JORN_Q105_ARENAFIGHT) == (1)) {
        if ((NPC_ISINSTATE(HERO, 61603)) || (NPC_ISINSTATE(NONE_1_JORN, 61603))) {
    ...
    if ((Q105_OPENCHEST) == (1)) {
        if ((MOB_HASITEMS("Q105_BIGCHEST", 33988)) == (0)) {
            Q105_OPENCHEST = 2;
