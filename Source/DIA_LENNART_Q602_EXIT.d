...
func void DIA_LENNART_Q602_STOP_INFO() {
    INFO_CLEARCHOICES(90529);
    AI_DRAWWEAPON(SELF);
    if (((HERO.GUILD) == (GIL_MIL)) || ((MARVIN_LOSTGUILDMILITA) == (1))) {
        AI_STARTFACEANI(SELF, S_WHAT, 1, -(1));
        AI_OUTPUT(SELF, OTHER, "DIA_Lennart_Q602_STOP_03_02");
        INFO_ADDCHOICE(90529, "It's a long story, the important thing is that I'm here now.", 90534);
        INFO_ADDCHOICE(90529, "I assisted the Water Mages on their expedition to Volfzacke.", 90535);
    };
    AI_STARTFACEANI(SELF, S_ANGRY, 1, -(1));
    AI_OUTPUT(SELF, OTHER, "DIA_Lennart_Q602_STOP_03_01");
    INFO_ADDCHOICE(90529, "Relax, I came to help you!", 90533);
}
...
func int DIA_LENNART_Q602_WHATHAPPEND_CONDITION() {
    if (((LOG_GETSTATUS(MIS_Q602)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 90529))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LENNART_Q602_NEED_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 90529)) && ((LOG_GETSTATUS(MIS_Q602)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_LENNART_Q602_RECRUITS_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_Q602)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 90529))) && ((Q602_BARRACK_EMPTYHOUSE_03_LOGENTRY) == (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
