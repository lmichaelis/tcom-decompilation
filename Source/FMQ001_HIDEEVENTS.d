func void FMQ001_HIDEEVENTS() {
    if (((NS02_SPAWNED) == (TRUE)) && (!(NPC_KNOWSINFO(HERO, 72041)))) {
        if (!(NPC_ISDEAD(VLK_11150_LUNATIC))) {
            TELEPORTNPCTOWP(52614, TOT);
            NPC_EXCHANGEROUTINE(VLK_11150_LUNATIC, TOT);
            NS02_HIDDEN = TRUE;
        };
    };
    if (((TRAP_SPAWNGAMEMASTER) == (TRUE)) && ((NPC_KNOWSINFO(HERO, 68053)) == (FALSE))) {
        if ((NPC_ISDEAD(NONE_11288_GAMEMASTER)) == (FALSE)) {
            TELEPORTNPCTOWP(52588, TOT);
...
func void FMQ001_BRINGBACKEVENTS() {
    if ((NS02_HIDDEN) == (TRUE)) {
        TELEPORTNPCTOWP(52614, VLK_11150_LUNATIC.WP);
        NPC_EXCHANGEROUTINE(VLK_11150_LUNATIC, START);
        NS02_HIDDEN = FALSE;
    };
    if ((TRAP_GAMEMASTER_HIDDEN) == (TRUE)) {
        TELEPORTNPCTOWP(52588, NONE_11288_GAMEMASTER.WP);
...
func void FMQ001_WINSTANGIVESWORD() {
    if ((HERO.HITCHANCE[1]) >= (HERO.HITCHANCE[2])) {
        CREATEINVITEMS(MIL_924_WINSTAN, 39506, 1);
    };
    CREATEINVITEMS(MIL_924_WINSTAN, 39509, 1);
    B_GIVEINVITEMS(MIL_924_WINSTAN, HERO, 39509, 1);
}

var int MARVIN_FMQ001_CURRENTARROW;
var int MARVIN_FMQ001_CURRENTBOLT;
var int MARVIN_FMQ001_CURRENTMANA;
var int MARVIN_FMQ001_CURRENTMAXMANA;
func void FMQ001_REMOVEARROWS() {
    ...
    MARVIN_FMQ001_CURRENTARROW = NPC_HASITEMS(HERO, 34383);
    MARVIN_FMQ001_CURRENTBOLT = NPC_HASITEMS(HERO, 34384);
    MARVIN_FMQ001_CURRENTMANA = HERO.ATTRIBUTE[2];
    MARVIN_FMQ001_CURRENTMAXMANA = HERO.ATTRIBUTE[3];
    HERO.ATTRIBUTE[2] = 2;
    HERO.ATTRIBUTE[3] = 2;
    if ((NPC_HASITEMS(HERO, 34383)) >= (1)) {
        NPC_REMOVEINVITEMS(HERO, 34383, MARVIN_FMQ001_CURRENTARROW);
    };
    if ((NPC_HASITEMS(HERO, 34384)) >= (1)) {
        NPC_REMOVEINVITEMS(HERO, 34384, MARVIN_FMQ001_CURRENTBOLT);
    };
}
...
func void FMQ001_BRINGBACKARROWS() {
    ...
    if ((MARVIN_FMQ001_CURRENTARROW) >= (1)) {
        CREATEINVITEMS(HERO, 34383, MARVIN_FMQ001_CURRENTARROW);
    };
    if ((MARVIN_FMQ001_CURRENTBOLT) >= (1)) {
        CREATEINVITEMS(HERO, 34384, MARVIN_FMQ001_CURRENTBOLT);
    };
}

func void FMQ001_FAKEWALL() {
    FF_APPLYONCEEXTGT(62778, 0, -(1));
}

func void FMQ001_FAKEWALL_APPLY() {
    var ZCMOVER MOVER1;
    var int MOVPTR1;
    var int FMQ001_FAKEWALL_COUNT;
...
func void FMQ001_WINSTANCAMERA_ENABLE() {
    ...
    TELEPORTNPCTOWP(1819, "PARTM3_HERO");
    TELEPORTNPCTOWP(52439, "PARTM3_MEETING_01");
}
...
func void FMQ001_SECONDFIGHT() {
    ...
    if ((NPC_ISINSTATE(MIL_4041_RECRUIT, 61599)) == (FALSE)) {
    ...
    if ((NPC_ISINSTATE(MIL_4042_RECRUIT, 61599)) == (FALSE)) {
...
func void FMQ001_FINALFIGHT() {
    ...
    B_IMMEDIATEATTACKPLAYER(MIL_4041_RECRUIT, AR_NONE);
    B_IMMEDIATEATTACKPLAYER(MIL_4042_RECRUIT, AR_NONE);
    if ((NPC_ISINSTATE(MIL_4040_RECRUIT, 61599)) == (FALSE)) {
...
func void FMQ001_TREESHOOT() {
    ...
    CREATEINVITEMS(MIL_4040_RECRUIT, 39718, 1);
    CREATEINVITEMS(MIL_4040_RECRUIT, 34384, 25);
    AI_EQUIPBESTRANGEDWEAPON(MIL_4040_RECRUIT);
    CREATEINVITEMS(MIL_4041_RECRUIT, 39718, 1);
    CREATEINVITEMS(MIL_4041_RECRUIT, 34384, 25);
    AI_EQUIPBESTRANGEDWEAPON(MIL_4041_RECRUIT);
    CREATEINVITEMS(MIL_4042_RECRUIT, 39718, 1);
    CREATEINVITEMS(MIL_4042_RECRUIT, 34384, 25);
