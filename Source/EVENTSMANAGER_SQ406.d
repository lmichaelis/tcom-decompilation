func void EVENTSMANAGER_SQ406() {
    ...
    if ((SQ406_HAVENLOGENTRY) == (FALSE)) {
        if ((NPC_GETDISTTOWP(HERO, "P17_HAVEN_IN_17")) <= (5000)) {
    ...
    if ((SQ406_FIGHTWITHGHOST_CLEARATTITUDE) == (1)) {
        if (NPC_ISINSTATE(PIR_6322_GHOST, 61603)) {
            ...
            MDL_STARTFACEANI(PIR_6322_GHOST, S_NEUTRAL, 1065353216, -1082130432);
            PRINTD("Clear Attitude");
        };
    };
    if ((SQ406_NEARCAVE_CHANGERTN) == (0)) {
        if (((((NPC_GETDISTTOWP(PIR_1313_GETTER, "PART17_CAVE_CAMPFIRE_01")) <= (1200)) && ((SQ406_GETTER_POTION) == (3))) || (((NPC_GETDISTTOWP(PIR_6322_GHOST, "PART17_CAVE_CAMPFIRE_01")) <= (1200)) && ((SQ406_GHOST_POTION) == (3)))) || (((NPC_GETDISTTOWP(PIR_1326_DAN, "PART17_CAVE_CAMPFIRE_01")) <= (1200)) && ((SQ406_DAN_POTION) == (3)))) {
            if (((((NPC_ISINSTATE(PIR_1313_GETTER, 61599)) == (FALSE)) && ((SQ406_GETTER_POTION) == (3))) || (((NPC_ISINSTATE(PIR_6322_GHOST, 61599)) == (FALSE)) && ((SQ406_GHOST_POTION) == (3)))) || (((NPC_ISINSTATE(PIR_1326_DAN, 61599)) == (FALSE)) && ((SQ406_DAN_POTION) == (3)))) {
                PRINTD("Zmiana RTN");
    ...
    if ((SQ406_NEARCAVE_CHANGERTN) == (1)) {
        if ((SQ406_GETTER_POTION) == (3)) {
            if ((NPC_GETDISTTONPC(HERO, PIR_1313_GETTER)) <= (2750)) {
