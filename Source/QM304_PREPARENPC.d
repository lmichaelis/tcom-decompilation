func void QM304_PREPARENPC() {
    WLD_INSERTNPC(53966, "HARBOUR_STAND_01");
    WLD_INSERTNPC(53969, "HARBOUR_DARKSECRETS_COUCH_02");
    WLD_INSERTNPC(55273, "SLUMS_QM304_REFUGEE");
    WLD_INSERTNPC(53972, "HARBOUR_WALLS_33");
    WLD_INSERTNPC(53975, "HARBOUR_WALLS_33");
    WLD_INSERTNPC(53978, "HARBOUR_WALLS_33");
}
...
func void QM304_FINISHQUEST() {
    ...
    if ((QM304_GIVENUGGETWINSTAN) == (TRUE)) {
        B_GIVEINVITEMS(OTHER, SELF, 34202, QM304_COUNTNUGGETS);
        CREATEINVITEMS(SELF, 34203, (QM304_FINISHGOLD) + ((QM304_BONUSGOLD) * (QM304_COUNTNUGGETS)));
        B_GIVEINVITEMS(SELF, OTHER, 34203, (QM304_FINISHGOLD) + ((QM304_BONUSGOLD) * (QM304_COUNTNUGGETS)));
        B_GIVEPLAYERXP((XP_QM304_FINISH) + ((XP_QM304_BONUSEXP) * (QM304_COUNTNUGGETS)));
    };
    CREATEINVITEMS(SELF, 34203, QM304_FINISHGOLD);
    B_GIVEINVITEMS(SELF, OTHER, 34203, QM304_FINISHGOLD);
