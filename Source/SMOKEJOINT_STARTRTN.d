func void SMOKEJOINT_STARTRTN() {
    ...
    if (((SELF.GUILD) == (GIL_VLK)) || ((SELF.GUILD) == (GIL_NONE))) {
        if ((NPC_HASITEMS(SELF, 34197)) == (0)) {
            CREATEINVITEM(SELF, 34197);
        };
    };
    if ((NPC_HASITEMS(SELF, 34194)) == (0)) {
        CREATEINVITEM(SELF, 34194);
    };
...
func void ZS_SMOKE_JOINT() {
    if ((NPC_HASEQUIPPEDARMOR(HERO)) == (TRUE)) {
        if ((((NPC_WASINSTATE(SELF, 61599)) && (NPC_HASGUILDARMOREQUIPPED(HERO, GIL_MIL))) && ((SELF.GUILD) == (GIL_VLK))) || (((SELF.GUILD) == (GIL_NONE)) && ((NPC_GETDISTTONPC(SELF, HERO)) <= (1000)))) {
            PRINTD("By³em w rozmowie");
            AI_STARTSTATE(SELF, 46731, 1, "");
        } else {
            SMOKEJOINT_STARTRTN();
        };
    };
...
func int ZS_SMOKE_JOINT_LOOP() {
    ...
    if ((SELF.AIVAR[19]) == (NOTINPOS)) {
        if (((SELF.GUILD) == (GIL_VLK)) || ((SELF.GUILD) == (GIL_NONE))) {
            AI_USEITEMTOSTATE(SELF, 34197, 0);
        } else {
            AI_USEITEMTOSTATE(SELF, 34194, 0);
        };
        SELF.AIVAR[19] = ISINPOS;
    };
    if ((SELF.AIVAR[19]) == (ISINPOS)) {
        if (NPC_HASGUILDARMOREQUIPPED(HERO, GIL_MIL)) {
            if ((((NPC_GETDISTTONPC(SELF, HERO)) <= (1500)) && ((SELF.GUILD) == (GIL_VLK))) || ((SELF.GUILD) == (GIL_NONE))) {
...
func void ZS_SMOKE_JOINT_END() {
    if (((SELF.GUILD) == (GIL_VLK)) || ((SELF.GUILD) == (GIL_NONE))) {
        AI_USEITEMTOSTATE(SELF, 34197, -(1));
    };
    AI_USEITEMTOSTATE(SELF, 34194, -(1));
}
