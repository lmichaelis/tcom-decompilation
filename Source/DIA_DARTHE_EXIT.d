...
func int DIA_DARTHE_QA203_HELLO_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_QA203)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 70121))) && (NPC_KNOWSINFO(OTHER, 77693))) {
        return TRUE;
    };
...
func int DIA_DARTHE_QA203_WHATSWRONG_CONDITION() {
    if (((LOG_GETSTATUS(MIS_QA203)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 77679))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_DARTHE_QA203_AFTERHELP_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_QA203)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 70132))) && ((NPC_HASITEMS(OTHER, 37102)) >= (1))) && ((NPC_HASITEMS(OTHER, 37112)) >= (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DARTHE_QA203_AFTERHELP_INFO() {
    ...
    INFO_CLEARCHOICES(77685);
    INFO_ADDCHOICE(77685, "You don't have to work for the Guild, lease is enough.", 77688);
    if ((NPC_HASITEMS(OTHER, 37115)) >= (1)) {
        INFO_ADDCHOICE(77685, "Your father warned you about a Guild that no longer exists.", 77689);
    };
}
...
func void DIA_DARTHE_QA203_AFTERHELP_GUILD() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 37112, 1);
    B_USEFAKESCROLL();
...
func void DIA_DARTHE_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(77699);
    INFO_ADDCHOICE(77699, DIALOG_BACK, 77703);
    INFO_ADDCHOICE(77699, DIALOG_PICKPOCKET, 77702);
}
