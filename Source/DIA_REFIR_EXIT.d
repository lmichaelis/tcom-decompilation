...
func int DIA_REFIR_SQ311_HELLO_CONDITION() {
    if (((NPC_ISINSTATE(SELF, 61599)) && (!(NPC_KNOWSINFO(OTHER, 80897)))) && ((Q504_TAKEWORKERS) != (2))) {
        return TRUE;
    };
...
func int DIA_REFIR_SQ311_LETSTALK_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ311)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 80897))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}

var int REFIR_SQ311_LETSTALK_WEIRD;
var int REFIR_SQ311_LETSTALK_PROBLEMS;
var int REFIR_SQ311_LETSTALK_WHEN;
var int REFIR_SQ311_LETSTALK_COUNT;
func void DIA_REFIR_SQ311_CHOICES() {
    INFO_CLEARCHOICES(80943);
    if ((REFIR_SQ311_LETSTALK_WEIRD) == (FALSE)) {
        INFO_ADDCHOICE(80943, "Was Reez acting strangely before he disappeared?", 80954);
    };
    if ((REFIR_SQ311_LETSTALK_PROBLEMS) == (FALSE)) {
        INFO_ADDCHOICE(80943, "Did Reez have problems with anyone?", 80953);
    };
    if ((REFIR_SQ311_LETSTALK_WHEN) == (FALSE)) {
        INFO_ADDCHOICE(80943, "When did Reez disappear?", 80952);
    };
}
...
func void DIA_REFIR_SQ311_COUNT() {
    ...
    if ((REFIR_SQ311_LETSTALK_COUNT) == (3)) {
        INFO_CLEARCHOICES(80943);
        INFO_ADDCHOICE(80943, "I'll try to find him.", 80955);
    };
...
func void DIA_REFIR_SQ311_LETSTALK_WEIRD_FIND() {
    ...
    CREATEINVITEMS(SELF, 37236, 1);
    B_GIVEINVITEMS(SELF, OTHER, 37236, 1);
...
func int DIA_REFIR_Q504_FEEL_CONDITION() {
    if ((((NPC_GETDISTTOWP(SELF, "PART5_WORKERSCAMP_SMALLTALK_01")) <= (2000)) && ((Q504_TAKEWORKERS) == (2))) && ((Q504_REFIRNERALVOLFZACKE) == (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_REFIR_TEACH_CHOICES() {
    ...
    INFO_CLEARCHOICES(80965);
    INFO_ADDCHOICE(80965, DIALOG_BACK, 80970);
    if ((HERO_HACKCHANCE) <= (95)) {
        INFO_ADDCHOICE(80965, B_BUILDLEARNSTRING2(PRINT_LEARN_MINE5, 0, REFIR_PAYMENT5), 80972);
    };
    if ((HERO_HACKCHANCE) <= (99)) {
        INFO_ADDCHOICE(80965, B_BUILDLEARNSTRING2(PRINT_LEARN_MINE1, 0, REFIR_PAYMENT1), 80971);
    };
}
...
func void DIA_REFIR_TEACHMINE1() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (REFIR_PAYMENT1)) {
        if ((HERO_HACKCHANCE) < (100)) {
...
func void DIA_REFIR_TEACHMINE5() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (REFIR_PAYMENT5)) {
        if ((HERO_HACKCHANCE) < (95)) {
...
func int DIA_REFIR_TRAIN_PICKPOCKET_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 80973)) && ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) < (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_REFIR_TRAIN_PICKPOCKET_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (REFIR_PICKPOCKET)) {
        if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (1)) {
            ...
            NPC_REMOVEINVITEMS(SELF, 34203, REFIR_PICKPOCKET);
            AI_OUTPUT(SELF, OTHER, "DIA_Refir_TRAIN_Pickpocket_03_01");
            B_GIVEINVITEMS(OTHER, SELF, 34203, REFIR_PICKPOCKET);
...
func void DIA_REFIR_TRAIN_PICKPOCKET2_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (REFIR_PICKPOCKET2)) {
        if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (2)) {
            B_GIVEINVITEMS(OTHER, SELF, 34203, REFIR_PICKPOCKET2);
            ...
            NPC_REMOVEINVITEMS(SELF, 34203, REFIR_PICKPOCKET2);
        };
    };
    B_SAY(SELF, OTHER, "$NOGOLD");
}
...
func int DIA_REFIR_AMBIENT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 80943)) && ((NPC_GETDISTTOWP(SELF, "PART5_WORKERSCAMP_SMALLTALK_01")) > (2000))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_REFIR_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(80985);
    INFO_ADDCHOICE(80985, DIALOG_BACK, 80989);
    INFO_ADDCHOICE(80985, DIALOG_PICKPOCKET, 80988);
}
