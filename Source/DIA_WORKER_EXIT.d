...
func int DIA_WORKER_BUSY_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_SQ309)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 75597))) && ((NPC_KNOWSINFO(OTHER, 77098)) == (FALSE))) && ((NPC_KNOWSINFO(OTHER, 75809)) == (FALSE))) {
        return FALSE;
    };
...
func int DIA_WORKER_INWORK_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_SQ309)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 75597))) && ((NPC_KNOWSINFO(OTHER, 77098)) == (FALSE))) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_WORKER_INWORK_INFO() {
    ...
    if (((((LOG_GETSTATUS(MIS_SQ309)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 75597))) && ((NPC_KNOWSINFO(OTHER, 77098)) == (FALSE))) && ((SQ309_LOGENTRYWORKER) == (FALSE))) {
        AI_LOGENTRY(TOPIC_SQ309, LOG_SQ309_WORKER_NOINFO);
        SQ309_LOGENTRYWORKER = TRUE;
    };
    AI_RESETFACEANI(SELF);
    AI_STOPPROCESSINFOS(SELF);
    AI_FUNCTION(SELF, 62385);
}
