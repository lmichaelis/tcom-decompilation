...
func int RESERVED_FUNC_INT_52() {
    if ((((NPC_KNOWSINFO(OTHER, 69491)) == (FALSE)) && ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_SMITH)) == (0))) && ((HERO.GUILD) == (GIL_MIL))) {
        return TRUE;
    };
...
func int RESERVED_FUNC_INT_53() {
    if ((NPC_HASITEMS(OTHER, 34203)) >= (INGOR_SMITH)) {
        if ((HERO.LP) >= (5)) {
            B_GIVEINVITEMS(OTHER, SELF, 34203, INGOR_SMITH);
            NPC_REMOVEINVITEMS(SELF, 34203, INGOR_SMITH);
        };
...
func int RESERVED_FUNC_INT_54() {
    if ((((NPC_KNOWSINFO(OTHER, 69491)) == (FALSE)) && ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_SMITH)) == (1))) && ((HERO.GUILD) == (GIL_MIL))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int RESERVED_FUNC_INT_55() {
    if ((NPC_HASITEMS(OTHER, 34203)) >= (INGOR_SMITH2)) {
        if ((HERO.LP) >= (10)) {
            B_GIVEINVITEMS(OTHER, SELF, 34203, INGOR_SMITH2);
            NPC_REMOVEINVITEMS(SELF, 34203, INGOR_SMITH2);
        };
...
func int RESERVED_FUNC_INT_63() {
    if (((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_ALCHEMY)) == (2)) && (NPC_KNOWSINFO(OTHER, 81394))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int RESERVED_FUNC_INT_95() {
    if ((NPC_ISINSTATE(SELF, 61599)) && ((LOG_GETSTATUS(MIS_QM401)) == (LOG_SUCCESS))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
