...
var int SILVESTR_FIGHTLEVEL;
var int SILVESTRCANTEACHUSFIGHT;
...
var int SILVESTR_GOLDCOST;
func void DIA_SILVESTR_TEACH_INFO() {
    AI_OUTPUT(OTHER, SELF, "DIA_Silvestr_Teach_15_01");
    SILVESTR_FIGHTLEVEL = OTHER.AIVAR[84];
    SILVESTR_GOLDCOST = 0;
    INFO_CLEARCHOICES(70021);
    INFO_ADDCHOICE(70021, DIALOG_BACK, 70027);
    INFO_ADDCHOICE(70021, B_BUILDLEARNSTRING2(PRINT_LEARN1H1, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_1H, 1), SILVESTR_GOLDCOST), 70025);
    INFO_ADDCHOICE(70021, B_BUILDLEARNSTRING2(PRINT_LEARN1H5, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_1H, 5), (SILVESTR_GOLDCOST) * (5)), 70026);
}
...
func int DIA_SILVESTR_CQ005_TENGRAL_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 65416)) && (NPC_KNOWSINFO(OTHER, 70028))) {
...
func void DIA_SILVESTR_CQ005_TENGRAL_INFO() {
    ...
    INFO_CLEARCHOICES(70031);
    INFO_ADDCHOICE(70031, "I am to assist you in this sacred duty.", 70035);
    INFO_ADDCHOICE(70031, "That's exactly right.", 70034);
}
...
func void DIA_SILVESTR_CQ005_EYEOFINNOS_INFO() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 37167, 1);
    ...
    if ((LOG_GETSTATUS(MIS_Q202)) == (LOG_RUNNING)) {
        INFO_CLEARCHOICES(70039);
        INFO_ADDCHOICE(70039, "I'm in a bit of a hurry, I need to get references from respectable people in town.", 70043);
    };
    AI_LOGENTRY(TOPIC_CQ005, LOG_CQ005_SILVESTR_EYEOFINNOS);
}

var int RUNAR_CQ005_TAKEDOC;
func void DIA_SILVESTR_CQ005_EYEOFINNOS_NOTIME() {
    ...
    CREATEINVITEMS(SELF, 37166, 1);
    B_GIVEINVITEMS(SELF, OTHER, 37166, 1);
...
func void DIA_SILVESTR_CQ005_SCUM_INFO() {
    ...
    INFO_CLEARCHOICES(70044);
    if ((RUNAR_CQ005_TAKEDOC) == (1)) {
        if ((NPC_HASITEMS(OTHER, 37166)) >= (1)) {
            INFO_ADDCHOICE(70044, "Here, your reference.", 70049);
        };
        INFO_ADDCHOICE(70044, "Unfortunately, I no longer have your reference with me...", 70052);
    };
    INFO_ADDCHOICE(70044, "Excuse me.", 70051);
}

var int SILVESTRISMAD;
...
func void DIA_SILVESTR_CQ005_SCUM_HERE() {
    ...
    NPC_REMOVEINVITEMS(SELF, 37166, 1);
    AI_OUTPUT(SELF, OTHER, "DIA_Silvestr_CQ005_Here_101_02");
    B_GIVEINVITEMS(OTHER, SELF, 37166, 1);
...
func int DIA_SILVESTR_CQ005_RITUAL_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 67738)) && ((LOG_GETSTATUS(MIS_CQ005)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_SILVESTR_CQ005_LETSGO_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 70057)) && (WLD_ISTIME(0, 0, 2, 0))) && ((LOG_GETSTATUS(MIS_CQ005)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_SILVESTR_AMBIENT_INFO() {
    ...
    if ((!(NPC_KNOWSINFO(OTHER, 70031))) && (!(NPC_KNOWSINFO(OTHER, 70066)))) {
        AI_STARTFACEANI(SELF, S_SMUG, 1, -(1));
        AI_OUTPUT(SELF, OTHER, "DIA_Silvestr_Ambient_03_01");
    };
    if (((NPC_KNOWSINFO(OTHER, 70031)) && (!(NPC_KNOWSINFO(OTHER, 70044)))) && (!(NPC_KNOWSINFO(OTHER, 70066)))) {
        AI_STARTFACEANI(SELF, S_SMUG, 1, -(1));
        AI_OUTPUT(SELF, OTHER, "DIA_Silvestr_Ambient_03_02");
    };
    if (((NPC_KNOWSINFO(OTHER, 70044)) && (!(NPC_KNOWSINFO(OTHER, 70053)))) && (!(NPC_KNOWSINFO(OTHER, 70066)))) {
        AI_STARTFACEANI(SELF, S_ANGRY, 1, -(1));
        AI_OUTPUT(SELF, OTHER, "DIA_Silvestr_Ambient_03_03");
        AI_STOPPROCESSINFOS(SELF);
    };
    if ((NPC_KNOWSINFO(OTHER, 70053)) && (!(NPC_KNOWSINFO(OTHER, 70066)))) {
        AI_STARTFACEANI(SELF, S_SMUG, 1, -(1));
        AI_OUTPUT(SELF, OTHER, "DIA_Silvestr_Ambient_03_04");
    };
    if (NPC_KNOWSINFO(OTHER, 70066)) {
        AI_STARTFACEANI(SELF, S_SMUG, 1, -(1));
...
func void DIA_SILVESTR_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(70081);
    INFO_ADDCHOICE(70081, DIALOG_BACK, 70085);
    INFO_ADDCHOICE(70081, DIALOG_PICKPOCKET, 70084);
}

func void DIA_SILVESTR_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (2)) {
        CREATEINVITEMS(SELF, 34227, 1);
        B_GIVEINVITEMS(SELF, OTHER, 34227, 1);
