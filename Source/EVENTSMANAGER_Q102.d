func void EVENTSMANAGER_Q102() {
    var int Q102_STOPSCALETIME_FABIOWAY;
    var int Q102_STOPSCALETIME;
    ...
    if (Q102_JORNCHOSEN) {
        if ((Q102_FIRSTTIMEINSILBACH) == (FALSE)) {
            if (((NPC_GETDISTTOWP(HERO, "PART13_PATH_02")) <= (500)) && ((NPC_ISINSTATE(NONE_1_JORN, 61599)) == (FALSE))) {
                MUSIC_OVERRIDETRACK(21919);
    ...
    if (Q102_FABIOCHOSEN) {
        if ((Q102_FABIO_CHANGERTNAFTERMOLERAT) == (FALSE)) {
            if (((NPC_ISDEAD(CAVE_MOLERAT_01)) && (NPC_ISDEAD(CAVE_MOLERAT_02))) && (NPC_ISDEAD(CAVE_MOLERAT_03))) {
                if ((((NPC_ISINSTATE(NONE_100007_RUPERT, 61599)) == (FALSE)) && ((NPC_ISINSTATE(NONE_100012_KAZEEM, 61599)) == (FALSE))) && ((NPC_ISINSTATE(NONE_5_FABIO, 61599)) == (FALSE))) {
        ...
        if ((FABIOKAZEEMSMALLTALK2) == (FALSE)) {
            if (((KAZEEMGATHERWOOD) == (2)) || ((Q102_FABIOGATHERWOOD) == (2))) {
                if ((((!(NPC_ISINSTATE(NONE_5_FABIO, 61599))) && (!(NPC_ISINSTATE(NONE_100012_KAZEEM, 61599)))) && (!(NPC_ISINSTATE(HERO, 61599)))) && ((NPC_GETDISTTONPC(NONE_5_FABIO, NONE_100012_KAZEEM)) <= (700))) {
        ...
        if ((KAZEEMGATHERWOOD) == (1)) {
            if (((NPC_GETDISTTOWP(NONE_100012_KAZEEM, "PART_13_KAZEEM_GATHER")) <= (300)) && ((NPC_ISINSTATE(NONE_100012_KAZEEM, 61599)) == (FALSE))) {
        ...
        if ((Q102_FABIOGATHERWOOD) == (1)) {
            if (((NPC_GETDISTTOWP(NONE_5_FABIO, "PART_13_KAZEEM_GATHER")) <= (300)) && ((NPC_ISINSTATE(NONE_5_FABIO, 61599)) == (FALSE))) {
        ...
        if (((Q102_RUPERTDISTANCELIMIT) == (TRUE)) && ((HERO.AIVAR[4]) == (FALSE))) {
            if ((Q102_RUPERTDISTANCEWARN) == (FALSE)) {
                ...
                if ((NPC_GETDISTTONPC(HERO, NONE_100007_RUPERT)) >= (3500)) {
                    Q102_RUPERTDISTANCEWARN = 2;
                    FADESCREENTOBLACKF(1, 62043, 1000);
                };
            };
        };
