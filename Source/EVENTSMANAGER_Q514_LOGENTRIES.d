func void EVENTSMANAGER_Q514_LOGENTRIES() {
    var int Q514_VARINWORK_LADDER_LOGENTRY;
    ...
    if ((Q514_SWORD_FINISH) == (1)) {
        ...
        if ((Q514_CRAWLER_FINISH) == (FALSE)) {
            if ((NPC_GETDISTTOWP(HERO, "VOLFZACKE_RUINS_WATER")) <= (500)) {
                ...
                WLD_INSERTNPC(50992, "FP_VZ_DESTROYEDGOLEM_01");
                WLD_INSERTNPC(50993, "FP_VZ_DESTROYEDGOLEM_02");
                WLD_INSERTNPC(50994, "FP_VZ_DESTROYEDGOLEM_03");
                if ((Q509_CORTEZVOLFZACKE) == (1)) {
                    if ((NPC_ISDEAD(PIR_1303_CORTEZ_VZ)) == (FALSE)) {
                        ...
                        TELEPORTNPCTOWP(59313, "VOLFZACK_RUINS_02");
                    };
                };
...
func void EVENTSMANAGER_Q514() {
    ...
    if ((Q514_SPAWNKESSELANDRIORDIAN) == (FALSE)) {
        if ((((NPC_ISDEAD(ZOMBIE_VOLFZACKE_STORYRISE_01)) && (NPC_ISDEAD(ZOMBIE_VOLFZACKE_STORYRISE_02))) && (NPC_ISDEAD(SKELETON_VZ_STORY_01))) && (NPC_ISDEAD(SKELETON_VZ_STORY_02))) {
            ...
            WLD_INSERTNPC(59259, "VOLFZACK_02");
            WLD_INSERTNPC(59136, "VOLFZACK_01");
    ...
    if ((Q514_KESSELGUIDE_BRIDGE) == (1)) {
        if (((NPC_GETDISTTOWP(NONE_202_KESSEL_VZ, "VOLFZACK_13")) <= (300)) && ((NPC_ISINSTATE(NONE_202_KESSEL_VZ, 61599)) == (FALSE))) {
    ...
    if ((Q514_BRIDGECUTSCENE_MOVENPC) == (0)) {
        if ((((((NPC_GETDISTTOWP(NONE_11037_MARKUS_VZ, "VOLFZACK_10")) <= (1000)) && ((NPC_GETDISTTOWP(MIL_63710_DUSTER_VZ, "VOLFZACK_10")) <= (1000))) && ((NPC_GETDISTTOWP(SLD_13784_VARIN_VZ, "VOLFZACK_10")) <= (1000))) && ((NPC_GETDISTTOWP(NONE_13795_DISMAS_VZ, "VOLFZACK_10")) <= (1000))) && ((NPC_GETDISTTOWP(NONE_10039_WORKER_VZ, "VOLFZACK_10")) <= (1000))) {
            ...
            AI_WAIT(NONE_13795_DISMAS_VZ, 1091567616);
            AI_WAIT(NONE_10039_WORKER_VZ, 1093140480);
    ...
    if ((Q514_FIRSTGATEOPENED) == (TRUE)) {
        if ((Q514_CAMPISREADY) == (FALSE)) {
            if (((NPC_GETDISTTOWP(HERO, "VOLFZACK_14")) >= (4000)) && ((NPC_ISINSTATE(NONE_202_KESSEL_VZ, 61599)) == (FALSE))) {
        ...
        if ((Q514_DUSTERWORK_KITCHEN) == (1)) {
            ...
            if ((NPC_GETDISTTOWP(HERO, "VOLFZACK_46")) >= (3000)) {
        ...
        if ((Q514_DUSTERWORK_TRAININGHALL) == (1)) {
            ...
            if ((NPC_GETDISTTOWP(HERO, "VOLFZACK_38")) >= (3000)) {
        ...
        if ((Q514_SECONDGATE_FOUNDALLSWORDS) == (FALSE)) {
            if (((NPC_HASITEMS(HERO, 39610)) >= (1)) && ((NPC_HASITEMS(HERO, 39611)) >= (1))) {
    ...
    if ((Q514_SECONDGATEOPENED) == (TRUE)) {
        if ((NPC_GETDISTTOWP(HERO, "VOLFZACK_ARMORROOM_08")) <= (1250)) {
    ...
    if ((Q514_PUZZLECHAMBER_FINISH) == (TRUE)) {
        if ((Q514_CHESSCHAMBER_BUTTONPUZZLE) == (1)) {
            if ((Q514_CHESS_DEATH) == (1)) {
                ...
                WLD_INSERTNPC(59327, "VOLFZACK_CHESS_20");
                HERO.AIVAR[4] = TRUE;
                FF_APPLYONCEEXT(61408, 75, 4);
    ...
    if ((Q514_CHESS_FINISH) == (TRUE)) {
        ...
        if ((((Q514_CATACOMBS_GARGOYLE_FIRSTMEETING) == (1)) && ((NPC_GETDISTTOWP(HERO, "VOLFZACK_CATACOMBS_GRAVEROOM_ENTER")) <= (150))) || (((NPC_HASITEMS(HERO, 36890)) >= (1)) && ((NPC_GETDISTTOWP(HERO, "VOLFZACK_CATACOMBS_GRAVEROOM_ENTER")) <= (150)))) {
    ...
    if ((Q514_CATACOMBS_FINISH) == (TRUE)) {
        ...
        if ((Q514_TREASURY_EVENT) == (2)) {
            if ((Q514_TREASURY_CHANGERTN_KESSEL) == (FALSE)) {
                if (((NPC_GETDISTTOWP(NONE_202_KESSEL_VZ, "VOLFZACK_SWORD_KESSEL")) <= (300)) && ((NPC_ISINSTATE(NONE_202_KESSEL_VZ, 61599)) == (FALSE))) {
            ...
            if ((Q514_TREASURY_CHANGERTN_DACK) == (FALSE)) {
                if (((NPC_GETDISTTOWP(MIL_63710_DUSTER_VZ, "VOLFZACK_SWORD_DACK")) <= (300)) && ((NPC_ISINSTATE(MIL_63710_DUSTER_VZ, 61599)) == (FALSE))) {
    ...
    if ((Q514_TREASURY_FINISH) == (TRUE)) {
        if ((Q514_SWORD_CUTSCENE) == (1)) {
            ...
            FF_APPLYONCEEXT(94171, 500, 2);
        };
        if ((Q514_SWORD_CUTSCENE) == (4)) {
            if (((NPC_HASITEMS(HERO, 39466)) >= (1)) && ((NPC_HASITEMS(HERO, 37623)) >= (1))) {
...
func void Q514_VOLFZACKETREASURYTRAPCUTSCENE_APPLY() {
    var int Q514_VOLFZACKETREASURYTRAPCUTSCENE_APPLY_COUNT;
    ...
    if ((Q514_VOLFZACKETREASURYTRAPCUTSCENE_APPLY_COUNT) == (2)) {
        CUTSCENE_START(92709);
    };
}

func void Q514_VOLFZACKESWORDCUTSCENE_APPLY_START() {
    var int Q514_VOLFZACKESWORDCUTSCENE_START_APPLY_COUNT;
