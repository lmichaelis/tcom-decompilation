...
func void DIA_ZACHARY_SQ124_START_INFO() {
    ...
    INFO_CLEARCHOICES(77853);
    INFO_ADDCHOICE(77853, "I don't have time for this...", 77858);
    INFO_ADDCHOICE(77853, "I'll check out that cave.", 77856);
}
...
func void DIA_ZACHARY_SQ124_START_CHECK() {
    ...
    AI_RESETFACEANI(SELF);
    INFO_CLEARCHOICES(77853);
    CREATEINVITEMS(SELF, 36907, 1);
    B_GIVEINVITEMS(SELF, OTHER, 36907, 1);
...
var int ZACHARY_SQ124_TAKEQUEST;
...
func int DIA_ZACHARY_SQ124_TAKEQUEST_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 77853)) && ((ZACHARY_SQ124_TAKEQUEST) == (TRUE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ZACHARY_SQ124_FINISH_INFO() {
    ...
    CREATEINVITEMS(SELF, 33972, 8);
    B_GIVEINVITEMS(SELF, OTHER, 33972, 8);
    CREATEINVITEMS(SELF, 37647, 2);
    B_GIVEINVITEMS(SELF, OTHER, 37647, 2);
...
func int DIA_ZACHARY_SQ124_NOTE_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ124)) == (LOG_SUCCESS)) && ((NPC_HASITEMS(OTHER, 39866)) >= (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ZACHARY_SQ124_NOTE_INFO() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 39866, 1);
    AI_STARTFACEANI(SELF, S_THINK, 1, -(1));
    B_USEFAKESCROLL();
    AI_OUTPUT(SELF, OTHER, "DIA_Zachary_SQ124_Note_03_02");
    B_GIVEINVITEMS(SELF, OTHER, 39866, 1);
...
func int DIA_ZACHARY_YANNICK_CONDITION() {
    if ((((NPC_KNOWSINFO(OTHER, 77841)) && (NPC_KNOWSINFO(OTHER, 78426))) && ((LOG_GETSTATUS(MIS_Q208)) == (LOG_RUNNING))) && ((Q208_TALKEDWITHYANNIC) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ZACHARY_Q505_HELP_INFO() {
    ...
    CREATEINVITEMS(SELF, 37572, 1);
    B_GIVEINVITEMS(SELF, OTHER, 37572, 1);
    AI_RESETFACEANI(SELF);
    AI_RESETFACEANI(OTHER);
}
...
func void DIA_ZACHARY_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(77880);
    INFO_ADDCHOICE(77880, DIALOG_BACK, 77884);
    INFO_ADDCHOICE(77880, DIALOG_PICKPOCKET, 77883);
}

func void DIA_ZACHARY_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (2)) {
        CREATEINVITEMS(SELF, 33972, 3);
        B_GIVEINVITEMS(SELF, OTHER, 33972, 3);
