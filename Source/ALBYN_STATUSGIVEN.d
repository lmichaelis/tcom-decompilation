...
var int ALBYN_LASTPETZCOUNTER;
var int ALBYN_LASTPETZCRIME;
...
func void DIA_ALBYN_PMDEBTS_INFO() {
    ...
    if ((((B_GETGREATESTPETZCRIME(SELF)) != (CRIME_NONE)) || ((Q105_BREADTHIEF) == (2))) || ((ALBYN_DEBTS) >= (1))) {
        INFO_CLEARCHOICES(87673);
        INFO_CLEARCHOICES(87678);
        INFO_ADDCHOICE(87673, "I don't have enough gold!", 87682);
        INFO_ADDCHOICE(87673, "How much was it supposed to be?", 87677);
        if ((NPC_HASITEMS(OTHER, 34203)) >= (ALBYN_DEBTS)) {
            INFO_ADDCHOICE(87673, "I want to pay the fine!", 87681);
        };
    };
}
...
func void DIA_ALBYN_PETZMASTER_INFO() {
    ...
    INFO_CLEARCHOICES(87673);
    INFO_CLEARCHOICES(87678);
    INFO_ADDCHOICE(87678, "I don't have enough gold!", 87682);
    if ((NPC_HASITEMS(OTHER, 34203)) >= (ALBYN_DEBTS)) {
        INFO_ADDCHOICE(87678, "I want to pay the fine!", 87681);
    };
}

func void DIA_ALBYN_PETZMASTER_PAYNOW() {
    AI_OUTPUT(OTHER, SELF, "DIA_Albyn_PETZMASTER_PayNow_15_00");
    NPC_REMOVEINVITEMS(SELF, 34203, ALBYN_DEBTS);
    AI_OUTPUT(SELF, OTHER, "DIA_Albyn_PETZMASTER_PayNow_700_01");
    B_GIVEINVITEMS(OTHER, SELF, 34203, ALBYN_DEBTS);
...
func void DIA_ALBYN_LAW_INFO() {
    ...
    CREATEINVITEMS(SELF, 40400, 1);
    B_GIVEINVITEMS(SELF, OTHER, 40400, 1);
}
...
func int DIA_ALBYN_SIRRAMSEY_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 87689)) && ((NPC_KNOWSINFO(OTHER, 68834)) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ALBYN_Q104_FRATERNALASSISTANCE_INFO() {
    ...
    INFO_CLEARCHOICES(87695);
    INFO_ADDCHOICE(87695, "Don't forget that we are the ones in need.", 87698);
    INFO_ADDCHOICE(87695, "You're not very hospitable.", 87699);
    INFO_ADDCHOICE(87695, "How can we help you?", 87700);
}
...
func void DIA_ALBYN_Q104_FRATERNALASSISTANCE3() {
    ...
    INFO_CLEARCHOICES(87695);
    INFO_ADDCHOICE(87695, "Grazing sheep and shoveling dung? Are you kidding me?", 87702);
    INFO_ADDCHOICE(87695, "I'll talk to them, but I doubt they'll be happy.", 87701);
}
...
func int DIA_ALBYN_Q104_FRATERNALASSISTANCE4_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 87695)) && ((NPC_KNOWSINFO(OTHER, 87706)) == (FALSE))) && ((LOG_GETSTATUS(MIS_Q104)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_ALBYN_Q104_FRATERNALASSISTANCE5_CONDITION() {
    if (((((NPC_KNOWSINFO(OTHER, 87695)) && ((Q104_REFUGEESFORWORK) >= (3))) && (NPC_ISINSTATE(SELF, 61599))) && ((LOG_GETSTATUS(MIS_Q104)) == (LOG_RUNNING))) && (NPC_KNOWSINFO(OTHER, 88225))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_ALBYN_NOHELP_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 87935)) && ((HERO.GUILD) == (GIL_NONE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ALBYN_SQ221_START_INFO() {
    ...
    INFO_CLEARCHOICES(87712);
    INFO_ADDCHOICE(87712, "I care about time.", 87716);
    INFO_ADDCHOICE(87712, "How much?", 87715);
...
func void DIA_ALBYN_SQ221_BRIDGE_INFO() {
    ...
    if ((SQ221_UWEDONE) == (1)) {
        ...
        CREATEINVITEMS(SELF, 34203, SQ221_ALBYN_REWARD);
    };
...
var int SQ221_LOGENTRY_ALBYNGOODS;
...
func void DIA_ALBYN_SQ221_FINISH_INFO() {
    CREATEINVITEMS(SELF, 37136, 1);
    B_GIVEINVITEMS(SELF, OTHER, 37136, 1);
    CREATEINVITEMS(SELF, 37419, 1);
    B_GIVEINVITEMS(SELF, OTHER, 37419, 1);
...
func int DIA_ALBYN_SQ227_EZEKIEL_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ227)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 89636))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void ALBYN_SQ227_GIVEDOC() {
    ...
    B_STANDUP();
    B_USEFAKESCROLL();
    CREATEINVITEMS(SELF, 37105, 1);
    B_GIVEINVITEMS(SELF, OTHER, 37105, 1);
...
func void DIA_ALBYN_Q205_INFO() {
    ...
    INFO_CLEARCHOICES(87734);
    INFO_ADDCHOICE(87734, "How do you know they were part of Gerwin's unit?", 87739);
    INFO_ADDCHOICE(87734, "Which way did they go?", 87740);
}

func void DIA_ALBYN_Q205_COUNT() {
    var int ALBYN_Q205_RENEGADEINFORMATIONS;
...
func void DIA_ALBYN_SQ202_INFO() {
    ...
    INFO_CLEARCHOICES(87741);
    INFO_ADDCHOICE(87741, "I didn't know it was illegal.", 87744);
    INFO_ADDCHOICE(87741, "Someone's imagination got carried away.", 87745);
}
...
func void DIA_ALBYN_SQ202_DONTKNOW() {
    ...
    INFO_CLEARCHOICES(87741);
    INFO_ADDCHOICE(87741, "It won't happen again.", 87747);
    INFO_ADDCHOICE(87741, "Why forbid something that people demand?", 87748);
}
...
func void DIA_ALBYN_SQ202_WHATNEXT() {
    INFO_CLEARCHOICES(87741);
    INFO_ADDCHOICE(87741, "What awaits me?", 87749);
}
...
func void DIA_ALBYN_SQ202_DONTKNOW_WHY_WHATNEXT() {
    ...
    INFO_CLEARCHOICES(87741);
    INFO_ADDCHOICE(87741, "Here's the gold. (200 GP)", 87752);
    INFO_ADDCHOICE(87741, "It was Petra.", 87753);
    if ((SQ202_RASCOWANTSJOINT) == (2)) {
        INFO_ADDCHOICE(87741, "Rasco gave me joints. (Frame)", 87754);
    };
    INFO_ADDCHOICE(87741, "Do what you have to do.", 87755);
}
...
func void DIA_ALBYN_SQ202_STOCKS() {
    ...
    INFO_CLEARCHOICES(87741);
    AI_STOPPROCESSINFOS(SELF);
    AI_FUNCTION(SELF, 87756);
}

func void DIA_ALBYN_SQ202_DONTKNOW_WHY_WHATNEXT_GOLD() {
    if ((NPC_HASITEMS(OTHER, 34203)) >= (SQ202_ALBYNSAFE)) {
        AI_OUTPUT(OTHER, SELF, "DIA_Albyn_SQ202_Gold_15_01");
        B_GIVEINVITEMS(OTHER, SELF, 34203, SQ202_ALBYNSAFE);
...
func void ALBYN_SQ202_STOCKS() {
    ...
    FADESCREENTOBLACKF(1, 62711, 1000);
}
...
var int ALBYN_KQ405_QUESTIONS_WHO;
var int ALBYN_KQ405_QUESTIONS_SCOUT;
func int DIA_ALBYN_KQ405_QUESTIONS_CONDITION() {
    if (((LOG_GETSTATUS(MIS_KQ405)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 87764))) {
...
func void DIA_ALBYN_KQ405_QUESTIONS_INFO() {
    INFO_CLEARCHOICES(87767);
    INFO_ADDCHOICE(87767, DIALOG_BACK, 87772);
    if ((ALBYN_KQ405_QUESTIONS_WHO) == (FALSE)) {
        INFO_ADDCHOICE(87767, "Do you know who he was?", 87773);
    };
    if ((ALBYN_KQ405_QUESTIONS_SCOUT) == (FALSE)) {
        INFO_ADDCHOICE(87767, "He made no secret of his profession?", 87774);
    };
}

func void DIA_ALBYN_KQ405_QUESTIONS_BACK() {
    INFO_CLEARCHOICES(87764);
}
...
func int DIA_ALBYN_AMBIENT_CONDITION() {
    if ((NPC_ISINSTATE(SELF, 61599)) && (NPC_KNOWSINFO(OTHER, 87683))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_ALBYN_FORESTBUG_INFO() {
    var int ALBYN_WANTEDPOSTER_REWARD;
    ...
    CREATEINVITEMS(SELF, 34203, ALBYN_WANTEDPOSTER_REWARD);
    B_GIVEINVITEMS(SELF, OTHER, 34203, ALBYN_WANTEDPOSTER_REWARD);
...
func void DIA_ALBYN_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(87782);
    INFO_ADDCHOICE(87782, DIALOG_BACK, 87786);
    INFO_ADDCHOICE(87782, DIALOG_PICKPOCKET, 87785);
}
