...
func void DIA_BEWILDEREDFARMER_NS70_START_INFO() {
    ...
    INFO_CLEARCHOICES(87609);
    INFO_ADDCHOICE(87609, "No.", 87619);
    INFO_ADDCHOICE(87609, "Yes.", 87618);
}

func void DIA_BEWILDEREDFARMER_NS70_ANOTHERCHOICE() {
    INFO_CLEARCHOICES(87609);
    INFO_ADDCHOICE(87609, "No.", 87621);
    INFO_ADDCHOICE(87609, "Yes.", 87620);
}

func void DIA_BEWILDEREDFARMER_NS70_ANOTHERCHOICE2() {
    INFO_CLEARCHOICES(87609);
    INFO_ADDCHOICE(87609, "(Draw your weapon)", 87617);
    INFO_ADDCHOICE(87609, "No.", 87616);
    INFO_ADDCHOICE(87609, "Yes.", 87615);
}
...
func int DIA_BEWILDEREDFARMER_NS70_AFTEREVENT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 87609)) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
