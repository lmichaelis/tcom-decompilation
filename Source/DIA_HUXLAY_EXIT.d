...
func int DIA_HUXLAY_KQ404_GRAYSON_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_KQ404)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 68508))) && (NPC_KNOWSINFO(OTHER, 65783))) {
        return TRUE;
    };
...
func int DIA_HUXLAY_KQ404_HELP_CONDITION() {
    if (((LOG_GETSTATUS(MIS_KQ404)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 65728))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_HUXLAY_KQ404_WHATDO_CONDITION() {
    if (((LOG_GETSTATUS(MIS_KQ404)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 65731))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_HUXLAY_KQ404_WHATDO_INFO() {
    ...
    INFO_CLEARCHOICES(65734);
    INFO_ADDCHOICE(65734, "I don't think he'll be happy.", 65738);
    INFO_ADDCHOICE(65734, "You're in charge.", 65739);
}
...
func int DIA_HUXLAY_KQ404_FINALLY_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_KQ404)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 69891))) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_HUXLAY_KQ404_FINALLY_INFO() {
    ...
    INFO_CLEARCHOICES(65740);
    INFO_ADDCHOICE(65740, "Who are we having fun with?", 65743);
}
...
func int DIA_HUXLAY_KQ404_WHAT_CONDITION() {
    if (((LOG_GETSTATUS(MIS_KQ404)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 68593))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_HUXLAY_KQ404_BEATHIM_CONDITION() {
    if (((LOG_GETSTATUS(MIS_KQ404)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 65744))) {
...
func void DIA_HUXLAY_KQ404_BEATHIM_INFO() {
    ...
    TRIA_WAIT();
    TRIA_NEXT(NONE_1396_INEXTREMO_FLEX_SACK);
    AI_FUNCTION(SELF, 61849);
    AI_OUTPUT(SELF, OTHER, "DIA_Huxlay_KQ404_BeatHim_03_04");
    TRIA_WAIT();
    TRIA_NEXT(MIL_13382_HUXLAY);
    AI_OUTPUT(SELF, OTHER, "DIA_Huxlay_KQ404_BeatHim_03_05");
    INFO_CLEARCHOICES(65748);
    INFO_ADDCHOICE(65748, "With pleasure!", 65752);
    INFO_ADDCHOICE(65748, "It's enough that I have to look at it", 65751);
}
...
func int DIA_HUXLAY_KQ404_AFTERBEATUP_CONDITION() {
    if (((LOG_GETSTATUS(MIS_KQ404)) == (LOG_RUNNING)) && ((KQ404_FLEXATTACK) == (2))) {
        if ((NPC_ISINSTATE(NONE_1396_INEXTREMO_FLEX_SACK, 61603)) == (FALSE)) {
            if (((NPC_GETDISTTOWP(MIL_13382_HUXLAY, "HARBOUR_DARKSECRETS_HUXLAY")) <= (500)) && ((NPC_GETDISTTOWP(NONE_1396_INEXTREMO_FLEX_SACK, "HARBOUR_DARKSECRETS_FLEX")) <= (500))) {
                return TRUE;
            };
        };
...
func void DIA_HUXLAY_KQ404_AFTERBEATUP_INFO() {
    ...
    TRIA_WAIT();
    TRIA_NEXT(MIL_13382_HUXLAY);
    AI_FUNCTION(SELF, 61852);
    AI_OUTPUT(SELF, OTHER, "DIA_Huxlay_KQ404_AfterBeatUp_03_08");
    AI_WAITTILLEND(OTHER, SELF);
    AI_TURNTONPC(SELF, OTHER);
    AI_OUTPUT(SELF, OTHER, "DIA_Huxlay_KQ404_AfterBeatUp_03_09");
    INFO_CLEARCHOICES(65753);
    INFO_ADDCHOICE(65753, "If I have to...", 65757);
    INFO_ADDCHOICE(65753, DIALOG_DONOTTALK, 65756);
}
...
func void DIA_HUXLAY_KQ404_HAVEMERCY_INFO() {
    ...
    TRIA_WAIT();
    TRIA_NEXT(MIL_13382_HUXLAY);
    AI_FUNCTION(SELF, 61855);
    AI_OUTPUT(SELF, OTHER, "DIA_Huxlay_KQ404_HaveMercy_03_08");
    INFO_CLEARCHOICES(65758);
    INFO_ADDCHOICE(65758, DIALOG_INTERVENE, 65761);
    INFO_ADDCHOICE(65758, DIALOG_DONOTTALK, 65763);
}
...
func int DIA_HUXLAY_KQ404_RESULT_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_KQ404)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 68596))) && ((KQ404_FINISHWAY) == (0))) {
        if (((NPC_GETDISTTOWP(MIL_13382_HUXLAY, "HARBOUR_DARKSECRETS_HUXLAY")) <= (500)) && ((NPC_GETDISTTOWP(NONE_1396_INEXTREMO_FLEX_SACK, "HARBOUR_DARKSECRETS_FLEX")) <= (500))) {
            return TRUE;
        };
    };
...
func int DIA_HUXLAY_KQ406_HELLO_CONDITION() {
    if (((LOG_GETSTATUS(MIS_KQ406)) == (LOG_RUNNING)) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_HUXLAY_KQ406_HELLO_INFO() {
    ...
    INFO_CLEARCHOICES(65767);
    INFO_ADDCHOICE(65767, "What makes you so sure?", 65770);
}
...
func int DIA_HUXLAY_KQ406_WHAT_CONDITION() {
    if (((LOG_GETSTATUS(MIS_KQ406)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 65767))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_HUXLAY_KQ406_WHAT_INFO() {
    ...
    CREATEINVITEMS(SELF, 37437, 1);
    B_GIVEINVITEMS(SELF, OTHER, 37437, 1);
}
...
func int DIA_HUXLAY_KQ406_HARBOUR_CONDITION() {
    if ((LOG_GETSTATUS(MIS_KQ406)) == (LOG_RUNNING)) {
        if ((NPC_KNOWSINFO(OTHER, 73236)) || ((KQ406_FIGHTWITHWORKER) == (2))) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
...
func int DIA_HUXLAY_KQ406_OKAY_CONDITION() {
    if (((LOG_GETSTATUS(MIS_KQ406)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 65938))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_HUXLAY_AMBIENT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 65783)) && ((KQ406_BLOCKHUXLAYDIALOGUES) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_HUXLAY_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(65789);
    INFO_ADDCHOICE(65789, DIALOG_BACK, 65793);
    INFO_ADDCHOICE(65789, DIALOG_PICKPOCKET, 65792);
}
