func void EVENTSMANAGER_Q304() {
    ...
    if (((Q304_POCKETGIVEN) == (1)) && ((Q304_CAVEFIGHTAFTERPAYING) == (FALSE))) {
        if (((NPC_GETDISTTONPC(HERO, NONE_6336_BODYGUARD)) >= (4200)) && ((NPC_GETDISTTONPC(HERO, NONE_6340_SMUGGLER)) >= (4200))) {
    ...
    if ((Q304_ANTONIORUNAWAY) == (FALSE)) {
        if (NPC_KNOWSINFO(HERO, 84158)) {
            if (((NPC_GETDISTTONPC(HERO, BAU_6287_GONZALO)) <= (750)) && ((NPC_ISINSTATE(BAU_6287_GONZALO, 61599)) == (FALSE))) {
    ...
    if ((Q304_ANTONIORUNAWAY) == (1)) {
        if (((NPC_GETDISTTOWP(BAU_6287_GONZALO, "PART15_PATH_11")) <= (750)) && ((NPC_ISINSTATE(BAU_6287_GONZALO, 61599)) == (FALSE))) {
    ...
    if ((Q304_BRANCHESANDLEAVESLOGENTRY) == (FALSE)) {
        if (((NPC_HASITEMS(HERO, 37254)) >= (20)) && ((NPC_HASITEMS(HERO, 37255)) >= (20))) {
    ...
    if (((Q304_FINALCUTSCENE) >= (4)) && ((Q304_FINALCUTSCENE) < (10))) {
        ...
        if ((NPC_GETDISTTONPC(HERO, NONE_6340_SMUGGLER)) >= (2500)) {
            MUSIC_DISABLEOVERRIDE();
...
func void Q304_TRAPPITMOVER() {
    var ZCMOVER MOVER1;
    var int MOVPTR1;
    var int CHANGEPITTRAPCOLLISION;
...
func void Q304_CUTSCENEFINAL_START() {
    FADESCREENTOBLACKF(2, 94070, 1000);
}
...
func void Q304_CUTSCENEFINAL_START_FADESCREEN() {
    ...
    if ((Q304_GONZALOSAFED) == (FALSE)) {
        ...
        CREATEINVITEMS(BAU_6287_GONZALO, 37250, 1);
    };
    CUTSCENE_START(92443);
}
