...
func int DIA_JORN_Q101_AFTERFABIOFIGHT_CONDITION() {
    if ((((Q101_FABIOAFTERFIGHT) == (TRUE)) && (NPC_ISINSTATE(SELF, 61599))) && ((LOG_GETSTATUS(MIS_Q101)) == (LOG_RUNNING))) {
        return TRUE;
    };
...
func int DIA_JORN_Q101_WHATSUP_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 64736)) && ((NPC_GETDISTTOWP(SELF, "SHIP_JORN_02")) <= (TA_DIST_SELFWP_MAX))) && ((LOG_GETSTATUS(MIS_Q101)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_JORN_Q101_WHATSUP_INFO() {
    ...
    INFO_CLEARCHOICES(64742);
    INFO_ADDCHOICE(64742, "Actually, I'll talk to them.", 64751);
    if ((SHIPTALK) == (0)) {
        INFO_ADDCHOICE(64742, "No.", 64749);
    };
    INFO_ADDCHOICE(64742, "More or less.", 64748);
}
...
func int DIA_JORN_Q101_STANDING_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 64742)) && ((Q101_JORNWILLTRY) == (TRUE))) && ((LOG_GETSTATUS(MIS_Q101)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
