...
func void DIA_SOREN_SQ208_LIGHTSOURCE_BACK() {
    INFO_CLEARCHOICES(86140);
}

func void DIA_SOREN_SQ208_LIGHTSOURCE_INFO() {
    INFO_CLEARCHOICES(86140);
    INFO_ADDCHOICE(86140, DIALOG_BACK, 86142);
    if ((NPC_HASITEMS(OTHER, 34742)) >= (1)) {
        INFO_ADDCHOICE(86140, "(Give torch)", 86145);
    };
    if ((NPC_HASITEMS(OTHER, 34686)) >= (1)) {
        INFO_ADDCHOICE(86140, "(Give scroll of light)", 86146);
    };
}
...
func void DIA_SOREN_SQ208_LIGHTSOURCE_TORCH() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 34742, 1);
    AI_WAITTILLEND(SELF, OTHER);
...
func void DIA_SOREN_SQ208_LIGHTSOURCE_SCROLL() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 34686, 1);
...
func void DIA_SOREN_Q207_ANTONIO_INFO() {
    ...
    INFO_CLEARCHOICES(86148);
    INFO_ADDCHOICE(86148, "Apparently, he's got connections to a dangerous gang.", 86154);
    if (NPC_HASGUILDARMOREQUIPPED(OTHER, GIL_MIL)) {
        INFO_ADDCHOICE(86148, "It's city guard business.", 86166);
    };
}
...
func void DIA_SOREN_Q207_ANTONIO_CHOICES() {
    INFO_CLEARCHOICES(86148);
    INFO_ADDCHOICE(86148, "I'm looking for my brother.", 86165);
    INFO_ADDCHOICE(86148, "(Intimidate)", 86157);
    INFO_ADDCHOICE(86148, "How much do you want for this information?", 86155);
}
...
func void DIA_SOREN_Q207_ANTONIO_INFORMATION() {
    ...
    INFO_CLEARCHOICES(86148);
    INFO_ADDCHOICE(86148, "What did these people do to him? Did they threaten him?", 86162);
    INFO_ADDCHOICE(86148, "Why didn't he report to the guard?", 86163);
    INFO_ADDCHOICE(86148, "What do you know about these kidnappers?", 86164);
}
...
func void DIA_SOREN_Q207_ANTONIO_COUNT() {
    var int ISSAC_Q207_INFORMATION;
...
func int DIA_SOREN_Q207_WINECHESTS_CONDITION() {
    if ((LOG_GETSTATUS(MIS_Q205)) == (LOG_SUCCESS)) {
        if ((LOG_GETSTATUS(MIS_Q207)) == (LOG_RUNNING)) {
            if (((MOB_HASITEMS("WITHOUTRACE_VINEYARD_CHEST_02", 37147)) == (2)) && ((LOG_GETSTATUS(MIS_Q207)) == (LOG_RUNNING))) {
                return TRUE;
            };
        };
    };
...
func void DIA_SOREN_Q207_WINECHESTS_INFO() {
    ...
    AI_RESETFACEANI(OTHER);
    INFO_CLEARCHOICES(86167);
    INFO_ADDCHOICE(86167, "They were lying between the bushes.", 86171);
    INFO_ADDCHOICE(86167, "Gonzalo took them.", 86172);
}
...
func int DIA_SOREN_Q207_RIKANTONIO_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_Q207)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 89004))) && (NPC_KNOWSINFO(OTHER, 86148))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_SOREN_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(86182);
    INFO_ADDCHOICE(86182, DIALOG_BACK, 86186);
    INFO_ADDCHOICE(86182, DIALOG_PICKPOCKET, 86185);
}
