...
func int DIA_WORKER2_BUSY_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_SQ309)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 75597))) && ((NPC_KNOWSINFO(OTHER, 77098)) == (FALSE))) && ((NPC_KNOWSINFO(OTHER, 75818)) == (FALSE))) {
        return FALSE;
    };
...
func int DIA_WORKER2_SQ309_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ309)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 75597))) && ((NPC_KNOWSINFO(OTHER, 77098)) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
