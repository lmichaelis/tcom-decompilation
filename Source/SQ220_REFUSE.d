...
func int DIA_EWALD_SQ220_BEGIN_CONDITION() {
    if ((((NPC_HASITEMS(OTHER, 34203)) >= (SQ220_TRIGGER)) && ((MARVIN_MILITIASPECIALIZATION) == (MILITIA_SPECIALIZATION_NONE))) && ((MARVIN_ARAXOSSPECIALIZATION) == (ARAXOS_SPECIALIZATION_NONE))) {
...
func void DIA_EWALD_SQ220_BEGIN_INFO() {
    ...
    INFO_CLEARCHOICES(67676);
    INFO_ADDCHOICE(67676, "I don't have time right now.", 67680);
    INFO_ADDCHOICE(67676, "Sure, what needs to be done?", 67683);
}
...
func void DIA_EWALD_SQ220_YEAH3() {
    ...
    if ((SQ220_REFUSE) == (0)) {
        INFO_CLEARCHOICES(67676);
        INFO_ADDCHOICE(67676, "I don't have time right now.", 67682);
        INFO_ADDCHOICE(67676, "Let's go.", 67685);
    };
    INFO_CLEARCHOICES(67688);
    INFO_ADDCHOICE(67688, "I don't have time right now.", 67682);
    INFO_ADDCHOICE(67688, "Let's go.", 67685);
}
...
func void DIA_EWALD_SQ220_HELLYEAH() {
    ...
    CREATEINVITEMS(SELF, 36958, 3);
    B_GIVEINVITEMS(SELF, OTHER, 36958, 3);
...
func void EWALD_SQ220_SPAWNFRIENDS() {
    ...
    WLD_INSERTNPC(53162, "PARTM4_WORKSHOP_FRIEND_01");
    WLD_INSERTNPC(53165, "PARTM4_WORKSHOP_FRIEND_02");
}
...
func int DIA_EWALD_SQ220_AFTERREFUSE1_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 67676)) && ((SQ220_REFUSE) == (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_EWALD_SQ220_AFTERREFUSE2_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 67676)) && ((SQ220_REFUSE) == (2))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_EWALD_SQ220_TRAP_INFO() {
    ...
    TRIA_START();
    NPC_REMOVEINVITEMS(HERO, 36958, NPC_HASITEMS(HERO, 36958));
    AI_STARTFACEANI(SELF, S_SMUG, 1, -(1));
    AI_OUTPUT(SELF, OTHER, "DIA_Ewald_SQ220_Trap_03_01");
    INFO_CLEARCHOICES(67694);
    INFO_ADDCHOICE(67694, "What deal?", 67698);
    INFO_ADDCHOICE(67694, "Are you trying to rob me?", 67697);
}
...
func void DIA_EWALD_SQ220_TRAP_DEAL() {
    ...
    INFO_CLEARCHOICES(67694);
    if ((NPC_HASITEMS(OTHER, 34203)) >= (SQ220_DEAL)) {
        INFO_ADDCHOICE(67694, "Give me that contract.", 67703);
    };
    INFO_ADDCHOICE(67694, "What's in it for me?", 67700);
    INFO_ADDCHOICE(67694, "I'm not giving you my gold!", 67699);
}
...
func void DIA_EWALD_SQ220_TRAP_DEAL_GIVE() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 34203, SQ220_DEAL);
...
func int DIA_EWALD_SQ220_AFTERFIGHT_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ220)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 67694))) {
...
func void DIA_EWALD_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(67712);
    INFO_ADDCHOICE(67712, DIALOG_BACK, 67716);
    INFO_ADDCHOICE(67712, DIALOG_PICKPOCKET, 67715);
}
