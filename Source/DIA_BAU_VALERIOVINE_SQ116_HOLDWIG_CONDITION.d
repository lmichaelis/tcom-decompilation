func int DIA_BAU_VALERIOVINE_SQ116_HOLDWIG_CONDITION() {
    if ((LOG_GETSTATUS(MIS_SQ116)) == (LOG_RUNNING)) {
        if (((NPC_KNOWSINFO(OTHER, 64891)) && ((SQ116_BLOCKTERRYWAY) == (FALSE))) && ((SQ116_GUMBERTWAY_BLOCK) == (FALSE))) {
...
func int DIA_BAU_VALERIOVINE_SQ225_QUESTION_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_SQ225)) == (LOG_RUNNING)) && ((NPC_KNOWSINFO(OTHER, 73879)) == (FALSE))) && ((NPC_KNOWSINFO(OTHER, 65171)) == (FALSE))) && ((SQ225_FIGHTINVINEYARD_BLOCKFASTTRAVEL) == (0))) {
...
var int SQ225_BAU_VALERIOVINE_FIRECART_LOGENTRY;
...
func int DIA_BAU_VALERIOVINE_SQ225_GOAWAY_CONDITION() {
    if ((LOG_GETSTATUS(MIS_SQ225)) == (LOG_RUNNING)) {
        if ((((SQ225_ANDERASWAY_FAILED) == (TRUE)) && (NPC_KNOWSINFO(OTHER, 72211))) && (NPC_ISINSTATE(SELF, 61599))) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
...
func int DIA_BAU_VALERIOVINE_SQ225_HELPME_CONDITION() {
    if ((LOG_GETSTATUS(MIS_SQ225)) == (LOG_RUNNING)) {
        if (((SQ225_FIGHTINVINEYARD_HOLDWIG) >= (2)) && (NPC_ISINSTATE(SELF, 61599))) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
