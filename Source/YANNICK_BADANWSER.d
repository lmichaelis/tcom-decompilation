var int YANNICK_BADANWSER;
var int YANNICK_PREPARETIME;
var int YANNICK_SWAMPPOINTS;
...
func int DIA_YANNICK_Q208_BUSINESS_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 77940)) && ((LOG_GETSTATUS(MIS_Q208)) == (LOG_RUNNING))) && ((Q208_MILITIAFINISHWAY) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_YANNICK_Q208_BUSINESS_INFO() {
    ...
    INFO_CLEARCHOICES(77943);
    INFO_ADDCHOICE(77943, "You go boating?", 77946);
    INFO_ADDCHOICE(77943, "Apparently, you're in the business of making people 'disappear'.", 77947);
}
...
func void DIA_YANNICK_Q208_BUSINESS_BOAT() {
    ...
    INFO_CLEARCHOICES(77943);
    INFO_ADDCHOICE(77943, "'Take me where the waters are shallow and the fish are big.'", 77948);
    INFO_ADDCHOICE(77943, "'Take me where the waters are deep and the fish are thick.'", 77949);
    INFO_ADDCHOICE(77943, "'Take me where the waters are shallow and the fish are thick.'", 77950);
}
...
func void DIA_YANNICK_Q208_BUSINESS_BOAT_RIGHT() {
    ...
    INFO_CLEARCHOICES(77943);
    INFO_ADDCHOICE(77943, "Why?", 77951);
    INFO_CLEARCHOICES(77952);
    INFO_ADDCHOICE(77952, "Why?", 77951);
}
...
func void DIA_YANNICK_Q208_BUSINESS_WHY() {
    ...
    if (NPC_ISDEAD(MIL_6352_RANDHAL)) {
        WLD_INSERTNPC(55856, MIL_6352_RANDHAL.WP);
    };
    if (NPC_ISDEAD(MIL_6353_MILITIA)) {
        WLD_INSERTNPC(55865, MIL_6353_MILITIA.WP);
    };
}
...
func int DIA_YANNICK_Q208_GOODANWSER_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 77943)) && ((LOG_GETSTATUS(MIS_Q208)) == (LOG_RUNNING))) && ((YANNICK_BADANWSER) == (TRUE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_YANNICK_Q208_MILITIAGONE_HAVEN() {
    ...
    INFO_CLEARCHOICES(77955);
    INFO_ADDCHOICE(77955, "What do you mean by that?", 77962);
}
...
func void DIA_YANNICK_Q208_MILITIAGONE_INFO() {
    ...
    if ((Q208_MILITIAFINISHWAY) == (1)) {
        ...
        INFO_CLEARCHOICES(77955);
        INFO_ADDCHOICE(77955, "I have my ways.", 77960);
        INFO_ADDCHOICE(77955, "It wasn't difficult.", 77961);
    };
}
...
func void DIA_YANNICK_Q208_MILITIAGONE_WHAT() {
    ...
    INFO_CLEARCHOICES(77955);
    INFO_ADDCHOICE(77955, "I'll manage somehow.", 77964);
    INFO_ADDCHOICE(77955, "This is great news!", 77965);
}
...
func void DIA_YANNICK_Q208_MILITIAGONE_READY() {
    ...
    INFO_CLEARCHOICES(77955);
    INFO_ADDCHOICE(77955, "I need to get ready.", 77966);
    INFO_ADDCHOICE(77955, "There's no time to waste!", 77968);
}
...
func int DIA_YANNICK_READYBOAT_CONDITION() {
    if ((((YANNICK_PREPARETIME) == (TRUE)) && (NPC_KNOWSINFO(OTHER, 77955))) && ((LOG_GETSTATUS(MIS_Q208)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_YANNICK_Q208_SWAMP_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 77972)) && ((NPC_GETDISTTOWP(SELF, "PART17_SWAMPBLOOD_02")) <= (500))) && ((LOG_GETSTATUS(MIS_Q208)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_YANNICK_Q208_SWAMP_INFO() {
    ...
    INFO_CLEARCHOICES(77977);
    INFO_ADDCHOICE(77977, "How do I get to this 'Haven'?", 77981);
    INFO_ADDCHOICE(77977, "Do you have any more advice for me?", 77982);
}
...
func void DIA_YANNICK_Q208_SWAMP_DEAL_WHY() {
    ...
    INFO_CLEARCHOICES(77977);
    INFO_ADDCHOICE(77977, "I'm looking for my brother.", 77984);
    INFO_ADDCHOICE(77977, "I'd rather keep it to myself.", 77985);
}
...
func void DIA_YANNICK_AMBIENT_INFO() {
    ...
    if ((LOG_GETSTATUS(MIS_Q208)) == (LOG_RUNNING)) {
        if ((NPC_KNOWSINFO(OTHER, 77972)) && ((NPC_GETDISTTOWP(SELF, "PART17_SWAMPBLOOD_02")) <= (3000))) {
...
func void DIA_YANNICK_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(77990);
    INFO_ADDCHOICE(77990, DIALOG_BACK, 77994);
    INFO_ADDCHOICE(77990, DIALOG_PICKPOCKET, 77993);
}
