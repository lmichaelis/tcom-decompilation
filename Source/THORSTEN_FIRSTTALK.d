var int THORSTEN_FIRSTTALK;
var int THORSTEN_TAKEQUEST;
...
func int DIA_THORSTEN_TRADE_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 88509)) && ((LOG_GETSTATUS(MIS_Q515)) != (LOG_SUCCESS))) {
        return TRUE;
    };
    if (((LOG_GETSTATUS(MIS_Q515)) == (LOG_SUCCESS)) && ((NPC_KNOWSINFO(OTHER, 88500)) == (FALSE))) {
        return FALSE;
    };
    if (((LOG_GETSTATUS(MIS_Q515)) == (LOG_SUCCESS)) && (NPC_KNOWSINFO(OTHER, 88500))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_THORSTEN_HELLO_CONDITION() {
    if ((NPC_ISINSTATE(SELF, 61599)) && ((LOG_GETSTATUS(MIS_Q515)) != (LOG_SUCCESS))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_THORSTEN_SQ202HAMMERS_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ202)) == (LOG_RUNNING)) && ((NPC_HASITEMS(OTHER, 37129)) >= (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_THORSTEN_SQ202IRON_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ202)) == (LOG_RUNNING)) && ((NPC_HASITEMS(OTHER, 37127)) >= (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_THORSTEN_BOLT_INFO() {
    ...
    if (((STONE_NEWTEACHER) == (0)) && (NPC_KNOWSINFO(OTHER, 88580))) {
    ...
    INFO_CLEARCHOICES(88524);
    INFO_ADDCHOICE(88524, "Thanks for your help.", 88527);
    INFO_ADDCHOICE(88524, "Thanks for nothing.", 88528);
}
...
func int DIA_THORSTEN_TEACH_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 88515)) && ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_SMITH)) < (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_THORSTEN_TRAIN_SMITH_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 88529)) && ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_SMITH)) < (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_THORSTEN_TRAIN_SMITH_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (THORSTEN_PAYMENT)) {
        if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_SMITH)) >= (1)) {
            NPC_REMOVEINVITEMS(SELF, 34203, THORSTEN_PAYMENT);
            AI_OUTPUT(SELF, OTHER, "DIA_Thorsten_TRAIN_smith_03_01");
            B_GIVEINVITEMS(OTHER, SELF, 34203, THORSTEN_PAYMENT);
...
func void DIA_THORSTEN_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(88538);
    INFO_ADDCHOICE(88538, DIALOG_BACK, 88542);
    INFO_ADDCHOICE(88538, DIALOG_PICKPOCKET, 88541);
}

func void DIA_THORSTEN_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (1)) {
        CREATEINVITEMS(SELF, 34228, 1);
        B_GIVEINVITEMS(SELF, OTHER, 34228, 1);
