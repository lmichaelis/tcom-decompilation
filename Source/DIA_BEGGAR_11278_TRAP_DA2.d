...
func void DIA_BEGGAR_11278_TRAP_DA2_INFO() {
    INFO_CLEARCHOICES(72348);
    INFO_ADDCHOICE(72348, "(Do nothing)", 72351);
    if ((NPC_HASITEMS(OTHER, 34203)) >= (EVENT_BEGGARARMY)) {
        INFO_ADDCHOICE(72348, DIALOG_GIVE10G, 72352);
    };
}
...
func void DIA_BEGGAR_11278_TRAP_DA3_INFO() {
    INFO_CLEARCHOICES(72353);
    INFO_ADDCHOICE(72353, "(Do nothing)", 72356);
    if ((NPC_HASITEMS(OTHER, 34203)) >= (EVENT_BEGGARARMY)) {
        INFO_ADDCHOICE(72353, DIALOG_GIVE10G, 72357);
    };
}
