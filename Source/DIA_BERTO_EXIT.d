...
func void DIA_BERTO_Q205_HELP_INFO() {
    ...
    AI_STARTFACEANI(SELF, S_SMILE, 1, -(1));
    CREATEINVITEMS(SELF, 35509, 1);
    B_GIVEINVITEMS(SELF, OTHER, 35509, 1);
    AI_EQUIPARMOR(SELF, 35509);
    AI_EQUIPARMOR(OTHER, 35509);
    AI_OUTPUT(SELF, OTHER, "DIA_Berto_Q205_Help_03_01");
    AI_OUTPUT(SELF, OTHER, "DIA_Berto_Q205_Help_03_02");
    INFO_CLEARCHOICES(78625);
    INFO_ADDCHOICE(78625, "I have to get out of here somehow!", 78635);
    INFO_ADDCHOICE(78625, "Why are you helping me?", 78631);
}
...
func void DIA_BERTO_Q205_HELP_WHY() {
    ...
    INFO_ADDCHOICE(78625, "Can you tell me exactly what happened here?", 78632);
    INFO_ADDCHOICE(78625, "How can I get my stuff back?", 78633);
}
...
func void DIA_BERTO_Q205_HELP_WHY_HOW() {
    ...
    INFO_ADDCHOICE(78625, "Any idea how to get rid of him?", 78634);
}
...
func int DIA_BERTO_Q205_IDEA_CONDITION() {
    if (((LOG_GETSTATUS(MIS_Q205)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 78576))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_BERTO_Q205_IDEA_INFO() {
    ...
    CREATEINVITEMS(SELF, 35921, 1);
    B_GIVEINVITEMS(SELF, OTHER, 35921, 1);
    AI_STARTFACEANI(SELF, S_THINK, 1, -(1));
    AI_PLAYANI(SELF, T_SEARCH);
    AI_OUTPUT(SELF, OTHER, "DIA_Berto_Q205_Idea_03_04");
    INFO_CLEARCHOICES(78636);
    INFO_ADDCHOICE(78636, "What makes you so sure I'm alone?", 78639);
    INFO_ADDCHOICE(78636, "Roderich clearly did not foresee that a rebellion had occurred.", 78640);
}
...
func void DIA_BERTO_Q205_IDEA_RIOT() {
    ...
    INFO_CLEARCHOICES(78636);
    INFO_ADDCHOICE(78636, "I'm looking for my brother. I suspect he was abducted in Silbach.", 78641);
}
...
func int DIA_BERTO_Q205_IMBUSY_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_Q205)) == (LOG_RUNNING)) && ((Q205_ATTACKVINEYARD_READ) == (TRUE))) && ((Q205_TREEHEROFELL) != (2))) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
var int BERTO_Q205_RUNAWAY_WHAT;
var int BERTO_Q205_RUNAWAY_KILL;
func void DIA_BERTO_Q205_RUNAWAY_CHOICES() {
    INFO_CLEARCHOICES(78645);
    if (((BERTO_Q205_RUNAWAY_WHAT) == (FALSE)) || ((BERTO_Q205_RUNAWAY_KILL) == (FALSE))) {
        if ((BERTO_Q205_RUNAWAY_WHAT) == (FALSE)) {
            INFO_ADDCHOICE(78645, "What do I do?", 78652);
        };
        if ((BERTO_Q205_RUNAWAY_KILL) == (FALSE)) {
            INFO_ADDCHOICE(78645, "Did you kill him?", 78651);
        };
    };
    INFO_ADDCHOICE(78645, "Good luck, Berto.", 78654);
}
...
func void DIA_BERTO_Q205_RUNAWAY_WHAT() {
    ...
    INFO_CLEARCHOICES(78645);
    INFO_ADDCHOICE(78645, "You're not running away?", 78653);
}
...
func int DIA_BERTO_QM401_SALVI_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 78658)) && ((LOG_GETSTATUS(MIS_QM401)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_BERTO_QM401_NOTIME_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_QM401)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 66200))) && ((NPC_GETDISTTOWP(SELF, "PART7_PATH_64")) <= (1500))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_BERTO_QM401_AFTERBRODDY_INFO() {
    ...
    INFO_CLEARCHOICES(78667);
    INFO_ADDCHOICE(78667, "Roderich assigned additional men to protect the vineyard.", 78670);
}
...
func void DIA_BERTO_QM401_AFTERBRODDY_PROTECTION() {
    ...
    INFO_CLEARCHOICES(78667);
    INFO_ADDCHOICE(78667, "What do you suggest?", 78671);
}
...
func void DIA_BERTO_QM401_AFTERFIGHT_INFO() {
    ...
    INFO_CLEARCHOICES(78672);
    INFO_ADDCHOICE(78672, "You too, Berto!", 78676);
    INFO_ADDCHOICE(78672, "We made it!", 78677);
}
...
func void DIA_BERTO_Q509_QUESTION_INFO() {
    ...
    INFO_CLEARCHOICES(78678);
    INFO_ADDCHOICE(78678, "Just like that? You know what they say about this place?", 78681);
}
...
func int DIA_BERTO_Q509_LETSGO_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_Q509)) == (LOG_RUNNING)) && ((LOG_GETSTATUS(MIS_QM401)) == (LOG_SUCCESS))) && ((Q509_COUNTWARRIORS) < (4))) && (NPC_KNOWSINFO(OTHER, 78678))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_BERTO_Q509_FEEL_CONDITION() {
    if (((NPC_GETDISTTOWP(SELF, "PART5_Q509_BERTO")) <= (2000)) && ((Q509_BERTOVOLFZACKE) == (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
