...
var int IVY_Q602_HELLO_TRAITOR;
var int IVY_Q602_HELLO_WHERE;
var int IVY_Q602_HELLO_VOLKER;
...
func void IVY_FINALFIGHT() {
    FF_APPLYONCEEXTGT(90496, 0, -(1));
    INFO_CLEARCHOICES(90491);
    AI_STOPPROCESSINFOS(SELF);
...
func void DIA_IVY_Q602_HELLO_CHOICES() {
    INFO_CLEARCHOICES(90491);
    INFO_ADDCHOICE(90491, "Enough of this talk.", 90507);
    if ((IVY_Q602_HELLO_VOLKER) == (FALSE)) {
        INFO_ADDCHOICE(90491, "Do you know where the Usurer is?", 90505);
    };
    if ((IVY_Q602_HELLO_WHERE) == (FALSE)) {
        INFO_ADDCHOICE(90491, "Where have you been all this time?", 90502);
    };
    if ((IVY_Q602_HELLO_TRAITOR) == (FALSE)) {
        INFO_ADDCHOICE(90491, "You're the one who sent those people in the Wolf's Den after me!", 90500);
    };
}
...
func void DIA_IVY_Q602_HELLO_TRAITOR() {
    ...
    INFO_CLEARCHOICES(90491);
    INFO_ADDCHOICE(90491, "I think I understand everything now...", 90501);
}
...
func void DIA_IVY_Q602_HELLO_WHERE() {
    ...
    INFO_CLEARCHOICES(90491);
    INFO_ADDCHOICE(90491, "What did he do to you?", 90503);
}
...
func void DIA_IVY_Q602_HELLO_WHERE_WHAT() {
    ...
    if ((NPC_ISDEAD(NONE_2246_BRADLOCK_Q602)) && ((Q305_JAVAD_WENTTONEWHOME) != (2))) {
        INFO_CLEARCHOICES(90491);
        INFO_ADDCHOICE(90491, "I killed Bradlock.", 90504);
    };
    DIA_IVY_Q602_HELLO_CHOICES();
}
...
func void DIA_IVY_Q602_HELLO_VOLKER() {
    ...
    INFO_CLEARCHOICES(90491);
    INFO_ADDCHOICE(90491, "You're the one who killed his men?", 90506);
}
...
func void DIA_IVY_Q602_HELLO_FINISH() {
    INFO_CLEARCHOICES(90491);
    INFO_ADDCHOICE(90491, DIALOG_BACK, 90508);
    INFO_ADDCHOICE(90491, "We both want to get rid of the Usurer, let's join forces.", 90511);
    INFO_ADDCHOICE(90491, "I'm giving you one chance to disappear forever.", 90510);
    INFO_ADDCHOICE(90491, "You contributed to Jorn's death, you have to pay for it.", 90509);
}
...
func void DIA_IVY_Q602_HELLO_FINISH_LEAVE() {
    ...
    if ((IVYREPUTATION) >= (5)) {
        ...
        AI_FUNCTION(SELF, 90512);
        AI_SETWALKMODE(SELF, NPC_WALK);
        AI_GOTOWP(SELF, "PARTE5_SEWERS_12");
        AI_FUNCTION(SELF, 90513);
        AI_USEMOB(SELF, "LEVER", -(1));
        AI_FUNCTION(SELF, 90514);
        AI_USEMOB(SELF, "LEVER", 1);
...
func void DIA_IVY_Q602_HELLO_FINISH_TOGETHER() {
    ...
    INFO_CLEARCHOICES(90491);
    INFO_ADDCHOICE(90491, "I don't blame you... I've done a lot of bad things myself lately...", 90520);
    INFO_ADDCHOICE(90491, "We'll get that bastard and we'll each go our separate ways.", 90521);
}

func void IVY_Q602_CAMERA_01() {
    TELEPORTNPCTOWP(1819, "PARTE5_SEWERS_14");
    TELEPORTNPCTOWP(59916, "PARTE5_IVY");
...
func void IVY_Q602_CAMERA_END() {
    FF_APPLYONCEEXTGT(90516, 75, 4);
}

func void IVY_Q602_CAMERA_END_APPLY() {
    var int IVY_Q602_CAMERA_END_COUNT;
...
func int DIA_IVY_Q602_AMBIENT_CONDITION() {
    if ((NPC_ISINSTATE(SELF, 61599)) && ((IVY_Q602_JOINEDTEAM) == (TRUE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
