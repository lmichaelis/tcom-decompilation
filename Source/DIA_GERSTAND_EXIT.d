...
func int DIA_GERSTAND_HELLO_CONDITION() {
    if ((NPC_GETDISTTOWP(SELF, "PARTM4_TAVERN_GERSTAND")) <= (3000)) {
        return TRUE;
    };
...
func int DIA_GERSTAND_CQ003_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_CQ003)) == (LOG_RUNNING)) && ((NPC_HASITEMS(OTHER, 36364)) >= (1))) && (NPC_KNOWSINFO(OTHER, 69287))) {
        if ((NPC_GETDISTTOWP(SELF, "PARTM4_TAVERN_GERSTAND")) <= (3000)) {
            return TRUE;
        };
    };
...
func void DIA_GERSTAND_CQ003_INFO() {
    ...
    INFO_CLEARCHOICES(69296);
    INFO_ADDCHOICE(69296, "Dark Paladine has a very rich, surprising flavor and aroma.", 69300);
    INFO_ADDCHOICE(69296, "Dark Paladine is a strong, warming beer.", 69299);
}
...
func void DIA_GERSTAND_WELCOMEMIL_INFO() {
    ...
    AI_STOPPROCESSINFOS(SELF);
    AI_RESETFACEANI(SELF);
    CREATEINVITEMS(SELF, 33974, 1);
    B_GIVEINVITEMS(SELF, OTHER, 33974, 1);
}
...
func void DIA_GERSTAND_SQ225_GERHARD_INFO() {
    ...
    MOB_CREATEITEMS("SQ225_GERSTANDCHEST", 37084, 1);
    AI_OUTPUT(OTHER, SELF, "DIA_Gerstand_SQ225_Gerhard_15_01");
    AI_STARTFACEANI(SELF, S_SERIOUS, 1, -(1));
    AI_OUTPUT(SELF, OTHER, "DIA_Gerstand_SQ225_Gerhard_03_02");
    INFO_CLEARCHOICES(69304);
    INFO_ADDCHOICE(69304, "Is that important? I want to offer you to take over his position.", 69309);
    INFO_ADDCHOICE(69304, "None of your business. You better tell me what you know about him.", 69308);
    if ((KAPITEL) == (2)) {
        if (((HERO.GUILD) != (GIL_MIL)) && ((HERO.GUILD) != (GIL_SLD))) {
            INFO_ADDCHOICE(69304, "My name is Marvin.", 69310);
        };
    };
...
func int DIA_GERSTAND_SQ225_GETOUT_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_SQ225)) == (LOG_RUNNING)) && ((SQ225_GERSTANDBOOK_READ) == (1))) && ((SQ225_HOLDWIGWAY_AGREED) == (1))) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_GERSTAND_SQ225_GETOUT_INFO() {
    ...
    INFO_CLEARCHOICES(69311);
    INFO_ADDCHOICE(69311, "I'm going to get rid of Gerhard, and you're going to help me do it.", 69316);
    INFO_ADDCHOICE(69311, "Relax, I just wanted to ask if you lost anything.", 69315);
}

func void DIA_GERSTAND_SQ225_GETOUT_CHOICES() {
    INFO_CLEARCHOICES(69311);
    INFO_ADDCHOICE(69311, "Tell Gerhard about the situation and urge him to leave Archolos.", 69321);
    INFO_ADDCHOICE(69311, "Plead guilty.", 69320);
}
...
var int GERSTAND_SQ225_GERHARDBYEBYE;
var int GERSTAND_SQ225_GERHARDBYEBYE_DAY;
var int GERSTAND_SQ225_WENTTOBARRACK;
...
func void DIA_GERSTAND_SQ225_GERHARDGONE_INFO() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 37084, 1);
    AI_STARTFACEANI(SELF, S_SMILE, 1, -(1));
...
func void DIA_GERSTAND_SQ225_READY_INFO() {
    ...
    INFO_CLEARCHOICES(69325);
    INFO_ADDCHOICE(69325, "It's your only chance to get out of the case alive.", 69330);
    INFO_ADDCHOICE(69325, "You come in, explain everything in detail, and you're done.", 69329);
}
...
func void DIA_GERSTAND_SQ225_AFTERRODERICH_INFO() {
    ...
    INFO_CLEARCHOICES(69331);
    INFO_ADDCHOICE(69331, "That's all I wanted to hear. Goodbye.", 69335);
    INFO_ADDCHOICE(69331, "So you were lucky to run into me.", 69334);
}
...
func int DIA_GERSTAND_BRUNO_CONDITION() {
    if (((KAPITEL) == (3)) && (!(NPC_KNOWSINFO(OTHER, 75971)))) {
        if ((NPC_GETDISTTOWP(SELF, "PARTM4_TAVERN_GERSTAND")) <= (3000)) {
...
func void DIA_GERSTAND_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(69346);
    INFO_ADDCHOICE(69346, DIALOG_BACK, 69350);
    INFO_ADDCHOICE(69346, DIALOG_PICKPOCKET, 69349);
}
