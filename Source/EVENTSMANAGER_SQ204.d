func void EVENTSMANAGER_SQ204() {
    ...
    if ((SQ204_DETLOWATTACKWOLF) == (1)) {
        if ((((((NPC_ISDEAD(WOLF_DETLOW_01)) && (NPC_ISDEAD(WOLF_DETLOW_02))) && (NPC_ISDEAD(WOLF_DETLOW_03))) && (NPC_ISDEAD(WOLF_DETLOW_04))) && (NPC_ISDEAD(WOLF_DETLOW_05))) && ((NPC_ISINSTATE(VLK_3015_DETLOW, 61599)) == (FALSE))) {
    ...
    if ((SQ204_STARTCUTSCENE) == (2)) {
        if (((NPC_GETDISTTOWP(VLK_3015_DETLOW, "PART11_PATH_62")) <= (500)) && ((NPC_ISINSTATE(VLK_3015_DETLOW, 61599)) == (FALSE))) {
