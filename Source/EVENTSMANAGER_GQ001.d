func void EVENTSMANAGER_GQ001() {
    ...
    if ((GQ001_KURTGOTOALBYN) == (FALSE)) {
        if (NPC_KNOWSINFO(HERO, 87898)) {
            if (NPC_KNOWSINFO(HERO, 88045)) {
                if ((NPC_GETDISTTOWP(HERO, "VILLAGE_POORPLACE_03")) >= (5000)) {
                    GQ001_REMOVEFARMERS();
    ...
    if ((LOG_GETSTATUS(MIS_Q201)) != (LOG_RUNNING)) {
        ...
        if ((GQ001_BEACHPART13) == (FALSE)) {
            if (((NPC_GETDISTTOWP(HERO, "PART_13_NAV_06")) < (500)) && (NPC_KNOWSINFO(HERO, 89575))) {
