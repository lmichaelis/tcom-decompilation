...
func int DIA_RIORDIAN_Q514_HELLO_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_Q514)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 87105))) && ((Q514_CRAWLER_FINISH) == (0))) {
        return TRUE;
    };
...
func int DIA_RIORDIAN_Q514_IDEA_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_Q514)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 86756))) && ((Q514_CRAWLER_FINISH) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_RIORDIAN_Q514_FINALLY_INFO() {
    ...
    INFO_CLEARCHOICES(86762);
    INFO_ADDCHOICE(86762, "It won't be necessary. They're dead.", 86774);
    INFO_ADDCHOICE(86762, "I've met them, but I'm the only one who made it back here.", 86775);
}
...
var int RIORDIANVZ_WHODIES_KESSEL;
var int RIORDIANVZ_WHODIES_MARKUS;
var int RIORDIANVZ_WHODIES_DACK;
var int RIORDIANVZ_WHODIES_COUNT;
func void DIA_RIORDIAN_Q514_FINALLY_SWORD() {
    ...
    if ((RIORDIANVZ_WHODIES_KESSEL) == (FALSE)) {
        INFO_ADDCHOICE(86762, "I'm sorry, Riordan. The tomb was empty.", 86781);
    };
    INFO_ADDCHOICE(86762, "Not only were the legends of death and suffering true. I found the Peacemaker.", 86782);
}
...
func void DIA_RIORDIAN_Q514_FINALLY_CHOICES() {
    ...
    if ((((RIORDIANVZ_WHODIES_KESSEL) == (TRUE)) || ((RIORDIANVZ_WHODIES_MARKUS) == (TRUE))) || ((RIORDIANVZ_WHODIES_DACK) == (TRUE))) {
        INFO_ADDCHOICE(86762, "I haven't met anyone else.", 86780);
    };
    if ((RIORDIANVZ_WHODIES_DACK) == (FALSE)) {
        INFO_ADDCHOICE(86762, "Duster and I were trying to get through the crawler tunnels.", 86779);
    };
    if ((RIORDIANVZ_WHODIES_MARKUS) == (FALSE)) {
        INFO_ADDCHOICE(86762, "Markus throw himself at the heap of gold in the vault.", 86778);
    };
    if ((RIORDIANVZ_WHODIES_KESSEL) == (FALSE)) {
        INFO_ADDCHOICE(86762, "Kessel lost his temper.", 86777);
    };
}
...
func void DIA_RIORDIAN_Q514_FINALLY_ONLYME_NEXT_ALL_NEXT2_SWORD_YES() {
    ...
    INFO_CLEARCHOICES(86762);
    INFO_ADDCHOICE(86762, "(Don't show)", 86784);
    if ((NPC_HASITEMS(OTHER, 39466)) >= (1)) {
        INFO_ADDCHOICE(86762, "(Show)", 86783);
    };
}
...
func void DIA_RIORDIAN_Q514_FINALLY_ONLYME_NEXT_ALL_NEXT2_SWORD_YES_SHOW() {
    ...
    CREATEINVITEMS(SELF, 36082, 1);
    AI_USEITEMTOSTATE(SELF, 36082, 1);
    ...
    AI_USEITEMTOSTATE(SELF, 36082, -(1));
    B_GIVEINVITEMS(SELF, OTHER, 39466, 1);
...
func int DIA_RIORDIAN_Q514_WHATHAPPEND_CONDITION() {
    if (((LOG_GETSTATUS(MIS_Q514)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 86762))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_RIORDIAN_Q514_GOLEMS_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_Q514)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 86762))) && (!(NPC_KNOWSINFO(OTHER, 86791)))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_RIORDIAN_Q514_PREPARELEAVE_CONDITION() {
    if (((LOG_GETSTATUS(MIS_Q514)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 86785))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_RIORDIAN_Q514_LEAVE_INFO() {
    ...
    INFO_CLEARCHOICES(86794);
    INFO_ADDCHOICE(86794, "Let's go.", 86798);
    INFO_ADDCHOICE(86794, "What about Kessel? Are you going to leave him here like this?", 86797);
}

func void DIA_RIORDIAN_Q514_LEAVE_KESSEL() {
    AI_OUTPUT(OTHER, SELF, "DIA_Riordian_Q514_Leave_Kessel_15_01");
    if (NPC_KNOWSINFO(OTHER, 87447)) {
...
var int RIORDIAN_VZ_Q514_PROBLEM_SWORD;
var int RIORDIAN_VZ_Q514_PROBLEM_SECONDGATE;
var int RIORDIAN_VZ_Q514_PROBLEM_STONEPLATE;
var int RIORDIAN_VZ_Q514_PROBLEM_TOUCHPLATE;
var int RIORDIAN_VZ_Q514_PROBLEM_COLORS;
func void DIA_RIORDIAN_VZ_Q514_PROBLEM_CHOICES() {
    INFO_CLEARCHOICES(86811);
    INFO_ADDCHOICE(86811, DIALOG_BACK, 86820);
    if (((Q514_GARGOYLECHAMBER_CLOSEDGATELOGENTRY) == (FALSE)) && ((Q514_SECONDGATEOPENED) == (FALSE))) {
        if ((RIORDIAN_VZ_Q514_PROBLEM_SECONDGATE) == (FALSE)) {
            INFO_ADDCHOICE(86811, "At the end of the great hall is another great door.", 86821);
        };
    };
    if ((RIORDIAN_VZ_Q514_PROBLEM_SWORD) == (FALSE)) {
        if (((NPC_HASITEMS(OTHER, 39610)) >= (1)) || ((NPC_HASITEMS(OTHER, 39611)) >= (1))) {
            INFO_ADDCHOICE(86811, "I found this strange sword.", 86822);
        };
    };
    if ((RIORDIAN_VZ_Q514_PROBLEM_STONEPLATE) == (FALSE)) {
        if (((Q514_PUZZLECHAMBER_ENTER_LOGENTRY) == (TRUE)) && ((Q514_PUZZLECHAMBER_FINISH) == (FALSE))) {
            INFO_ADDCHOICE(86811, "I found stone pedestals.", 86823);
        };
    };
    if ((RIORDIAN_VZ_Q514_PROBLEM_TOUCHPLATE) == (FALSE)) {
        if (((Q514_CHESSCHAMBER_BUTTONPUZZLE) == (TRUE)) && ((Q514_CHESS_FINISH) == (FALSE))) {
            INFO_ADDCHOICE(86811, "In the throne room, the floor moves when I stand on it.", 86824);
        };
    };
    if ((RIORDIAN_VZ_Q514_PROBLEM_COLORS) == (FALSE)) {
        if ((Q514_TRAP04_COLORS) == (1)) {
            if (((NPC_HASITEMS(OTHER, 35440)) == (0)) && ((NPC_KNOWSINFO(OTHER, 86687)) == (FALSE))) {
                INFO_ADDCHOICE(86811, "I reached the room with the colored switches.", 86825);
            };
        };
    };
}
...
func void DIA_RIORDIAN_VZ_Q514_PROBLEM_SWORD() {
    ...
    if ((NPC_HASITEMS(OTHER, 39610)) >= (1)) {
    };
    if ((NPC_HASITEMS(OTHER, 39611)) >= (1)) {
        B_GIVEINVITEMS(OTHER, SELF, 39611, 1);
    };
    CREATEINVITEMS(SELF, 36125, 1);
    AI_USEITEMTOSTATE(SELF, 36125, 1);
    ...
    AI_USEITEMTOSTATE(SELF, 36125, -(1));
    if ((NPC_HASITEMS(SELF, 39610)) >= (1)) {
    };
    if ((NPC_HASITEMS(SELF, 39611)) >= (1)) {
        B_GIVEINVITEMS(SELF, OTHER, 39611, 1);
    };
...
var int RIORDIANVZCURRENTMANALEVEL;
var int RIORDIANVZ_CANTTEACH;
...
func int DIA_RIORDIAN_TEACH_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 87105)) && (!(NPC_KNOWSINFO(OTHER, 87118)))) && ((RIORDIANVZ_CANTTEACH) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_RIORDIAN_TEACH_CHOICES() {
    ...
    INFO_CLEARCHOICES(86828);
    INFO_ADDCHOICE(86828, DIALOG_BACK, 86833);
    INFO_ADDCHOICE(86828, B_BUILDLEARNSTRING2(PRINT_LEARNMANA1, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_MANA_MAX, 1), RIORDIAN_GOLDCOST), 86834);
    INFO_ADDCHOICE(86828, B_BUILDLEARNSTRING2(PRINT_LEARNMANA5, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_MANA_MAX, 5), (RIORDIAN_GOLDCOST) * (5)), 86835);
}
...
func int DIA_RIORDIAN_VZ_TEACHMECIRCLE_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 87105)) && ((NPC_KNOWSINFO(OTHER, 87118)) == (FALSE))) && ((SQ504_JOINEDWATERCIRCLE) == (TRUE))) {
...
func void DIA_RIORDIAN_VZ_TEACHMECIRCLE_CHOICES() {
    INFO_CLEARCHOICES(86836);
    INFO_ADDCHOICE(86836, DIALOG_BACK, 86840);
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_SCROLLWRITING)) == (0)) {
        INFO_ADDCHOICE(86836, B_BUILDLEARNSTRING2(PRINT_LEARN_MAGICSCROLL, 5, 0), 86845);
    };
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_MAGE)) == (0)) {
        INFO_ADDCHOICE(86836, B_BUILDLEARNSTRING2(PRINT_LEARN_CIRCLE1, (CIRCLEKOSTEN_01) - ((CIRCLEKOSTEN_BOOK) * (MARVIN_MAGELEARNING_TIER1)), 0), 86841);
    };
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_MAGE)) == (1)) {
        INFO_ADDCHOICE(86836, B_BUILDLEARNSTRING2(PRINT_LEARN_CIRCLE2, (CIRCLEKOSTEN_02) - ((CIRCLEKOSTEN_BOOK) * (MARVIN_MAGELEARNING_TIER2)), 0), 86842);
    };
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_MAGE)) == (2)) {
        INFO_ADDCHOICE(86836, B_BUILDLEARNSTRING2(PRINT_LEARN_CIRCLE3, (CIRCLEKOSTEN_03) - ((CIRCLEKOSTEN_BOOK) * (MARVIN_MAGELEARNING_TIER3)), 0), 86843);
    };
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_MAGE)) == (3)) {
        INFO_ADDCHOICE(86836, B_BUILDLEARNSTRING2(PRINT_LEARN_CIRCLE4, (CIRCLEKOSTEN_04) - ((CIRCLEKOSTEN_BOOK) * (MARVIN_MAGELEARNING_TIER4)), 0), 86844);
    };
}
