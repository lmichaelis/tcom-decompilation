...
func int DIA_KYLID_SQ415_EMOTIONS_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ415)) == (LOG_RUNNING)) && ((SQ415_OURWARRIOR) == (1))) && (NPC_KNOWSINFO(OTHER, 82376))) {
        return TRUE;
    };
...
func int DIA_KYLID_SQ415_CANTRAIN_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ415)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 82351))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
var int KYLID_SQ415_TRAININGSTATUS;
func int DIA_KYLID_SQ415_LETSGO_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ415)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 82354))) {
...
func void DIA_KYLID_SQ415_COUNTTASKS() {
    var int KYLID_SQ415_COUNTTASKS;
...
func int DIA_KYLID_SQ415_GOTPLANT_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ415)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 82351))) && ((NPC_HASITEMS(OTHER, 34286)) >= (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_KYLID_SQ415_GOTPLANT_INFO() {
    NPC_REMOVEINVITEMS(SELF, 34286, 1);
    AI_OUTPUT(OTHER, SELF, "DIA_Kylid_SQ415_GotPlant_15_01");
    B_GIVEINVITEMS(OTHER, SELF, 34286, 1);
...
func int DIA_KYLID_SQ415_FINISH_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_SQ415)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 82305))) && ((SQ415_OURWARRIOR) == (1))) && ((SQ415_FIGHTRESULT) >= (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_KYLID_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(82385);
    INFO_ADDCHOICE(82385, DIALOG_BACK, 82389);
    INFO_ADDCHOICE(82385, DIALOG_PICKPOCKET, 82388);
}
