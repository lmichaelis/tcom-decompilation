func void EVENTSMANAGER_Q405() {
    ...
    if (((Q404_TELEPORTVOLKERPEOPLE) == (2)) && ((Q405_CLOSEDDOORLOGENTRY) == (2))) {
        if (((NPC_GETDISTTOWP(NONE_6396_VOLKERGUARD, "SLUMS_HOUSE17_25")) <= (2500)) && ((NPC_GETDISTTOWP(NONE_6397_VOLKERGUARD, "SLUMS_HOUSE17_25")) <= (2500))) {
...
func void Q405_STARTQUEST_MOVERS() {
    var ZCMOVER MOVER1;
    var int MOVPTR1;
    var int CHANGEDEADBODYCOLLISION;
