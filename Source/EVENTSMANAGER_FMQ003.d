func void EVENTSMANAGER_FMQ003() {
    if (((LOG_GETSTATUS(MIS_FMQ003)) != (LOG_RUNNING)) || (((LOG_GETSTATUS(MIS_FMQ003)) == (LOG_RUNNING)) && ((NPC_KNOWSINFO(HERO, 66487)) == (FALSE)))) {
        return;
    };
    ...
    if ((FMQ003_PATROLCHURCHCHOSEN) == (TRUE)) {
        if ((((FMQ003_CHANGEWEGARRTN) == (1)) && ((NPC_GETDISTTOWP(MIL_4016_WEGAR, "PARTM8_PATH_20")) <= (300))) && ((NPC_ISINSTATE(MIL_4016_WEGAR, 61599)) == (FALSE))) {
    ...
    if ((FMQ003_THIEFTALK) == (2)) {
        if ((FMQ003_WEGARHELPFIGHT) == (FALSE)) {
            if (HLP_ISVALIDNPC(VLK_6235_THIEF)) {
                if ((NPC_ISINSTATE(VLK_6235_THIEF, 61615)) || (NPC_ISINSTATE(VLK_6235_THIEF, 61591))) {
    ...
    if ((HLP_ISVALIDNPC(MIL_4047_PRISONGUARD)) && (HLP_ISVALIDNPC(VLK_6235_THIEF))) {
        if ((FMQ003_CHANGEPRISONGUARDRTN) == (0)) {
            if (((((NPC_GETDISTTOWP(MIL_4047_PRISONGUARD, "PARTM1_CONNECTION_PARTM3")) <= (750)) && ((NPC_GETDISTTOWP(VLK_6235_THIEF, "PARTM1_PATH_99")) <= (750))) && ((NPC_ISINSTATE(MIL_4047_PRISONGUARD, 61599)) == (FALSE))) && ((NPC_ISINSTATE(VLK_6235_THIEF, 61599)) == (FALSE))) {
    ...
    if ((FMQ003_PATROLSLUMSCHOSEN) == (TRUE)) {
        if ((((FMQ003_CHANGEWEGARRTN) == (1)) && ((NPC_GETDISTTOWP(MIL_4016_WEGAR, SLUMS_PATH_30)) < (300))) && ((NPC_ISINSTATE(MIL_4016_WEGAR, 61599)) == (FALSE))) {
            if ((GIANTRATATTACKED) == (FALSE)) {
                FMQ003_CHANGEWEGARRTN = 2;
                GIANTRATATTACKED = TRUE;
            };
            if ((FMQ003_CHANGEWEGARRTN) == (2)) {
                WLD_INSERTNPC(50471, "SLUMS_PATH_42");
                B_STARTOTHERROUTINE(MIL_4016_WEGAR, "SlumsWait");
                NPC_REFRESH(MIL_4016_WEGAR);
            };
        };
    };
    if ((NPC_KNOWSINFO(HERO, 74961)) == (FALSE)) {
    ...
    if ((FMQ003_PATROLWATERMAGESCHOSEN) == (TRUE)) {
        if ((((FMQ003_CHANGEWEGARRTN) == (1)) && ((NPC_GETDISTTOWP(MIL_4016_WEGAR, "HARBOUR_PATH_73")) <= (300))) && ((NPC_ISINSTATE(MIL_4016_WEGAR, 61599)) == (FALSE))) {
    ...
    if ((FMQ003_PATROLFIREMAGESCHOSEN) == (TRUE)) {
        if ((((FMQ003_CHANGEWEGARRTN) == (1)) && ((NPC_GETDISTTOWP(MIL_4016_WEGAR, "PARTM1_PATH_66")) <= (300))) && ((NPC_ISINSTATE(MIL_4016_WEGAR, 61599)) == (FALSE))) {
    ...
    if ((FMQ003_PATROLCRAFTCHOSEN) == (TRUE)) {
        if ((((FMQ003_CHANGEWEGARRTN) == (1)) && ((NPC_GETDISTTOWP(MIL_4016_WEGAR, "PARTM3_PATH_152")) <= (300))) && ((NPC_ISINSTATE(MIL_4016_WEGAR, 61599)) == (FALSE))) {
    ...
    if (HLP_ISVALIDNPC(NONE_6240_HOMELESS)) {
        if (((((FMQ003_PATROLCRAFTCHOSEN) == (TRUE)) && ((FMQ003_HOMELESSRTN) == (0))) && ((NPC_GETDISTTOWP(NONE_6240_HOMELESS, "HARBOUR_TAVERN_01")) < (1200))) && ((NPC_ISINSTATE(NONE_6240_HOMELESS, 61599)) == (FALSE))) {
    ...
    if ((FMQ003_PATROLVILLACHOSEN) == (TRUE)) {
        if ((((FMQ003_CHANGEWEGARRTN) == (1)) && ((NPC_GETDISTTOWP(MIL_4016_WEGAR, "PARTM4_PATH_43")) <= (400))) && ((NPC_ISINSTATE(MIL_4016_WEGAR, 61599)) == (FALSE))) {
            ...
            if ((FMQ003_CUTSCENEVOLKER) == (0)) {
                if ((((NPC_ISINSTATE(MIL_4016_WEGAR, 61599)) == (FALSE)) && ((NPC_ISINSTATE(VLK_6241_ANGRYCITIZEN01, 61599)) == (FALSE))) && ((NPC_ISINSTATE(VLK_6242_ARS_FMQ003, 61599)) == (FALSE))) {
    ...
    if ((FMQ003_PATROLGUILDCHOSEN) == (TRUE)) {
        if ((((FMQ003_CHANGEWEGARRTN) == (1)) && ((NPC_GETDISTTOWP(MIL_4016_WEGAR, "PARTM1_GUILDHOUSE02_40")) <= (300))) && ((NPC_ISINSTATE(MIL_4016_WEGAR, 61599)) == (FALSE))) {
