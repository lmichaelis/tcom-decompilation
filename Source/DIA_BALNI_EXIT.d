...
func int DIA_BALNI_NET_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 77723)) && ((NPC_HASITEMS(OTHER, 37177)) >= (1))) && ((LOG_GETSTATUS(MIS_FAQ004)) == (LOG_RUNNING))) {
        return TRUE;
    };
...
func void DIA_BALNI_NET_INFO() {
    ...
    INFO_CLEARCHOICES(77745);
    INFO_ADDCHOICE(77745, "I hear you like stories.", 77748);
    INFO_ADDCHOICE(77745, "And for a few gold pieces you'll do it now?", 77749);
    if ((NPC_HASITEMS(OTHER, 33972)) >= (1)) {
        INFO_ADDCHOICE(77745, "How many fish do you usually catch when fishing?", 77750);
    };
}
...
func int DIA_BALNI_STORYTIME_CONDITION() {
    if ((((FAQ004_TELLBALNISTORY) == (TRUE)) && ((NPC_HASITEMS(OTHER, 37177)) >= (1))) && ((LOG_GETSTATUS(MIS_FAQ004)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_BALNI_STORYTIME_PICNIC_VETERAN_DEAD_RESULT() {
    if ((FAQ004_BALNISTORYGOODPOINTSCOUNT) == (3)) {
        ...
        AI_FUNCTION(SELF, 77754);
    };
    AI_OUTPUT(SELF, OTHER, "DIA_Balni_StoryTime_Result_03_03");
    AI_FUNCTION(SELF, 77755);
    INFO_CLEARCHOICES(77752);
    AI_STOPPROCESSINFOS(SELF);
}
...
func void DIA_BALNI_STORYTIME_INFO() {
    ...
    AI_FUNCTION(HERO, 77757);
    AI_FUNCTION(SELF, 77758);
    INFO_CLEARCHOICES(77752);
    INFO_ADDCHOICE(77752, "One time I went to a festival.", 77760);
    INFO_ADDCHOICE(77752, "I once went to a cartographer with my brother.", 77761);
    INFO_ADDCHOICE(77752, "I saw a dragon once.", 77762);
}
...
func void DIA_BALNI_STORYTIME_PICNIC() {
    ...
    INFO_CLEARCHOICES(77752);
    INFO_ADDCHOICE(77752, "Besides us, there was a tamed orc.", 77763);
    INFO_ADDCHOICE(77752, "Besides us, there was an old war veteran.", 77764);
    INFO_ADDCHOICE(77752, "Besides us, there was a paladin.", 77765);
}
...
func void DIA_BALNI_STORYTIME_PICNIC_VETERAN() {
    ...
    FAQ004_BALNISTORYGOODPOINTSCOUNT = (FAQ004_BALNISTORYGOODPOINTSCOUNT) + (1);
    INFO_CLEARCHOICES(77752);
    INFO_ADDCHOICE(77752, "It wasn't long before we got a decent sword from him.", 77766);
    INFO_ADDCHOICE(77752, "He died a short time later.", 77767);
    INFO_ADDCHOICE(77752, "Soon after, the village was invaded by orcs.", 77768);
}
...
func int DIA_BALNI_FISH_CONDITION() {
    if ((((FAQ004_BRINGBALNIFISHES) == (TRUE)) && ((NPC_HASITEMS(OTHER, 33972)) >= (20))) && ((LOG_GETSTATUS(MIS_FAQ004)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_BALNI_FISH_INFO() {
    ...
    NPC_REMOVEINVITEMS(SELF, 33972, 20);
    AI_FUNCTION(SELF, 77773);
    B_GIVEINVITEMS(OTHER, SELF, 33972, 20);
    AI_FUNCTION(OTHER, 77774);
    B_GIVEINVITEMS(OTHER, SELF, 37177, 1);
}
...
func void BALNIREPAIRNET() {
    ...
    AI_WAITTILLEND(HERO, NONE_6260_BALNI);
    AI_TURNTONPC(HERO, NONE_6260_BALNI);
    AI_WAIT(NONE_6260_BALNI, 1088421888);
}

func void BALNIREPAIRNETFADE() {
    FADESCREENTOBLACKF(10, 77775, 1000);
}

func void BALNIREPAIRNETFADESCREEN() {
    WLD_SENDTRIGGER("KM_NETREPAIR_01");
    AI_TURNTONPC(HERO, NONE_6260_BALNI);
    AI_WAIT(NONE_6260_BALNI, 1082130432);
    B_STANDUP();
    HERO.AIVAR[4] = FALSE;
    ...
    AI_FUNCTION(NONE_6260_BALNI, 77776);
...
func void BALNIREPAIRNETDONE() {
    ...
    CREATEINVITEMS(NONE_6260_BALNI, 37178, 1);
    B_GIVEINVITEMS(NONE_6260_BALNI, HERO, 37178, 1);
    FAQ004_FISHINGNETDONEBYBALNI = TRUE;
...
func void DIA_BALNI_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(77782);
    INFO_ADDCHOICE(77782, DIALOG_BACK, 77786);
    INFO_ADDCHOICE(77782, DIALOG_PICKPOCKET, 77785);
}
