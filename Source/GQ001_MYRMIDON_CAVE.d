var int GQ001_MYRMIDON_CAVE;
var int GQ001_MYRMIDON_WHO;
var int GQ001_MYRMIDON_INFORMATION;
var int GQ001_MYRMIDON_WHAT;
var int GQ001_MYRMIDON_GONZALO;
...
func int DIA_BDT_MYRMIDON_HELLO_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 84482)) && ((LOG_GETSTATUS(MIS_Q207)) == (LOG_SUCCESS))) && ((KAPITEL) == (3))) {
        return TRUE;
    };
...
func void DIA_BDT_MYRMIDON_HELLO_INFO() {
    ...
    INFO_CLEARCHOICES(82726);
    INFO_ADDCHOICE(82726, "I saw you in the cave.", 82732);
}

var int MYRMIDON_HELLO_GONZALO;
var int MYRMIDON_HELLO_BUISNESS;
func void DIA_BDT_MYRMIDON_HELLO_CHOICES() {
    INFO_CLEARCHOICES(82726);
    if ((MYRMIDON_HELLO_GONZALO) == (FALSE)) {
        INFO_ADDCHOICE(82726, "Why did you kill Gonzalo?", 82733);
    };
    if ((MYRMIDON_HELLO_BUISNESS) == (FALSE)) {
        INFO_ADDCHOICE(82726, "You guys said something about taking over the business.", 82735);
    };
}
...
func void DIA_BDT_MYRMIDON_HELLO_CAVE_GONZALO() {
    ...
    INFO_CLEARCHOICES(82726);
    INFO_ADDCHOICE(82726, "I ask seriously.", 82734);
}
...
func void DIA_BDT_MYRMIDON_HELLO_CAVE_BUSINESS() {
    ...
    INFO_CLEARCHOICES(82726);
    INFO_ADDCHOICE(82726, "Do you know anything about the recent kidnapping in Silbach?", 82736);
}
...
func void DIA_BDT_MYRMIDON_HELLO_CAVE_BUSINESS_SILBACH() {
    ...
    INFO_CLEARCHOICES(82726);
    INFO_ADDCHOICE(82726, "Someone trashed my uncle's hut to get my brother.", 82737);
    INFO_ADDCHOICE(82726, "You look like a professional.", 82738);
}
...
func void DIA_BDT_MYRMIDON_HELLO_CAVE_BUSINESS_SILBACH_PROFESSIONAL() {
    ...
    INFO_CLEARCHOICES(82726);
    INFO_ADDCHOICE(82726, "Circumstantial evidence suggests that there were two kidnappers.", 82739);
}
...
func int DIA_BDT_MYRMIDON_WHO_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 82726)) && ((GQ001_MYRMIDON_WHO) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_BDT_MYRMIDON_WHAT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 82726)) && ((GQ001_MYRMIDON_WHAT) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_BDT_MYRMIDON_INFORMATION_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 82726)) && ((GQ001_MYRMIDON_INFORMATION) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_BDT_MYRMIDON_GONZALO_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 82726)) && ((GQ001_MYRMIDON_GONZALO) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_MYRMIDON_KQ405_HARRY_INFO() {
    ...
    INFO_CLEARCHOICES(82758);
    if (((MARVIN_LOSTGUILDMILITA) == (TRUE)) || ((HERO.GUILD) == (GIL_MIL))) {
        INFO_ADDCHOICE(82758, "Wait, I know you! You killed Gonzalo!", 82765);
    };
    INFO_ADDCHOICE(82758, "I am sent by the Royal Envoy.", 82764);
    INFO_ADDCHOICE(82758, "I have a case for him.", 82763);
}
...
func void DIA_MYRMIDON_KQ405_HARRY_NEEDTALK() {
    ...
    INFO_CLEARCHOICES(82758);
    if ((NPC_HASITEMS(OTHER, 34203)) >= (KQ405_HUNTERSPRICE)) {
        INFO_ADDCHOICE(82758, "(Offer 200 GP)", 82766);
    };
    INFO_ADDCHOICE(82758, "I don't carry that much gold.", 82767);
}
...
func void DIA_MYRMIDON_KQ405_HARRY_NEEDTALK_200() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 34203, KQ405_HUNTERSPRICE);
    DIA_MYRMIDON_KQ405_HARRY_GRAYSON_NEXT();
}
...
func int DIA_MYRMIDON_KQ405_LETSFIGHT_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_KQ405)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 82758))) && ((NPC_GETDISTTOWP(SELF, "PART13_KQ405_HUNTERGUIDE_01")) <= (500))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
