...
func void ZCVIEW_DELETE(var ZCVIEW THIS) {
    ...
    CALL__THISCALL(MEM_INSTTOPTR(11364), ZCVIEW__@ZCVIEW);
}
...
func void VIEWPTR_DELETETEXT(var int PTR) {
    ...
    V = _^(PTR);
    if (V.TEXTLINES_NEXT) {
        LIST_FORF(V.TEXTLINES_NEXT, 11422);
...
func void ZCVIEW_ARCHIVER(var ZCVIEW THIS) {
    ...
    if (MEMINT_SWITCHG1G2(FALSE, TRUE)) {
        PM_SAVEINT("m_bFillZ", MEM_READINT((_@(11510)) + (8)));
    };
...
func void ZCVIEW_UNARCHIVER(var ZCVIEW THIS) {
    ...
    _VIEWPTR_CREATEINTOPTR(_@(11512), VX1, VY1, VX2, VY2);
    THIS._VTBL = PM_LOADINT("_vtbl");
    THIS._ZCINPUTCALLBACK_VTBL = PM_LOADINT("_zCInputCallBack_vtbl");
    if (MEMINT_SWITCHG1G2(FALSE, TRUE)) {
        MEM_WRITEINT((_@(11512)) + (8), PM_LOADINT("m_bFillZ"));
    };
    ...
    VIEWPTR_SETTEXTURE(_@(11512), PM_LOADSTRING("backtex"));
