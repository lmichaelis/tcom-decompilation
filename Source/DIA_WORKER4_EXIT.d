...
func void DIA_WORKER4_SQ309_INFO() {
    ...
    INFO_CLEARCHOICES(77098);
    INFO_ADDCHOICE(77098, "I just wanted to find out who was bringing them in.", 77101);
}
...
func void DIA_WORKER4_SQ309_WHO() {
    ...
    INFO_CLEARCHOICES(77098);
    INFO_ADDCHOICE(77098, "I don't want to buy them.", 77102);
    INFO_ADDCHOICE(77098, "Actually, I'm looking for a job.", 77103);
}
...
func void DIA_WORKER4_SQ309_WHO_WORK() {
    ...
    INFO_CLEARCHOICES(77098);
    INFO_ADDCHOICE(77098, "I'd be happy to.", 77104);
}
