...
func int DIA_DEVIR_SQ415_GOTPLANT_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ415)) == (LOG_RUNNING)) && ((NPC_HASITEMS(OTHER, 34288)) >= (1))) && (NPC_KNOWSINFO(OTHER, 82320))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DEVIR_SQ415_COUNTTASKS() {
    var int DEVIR_SQ415_COUNTTASKS;
...
func void DIA_DEVIR_SQ415_GOTPLANT_INFO() {
    NPC_REMOVEINVITEMS(SELF, 34288, 1);
    AI_OUTPUT(OTHER, SELF, "DIA_Devir_SQ415_GotPlant_15_01");
    B_GIVEINVITEMS(OTHER, SELF, 34288, 1);
...
func int DIA_DEVIR_SQ415_FOUNDSWORD_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 82320)) && ((LOG_GETSTATUS(MIS_SQ415)) == (LOG_RUNNING))) && ((NPC_HASITEMS(OTHER, 39534)) >= (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DEVIR_SQ415_FOUNDSWORD_INFO() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 39534, 1);
...
func int DIA_DEVIR_SQ415_FINISH_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_SQ415)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 82305))) && ((SQ415_OURWARRIOR) == (2))) && ((SQ415_FIGHTRESULT) >= (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_DEVIR_AMBIENT_INFO() {
    ...
    if ((NPC_KNOWSINFO(OTHER, 82320)) == (FALSE)) {
...
func void DIA_DEVIR_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(82343);
    INFO_ADDCHOICE(82343, DIALOG_BACK, 82347);
    INFO_ADDCHOICE(82343, DIALOG_PICKPOCKET, 82346);
}
