...
func int DIA_MARKUS_Q514_GOLD_CONDITION() {
    if ((((Q514_TREASURY_EVENT) == (2)) && ((LOG_GETSTATUS(MIS_Q514)) == (LOG_RUNNING))) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}

var int MARKUSVZ_MADGOLD;
...
var int MARKUS_VZ_NOMORE;
var string MARKUS_VZ_PRINTS;
var int MARKUS_VZ_CURRENTBLEVEL;
var int MARKUS_VZ_CURRENTDEXLEVEL;
...
func int DIA_MARKUS_VZ_TEACH_CONDITION() {
    if ((((((MARKUS_VZ_NOMORE) == (FALSE)) && ((LOG_GETSTATUS(MIS_Q514)) == (LOG_RUNNING))) && ((Q514_CAMPISREADY) == (TRUE))) && ((Q514_TREASURY_EVENT) != (2))) && (NPC_KNOWSINFO(OTHER, 86988))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_MARKUS_VZ_TEACH_CHOICES() {
    var int MARKUS_VZ_GOLDCOST;
    MARKUS_VZ_GOLDCOST = 25;
    MARKUS_VZ_CURRENTBLEVEL = OTHER.HITCHANCE[3];
    MARKUS_VZ_CURRENTDEXLEVEL = OTHER.ATTRIBUTE[5];
    INFO_CLEARCHOICES(86995);
    INFO_ADDCHOICE(86995, DIALOG_BACK, 87000);
    INFO_ADDCHOICE(86995, B_BUILDLEARNSTRING2(PRINT_LEARNDEX1, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_DEXTERITY, 1), MARKUS_VZ_GOLDCOST), 87004);
    INFO_ADDCHOICE(86995, B_BUILDLEARNSTRING2(PRINT_LEARNDEX5, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_DEXTERITY, 5), (MARKUS_VZ_GOLDCOST) * (5)), 87003);
...
func void DIA_MARKUS_VZ_TEACH_BOW1() {
    if ((NPC_HASITEMS(OTHER, 34203)) >= (MARKUS_VZ_PAYMENT1)) {
        if ((MARKUS_VZ_CURRENTBLEVEL) < (OTHER.HITCHANCE[3])) {
            SND_PLAY(GELDBEUTEL);
            B_GIVEINVITEMS(OTHER, SELF, 34203, MARKUS_VZ_PAYMENT1);
        };
...
func void DIA_MARKUS_VZ_TEACH_BOW5() {
    if ((NPC_HASITEMS(OTHER, 34203)) >= (MARKUS_VZ_PAYMENT5)) {
        if ((MARKUS_VZ_CURRENTBLEVEL) < (OTHER.HITCHANCE[3])) {
            B_GIVEINVITEMS(OTHER, SELF, 34203, MARKUS_VZ_PAYMENT5);
            SND_PLAY(GELDBEUTEL);
        };
...
func int DIA_MARKUS_VZ_TEACHFLETCHERY_CONDITION() {
    if ((((((LOG_GETSTATUS(MIS_Q514)) == (LOG_RUNNING)) && ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_FLETCHERY)) == (0))) && ((Q514_CAMPISREADY) == (TRUE))) && ((Q514_TREASURY_EVENT) != (2))) && (NPC_KNOWSINFO(OTHER, 86988))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_MARKUS_VZ_TEACHFLETCHERY_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (MARKUS_VZ_FLETCHERY1)) {
        if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_FLETCHERY)) == (1)) {
            NPC_REMOVEINVITEMS(SELF, 34203, MARKUS_VZ_FLETCHERY1);
            AI_OUTPUT(SELF, OTHER, "DIA_Markus_VZ_TeachFletchery_13_02");
            B_GIVEINVITEMS(OTHER, SELF, 34203, MARKUS_VZ_FLETCHERY1);
...
func int DIA_MARKUS_VZ_TEACHFLETCHERY2_CONDITION() {
    if ((((((LOG_GETSTATUS(MIS_Q514)) == (LOG_RUNNING)) && ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_FLETCHERY)) == (1))) && ((Q514_CAMPISREADY) == (TRUE))) && ((Q514_TREASURY_EVENT) != (2))) && (NPC_KNOWSINFO(OTHER, 86988))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_MARKUS_VZ_TEACHFLETCHERY2_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (MARKUS_VZ_FLETCHERY2)) {
        if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_FLETCHERY)) == (2)) {
            NPC_REMOVEINVITEMS(SELF, 34203, MARKUS_VZ_FLETCHERY2);
            AI_OUTPUT(SELF, OTHER, "DIA_Markus_VZ_TeachFletchery2_03_02");
            B_GIVEINVITEMS(OTHER, SELF, 34203, MARKUS_VZ_FLETCHERY2);
...
func int DIA_MARKUS_HUNTINGVZ_SPECIAL_CONDITION() {
    if (((((((LOG_GETSTATUS(MIS_Q514)) == (LOG_RUNNING)) && ((Q514_CAMPISREADY) == (TRUE))) && ((Q514_TREASURY_EVENT) != (2))) && (NPC_KNOWSINFO(OTHER, 86988))) && ((MARKUS_ALLHUNTVZ) == (FALSE))) && ((PLAYER_TALENT_TAKEANIMALTROPHY[2]) == (TRUE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_MARKUS_HUNTINGVZ_SPECIAL_CHOICES() {
    INFO_CLEARCHOICES(87018);
    INFO_ADDCHOICE(87018, DIALOG_BACK, 87022);
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[8]) == (FALSE)) {
        INFO_ADDCHOICE(87018, B_BUILDLEARNSTRING2(PRINT_TEACHMANDIBLES, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_MANDIBLES), MARKUS_VZ_MANDIBLESTROPHY), 87023);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[17]) == (FALSE)) {
        INFO_ADDCHOICE(87018, B_BUILDLEARNSTRING2(PRINT_TEACHSHELLS, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_SHELLS), MARKUS_VZ_SHELLSTROPHY), 87024);
    };
    if ((PLAYER_TALENT_TAKEANIMALTROPHY[3]) == (FALSE)) {
        INFO_ADDCHOICE(87018, B_BUILDLEARNSTRING2(PRINT_TEACHHEART, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_TAKEANIMALTROPHY, TROPHY_HEART), MARKUS_VZ_HEARTTROPHY), 87025);
    };
}
...
func void DIA_MARKUS_HUNTINGVZ_SPECIAL_MANDIBLES() {
    if ((NPC_HASITEMS(OTHER, 34203)) >= (MARKUS_VZ_MANDIBLESTROPHY)) {
...
func void DIA_MARKUS_HUNTINGVZ_SPECIAL_SHELLS() {
    if ((NPC_HASITEMS(OTHER, 34203)) >= (MARKUS_VZ_SHELLSTROPHY)) {
...
func void DIA_MARKUS_HUNTINGVZ_SPECIAL_HEART() {
    if ((NPC_HASITEMS(OTHER, 34203)) >= (MARKUS_VZ_HEARTTROPHY)) {
