...
func void DIA_WOLFSON_EVT_TRIALPRE_INFO() {
    ...
    CREATEINVITEMS(SELF, 39581, 1);
    B_GIVEINVITEMS(SELF, OTHER, 39581, 1);
    INFO_CLEARCHOICES(82408);
    INFO_ADDCHOICE(82408, "(Test your strength)", 82411);
}
...
func int DIA_WOLFSON_AFTEREVENT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 82408)) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
