...
var int HARRYGOODANSWERS;
var int HARRYBADANSWERS;
...
func void DIA_HARRY_GATEJORN_INFO() {
    ...
    INFO_CLEARCHOICES(89536);
    INFO_ADDCHOICE(89536, "We come from the city.", 89542);
    INFO_ADDCHOICE(89536, "We come from Londram.", 89545);
    INFO_ADDCHOICE(89536, "We are just simple wanderers.", 89548);
}

func void DIA_HARRY_SILBACH_INFO() {
    AI_OUTPUT(SELF, OTHER, "DIA_Harry_Silbach_03_00");
    INFO_CLEARCHOICES(89536);
    INFO_ADDCHOICE(89536, "We are exhausted, wounded and hungry. We seek shelter.", 89551);
    INFO_ADDCHOICE(89536, "We're running away from the war.", 89552);
}
...
func void DIA_HARRY_GATEJORN_CITY() {
    ...
    INFO_CLEARCHOICES(89536);
    INFO_ADDCHOICE(89536, "We veered slightly off the path.", 89543);
    INFO_ADDCHOICE(89536, "We got lost in that storm.", 89544);
}
...
func void DIA_HARRY_GATEJORN_LONDRAM() {
    ...
    HARRYGOODANSWERS = (HARRYGOODANSWERS) + (1);
    INFO_CLEARCHOICES(89536);
    INFO_ADDCHOICE(89536, "We took off on a fishing boat.", 89546);
    INFO_ADDCHOICE(89536, "A merchant frigate disembarked us on the west side of the island.", 89547);
}
...
func void DIA_HARRY_INSUM_PUB() {
    ...
    INFO_CLEARCHOICES(89536);
    INFO_ADDCHOICE(89536, "Where exactly is the inn?", 89560);
    INFO_ADDCHOICE(89536, "Thanks for your help.", 89559);
}
...
func void DIA_HARRY_SILBACH_BROTHER() {
    ...
    INFO_CLEARCHOICES(89536);
    INFO_ADDCHOICE(89536, "(Intimidate)", 89554);
    INFO_ADDCHOICE(89536, "We will repay you for your help.", 89555);
    INFO_ADDCHOICE(89536, "We were attacked by wild beasts. We have a wounded comrade.", 89556);
    INFO_ADDCHOICE(89536, "We're just passing through.", 89557);
}
...
func int DIA_HARRY_Q102_FABIOCHOSEN_CONDITION() {
    if (((LOG_GETSTATUS(MIS_Q102)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 91350))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_HARRY_Q102_FABIOCHOSEN_INFO() {
    ...
    INFO_CLEARCHOICES(89561);
    INFO_ADDCHOICE(89561, "Yes, it's me. Has Jorn been here yet?", 89564);
}
...
func void DIA_HARRY_Q102_FABIOCHOSEN_YES() {
    ...
    INFO_CLEARCHOICES(89561);
    INFO_ADDCHOICE(89561, "Where can I find Jorn and this Viktor?", 89565);
}
...
func void DIA_HARRY_SQ118_NEEDHELP_INFO() {
    ...
    INFO_CLEARCHOICES(89566);
    INFO_ADDCHOICE(89566, "What do you want in return for your help? Money?", 89571);
    INFO_ADDCHOICE(89566, "Adanos would help his children in need.", 89570);
    INFO_ADDCHOICE(89566, "You are, after all, a sentry of this village.", 89569);
}
...
func int DIA_HARRY_SQ118_YOURGOLD_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_SQ118)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 89566))) && ((NPC_HASITEMS(OTHER, 34203)) >= (SQ118_HARRY_PAYMENT))) && ((SQ118_GUARDSCOUNT) < (2))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_HARRY_SQ118_YOURGOLD_INFO() {
    B_GIVEINVITEMS(OTHER, SELF, 34203, SQ118_HARRY_PAYMENT);
    AI_STARTFACEANI(SELF, S_SMUG, 1, -(1));
...
func void DIA_HARRY_WHEREISJORN_INFO() {
    ...
    INFO_CLEARCHOICES(89575);
    INFO_ADDCHOICE(89575, "Are you sure you haven't seen him?", 89578);
    INFO_ADDCHOICE(89575, "Have you heard anything about Kurt's break-in?", 89579);
    INFO_ADDCHOICE(89575, "In that case, I'll look for him somewhere else.", 89580);
}
...
func int DIA_HARRY_BORING_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_SQ202)) == (LOG_RUNNING)) && (NPC_ISINSTATE(SELF, 61599))) && (WLD_ISTIME(8, 0, 20, 0))) && ((SQ202_HARRYCHECK) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_HARRY_BORING_INFO() {
    ...
    INFO_CLEARCHOICES(89581);
    INFO_ADDCHOICE(89581, "What are you doing so far from the gate?", 89584);
}
...
func void DIA_HARRY_BUSTED_INFO() {
    ...
    if ((OTHER.ATTRIBUTE[4]) < (MIL_707_HARRY.ATTRIBUTE[4])) {
        ...
        MARVINJOINTNUMBERS = NPC_HASITEMS(OTHER, 34194);
        AI_OUTPUT(SELF, OTHER, "DIA_Harry_Busted_03_02");
        B_GIVEINVITEMS(OTHER, SELF, 34194, MARVINJOINTNUMBERS);
    ...
    INFO_CLEARCHOICES(89585);
    INFO_ADDCHOICE(89585, "I'll tell Albyn you left your post.", 89589);
}
...
func int DIA_HARRY_KQ405_SEARCH_CONDITION() {
    if (((LOG_GETSTATUS(MIS_KQ405)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 89590))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_HARRY_KQ405_SEARCH_INFO() {
    ...
    INFO_CLEARCHOICES(89593);
    INFO_ADDCHOICE(89593, "Were they local hunters?", 89596);
}

func void DIA_HARRY_KQ405_SEARCH_HUNTERS() {
    AI_FUNCTION(SELF, 61247);
    AI_STARTFACEANI(OTHER, S_WHAT, 1, -(1));
...
func void DIA_HARRY_KQ405_AFTERHUNTERS_INFO() {
    ...
    INFO_ADDCHOICE(89597, "Okay, I believe you.", 89601);
    INFO_ADDCHOICE(89597, "(Draw your weapon)", 89602);
}

var int HARRY_KQ405_SCAREDANIMATION;
...
func void DIA_HARRY_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(89607);
    INFO_ADDCHOICE(89607, DIALOG_BACK, 89611);
    INFO_ADDCHOICE(89607, DIALOG_PICKPOCKET, 89610);
}
