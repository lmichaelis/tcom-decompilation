...
func void DIA_LARRY_GETTER_INFO() {
    ...
    INFO_CLEARCHOICES(84545);
    INFO_ADDCHOICE(84545, "Maybe I can try to get it back?", 84548);
}
...
func int DIA_LARRY_PURSE_CONDITION() {
    if (((NPC_HASITEMS(OTHER, 37281)) >= (1)) && (NPC_KNOWSINFO(OTHER, 84545))) {
        return TRUE;
    };
    if (((((NPC_HASITEMS(OTHER, 37281)) < (1)) && ((NPC_HASITEMS(OTHER, 34203)) >= (SQ303_LARRYGOLD))) && ((LARRYPURSEOPENED) == (TRUE))) && (NPC_KNOWSINFO(OTHER, 84545))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_LARRY_PURSE_INFO() {
    ...
    INFO_CLEARCHOICES(84550);
    INFO_ADDCHOICE(84550, "I think I'll keep it for myself.", 84553);
    if ((NPC_HASITEMS(OTHER, 37281)) >= (1)) {
        INFO_ADDCHOICE(84550, "Okay, keep it.", 84554);
    };
    if ((((NPC_HASITEMS(OTHER, 37281)) < (1)) && ((NPC_HASITEMS(OTHER, 34203)) >= (SQ303_LARRYGOLD))) && ((STEALPURSE) == (TRUE))) {
        INFO_ADDCHOICE(84550, "Okay, keep it.", 84555);
    };
}
...
func void DIA_LARRY_PURSE_PURSE() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 37281, 1);
    AI_OUTPUT(SELF, OTHER, "DIA_Larry_Purse_Purse_13_17");
    CREATEINVITEMS(SELF, 34203, SQ303_REWARD);
    B_GIVEINVITEMS(SELF, OTHER, 34203, SQ303_REWARD);
...
func void DIA_LARRY_PURSE_MONEY() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 34203, SQ303_LARRYGOLD);
    ...
    CREATEINVITEMS(SELF, 34203, (SQ303_LARRYGOLD) / (2));
    B_GIVEINVITEMS(SELF, OTHER, 34203, (SQ303_LARRYGOLD) / (2));
...
var int Q302_ACTIVEDUELWITHLARRY;
...
var int Q302_PLAYERDUELWITHLARRYSTATE;
...
func int DIA_LARRY_TRAIN_PICKLOCK_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 84577)) && ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKLOCK)) < (2))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_LARRY_TRAIN_PICKLOCK_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (LARRY_PICKLOCK)) {
        if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKLOCK)) >= (2)) {
            ...
            NPC_REMOVEINVITEMS(SELF, 34203, LARRY_PICKLOCK);
            AI_OUTPUT(SELF, OTHER, "DIA_Larry_TRAIN_Picklock_03_01");
            B_GIVEINVITEMS(OTHER, SELF, 34203, LARRY_PICKLOCK);
...
func int DIA_LARRY_TRAIN_PICKPOCKET_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 84577)) && ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) < (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_LARRY_TRAIN_PICKPOCKET_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (LARRY_PICKPOCKET)) {
        if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (1)) {
            ...
            B_GIVEINVITEMS(OTHER, SELF, 34203, LARRY_PICKPOCKET);
            ...
            NPC_REMOVEINVITEMS(SELF, 34203, LARRY_PICKPOCKET);
        };
    };
...
func void DIA_LARRY_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(84586);
    INFO_ADDCHOICE(84586, DIALOG_BACK, 84590);
    INFO_ADDCHOICE(84586, DIALOG_PICKPOCKET, 84589);
}
