...
func void DIA_PETE_CHEESEFORYOU_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 33966)) >= (2)) {
        B_GIVEINVITEMS(OTHER, SELF, 33966, 2);
        AI_OUTPUT(SELF, OTHER, "DIA_Pete_CheeseForYou_03_02");
        CREATEINVITEMS(SELF, 34203, EVENT_CHEESE_SILBACH);
        B_GIVEINVITEMS(SELF, OTHER, 34203, EVENT_CHEESE_SILBACH);
