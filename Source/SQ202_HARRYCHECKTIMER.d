...
func void ALBYN_SQ202_STOCKS_FADESCREEN() {
    CUTSCENE_START(92883);
}

func void SQ202_CUTSCENE_APPLY() {
    var int SQ202_CUTSCENE_COUNT;
...
func void SQ202_EXCHANGEGOODS() {
    if ((NPC_HASITEMS(HERO, 37125)) >= (1)) {
        CREATEINVITEM(HERO, 37126);
    };
    if ((NPC_HASITEMS(HERO, 37127)) >= (1)) {
        CREATEINVITEM(HERO, 37128);
    };
    if ((NPC_HASITEMS(HERO, 37129)) >= (1)) {
        CREATEINVITEM(HERO, 37130);
    };
    WLD_REMOVEITEM(ITMIS_SQ202_HAMMERS_01);
}

func void SQ202_SPAWNBANDITS() {
    WLD_INSERTNPC(56779, "PART9_PETRAMAN_02");
    WLD_INSERTNPC(56781, "PART9_PETRAMAN_01");
}
