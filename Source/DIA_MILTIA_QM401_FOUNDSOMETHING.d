...
func void DIA_MILTIA_QM401_FOUNDSOMETHING_INFO() {
    ...
    INFO_CLEARCHOICES(65844);
    INFO_ADDCHOICE(65844, "Let's go!", 65847);
}
...
func void DIA_MILTIA_QM401_WATERFALL_INFO() {
    ...
    CREATEINVITEMS(SELF, 37312, 1);
    B_GIVEINVITEMS(SELF, OTHER, 37312, 1);
}
...
func void DIA_MILTIA_QM401_LETTER_INFO() {
    ...
    INFO_CLEARCHOICES(65851);
    INFO_ADDCHOICE(65851, "Yes, someone wants to meet me without witnesses...", 65855);
    INFO_ADDCHOICE(65851, "No, this letter doesn't make any sense...", 65856);
}
