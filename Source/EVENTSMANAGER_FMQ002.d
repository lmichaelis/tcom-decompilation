func void EVENTSMANAGER_FMQ002() {
    ...
    if ((FMQ002_KNOWSODGAR) == (FALSE)) {
        if (((PEON_ODGAR) == (TRUE)) && ((NPC_ISINSTATE(MIL_4000_RODERICH, 61599)) == (FALSE))) {
    ...
    if (((FMQ002_LETSFIGHT) == (1)) && ((FMQ002_GOTSWORD) != (1))) {
        if (((FMQ002_HOUROFARWIDFIGHT) <= ((WLD_GETHOUR()) - (2))) || ((FMQ002_DAYOFARWIDFIGHT) != (WLD_GETDAY()))) {
            if (((FMQ002_FORFEITSTATUS) == (0)) && ((NPC_GETDISTTONPC(HERO, MIL_4017_ARWID)) >= (6500))) {
    ...
    if ((((NPC_GETDISTTOWP(MIL_4017_ARWID, "PARTM8_PATH_04")) <= (300)) && ((NPC_ISINSTATE(MIL_4017_ARWID, 61599)) == (FALSE))) && ((CHANGERTNARWID) == (FALSE))) {
