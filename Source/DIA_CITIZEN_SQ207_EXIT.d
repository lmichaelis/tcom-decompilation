...
func int DIA_CITIZEN_SQ207_ITEMS_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ207)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 73299))) && ((SQ207_FAILED) == (FALSE))) {
...
func void DIA_CITIZEN_SQ207_ITEMS_INFO() {
    ...
    INFO_CLEARCHOICES(73302);
    if (((NPC_HASITEMS(OTHER, 37132)) >= (1)) && ((NPC_HASITEMS(OTHER, 34217)) >= (1))) {
        INFO_ADDCHOICE(73302, "Here they are.", 73306);
    };
    INFO_ADDCHOICE(73302, "No way.", 73307);
}
