...
func void DIA_THUG_10034_AFTER_SQ218_INFO() {
    ...
    INFO_CLEARCHOICES(67663);
    INFO_ADDCHOICE(67663, "I'm not giving you anything!", 67666);
    INFO_ADDCHOICE(67663, "I don't think I understand...", 67667);
    if ((NPC_HASITEMS(OTHER, 34203)) >= (SQ218_THUGMONEY)) {
        INFO_ADDCHOICE(67663, "Hold it! (Pay 100 GP)", 67668);
    };
}
...
func void DIA_THUG_10034_AFTER_SQ218_GOLD() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 34203, SQ218_THUGMONEY);
