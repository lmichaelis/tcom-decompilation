...
func void SALVI_Q205_DANIELINCORNER() {
    ...
    INFO_CLEARCHOICES(78509);
    INFO_ADDCHOICE(78509, "You want me to kill a defenseless boy? Not gonna happen.", 78540);
    INFO_ADDCHOICE(78509, "You don't have to kill him.", 78539);
    INFO_ADDCHOICE(78509, "Then why don't you untie me?", 78534);
    INFO_CLEARCHOICES(78535);
    INFO_ADDCHOICE(78535, "You want me to kill a defenseless boy? Not gonna happen.", 78540);
    INFO_ADDCHOICE(78535, "You don't have to kill him.", 78539);
    INFO_ADDCHOICE(78535, "I'll do it.", 78538);
}
...
func void DIA_SALVI_Q205_RENEGADECATCH_QUESTIONS() {
    INFO_CLEARCHOICES(78509);
    INFO_ADDCHOICE(78509, "So you dream of a lawless country?", 78529);
    INFO_ADDCHOICE(78509, "Sooner or later Roderich will find you.", 78530);
    INFO_ADDCHOICE(78509, "It's not too late for you to correct your mistake.", 78531);
}
...
func void DIA_SALVI_Q205_RENEGADECATCH_INFO() {
    ...
    DIA_SALVI_Q205_RENEGADECATCH_GERWIN();
    INFO_CLEARCHOICES(78509);
    INFO_ADDCHOICE(78509, "I think I lost my way.", 78525);
    INFO_ADDCHOICE(78509, "Roderich sent me.", 78523);
}
...
func void DIA_SALVI_Q205_RENEGADECATCH_JOIN() {
    ...
    INFO_CLEARCHOICES(78509);
    INFO_ADDCHOICE(78509, "What would I have to do?", 78533);
}
...
func void Q205_DIALOGUE_SALVI_WORK() {
    ...
    INFO_CLEARCHOICES(78509);
    INFO_ADDCHOICE(78509, "Let's settle this between us.", 78532);
    INFO_ADDCHOICE(78509, "I want to join you.", 78524);
}

func void SALVI_Q205_COUNT() {
    var int SALVI_Q205_RENEGADEINFORMATIONS;
...
func void DIA_SALVI_Q205_DANIEL_ALRIGHT() {
    ...
    CREATEINVITEMS(SELF, 39512, 1);
    B_GIVEINVITEMS(SELF, OTHER, 39512, 1);
    AI_WAITTILLEND(SELF, OTHER);
    AI_WAITTILLEND(OTHER, SELF);
    AI_EQUIPBESTMELEEWEAPON(HERO);
    HERO.AIVAR[95] = TRUE;
...
func void DIA_SALVI_Q205_DANIELRESULT_INFO() {
    ...
    if ((Q205_TRYTOSAVEDANIEL) == (4)) {
        ...
        INFO_CLEARCHOICES(78541);
        INFO_ADDCHOICE(78541, "As for my equipment...", 78544);
    };
...
var int SALVI_QUESTIONS_LEAVE;
var int SALVI_QUESTIONS_PLAN;
var int SALVI_QUESTIONS_ACTION;
...
func void DIA_SALVI_Q205_QUESTIONS_CHOICES() {
    INFO_CLEARCHOICES(78545);
    INFO_ADDCHOICE(78545, DIALOG_BACK, 78552);
    if ((SALVI_QUESTIONS_ACTION) == (FALSE)) {
        INFO_ADDCHOICE(78545, "When do we get out of here?", 78553);
    };
    if ((SALVI_QUESTIONS_PLAN) == (FALSE)) {
        INFO_ADDCHOICE(78545, "What are you planning?", 78554);
    };
    if ((SALVI_QUESTIONS_LEAVE) == (FALSE)) {
        INFO_ADDCHOICE(78545, "Why don't you let people leave this place?", 78555);
    };
}
...
func void DIA_SALVI_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(78556);
    INFO_ADDCHOICE(78556, DIALOG_BACK, 78560);
    INFO_ADDCHOICE(78556, DIALOG_PICKPOCKET, 78559);
}

func void DIA_SALVI_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (2)) {
        B_PICKPOCKET_AMBIENT_TIER_2();
        CREATEINVITEMS(SELF, 36884, 1);
        B_GIVEINVITEMS(SELF, OTHER, 36884, 1);
        SELF.AIVAR[6] = TRUE;
        INFO_CLEARCHOICES(78556);
    };
