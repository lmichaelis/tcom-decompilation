...
var int GERHARD_SQ225_HOLDWIGFINISH_OTHERWAY;
var int GERHARD_SQ225_HOLDWIGFINISH_LETTER;
func void DIA_GERHARD_SQ225_HOLDWIGFINISH_CHOICES() {
    INFO_CLEARCHOICES(80740);
    if ((GERHARD_SQ225_HOLDWIGFINISH_OTHERWAY) == (FALSE)) {
        INFO_ADDCHOICE(80740, "There must be some other way.", 80749);
    };
    INFO_ADDCHOICE(80740, "It may not be so easy to get out of the colony.", 80751);
    if ((SQ225_READHARRYLETTER) == (TRUE)) {
        if ((GERHARD_SQ225_HOLDWIGFINISH_LETTER) == (FALSE)) {
            INFO_ADDCHOICE(80740, "You have to explain something to me first! (Show letter)", 80750);
        };
    };
    if ((GERHARD_SQ225_HOLDWIGFINISH_LETTER) == (FALSE)) {
        INFO_ADDCHOICE(80740, "(Don't react)", 80748);
    };
    INFO_ADDCHOICE(80740, "Kill him, but my silence will cost you.", 80752);
}
...
func void DIA_GERHARD_SQ225_HOLDWIGFINISH_LETTER_GOLD() {
    ...
    INFO_CLEARCHOICES(80740);
    INFO_ADDCHOICE(80740, "500 Gold pieces.", 80753);
    INFO_ADDCHOICE(80740, "1000 Gold pieces.", 80754);
}
...
func void DIA_GERHARD_SQ225_HOLDWIGFINISH_LETTER_GOLD_500() {
    ...
    CREATEINVITEMS(SELF, 34203, SQ225_GERHARD_MONEY);
    B_GIVEINVITEMS(SELF, OTHER, 34203, SQ225_GERHARD_MONEY);
