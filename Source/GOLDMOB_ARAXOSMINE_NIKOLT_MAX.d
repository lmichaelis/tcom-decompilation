...
var int GOLDMOB_ARAXOSMINE_NIKOLT_AMOUNT;
var int GOLDMOB_ARAXOSMINE_01_AMOUNT;
var int GOLDMOB_ARAXOSMINE_02_AMOUNT;
var int GOLDMOB_ARAXOSMINE_03_AMOUNT;
var int GOLDMOB_ARAXOSMINE_04_AMOUNT;
var int GOLDMOB_ARAXOSMINE_05_AMOUNT;
var int GOLDMOB_ARAXOSMINE_06_AMOUNT;
var int GOLDMOB_ARAXOSMINE_07_AMOUNT;
var int GOLDMOB_ARAXOSMINE_08_AMOUNT;
var int GOLDMOB_ARAXOSMINE_09_AMOUNT;
var int GOLDMOB_ARAXOSMINE_10_AMOUNT;
var int GOLDMOB_ARAXOSMINE_11_AMOUNT;
var int GOLDMOB_ARAXOSMINE_12_AMOUNT;
var int GOLDMOB_ARAXOSMINE_13_AMOUNT;
var int GOLDMOB_ARAXOSMINE_14_AMOUNT;
var int GOLDMOB_ARAXOSMINE_15_AMOUNT;
var int GOLDMOB_ARAXOSMINE_16_AMOUNT;
var int GOLDMOB_ARAXOSMINE_17_AMOUNT;
var int GOLDMOB_ARAXOSMINE_18_AMOUNT;
var int GOLDMOB_ARAXOSMINE_19_AMOUNT;
var int GOLDMOB_ARAXOSMINE_20_AMOUNT;
var int GOLDMOB_ARAXOSMINE_21_AMOUNT;
var int GOLDMOB_ARAXOSMINE_22_AMOUNT;
var int GOLDMOB_ARAXOSMINE_23_AMOUNT;
var int GOLDMOB_ARAXOSMINE_24_AMOUNT;
var int GOLDMOB_ARAXOSMINE_25_AMOUNT;
var int GOLDMOB_ARAXOSMINE_26_AMOUNT;
var int GOLDMOB_ARAXOSMINE_27_AMOUNT;
var int GOLDMOB_ARAXOSMINE_28_AMOUNT;
var int GOLDCOUNTER_ARAXOSMINE;
var int GOLDCOUNTER_PICKAXEBROKE;
...
var int GOLDCOUNTER_NEEDTOTAKEBREAK;
...
var int ARAXOSMINE_COUNTPICKAXE;
func void GOLDCOUNTER_PICKAXEBROKE_PREPARE() {
    ARAXOSMINE_COUNTPICKAXE = NPC_HASITEMS(HERO, 34015);
    FF_APPLYONCEEXT(47337, 30, 7);
    HERO.AIVAR[4] = FALSE;
...
func void GOLDCOUNTER_PICKAXEBROKE_APPLY() {
    var int SQ119_INFOABOUTPICKAXE_LOGENTRY;
    var int GOLDCOUNTER_PICKAXEBROKE_COUNT;
    GOLDCOUNTER_PICKAXEBROKE_COUNT = (GOLDCOUNTER_PICKAXEBROKE_COUNT) + (1);
    if ((GOLDCOUNTER_PICKAXEBROKE_COUNT) == (5)) {
        NPC_REMOVEINVITEMS(HERO, 34015, ARAXOSMINE_COUNTPICKAXE);
    ...
    if ((GOLDCOUNTER_PICKAXEBROKE_COUNT) == (6)) {
        if ((ARAXOSMINE_COUNTPICKAXE) != (1)) {
            CREATEINVITEMS(HERO, 34015, (ARAXOSMINE_COUNTPICKAXE) - (1));
        };
