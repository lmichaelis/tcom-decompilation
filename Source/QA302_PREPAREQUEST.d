func void QA302_PREPAREQUEST() {
    WLD_INSERTNPC(50315, "PART2_PATH_68");
    WLD_INSERTNPC(50472, "PART2_MOB_32");
    WLD_INSERTNPC(50473, "PART2_MOB_33");
    WLD_INSERTNPC(50474, "PART2_MOB_34");
    WLD_INSERTNPC(50475, "PART2_MOB_36");
...
func void QA302_PREPAREQUEST_APPLY() {
    ...
    var ZCMOVER MOVER1;
    var int MOVPTR1;
    var int QA302_PREPAREQUEST_COUNT;
...
func void QA302_FOLLOWCITIZEN_SPAWN() {
    ...
    WLD_INSERTNPC(53909, "PARTM4_PATH_81");
}
...
func void QA302_PREPAREBANDITS() {
    ...
    WLD_INSERTNPC(53903, "HARBOUR_QA302_SPOT_05");
    WLD_INSERTNPC(53905, "HARBOUR_QA302_SPOT_05");
    WLD_INSERTNPC(53907, "HARBOUR_QA302_SPOT_05");
    WLD_INSERTNPC(53916, "HARBOUR_QA302_SPOT_05");
}

func void QA302_BANDITS_CUTSCENEENABLE_APPLY() {
    var int QA302_BANDITS_CUTSCENEENABLE_COUNT;
    QA302_BANDITS_CUTSCENEENABLE_COUNT = (QA302_BANDITS_CUTSCENEENABLE_COUNT) + (1);
    if ((QA302_BANDITS_CUTSCENEENABLE_COUNT) == (4)) {
        CUTSCENE_START(92782);
    };
}

func void QA302_BANDITS_END_APPLY() {
    var int QA302_BANDITS_END_COUNT;
