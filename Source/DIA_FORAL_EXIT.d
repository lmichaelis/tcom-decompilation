...
var int FORAL_CANTEACHYOU;
func int DIA_FORAL_TEACH_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 81219)) && ((FORAL_CANTEACHYOU) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_FORAL_TEACH_CHOICES() {
    INFO_CLEARCHOICES(81222);
    INFO_ADDCHOICE(81222, DIALOG_BACK, 81229);
    if ((HERO_HACKCHANCE) <= (65)) {
        INFO_ADDCHOICE(81222, B_BUILDLEARNSTRING2(PRINT_LEARN_MINE5, 0, FORAL_PAYMENT2), 81231);
    };
    if ((HERO_HACKCHANCE) <= (69)) {
        INFO_ADDCHOICE(81222, B_BUILDLEARNSTRING2(PRINT_LEARN_MINE1, 0, FORAL_PAYMENT1), 81230);
    };
}
...
func void DIA_FORAL_TEACH_1POINTS() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (FORAL_PAYMENT1)) {
        if ((HERO_HACKCHANCE) < (100)) {
...
func void DIA_FORAL_TEACH_5POINTS() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (FORAL_PAYMENT2)) {
...
func int DIA_FORAL_DACK_CONDITION() {
    if (((DACK_WANTTOSEESON) == (TRUE)) && (NPC_KNOWSINFO(OTHER, 81216))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_FORAL_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(81235);
    INFO_ADDCHOICE(81235, DIALOG_BACK, 81239);
    INFO_ADDCHOICE(81235, DIALOG_PICKPOCKET, 81238);
}
