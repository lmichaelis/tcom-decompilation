...
func void EVT_SWAMTEMPLE_SPAWNGUARDIANS_R() {
    var int SWAMTEMPLE_SPAWNGUARDIANS_R_CHECK;
    if ((SWAMTEMPLE_SPAWNGUARDIANS_R_CHECK) == (FALSE)) {
        ...
        WLD_INSERTNPC(58480, "PART17_TEMPLE_GUARDIAN_04");
        WLD_INSERTNPC(58482, "PART17_TEMPLE_GUARDIAN_05");
    };
}

func void EVT_SWAMTEMPLE_SPAWNGUARDIANS_L() {
    var int SWAMTEMPLE_SPAWNGUARDIANS_L_CHECK;
    if ((SWAMTEMPLE_SPAWNGUARDIANS_L_CHECK) == (FALSE)) {
        ...
        WLD_INSERTNPC(58484, "PART17_TEMPLE_GUARDIAN_06");
        WLD_INSERTNPC(58486, "PART17_TEMPLE_GUARDIAN_07");
    };
}
...
func void SWAMTEMPLE_SPAWNGUARDIANS() {
    ...
    WLD_INSERTNPC(58474, "PART17_TEMPLE_GUARDIAN_01");
    WLD_INSERTNPC(58476, "PART17_TEMPLE_GUARDIAN_02");
    WLD_INSERTNPC(58478, "PART17_TEMPLE_GUARDIAN_03");
}

var int SWAMPTEMPLE_BLOCKGATE;
