...
func void FOOD_FORESTBERRYBONUS() {
    var int FOOD_FORESTBERRYBONUS_PRINT2;
    var int FOOD_FORESTBERRYBONUS_PRINT1;
    if ((SELF.ID) == (0)) {
...
var int MEAL_APPLEPIE_CHECKBONUS;
var int MEAL_BATSTEW_CHECKBONUS;
var int MEAL_BEERFISH_CHECKBONUS;
var int MEAL_BEERBREAD_CHECKBONUS;
var int MEAL_BERRYCOMPOTE_CHECKBONUS;
var int MEAL_BERRYJAM_CHECKBONUS;
var int MEAL_BLUESTEW_CHECKBONUS;
var int MEAL_BOARSTEW_CHECKBONUS;
var int MEAL_BREADSOUP_CHECKBONUS;
var int MEAL_CABBAGESOUP_CHECKBONUS;
var int MEAL_DEXDUMPLINGS_CHECKBONUS;
var int MEAL_DRYFRUITCOMPOTE_CHECKBONUS;
var int MEAL_EXOTICDESSERT_CHECKBONUS;
var int MEAL_FATSTEW_CHECKBONUS;
var int MEAL_FISHCOTLET_CHECKBONUS;
var int MEAL_FISHFILLETPERM_CHECKBONUS;
var int MEAL_FISHPOT_CHECKBONUS;
var int MEAL_FISHVINEGAR_CHECKBONUS;
var int MEAL_FRIEDFISHSKINS_CHECKBONUS;
var int MEAL_GRAPEJUICE_CHECKBONUS;
var int MEAL_HERBFISHSOUP_CHECKBONUS;
var int MEAL_HERBMUSHROOMBREWING_CHECKBONUS;
var int MEAL_HERBSTEW_CHECKBONUS;
var int MEAL_HONEYCOOKIES_CHECKBONUS;
var int MEAL_HUNTERSPECIAL_CHECKBONUS;
var int MEAL_MANAPERMSOUP_CHECKBONUS;
var int MEAL_MARTHSOUP4_CHECKBONUS;
var int MEAL_MARTHSOUP3_CHECKBONUS;
var int MEAL_MARTHSOUP2_CHECKBONUS;
var int MEAL_MARTHSOUP1_CHECKBONUS;
var int MEAL_MEATANDBREAD_CHECKBONUS;
var int MEAL_MEATANDCHEESE_CHECKBONUS;
var int MEAL_MEATMISHMASH_CHECKBONUS;
var int MEAL_MEATPACKS_CHECKBONUS;
var int MEAL_MULLEDWISP_CHECKBONUS;
var int MEAL_MUSHROOMCOTLET_CHECKBONUS;
var int MEAL_MUSHROOMSOUP_CHECKBONUS;
var int MEAL_MUSHROOMSTEW_CHECKBONUS;
var int MEAL_PICKLEDBEET_CHECKBONUS;
var int MEAL_PICKLEDMUSHROOMS_CHECKBONUS;
var int MEAL_POORAPPLEPIE_CHECKBONUS;
var int MEAL_POORBROTH_CHECKBONUS;
var int MEAL_WEEDSTEW_CHECKBONUS;
var int MEAL_POOREGGS_CHECKBONUS;
var int MEAL_POORPATE_CHECKBONUS;
var int MEAL_PUMPKINCOMPOTE_CHECKBONUS;
var int MEAL_RASPBERRYDRINK_CHECKBONUS;
var int MEAL_RASPBERRYTINCTURE_CHECKBONUS;
var int MEAL_RATSTICK_CHECKBONUS;
var int MEAL_REDSTEW_CHECKBONUS;
var int MEAL_RIVERMIRTSOUP_CHECKBONUS;
var int MEAL_ROASTEDINSECTS_CHECKBONUS;
var int MEAL_SCAVENGERSHASHLIK_CHECKBONUS;
var int MEAL_BEARSTEW_CHECKBONUS;
var int MEAL_SHEPARDROAST_CHECKBONUS;
var int MEAL_SIMPLEOYSTERS_CHECKBONUS;
var int MEAL_SLAGERMEAT_CHECKBONUS;
var int MEAL_SMOKEDHERBFISH_CHECKBONUS;
var int MEAL_SPEEDHERBOYSTERS_CHECKBONUS;
var int MEAL_SPEEDSTEW_CHECKBONUS;
var int MEAL_SPICYFISH_CHECKBONUS;
var int MEAL_SPICYPIE_CHECKBONUS;
var int MEAL_STRENGTHJAM_CHECKBONUS;
var int MEAL_SWEETBUN_CHECKBONUS;
var int MEAL_TROLLSOUP_CHECKBONUS;
var int MEAL_VEGEPIE_CHECKBONUS;
var int MEAL_POINTSBONUS;
func void FOOD_MEALSBONUS() {
    var string CONCATTEXT;
    var int MEAL_BONUSTRY;
    if ((SELF.ID) == (0)) {
...
func void USE_MEATTESTPACKET() {
    CREATEINVITEMS(HERO, 33843, 10);
    CREATEINVITEMS(HERO, 33845, 10);
    CREATEINVITEMS(HERO, 36403, 10);
    CREATEINVITEMS(HERO, 36405, 10);
    CREATEINVITEMS(HERO, 36409, 10);
    CREATEINVITEMS(HERO, 36407, 10);
    CREATEINVITEMS(HERO, 36411, 10);
    CREATEINVITEMS(HERO, 36413, 10);
    CREATEINVITEMS(HERO, 36417, 10);
    CREATEINVITEMS(HERO, 36415, 10);
    CREATEINVITEMS(HERO, 36421, 10);
    CREATEINVITEMS(HERO, 36419, 10);
    CREATEINVITEMS(HERO, 36425, 10);
    CREATEINVITEMS(HERO, 36423, 10);
    CREATEINVITEMS(HERO, 36429, 10);
    CREATEINVITEMS(HERO, 36427, 10);
    CREATEINVITEMS(HERO, 36433, 10);
    CREATEINVITEMS(HERO, 36431, 10);
    CREATEINVITEMS(HERO, 36437, 10);
    CREATEINVITEMS(HERO, 36435, 10);
    CREATEINVITEMS(HERO, 36441, 10);
    CREATEINVITEMS(HERO, 36439, 10);
    SND_PLAY(GELDBEUTEL);
}
...
func void USE_HAPPYMEAL() {
    CREATEINVITEMS(HERO, 36604, 1);
    CREATEINVITEMS(HERO, 36606, 1);
    CREATEINVITEMS(HERO, 36608, 1);
    CREATEINVITEMS(HERO, 36610, 1);
    CREATEINVITEMS(HERO, 36612, 1);
    CREATEINVITEMS(HERO, 36614, 1);
    CREATEINVITEMS(HERO, 36616, 1);
    CREATEINVITEMS(HERO, 36618, 1);
    CREATEINVITEMS(HERO, 36622, 1);
    CREATEINVITEMS(HERO, 36624, 1);
    CREATEINVITEMS(HERO, 36626, 1);
    CREATEINVITEMS(HERO, 36628, 1);
    CREATEINVITEMS(HERO, 36631, 1);
    CREATEINVITEMS(HERO, 36633, 1);
    CREATEINVITEMS(HERO, 36635, 1);
    CREATEINVITEMS(HERO, 36637, 1);
    CREATEINVITEMS(HERO, 36639, 1);
    CREATEINVITEMS(HERO, 36641, 1);
    CREATEINVITEMS(HERO, 36643, 1);
    CREATEINVITEMS(HERO, 36645, 1);
    CREATEINVITEMS(HERO, 36647, 1);
    CREATEINVITEMS(HERO, 36649, 1);
    CREATEINVITEMS(HERO, 36652, 1);
    CREATEINVITEMS(HERO, 36654, 1);
    CREATEINVITEMS(HERO, 36656, 1);
    CREATEINVITEMS(HERO, 36658, 1);
    CREATEINVITEMS(HERO, 36660, 1);
    CREATEINVITEMS(HERO, 36662, 1);
    CREATEINVITEMS(HERO, 36664, 1);
    CREATEINVITEMS(HERO, 36666, 1);
    CREATEINVITEMS(HERO, 36668, 1);
    CREATEINVITEMS(HERO, 36670, 1);
    CREATEINVITEMS(HERO, 36672, 1);
    CREATEINVITEMS(HERO, 36674, 1);
    CREATEINVITEMS(HERO, 36676, 1);
    CREATEINVITEMS(HERO, 36678, 1);
    CREATEINVITEMS(HERO, 36680, 1);
    CREATEINVITEMS(HERO, 36682, 1);
    CREATEINVITEMS(HERO, 36684, 1);
    CREATEINVITEMS(HERO, 36686, 1);
    CREATEINVITEMS(HERO, 36688, 1);
    CREATEINVITEMS(HERO, 36690, 1);
    CREATEINVITEMS(HERO, 36692, 1);
    CREATEINVITEMS(HERO, 36694, 1);
    CREATEINVITEMS(HERO, 36696, 1);
    CREATEINVITEMS(HERO, 36698, 1);
    CREATEINVITEMS(HERO, 36700, 1);
    CREATEINVITEMS(HERO, 36702, 1);
    CREATEINVITEMS(HERO, 36704, 1);
    CREATEINVITEMS(HERO, 36706, 1);
    CREATEINVITEMS(HERO, 36708, 1);
    CREATEINVITEMS(HERO, 36710, 1);
    CREATEINVITEMS(HERO, 36712, 1);
    CREATEINVITEMS(HERO, 36714, 1);
    CREATEINVITEMS(HERO, 36716, 1);
    CREATEINVITEMS(HERO, 36718, 1);
    CREATEINVITEMS(HERO, 36720, 1);
}
...
func void USE_SPEEDSTEW() {
    ...
    BUFF_APPLYEXT(SELF, 32454, (DURATION_SPEEDSTEW) * (1000), FALSE, TRUE);
}
