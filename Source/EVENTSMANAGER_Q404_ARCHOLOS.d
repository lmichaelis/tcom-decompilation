func void EVENTSMANAGER_Q404_ARCHOLOS() {
    ...
    if ((Q404_DALMONSTATUS) == (1)) {
        if (((NPC_GETDISTTOWP(DJG_10027_DALMON, "WOLFSDEN_CITADEL_10")) <= (500)) && ((NPC_ISINSTATE(DJG_10027_DALMON, 61599)) == (FALSE))) {
            Q404_DALMONSTATUS = 2;
    ...
    if ((Q404_DALMONSTATUS) == (2)) {
        if (((NPC_GETDISTTOWP(DJG_10027_DALMON, "WOLFSDEN_CITADEL_HELP_04")) <= (500)) && ((NPC_ISINSTATE(DJG_10027_DALMON, 61599)) == (FALSE))) {
    ...
    if ((Q404_LEGRIFSTATUS) == (1)) {
        if (((NPC_GETDISTTOWP(DJG_10017_LEGRIF, "WOLFSDEN_CITADEL_HELP_03")) <= (500)) && ((NPC_ISINSTATE(DJG_10017_LEGRIF, 61599)) == (FALSE))) {
            Q404_GUARDMINE_COUNT = (Q404_GUARDMINE_COUNT) + (1);
            Q404_LEGRIFSTATUS = 2;
    ...
    if ((Q404_VAHRALSTATUS) == (1)) {
        if (((NPC_GETDISTTOWP(DJG_10014_VAHRAL, "WOLFSDEN_CITADEL_HELP_02")) <= (500)) && ((NPC_ISINSTATE(DJG_10014_VAHRAL, 61599)) == (FALSE))) {
            Q404_GUARDMINE_COUNT = (Q404_GUARDMINE_COUNT) + (1);
            Q404_VAHRALSTATUS = 2;
    ...
    if ((Q404_GRONSTATUS) == (1)) {
        if (((NPC_GETDISTTOWP(DJG_10011_GRON, "WOLFSDEN_CITADEL_HELP_01")) <= (500)) && ((NPC_ISINSTATE(DJG_10011_GRON, 61599)) == (FALSE))) {
            Q404_GUARDMINE_COUNT = (Q404_GUARDMINE_COUNT) + (1);
            Q404_GRONSTATUS = 2;
            PRINTD("Vahral dobieg³ do kopalni");
            PRINTD("+1 stra¿ników kopalni");
