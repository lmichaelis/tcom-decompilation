...
func void DIA_VEIGO_CQ004_WHODIDTHIS_INFO() {
    ...
    INFO_CLEARCHOICES(75354);
    INFO_ADDCHOICE(75354, "Who do you think damaged the crane?", 75359);
    INFO_ADDCHOICE(75354, "Where were you when the crane stopped working?", 75360);
}

func void DIA_VEIGO_CQ004_WHODIDTHIS_NEXT() {
    var int CQ004_RECONANDVEIGOINFORMATION;
...
func void DIA_VEIGO_CQ004_KETHLOST_INFO() {
    ...
    CREATEINVITEMS(SELF, 34203, CQ004_VEIGOREWARD);
    B_GIVEINVITEMS(SELF, OTHER, 34203, CQ004_VEIGOREWARD);
    AI_STOPPROCESSINFOS(SELF);
    AI_FUNCTION(SELF, 62675);
...
func int DIA_VEIGO_Q504_FEEL_CONDITION() {
    if ((((NPC_GETDISTTOWP(SELF, "PART5_WORKERSCAMP_STAND_01")) <= (2000)) && ((Q504_VEIGOVOLFZACKE) == (1))) && ((Q504_TAKEWORKERS) == (2))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_VEIGO_AMBIENT_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 75348)) || (NPC_KNOWSINFO(OTHER, 75351))) || (NPC_KNOWSINFO(OTHER, 75354))) {
        if ((Q504_TAKEWORKERS) != (2)) {
            return TRUE;
        };
    };
...
func int DIA_VEIGO_LEAVEMEALONE_CONDITION() {
    if ((NPC_ISINSTATE(SELF, 61599)) && ((CQ004_RESULT) == (2))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_VEIGO_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(75379);
    INFO_ADDCHOICE(75379, DIALOG_BACK, 75383);
    INFO_ADDCHOICE(75379, DIALOG_PICKPOCKET, 75382);
}
