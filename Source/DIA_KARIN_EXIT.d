...
func int DIA_KARIN_HELLO_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ213)) == (LOG_RUNNING)) && ((NPC_KNOWSINFO(OTHER, 77793)) == (FALSE))) {
        return TRUE;
    };
...
func void DIA_KARIN_DIFFICULT() {
    ...
    INFO_CLEARCHOICES(77798);
    INFO_CLEARCHOICES(77793);
}
...
func void DIA_KARIN_WHO_INFO() {
    ...
    NPC_EXCHANGEROUTINE(SELF, "NORMALDAY");
    INFO_CLEARCHOICES(77793);
    INFO_ADDCHOICE(77793, DIALOG_BESILENT, 77801);
    INFO_ADDCHOICE(77793, "Is it harder for women in this profession?", 77796);
}
...
func int DIA_KARIN_TELLME_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 77790)) && ((NPC_KNOWSINFO(OTHER, 77793)) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_KARIN_TELLME_INFO() {
    ...
    DIA_KARIN_WHOIAM();
    INFO_CLEARCHOICES(77798);
    INFO_ADDCHOICE(77798, DIALOG_BESILENT, 77801);
    INFO_ADDCHOICE(77798, "Is it harder for women in this profession?", 77796);
}
...
func int DIA_KARIN_PLAYLUTE_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 77790)) || (NPC_KNOWSINFO(OTHER, 77793))) {
...
func void DIA_KARIN_ORCHARD_DONE() {
    ...
    INFO_CLEARCHOICES(77802);
    INFO_CLEARCHOICES(77810);
    INFO_CLEARCHOICES(77813);
}

func void DIA_KARIN_LUTE_LESSON() {
    CREATEINVITEMS(SELF, 34190, 1);
    CREATEINVITEMS(OTHER, 34190, 1);
    ...
    AI_USEITEMTOSTATE(OTHER, 34190, 1);
...
func void DIA_KARIN_BIMBER_GIVE() {
    ...
    INFO_CLEARCHOICES(77802);
    INFO_ADDCHOICE(77802, "I've always dreamed of it!", 77808);
    INFO_ADDCHOICE(77802, "It's a long story.", 77809);
    INFO_CLEARCHOICES(77810);
    INFO_ADDCHOICE(77810, "I've always dreamed of it!", 77808);
    INFO_ADDCHOICE(77810, "It's a long story.", 77809);
}
...
func int DIA_KARIN_BIMBER_CONDITION() {
    if ((((NPC_KNOWSINFO(OTHER, 77802)) && ((SQ213_KARINBIMBER) == (FALSE))) && ((NPC_HASITEMS(OTHER, 36385)) >= (1))) && ((LOG_GETSTATUS(MIS_SQ213)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_KARIN_GOLDLUTE_CONDITION() {
    if ((((NPC_KNOWSINFO(OTHER, 77802)) && ((NPC_HASITEMS(OTHER, 34203)) >= (MIST_KARINLUTE))) && ((SQ213_KARINGOLDLUTE) == (TRUE))) && ((LOG_GETSTATUS(MIS_SQ213)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_KARIN_GOLDLUTE_INFO() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 34203, MIST_KARINLUTE);
    DIA_KARIN_LUTE_LESSON();
}
...
func void DIA_KARIN_SQ213PLAYSONG_INFO() {
    ...
    AI_FUNCTION(SELF, 77822);
}

func void MIST_SONGWITHKARIN() {
    FADESCREENTOBLACKF(1, 77823, 1000);
}
...
func int DIA_KARIN_AMBIENT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 77793)) || (NPC_KNOWSINFO(OTHER, 77790))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_KARIN_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(77830);
    INFO_ADDCHOICE(77830, DIALOG_BACK, 77834);
    INFO_ADDCHOICE(77830, DIALOG_PICKPOCKET, 77833);
}
