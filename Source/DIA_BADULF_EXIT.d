...
func int DIA_BADULF_WHAT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 79869)) && ((LOG_GETSTATUS(MIS_Q515)) != (LOG_SUCCESS))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_BADULF_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(79890);
    INFO_ADDCHOICE(79890, DIALOG_BACK, 79894);
    INFO_ADDCHOICE(79890, DIALOG_PICKPOCKET, 79893);
}
