func void EVENTSMANAGER_Q401() {
    var int Q401_FABIOFRIENDISDEAD_LOGENTRY;
    var int Q401_FABIOISDEAD_LOGENTRY;
    if ((LOG_GETSTATUS(MIS_Q401)) != (LOG_RUNNING)) {
        return;
    };
    if ((Q401_NEARSWAMPHOUSE) == (FALSE)) {
        if (NPC_KNOWSINFO(HERO, 85435)) {
            if ((NPC_GETDISTTOWP(HERO, "PART11_SWAMPHOUSE_ENTRY")) <= (1850)) {
