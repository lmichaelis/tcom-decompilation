func void EVENTSMANAGER_Q602() {
    var int Q602_VOLKER_PROTECTIONBUFF;
    var int Q602_SPAWNIVYBATTLE;
    var int Q602_WPDISTANCETOWAR;
    var int Q602_FINALBATTLE_PREPAREFIGHT_CHANGEGUILD;
    var int Q602_FINALBATTLE_STAGE;
    var int Q602_RIORDIANCHECKPOINT_03;
    var int Q602_RIORDIANCHECKPOINT_02;
    var int Q602_RIORDIANCHECKPOINT_01;
    var int Q602_VOLKERSPECIALATTACK;
    var int Q602_RIORDIANCHECKPOINT_04;
    var int Q602_BLOCKTIME;
    var int Q602_SPAWN;
    ...
    if ((Q602_KUNOMADNESS) == (2)) {
        if (!(NPC_ISINSTATE(VLK_61270_KUNO_Q602, 61599))) {
    ...
    if ((Q602_CLOSEDGATEV1_LOGENTRY) == (FALSE)) {
        if ((NPC_GETDISTTOWP(HERO, "PARTE2_PATH_12")) <= (1500)) {
    ...
    if ((Q602_HERSHLIKCHANGERTN) == (1)) {
        if (((NPC_GETDISTTOWP(VLK_30020_HERSHLIK_Q602, "PARTM2_PATH_78")) <= (400)) && ((NPC_ISINSTATE(VLK_30020_HERSHLIK_Q602, 61599)) == (FALSE))) {
    ...
    if ((Q602_ARAXOSNEEDSHELP_LOGENTRY) == (FALSE)) {
        if ((NPC_GETDISTTOWP(HERO, "PARTM1_GUILDHOUSE02_40")) <= (2000)) {
    ...
    if ((Q602_GUIDECITIZEN) == (TRUE)) {
        if ((Q602_CITIZEN_CHANGERTN_01) == (FALSE)) {
            if ((!(NPC_ISDEAD(VLK_10076_CITIZEN_Q602))) && ((NPC_ISINSTATE(VLK_10076_CITIZEN_Q602, 61599)) == (FALSE))) {
        ...
        if ((Q602_CITIZEN_CHANGERTN_02) == (FALSE)) {
            if ((!(NPC_ISDEAD(VLK_6300_GROEN_Q602))) && ((NPC_ISINSTATE(VLK_6300_GROEN_Q602, 61599)) == (FALSE))) {
        ...
        if ((Q602_CITIZEN_CHANGERTN_03) == (FALSE)) {
            if ((!(NPC_ISDEAD(VLK_10079_CITIZEN_Q602))) && ((NPC_ISINSTATE(VLK_10079_CITIZEN_Q602, 61599)) == (FALSE))) {
        ...
        if ((Q602_CITIZEN_CHANGERTN_04) == (FALSE)) {
            if ((!(NPC_ISDEAD(VLK_10077_CITIZEN_Q602))) && ((NPC_ISINSTATE(VLK_10077_CITIZEN_Q602, 61599)) == (FALSE))) {
        ...
        if ((Q602_CITIZEN_CHANGERTN_05) == (FALSE)) {
            if ((!(NPC_ISDEAD(VLK_10078_CITIZEN_Q602))) && ((NPC_ISINSTATE(VLK_10078_CITIZEN_Q602, 61599)) == (FALSE))) {
        ...
        if ((Q602_CITIZEN_CHANGERTN_06) == (FALSE)) {
            if ((!(NPC_ISDEAD(VLK_10080_CITIZEN_Q602))) && ((NPC_ISINSTATE(VLK_10080_CITIZEN_Q602, 61599)) == (FALSE))) {
        ...
        if ((Q602_HELPSALL) >= (1)) {
            if ((Q602_SALL_CHANGERTN) == (FALSE)) {
                if ((!(NPC_ISDEAD(MIL_4044_SALL_Q602))) && ((NPC_ISINSTATE(MIL_4044_SALL_Q602, 61599)) == (FALSE))) {
        ...
        if ((Q602_RUNAR_CHANGERTN) == (FALSE)) {
            if ((!(NPC_ISDEAD(PAL_101_SILVESTR_Q602))) && ((NPC_ISINSTATE(PAL_101_SILVESTR_Q602, 61599)) == (FALSE))) {
    ...
    if ((Q602_GARDINCITY) == (1)) {
        if ((NPC_GETDISTTOWP(HERO, "PARTM8_PATH_12")) <= (2500)) {
            PRINTD("Flags");
            Q602_GARDINCITY = 2;
    ...
    if ((Q602_TRIMEGISTO_CUTSCENEENABLE) == (1)) {
        if (!(NPC_ISINSTATE(KDF_6404_TRIMEGISTO_Q602, 61599))) {
            HERO.AIVAR[4] = TRUE;
            Q602_TRIMEGISTO_CUTSCENEENABLE = 2;
            FF_APPLYONCEEXT(94196, 500, 2);
        };
    };
    ...
    if (((Q602_TELEPORTTENGRAL) == (1)) && ((NPC_ISINSTATE(KDF_9004_TENGRAL_Q602, 61599)) == (FALSE))) {
        PRINTD("Teleport");
        Q602_TELEPORTTENGRAL = 2;
        TELEPORTNPCTOWP(59632, "PARTE8_PATH_04");
    ...
    if ((Q602_GALBO_CHANGERTN) == (1)) {
        if ((NPC_GETDISTTOWP(NONE_6363_GALBO_Q602, "PARTE3_GALBO_RUN")) <= (750)) {
            if ((!(NPC_ISDEAD(NONE_6363_GALBO_Q602))) && ((NPC_ISINSTATE(NONE_6363_GALBO_Q602, 61599)) == (FALSE))) {
    ...
    if ((Q602_FIGHTWITHGALBO) == (1)) {
        if ((NPC_ISINSTATE(HERO, 61603)) && ((NPC_ISINSTATE(NONE_6363_GALBO_Q602, 61599)) == (FALSE))) {
    ...
    if ((Q602_FIGHTWITHFABIOEVENTS) == (1)) {
        if ((NPC_ISDEAD(NONE_6366_FABIO_Q602)) && (NPC_ISDEAD(NONE_6364_SIGMUN_Q602))) {
            if ((((NPC_ISINSTATE(VLK_10092_CITIZEN_Q602, 61599)) == (FALSE)) && ((NPC_ISINSTATE(VLK_10093_CITIZEN_Q602, 61599)) == (FALSE))) && ((NPC_ISINSTATE(VLK_10094_CITIZEN_Q602, 61599)) == (FALSE))) {
                PRINTD("Zmiana RTN");
    ...
    if ((SQ225_FINISHWAY) == (3)) {
        if ((Q602_VINEYARDFIGHT) == (1)) {
            if ((NPC_GETDISTTOWP(HERO, "PARTE4_Q602_VINEYARDLEADER")) <= (2200)) {
            ...
            if (((NPC_ISDEAD(NONE_50200_VOLKERGUARD_Q602)) && (NPC_ISDEAD(NONE_50201_VOLKERGUARD_Q602))) && (NPC_ISDEAD(NONE_50202_VOLKERGUARD_Q602))) {
                if (((((NPC_ISINSTATE(BAU_2245_HOLDWIG_Q602, 61599)) == (FALSE)) && ((NPC_ISINSTATE(VLK_11181_ANDERAS_Q602, 61599)) == (FALSE))) && ((NPC_ISINSTATE(NONE_50203_HOLDWIGGUARD_Q602, 61599)) == (FALSE))) && ((NPC_ISINSTATE(NONE_50205_ANDERASGUARD_Q602, 61599)) == (FALSE))) {
    ...
    if ((Q602_GUILD_V4) == (2)) {
        if (!(NPC_ISDEAD(NONE_500_RAMSEY_Q602))) {
            if (NPC_ISINSTATE(NONE_500_RAMSEY_Q602, 61603)) {
    ...
    if ((Q602_VINEYARDFIGHT) >= (1)) {
        if ((Q602_RIORDIANCHECKPOINT_01) == (FALSE)) {
            if (((NPC_GETDISTTOWP(HERO, "PARTM4_PATH_71")) <= (500)) && ((NPC_ISINSTATE(KDW_203_RIORDIAN_Q602, 61599)) == (FALSE))) {
        ...
        if ((Q602_RIORDIANCHECKPOINT_02) == (FALSE)) {
            if (((NPC_GETDISTTOWP(HERO, "PARTM4_PATH_87")) <= (500)) && ((NPC_ISINSTATE(KDW_203_RIORDIAN_Q602, 61599)) == (FALSE))) {
        ...
        if ((Q602_RIORDIANCHECKPOINT_03) == (FALSE)) {
            if ((NPC_ISINSTATE(KDW_203_RIORDIAN_Q602, 61599)) == (FALSE)) {
        ...
        if ((Q602_RIORDIANCHECKPOINT_04) == (FALSE)) {
            if (((NPC_GETDISTTOWP(HERO, "PARTM5_PATH_400")) <= (450)) && ((NPC_ISINSTATE(KDW_203_RIORDIAN_Q602, 61599)) == (FALSE))) {
    ...
    if ((Q602_FINALBATTLE_PREPAREFIGHT_CHANGEGUILD) == (0)) {
        if ((((((Q308_WHOWILLDIE) != (3)) && (NPC_KNOWSINFO(HERO, 76597))) && (NPC_KNOWSINFO(HERO, 90256))) || (((Q308_WHOWILLDIE) != (3)) && ((NPC_KNOWSINFO(HERO, 76597)) == (FALSE)))) || ((Q308_WHOWILLDIE) == (3))) {
            if ((NPC_GETDISTTOWP(HERO, "PARTM5_ANGRYMOB_HERO_02")) <= (1250)) {
                Q602_FINALBATTLE_PREPAREFIGHT_CHANGEGUILD = 1;
                FF_APPLYONCEEXT(61205, 75, 4);
            };
        };
    };
    ...
    if ((Q602_FINALBATTLE_STARTFIGHT) == (1)) {
        if ((NPC_GETDISTTOWP(HERO, "PARTM5_PATH_43")) <= (500)) {
            ...
            if ((NPC_GETDISTTONPC(HERO, KDW_203_RIORDIAN_Q602)) >= (700)) {
                TELEPORTNPCTOWP(59649, "PARTM5_PATH_44");
            };
        };
    };
    if ((Q602_FINALBATTLE_STARTFIGHT) == (3)) {
        if (((((((NPC_GETDISTTOWP(DJG_10181_WOLFSON_Q602, "PARTE5_SPAWNPOINT_01")) <= (2000)) && ((NPC_GETDISTTOWP(DJG_10182_WOLFSON_Q602, "PARTE5_SPAWNPOINT_01")) <= (2000))) && ((NPC_GETDISTTOWP(DJG_10183_WOLFSON_Q602, "PARTE5_SPAWNPOINT_01")) <= (2000))) && ((NPC_GETDISTTOWP(DJG_10184_WOLFSON_Q602, "PARTE5_SPAWNPOINT_01")) <= (2000))) && ((NPC_GETDISTTOWP(DJG_10185_WOLFSON_Q602, "PARTE5_SPAWNPOINT_01")) <= (2000))) && ((NPC_GETDISTTOWP(DJG_10186_WOLFSON_Q602, "PARTE5_SPAWNPOINT_01")) <= (2000))) {
            HERO.AIVAR[4] = TRUE;
            HERO.FLAGS = 2;
            FF_APPLYONCEEXT(61212, 100, 4);
    ...
    if ((Q602_FINALBATTLE_STARTFIGHT) == (6)) {
        if (((((((NPC_GETDISTTOWP(KDW_303_RIEROL_Q602, "PARTE5_SPAWNPOINT_01")) <= (2000)) && ((NPC_GETDISTTOWP(KDW_206_OTHEKAR_Q602, "PARTE5_SPAWNPOINT_01")) <= (2000))) && ((NPC_GETDISTTOWP(KDW_301_CUSTO_Q602, "PARTE5_SPAWNPOINT_01")) <= (2000))) && ((NPC_GETDISTTOWP(KDW_214_BADULF_Q602, "PARTE5_SPAWNPOINT_01")) <= (2000))) && ((NPC_GETDISTTOWP(KDW_216_INGOLF_Q602, "PARTE5_SPAWNPOINT_01")) <= (2000))) && ((NPC_GETDISTTOWP(KDW_215_NOTGER_Q602, "PARTE5_SPAWNPOINT_01")) <= (2000))) {
            HERO.AIVAR[4] = TRUE;
            HERO.FLAGS = 2;
            FF_APPLYONCEEXT(61214, 100, 4);
    ...
    if (((Q602_FINALBATTLE_STARTFIGHT) == (8)) && (NPC_ISINSTATE(NONE_15_ULRYK_Q602, 61603))) {
    ...
    if ((((Q602_FINALBATTLE_STARTFIGHT) == (10)) && ((NPC_GETDISTTOWP(KDW_215_NOTGER_Q602, "PARTM5_CITYHALL_07")) <= (700))) && ((NPC_ISINSTATE(KDW_215_NOTGER_Q602, 61599)) == (FALSE))) {
        ...
        AI_STARTSTATE(KDW_215_NOTGER_Q602, 61599, 1, "");
        HERO.AIVAR[4] = FALSE;
    };
    ...
    if ((Q602_STARTFIGHTWITHULRYK) == (1)) {
        if ((NONE_15_ULRYK_Q602.ATTRIBUTE[0]) <= (((NONE_15_ULRYK_Q602.ATTRIBUTE[1]) / (4)) * (3))) {
            ...
            if (NPC_ISINSTATE(NONE_15_ULRYK_Q602, 43856)) {
                NPC_SETSTATETIME(NONE_15_ULRYK_Q602, (SPL_TIME_FREEZE) + (1));
            };
            if (NPC_ISINSTATE(NONE_15_ULRYK_Q602, 43909)) {
                NPC_SETSTATETIME(NONE_15_ULRYK_Q602, (SPL_TIME_SHORTZAPPED) + (1));
            };
            if (NPC_ISINSTATE(NONE_15_ULRYK_Q602, 43905)) {
    ...
    if ((Q602_SPAWNIVYBATTLE) == (0)) {
        if ((NPC_GETDISTTOWP(HERO, "PARTE5_SEWERS_11")) <= (2000)) {
            Q602_SPAWNIVYBATTLE = 1;
            NONE_16_IVY_Q602.AIVAR[15] = TRUE;
            WLD_INSERTNPC(50288, "FP_PARTE5_SEWERS_01");
        };
    };
    if ((Q602_FINALBOSS_READYTOFIGHT) == (1)) {
        if ((VLK_15000_VOLKER_Q602.ATTRIBUTE[0]) != (VLK_15000_VOLKER_Q602.ATTRIBUTE[1])) {
            ...
            CREATEINVITEM(VLK_15000_VOLKER_Q602, 37630);
            AI_USEITEM(VLK_15000_VOLKER_Q602, 37630);
            AI_FUNCTION(VLK_15000_VOLKER_Q602, 61193);
    ...
    if ((Q602_FINALBOSSTIME) == (2)) {
        if (NPC_ISINSTATE(VLK_15000_VOLKER_Q602, 61603)) {
            MUSIC_DISABLEOVERRIDE();
            PRINTD("POKONA£EŒ FINAL BOSSA!");
            Q602_FINALBOSSTIME = 3;
            if (((IVY_Q602_JOINEDTEAM) == (TRUE)) && ((NPC_ISINSTATE(NONE_16_IVY_Q602, 61603)) == (FALSE))) {
            ...
            NPC_SETTRUEGUILD(VLK_15000_VOLKER_Q602, GIL_FRIENDLY_HUMAN);
    ...
    if ((Q602_FINALBOSSTIME) == (3)) {
        if ((NPC_ISDEAD(VLK_15000_VOLKER_Q602)) && ((NPC_KNOWSINFO(HERO, 90737)) == (FALSE))) {
...
func void Q602_TRIMEGISTO_CUTSCENEENABLE_APPLY() {
    var int Q602_TRIMEGISTO_CUTSCENEENABLE_COUNT;
