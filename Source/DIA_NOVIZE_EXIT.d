...
func void TRIA_NOVIZE_SQ508_NEWS_INFO() {
    ...
    INFO_CLEARCHOICES(80461);
    INFO_ADDCHOICE(80461, "Do you have a problem?", 80466);
    INFO_ADDCHOICE(80461, "Please, continue.", 80465);
}
...
func void TRIA_NOVIZE_SQ508_NEWS_NEXT() {
    ...
    INFO_CLEARCHOICES(80461);
    INFO_ADDCHOICE(80461, "Are you going to tell me what's going on here or not?", 80467);
}
...
func void TRIA_NOVIZE_SQ508_NEWS_PROBLEM_NEXT_TELL() {
    ...
    INFO_CLEARCHOICES(80461);
    INFO_ADDCHOICE(80461, "I don't have time right now.", 80472);
    INFO_ADDCHOICE(80461, "I'll check out that cemetery.", 80471);
}
...
func int DIA_NOVIZE_SQ508_CHECK_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ508)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 80461))) && ((SQ508_HELPNOVIZE) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_NOVIZE_SQ508_AFTERQUEST_INFO() {
    ...
    INFO_CLEARCHOICES(80479);
    INFO_ADDCHOICE(80479, "It's a long story, but the cemetery is now safe.", 80482);
}
...
func void DIA_NOVIZE_SQ508_AFTERQUEST_SAFE() {
    ...
    CREATEINVITEMS(SELF, 34707, 1);
    B_GIVEINVITEMS(SELF, OTHER, 34707, 1);
    CREATEINVITEMS(SELF, 34529, 1);
    B_GIVEINVITEMS(SELF, OTHER, 34529, 1);
    INFO_CLEARCHOICES(80479);
    AI_STOPPROCESSINFOS(SELF);
    AI_FUNCTION(SELF, 63360);
}
