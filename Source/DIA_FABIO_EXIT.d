...
func int DIA_FABIO_Q101_AFTERFIGHT_CONDITION() {
    ...
    if (((((SELF.AIVAR[47]) == (AR_NONE)) && ((SELF.AIVAR[45]) != (AF_NONE))) && ((SELF.AIVAR[45]) != (AF_AFTER_PLUS_DAMAGE))) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
    if (((Q101_FABIOAFTERFIGHT) == (TRUE)) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
...
func void DIA_FABIO_Q101_HELLO_INFO() {
    ...
    INFO_CLEARCHOICES(64810);
    INFO_ADDCHOICE(64810, "Relax, I was just asking. Then I'll be on my way.", 64814);
    INFO_ADDCHOICE(64810, "I feel like someone should give you a lesson in good manners.", 64815);
}
...
func int DIA_FABIO_Q101_BEER_CONDITION() {
    if ((((C_GOTANYKINDOFBEER(HERO)) && (NPC_KNOWSINFO(OTHER, 64810))) && ((Q101_FABIOWANTBEER) == (TRUE))) && ((Q101_AFTERJUMP) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
