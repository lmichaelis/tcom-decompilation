...
func void DIA_MARTHA_Q103_HELLO_INFO() {
    ...
    INFO_CLEARCHOICES(88127);
    INFO_ADDCHOICE(88127, "I don't think anyone taught you manners, woman.", 88130);
    INFO_ADDCHOICE(88127, "Can we get something to eat and a place to sleep?", 88131);
}
...
func void DIA_MARTHA_Q103_TRIALOG_FABIOWAY_INFO() {
    ...
    INFO_CLEARCHOICES(88132);
    INFO_ADDCHOICE(88132, "We split up, they are just heading towards the village.", 88135);
}
...
func void DIA_MARTHA_Q103_TRIALOG_FABIOWAY_SPLITUP() {
    ...
    CREATEINVITEMS(SELF, 36656, 1);
    B_GIVEINVITEMS(SELF, OTHER, 36656, 1);
...
func int DIA_MARTHA_HOWAREYOU_CONDITION() {
    if ((KAPITEL) == (1)) {
        if ((NPC_KNOWSINFO(OTHER, 88127)) && (NPC_KNOWSINFO(OTHER, 88000))) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
...
func void DIA_MARTHA_BIGPORTION_INFO() {
    ...
    INFO_CLEARCHOICES(88140);
    if ((LOG_GETSTATUS(MIS_SQ105)) == (LOG_RUNNING)) {
        INFO_ADDCHOICE(88140, "Actually, I didn't take it for myself, but for Lokvar.", 88143);
    };
    if ((MARTHA_BLACKTAKESTEW) == (TRUE)) {
        INFO_ADDCHOICE(88140, "Can I have some more of your stew?", 88144);
    };
    INFO_ADDCHOICE(88140, "(Give back the stew)", 88145);
}
...
func int DIA_MARTHA_SQ105_STEW_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 88413)) && ((LOG_GETSTATUS(MIS_SQ105)) == (LOG_RUNNING))) {
        if ((NPC_KNOWSINFO(OTHER, 88140)) == (FALSE)) {
...
func void DIA_MARTHA_GQ001_WHEREISJORN_INFO() {
    ...
    INFO_CLEARCHOICES(88150);
    INFO_ADDCHOICE(88150, "It's about Jorn.", 88153);
    INFO_ADDCHOICE(88150, "In that case, I'll ask someone else.", 88154);
    INFO_ADDCHOICE(88150, "If you help me, I promise to help you with your work.", 88155);
}
...
func int DIA_MARTHA_SQ213TAVERN_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 88159)) && ((NPC_GETDISTTOWP(SELF, "VILLAGE_PATH_92")) <= (500))) && ((LOG_GETSTATUS(MIS_SQ213)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_MARTHA_LUTZDEBT_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_SQ213)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 67108))) && ((SQ213_LUTZDEBTGIVEN) == (1))) && ((NPC_HASITEMS(OTHER, 34203)) >= (MIST_LUTZDEBT))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_MARTHA_LUTZDEBT_INFO() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 34203, MIST_LUTZDEBT);
    AI_RESETFACEANI(SELF);
...
func int DIA_MARTHA_SQ213FINISH_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 67129)) && ((LOG_GETSTATUS(MIS_SQ213)) == (LOG_RUNNING))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_MARTHA_SQ213FINISH_INFO() {
    ...
    INFO_CLEARCHOICES(88168);
    if ((NPC_HASITEMS(OTHER, 34203)) >= (MIST_MARTHACORRUPT)) {
        INFO_ADDCHOICE(88168, "Maybe a pouch will solve the problem? (200 GP)", 88171);
    };
    INFO_ADDCHOICE(88168, "Enough!", 88172);
}
...
func void DIA_MARTHA_SQ213FINISH_GOLD() {
    ...
    B_GIVEINVITEMS(OTHER, SELF, 34203, MIST_MARTHACORRUPT);
...
func int DIA_MARTHA_SQ213ANGRY_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_SQ213)) == (LOG_SUCCESS)) && ((SQ213_SONGRESULT) == (7))) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_MARTHA_SQ213DONE_INFO() {
    ...
    CREATEINVITEMS(SELF, 35963, 1);
    B_GIVEINVITEMS(SELF, OTHER, 35963, 1);
...
func void DIA_MARTHA_SQ410_ABOUTLUTZ_INFO() {
    ...
    AI_RESETFACEANI(OTHER);
    INFO_CLEARCHOICES(88179);
    INFO_ADDCHOICE(88179, "I haven't seen him.", 88184);
    INFO_ADDCHOICE(88179, "He is sitting outside the inn.", 88183);
}
...
func void DIA_MARTHA_SQ410_WHATNOW_INFO() {
    ...
    AI_RESETFACEANI(OTHER);
    if (((LOG_GETSTATUS(MIS_SQ410)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 67156))) {
...
func int DIA_MARTHA_SQ410_FINISH_CONDITION() {
    if (((LOG_GETSTATUS(MIS_SQ410)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 67172))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_MARTHA_SQ410_FINISH_INFO() {
    ...
    CREATEINVITEMS(SELF, 35965, 1);
    B_GIVEINVITEMS(SELF, OTHER, 35965, 1);
    AI_RESETFACEANI(OTHER);
...
func int DIA_MARTHA_AMBIENT_CONDITION() {
    if (((NPC_GETDISTTOWP(SELF, "VILLAGE_PUB_21")) <= (5500)) && ((SILBACHSLEEP) == (2))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_MARTHA_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(88204);
    INFO_ADDCHOICE(88204, DIALOG_BACK, 88208);
    INFO_ADDCHOICE(88204, DIALOG_PICKPOCKET, 88207);
}

func void DIA_MARTHA_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (3)) {
        CREATEINVITEMS(SELF, 36738, 1);
        B_GIVEINVITEMS(SELF, OTHER, 36738, 1);
