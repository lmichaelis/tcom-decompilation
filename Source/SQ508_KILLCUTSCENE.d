...
func void SQ508_KILLCUTSCENE_START() {
    ...
    CREATEINVITEMS(PAL_100_CANDAC, 34027, 1);
    AI_EQUIPBESTMELEEWEAPON(PAL_100_CANDAC);
    TELEPORTNPCTOWP(51954, "PART8_GRAVEYARD_INNOS_CASPAR");
    TELEPORTNPCTOWP(51962, "PART8_GRAVEYARD_INNOS_01");
    TELEPORTNPCTOWP(1819, "PART8_GRAVEYARD_INNOS_03");
    ...
    AI_FUNCTION(PAL_100_CANDAC, 93023);
    AI_PLAYANI(PAL_100_CANDAC, "T_2HATTACKR");
    AI_WAIT(PAL_100_CANDAC, 1053609165);
    AI_REMOVEWEAPON(PAL_100_CANDAC);
    AI_FUNCTION(PAL_100_CANDAC, 63356);
}
...
func void SQ508_KILLCASPAR() {
    ...
    B_MAGICHURTNPC(PAL_100_CANDAC, NONE_6239_CASPAR, 99999);
}
