...
func void DIA_RUUD_HELLO_INFO() {
    ...
    INFO_CLEARCHOICES(75629);
    INFO_ADDCHOICE(75629, "Why don't you go to the mages? They'll cure you.", 75632);
}
...
func void DIA_RUUD_HELLO_MAGES() {
    ...
    INFO_CLEARCHOICES(75629);
    INFO_ADDCHOICE(75629, "Tell me what to do.", 75633);
}
...
func void DIA_RUUD_BEINARD_INFO() {
    ...
    INFO_CLEARCHOICES(75634);
    INFO_ADDCHOICE(75634, "If not, then no. Forget it.", 75639);
    INFO_ADDCHOICE(75634, "Don't be a crybaby!", 75638);
    INFO_ADDCHOICE(75634, "Do you want to go back to work or not?", 75637);
}
...
func void DIA_RUUD_BEINARD_WORK() {
    ...
    CREATEINVITEMS(SELF, 37159, 1);
    B_GIVEINVITEMS(SELF, OTHER, 37159, 1);
...
var int RUUDAMBIENT_BEINARDWAY;
...
func void DIA_RUUD_SCARED_INFO() {
    ...
    INFO_CLEARCHOICES(75641);
    INFO_ADDCHOICE(75641, "Just be glad Beinard came without the axe.", 75645);
    INFO_ADDCHOICE(75641, "Relax, it'll only take a moment.", 75646);
    INFO_ADDCHOICE(75641, "Apparently some mage wants to help you.", 75647);
}
...
func void DIA_RUUD_SCARED_MAGE() {
    ...
    AI_FUNCTION(SELF, 75648);
    AI_WAITTILLEND(SELF, OTHER);
    AI_WAITTILLEND(OTHER, SELF);
    AI_WAIT(HERO, 1061997773);
    AI_WAIT(VLK_6282_RUUD, 1061997773);
    AI_WAIT(VLK_6283_BEINARD, 1061997773);
    TRIA_WAIT();
    ...
    CREATEINVITEM(VLK_6282_RUUD, 35549);
    AI_EQUIPARMOR(VLK_6282_RUUD, 35549);
    TRIA_WAIT();
    TRIA_NEXT(VLK_6283_BEINARD);
    ...
    if (((LOG_GETSTATUS(MIS_Q202)) != (LOG_RUNNING)) || ((LOG_GETSTATUS(MIS_Q202)) == (LOG_SUCCESS))) {
        ...
        CREATEINVITEMS(SELF, 34203, CQ006_REWARD);
    };
    if ((LOG_GETSTATUS(MIS_Q202)) == (LOG_RUNNING)) {
        ...
        CREATEINVITEMS(SELF, 37162, 1);
        B_GIVEINVITEMS(SELF, OTHER, 37162, 1);
...
func void BROKENARMREPAIR() {
    ...
    TELEPORTNPCTOWP(1819, "HARBOUR_PATH_400");
    TELEPORTNPCTOWP(54569, "HARBOUR_PATH_402");
    TELEPORTNPCTOWP(55160, "HARBOUR_PATH_402");
}
...
func void BROKENARMREPAIR_DISABLECAMERA() {
    FF_APPLYONCEEXT(75651, 75, 4);
}

func void BROKENARMREPAIR_DISABLECAMERA_APPLY() {
    var int BROKENARMREPAIR_DISABLECAMERA_COUNT;
...
func void DIA_RUUD_ALCHEMIST_INFO() {
    ...
    AI_WAITTILLEND(SELF, OTHER);
    AI_WAITTILLEND(OTHER, SELF);
    AI_FUNCTION(HERO, 75660);
    AI_WAITTILLEND(SELF, OTHER);
    AI_WAITTILLEND(OTHER, SELF);
    AI_WAIT(HERO, 1061997773);
    AI_WAIT(VLK_6282_RUUD, 1061997773);
    AI_WAIT(VLK_6284_FIGARO, 1061997773);
...
func void BROKENARMREPAIR_ALCHEMIST() {
    ...
    TELEPORTNPCTOWP(1819, "HARBOUR_PATH_400");
    TELEPORTNPCTOWP(54569, "HARBOUR_PATH_402");
    TELEPORTNPCTOWP(52105, "HARBOUR_PATH_402");
}
...
func int DIA_RUUD_REFERENCEEXCHANGE_CONDITION() {
    if ((((CQ006_RUUD_REFERENCEEXCHANGE) == (1)) && ((LOG_GETSTATUS(MIS_Q202)) == (LOG_RUNNING))) && (NPC_KNOWSINFO(OTHER, 73577))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_RUUD_REFERENCEEXCHANGE_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (CQ006_REWARD)) {
        NPC_REMOVEINVITEMS(SELF, 34203, CQ006_REWARD);
        AI_STARTFACEANI(SELF, S_SMILE, 1, -(1));
        B_GIVEINVITEMS(OTHER, SELF, 34203, CQ006_REWARD);
...
func int DIA_RUUD_TRAIN_PICKLOCK_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 75665)) && ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKLOCK)) < (2))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_RUUD_TRAIN_PICKLOCK_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (RUUD_PICKLOCK)) {
        if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKLOCK)) >= (2)) {
            ...
            NPC_REMOVEINVITEMS(SELF, 34203, RUUD_PICKLOCK);
...
func int DIA_RUUD_Q504_FEEL_CONDITION() {
    if ((((NPC_GETDISTTOWP(SELF, "PART5_WORKERSCAMP_STAND_02")) <= (2000)) && ((Q504_TAKEWORKERS) == (2))) && ((Q504_RUUDVOLFZACKE) == (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_RUUD_AMBIENT_CONDITION() {
    if (((NPC_ISINSTATE(SELF, 61599)) && (NPC_KNOWSINFO(OTHER, 75629))) && (((Q504_RUUDVOLFZACKE) == (1)) && ((NPC_GETDISTTOWP(SELF, "PART5_WORKERSCAMP_STAND_02")) <= (2000)))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_RUUD_AMBIENT_INFO() {
    ...
    if (((Q504_RUUDVOLFZACKE) == (1)) && ((NPC_GETDISTTOWP(SELF, "PART5_WORKERSCAMP_STAND_02")) > (2000))) {
...
func void DIA_RUUD_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(75677);
    INFO_ADDCHOICE(75677, DIALOG_BACK, 75681);
    INFO_ADDCHOICE(75677, DIALOG_PICKPOCKET, 75680);
}

func void DIA_RUUD_PICKPOCKET_DOIT() {
    if ((NPC_GETTALENTSKILL(OTHER, NPC_TALENT_PICKPOCKET)) >= (1)) {
        CREATEINVITEMS(SELF, 34000, 2);
        B_GIVEINVITEMS(SELF, OTHER, 34000, 2);
