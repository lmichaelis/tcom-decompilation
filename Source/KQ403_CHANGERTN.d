...
func void KQ403_PREPARELASTEVENT() {
    ...
    TELEPORTNPCTOWP(54077, VLK_6064_OLDGUY.WP);
...
func void KQ403_PREPAREHOUSE_INSIDEHOUSE_APPLY() {
    ...
    var int MOVPTR8;
    var ZCMOVER MOVER7;
    var int KQ403_PREPAREHOUSE_FORKING_COLLISION;
    var ZCMOVER MOVER1;
    var int MOVPTR2;
    var ZCMOVER MOVER4;
    var int MOVPTR1;
...
func void KQ403_PREPAREHOUSE_INSIDEHOUSE() {
    FF_APPLYONCEEXTGT(61891, 0, -(1));
}

func void KQ403_PREPAREHOUSE_SPAWNNPC() {
    WLD_INSERTNPC(60170, "HARBOUR_HOUSE01_04");
    WLD_INSERTNPC(60172, "HARBOUR_HOUSE01_04");
    WLD_INSERTNPC(60174, "HARBOUR_HOUSE01_04");
    WLD_INSERTNPC(60176, "HARBOUR_HOUSE01_04");
    WLD_INSERTNPC(60178, "HARBOUR_HOUSE01_04");
    WLD_INSERTNPC(60180, "HARBOUR_HOUSE01_04");
    WLD_INSERTNPC(60182, "HARBOUR_HOUSE01_04");
    WLD_INSERTNPC(60184, "HARBOUR_HOUSE01_04");
    WLD_INSERTNPC(60186, "HARBOUR_HOUSE01_04");
    WLD_INSERTNPC(60188, "HARBOUR_HOUSE01_04");
