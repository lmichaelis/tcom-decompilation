...
func int DIA_ELID_QM301_THIEFDEAD_CONDITION() {
    if (((LOG_GETSTATUS(MIS_QM301)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 66741))) {
...
func void DIA_ELID_QM301_THIEFDEAD_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 37245)) >= (1)) {
        ...
        B_GIVEINVITEMS(OTHER, SELF, 37245, 1);
...
func void DIA_ELID_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(69279);
    INFO_ADDCHOICE(69279, DIALOG_BACK, 69283);
    INFO_ADDCHOICE(69279, DIALOG_PICKPOCKET, 69282);
}
