...
func int DIA_GRETEL_HELLO_CONDITION() {
    if (((NPC_GETDISTTOWP(SELF, "WOLFSDEN_TRADER")) <= (850)) || (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
...
func void DIA_GRETEL_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(82271);
    INFO_ADDCHOICE(82271, DIALOG_BACK, 82275);
    INFO_ADDCHOICE(82271, DIALOG_PICKPOCKET, 82274);
}
