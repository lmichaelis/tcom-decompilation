var int CARAMON_Q206_LETSGO_DOUBLE;
func void CARAMON_REMOVEOLDARMOR() {
    if ((NPC_HASITEMS(SLD_1009_CARAMON, 35465)) == (1)) {
        NPC_REMOVEINVITEMS(SLD_1009_CARAMON, 35465, 1);
    };
    if ((NPC_HASITEMS(SLD_1009_CARAMON, 35454)) == (1)) {
        NPC_REMOVEINVITEMS(SLD_1009_CARAMON, 35454, 1);
    };
    if ((NPC_HASITEMS(SLD_1009_CARAMON, 35459)) == (1)) {
        NPC_REMOVEINVITEMS(SLD_1009_CARAMON, 35459, 1);
    };
    if ((NPC_HASITEMS(SLD_1009_CARAMON, 35470)) == (1)) {
        NPC_REMOVEINVITEMS(SLD_1009_CARAMON, 35470, 1);
    };
    if ((NPC_HASITEMS(SLD_1009_CARAMON, 35475)) == (1)) {
        NPC_REMOVEINVITEMS(SLD_1009_CARAMON, 35475, 1);
    };
    HERO.AIVAR[4] = FALSE;
}
...
func void CARAMON_CHANGEARMOR_TOHUNTER() {
    ...
    CREATEINVITEMS(SLD_1009_CARAMON, 35422, 1);
    AI_EQUIPARMOR(SLD_1009_CARAMON, 35422);
    AI_WAITTILLEND(OTHER, SELF);
    AI_WAITTILLEND(SELF, OTHER);
    AI_FUNCTION(SELF, 70261);
}

func void CARAMON_CHANGEARMOR_REMOVEITEM() {
    NPC_REMOVEINVITEMS(SLD_1009_CARAMON, 35422, 1);
    HERO.AIVAR[4] = FALSE;
}
...
func void CARAMON_CHANGEARMOR_TOARAXOS() {
    ...
    if ((MARVIN_ARAXOS_WHEREJOINED) == (1)) {
        if ((CARAMON_TIERARMOR) == (1)) {
            CREATEINVITEMS(SLD_1009_CARAMON, 35454, 1);
            AI_EQUIPARMOR(SLD_1009_CARAMON, 35454);
        } else if ((CARAMON_TIERARMOR) == (2)) {
            CREATEINVITEMS(SLD_1009_CARAMON, 35459, 1);
            AI_EQUIPARMOR(SLD_1009_CARAMON, 35459);
        } else {
            CREATEINVITEMS(SLD_1009_CARAMON, 35465, 1);
            AI_EQUIPARMOR(SLD_1009_CARAMON, 35465);
        };
    };
    if ((MARVIN_ARAXOS_WHEREJOINED) == (2)) {
        if ((CARAMON_TIERARMOR) == (3)) {
            CREATEINVITEMS(SLD_1009_CARAMON, 35470, 1);
            AI_EQUIPARMOR(SLD_1009_CARAMON, 35470);
        } else if ((CARAMON_TIERARMOR) == (4)) {
            CREATEINVITEMS(SLD_1009_CARAMON, 35475, 1);
            AI_EQUIPARMOR(SLD_1009_CARAMON, 35475);
        } else {
            CREATEINVITEMS(SLD_1009_CARAMON, 35465, 1);
            AI_EQUIPARMOR(SLD_1009_CARAMON, 35465);
        };
    ...
    CREATEINVITEMS(SLD_1009_CARAMON, 35465, 1);
    AI_EQUIPARMOR(SLD_1009_CARAMON, 35465);
    AI_FUNCTION(SLD_1009_CARAMON, 70263);
    AI_WAITTILLEND(OTHER, SELF);
    AI_WAITTILLEND(SELF, OTHER);
}
...
func int DIA_CARAMON_HELLO_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 70399)) == (FALSE)) {
        return TRUE;
    };
...
func void DIA_CARAMON_HELLO_THANKSADDCHOICE() {
    INFO_ADDCHOICE(70270, "Thanks for the advice.", 70279);
}
...
func void DIA_CARAMON_HELLO_INFO() {
    ...
    if ((OTHER.GUILD) == (GIL_NONE)) {
        ...
        INFO_CLEARCHOICES(70270);
        INFO_ADDCHOICE(70270, "I'd like to join you.", 70280);
        INFO_ADDCHOICE(70270, "I'm still considering it.", 70277);
    };
}

var int CARAMON_ABOUTLORENZO;
func void DIA_CARAMON_HELLO_ABOUTLORENZO() {
    if (((NPC_KNOWSINFO(OTHER, 70985)) == (FALSE)) && ((CARAMON_ABOUTLORENZO) == (FALSE))) {
...
func void DIA_CARAMON_HELLO_NEXT() {
    ...
    INFO_ADDCHOICE(70270, "What about the City Guard?", 70278);
}
...
func int DIA_CARAMON_Q206_WOODENSCAV_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 71055)) {
        if ((NPC_KNOWSINFO(OTHER, 70399)) || (NPC_KNOWSINFO(OTHER, 70270))) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
...
func void DIA_CARAMON_Q206_WOODENSCAV_INFO() {
    ...
    B_STANDUP();
    INFO_CLEARCHOICES(70281);
    INFO_ADDCHOICE(70281, "Give me a moment.", 70284);
    INFO_ADDCHOICE(70281, "Let's go.", 70287);
}
...
func int DIA_CARAMON_Q206_INGORARMOR_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 70281)) && ((CARAMON_Q206_LETSGO_DOUBLE) == (TRUE))) && ((NPC_GETDISTTOWP(SELF, "PARTM1_JOINARAXOS_SLD_01")) < (500))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_CARAMON_Q206_PRETAVERN_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 70291)) && ((NPC_GETDISTTOWP(SELF, "HARBOUR_PATH_125")) <= (500))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_CARAMON_Q206_ANYINFO_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_Q206)) == (LOG_RUNNING)) && ((Q206_KNOWSFINBAR) == (TRUE))) && ((NPC_KNOWSINFO(OTHER, 69184)) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_CARAMON_Q206_ANYINFO_INFO() {
    ...
    INFO_CLEARCHOICES(70297);
    INFO_ADDCHOICE(70297, "We need to look for Finbar, he's supposed to be around the cranes in the harbor.", 70300);
}
...
func void DIA_CARAMON_Q206_ANYINFO_SEARCH() {
    ...
    INFO_CLEARCHOICES(70297);
    INFO_ADDCHOICE(70297, "What if I find him?", 70301);
}
...
func int DIA_CARAMON_Q206_THANKSFORHELP_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_Q206)) == (LOG_RUNNING)) && ((Q206_SMUGLESDEAD()) == (TRUE))) && (NPC_KNOWSINFO(OTHER, 69184))) {
...
func void DIA_CARAMON_Q206_THANKSFORHELP_INFO() {
    ...
    INFO_CLEARCHOICES(70302);
    INFO_ADDCHOICE(70302, "This is Pablo, one of the smugglers.", 70305);
}
...
func void DIA_CARAMON_Q206_THANKSFORHELP_PABLO() {
    ...
    INFO_CLEARCHOICES(70302);
    INFO_ADDCHOICE(70302, "The issue is more complicated than we thought.", 70306);
}
...
func void DIA_CARAMON_Q206_THANKSFORHELP_PABLO_COMPLICATED() {
    ...
    INFO_CLEARCHOICES(70302);
    INFO_ADDCHOICE(70302, "You said you didn't know anything about these goods.", 70308);
    INFO_ADDCHOICE(70302, "You got a deal!", 70307);
}
...
func int DIA_CARAMON_Q206_TRUSTPABLO_CONDITION() {
    if ((((NPC_GETDISTTOWP(SELF, SELF.WP)) <= (500)) && ((LOG_GETSTATUS(MIS_Q206)) == (LOG_RUNNING))) && (NPC_KNOWSINFO(OTHER, 70302))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_CARAMON_Q206_TRUSTPABLO_INFO() {
    ...
    INFO_CLEARCHOICES(70310);
    INFO_ADDCHOICE(70310, "So far, he has proven to be quite useful.", 70314);
    INFO_ADDCHOICE(70310, "It's our only lead.", 70315);
}
...
func int DIA_CARAMON_Q206_AFTERPABLO_CONDITION() {
    if (((LOG_GETSTATUS(MIS_Q206)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 69211))) {
...
func void DIA_CARAMON_Q206_AFTERPABLO_INFO() {
    ...
    INFO_CLEARCHOICES(70316);
    INFO_ADDCHOICE(70316, "Last time, splitting up didn't work out too well for us.", 70319);
    INFO_ADDCHOICE(70316, "Thanks, I'm heading into town then.", 70320);
}
...
func int DIA_CARAMON_Q206_DOOR_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_Q206)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 70316))) && ((NPC_GETDISTTOWP(SELF, SELF.WP)) <= (500))) && ((Q206_CHECKDOORWITHCARAMON) == (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_CARAMON_YOURBROTHER_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 70324)) && ((Q509_CARAMONVOLFZACKE) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_CARAMON_WHEREBORN_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 70327)) && ((Q509_CARAMONVOLFZACKE) == (FALSE))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_CARAMON_QA302_HELP_CONDITION() {
    if (((LOG_GETSTATUS(MIS_QA302)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 70557))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_CARAMON_QA302_LETSGO_CONDITION() {
    if (((LOG_GETSTATUS(MIS_QA302)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 70336))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_CARAMON_QA302_GERSTANDINN_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_QA302)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 70339))) && ((NPC_GETDISTTOWP(SELF, "PARTM4_PATH_84")) <= (500))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_CARAMON_QA302_SUSPECT_CONDITION() {
    if (((LOG_GETSTATUS(MIS_QA302)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 74765))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_CARAMON_QA302_BANDITS_INFO() {
    ...
    INFO_CLEARCHOICES(70348);
    INFO_ADDCHOICE(70348, "We need to inform Garos.", 70351);
    INFO_ADDCHOICE(70348, "Yeah, let's go!", 70352);
}
...
func void DIA_CARAMON_KQ403_ACTION_INFO() {
    ...
    INFO_CLEARCHOICES(70356);
    INFO_ADDCHOICE(70356, "Do you know each other?", 70359);
}
...
func void DIA_CARAMON_KQ403_ACTION_KNOW() {
    ...
    INFO_CLEARCHOICES(70356);
    INFO_ADDCHOICE(70356, "We have to come up with something. Otherwise we'll be homeless.", 70360);
}
...
func int DIA_CARAMON_KQ403_HOUSE_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_KQ403)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 70356))) && ((NPC_GETDISTTOWP(SELF, "HARBOUR_PATH_170")) <= (500))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_CARAMON_KQ403_NOGOOD_INFO() {
    ...
    INFO_CLEARCHOICES(70367);
    INFO_ADDCHOICE(70367, "I'm scared to ask...", 70370);
}
...
func int DIA_CARAMON_KQ403_GOSSIP_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_KQ403)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 70367))) && ((NPC_GETDISTTOWP(SELF, "HARBOUR_HOUSE01_06")) <= (350))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_CARAMON_KQ403_GOSSIP_INFO() {
    ...
    INFO_CLEARCHOICES(70371);
    INFO_ADDCHOICE(70371, "Haunted? Are you making fun of me?", 70375);
    INFO_ADDCHOICE(70371, "What are you talking about?", 70376);
}
...
func int DIA_CARAMON_KQ403_GOODJOB_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_KQ403)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 70371))) && ((NPC_GETDISTTOWP(SELF, "HARBOUR_PATH_143")) <= (500))) && (NPC_KNOWSINFO(OTHER, 74985))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_CARAMON_KQ403_GOTEVERYTHING_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_KQ403)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 70377))) && ((KQ403_READYFORDEMOLISHHOUSE) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_CARAMON_KQ403_GOTEVERYTHING_INFO() {
    ...
    if ((((NPC_HASITEMS(OTHER, 33875)) >= (3)) && ((NPC_HASITEMS(OTHER, 37328)) >= (1))) && ((NPC_HASITEMS(OTHER, 39536)) >= (1))) {
...
func int DIA_CARAMON_KQ403_READY_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_KQ403)) == (LOG_RUNNING)) && ((KQ403_GHOSTCOUNT) == (4))) && (WLD_ISTIME(6, 0, 22, 0))) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_CARAMON_KQ403_CONGRATULATIONS_CONDITION() {
    if (((LOG_GETSTATUS(MIS_KQ403)) == (LOG_SUCCESS)) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_CARAMON_KQ403_CONGRATULATIONS_INFO() {
    ...
    NPC = HLP_GETNPC(1819);
    NPCPTR = _@(70390);
    FF_APPLYEXTDATAGT(70392, 75, -(1), NPCPTR);
}
    ...
    if ((CURRENTLEVEL) == (ARCHOLOS_ZEN)) {
        if ((KQ403_CARAMONPROMOTION) == (1)) {
            if ((KQ403_CARAMONPROMOTION_DAY) <= ((WLD_GETDAY()) - (1))) {
                ...
                } else if ((MARVIN_ARAXOS_WHEREJOINED) == (2)) {
                    if ((CARAMON_TIERARMOR) == (3)) {
                        CARAMON_TIERARMOR = 4;
                        NPC_CHANGEARMOR(SLD_1009_CARAMON, 35475);
                        NPC_REMOVEINVITEMS(SLD_1009_CARAMON, 35470, 1);
                        CREATEINVITEMS(SLD_1009_CARAMON, 39751, 1);
                        ...
                        NPC_REMOVEINVITEMS(SLD_1009_CARAMON, 35465, 1);
                        CREATEINVITEMS(SLD_1009_CARAMON, 39749, 1);
                        CREATEINVITEMS(SLD_1009_CARAMON, 34383, 20);
                        B_SETATTRIBUTESTOLEVEL(SLD_1009_CARAMON, 40);
                    };
                };
...
var int CARAMON_KNOWHOW;
var int CARAMON_SAME;
var int CARAMON_KNOWWHY;
...
func void DIA_CARAMON_YOUALIVE_INFO() {
    ...
    INFO_CLEARCHOICES(70399);
    INFO_ADDCHOICE(70399, "Did your baptism look the same?", 70402);
    INFO_ADDCHOICE(70399, "Why did you join the Guild?", 70403);
    INFO_ADDCHOICE(70399, "What was your recruitment process like?", 70404);
}
...
func int DIA_CARAMON_CANYOUTEACH_CONDITION() {
    if (((OTHER.GUILD) == (GIL_SLD)) && (NPC_KNOWSINFO(OTHER, 71055))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
var int CARAMON_NOMORE;
var int CARAMON_CURRENTBLEVEL;
var int CARAMON_CURRENT1HLEVEL;
var int CARAMON_CURRENTDEXLEVEL;
...
func int DIA_CARAMON_TEACH_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 70405)) && ((CARAMON_NOMORE) == (FALSE))) && ((OTHER.GUILD) == (GIL_SLD))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_CARAMON_TEACH_CHOICES() {
    var int CARAMON_GOLDCOST;
    CARAMON_CURRENTBLEVEL = OTHER.AIVAR[86];
    CARAMON_CURRENT1HLEVEL = OTHER.AIVAR[84];
    CARAMON_CURRENTDEXLEVEL = OTHER.AIVAR[82];
    CARAMON_GOLDCOST = 0;
    INFO_CLEARCHOICES(70415);
    INFO_ADDCHOICE(70415, DIALOG_BACK, 70420);
    INFO_ADDCHOICE(70415, B_BUILDLEARNSTRING2(PRINT_LEARNBOW1, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_BOW, 1), CARAMON_GOLDCOST), 70421);
    INFO_ADDCHOICE(70415, B_BUILDLEARNSTRING2(PRINT_LEARNBOW5, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_BOW, 5), (CARAMON_GOLDCOST) * (5)), 70422);
    INFO_ADDCHOICE(70415, B_BUILDLEARNSTRING2(PRINT_LEARN1H1, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_1H, 1), CARAMON_GOLDCOST), 70423);
    INFO_ADDCHOICE(70415, B_BUILDLEARNSTRING2(PRINT_LEARN1H5, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_1H, 5), (CARAMON_GOLDCOST) * (5)), 70424);
    INFO_ADDCHOICE(70415, B_BUILDLEARNSTRING2(PRINT_LEARNDEX1, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_DEXTERITY, 1), CARAMON_GOLDCOST), 70425);
    INFO_ADDCHOICE(70415, B_BUILDLEARNSTRING2(PRINT_LEARNDEX5, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_DEXTERITY, 5), (CARAMON_GOLDCOST) * (5)), 70426);
}
...
func void DIA_CARAMON_Q509_QUESTION_INFO() {
    ...
    INFO_CLEARCHOICES(70427);
    INFO_ADDCHOICE(70427, "Thanks, Caramon, that means a lot to me.", 70430);
}
...
func int DIA_CARAMON_Q509_FEEL_CONDITION() {
    if (((Q509_CARAMONVOLFZACKE) == (1)) && ((NPC_GETDISTTOWP(SELF, "PART5_Q509_HEROFRIEND")) <= (2000))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_CARAMON_AMBIENT_CONDITION() {
    if (NPC_KNOWSINFO(OTHER, 70270)) {
        if ((((((LOG_GETSTATUS(MIS_Q206)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 70285))) || (((LOG_GETSTATUS(MIS_QA302)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 70339)))) || (((LOG_GETSTATUS(MIS_KQ403)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 70356)))) || (((LOG_GETSTATUS(MIS_QA401)) == (LOG_RUNNING)) && ((QA401_PREPAREARAXOSONBEACH) == (TRUE)))) {
            return FALSE;
        };
        return TRUE;
    };
