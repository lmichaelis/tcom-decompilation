...
func void DIA_RENEGADE2_BLOCK_INFO() {
    ...
    INFO_CLEARCHOICES(78601);
    INFO_ADDCHOICE(78601, "I thought tolls were paid for transporting goods.", 78608);
    INFO_ADDCHOICE(78601, "You're not getting anything from me.", 78607);
    INFO_ADDCHOICE(78601, "How much do you want?", 78605);
    HEROARMOR = NPC_GETEQUIPPEDARMOR(HERO);
    if (HLP_ISITEM(HEROARMOR, 35509)) {
        INFO_ADDCHOICE(78601, "I'm one of Salvi's men, are you crazy?", 78615);
    };
    if ((HERO.GUILD) == (GIL_MIL)) {
        INFO_ADDCHOICE(78601, "I'm a city guard, damn it!", 78609);
    };
}
...
func void DIA_RENEGADE2_BLOCK_GOLD() {
    ...
    INFO_ADDCHOICE(78601, "I'm sorry, but I don't have that much on me.", 78612);
    if ((NPC_HASITEMS(OTHER, 34203)) >= (RENEGADE_PASSAGE)) {
        INFO_ADDCHOICE(78601, "Here's the money.", 78610);
    };
}
...
func void DIA_RENEGADE2_BLOCK_MILITIA() {
    ...
    INFO_CLEARCHOICES(78601);
    INFO_ADDCHOICE(78601, "In that case, show the papers.", 78613);
}
