...
func int DIA_NERAL_SQ311_HELLO_CONDITION() {
    if (((!(NPC_KNOWSINFO(OTHER, 80897))) && (NPC_ISINSTATE(SELF, 61599))) && ((Q504_TAKEWORKERS) != (2))) {
        return TRUE;
    };
...
func int DIA_NERAL_SQ311_LETSTALK_CONDITION() {
    if (((((LOG_GETSTATUS(MIS_SQ311)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 80897))) && ((NERAL_SQ311_NEEDSPOTION) == (FALSE))) && (NPC_ISINSTATE(SELF, 61599))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}

var int NERAL_SQ311_NEEDSPOTION;
...
func void DIA_NERAL_SQ311_OGISKEY_INFO() {
    ...
    WLD_INSERTNPC(50505, "FP_ROAM_PART10_134");
    WLD_INSERTNPC(50505, "FP_ROAM_PART10_135");
}
...
func int DIA_NERAL_Q504_FEEL_CONDITION() {
    if ((((NPC_GETDISTTOWP(SELF, "PART5_WORKERSCAMP_SMALLTALK_02")) <= (2000)) && ((Q504_TAKEWORKERS) == (2))) && ((Q504_REFIRNERALVOLFZACKE) == (1))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_NERAL_TEACH_CHOICES() {
    ...
    INFO_CLEARCHOICES(81015);
    INFO_ADDCHOICE(81015, DIALOG_BACK, 81020);
    if ((HERO_HACKCHANCE) <= (55)) {
        INFO_ADDCHOICE(81015, B_BUILDLEARNSTRING2(PRINT_LEARN_MINE5, 0, NERAL_PAYMENT5), 81022);
    };
    if ((HERO_HACKCHANCE) <= (59)) {
        INFO_ADDCHOICE(81015, B_BUILDLEARNSTRING2(PRINT_LEARN_MINE1, 0, NERAL_PAYMENT1), 81021);
    };
}
...
func void DIA_NERAL_TEACHMINE1() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (NERAL_PAYMENT1)) {
        if ((HERO_HACKCHANCE) < (100)) {
...
func void DIA_NERAL_TEACHMINE5() {
    ...
    if ((NPC_HASITEMS(OTHER, 34203)) >= (NERAL_PAYMENT5)) {
...
func int DIA_NERAL_AMBIENT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 81000)) && ((NPC_GETDISTTOWP(SELF, "PART5_WORKERSCAMP_SMALLTALK_02")) > (2000))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_NERAL_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(81026);
    INFO_ADDCHOICE(81026, DIALOG_BACK, 81030);
    INFO_ADDCHOICE(81026, DIALOG_PICKPOCKET, 81029);
}
