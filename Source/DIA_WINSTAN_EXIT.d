...
var int WINSTAN_NOMORE;
var int WINSTAN_CURRENT1HLEVEL;
var int WINSTAN_CURRENT2HLEVEL;
var int WINSTAN_CURRENTSTRLEVEL;
...
func int DIA_WINSTAN_TEACH_CONDITION() {
    if (((NPC_KNOWSINFO(OTHER, 67474)) && ((WINSTAN_NOMORE) == (FALSE))) && ((OTHER.GUILD) == (GIL_MIL))) {
        if ((MARVIN_MILITIASPECIALIZATION) >= (1)) {
            return TRUE;
        };
    };
...
func void DIA_WINSTAN_TEACH_CHOICES() {
    var int WINSTAN_GOLDCOST;
    WINSTAN_CURRENT1HLEVEL = OTHER.AIVAR[84];
    WINSTAN_CURRENT2HLEVEL = OTHER.AIVAR[85];
    WINSTAN_CURRENTSTRLEVEL = OTHER.AIVAR[81];
    WINSTAN_GOLDCOST = 0;
    INFO_CLEARCHOICES(67484);
    INFO_ADDCHOICE(67484, DIALOG_BACK, 67489);
    INFO_ADDCHOICE(67484, B_BUILDLEARNSTRING2(PRINT_LEARN1H1, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_1H, 1), WINSTAN_GOLDCOST), 67490);
    INFO_ADDCHOICE(67484, B_BUILDLEARNSTRING2(PRINT_LEARN1H5, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_1H, 5), (WINSTAN_GOLDCOST) * (5)), 67491);
    INFO_ADDCHOICE(67484, B_BUILDLEARNSTRING2(PRINT_LEARN2H1, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_2H, 1), WINSTAN_GOLDCOST), 67492);
    INFO_ADDCHOICE(67484, B_BUILDLEARNSTRING2(PRINT_LEARN2H5, B_GETLEARNCOSTTALENT(OTHER, NPC_TALENT_2H, 5), (WINSTAN_GOLDCOST) * (5)), 67493);
    INFO_ADDCHOICE(67484, B_BUILDLEARNSTRING2(PRINT_LEARNSTR1, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_STRENGTH, 1), WINSTAN_GOLDCOST), 67494);
    INFO_ADDCHOICE(67484, B_BUILDLEARNSTRING2(PRINT_LEARNSTR5, B_GETLEARNCOSTATTRIBUTE(OTHER, ATR_STRENGTH, 5), (WINSTAN_GOLDCOST) * (5)), 67495);
...
func void FMQ001_SWORDTRAINING() {
    ...
    AI_STOPPROCESSINFOS(SELF);
    AI_FUNCTION(SELF, 62784);
    AI_FUNCTION(SELF, 62770);
...
func void DIA_WINSTAN_FMQ001_START_INFO() {
    ...
    INFO_CLEARCHOICES(67496);
    INFO_ADDCHOICE(67496, "Marvin.", 67501);
    INFO_ADDCHOICE(67496, "Recruit Marvin reporting for duty!", 67502);
}
...
func void DIA_WINSTAN_AFTERFMQ001_SWORDTRAINING() {
    ...
    AI_FUNCTION(SELF, 62787);
    AI_FUNCTION(SELF, 62776);
    AI_STOPPROCESSINFOS(SELF);
}
...
func int DIA_WINSTAN_FMQ001_SWORDTRAININGRESULT_CONDITION() {
    if (((LOG_GETSTATUS(MIS_FMQ001)) == (LOG_RUNNING)) && (NPC_ISINSTATE(SELF, 61599))) {
...
func void DIA_WINSTAN_FMQ001_SWORDTRAININGRESULT2VS1_INFO() {
    ...
    if ((FMQ001_TRAINING2VS1FIGHTRESULT) == (3)) {
        ...
        INFO_CLEARCHOICES(67510);
        INFO_ADDCHOICE(67510, "I'd rather not risk it.", 67514);
        INFO_ADDCHOICE(67510, "I'd love to try.", 67513);
    };
    FMQ001_CHECKRECRUITHP();
    FMQ001_REMOVEPARTYMEMBER();
...
func void DIA_WINSTAN_FMQ001_SWORDTRAININGRESULT3VS1_INFO() {
    ...
    if ((TRAINING3VS1FIGHTRESULT) == (3)) {
        ...
        INFO_CLEARCHOICES(67515);
        INFO_ADDCHOICE(67515, "I'd love to stay.", 67518);
        INFO_ADDCHOICE(67515, "I've shown what I can do. I'm going back to Roderich.", 67519);
    };
    FMQ001_CHECKRECRUITHP();
    FMQ001_REMOVEPARTYMEMBER();
...
func void DIA_WINSTAN_QM304_START_INFO() {
    ...
    INFO_CLEARCHOICES(67523);
    if ((QM_304_DETAIL) == (FALSE)) {
        INFO_ADDCHOICE(67523, "Are they even found in the Archipelago?", 67526);
    };
    INFO_ADDCHOICE(67523, "Where did he get the nugget of ore?", 67527);
}
...
func void DIA_WINSTAN_QM304_FINISH_INFO() {
    ...
    if (((QM304_COUNTNUGGETS) == (0)) || ((NPC_HASITEMS(HERO, 34202)) == (0))) {
        DIA_WINSTAN_QM304_FINISH_LEAVE();
    };
    if (((QM304_COUNTNUGGETS) >= (1)) && ((NPC_HASITEMS(HERO, 34202)) >= (1))) {
        INFO_CLEARCHOICES(67528);
        INFO_ADDCHOICE(67528, "(Accept payment and leave)", 67530);
        INFO_ADDCHOICE(67528, "(Hand over found ore)", 67532);
    };
}
...
var int WINSTAN_QM305_START_WHY;
var int WINSTAN_QM305_START_ONLY;
var int WINSTAN_QM305_START_WHERE;
...
func void DIA_WINSTAN_QM305_START_CHOICES() {
    ...
    if ((((WINSTAN_QM305_START_WHY) == (FALSE)) || ((WINSTAN_QM305_START_ONLY) == (FALSE))) || ((WINSTAN_QM305_START_WHERE) == (FALSE))) {
        if ((WINSTAN_QM305_START_WHY) == (FALSE)) {
            INFO_ADDCHOICE(67533, "Why does Odgar need 'Nordmarians' Mastery'?", 67543);
        };
        if ((WINSTAN_QM305_START_ONLY) == (FALSE)) {
            INFO_ADDCHOICE(67533, "Are you sure this is the only copy of this book?", 67542);
        };
        if ((WINSTAN_QM305_START_WHERE) == (FALSE)) {
            INFO_ADDCHOICE(67533, "Where can I find this Wolf Son?", 67541);
        };
    };
...
func int DIA_WINSTAN_QM305_FINISH_CONDITION() {
    if ((LOG_GETSTATUS(MIS_QM305)) == (LOG_RUNNING)) {
        if (((NPC_HASITEMS(OTHER, 37234)) >= (1)) || ((NPC_HASITEMS(OTHER, 37235)) >= (1))) {
            return TRUE;
        };
    };
    return 0 /* !broken stack! */;
...
func void DIA_WINSTAN_QM305_FINISH_INFO() {
    ...
    if (((NPC_HASITEMS(OTHER, 37234)) >= (1)) && ((NPC_HASITEMS(OTHER, 37235)) >= (1))) {
        ...
        B_GIVEINVITEMS(OTHER, SELF, 37234, 1);
        AI_OUTPUT(OTHER, SELF, "DIA_Winstan_QM305_Finish_15_03");
        B_GIVEINVITEMS(OTHER, SELF, 37235, 1);
        AI_STARTFACEANI(SELF, S_SMILE, 1, -(1));
    ...
    if ((WINSTAN_QM305_FINISH) == (1)) {
        ...
        CREATEINVITEMS(SELF, 34203, QM305_FINISH_V1);
        B_GIVEINVITEMS(SELF, OTHER, 34203, QM305_FINISH_V1);
        AI_LOGENTRY(TOPIC_QM305, LOG_QM305_FINISH_V1);
    };
    if ((WINSTAN_QM305_FINISH) == (2)) {
        B_GIVEPLAYERXP(XP_QM305_FINISH_V2);
        CREATEINVITEMS(SELF, 34203, QM305_FINISH_V2);
        B_GIVEINVITEMS(SELF, OTHER, 34203, QM305_FINISH_V2);
        AI_LOGENTRY(TOPIC_QM305, LOG_QM305_FINISH_V2);
    };
    if ((WINSTAN_QM305_FINISH) == (3)) {
        B_GIVEPLAYERXP(XP_QM305_FINISH_V3);
        CREATEINVITEMS(SELF, 34203, QM305_FINISH_V3);
        B_GIVEINVITEMS(SELF, OTHER, 34203, QM305_FINISH_V3);
...
var int WINSTAN_QM401_PLAN_CITY;
var int WINSTAN_QM401_PLAN_ANYTIME;
var int WINSTAN_QM401_PLAN_SALVI;
...
func void DIA_WINSTAN_QM401_PLAN_CHOICES() {
    ...
    if ((((WINSTAN_QM401_PLAN_CITY) == (FALSE)) || ((WINSTAN_QM401_PLAN_ANYTIME) == (FALSE))) || ((WINSTAN_QM401_PLAN_SALVI) == (FALSE))) {
        if ((WINSTAN_QM401_PLAN_CITY) == (FALSE)) {
            INFO_ADDCHOICE(67552, "The renegades will attack from the side of the city.", 67560);
        };
        if ((WINSTAN_QM401_PLAN_ANYTIME) == (FALSE)) {
            INFO_ADDCHOICE(67552, "An attack could happen at any time.", 67561);
        };
        if ((WINSTAN_QM401_PLAN_SALVI) == (FALSE)) {
            INFO_ADDCHOICE(67552, "Salvi has recruited a lot of new people.", 67562);
        };
    };
...
func int DIA_WINSTAN_QM401_FARMERS_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_QM401)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 67552))) && ((QM401_FIGHTWITHRENEGADESCHECK) == (0))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_WINSTAN_QM401_AFTERFIREPLACE_CONDITION() {
    if (((LOG_GETSTATUS(MIS_QM401)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 67006))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_WINSTAN_QM401_NEXTPLAN_CONDITION() {
    if (((LOG_GETSTATUS(MIS_QM401)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 67566))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_WINSTAN_QM401_NEXTPLAN_INFO() {
    ...
    INFO_CLEARCHOICES(67569);
    INFO_ADDCHOICE(67569, "I have to cut grass?", 67573);
    INFO_ADDCHOICE(67569, "Yes, sir!", 67574);
}
...
func void DIA_WINSTAN_QM401_NEXTPLAN_NEXT() {
    ...
    INFO_CLEARCHOICES(67569);
    AI_STOPPROCESSINFOS(SELF);
    CREATEINVITEMS(SELF, 36050, 1);
    B_GIVEINVITEMS(SELF, OTHER, 36050, 1);
    AI_FUNCTION(SELF, 62840);
    AI_RESETFACEANI(OTHER);
    AI_RESETFACEANI(SELF);
}
...
func void DIA_WINSTAN_QM401_AFTERWORK_INFO() {
    ...
    INFO_CLEARCHOICES(67575);
    INFO_ADDCHOICE(67575, "Which way was Duster supposed to go?", 67578);
}
...
func int DIA_WINSTAN_QM401_AFTERFIGHT_CONDITION() {
    if ((((LOG_GETSTATUS(MIS_QM401)) == (LOG_RUNNING)) && (NPC_KNOWSINFO(OTHER, 78672))) && ((QM401_FIGHTWITHRENEGADESCHECK) == (2))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_WINSTAN_SQ503_FINALLY_INFO() {
    ...
    INFO_CLEARCHOICES(67582);
    INFO_ADDCHOICE(67582, "What am I supposed to do?", 67585);
}
...
func void DIA_WINSTAN_SQ503_FINALLY_WHAT() {
    ...
    CREATEINVITEMS(SELF, 37510, 1);
    B_GIVEINVITEMS(SELF, OTHER, 37510, 1);
    INFO_CLEARCHOICES(67582);
    INFO_ADDCHOICE(67582, "Let's not waste time. Let's go.", 67586);
    INFO_ADDCHOICE(67582, "Cortez is to receive the terms of surrender?", 67587);
}
...
func void DIA_WINSTAN_SQ503_AFTERCORTEZ_NEXT() {
    AI_RESETFACEANI(OTHER);
    INFO_CLEARCHOICES(67588);
    INFO_ADDCHOICE(67588, "What's the next plan?", 67594);
}
...
func void DIA_WINSTAN_SQ503_AFTERCORTEZ_INFO() {
    ...
    INFO_CLEARCHOICES(67588);
    INFO_ADDCHOICE(67588, "It could have gone better...", 67592);
    INFO_ADDCHOICE(67588, "All according to plan.", 67593);
}
...
func void DIA_WINSTAN_PROMOTION_TIER1_READY_INFO() {
    var string WINSTAN_CHECKSMARVIN2HLEVEL;
    var string MARVIN_CURRENT2HLEVEL_WINSTAN;
    var string MARVIN_CURRENT1HLEVEL_WINSTAN;
...
func int DIA_WINSTAN_PROMOTION_FINALTIER_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 66297)) && ((MARVIN_MILITIASPECIALIZATION) == (MILITIA_SPECIALIZATION_MASTERFIGHTER))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func int DIA_WINSTAN_AMBIENT_CONDITION() {
    if ((NPC_KNOWSINFO(OTHER, 67609)) || (NPC_KNOWSINFO(OTHER, 67496))) {
        return TRUE;
    };
    return 0 /* !broken stack! */;
}
...
func void DIA_WINSTAN_PICKPOCKET_INFO() {
    INFO_CLEARCHOICES(67615);
    INFO_ADDCHOICE(67615, DIALOG_BACK, 67619);
    INFO_ADDCHOICE(67615, DIALOG_PICKPOCKET, 67618);
}
