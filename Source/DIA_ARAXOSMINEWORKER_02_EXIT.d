...
var int WORKER_ARAXOSMINE_02_WANTORE;
...
var int WORKER_ARAXOSMINE_02_GIVENORE;
func void DIA_WORKER_ARAXOSMINE_02_GIVEORE_INFO() {
    ...
    if ((NPC_HASITEMS(OTHER, 33660)) >= (4)) {
        ...
        B_GIVEINVITEMS(OTHER, SELF, 33660, 4);
...
func void DIA_WORKER_QA306_BACK_INFO() {
    ...
    CREATEINVITEMS(SELF, 33660, 8);
    B_GIVEINVITEMS(SELF, OTHER, 33660, 8);
}
